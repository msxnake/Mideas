...
/**
 * Game flow icon, alias for WorldMapIcon.
 */
...
/**
 * Arrow U-turn left icon (for Undo).
 */
...
/**
 * Arrow U-turn right icon (for Redo).
 */
...
/**
 * Copy icon, alias for DocumentDuplicateIcon.
 */
...
/**
 * Sparkles icon, alias for FireIcon.
 */
...
/**
 * Paste icon, alias for ClipboardDocumentListIcon.
 */
export const PasteIcon = ClipboardDocumentListIcon; // Alias for Paste contexts

/**
 * Viewfinder circle icon (for "Select Area" tool).
 */
...
/**
 * Stop circle icon (for "Unselect Area").
 */
...
/**
 * Paint brush icon (for "Fill Selection").
 */
...
/**
 * Arrows pointing out icon (for "Clone Grid").
 */
