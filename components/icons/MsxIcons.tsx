...
export const LineToolIcon = wrapIcon(Lucide.Slash);
export const RectShapeIcon = wrapIcon(Lucide.Square);
export const EllipseShapeIcon = wrapIcon(Lucide.Circle);
export const SprayIcon = wrapIcon(Lucide.SprayCan);
export const SelectionIcon = wrapIcon(Lucide.SquareDashed);
export const StampIcon = wrapIcon(Lucide.Stamp);
