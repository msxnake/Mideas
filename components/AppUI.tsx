...
interface AppUIProps {
  ...
  /** Deletes bitmap tile sources (tile assets and/or room atlas entries) in one history step. */
  handleDeleteBitmapTileSources: (payload: {
    assetIds?: string[];
        ...
        <div className="relative min-h-0 min-w-0 flex-grow flex flex-col" role="main">
          ...
          {currentEditor === EditorType.Msx2BitmapStamp && activeAsset?.type === 'msx2bitmapstamp' && (
            <Msx2BitmapStampEditor
              ...
              onSelectAsset={onSelectAsset}
              onDeleteTileSources={handleDeleteBitmapTileSources}
              setStatusBarMessage={setStatusBarMessage}
            />
          )}
          ...
          {currentEditor === EditorType.Msx2EnemyBehavior && activeAsset?.type === 'msx2enemybehavior' && ( <Msx2EnemyBehaviorEditor behavior={activeAsset.data as Msx2EnemyBehaviorAsset} onUpdate={(data) => handleUpdateAsset(activeAsset.id, data)} setStatusBarMessage={setStatusBarMessage} allAssets={assets} />)}
