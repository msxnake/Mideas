...
import { 
  ...
  Boss, Point, HistoryState, WaypointPickerState, CopiedTileData, MainMenuConfig, GameFlowGraph
} from '../types';
import { 
...
interface AppUIProps {
  ...
  setBossEditorZoomLevel: React.Dispatch<React.SetStateAction<number>>;
