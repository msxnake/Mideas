    ...
    <div className="flex flex-col h-screen bg-msx-bgcolor text-msx-textprimary font-sans">
      ...
      <div className="flex-grow flex overflow-hidden">
        ...
        <div className="flex-grow flex flex-col" role="main">
          ...
          {currentEditor === EditorType.WorldMap && activeAsset?.type === 'worldmap' && ( <WorldMapEditor worldMapGraph={activeAsset.data as WorldMapGraph} onUpdate={(data) => handleUpdateAsset(activeAsset.id, data)} availableScreenMaps={assets.filter(a => a.type === 'screenmap').map(a => a.data as ScreenMap)} tileset={assets.filter(a => a.type === 'tile').map(a => a.data as Tile)} currentScreenMode={currentScreenMode} dataOutputFormat={dataOutputFormat} onNavigateToAsset={memoizedHandleSelectAsset} onShowContextMenu={showContextMenu}/>)}
