...
export const AppUI: React.FC<AppUIProps> = (props) => {
  ...
  */
  ...
  const renderRightPanelContent = () => {
    ...
    const paletteEditors = [EditorType.Tile, EditorType.Sprite, EditorType.Msx2Sprite, EditorType.Msx2Bitmap, EditorType.Msx2Screen, EditorType.Screen, EditorType.Font, EditorType.Boss];
    ...
    <div className="flex flex-col h-screen bg-msx-bgcolor text-msx-textprimary font-sans" onContextMenu={(e) => e.preventDefault()}>
      ...
      <div className="min-h-0 flex-grow flex overflow-hidden">
        ...
        <div className="min-h-0 min-w-0 flex-grow flex flex-col" role="main">
          ...
          {currentEditor === EditorType.Msx2Screen && activeAsset?.type === 'msx2screen' && ( <Msx2Screen5TileScreenEditor screen={activeAsset.data as Msx2Screen5TileScreen} onUpdate={(data) => handleUpdateAsset(activeAsset.id, data)} />)}
