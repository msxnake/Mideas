    ...
    <div className="flex flex-col h-screen bg-msx-bgcolor text-msx-textprimary font-sans" onContextMenu={(e) => e.preventDefault()}>
      ...
      <div className="min-h-0 flex-grow flex overflow-hidden">
        ...
        <div className="relative min-h-0 min-w-0 flex-grow flex flex-col" role="main">
          ...
          {currentEditor === EditorType.Msx2Player && activeAsset?.type === 'msx2player' && ( <Msx2PlayerEditor player={activeAsset.data as Msx2PlayerDefinition} playerAssetId={activeAsset.id} playerAssetName={activeAsset.name} onUpdate={(patch) => handleUpdateAsset(activeAsset.id, buildDetailedMsx2PlayerDocument(mergeMsx2PlayerUpdate(activeAsset.data, patch)))} allAssets={assets} onUpsertStateMachineAsset={(stateMachineAsset) => setAssetsWithHistory(prev => {
