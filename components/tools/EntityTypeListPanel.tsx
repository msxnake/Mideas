...
export const EntityTypeListPanel: React.FC<EntityTypeListPanelProps> = ({
  ...
  const collapseButton = (
    <button
      ...
      className="text-[0.65rem] text-msx-textsecondary hover:text-white px-2 py-1 rounded transition-colors"
      aria-label={isCollapsed ? 'Expand entity templates' : 'Collapse entity templates'}
    >
