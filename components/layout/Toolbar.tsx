  ...
  return (
    <div className="bg-msx-panelbg border-b border-msx-border px-2 py-1 flex items-center gap-1 shadow-md relative">
      ...
      <DropdownMenu label="New Asset">
        ...
        {shouldShowAssetType('msx2enemybehavior') && <DropdownItem onClick={() => onNewAsset('msx2enemybehavior')} icon={<BugIcon />} colorClass="text-lime-200 hover:bg-lime-700 hover:text-white" disabled={!canCreateAsset('msx2enemybehavior')}>MSX2 Enemy Behaviour</DropdownItem>}
        {shouldShowAssetType('msx2boss') && <DropdownItem onClick={() => onNewAsset('msx2boss')} icon={<BugIcon />} colorClass="text-red-300 hover:bg-red-700 hover:text-white" disabled={!canCreateAsset('msx2boss')}>MSX2 Boss</DropdownItem>}
        {shouldShowAssetType('msx2bosspath') && <DropdownItem onClick={() => onNewAsset('msx2bosspath')} icon={<BugIcon />} colorClass="text-orange-300 hover:bg-orange-700 hover:text-white" disabled={!canCreateAsset('msx2bosspath')}>MSX2 Boss Path</DropdownItem>}
        {shouldShowAssetType('msx2shoot') && <DropdownItem onClick={() => onNewAsset('msx2shoot')} icon={<SparklesIcon />} colorClass="text-amber-300 hover:bg-amber-700 hover:text-white" disabled={!canCreateAsset('msx2shoot')}>MSX2 Shoots Definition</DropdownItem>}
