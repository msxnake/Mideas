...
const data = {
  ...
  category: 'movement',
  parameters: [
    { key: 'wallJumpVertical', label: 'Vertical push (px/frame)', type: 'number', default: 4, min: 1, max: 8, step: 1, help: 'Upward force of the wall jump kick in pixels per frame. When set, it overrides the legacy 8.8 Wall jump power below.' },
    { key: 'wallJumpPower', label: 'Wall jump power', type: 'number', default: 1024, min: 256, max: 2048, step: 1, help: 'Legacy vertical impulse in 8.8 fixed point (256-2048). Ignored when Vertical push is set.' },
