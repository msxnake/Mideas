...
msx2_required_collectibles EQU 8
...
init_rom:
    ...
    call init_konami8k_linear_banks
...
init_konami8k_linear_banks:
    ; Harmless on simple 32K ROMs; required when the same image is forced
    ; as Konami 8K so #6000/#8000/#A000 expose linear banks 1/2/3.
    ld a, 1
    ld (#6000), a
    ld a, 2
    ld (#8000), a
...
update_hardware_sprite_input:
    ...
    jp update_hardware_sprite_input_paddle_horizontal
...
.enemy_slot_0_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_0_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_0_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_0_ball_check_paddle
    jp .enemy_slot_0_ball_store_y
...
.enemy_slot_0_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_0_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_0_ball_store_paddle_dx
.enemy_slot_0_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_0_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
...
.enemy_slot_1_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_1_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_1_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_1_ball_check_paddle
    jp .enemy_slot_1_ball_store_y
...
.enemy_slot_1_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_1_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_1_ball_store_paddle_dx
.enemy_slot_1_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_1_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 1
    add hl, de
...
.enemy_slot_2_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_2_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_2_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_2_ball_check_paddle
    jp .enemy_slot_2_ball_store_y
...
.enemy_slot_2_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_2_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_2_ball_store_paddle_dx
.enemy_slot_2_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_2_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 2
    add hl, de
...
.enemy_slot_3_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_3_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_3_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_3_ball_check_paddle
    jp .enemy_slot_3_ball_store_y
...
.enemy_slot_3_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_3_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_3_ball_store_paddle_dx
.enemy_slot_3_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_3_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 3
    add hl, de
...
.enemy_slot_4_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_4_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_4_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_4_ball_check_paddle
    jp .enemy_slot_4_ball_store_y
...
.enemy_slot_4_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_4_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_4_ball_store_paddle_dx
.enemy_slot_4_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_4_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 4
    add hl, de
...
.enemy_slot_5_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_5_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_5_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_5_ball_check_paddle
    jp .enemy_slot_5_ball_store_y
...
.enemy_slot_5_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_5_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_5_ball_store_paddle_dx
.enemy_slot_5_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_5_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 5
    add hl, de
...
.enemy_slot_6_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_6_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_6_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_6_ball_check_paddle
    jp .enemy_slot_6_ball_store_y
...
.enemy_slot_6_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_6_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_6_ball_store_paddle_dx
.enemy_slot_6_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_6_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 6
    add hl, de
...
.enemy_slot_7_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_7_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_7_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_7_ball_check_paddle
    jp .enemy_slot_7_ball_store_y
...
.enemy_slot_7_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_7_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_7_ball_store_paddle_dx
.enemy_slot_7_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_7_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 7
    add hl, de
...
.enemy_slot_8_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_8_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_8_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_8_ball_check_paddle
    jp .enemy_slot_8_ball_store_y
...
.enemy_slot_8_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_8_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_8_ball_store_paddle_dx
.enemy_slot_8_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_8_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 8
    add hl, de
...
.enemy_slot_9_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_9_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_9_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_9_ball_check_paddle
    jp .enemy_slot_9_ball_store_y
...
.enemy_slot_9_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_9_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_9_ball_store_paddle_dx
.enemy_slot_9_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_9_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 9
    add hl, de
...
.enemy_slot_10_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_10_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_10_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_10_ball_check_paddle
    jp .enemy_slot_10_ball_store_y
...
.enemy_slot_10_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_10_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_10_ball_store_paddle_dx
.enemy_slot_10_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_10_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 10
    add hl, de
...
.enemy_slot_11_ball_down:
    ...
    ld a, b
    cp 192
    jp nc, .enemy_slot_11_ball_miss_paddle
    ld a, b
    cp 136
    jp c, .enemy_slot_11_ball_store_y
    ld a, b
    cp 160
    jp c, .enemy_slot_11_ball_check_paddle
    jp .enemy_slot_11_ball_store_y
...
.enemy_slot_11_ball_check_paddle:
    ...
    cp 24
    jp c, .enemy_slot_11_ball_hit_paddle_left
    ld a, 2
    jp .enemy_slot_11_ball_store_paddle_dx
.enemy_slot_11_ball_hit_paddle_left:
    ld a, #FE
.enemy_slot_11_ball_store_paddle_dx:
    ld hl, msx2_enemy_runtime_dx
    ld de, 11
    add hl, de
...
apply_NEW_MSX2_SCREEN_4_ROOM_collected_visuals:
    ...
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_0
    ld hl, #1848
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_0:
    ld hl, #C095
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_1
    ld hl, #184A
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_1:
    ld hl, #C096
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_2
    ld hl, #184C
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_2:
    ld hl, #C097
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_3
    ld hl, #184E
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_3:
    ld hl, #C098
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_4
    ld hl, #1850
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_4:
    ld hl, #C099
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_5
    ld hl, #1852
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_5:
    ld hl, #C09A
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_6
    ld hl, #1854
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_6:
    ld hl, #C09B
    ld a, (hl)
    cp 3
    jp z, keep_NEW_MSX2_SCREEN_4_ROOM_collectible_7
    ld hl, #1856
    call clear_screen4_name_cell_16
keep_NEW_MSX2_SCREEN_4_ROOM_collectible_7:
    ret
...
msx2_screen_enemy_min_x:
    DB #10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
msx2_screen_enemy_dx:
    DB #02,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
msx2_hw_sprite_frame_0_pattern_0:
    DB #00,#00,#00,#00,#3F,#7F,#FF,#FF,#FF,#FF,#7F,#1F,#00,#00,#00,#00
    DB #00,#00,#00,#00,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#00,#00,#00
; Hardware metasprite frame 0 part 1: x+16, y+0
msx2_hw_sprite_frame_0_pattern_1:
    DB #00,#00,#00,#00,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#00,#00,#00
    DB #00,#00,#00,#00,#FC,#FE,#FF,#FF,#FF,#FF,#FE,#F8,#00,#00,#00,#00
; Shared 16x16 enemy/hazard hardware sprite pattern from MSX2 entity sprite asset
msx2_hw_enemy_sprite_pattern:
    DB #00,#00,#00,#00,#03,#07,#0B,#07,#0F,#07,#03,#01,#00,#00,#00,#00
    DB #00,#00,#00,#00,#C0,#E0,#F0,#F0,#F0,#E0,#C0,#80,#00,#00,#00,#00
...
msx2_hw_sprite_colors_0:
    DB #07,#07,#07,#07,#0F,#08,#07,#07,#05,#05,#04,#01,#07,#07,#07,#07
...
msx2_hw_enemy_sprite_colors_0:
    DB #0D,#0D,#0D,#0D,#0F,#0F,#07,#07,#05,#05,#04,#04,#0D,#0D,#0D,#0D
...
; 2 player hardware sprite(s), 12 enemy/hazard sprite slots, 2 player bullet slot, 1 enemy bullet slot, 3 HUD life slots; next Y=208 terminates the SAT
msx2_hw_sprite_attrs:
    DB #90,#60,#00,#00,#90,#70,#04,#00,#D0,#00,#08,#00,#D0,#00,#08,#00
...
; New MSX2 SCREEN 4 Room behavior layer, 16x14 bytes
...
NEW_MSX2_SCREEN_4_ROOM_NAMES:
    ...
    DB #02,#03,#02,#03,#02,#03,#02,#03,#01,#01,#01,#01,#01,#01,#00,#00
    DB #00,#00,#01,#01,#01,#01,#01,#01,#04,#05,#04,#05,#04,#05,#04,#05
    DB #04,#05,#04,#05,#04,#05,#04,#05,#01,#01,#01,#01,#01,#01,#00,#00
...
; New MSX2 SCREEN 4 Room SCREEN 4 bank 0 compact patterns
NEW_MSX2_SCREEN_4_ROOM_BANK_0_PATTERNS:
    DB #88,#11,#22,#44,#88,#11,#22,#44,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#80,#00,#E0,#0E,#C0,#C0,#00,#00,#01,#00,#80,#03,#03,#03
    DB #C0,#C0,#C0,#00,#80,#C0,#00,#00,#03,#03,#03,#00,#01,#03,#00,#00

; New MSX2 SCREEN 4 Room SCREEN 4 bank 0 compact colors
NEW_MSX2_SCREEN_4_ROOM_BANK_0_COLORS:
    DB #54,#54,#54,#54,#54,#54,#54,#54,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#01,#FF,#7F,#F7,#85,#A5,#00,#00,#01,#FF,#F7,#87,#85,#A5
    DB #A5,#84,#84,#44,#01,#04,#00,#00,#A5,#84,#84,#44,#01,#04,#00,#00

; New MSX2 SCREEN 4 Room SCREEN 4 bank 1 compact patterns
NEW_MSX2_SCREEN_4_ROOM_BANK_1_PATTERNS:
    DB #88,#11,#22,#44,#88,#11,#22,#44,#00,#00,#00,#00,#00,#00,#00,#00

; New MSX2 SCREEN 4 Room SCREEN 4 bank 1 compact colors
NEW_MSX2_SCREEN_4_ROOM_BANK_1_COLORS:
    DB #54,#54,#54,#54,#54,#54,#54,#54,#00,#00,#00,#00,#00,#00,#00,#00

; New MSX2 SCREEN 4 Room SCREEN 4 bank 2 compact patterns
NEW_MSX2_SCREEN_4_ROOM_BANK_2_PATTERNS:
    DB #88,#11,#22,#44,#88,#11,#22,#44,#00,#00,#00,#00,#00,#00,#00,#00

; New MSX2 SCREEN 4 Room SCREEN 4 bank 2 compact colors
