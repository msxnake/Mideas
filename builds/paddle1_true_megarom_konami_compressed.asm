...
NEW_MSX2_SCREEN_4_ROOM_EFFECTS:
    ; ZX0 compressed effects (192 -> 10 bytes)
    DB #81,#00,#69,#03,#68,#00,#40,#5D,#55,#56
...
NEW_MSX2_SCREEN_4_ROOM_NAMES:
    ; ZX0 compressed layout (768 -> 28 bytes)
    DB #80,#00,#06,#BE,#01,#FC,#25,#02,#03,#39,#D4,#F7,#C0,#89,#FD,#04
    DB #05,#4F,#C0,#5F,#FE,#5E,#C0,#14,#15,#D5,#55,#60
NEW_MSX2_SCREEN_4_ROOM_BANK_0_PATTERNS:
    ; ZX0 compressed tile_pattern (48 -> 33 bytes)
    DB #0F,#88,#11,#22,#44,#F8,#B8,#00,#FE,#21,#BA,#80,#00,#E0,#0E,#C0
    DB #ED,#01,#2E,#03,#FF,#8F,#C0,#F1,#BB,#E4,#EA,#ED,#DD,#FB,#00,#55
    DB #56
NEW_MSX2_SCREEN_4_ROOM_BANK_0_COLORS:
    ; ZX0 compressed tile_color (48 -> 28 bytes)
    DB #96,#54,#81,#00,#93,#01,#FF,#7F,#F7,#85,#A5,#E2,#F0,#F7,#87,#24
    DB #FD,#A5,#84,#84,#44,#01,#04,#E5,#F0,#D5,#55,#60
NEW_MSX2_SCREEN_4_ROOM_BANK_1_PATTERNS:
    ; ZX0 compressed tile_pattern (16 -> 12 bytes)
    DB #0F,#88,#11,#22,#44,#F8,#BC,#00,#FE,#D5,#55,#60
NEW_MSX2_SCREEN_4_ROOM_BANK_1_COLORS:
    ; ZX0 compressed tile_color (16 -> 7 bytes)
    DB #96,#54,#97,#00,#55,#55,#80
