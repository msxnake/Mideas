...
; Project: msx2_screen4_simple_visual_test
...
init_rom:
    ...
    call load_MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_screen4
...
init_msx2_effect_buffers:
    ...
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_EFFECTS
    ld de, #C030
    ld bc, msx2_layer_size
    ldir
    ret

load_MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_screen4:
    xor a
    ld hl, SCREEN4_NAME_VRAM
    ld bc, SCREEN4_NAME_SIZE
    call FILVRM
    ...
    call FILVRM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_0_PATTERNS
    ld de, #0000
    ld bc, 40
    call LDIRVM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_0_COLORS
    ld de, #2000
    ld bc, 40
    call LDIRVM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_1_PATTERNS
    ld de, #0800
    ld bc, 104
    call LDIRVM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_1_COLORS
    ld de, #2800
    ld bc, 104
    call LDIRVM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_2_PATTERNS
    ld de, #1000
    ld bc, 88
    call LDIRVM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_2_COLORS
    ld de, #3000
    ld bc, 88
    call LDIRVM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_NAMES
    ld de, SCREEN4_NAME_VRAM
    ld bc, SCREEN4_NAME_SIZE
    call LDIRVM
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_COLLISION
    ld (msx2_current_collision_ptr), hl
    ld hl, MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BEHAVIOR
    ld (msx2_current_behavior_ptr), hl
    ld hl, #C030
    ld (msx2_current_effects_ptr), hl
    call apply_MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_collected_visuals
    ret

apply_MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_collected_visuals:
...
; MSX2 SCREEN 4 Simple Visual Test collision layer, 16x14 bytes
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_COLLISION:
...
; MSX2 SCREEN 4 Simple Visual Test effects layer, 16x14 bytes
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_EFFECTS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; MSX2 SCREEN 4 Simple Visual Test behavior layer, 16x14 bytes
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BEHAVIOR:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; MSX2 SCREEN 4 Simple Visual Test SCREEN 4 name table, 32x24 chars
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_NAMES:
    ...
    DB #04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#02,#03
    DB #00,#01,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04
    DB #04,#04,#04,#04,#05,#06,#04,#04,#04,#04,#04,#04,#04,#04,#00,#01
    DB #02,#03,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04
    DB #04,#04,#04,#04,#07,#08,#04,#04,#04,#04,#04,#04,#04,#04,#02,#03
    DB #00,#01,#04,#04,#04,#04,#04,#04,#04,#04,#09,#0A,#04,#04,#04,#04
    DB #04,#04,#04,#04,#05,#06,#04,#04,#04,#04,#04,#04,#04,#04,#00,#01
    DB #02,#03,#04,#04,#04,#04,#04,#04,#04,#04,#0B,#0C,#04,#04,#04,#04
    DB #04,#04,#04,#04,#07,#08,#04,#04,#04,#04,#04,#04,#04,#04,#02,#03
    DB #00,#01,#04,#04,#04,#04,#04,#04,#04,#04,#09,#0A,#04,#04,#05,#06
    DB #04,#04,#04,#04,#05,#06,#04,#04,#04,#04,#04,#04,#04,#04,#00,#01
    DB #02,#03,#04,#04,#04,#04,#04,#04,#04,#04,#0B,#0C,#04,#04,#07,#08
    DB #04,#04,#04,#04,#07,#08,#04,#04,#04,#04,#04,#04,#04,#04,#02,#03
    DB #00,#01,#04,#04,#04,#04,#04,#04,#04,#04,#09,#0A,#04,#04,#04,#04
    DB #04,#04,#04,#04,#05,#06,#04,#04,#04,#04,#04,#04,#04,#04,#00,#01
    DB #02,#03,#04,#04,#04,#04,#04,#04,#04,#04,#0B,#0C,#04,#04,#04,#04
    DB #04,#04,#04,#04,#07,#08,#04,#04,#04,#04,#04,#04,#04,#04,#02,#03
    DB #00,#01,#04,#04,#04,#04,#04,#04,#04,#04,#05,#06,#04,#04,#04,#04
    DB #04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#00,#01
    DB #02,#03,#04,#04,#04,#04,#04,#04,#04,#04,#07,#08,#04,#04,#04,#04
    DB #04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#02,#03
    DB #00,#01,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09
    DB #09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#00,#01
    DB #02,#03,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A
    DB #0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#02,#03
    DB #00,#01,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09
    DB #09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#09,#00,#01
    DB #02,#03,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A
    DB #0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#0A,#02,#03
...
; MSX2 SCREEN 4 Simple Visual Test SCREEN 4 bank 0 compact patterns
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_0_PATTERNS:
    DB #00,#00,#C0,#C0,#C0,#C0,#C0,#C0,#00,#00,#03,#03,#03,#03,#03,#03
    DB #C0,#C0,#C0,#C0,#C0,#C0,#00,#00,#03,#03,#03,#03,#03,#03,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00

; MSX2 SCREEN 4 Simple Visual Test SCREEN 4 bank 0 compact colors
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_0_COLORS:
    DB #55,#55,#51,#51,#51,#51,#51,#51,#55,#55,#51,#51,#51,#51,#51,#51
    DB #51,#51,#51,#51,#51,#51,#55,#55,#51,#51,#51,#51,#51,#51,#55,#55
    DB #11,#11,#11,#11,#11,#11,#11,#11

; MSX2 SCREEN 4 Simple Visual Test SCREEN 4 bank 1 compact patterns
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_1_PATTERNS:
    DB #00,#00,#C0,#C0,#C0,#C0,#C0,#C0,#00,#00,#03,#03,#03,#03,#03,#03
    DB #C0,#C0,#C0,#C0,#C0,#C0,#00,#00,#03,#03,#03,#03,#03,#03,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#03,#07,#0F,#E0,#C0
    DB #00,#00,#80,#C0,#E0,#F0,#07,#03,#C0,#E0,#0F,#07,#03,#01,#00,#00
    DB #03,#07,#F0,#E0,#C0,#80,#00,#00,#00,#00,#C0,#C0,#C0,#C0,#C0,#C0
    DB #00,#00,#03,#03,#03,#03,#03,#03,#C0,#C0,#C0,#C0,#C0,#C0,#00,#00
    DB #03,#03,#03,#03,#03,#03,#00,#00

; MSX2 SCREEN 4 Simple Visual Test SCREEN 4 bank 1 compact colors
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_1_COLORS:
    DB #55,#55,#51,#51,#51,#51,#51,#51,#55,#55,#51,#51,#51,#51,#51,#51
    DB #51,#51,#51,#51,#51,#51,#55,#55,#51,#51,#51,#51,#51,#51,#55,#55
    DB #11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#A1,#A1,#A1,#A1,#1A,#1A
    DB #11,#11,#A1,#A1,#A1,#A1,#1A,#1A,#1A,#1A,#A1,#A1,#A1,#A1,#11,#11
    DB #1A,#1A,#A1,#A1,#A1,#A1,#11,#11,#FF,#FF,#F8,#F8,#F8,#F8,#F8,#F8
    DB #FF,#FF,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#FF,#FF
    DB #F8,#F8,#F8,#F8,#F8,#F8,#FF,#FF

; MSX2 SCREEN 4 Simple Visual Test SCREEN 4 bank 2 compact patterns
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_2_PATTERNS:
    DB #00,#00,#C0,#C0,#C0,#C0,#C0,#C0,#00,#00,#03,#03,#03,#03,#03,#03
    DB #C0,#C0,#C0,#C0,#C0,#C0,#00,#00,#03,#03,#03,#03,#03,#03,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#C0,#C0,#C0,#C0,#C0,#C0
    DB #00,#00,#03,#03,#03,#03,#03,#03,#C0,#C0,#C0,#C0,#C0,#C0,#00,#00
    DB #03,#03,#03,#03,#03,#03,#00,#00,#00,#00,#00,#00,#33,#66,#CC,#99
    DB #33,#66,#CC,#99,#33,#66,#CC,#99

; MSX2 SCREEN 4 Simple Visual Test SCREEN 4 bank 2 compact colors
MSX2_SCREEN_4_SIMPLE_VISUAL_TEST_BANK_2_COLORS:
    DB #55,#55,#51,#51,#51,#51,#51,#51,#55,#55,#51,#51,#51,#51,#51,#51
    DB #51,#51,#51,#51,#51,#51,#55,#55,#51,#51,#51,#51,#51,#51,#55,#55
    DB #11,#11,#11,#11,#11,#11,#11,#11,#FF,#FF,#F8,#F8,#F8,#F8,#F8,#F8
    DB #FF,#FF,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#F8,#FF,#FF
    DB #F8,#F8,#F8,#F8,#F8,#F8,#FF,#FF,#33,#33,#33,#33,#C2,#C2,#C2,#C2
