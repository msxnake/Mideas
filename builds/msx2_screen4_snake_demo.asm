...
; Project: msx2_screen4_snake_demo
...
init_rom:
    ...
    call load_SNAKE_SCREEN_4_DEMO_screen4

    call init_msx2_snake_char
...
init_msx2_snake_char:
    ...
    ld a, 4
    ld (msx2_snake_body_cells), a
    ld a, 5
    ld (msx2_snake_body_cells + 1), a
...
msx2_snake_load_runtime_chars:
    ...
    ld bc, 32
    call LDIRVM
    ld hl, msx2_snake_empty_pattern
    ld de, #0000
    ld bc, 32
    call LDIRVM
    ld hl, msx2_snake_empty_pattern
...
; Snake dynamic head/body char pattern, copied to all SCREEN 4 banks
msx2_snake_head_pattern:
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
; Snake dynamic head/body char color, copied to all SCREEN 4 banks
msx2_snake_head_color:
    DB #C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3
    DB #C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3
; Snake dynamic food char pattern, copied to all SCREEN 4 banks
msx2_snake_food_pattern:
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
; Snake dynamic food char color, copied to all SCREEN 4 banks
msx2_snake_food_color:
    DB #54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54
    DB #54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54
; Snake dynamic empty char pattern, copied to all SCREEN 4 banks
msx2_snake_empty_pattern:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
; Snake dynamic empty char color, copied to all SCREEN 4 banks
msx2_snake_empty_color:
...
init_msx2_effect_buffers:
    ...
    ; Clobbers AF/BC/DE/HL.
    ld hl, SNAKE_SCREEN_4_DEMO_EFFECTS
    ld de, #C080
    ld bc, msx2_layer_size
    ldir
    ret

load_SNAKE_SCREEN_4_DEMO_screen4:
    xor a
    ld hl, SCREEN4_NAME_VRAM
    ld bc, SCREEN4_NAME_SIZE
    call FILVRM
    ...
    call FILVRM
    ld hl, SNAKE_SCREEN_4_DEMO_BANK_0_PATTERNS
    ld de, #0000
    ld bc, 1992
    call LDIRVM
    ld hl, SNAKE_SCREEN_4_DEMO_BANK_0_COLORS
    ld de, #2000
    ld bc, 1992
    call LDIRVM
    ld hl, SNAKE_SCREEN_4_DEMO_BANK_1_PATTERNS
    ld de, #0800
    ld bc, 1992
    call LDIRVM
    ld hl, SNAKE_SCREEN_4_DEMO_BANK_1_COLORS
    ld de, #2800
    ld bc, 1992
    call LDIRVM
    ld hl, SNAKE_SCREEN_4_DEMO_BANK_2_PATTERNS
    ld de, #1000
    ld bc, 1992
    call LDIRVM
    ld hl, SNAKE_SCREEN_4_DEMO_BANK_2_COLORS
    ld de, #3000
    ld bc, 1992
    call LDIRVM
    call msx2_snake_load_runtime_chars

    ld hl, SNAKE_SCREEN_4_DEMO_NAMES
    ld de, SCREEN4_NAME_VRAM
    ld bc, SCREEN4_NAME_SIZE
    call LDIRVM
    ld hl, SNAKE_SCREEN_4_DEMO_COLLISION
    ld (msx2_current_collision_ptr), hl
    ld hl, SNAKE_SCREEN_4_DEMO_BEHAVIOR
    ld (msx2_current_behavior_ptr), hl
    ld hl, #C080
    ld (msx2_current_effects_ptr), hl
    call apply_SNAKE_SCREEN_4_DEMO_collected_visuals
    ret

apply_SNAKE_SCREEN_4_DEMO_collected_visuals:
    ; Re-erases collectibles already cleared from this screen's persistent effect RAM.
    ; Clobbers AF/BC/DE/HL.
    ld hl, #C0D8
    ld a, (hl)
    cp 3
    jp z, keep_SNAKE_SCREEN_4_DEMO_collectible_0
    ld hl, #1950
    call clear_screen4_name_cell_16
keep_SNAKE_SCREEN_4_DEMO_collectible_0:
    ret

; Palette bytes: byte1=(R<<4)|B, byte2=G
screen4_palette_data:
    DB #00,#00,#00,#00,#11,#01,#11,#06,#70,#00,#70,#07,#77,#07,#07,#02
    DB #70,#04,#07,#04,#44,#04,#65,#02,#22,#02,#55,#05,#77,#00,#07,#00
...
msx2_screen_enemy_y:
    DB #50,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Snake SCREEN 4 Demo collision layer, 16x14 bytes
SNAKE_SCREEN_4_DEMO_COLLISION:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Snake SCREEN 4 Demo effects layer, 16x14 bytes
SNAKE_SCREEN_4_DEMO_EFFECTS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#03,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Snake SCREEN 4 Demo behavior layer, 16x14 bytes
SNAKE_SCREEN_4_DEMO_BEHAVIOR:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Snake SCREEN 4 Demo SCREEN 4 name table, 32x24 chars
SNAKE_SCREEN_4_DEMO_NAMES:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Snake SCREEN 4 Demo SCREEN 4 bank 0 compact patterns
SNAKE_SCREEN_4_DEMO_BANK_0_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ...
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
    DB #00,#00,#00,#00,#00,#00,#00,#00,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F

; Snake SCREEN 4 Demo SCREEN 4 bank 0 compact colors
SNAKE_SCREEN_4_DEMO_BANK_0_COLORS:
    ...
    DB #C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3
    DB #C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3
    DB #00,#00,#00,#00,#00,#00,#00,#00,#54,#54,#54,#54,#54,#54,#54,#54
    DB #54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54,#54
    DB #54,#54,#54,#54,#54,#54,#54,#54

; Snake SCREEN 4 Demo SCREEN 4 bank 1 compact patterns
SNAKE_SCREEN_4_DEMO_BANK_1_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F
    DB #F0,#F0,#F0,#F0,#0F,#0F,#0F,#0F,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Snake SCREEN 4 Demo SCREEN 4 bank 1 compact colors
SNAKE_SCREEN_4_DEMO_BANK_1_COLORS:
    DB #11,#11,#11,#11,#11,#11,#11,#11,#C3,#C3,#C3,#C3,#C3,#C3,#C3,#C3
...
; Snake SCREEN 4 Demo SCREEN 4 bank 2 compact patterns
SNAKE_SCREEN_4_DEMO_BANK_2_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Snake SCREEN 4 Demo SCREEN 4 bank 2 compact colors
SNAKE_SCREEN_4_DEMO_BANK_2_COLORS:
    DB #11,#11,#11,#11,#11,#11,#11,#11,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
