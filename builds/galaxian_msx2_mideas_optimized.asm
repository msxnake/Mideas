...
init_rom:
    ...
    call load_GALAXIAN_SECTOR_screen4
...
init_msx2_effect_buffers:
    ...
    ; Clobbers AF/BC/DE/HL.
    ld hl, GALAXIAN_SECTOR_EFFECTS
    ld de, #C080
    ld bc, msx2_layer_size
    ldir
    ret

load_GALAXIAN_SECTOR_screen4:
    xor a
    ld hl, SCREEN4_NAME_VRAM
    ld bc, SCREEN4_NAME_SIZE
    call FILVRM
    ...
    call FILVRM
    ld hl, GALAXIAN_SECTOR_BANK_0_PATTERNS
    ld de, #0000
    ld bc, 96
    call LDIRVM
    ld hl, GALAXIAN_SECTOR_BANK_0_COLORS
    ld de, #2000
    ld bc, 96
    call LDIRVM
    ld hl, GALAXIAN_SECTOR_BANK_1_PATTERNS
    ld de, #0800
    ld bc, 96
    call LDIRVM
    ld hl, GALAXIAN_SECTOR_BANK_1_COLORS
    ld de, #2800
    ld bc, 96
    call LDIRVM
    ld hl, GALAXIAN_SECTOR_BANK_2_PATTERNS
    ld de, #1000
    ld bc, 96
    call LDIRVM
    ld hl, GALAXIAN_SECTOR_BANK_2_COLORS
    ld de, #3000
    ld bc, 96
    call LDIRVM

    ld hl, GALAXIAN_SECTOR_NAMES
    ld de, SCREEN4_NAME_VRAM
    ld bc, SCREEN4_NAME_SIZE
    call LDIRVM
    ld hl, GALAXIAN_SECTOR_COLLISION
    ld (msx2_current_collision_ptr), hl
    ld hl, GALAXIAN_SECTOR_BEHAVIOR
    ld (msx2_current_behavior_ptr), hl
    ld hl, #C080
    ld (msx2_current_effects_ptr), hl
    call apply_GALAXIAN_SECTOR_collected_visuals
    ret

apply_GALAXIAN_SECTOR_collected_visuals:
...
msx2_screen_enemy_dx:
    DB #01,#01,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00
...
msx2_hw_sprite_frame_0_pattern_0:
    DB #03,#03,#07,#04,#0C,#18,#30,#70,#7C,#0C,#04,#04,#08,#10,#30,#00
    DB #00,#00,#80,#80,#C0,#60,#30,#38,#F8,#C0,#80,#80,#40,#20,#30,#00
; Hardware metasprite frame 0 part 1: x+0, y+0
msx2_hw_sprite_frame_0_pattern_1:
    DB #00,#00,#00,#03,#03,#07,#0F,#0F,#03,#03,#03,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#80,#C0,#C0,#00,#00,#00,#00,#00,#00,#00,#00
...
msx2_hw_sprite_colors_0:
    DB #05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#0F
; Line colors for hardware sprite layer 1
msx2_hw_sprite_colors_1:
    DB #0F,#0F,#0F,#08,#08,#08,#08,#08,#08,#08,#08,#0F,#0F,#0F,#0F,#0F
...
; Galaxian Sector collision layer, 16x14 bytes
GALAXIAN_SECTOR_COLLISION:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Galaxian Sector effects layer, 16x14 bytes
GALAXIAN_SECTOR_EFFECTS:
...
; Galaxian Sector behavior layer, 16x14 bytes
GALAXIAN_SECTOR_BEHAVIOR:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Galaxian Sector SCREEN 4 name table, 32x24 chars
GALAXIAN_SECTOR_NAMES:
    ...
    DB #04,#04,#04,#04,#04,#04,#04,#04,#00,#01,#05,#06,#04,#04,#04,#04
    DB #04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#00,#01
    DB #04,#04,#04,#04,#04,#04,#04,#04,#02,#03,#04,#07,#04,#04,#04,#04
    DB #04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04,#02,#03
    DB #04,#04,#04,#04,#04,#04,#04,#04,#08,#09,#04,#04,#08,#09,#04,#04
    DB #08,#09,#04,#04,#08,#09,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04
    DB #04,#04,#04,#04,#04,#04,#04,#04,#0A,#0B,#04,#04,#0A,#0B,#04,#04
    DB #0A,#0B,#04,#04,#0A,#0B,#04,#04,#04,#04,#04,#04,#04,#04,#04,#04
    DB #04,#04,#00,#01,#04,#04,#04,#04,#04,#04,#08,#09,#04,#04,#08,#09
    DB #04,#04,#08,#09,#04,#04,#08,#09,#00,#01,#04,#04,#04,#04,#05,#06
    DB #04,#04,#02,#03,#04,#04,#04,#04,#04,#04,#0A,#0B,#04,#04,#0A,#0B
    DB #04,#04,#0A,#0B,#04,#04,#0A,#0B,#02,#03,#04,#04,#04,#04,#04,#07
    DB #00,#00,#00,#00,#00,#00,#01,#02,#04,#05,#08,#09,#04,#05,#00,#00
    DB #04,#05,#00,#00,#04,#05,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#03,#06,#07,#0A,#0B,#06,#07,#00,#00
    DB #06,#07,#00,#00,#06,#07,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#04,#05,#00,#00,#04,#05
    DB #01,#02,#04,#05,#00,#00,#04,#05,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#06,#07,#00,#00,#06,#07
    DB #00,#03,#06,#07,#00,#00,#06,#07,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#08,#09,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#08,#09,#00,#00,#00,#00
    DB #00,#00,#00,#00,#0A,#0B,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#0A,#0B,#00,#00,#00,#00
    DB #00,#00,#01,#02,#00,#00,#00,#00,#00,#00,#00,#00,#08,#09,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#03,#00,#00,#00,#00,#00,#00,#00,#00,#0A,#0B,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#02,#00,#00
    DB #00,#00,#00,#00,#04,#05,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#03,#00,#00
    DB #00,#00,#00,#00,#06,#07,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#04,#05,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#01,#02,#00,#00,#00,#00,#04,#05,#00,#00
    DB #00,#00,#00,#00,#00,#00,#06,#07,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#03,#00,#00,#00,#00,#06,#07,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#04,#05
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#06,#07
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #04,#05,#00,#00,#08,#09,#00,#00,#01,#02,#00,#00,#08,#09,#00,#00
    DB #00,#00,#00,#00,#08,#09,#04,#05,#00,#00,#00,#00,#08,#09,#00,#00
    DB #06,#07,#00,#00,#0A,#0B,#00,#00,#00,#03,#00,#00,#0A,#0B,#00,#00
    DB #00,#00,#00,#00,#0A,#0B,#06,#07,#00,#00,#00,#00,#0A,#0B,#00,#00

; Galaxian Sector SCREEN 4 bank 0 compact patterns
GALAXIAN_SECTOR_BANK_0_PATTERNS:
    DB #00,#00,#00,#20,#00,#00,#00,#00,#00,#02,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#08,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#04,#00,#00
    DB #00,#00,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00
    DB #00,#00,#00,#00,#01,#03,#07,#70,#00,#00,#00,#00,#80,#C0,#E0,#0E
    DB #70,#07,#03,#01,#00,#00,#00,#00,#0E,#E0,#C0,#80,#00,#00,#00,#00

; Galaxian Sector SCREEN 4 bank 0 compact colors
GALAXIAN_SECTOR_BANK_0_COLORS:
    DB #11,#11,#11,#51,#11,#11,#11,#11,#11,#A1,#11,#11,#11,#11,#11,#11
    DB #11,#11,#11,#11,#11,#11,#A1,#11,#11,#11,#51,#11,#11,#11,#11,#11
    DB #11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#C1,#11,#11
    DB #11,#11,#81,#11,#11,#11,#11,#11,#11,#11,#11,#11,#C1,#11,#11,#11
    DB #11,#11,#11,#11,#A1,#A1,#A8,#8A,#11,#11,#11,#11,#A1,#A1,#A8,#8A
    DB #8D,#D8,#D1,#D1,#11,#11,#11,#11,#8D,#D8,#D1,#D1,#11,#11,#11,#11

; Galaxian Sector SCREEN 4 bank 1 compact patterns
GALAXIAN_SECTOR_BANK_1_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#04,#00,#00
    DB #00,#00,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00
    DB #00,#00,#00,#00,#01,#03,#07,#70,#00,#00,#00,#00,#80,#C0,#E0,#0E
    DB #70,#07,#03,#01,#00,#00,#00,#00,#0E,#E0,#C0,#80,#00,#00,#00,#00
...
; Galaxian Sector SCREEN 4 bank 1 compact colors
GALAXIAN_SECTOR_BANK_1_COLORS:
    DB #11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#C1,#11,#11
    DB #11,#11,#81,#11,#11,#11,#11,#11,#11,#11,#11,#11,#C1,#11,#11,#11
    DB #11,#11,#11,#11,#A1,#A1,#A8,#8A,#11,#11,#11,#11,#A1,#A1,#A8,#8A
    DB #8D,#D8,#D1,#D1,#11,#11,#11,#11,#8D,#D8,#D1,#D1,#11,#11,#11,#11
...
; Galaxian Sector SCREEN 4 bank 2 compact patterns
GALAXIAN_SECTOR_BANK_2_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#04,#00,#00
    DB #00,#00,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00
    DB #00,#00,#00,#20,#00,#00,#00,#00,#00,#02,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#08,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#00,#00,#80,#80
    DB #07,#07,#07,#E0,#E0,#E0,#E0,#E0,#E0,#E0,#E0,#07,#07,#07,#07,#07

; Galaxian Sector SCREEN 4 bank 2 compact colors
GALAXIAN_SECTOR_BANK_2_COLORS:
    DB #11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#11,#C1,#11,#11
    DB #11,#11,#81,#11,#11,#11,#11,#11,#11,#11,#11,#11,#C1,#11,#11,#11
    DB #11,#11,#11,#51,#11,#11,#11,#11,#11,#A1,#11,#11,#11,#11,#11,#11
    DB #11,#11,#11,#11,#11,#11,#A1,#11,#11,#11,#51,#11,#11,#11,#11,#11
    DB #11,#11,#11,#11,#11,#11,#81,#81,#11,#11,#11,#11,#11,#11,#81,#81
    DB #C1,#C1,#C1,#13,#13,#13,#13,#13,#C1,#C1,#C1,#13,#13,#13,#13,#13
