...
hace `add a, 20`). La colisión usa coords lógicas (0–191) sin offset.
...
- **`load_room` colisión basura por clobber de DE (2026-06-20)** — `replay_room_commands`
  ...
  `ai/ASM_GUIDELINES.md` y `ai/LESSONS_LEARNED.md`. **No es problema de mapper**
...
- **Lag tras transición por R#15 sin restaurar (2026-06-20)** — `load_room` usa el command
  ...
  de CPU (ver `ai/ASM_GUIDELINES.md`).
