...
; Estimated payload bytes: 118350
; Estimated banks used: 15
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (1204 bytes)
; BANK 00 @#04B4 : colors.asm (1076 bytes)
; BANK 00 @#08E8 : components.asm (22 bytes)
; BANK 00 @#08FE : entities.asm (5890 bytes)
; BANK 01 @#0000 : entities.asm (1134 bytes)
; BANK 01 @#046E : worlds.asm (3978 bytes)
; BANK 01 @#13F8 : screens.asm part 1/3 (3080 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (6254 bytes)
; BANK 03 @#186E : sprites.asm part 1/2 (1938 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (7948 bytes)
; BANK 04 @#1F0C : font.asm (244 bytes)
; BANK 05 @#0000 : font.asm (3303 bytes)
; BANK 05 @#0CE7 : hud.asm (4467 bytes)
; BANK 05 @#1E5A : menus.asm (422 bytes)
; BANK 06 @#0000 : menus.asm (22 bytes)
; BANK 06 @#0016 : sound.asm part 1/2 (8170 bytes)
; BANK 07 @#0000 : sound.asm part 2/2 (1231 bytes)
; BANK 07 @#04CF : scroll.asm (2353 bytes)
; BANK 07 @#0E00 : animtiles.asm (4608 bytes)
; BANK 08 @#0000 : animtiles.asm (285 bytes)
; BANK 08 @#011D : particles.asm (4963 bytes)
; BANK 08 @#1480 : statemachine.asm part 1/4 (2944 bytes)
...
; BANK 12 @#0000 : statemachine.asm part 5/4 (2794 bytes)
; BANK 12 @#0AEA : gameflow.asm part 1/3 (5398 bytes)
; BANK 13 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : gameflow.asm part 3/3 (3662 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (136 -> 118 bytes)
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #88,#FE,#EF,#F0,#82,#48,#5A,#90,#12,#3B,#82,#83,#FD,#80,#95,#C0
    DB #F7,#B8,#D0,#C0,#AF,#86,#80,#06,#3D,#81,#81,#00,#18,#94,#83,#83
    DB #37,#6E,#79,#80,#5F,#8B,#9E,#FC,#80,#57,#88,#CD,#00,#85,#32,#C6
    DB #1B,#8E,#C9,#FF,#BE,#3E,#FB,#C0,#78,#76,#C9,#0C,#0F,#80,#75,#95
    DB #CC,#F7,#80,#BD,#F6,#80,#13,#DF,#C0,#F1,#D3,#FC,#BF,#C0,#F0,#A8
    DB #40,#86,#42,#9D,#82,#F9,#88,#A8,#E0,#FE,#78,#80,#7B,#FC,#D4,#80
    DB #FF,#FC,#80,#4A,#86,#43,#97,#B0,#36,#7E,#8F,#82,#80,#0F,#B0,#78
    DB #A0,#3E,#FB,#80,#35,#55,#58
...
; Free RAM buffer for tile pattern data decompression (136 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D800

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (136 bytes)
; ==================================================================
