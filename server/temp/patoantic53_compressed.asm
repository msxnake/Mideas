...
; BANK 03 @#0000 : sprites.asm (7729 bytes)
; BANK 03 @#1E31 : font.asm (463 bytes)
; BANK 04 @#0000 : font.asm (3084 bytes)
; BANK 04 @#0C0C : hud.asm (3836 bytes)
; BANK 04 @#1B08 : menus.asm (444 bytes)
; BANK 04 @#1CC4 : sound.asm (828 bytes)
; BANK 05 @#0000 : sound.asm (2356 bytes)
; BANK 05 @#0934 : scroll.asm (2353 bytes)
; BANK 05 @#1265 : animtiles.asm (3483 bytes)
; BANK 06 @#0000 : animtiles.asm (2433 bytes)
; BANK 06 @#0981 : particles.asm (4963 bytes)
; BANK 06 @#1CE4 : statemachine.asm part 1/4 (796 bytes)
...
; BANK 10 @#0000 : statemachine.asm part 5/4 (8 bytes)
; BANK 10 @#0008 : gameflow.asm part 1/3 (8184 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (380 bytes)
...
; Sprite Asset 10: nina_idle_right
...
SPRITE_NINA_IDLE_RIGHT_10_WIDTH     EQU 16
SPRITE_NINA_IDLE_RIGHT_10_HEIGHT    EQU 16
SPRITE_NINA_IDLE_RIGHT_10_FRAMES    EQU 1

;; ---- Sprite Frame: nina_idle_right_10_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_RIGHT_10_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_RIGHT_10_F0_DATA (32 bytes)
SPRITE_10_PATTERN EQU NINA_IDLE_RIGHT_10_F0_LAYER1
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_11_F0_DATA (32 bytes)
SPRITE_11_PATTERN EQU NINA_JUMP_RIGHT_11_F0_LAYER0
...
sprite_asset_frame_count:
    ...
    db 1 ; Sprite 10: nina_idle_right
...
sprite_loop_flags:
    ...
    db 0 ; Sprite 10: nina_idle_right
...
; Sprite 10: nina_idle_right frame pointers
SPRITE_10_FRAME_PTRS:
    dw NINA_IDLE_RIGHT_10_F0_LAYER1

; Sprite 11: nina_jump_right frame pointers
SPRITE_11_FRAME_PTRS:
    dw NINA_JUMP_RIGHT_11_F0_LAYER0
...
sprite_dir_left_table:
    db 8, 1, 2, 3, 4, 5, 6, 7, 8, 4, 5, 6, 7

sprite_dir_right_table:
    db 0, 1, 2, 3, 9, 10, 11, 12, 0, 9, 10, 11, 12
...
ZX0_SPRITE_FRAME_NINA_IDLE_RIGHT_10_F0_DATA:
    ; ZX0 compressed sprite frame NINA_IDLE_RIGHT_10_F0 (64 -> 48 bytes)
...
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_11_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_RIGHT_11_F0 (64 -> 53 bytes)
...
; Frame group: NINA_IDLE_RIGHT_10_F0
NINA_IDLE_RIGHT_10_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_IDLE_RIGHT_10_F0_DATA
; Frame group: NINA_JUMP_RIGHT_11_F0
NINA_JUMP_RIGHT_11_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_11_F0_DATA
