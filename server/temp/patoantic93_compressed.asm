...
; BANK 00 @#077B : entities.asm (5330 bytes)
; BANK 00 @#1C4D : worlds.asm (947 bytes)
; BANK 01 @#0000 : worlds.asm (3053 bytes)
; BANK 01 @#0BED : screens.asm part 1/3 (5139 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (4195 bytes)
; BANK 03 @#1063 : sprites.asm part 1/2 (3997 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (5768 bytes)
; BANK 04 @#1688 : font.asm (2424 bytes)
; BANK 05 @#0000 : font.asm (1123 bytes)
; BANK 05 @#0463 : hud.asm (3836 bytes)
; BANK 05 @#135F : menus.asm (444 bytes)
; BANK 05 @#151B : sound.asm (2789 bytes)
; BANK 06 @#0000 : sound.asm (681 bytes)
; BANK 06 @#02A9 : scroll.asm (2353 bytes)
; BANK 06 @#0BDA : animtiles.asm (5158 bytes)
; BANK 07 @#0000 : animtiles.asm (758 bytes)
; BANK 07 @#02F6 : particles.asm (4963 bytes)
; BANK 07 @#1659 : statemachine.asm part 1/4 (2471 bytes)
