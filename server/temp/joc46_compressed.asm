...
; BANK 01 @#0000 : entities.asm (1962 bytes)
; BANK 01 @#07AA : worlds.asm (1837 bytes)
; BANK 01 @#0ED7 : screens.asm part 1/3 (4393 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (4835 bytes)
; BANK 03 @#12E3 : sprites.asm part 1/2 (3357 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (5049 bytes)
; BANK 04 @#13B9 : font.asm (3143 bytes)
; BANK 05 @#0000 : font.asm (324 bytes)
; BANK 05 @#0144 : hud.asm (3947 bytes)
; BANK 05 @#10AF : menus.asm (168 bytes)
; BANK 05 @#1157 : sound.asm (3753 bytes)
; BANK 06 @#0000 : sound.asm (665 bytes)
; BANK 06 @#0299 : scroll.asm (2353 bytes)
; BANK 06 @#0BCA : animtiles.asm (5174 bytes)
; BANK 07 @#0000 : animtiles.asm (226 bytes)
; BANK 07 @#00E2 : bosses.asm (5666 bytes)
; BANK 07 @#1704 : statemachine.asm part 1/3 (2300 bytes)
; BANK 08 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 10 @#0000 : statemachine.asm part 4/3 (1295 bytes)
; BANK 10 @#050F : gameflow.asm (6596 bytes)
...
SCREEN_PAN1_0_BLOCK_CATALOG_COUNT EQU 4
SCREEN_PAN1_0_BLOCK_CATALOG_SIZE EQU 64
...
SCREEN_PAN1_0_BLOCK_TOTAL_SIZE EQU 112
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (64 -> 21 bytes)
    DB #95,#FF,#BC,#8C,#F8,#A1,#91,#58,#E2,#80,#81,#FD,#82,#83,#3E,#F3
    DB #EF,#9D,#83,#55,#56
SCREEN_PAN1_0_BLOCK_MAP:
    ; ZX0 compressed screen_block_map (48 -> 13 bytes)
    DB #96,#00,#F2,#01,#F0,#85,#02,#6F,#03,#FE,#35,#55,#58
