...
; Estimated payload bytes: 126569
...
; BANK 11 @#0000 : animtiles.asm (5366 bytes)
; BANK 11 @#14F6 : statemachine.asm part 1/3 (2826 bytes)
...
; BANK 15 @#0000 : gameflow.asm part 3/2 (3689 bytes)
