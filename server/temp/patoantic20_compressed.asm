...
; BANK 02 @#0000 : screens.asm part 2/2 (5904 bytes)
; BANK 02 @#1710 : sprites.asm (2288 bytes)
; BANK 03 @#0000 : sprites.asm (2156 bytes)
; BANK 03 @#086C : font.asm (3547 bytes)
; BANK 03 @#1647 : hud.asm (2489 bytes)
; BANK 04 @#0000 : hud.asm (1347 bytes)
; BANK 04 @#0543 : menus.asm (444 bytes)
; BANK 04 @#06FF : sound.asm (3184 bytes)
; BANK 04 @#136F : scroll.asm (2353 bytes)
; BANK 04 @#1CA0 : animtiles.asm (864 bytes)
; BANK 05 @#0000 : animtiles.asm (2485 bytes)
; BANK 05 @#09B5 : particles.asm (4963 bytes)
; BANK 05 @#1D18 : statemachine.asm part 1/3 (744 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 07 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 4/3 (5831 bytes)
; BANK 08 @#16C7 : gameflow.asm part 1/3 (2361 bytes)
; BANK 09 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 10 @#0000 : gameflow.asm part 3/3 (6124 bytes)
