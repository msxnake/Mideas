...
; BANK 00 @#066A : entities.asm (402 bytes)
; BANK 00 @#07FC : worlds.asm (1181 bytes)
; BANK 00 @#0C99 : screens.asm (4967 bytes)
; BANK 01 @#0000 : screens.asm (798 bytes)
; BANK 01 @#031E : sprites.asm (2623 bytes)
; BANK 01 @#0D5D : font.asm (174 bytes)
; BANK 01 @#0E0B : hud.asm (79 bytes)
; BANK 01 @#0E5A : menus.asm (168 bytes)
; BANK 01 @#0F02 : sound.asm part 1/2 (4350 bytes)
; BANK 02 @#0000 : sound.asm part 2/2 (5181 bytes)
; BANK 02 @#143D : scroll.asm (2353 bytes)
; BANK 02 @#1D6E : animtiles.asm (658 bytes)
; BANK 03 @#0000 : animtiles.asm (3947 bytes)
; BANK 03 @#0F6B : statemachine.asm (5 bytes)
; BANK 03 @#0F70 : gameflow.asm (4080 bytes)
...
SPRITE_BOT1_RIGHT_0_WIDTH     EQU 16
SPRITE_BOT1_RIGHT_0_HEIGHT    EQU 16
SPRITE_BOT1_RIGHT_0_FRAMES    EQU 2

;; ---- Sprite Frame: bot1_right_0_F0 ----
;; Size: 16x16
BOT1_RIGHT_0_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #FFFFFF)
    DB #1F,#7F,#CF,#8F,#07,#00,#2F,#6F,#6F,#6F,#00,#0C,#FC,#FC,#C0,#C0
    DB #E0,#B0,#B0,#F0,#E0,#00,#F0,#BD,#BD,#F0,#00,#1C,#1C,#07,#07,#07

;; ---- End of Frame: bot1_right_0_F0 ----

;; ---- Sprite Frame: bot1_right_0_F1 ----
;; Size: 16x16
BOT1_RIGHT_0_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #FFFFFF)
    DB #1F,#FF,#CF,#0F,#07,#00,#2F,#6F,#6F,#6E,#00,#01,#01,#01,#01,#01
    DB #E0,#B0,#B0,#F0,#E0,#00,#F0,#F0,#F0,#70,#00,#80,#80,#80,#E0,#E0

;; ---- End of Frame: bot1_right_0_F1 ----


; Unified pattern label for sprite 0
SPRITE_0_PATTERN EQU BOT1_RIGHT_0_F0_LAYER3
SPRITE_0_PATTERN_BANK EQU ((SPRITE_0_PATTERN - #4000) / #2000)

; Sprite Asset 1: bot1_left
;; Sprite: bot1_left
;; Total Frames: 2
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_BOT1_LEFT_1_WIDTH     EQU 16
SPRITE_BOT1_LEFT_1_HEIGHT    EQU 16
SPRITE_BOT1_LEFT_1_FRAMES    EQU 2

;; ---- Sprite Frame: bot1_left_1_F0 ----
;; Size: 16x16
BOT1_LEFT_1_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #FFFFFF)
    DB #07,#0D,#0D,#0F,#07,#00,#0F,#BD,#BD,#0F,#00,#38,#38,#E0,#E0,#E0
    DB #F8,#FE,#F3,#F1,#E0,#00,#F4,#F6,#F6,#F6,#00,#30,#3F,#3F,#03,#03

;; ---- End of Frame: bot1_left_1_F0 ----

;; ---- Sprite Frame: bot1_left_1_F1 ----
;; Size: 16x16
BOT1_LEFT_1_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #FFFFFF)
    DB #07,#0D,#0D,#0F,#07,#00,#0F,#0F,#0F,#0E,#00,#01,#01,#01,#07,#07
    DB #F8,#FF,#F3,#F0,#E0,#00,#F4,#F6,#F6,#76,#00,#80,#80,#80,#80,#80

;; ---- End of Frame: bot1_left_1_F1 ----


; Unified pattern label for sprite 1
SPRITE_1_PATTERN EQU BOT1_LEFT_1_F0_LAYER3
...
sprite_asset_frame_count:
    db 2 ; Sprite 0: bot1_right
    db 2 ; Sprite 1: bot1_left
...
; Sprite 0: bot1_right frame pointers
SPRITE_0_FRAME_PTRS:
    dw BOT1_RIGHT_0_F0_LAYER3
    dw BOT1_RIGHT_0_F1_LAYER3

; Sprite 1: bot1_left frame pointers
SPRITE_1_FRAME_PTRS:
    dw BOT1_LEFT_1_F0_LAYER3
    dw BOT1_LEFT_1_F1_LAYER3
...
SM_SpriteLayerColorTable:
    db 15 ; Sprite 0: bot1_right
    db 15 ; Sprite 1: bot1_left
...
load_sprite_patterns:
    ...
    call mapper_push_p2
    ; No active entities detected, load all sprite assets sequentially
    ; Sprite Asset 0: bot1_right (2 frames, 1 layers)
    ...
    ld bc, 64
    call FAST_LDIRVM
    ; Sprite Asset 1: bot1_left (2 frames, 1 layers)
...
load_screen_pantalla1_757845666799:
    ...
    call mapper_push_p2
    ld a, SCREEN_PANTALLA1_0_LAYOUT_BANK
    call mapper_set_bank_p2
    ...
    call mapper_push_p2
    ld a, SCREEN_PANTALLA1_0_EFFECTS_LAYOUT_BANK
    call mapper_set_bank_p2
    ...
    call mapper_push_p2
    ld a, BEHAVIOR_PANTALLA1_0_DATA_BANK
    call mapper_set_bank_p2
    ...
    or a
    jr z, .load_pantalla1_757845666799_zones_done
    call mapper_push_p2
    ld a, SCREEN_PANTALLA1_0_EFFECT_ZONE_TABLE_BANK
    call mapper_set_bank_p2
    ...
    ldir
    call mapper_pop_p2
.load_pantalla1_757845666799_zones_done:
...
gameflow_node_gf_start_1757846301679_data:
    dw gameflow_node_gf_start_1757846301679_init    ; Initialization routine address
    db ((gameflow_node_gf_start_1757846301679_init - #4000) / #2000)    ; Initialization routine bank
...
; ------------------------------------------------------------------
; gameflow_node_gf_start_1757846301679_init
...
gameflow_node_gfn_1757846312799_data:
    ...
    db ((load_world_worldmap_1757846280079 - #4000) / #2000)
...
load_world_worldmap_1757846280079:
    ...
    ld a, ((load_screen_pantalla1_757845666799 - #4000) / #2000)
    ld hl, load_screen_pantalla1_757845666799
    call mapper_call_hl_auto
...
.dispatch_world:
    ...
    jp z, check_transition_world_worldmap_1757846280079
    ret

check_transition_world_worldmap_1757846280079:
    ret
