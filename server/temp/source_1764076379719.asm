...
; Tile 13: New Tile = 16x16px (2x2 MSX chars)
...
tile_pattern_bank0:
    ...
    ; Tile 13: New Tile (16x16px = 2×2 chars = 4 MSX characters)
    ; Character layout: 2×2 grid
    ; Row 0: Char0 Char1 
    ; Row 1: Char2 Char3 
...
tile_color_bank0:
    ...
    ; Tile 13: New Tile colors (fg/bg pairs)
...
SPRITE_HERO_WIDTH     EQU 16
SPRITE_HERO_HEIGHT    EQU 16
SPRITE_HERO_FRAMES    EQU 2

;; ---- Sprite Frame: hero_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#01,#00

HERO_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
...
SPRITE_BIRD_WIDTH     EQU 16
SPRITE_BIRD_HEIGHT    EQU 16
SPRITE_BIRD_FRAMES    EQU 4

;; ---- Sprite Frame: bird_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
BIRD_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
...
;; ---- End of Frame: bird_F0 ----

;; ---- Sprite Frame: bird_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
BIRD_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#0E,#E0,#11,#10
    DB #21,#08,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: bird_F1 ----

;; ---- Sprite Frame: bird_F2 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
BIRD_F2_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#06,#C0,#09,#20,#11,#10
    DB #10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: bird_F2 ----

;; ---- Sprite Frame: bird_F3 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
BIRD_F3_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#06,#C0,#09,#20,#11,#10
    DB #10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: bird_F3 ----


; Unified pattern label for sprite 1
SPRITE_1_PATTERN EQU BIRD_F0_LAYER1
...
SPRITE_BOT2_WIDTH     EQU 16
SPRITE_BOT2_HEIGHT    EQU 16
SPRITE_BOT2_FRAMES    EQU 2

;; ---- Sprite Frame: bot2_F0 ----
;; Size: 16x16
BOT2_F0_LAYER0: ; Brush Color Index 0 (Actual Color: #FFFFFF)
...
;; ---- End of Frame: bot2_F0 ----

;; ---- Sprite Frame: bot2_F1 ----
;; Size: 16x16
BOT2_F1_LAYER0: ; Brush Color Index 0 (Actual Color: #FFFFFF)
...
;; Layer 2 (Color: #3EB847) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #74D07D) - SKIPPED (color not used or is background)
;; ---- End of Frame: bot2_F1 ----


; Unified pattern label for sprite 2
SPRITE_2_PATTERN EQU BOT2_F0_LAYER0
...
SPRITE_HERO_DEAD2_WIDTH     EQU 16
SPRITE_HERO_DEAD2_HEIGHT    EQU 16
SPRITE_HERO_DEAD2_FRAMES    EQU 16

;; ---- Sprite Frame: hero_dead2_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#01,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F0 ----

;; ---- Sprite Frame: hero_dead2_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#01,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F1 ----

;; ---- Sprite Frame: hero_dead2_F2 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F2_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F2 ----

;; ---- Sprite Frame: hero_dead2_F3 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F3_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F3 ----

;; ---- Sprite Frame: hero_dead2_F4 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F4_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#16,#00,#36,#20,#3E,#60,#1E,#40,#02,#40,#00,#00,#00,#00
    DB #00,#00,#52,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F4 ----

;; ---- Sprite Frame: hero_dead2_F5 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F5_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#16,#00,#36,#20,#3E,#60,#1E,#40,#02,#40,#00,#00,#00,#00
    DB #00,#00,#52,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F5 ----

;; ---- Sprite Frame: hero_dead2_F6 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F6_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#36,#20,#3E,#60,#1E,#40,#02,#40,#00,#00,#00,#00
    DB #00,#00,#12,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F6 ----

;; ---- Sprite Frame: hero_dead2_F7 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F7_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#36,#20,#3E,#60,#1E,#40,#02,#40,#00,#00,#00,#00
    DB #00,#00,#12,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F7 ----

;; ---- Sprite Frame: hero_dead2_F8 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F8_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#3C,#30,#3C,#20,#04,#20,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#24,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F8 ----

;; ---- Sprite Frame: hero_dead2_F9 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F9_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#3C,#30,#3C,#20,#04,#20,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#24,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F9 ----

;; ---- Sprite Frame: hero_dead2_F10 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F10_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#1C,#20,#04,#20,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F10 ----

;; ---- Sprite Frame: hero_dead2_F11 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F11_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#1C,#20,#04,#20,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F11 ----

;; ---- Sprite Frame: hero_dead2_F12 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F12_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#08,#10,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#08,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F12 ----

;; ---- Sprite Frame: hero_dead2_F13 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F13_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#08,#10,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#08,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F13 ----

;; ---- Sprite Frame: hero_dead2_F14 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_DEAD2_F14_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#08,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_dead2_F14 ----

;; ---- Sprite Frame: hero_dead2_F15 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
;; Layer 1 (Color: #FFFFFF) - SKIPPED (color not used or is background)
;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; NO ACTIVE LAYERS EXPORTED for hero_dead2_F15 - Frame might be empty or only contain the background color.
;; ---- End of Frame: hero_dead2_F15 ----


; Unified pattern label for sprite 3
SPRITE_3_PATTERN EQU HERO_DEAD2_F0_LAYER1
...
SPRITE_NEW_SPRITE_WIDTH     EQU 32
SPRITE_NEW_SPRITE_HEIGHT    EQU 16
SPRITE_NEW_SPRITE_FRAMES    EQU 2

;; ---- Sprite Frame: New Sprite_F0 ----
;; Size: 32x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
NEW_SPRITE_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: New Sprite_F0 ----

;; ---- Sprite Frame: New Sprite_F1 ----
;; Size: 32x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
NEW_SPRITE_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#7F,#FF,#FF,#FE
...
;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: New Sprite_F1 ----


; Unified pattern label for sprite 4
SPRITE_4_PATTERN EQU NEW_SPRITE_F0_LAYER1
...
SPRITE_GEMA1_WIDTH     EQU 16
SPRITE_GEMA1_HEIGHT    EQU 16
SPRITE_GEMA1_FRAMES    EQU 2

;; ---- Sprite Frame: gema1_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
;; Layer 1 (Color: #FFFFFF) - SKIPPED (color not used or is background)
GEMA1_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#00,#00,#00,#80,#01,#C0,#03,#E0,#06,#F0,#05,#D0,#06,#D0
    DB #07,#90,#07,#90,#03,#20,#01,#40,#00,#80,#00,#00,#00,#00,#00,#00

;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: gema1_F0 ----

;; ---- Sprite Frame: gema1_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
;; Layer 1 (Color: #FFFFFF) - SKIPPED (color not used or is background)
GEMA1_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#10,#04,#08,#88,#01,#C0,#03,#E0,#06,#F0,#05,#D0,#66,#D3
    DB #07,#90,#07,#90,#03,#20,#01,#40,#08,#88,#10,#04,#00,#00,#00,#00

;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: gema1_F1 ----


; Unified pattern label for sprite 5
SPRITE_5_PATTERN EQU GEMA1_F0_LAYER2
...
SPRITE_BOX_WIDTH     EQU 16
SPRITE_BOX_HEIGHT    EQU 16
SPRITE_BOX_FRAMES    EQU 3

;; ---- Sprite Frame: Box_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
BOX_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #D4C154)
...
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
BOX_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #D4C154)
...
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
BOX_F2_LAYER1: ; Brush Color Index 1 (Actual Color: #D4C154)
...
SPRITE_6_PATTERN EQU BOX_F0_LAYER1
...
SPRITE_FIRE_WIDTH     EQU 16
SPRITE_FIRE_HEIGHT    EQU 16
SPRITE_FIRE_FRAMES    EQU 2

;; ---- Sprite Frame: fire_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
FIRE_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#01,#C0,#00,#80
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: fire_F0 ----

;; ---- Sprite Frame: fire_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
FIRE_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#40,#00,#80,#01,#40
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: fire_F1 ----


; Unified pattern label for sprite 7
SPRITE_7_PATTERN EQU FIRE_F0_LAYER1
...
SPRITE_FIRE2_WIDTH     EQU 16
SPRITE_FIRE2_HEIGHT    EQU 16
SPRITE_FIRE2_FRAMES    EQU 5

;; ---- Sprite Frame: fire2_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
FIRE2_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00,#40
    DB #00,#00,#00,#40,#00,#00,#00,#40,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: fire2_F0 ----

;; ---- Sprite Frame: fire2_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
FIRE2_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#10,#00,#00,#00,#10,#00,#40
    DB #00,#10,#00,#40,#00,#10,#00,#00,#00,#10,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: fire2_F1 ----

;; ---- Sprite Frame: fire2_F2 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
FIRE2_F2_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#04,#00,#00,#00,#10,#00,#00,#00,#14,#00,#20
    DB #00,#50,#00,#24,#00,#10,#00,#00,#00,#14,#00,#00,#00,#04,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: fire2_F2 ----

;; ---- Sprite Frame: fire2_F3 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
FIRE2_F3_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#04,#00,#00,#00,#10,#00,#00,#00,#04,#00,#00
    DB #00,#00,#00,#04,#00,#00,#00,#00,#00,#14,#00,#00,#00,#04,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: fire2_F3 ----

;; ---- Sprite Frame: fire2_F4 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
FIRE2_F4_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#04,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#04,#00,#00,#00,#00,#00,#01,#00,#00

;; Layer 2 (Color: #FF0000) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: fire2_F4 ----


; Unified pattern label for sprite 8
SPRITE_8_PATTERN EQU FIRE2_F0_LAYER1
...
SPRITE_NEW_SPRITE_WIDTH     EQU 16
SPRITE_NEW_SPRITE_HEIGHT    EQU 16
SPRITE_NEW_SPRITE_FRAMES    EQU 1

;; ---- Sprite Frame: New Sprite_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
NEW_SPRITE_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #CCCCCC)
...
NEW_SPRITE_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #7D76FC)
...
SPRITE_9_PATTERN EQU NEW_SPRITE_F0_LAYER1
...
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
;; Layer 1 (Color: #FFFFFF) - SKIPPED (color not used or is background)
NEW_SPRITE_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
...
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
;; Layer 1 (Color: #FFFFFF) - SKIPPED (color not used or is background)
NEW_SPRITE_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
...
SPRITE_10_PATTERN EQU NEW_SPRITE_F0_LAYER2
...
SPRITE_HERO_JUMP_WIDTH     EQU 16
SPRITE_HERO_JUMP_HEIGHT    EQU 16
SPRITE_HERO_JUMP_FRAMES    EQU 1

;; ---- Sprite Frame: hero_jump_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_JUMP_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80
    DB #00,#00,#29,#00,#00,#00,#00,#00,#AA,#28,#00,#02,#00,#00,#00,#00

HERO_JUMP_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #03,#C0,#1F,#E0,#00,#E0,#00,#95,#00,#2A,#00,#01,#00,#01,#00,#00
    DB #03,#C0,#16,#40,#03,#E0,#87,#F0,#55,#D6,#00,#00,#00,#02,#00,#00

;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_jump_F0 ----


; Unified pattern label for sprite 11
SPRITE_11_PATTERN EQU HERO_JUMP_F0_LAYER1
...
SPRITE_HERO_GROUND_WIDTH     EQU 16
SPRITE_HERO_GROUND_HEIGHT    EQU 16
SPRITE_HERO_GROUND_FRAMES    EQU 3

;; ---- Sprite Frame: hero_ground_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_GROUND_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#20,#84,#19,#18

HERO_GROUND_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #1F,#E0,#00,#E0,#00,#AC,#00,#3A,#00,#01,#00,#00,#00,#00,#03,#C0
    DB #16,#40,#03,#C0,#03,#E0,#07,#F0,#00,#00,#00,#80,#00,#00,#02,#80

;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_ground_F0 ----

;; ---- Sprite Frame: hero_ground_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_GROUND_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80
    DB #00,#00,#29,#00,#00,#00,#40,#02,#A0,#05,#40,#82,#00,#00,#01,#80

HERO_GROUND_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #00,#00,#1F,#E0,#00,#E0,#00,#AC,#00,#3B,#00,#00,#00,#00,#00,#00
    DB #03,#C0,#16,#40,#03,#C0,#03,#E0,#07,#F0,#00,#00,#00,#80,#02,#00

;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_ground_F1 ----

;; ---- Sprite Frame: hero_ground_F2 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_GROUND_F2_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80
    DB #01,#80,#00,#00,#29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#01,#00

HERO_GROUND_F2_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #00,#00,#00,#00,#1F,#E0,#00,#E0,#00,#AD,#00,#3A,#00,#00,#00,#00
    DB #00,#00,#03,#C0,#16,#40,#03,#C0,#03,#E0,#07,#F0,#00,#00,#02,#80

;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_ground_F2 ----


; Unified pattern label for sprite 12
SPRITE_12_PATTERN EQU HERO_GROUND_F0_LAYER1
...
SPRITE_HERO_FRAME_0_FRAME_1_WIDTH     EQU 16
SPRITE_HERO_FRAME_0_FRAME_1_HEIGHT    EQU 16
SPRITE_HERO_FRAME_0_FRAME_1_FRAMES    EQU 10

;; ---- Sprite Frame: hero_frame_0_frame_1_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
...
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F0 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#03,#00,#13,#40,#1A,#C0,#0C,#80,#01,#80,#00,#00
    DB #28,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#01,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F1 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F2 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F2_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#06,#00,#0A,#00,#1B,#00,#1B,#C0,#09,#00,#01,#00,#00,#00
    DB #09,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#01,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F2 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F3 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F3_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#03,#00,#08,#00,#13,#00,#07,#C0,#02,#00,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#00,#01,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F3 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F4 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F4_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#07,#00,#0B,#00,#19,#00,#02,#80,#0B,#00,#01,#80,#00,#00
    DB #09,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F4 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F5 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F5_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#04,#00,#00,#00,#02,#00,#02,#40,#00,#80,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#00,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F5 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F6 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F6_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#04,#00,#01,#00,#00,#00,#10,#40,#06,#00,#00,#80,#00,#00
    DB #28,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F6 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F7 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F7_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#02,#00,#01,#80,#00,#00
    DB #09,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F7 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F8 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_FRAME_0_FRAME_1_F8_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#40,#00,#00,#00,#80,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#00,#00,#00

;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_frame_0_frame_1_F8 ----

;; ---- Sprite Frame: hero_frame_0_frame_1_F9 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
;; Layer 1 (Color: #FFFFFF) - SKIPPED (color not used or is background)
;; Layer 2 (Color: #D4524D) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #00FF00) - SKIPPED (color not used or is background)
;; NO ACTIVE LAYERS EXPORTED for hero_frame_0_frame_1_F9 - Frame might be empty or only contain the background color.
;; ---- End of Frame: hero_frame_0_frame_1_F9 ----


; Unified pattern label for sprite 13
SPRITE_13_PATTERN EQU HERO_FRAME_0_FRAME_1_F0_LAYER1
...
SPRITE_DUST_SPR_WIDTH     EQU 16
SPRITE_DUST_SPR_HEIGHT    EQU 16
SPRITE_DUST_SPR_FRAMES    EQU 6

;; ---- Sprite Frame: dust_spr_F0 ----
;; Size: 16x16
DUST_SPR_F0_LAYER0: ; Brush Color Index 0 (Actual Color: #CCCCCC)
...
;; ---- End of Frame: dust_spr_F0 ----

;; ---- Sprite Frame: dust_spr_F1 ----
;; Size: 16x16
DUST_SPR_F1_LAYER0: ; Brush Color Index 0 (Actual Color: #CCCCCC)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00
    DB #C0,#00,#94,#03,#08,#03,#C0,#03,#E0,#01,#40,#00,#00,#00,#06,#18

DUST_SPR_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #08,#01,#08,#00,#40,#00,#20,#00,#00,#00,#00,#00,#02,#08,#01,#04

;; Layer 2 (Color: #E6CE80) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #FF7978) - SKIPPED (color not used or is background)
;; ---- End of Frame: dust_spr_F1 ----

;; ---- Sprite Frame: dust_spr_F2 ----
;; Size: 16x16
DUST_SPR_F2_LAYER0: ; Brush Color Index 0 (Actual Color: #CCCCCC)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00
    DB #C0,#00,#80,#01,#00,#01,#C0,#00,#E0,#00,#40,#00,#00,#00,#02,#18

DUST_SPR_F2_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#01,#00,#00,#40,#00,#20,#00,#00,#00,#00,#00,#00,#00,#01,#00

;; Layer 2 (Color: #E6CE80) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #FF7978) - SKIPPED (color not used or is background)
;; ---- End of Frame: dust_spr_F2 ----

;; ---- Sprite Frame: dust_spr_F3 ----
;; Size: 16x16
DUST_SPR_F3_LAYER0: ; Brush Color Index 0 (Actual Color: #CCCCCC)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00
    DB #C0,#00,#80,#01,#00,#01,#C0,#00,#E0,#00,#40,#00,#00,#00,#02,#18

DUST_SPR_F3_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#01,#00,#00,#40,#00,#20,#00,#00,#00,#00,#00,#00,#00,#01,#00

;; Layer 2 (Color: #E6CE80) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #FF7978) - SKIPPED (color not used or is background)
;; ---- End of Frame: dust_spr_F3 ----

;; ---- Sprite Frame: dust_spr_F4 ----
;; Size: 16x16
DUST_SPR_F4_LAYER0: ; Brush Color Index 0 (Actual Color: #CCCCCC)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00
    DB #80,#00,#00,#01,#00,#01,#C0,#00,#40,#00,#00,#00,#00,#00,#02,#18

DUST_SPR_F4_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#01,#00,#00,#40,#00,#20,#00,#00,#00,#00,#00,#00,#00,#01,#00

;; Layer 2 (Color: #E6CE80) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #FF7978) - SKIPPED (color not used or is background)
;; ---- End of Frame: dust_spr_F4 ----

;; ---- Sprite Frame: dust_spr_F5 ----
;; Size: 16x16
DUST_SPR_F5_LAYER0: ; Brush Color Index 0 (Actual Color: #CCCCCC)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00
...
;; Layer 2 (Color: #E6CE80) - SKIPPED (color not used or is background)
;; Layer 3 (Color: #FF7978) - SKIPPED (color not used or is background)
;; ---- End of Frame: dust_spr_F5 ----


; Unified pattern label for sprite 14
SPRITE_14_PATTERN EQU DUST_SPR_F0_LAYER0
...
SPRITE_HERO_GUN_WIDTH     EQU 16
SPRITE_HERO_GUN_HEIGHT    EQU 16
SPRITE_HERO_GUN_FRAMES    EQU 2

;; ---- Sprite Frame: hero_gun_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_GUN_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80,#00,#00
    DB #29,#00,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#01,#00

HERO_GUN_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #1F,#E0,#00,#E0,#00,#AC,#00,#3A,#00,#01,#00,#00,#00,#00,#03,#C0
    DB #16,#40,#03,#C0,#03,#E0,#07,#F0,#00,#00,#00,#80,#00,#00,#02,#80

HERO_GUN_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #5455ED)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#E0,#00
    DB #40,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: hero_gun_F0 ----

;; ---- Sprite Frame: hero_gun_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_GUN_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#0F,#00,#0B,#00,#1B,#40,#1F,#C0,#0F,#80,#01,#80
    DB #00,#00,#29,#00,#00,#00,#00,#00,#0A,#28,#00,#04,#08,#00,#10,#00

HERO_GUN_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #03,#C0,#1F,#E0,#00,#E1,#00,#95,#00,#2A,#00,#00,#00,#00,#00,#00
    DB #03,#C0,#16,#40,#03,#E0,#07,#F0,#05,#D4,#08,#00,#00,#04,#28,#00

HERO_GUN_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #5455ED)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #E0,#00,#40,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: hero_gun_F1 ----


; Unified pattern label for sprite 15
SPRITE_15_PATTERN EQU HERO_GUN_F0_LAYER1
...
SPRITE_HERO_COLLECTOR_WIDTH     EQU 16
SPRITE_HERO_COLLECTOR_HEIGHT    EQU 16
SPRITE_HERO_COLLECTOR_FRAMES    EQU 2

;; ---- Sprite Frame: hero_collector_F0 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_COLLECTOR_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#C0,#0F,#00,#0B,#40,#1B,#40,#1F,#40,#0F,#40,#21,#44,#00,#40
    DB #00,#C0,#00,#00,#00,#00,#00,#00,#00,#80,#00,#00,#00,#80,#01,#00

HERO_COLLECTOR_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #1F,#20,#00,#E0,#00,#AC,#00,#3A,#00,#01,#00,#20,#00,#20,#03,#00
    DB #03,#00,#03,#C0,#03,#E0,#07,#F0,#00,#00,#00,#80,#00,#00,#02,#80

;; Layer 3 (Color: #5455ED) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_collector_F0 ----

;; ---- Sprite Frame: hero_collector_F1 ----
;; Size: 16x16
;; Layer 0 (Color: #000000) - SKIPPED (color not used or is background)
HERO_COLLECTOR_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #01,#C0,#00,#C0,#0F,#00,#0B,#40,#1B,#40,#1F,#40,#0F,#40,#01,#40
    DB #80,#40,#00,#C1,#00,#00,#00,#00,#28,#00,#00,#2A,#20,#00,#00,#00

HERO_COLLECTOR_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #06,#00,#1F,#20,#00,#E0,#00,#AC,#00,#3A,#00,#01,#00,#20,#00,#20
    DB #03,#00,#03,#00,#03,#C0,#03,#E0,#17,#F0,#20,#14,#00,#02,#60,#00

;; Layer 3 (Color: #5455ED) - SKIPPED (color not used or is background)
;; ---- End of Frame: hero_collector_F1 ----


; Unified pattern label for sprite 16
SPRITE_16_PATTERN EQU HERO_COLLECTOR_F0_LAYER1
...
SPRITE_ID_HERO    EQU 0      ; hero
SPRITE_ID_BIRD    EQU 1      ; bird
SPRITE_ID_BOT2    EQU 2      ; bot2
SPRITE_ID_HERO_DEAD2    EQU 3      ; hero_dead2
SPRITE_ID_NEW_SPRITE    EQU 4      ; New Sprite
SPRITE_ID_GEMA1    EQU 5      ; gema1
SPRITE_ID_BOX    EQU 6      ; Box
SPRITE_ID_FIRE    EQU 7      ; fire
SPRITE_ID_FIRE2    EQU 8      ; fire2
SPRITE_ID_NEW_SPRITE    EQU 9      ; New Sprite
SPRITE_ID_NEW_SPRITE    EQU 10      ; New Sprite
SPRITE_ID_HERO_JUMP    EQU 11      ; hero_jump
SPRITE_ID_HERO_GROUND    EQU 12      ; hero_ground
SPRITE_ID_HERO_FRAME_0_FRAME_1    EQU 13      ; hero_frame_0_frame_1
SPRITE_ID_DUST_SPR    EQU 14      ; dust_spr
SPRITE_ID_HERO_GUN    EQU 15      ; hero_gun
SPRITE_ID_HERO_COLLECTOR    EQU 16      ; hero_collector
