...
; Estimated payload bytes: 130388
; Estimated banks used: 16
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (2177 bytes)
; BANK 00 @#08E1 : colors.asm (1947 bytes)
; BANK 00 @#107C : components.asm (22 bytes)
; BANK 00 @#1092 : entities.asm (3950 bytes)
; BANK 01 @#0000 : entities.asm (3886 bytes)
; BANK 01 @#0F2E : worlds.asm (4306 bytes)
; BANK 02 @#0000 : worlds.asm (3722 bytes)
; BANK 02 @#0E8A : screens.asm part 1/6 (4470 bytes)
...
; BANK 07 @#0000 : screens.asm part 6/6 (4655 bytes)
; BANK 07 @#122F : sprites.asm part 1/2 (3537 bytes)
; BANK 08 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 09 @#0000 : sprites.asm part 3/2 (874 bytes)
; BANK 09 @#036A : font.asm (3487 bytes)
; BANK 09 @#1109 : hud.asm (3831 bytes)
; BANK 10 @#0000 : hud.asm (76 bytes)
; BANK 10 @#004C : menus.asm (454 bytes)
; BANK 10 @#0212 : sound.asm (7247 bytes)
; BANK 10 @#1E61 : scroll.asm (415 bytes)
; BANK 11 @#0000 : scroll.asm (1938 bytes)
; BANK 11 @#0792 : animtiles.asm (6254 bytes)
; BANK 12 @#0000 : animtiles.asm (612 bytes)
; BANK 12 @#0264 : statemachine.asm part 1/3 (7580 bytes)
; BANK 13 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : statemachine.asm part 3/3 (1889 bytes)
; BANK 14 @#0761 : gameflow.asm part 1/2 (6303 bytes)
; BANK 15 @#0000 : gameflow.asm part 2/2 (7508 bytes)
...
; Tile 19: clock = 8x8px (1x1 MSX chars)
; Tile 20: tile_hud = 8x8px (1x1 MSX chars)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (256 -> 220 bytes)
    ...
    DB #4F,#1A,#F8,#14,#29,#66,#FF,#BF,#DF,#0D,#7E,#3C,#18,#3C,#42,#81
    DB #B1,#89,#81,#42,#3C,#00,#9B,#80,#00,#55,#55,#80
load_pattern_bank0:
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (256 -> 88 bytes)
    ...
    DB #FE,#8F,#A1,#8B,#80,#F0,#FB,#8D,#FC,#A5,#FF,#F1,#EE,#D0,#5C,#7F
    DB #D7,#D0,#E9,#FF,#A1,#75,#55,#58
load_color_bank0:
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 177 bytes)
    DB #95,#84,#68,#FF,#5B,#9D,#AF,#FB,#9E,#FE,#4A,#84,#55,#AB,#80,#81
    DB #8F,#FC,#FB,#C6,#FC,#23,#88,#92,#EF,#F0,#82,#7B,#C0,#FC,#88,#82
    DB #83,#BF,#80,#EE,#C5,#B8,#F5,#C0,#3A,#81,#86,#15,#BF,#81,#05,#00
    DB #88,#89,#8A,#56,#24,#83,#83,#5F,#85,#BF,#91,#80,#F8,#91,#00,#E7
    DB #CB,#8A,#8B,#8C,#EE,#87,#F8,#80,#47,#A5,#51,#8C,#C8,#C6,#6F,#8E
    DB #FF,#EF,#F0,#93,#FF,#B3,#F4,#F8,#0E,#38,#5B,#88,#FC,#FE,#2C,#33
    DB #C0,#52,#90,#83,#3D,#80,#6D,#89,#D6,#65,#C8,#79,#C0,#0E,#D1,#80
    DB #8B,#E0,#B4,#D6,#80,#28,#83,#12,#19,#9C,#98,#99,#9A,#82,#7D,#5C
    DB #7E,#FE,#9E,#9B,#80,#26,#88,#92,#92,#FF,#F8,#C0,#5E,#FA,#EA,#80
    DB #85,#D3,#B8,#D3,#B0,#3D,#C0,#69,#80,#F7,#80,#F7,#30,#D0,#7D,#FC
    DB #BF,#82,#FB,#80,#0C,#BE,#44,#B5,#FC,#4B,#80,#E3,#FB,#D0,#55,#55
    DB #80
