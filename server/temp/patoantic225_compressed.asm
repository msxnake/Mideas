...
; Estimated payload bytes: 126668
; Estimated banks used: 16
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (1574 bytes)
; BANK 00 @#0626 : colors.asm (1355 bytes)
; BANK 00 @#0B71 : components.asm (22 bytes)
; BANK 00 @#0B87 : entities.asm (5241 bytes)
; BANK 01 @#0000 : entities.asm (2187 bytes)
; BANK 01 @#088B : worlds.asm (6005 bytes)
; BANK 02 @#0000 : worlds.asm (1994 bytes)
; BANK 02 @#07CA : screens.asm part 1/6 (6198 bytes)
...
; BANK 07 @#0000 : screens.asm part 6/6 (2810 bytes)
; BANK 07 @#0AFA : sprites.asm part 1/2 (5382 bytes)
; BANK 08 @#0000 : sprites.asm part 2/2 (5629 bytes)
; BANK 08 @#15FD : font.asm (2563 bytes)
; BANK 09 @#0000 : font.asm (984 bytes)
; BANK 09 @#03D8 : hud.asm (3907 bytes)
; BANK 09 @#131B : menus.asm (454 bytes)
; BANK 09 @#14E1 : sound.asm (2847 bytes)
; BANK 10 @#0000 : sound.asm (4400 bytes)
; BANK 10 @#1130 : scroll.asm (2353 bytes)
; BANK 10 @#1A61 : animtiles.asm (1439 bytes)
; BANK 11 @#0000 : animtiles.asm (5420 bytes)
; BANK 11 @#152C : statemachine.asm part 1/3 (2772 bytes)
; BANK 12 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : statemachine.asm part 3/3 (6697 bytes)
; BANK 13 @#1A29 : gameflow.asm part 1/2 (1495 bytes)
; BANK 14 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 15 @#0000 : gameflow.asm part 3/2 (3788 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (248 -> 215 bytes)
    ...
    DB #4F,#1A,#F8,#14,#28,#66,#FF,#BF,#DF,#D9,#7E,#3C,#95,#75,#42,#81
    DB #B1,#89,#81,#42,#3C,#55,#58
load_pattern_bank0:
    ...
    ld bc, 248    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 248    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (248 -> 86 bytes)
...
load_color_bank0:
    ...
    ld bc, 248     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
