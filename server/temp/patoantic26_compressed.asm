...
; BANK 03 @#0000 : sprites.asm (4769 bytes)
; BANK 03 @#12A1 : font.asm (3423 bytes)
; BANK 04 @#0000 : font.asm (124 bytes)
; BANK 04 @#007C : hud.asm (3836 bytes)
; BANK 04 @#0F78 : menus.asm (444 bytes)
; BANK 04 @#1134 : sound.asm (3184 bytes)
; BANK 04 @#1DA4 : scroll.asm (604 bytes)
; BANK 05 @#0000 : scroll.asm (1749 bytes)
; BANK 05 @#06D5 : animtiles.asm (3349 bytes)
; BANK 05 @#13EA : particles.asm (3094 bytes)
; BANK 06 @#0000 : particles.asm (1869 bytes)
; BANK 06 @#074D : statemachine.asm part 1/3 (6323 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 4/3 (278 bytes)
; BANK 09 @#0116 : gameflow.asm part 1/3 (7914 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (611 bytes)
...
SPRITE_NINA_LEFT_5_WIDTH     EQU 16
SPRITE_NINA_LEFT_5_HEIGHT    EQU 16
SPRITE_NINA_LEFT_5_FRAMES    EQU 2

;; ---- Sprite Frame: nina_left_5_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_5_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_5_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_5_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_5_F1_DATA (32 bytes)
SPRITE_5_PATTERN EQU NINA_LEFT_5_F0_LAYER0
SPRITE_5_PATTERN_BANK EQU ((SPRITE_5_PATTERN - #4000) / #2000)

; Sprite Asset 6: anec_left
;; Sprite: anec_left
;; Total Frames: 2
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_ANEC_LEFT_6_WIDTH     EQU 16
SPRITE_ANEC_LEFT_6_HEIGHT    EQU 16
SPRITE_ANEC_LEFT_6_FRAMES    EQU 2

;; ---- Sprite Frame: anec_left_6_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_6_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_6_F1_DATA (32 bytes)
SPRITE_6_PATTERN EQU ANEC_LEFT_6_F0_LAYER1
SPRITE_6_PATTERN_BANK EQU ((SPRITE_6_PATTERN - #4000) / #2000)

; Sprite Asset 7: nina_right
;; Sprite: nina_right
;; Total Frames: 2
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_NINA_RIGHT_7_WIDTH     EQU 16
SPRITE_NINA_RIGHT_7_HEIGHT    EQU 16
SPRITE_NINA_RIGHT_7_FRAMES    EQU 2

;; ---- Sprite Frame: nina_right_7_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_7_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_7_F1_DATA (32 bytes)
SPRITE_7_PATTERN EQU NINA_RIGHT_7_F0_LAYER0
...
sprite_asset_frame_count:
    ...
    db 2 ; Sprite 5: nina_left
    db 2 ; Sprite 6: anec_left
    db 2 ; Sprite 7: nina_right
...
; Sprite 5: nina_left frame pointers
SPRITE_5_FRAME_PTRS:
    dw NINA_LEFT_5_F0_LAYER0
    dw NINA_LEFT_5_F1_LAYER0

; Sprite 6: anec_left frame pointers
SPRITE_6_FRAME_PTRS:
    dw ANEC_LEFT_6_F0_LAYER1
    dw ANEC_LEFT_6_F1_LAYER1

; Sprite 7: nina_right frame pointers
SPRITE_7_FRAME_PTRS:
    dw NINA_RIGHT_7_F0_LAYER0
    dw NINA_RIGHT_7_F1_LAYER0
...
ZX0_SPRITE_FRAME_BOLA_DEAD_4_F4_DATA:
    ...
    DB #95,#00,#75,#55,#58
ZX0_SPRITE_FRAME_NINA_LEFT_5_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LEFT_5_F0 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_NINA_LEFT_5_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LEFT_5_F1 (64 -> 56 bytes)
...
ZX0_SPRITE_FRAME_ANEC_LEFT_6_F0_DATA:
    ; ZX0 compressed sprite frame ANEC_LEFT_6_F0 (64 -> 59 bytes)
...
ZX0_SPRITE_FRAME_ANEC_LEFT_6_F1_DATA:
    ; ZX0 compressed sprite frame ANEC_LEFT_6_F1 (64 -> 58 bytes)
...
ZX0_SPRITE_FRAME_NINA_RIGHT_7_F0_DATA:
    ; ZX0 compressed sprite frame NINA_RIGHT_7_F0 (64 -> 50 bytes)
    ...
    DB #55,#56
ZX0_SPRITE_FRAME_NINA_RIGHT_7_F1_DATA:
    ; ZX0 compressed sprite frame NINA_RIGHT_7_F1 (64 -> 55 bytes)
...
; Frame group: NINA_LEFT_5_F0
NINA_LEFT_5_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LEFT_5_F0_DATA
; Frame group: NINA_LEFT_5_F1
NINA_LEFT_5_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LEFT_5_F1_DATA
; Frame group: ANEC_LEFT_6_F0
ANEC_LEFT_6_F0_LAYER1 EQU ZX0_SPRITE_FRAME_ANEC_LEFT_6_F0_DATA
; Frame group: ANEC_LEFT_6_F1
ANEC_LEFT_6_F1_LAYER1 EQU ZX0_SPRITE_FRAME_ANEC_LEFT_6_F1_DATA
; Frame group: NINA_RIGHT_7_F0
NINA_RIGHT_7_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_RIGHT_7_F0_DATA
; Frame group: NINA_RIGHT_7_F1
NINA_RIGHT_7_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_RIGHT_7_F1_DATA
