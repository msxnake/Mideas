...
; ==================================================================
; FAST VRAM ACCESS ROUTINES (NO BIOS - DIRECT PORT ACCESS)
; ==================================================================

; Fast block transfer RAM -> VRAM (replaces BIOS LDIRVM)
...
FAST_LDIRVM:
    ...
    ld a, e                    ; Low byte of VRAM address
    out (#99), a               ; Write to VDP address port
    ld a, d                    ; High byte of VRAM address
...
.loop:
    ...
    out (#98), a               ; Write to VRAM data port
...
; Fast write single byte to VRAM (replaces BIOS WRTVRM)
; Input: A = data byte
;        HL = VRAM address
; Destroys: AF
FAST_WRTVRM:
...
; Fast write to VDP register (replaces BIOS WRTVDP)
; Input: B = register number
;        C = value
; Destroys: AF
FAST_WRTVDP:
    ld a, c                    ; Value to write
    out (#99), a               ; Write value first
    ld a, b                    ; Register number
    or #80                     ; Set register write bit (bit 7)
    out (#99), a               ; Write register number
    ret
