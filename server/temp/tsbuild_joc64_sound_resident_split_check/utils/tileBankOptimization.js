...
exports.resolveTileAssignmentLabel = exports.buildTileCharSignature = exports.getTileCharPatternColorBytes = exports.resolveTileAssignmentCharCode = exports.getTileAssignmentCharCodes = exports.getTileLocalCharIndex = exports.getTileCharDimensions = void 0;
...
const getTileAssignmentCharCodes = (assignment, tile) => {
    ...
    if (Array.isArray(assignment.charMap) && assignment.charMap.length > 0) {
        return Array.from(new Set(assignment.charMap
            ...
            .filter(code => Number.isFinite(code) && code >= 0 && code <= 255)));
    }
