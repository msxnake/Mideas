; ==================================================================
; EPIC2PATTERNS_FIXED - UNIFIED FILE
...
; BANK 02 @#0000 : sound.asm part 3/2 (2253 bytes)
; BANK 02 @#08CD : scroll.asm (2407 bytes)
; BANK 02 @#1234 : animtiles.asm (2549 bytes)
; BANK 02 @#1C29 : bosses.asm (983 bytes)
; BANK 03 @#0000 : bosses.asm (4799 bytes)
; BANK 03 @#12BF : statemachine.asm (5 bytes)
; BANK 03 @#12C4 : gameflow.asm (3388 bytes)
; BANK 04 @#0000 : gameflow.asm (1512 bytes)
...
; Flow: Start → Music (gf_epic_music)
; ==================================================================
...
music_track_ptr_table:
    DW music_track_0_Epic_Piano_March_data

; ------------------------------------------------------------------
; Tracker Song 0: Epic Piano March
; ------------------------------------------------------------------
music_track_0_Epic_Piano_March_data:
    DB #06
    DB #02
    DB #00
    DB #01
    DB #02
    DW music_track_0_Epic_Piano_March_order_table
    DW music_track_0_Epic_Piano_March_pattern_table
    DW music_track_0_Epic_Piano_March_instrument_ptr_table
    DW music_track_0_Epic_Piano_March_ornament_ptr_table
    DW #00D2
    DB #10

music_track_0_Epic_Piano_March_order_table:
    DB #00,#01

music_track_0_Epic_Piano_March_pattern_table:
    DW music_track_0_Epic_Piano_March_pattern_0_rows
    DB #40
    DW music_track_0_Epic_Piano_March_pattern_1_rows
    DB #40

music_track_0_Epic_Piano_March_instrument_ptr_table:
    DW 0
    DW music_track_0_Epic_Piano_March_inst_1
    DW 0
    DW 0
    DW 0
    DW music_track_0_Epic_Piano_March_inst_5
    DW music_track_0_Epic_Piano_March_inst_6
    DW music_track_0_Epic_Piano_March_inst_7
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_Epic_Piano_March_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_Epic_Piano_March_pattern_0_rows:
    DB #34,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
...
music_track_0_Epic_Piano_March_pattern_1_rows:
    DB #3B,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #4A,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    ...
    DB #43,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #4C,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #4A,#01,#FF,#0F,#18,#05,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#1E,#07,#FF,#0C,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#1A,#06,#FF,#0E,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1E,#07,#FF,#0A,#FF,#FF,#FF,#FF
...
music_track_0_Epic_Piano_March_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_Epic_Piano_March_inst_1_vol_env
    DB #0B
    DB #FF
    DW music_track_0_Epic_Piano_March_inst_1_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_Epic_Piano_March_inst_1_vol_env:
    DB #0F,#0E,#0D,#0B,#09,#07,#05,#03,#02,#01,#00
music_track_0_Epic_Piano_March_inst_1_tone_env:
    DB #00

music_track_0_Epic_Piano_March_inst_5:
    DB #03
    DB #0F
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_Epic_Piano_March_inst_5_vol_env
    DB #06
    DB #FF
    DW music_track_0_Epic_Piano_March_inst_5_tone_env
    DB #04
    DB #FF
    DW music_track_0_Epic_Piano_March_inst_5_noise_env
    DB #04
    DB #FF
music_track_0_Epic_Piano_March_inst_5_vol_env:
    DB #0F,#0E,#0C,#09,#05,#00
music_track_0_Epic_Piano_March_inst_5_tone_env:
    DB #E4,#EE,#F8,#00
music_track_0_Epic_Piano_March_inst_5_noise_env:
    DB #02,#04,#08,#10

music_track_0_Epic_Piano_March_inst_6:
    DB #03
    DB #0E
    DB #00
    DB #07
    DW #00D2
    DW music_track_0_Epic_Piano_March_inst_6_vol_env
    DB #06
    DB #FF
    DW music_track_0_Epic_Piano_March_inst_6_tone_env
    DB #01
    DB #FF
    DW music_track_0_Epic_Piano_March_inst_6_noise_env
    DB #05
    DB #FF
music_track_0_Epic_Piano_March_inst_6_vol_env:
    DB #0E,#0D,#0A,#07,#03,#00
music_track_0_Epic_Piano_March_inst_6_tone_env:
    DB #00
music_track_0_Epic_Piano_March_inst_6_noise_env:
    DB #06,#0A,#0E,#14,#1C

music_track_0_Epic_Piano_March_inst_7:
    DB #02
    DB #0B
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_Epic_Piano_March_inst_7_vol_env
    DB #04
    DB #FF
    DW music_track_0_Epic_Piano_March_inst_7_tone_env
    DB #01
    DB #FF
    DW music_track_0_Epic_Piano_March_inst_7_noise_env
    DB #04
    DB #FF
music_track_0_Epic_Piano_March_inst_7_vol_env:
    DB #0B,#08,#04,#00
music_track_0_Epic_Piano_March_inst_7_tone_env:
    DB #00
music_track_0_Epic_Piano_March_inst_7_noise_env:
    DB #02,#03,#04,#06
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_epic_start
...
; Node: Start - "gf_epic_start"
gameflow_node_gf_epic_start:
    db NODE_TYPE_START
    dw gameflow_node_gf_epic_start_data
    dw gameflow_node_gf_epic_start_conn

gameflow_node_gf_epic_start_data:
    dw gameflow_node_gf_epic_start_init    ; Initialization routine address
    db ((gameflow_node_gf_epic_start_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_epic_start_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_epic_music
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_epic_start_init
...
; Node: Music - "gf_epic_music"
gameflow_node_gf_epic_music:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gf_epic_music_data
    dw gameflow_node_gf_epic_music_conn

gameflow_node_gf_epic_music_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gf_epic_music_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_epic_end
    db CONNECTION_END

; Node: End - "gf_epic_end"
gameflow_node_gf_epic_end:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gf_epic_end_conn

gameflow_node_gf_epic_end_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
