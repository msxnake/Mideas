...
; BANK 04 @#0000 : sprites.asm part 3/2 (65 bytes)
; BANK 04 @#0041 : font.asm (3547 bytes)
; BANK 04 @#0E1C : hud.asm (3836 bytes)
; BANK 04 @#1D18 : menus.asm (444 bytes)
; BANK 04 @#1ED4 : sound.asm (300 bytes)
; BANK 05 @#0000 : sound.asm (2884 bytes)
; BANK 05 @#0B44 : scroll.asm (2353 bytes)
; BANK 05 @#1475 : animtiles.asm (2955 bytes)
; BANK 06 @#0000 : animtiles.asm (2961 bytes)
; BANK 06 @#0B91 : particles.asm (4963 bytes)
; BANK 06 @#1EF4 : statemachine.asm part 1/4 (268 bytes)
...
; BANK 10 @#0000 : statemachine.asm part 5/4 (551 bytes)
; BANK 10 @#0227 : gameflow.asm part 1/3 (7641 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (930 bytes)
...
SPRITE_NINA_LAND_7_WIDTH     EQU 16
SPRITE_NINA_LAND_7_HEIGHT    EQU 16
SPRITE_NINA_LAND_7_FRAMES    EQU 1

;; ---- Sprite Frame: nina_land_7_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_7_F0_DATA (32 bytes)
SPRITE_7_PATTERN:
...
; Sprite Asset 8: Imported Sprite 9_left
;; Sprite: Imported Sprite 9_left
;; Total Frames: 3
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
;; Drawable Palette (Hex): C0=#D4524D, C1=#FFFFFF, C2=#000000, C3=#3EB847

SPRITE_IMPORTED_SPRITE_9_LEFT_8_WIDTH     EQU 16
SPRITE_IMPORTED_SPRITE_9_LEFT_8_HEIGHT    EQU 16
SPRITE_IMPORTED_SPRITE_9_LEFT_8_FRAMES    EQU 3

;; ---- Sprite Frame: Imported Sprite 9_left_8_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F2_DATA (32 bytes)
SPRITE_8_PATTERN EQU IMPORTED_SPRITE_9_LEFT_8_F0_LAYER0
...
; Sprite Asset 13: Imported Sprite 9_right
;; Sprite: Imported Sprite 9_right
;; Total Frames: 3
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
;; Drawable Palette (Hex): C0=#D4524D, C1=#FFFFFF, C2=#000000, C3=#3EB847

SPRITE_IMPORTED_SPRITE_9_RIGHT_13_WIDTH     EQU 16
SPRITE_IMPORTED_SPRITE_9_RIGHT_13_HEIGHT    EQU 16
SPRITE_IMPORTED_SPRITE_9_RIGHT_13_FRAMES    EQU 3

;; ---- Sprite Frame: Imported Sprite 9_right_13_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F2_DATA (32 bytes)
SPRITE_13_PATTERN EQU IMPORTED_SPRITE_9_RIGHT_13_F0_LAYER0
...
sprite_loop_flags:
    ...
    db 2 ; Sprite 7: nina_land
    db 2 ; Sprite 8: Imported Sprite 9_left
    db 2 ; Sprite 9: anec_left
    db 2 ; Sprite 10: nina_walk_right
    db 0 ; Sprite 11: nina_idle_right
    db 0 ; Sprite 12: nina_jump_right
    db 2 ; Sprite 13: Imported Sprite 9_right
...
; Sprite 7: nina_land frame pointers
SPRITE_7_FRAME_PTRS:
    dw SPRITE_PLACEHOLDER_PATTERN

; Sprite 8: Imported Sprite 9_left frame pointers
SPRITE_8_FRAME_PTRS:
    dw IMPORTED_SPRITE_9_LEFT_8_F0_LAYER0
    dw IMPORTED_SPRITE_9_LEFT_8_F1_LAYER0
    dw IMPORTED_SPRITE_9_LEFT_8_F2_LAYER0
...
; Sprite 13: Imported Sprite 9_right frame pointers
SPRITE_13_FRAME_PTRS:
    dw IMPORTED_SPRITE_9_RIGHT_13_F0_LAYER0
    dw IMPORTED_SPRITE_9_RIGHT_13_F1_LAYER0
    dw IMPORTED_SPRITE_9_RIGHT_13_F2_LAYER0
...
sprite_dir_left_table:
    db 9, 1, 2, 3, 4, 5, 6, 7, 8, 9, 4, 5, 6, 8

sprite_dir_right_table:
    db 0, 1, 2, 3, 10, 11, 12, 7, 13, 0, 10, 11, 12, 13
...
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_6_F0_DATA:
    ...
    DB #ED,#28,#C2,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_7_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_7_F0 (96 -> 6 bytes)
    DB #85,#00,#57,#55,#55,#80
ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F0_DATA:
    ; ZX0 compressed sprite frame IMPORTED_SPRITE_9_LEFT_8_F0 (64 -> 48 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#5B,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#9F,#B0,#F2,#EF,#CB,#80,#D3,#FF,#FE,#C2,#55,#55,#80
ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F1_DATA:
    ; ZX0 compressed sprite frame IMPORTED_SPRITE_9_LEFT_8_F1 (64 -> 52 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#58,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#F8,#FE,#F9,#40,#11,#F6,#BF,#C0,#80,#80,#FE,#8D,#F5
    DB #81,#04,#55,#56
ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F2_DATA:
    ; ZX0 compressed sprite frame IMPORTED_SPRITE_9_LEFT_8_F2 (64 -> 52 bytes)
...
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_12_F0_DATA:
    ...
    DB #80,#9D,#55,#55,#56
ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F0_DATA:
    ; ZX0 compressed sprite frame IMPORTED_SPRITE_9_RIGHT_13_F0 (64 -> 50 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
    DB #01,#F8,#00,#9A,#C0,#40,#C0,#EA,#E0,#EC,#40,#FB,#FF,#CB,#01,#EF
    DB #CF,#FE,#C2,#E4,#F3,#BF,#F0,#D0,#D8,#F8,#F0,#80,#FD,#FE,#F5,#F3
    DB #55,#58
ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F1_DATA:
    ; ZX0 compressed sprite frame IMPORTED_SPRITE_9_RIGHT_13_F1 (64 -> 53 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
    DB #01,#F8,#00,#9A,#C0,#40,#C0,#EA,#E0,#EC,#40,#FB,#FF,#CB,#01,#FE
    DB #CF,#FE,#F5,#29,#81,#20,#7F,#F0,#D0,#D8,#F8,#F0,#80,#00,#FD,#FE
    DB #8D,#02,#88,#55,#56
ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F2_DATA:
    ; ZX0 compressed sprite frame IMPORTED_SPRITE_9_RIGHT_13_F2 (64 -> 52 bytes)
...
; Frame group: NINA_LAND_7_F0
NINA_LAND_7_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_LAND_7_F0_DATA
; Frame group: IMPORTED_SPRITE_9_LEFT_8_F0
IMPORTED_SPRITE_9_LEFT_8_F0_LAYER0 EQU ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F0_DATA
; Frame group: IMPORTED_SPRITE_9_LEFT_8_F1
IMPORTED_SPRITE_9_LEFT_8_F1_LAYER0 EQU ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F1_DATA
; Frame group: IMPORTED_SPRITE_9_LEFT_8_F2
IMPORTED_SPRITE_9_LEFT_8_F2_LAYER0 EQU ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_LEFT_8_F2_DATA
...
; Frame group: IMPORTED_SPRITE_9_RIGHT_13_F0
IMPORTED_SPRITE_9_RIGHT_13_F0_LAYER0 EQU ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F0_DATA
; Frame group: IMPORTED_SPRITE_9_RIGHT_13_F1
IMPORTED_SPRITE_9_RIGHT_13_F1_LAYER0 EQU ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F1_DATA
; Frame group: IMPORTED_SPRITE_9_RIGHT_13_F2
IMPORTED_SPRITE_9_RIGHT_13_F2_LAYER0 EQU ZX0_SPRITE_FRAME_IMPORTED_SPRITE_9_RIGHT_13_F2_DATA
