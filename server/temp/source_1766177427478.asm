...
temp_byte_8         EQU #C4DC   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #C4FC   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #C51C   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #C53C   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #C55C   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #C57C   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #C59C   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #C5BC   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #C5DC   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #C5FC   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C61C   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C65C   ; Temporary 16-bit storage (64 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C69C   ; End of project variables (1692 bytes used)

; ==================================================================
; MEMORY SAFETY CHECK
; ==================================================================
; RAM Layout:
;   #C000-#C69C: Project variables (1692 bytes)
;   #C69C-#F37F: Free RAM (~11492 bytes available)
...
; Reserve space for all variables defined above
    DS 1692   ; Reserve 1692 bytes for all variables
