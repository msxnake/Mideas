...
; ------------------------------------------------------------------
; Bank 1 [#6000-#8000]: components (45479/8192 bytes est.)
; Bank 2 [#8000-#A000]: components_tail, statemachine, gameflow (19095/8192 bytes est.)
...
; Bank 9 [#6000-#8000]: screen_loaders (4427/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 10 [#6000-#8000]: sprites (3097/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 11 [#6000-#8000]: animtiles (2586/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 12 [#6000-#8000]: scroll (2407/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 13 [#6000-#8000]: worlds (1526/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 14 [#6000-#8000]: screens_code (1367/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 15 [#6000-#8000]: patterns_code (893/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 16 [#6000-#8000]: colors_code (845/8192 bytes est.) [FAR — accessed via trampoline]
...
; ------------------------------------------------------------------
; Far code banks: bank6(bosses) bank7(entities) bank8(sound) bank9(screen_loaders) bank10(sprites) bank11(animtiles) bank12(scroll) bank13(worlds) bank14(screens_code) bank15(patterns_code) bank16(colors_code) bank17(hud)
; ------------------------------------------------------------------
...
; BANK 10 @#0000 : bosses.asm (2586 bytes)
; BANK 10 @#0A1A : statemachine.asm (5606 bytes)
; BANK 11 @#0000 : statemachine.asm (2466 bytes)
; BANK 11 @#09A2 : gameflow.asm (5579 bytes); ==================================================================
...
;   reason: post-ZX0 first-fit single patterns resource; ZX0 843/1016 bytes; bank 3 zone 0 offset +#04A4; zone slack after pack 5783 bytes
; - tile_color_bank0                   288 stored /  1016 raw bytes @ #A7EF (rom #A7EF, offset +#07EF) [COLORS/TILE_COLORS] flags=1
;   reason: post-ZX0 first-fit single colors resource; ZX0 288/1016 bytes; bank 3 zone 0 offset +#07EF; zone slack after pack 5783 bytes
; - SCREEN_NEW_PLAYABLE_SCREEN_0_LAYOUT     9 stored /   768 raw bytes @ #A90F (rom #A90F, offset +#090F) [SCREENS/SCREEN_LAYOUT] flags=1
;   reason: post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_LAYOUT resource; ZX0 9/768 bytes; bank 3 zone 0 offset +#090F; zone slack after pack 5783 bytes
...
;   reason: post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECTS_LAYOUT resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0918; zone slack after pack 5783 bytes
...
;   reason: post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_INTERACTION_TARGET_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#092D; zone slack after pack 5783 bytes
; - NEW_SPRITE_0_F0_LAYER2              25 stored /    32 raw bytes @ #A933 (rom #A933, offset +#0933) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_0_F0_LAYER2 resource; ZX0 25/32 bytes; bank 3 zone 0 offset +#0933; zone slack after pack 5783 bytes
; - SPRITE_PLACEHOLDER_PATTERN           5 stored /    32 raw bytes @ #A94C (rom #A94C, offset +#094C) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single SPRITE_PLACEHOLDER_PATTERN resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#094C; zone slack after pack 5783 bytes
; - SCREEN_NEW_PLAYABLE_SCREEN_0_BOSS_TABLE    13 stored /    13 raw bytes @ #A951 (rom #A951, offset +#0951) [SCREENS/SCREEN_DATA] flags=0
;   reason: post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_BOSS_TABLE resource; raw 13 bytes; bank 3 zone 0 offset +#0951; zone slack after pack 5783 bytes
; - SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECT_ZONE_TABLE     1 stored /     1 raw bytes @ #A95E (rom #A95E, offset +#095E) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
;   reason: post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECT_ZONE_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#095E; zone slack after pack 5783 bytes
...
;         "metadataChecksum": "fnv1a32:BD617C94",
;         "resourceCount": 14,
;         "storedBytes": 2409
;       },
;       "resources": [
...
;           "flags": 1,
;           "sourceIndex": 2,
;           "placementReason": "post-ZX0 first-fit single patterns resource; ZX0 843/1016 bytes; bank 3 zone 0 offset +#04A4; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 4,
...
;           "flags": 1,
;           "sourceIndex": 4,
;           "placementReason": "post-ZX0 first-fit single colors resource; ZX0 288/1016 bytes; bank 3 zone 0 offset +#07EF; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 6,
...
;           "flags": 1,
;           "sourceIndex": 6,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_LAYOUT resource; ZX0 9/768 bytes; bank 3 zone 0 offset +#090F; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 7,
...
;           "flags": 1,
;           "sourceIndex": 7,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECTS_LAYOUT resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0918; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 11,
...
;           "flags": 1,
;           "sourceIndex": 13,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_INTERACTION_TARGET_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#092D; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 0,
...
;           "flags": 1,
;           "sourceIndex": 0,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_0_F0_LAYER2 resource; ZX0 25/32 bytes; bank 3 zone 0 offset +#0933; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 1,
...
;           "flags": 1,
;           "sourceIndex": 1,
;           "placementReason": "post-ZX0 first-fit single SPRITE_PLACEHOLDER_PATTERN resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#094C; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 9,
...
;           "flags": 0,
;           "sourceIndex": 9,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_BOSS_TABLE resource; raw 13 bytes; bank 3 zone 0 offset +#0951; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 8,
...
;           "flags": 0,
;           "sourceIndex": 8,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECT_ZONE_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#095E; zone slack after pack 5783 bytes"
;         },
;         {
;           "id": 10,
...
;         "sceneId": "screenmap_1777833014252",
;         "sceneName": "New Playable Screen",
;         "placementReason": "proposed scene first-fit placement; 13/13 bytes; bank 3 offset +#0933; current ROM placement unchanged"
;       },
;       {
;         "id": 8,
;         "label": "SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECT_ZONE_TABLE",
...
;         "sceneId": "screenmap_1777833014252",
;         "sceneName": "New Playable Screen",
;         "placementReason": "proposed scene first-fit placement; 1/1 bytes; bank 3 offset +#0940; current ROM placement unchanged"
;       },
;       {
;         "id": 10,
;         "label": "SCREEN_NEW_PLAYABLE_SCREEN_0_CHAR_BEHAVIOR_TABLE",
...
; - components: 45479 estimated bytes
...
; - screen_loaders: 4427 estimated bytes
; - screens_code: 1367 estimated bytes
...
;         {
;           "key": "sound",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 3; physical bank 8; executes through P1/#6000 after reserved asset-data banks; module sound is callable only through bank-0 far trampolines",
;           "estimatedBytes": 4769
;         }
;       ]
;     },
...
;       "estimatedUsedBytes": 4427,
;       "estimatedFreeBytes": 3765,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "screen_loaders",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 4; physical bank 9; executes through P1/#6000 after reserved asset-data banks; module screen_loaders is callable only through bank-0 far trampolines",
;           "estimatedBytes": 4427
;         }
;       ]
;     },
...
;       "estimatedUsedBytes": 1367,
;       "estimatedFreeBytes": 6825,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "screens_code",
...
; ==================================================================
current_screen_id   EQU #E0F6   ; Currently displayed screen ID
current_screen_engine EQU #E0F7   ; Runtime engine: 0=Player, 1=FakePlayer
screen_dirty_flag   EQU #E0F8   ; Screen needs redraw flag
screen_transition_cooldown EQU #E0F9   ; Cooldown frames after screen transition
current_world_id    EQU #E0FA   ; Current world ID (for multi-world support)
current_screen_index EQU #E0FB   ; Current screen index within world
current_screen_anim_group_count EQU #E0FC   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E0FD   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E0FE   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E0FF   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E100   ; Player X position (16-bit)
player_y            EQU #E102   ; Player Y position (16-bit)
player_runtime_enabled EQU #E104   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E105   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E106   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E107   ; Cached player Y velocity (signed 8-bit)
player_dash_timer   EQU #E108   ; Frames remaining in current Player dash
player_dash_cooldown EQU #E109   ; Frames until Player can dash again
player_dash_dir     EQU #E10A   ; Player dash direction (1=left,2=right,3=up,4=down)
player_dash_tile_x  EQU #E10B   ; Dash front probe tile X scratch
player_dash_tile_y  EQU #E10C   ; Dash front probe tile Y scratch
player_health       EQU #E10D   ; Player health points
player_score        EQU #E10E   ; Player score (16-bit)
gem_count           EQU #E110   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E111   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E112   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E113   ; Interaction type id of last interacted tile
last_interaction_value EQU #E114   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E115   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E116   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E117   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E118   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E119   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E11A   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E15A   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E19A   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E1DA   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E21A   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E22A   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E23A   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E24A   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E25A   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E26A   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E27A   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E27B   ; Temporary 16-bit storage
temp_word_2         EQU #E27D   ; Temporary 16-bit storage
temp_byte_1         EQU #E27F   ; Temporary 8-bit storage
temp_byte_2         EQU #E280   ; Temporary 8-bit storage
temp_byte_3         EQU #E281   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E2A1   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E2C1   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E2E1   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E301   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E302   ; Frames remaining for current SFX
sfx_fadeout         EQU #E303   ; Reserved fadeout flag/state
temp_byte_7         EQU #E304   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E324   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E344   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E364   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E384   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E3A4   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E3C4   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E3E4   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E404   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E424   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E444   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E464   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E484   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E4A4   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E4C4   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E4E4   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E504   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E524   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E544   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E564   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E5A4   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E5E4   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E604   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E624   ; Temporary 8-bit storage (32 bytes)
temp_byte_29        EQU #E644   ; Temporary 8-bit storage (32 bytes)
temp_byte_30        EQU #E664   ; Temporary 8-bit storage (32 bytes)
temp_byte_31        EQU #E684   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E6A4   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E6A5   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E6A6   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E6A7   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E6A8   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E6A9   ; Cached entity X for wall checks
wall_temp_y         EQU #E6AA   ; Cached entity Y for wall checks
wall_hit_left       EQU #E6AB   ; Hitbox left edge cache
wall_hit_top        EQU #E6AC   ; Hitbox top edge cache
wall_hit_right      EQU #E6AD   ; Hitbox right edge cache
wall_hit_bottom     EQU #E6AE   ; Hitbox bottom edge cache
wall_hit_w          EQU #E6AF   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E6B0   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E6B1   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E6B2   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E6B3   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E6B4   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E6B5   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E6D5   ; Number of entries in active_entity_list
hero_entity_id      EQU #E6D6   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E6D7   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E6D8   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E6F8   ; Number of entries in input_entity_list
render_entity_list  EQU #E6F9   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E719   ; Number of entries in render_entity_list
collision_entity_list EQU #E71A   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E73A   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E73B   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E75B   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E75C   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E77C   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E77D   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E79D   ; Number of entities in coll_list
coll_src_left       EQU #E79E   ; Source AABB left edge (scratch)
coll_src_right      EQU #E79F   ; Source AABB right edge (scratch)
coll_src_top        EQU #E7A0   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E7A1   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E7A2   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E7A2   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E7A4   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E7A6   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E7A8   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E7AA   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E7AC   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E7AE   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E7B0   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E7B2   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E7B3   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E7B8   ; Frame counter (16-bit)
task_exec_time          EQU #E7BA   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E7BC   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E7BD   ; 1 while the H.TIMI dispatcher is running
RAM_INTERRUPT_END       EQU #E7BE   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E7BE   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E7BF   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E7C0   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E7C1   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E7C2   ; 0=stopped, 1=track active
music_muted          EQU #E7C3   ; 0=audible, 1=muted/pause
music_loop           EQU #E7C4   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E7C5   ; Current ROM track index
music_row_frames     EQU #E7C6   ; Frames per tracker row
music_row_countdown  EQU #E7C7   ; Countdown to next row
music_order_pos      EQU #E7C8   ; Current order position
music_pattern_index  EQU #E7C9   ; Current pattern index
music_pattern_row    EQU #E7CA   ; Current row inside pattern
music_pattern_rows   EQU #E7CB   ; Cached rows in current pattern
music_track_ptr_l    EQU #E7CC   ; Current track pointer low byte
music_track_ptr_h    EQU #E7CD   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E7CE   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E7CF   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E7D0   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E7D1   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E7D2   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E7D3   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E7D4   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E7D4   ; Channel A
music_ch_b_note EQU #E7D5   ; Channel B
music_ch_c_note EQU #E7D6   ; Channel C
music_ch_instrument_base EQU #E7D7   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E7D7   ; Channel A
music_ch_b_instrument EQU #E7D8   ; Channel B
music_ch_c_instrument EQU #E7D9   ; Channel C
music_ch_ornament_base EQU #E7DA   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E7DA   ; Channel A
music_ch_b_ornament EQU #E7DB   ; Channel B
music_ch_c_ornament EQU #E7DC   ; Channel C
music_ch_volume_base EQU #E7DD   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E7DD   ; Channel A
music_ch_b_volume EQU #E7DE   ; Channel B
music_ch_c_volume EQU #E7DF   ; Channel C
music_ch_vol_step_base EQU #E7E0   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E7E0   ; Channel A
music_ch_b_vol_step EQU #E7E1   ; Channel B
music_ch_c_vol_step EQU #E7E2   ; Channel C
music_ch_tone_step_base EQU #E7E3   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E7E3   ; Channel A
music_ch_b_tone_step EQU #E7E4   ; Channel B
music_ch_c_tone_step EQU #E7E5   ; Channel C
music_ch_noise_step_base EQU #E7E6   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E7E6   ; Channel A
music_ch_b_noise_step EQU #E7E7   ; Channel B
music_ch_c_noise_step EQU #E7E8   ; Channel C
music_ch_orn_step_base EQU #E7E9   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E7E9   ; Channel A
music_ch_b_orn_step EQU #E7EA   ; Channel B
music_ch_c_orn_step EQU #E7EB   ; Channel C
music_ch_hw_env_step_base EQU #E7EC   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E7EC   ; Channel A
music_ch_b_hw_env_step EQU #E7ED   ; Channel B
music_ch_c_hw_env_step EQU #E7EE   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E7EF   ; End of project variables (10223 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E7EF: Project variables (10223 bytes)
;   #E7EF-#E800: Alignment padding/free RAM (17 bytes)
...
;   + SCREEN_NEW_PLAYABLE_SCREEN_0_BOSS_TABLE @ +#0951 size=13
;   + SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECT_ZONE_TABLE @ +#095E size=1
...
; ##################################################################
; FAR BANK 9 — [#6000h-#8000h] FAR CODE: screen_loaders
; Accessed ONLY via trampolines in bank 0 (entrypoint_far labels).
