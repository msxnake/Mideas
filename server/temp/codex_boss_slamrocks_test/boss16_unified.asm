...
; BANK 07 @#0000 : bosses.asm part 4/3 (1074 bytes)
; BANK 07 @#0432 : statemachine.asm (5 bytes)
; BANK 07 @#0437 : gameflow.asm (6064 bytes)
...
boss_meteor_age     EQU #C05E   ; Boss meteor cycle age
boss_meteor_count   EQU #C05F   ; Active meteor lanes
boss_meteor_index   EQU #C060   ; Current meteor lane index
boss_meteor_base_x  EQU #C061   ; First meteor lane X
boss_meteor_base_y  EQU #C062   ; Meteor spawn Y
boss_meteor_sprite_slot EQU #C063   ; First HW sprite slot for meteors
boss_meteor_color   EQU #C064   ; Meteor sprite color
boss_meteor_pattern EQU #C065   ; Meteor base pattern
boss_meteor_speed   EQU #C066   ; Meteor fall speed
boss_meteor_range   EQU #C067   ; Meteor fall range
boss_meteor_spread  EQU #C068   ; Meteor lane spacing
boss_meteor_warn    EQU #C069   ; Meteor warning frames
boss_bomb_age       EQU #C06A   ; Boss bomb cycle age
boss_bomb_count     EQU #C06B   ; Active bomb lanes
boss_bomb_index     EQU #C06C   ; Current bomb lane index
boss_bomb_base_x    EQU #C06D   ; First bomb lane X
boss_bomb_base_y    EQU #C06E   ; Bomb spawn Y
boss_bomb_sprite_slot EQU #C06F   ; First HW sprite slot for bombs
boss_bomb_color     EQU #C070   ; Bomb sprite color
boss_bomb_pattern   EQU #C071   ; Bomb base pattern
boss_bomb_explosion_pattern EQU #C072   ; Bomb explosion pattern
boss_bomb_spread    EQU #C073   ; Bomb lane spacing
boss_bomb_fuse      EQU #C074   ; Bomb fuse frames
boss_bomb_radius    EQU #C075   ; Bomb explosion radius
boss_bomb_duration  EQU #C076   ; Bomb explosion active frames
boss_boomerang_age  EQU #C077   ; Boss boomerang cycle age
boss_boomerang_base_x EQU #C078   ; Boomerang origin X
boss_boomerang_base_y EQU #C079   ; Boomerang origin Y
boss_boomerang_sprite_slot EQU #C07A   ; HW sprite slot for boomerang
boss_boomerang_color EQU #C07B   ; Boomerang sprite color
boss_boomerang_pattern EQU #C07C   ; Boomerang base pattern
boss_boomerang_speed EQU #C07D   ; Boomerang speed
boss_boomerang_range EQU #C07E   ; Boomerang max distance
boss_boomerang_distance EQU #C07F   ; Current boomerang distance from origin
boss_boomerang_direction EQU #C080   ; Boomerang direction
boss_rock_age       EQU #C081   ; Boss rock cycle age
boss_rock_base_x    EQU #C082   ; Rock origin X
boss_rock_base_y    EQU #C083   ; Rock origin Y
boss_rock_sprite_slot EQU #C084   ; HW sprite slot for rock
boss_rock_color     EQU #C085   ; Rock sprite color
boss_rock_pattern   EQU #C086   ; Rock base pattern
boss_rock_speed     EQU #C087   ; Rock speed
boss_rock_range     EQU #C088   ; Rock max travel distance
boss_rock_distance  EQU #C089   ; Current rock distance from origin
boss_rock_direction EQU #C08A   ; Rock direction
boss_rock_arc_height EQU #C08B   ; Rock parabolic arc height
boss_rock_arc_offset EQU #C08C   ; Current rock arc offset
boss_laser_age      EQU #C08D   ; Boss laser cycle age
boss_laser_base_x   EQU #C08E   ; Laser origin X in pixels
boss_laser_base_y   EQU #C08F   ; Laser origin Y in pixels
boss_laser_tile_char EQU #C090   ; Laser beam char code
boss_laser_length   EQU #C091   ; Laser length in chars
boss_laser_duration EQU #C092   ; Laser active frames
boss_laser_direction EQU #C093   ; Laser direction
boss_laser_index    EQU #C094   ; Current laser char index
boss_laser_origin_tile_x EQU #C095   ; Laser origin tile X
boss_laser_origin_tile_y EQU #C096   ; Laser origin tile Y
boss_laser_tile_x   EQU #C097   ; Current laser tile X
boss_laser_tile_y   EQU #C098   ; Current laser tile Y
boss_laser_write_mode EQU #C099   ; 0=draw laser, 1=restore map
boss_wave_age       EQU #C09A   ; Boss sine-wave projectile cycle age
boss_wave_base_x    EQU #C09B   ; Sine-wave projectile origin X
boss_wave_base_y    EQU #C09C   ; Sine-wave projectile origin Y
boss_wave_sprite_slot EQU #C09D   ; HW sprite slot for sine-wave projectile
boss_wave_color     EQU #C09E   ; Sine-wave projectile sprite color
boss_wave_pattern   EQU #C09F   ; Sine-wave projectile base pattern
boss_wave_speed     EQU #C0A0   ; Sine-wave projectile speed
boss_wave_range     EQU #C0A1   ; Sine-wave projectile max travel distance
boss_wave_distance  EQU #C0A2   ; Current sine-wave projectile distance
boss_wave_direction EQU #C0A3   ; Sine-wave projectile direction
boss_wave_amplitude EQU #C0A4   ; Sine-wave perpendicular amplitude
boss_wave_frequency EQU #C0A5   ; Frames per sine-wave phase step
boss_wave_phase     EQU #C0A6   ; Current sine-wave phase index
boss_wave_offset    EQU #C0A7   ; Signed sine-wave perpendicular offset
boss_homing_age     EQU #C0A8   ; Boss homing missile cycle age
boss_homing_base_x  EQU #C0A9   ; Homing missile origin X
boss_homing_base_y  EQU #C0AA   ; Homing missile origin Y
boss_homing_sprite_slot EQU #C0AB   ; HW sprite slot for homing missile
boss_homing_color   EQU #C0AC   ; Homing missile sprite color
boss_homing_pattern EQU #C0AD   ; Homing missile base pattern
boss_homing_speed   EQU #C0AE   ; Homing missile speed
boss_homing_range   EQU #C0AF   ; Homing missile max travel distance
boss_homing_distance EQU #C0B0   ; Current homing missile distance
boss_homing_direction EQU #C0B1   ; Homing missile launch direction
boss_homing_turn_step EQU #C0B2   ; Homing missile steering strength
boss_homing_turn_distance EQU #C0B3   ; Homing missile steering distance
autocontrol_screen_id EQU #C0B4   ; Screen id bound to current FakePlayer script
autocontrol_entity_index EQU #C0B5   ; Active FakePlayer entity index (#FF=none)
autocontrol_script_ptr_l EQU #C0B6   ; Current FakePlayer script pointer low byte
autocontrol_script_ptr_h EQU #C0B7   ; Current FakePlayer script pointer high byte
autocontrol_script_start_l EQU #C0B8   ; FakePlayer script start pointer low byte
autocontrol_script_start_h EQU #C0B9   ; FakePlayer script start pointer high byte
autocontrol_wait_frames EQU #C0BA   ; FakePlayer wait countdown in frames
autocontrol_move_opcode EQU #C0BB   ; Active FakePlayer movement opcode
autocontrol_move_remaining EQU #C0BC   ; Remaining FakePlayer movement pixels
autocontrol_loop_flag EQU #C0BD   ; 1=loop FakePlayer script on END
autocontrol_active EQU #C0BE   ; 1=FakePlayer script active
autoev_screen_id EQU #C0BF   ; Screen id bound to compact FakePlayer event script
autoev_entity_index EQU #C0C0   ; Active compact FakePlayer entity index (#FF=none)
autoev_script_ptr_l EQU #C0C1   ; Compact FakePlayer event pointer low byte
autoev_script_ptr_h EQU #C0C2   ; Compact FakePlayer event pointer high byte
autoev_script_start_l EQU #C0C3   ; Compact FakePlayer event start pointer low byte
autoev_script_start_h EQU #C0C4   ; Compact FakePlayer event start pointer high byte
autoev_wait_frames EQU #C0C5   ; Compact FakePlayer wait countdown in frames
autoev_move_axis EQU #C0C6   ; Compact move axis (1=x,2=y)
autoev_move_step EQU #C0C7   ; Compact move step (1 or #FF)
autoev_move_remaining EQU #C0C8   ; Remaining compact FakePlayer movement pixels
autoev_loop_flag EQU #C0C9   ; 1=loop compact FakePlayer event script
autoev_active EQU #C0CA   ; 1=compact FakePlayer event script active
autoev_wait_mode EQU #C0CB   ; 1=wait SPC, 2=wait typewriter
autoev_number_l EQU #C0CC   ; Parsed compact event number low byte
autoev_number_h EQU #C0CD   ; Parsed compact event number high byte
dialogue_active    EQU #C0CE   ; 1=dialogue box is open
dialogue_current_box EQU #C0CF   ; Current dialogue box config index
dialogue_text_active EQU #C0D0   ; 1=typewriter is writing text
dialogue_text_ptr_l EQU #C0D1   ; Dialogue typewriter text pointer low byte
dialogue_text_ptr_h EQU #C0D2   ; Dialogue typewriter text pointer high byte
dialogue_vram_ptr_l EQU #C0D3   ; Dialogue typewriter VRAM pointer low byte
dialogue_vram_ptr_h EQU #C0D4   ; Dialogue typewriter VRAM pointer high byte
dialogue_row_start_l EQU #C0D5   ; Current dialogue row start VRAM low byte
dialogue_row_start_h EQU #C0D6   ; Current dialogue row start VRAM high byte
dialogue_char_delay EQU #C0D7   ; Dialogue character delay countdown
dialogue_char_delay_reload EQU #C0D8   ; Dialogue character delay reload value
dialogue_box_vram_l EQU #C0D9   ; Dialogue box VRAM start low byte
dialogue_box_vram_h EQU #C0DA   ; Dialogue box VRAM start high byte
dialogue_box_width EQU #C0DB   ; Dialogue box width in chars
dialogue_box_height EQU #C0DC   ; Dialogue box height in chars
dialogue_box_tl_char EQU #C0DD   ; Dialogue top-left border char
dialogue_box_tr_char EQU #C0DE   ; Dialogue top-right border char
dialogue_box_bl_char EQU #C0DF   ; Dialogue bottom-left border char
dialogue_box_br_char EQU #C0E0   ; Dialogue bottom-right border char
dialogue_box_h_char EQU #C0E1   ; Dialogue horizontal border char
dialogue_box_v_char EQU #C0E2   ; Dialogue vertical border char
dialogue_graphic_enabled EQU #C0E3   ; 1=dialogue tile graphic is visible
dialogue_graphic_vram_l EQU #C0E4   ; Dialogue graphic VRAM start low byte
dialogue_graphic_vram_h EQU #C0E5   ; Dialogue graphic VRAM start high byte
dialogue_graphic_ptr_l EQU #C0E6   ; Dialogue graphic tile data pointer low byte
dialogue_graphic_ptr_h EQU #C0E7   ; Dialogue graphic tile data pointer high byte
dialogue_graphic_width EQU #C0E8   ; Dialogue graphic width in chars
dialogue_graphic_height EQU #C0E9   ; Dialogue graphic height in chars
current_flow_state  EQU #C0EA   ; Current game flow state
prev_flow_state     EQU #C0EB   ; Previous game flow state
gameflow_exit_requested EQU #C0EC   ; Exit flag for WorldLink loop
gameflow_menu_selection EQU #C0ED   ; Current/last submenu selection
gameflow_submenu_data_ptr EQU #C0EE   ; Pointer to active submenu data (16-bit)
gameflow_submenu_option_count EQU #C0F0   ; Cached submenu option count
gameflow_submenu_cursor_enabled EQU #C0F1   ; 1 when submenu uses sprite cursor
gameflow_submenu_cursor_layer_count EQU #C0F2   ; Cursor sprite layer count (1..4)
gameflow_condition_result EQU #C0F3   ; Result of last condition evaluation
transition_delay_var    EQU #C0F4   ; Frames per step for active transition effect

; ==================================================================
; MIDEAS GLOBAL VARIABLES (DEFAULTS + CUSTOM)
; ==================================================================
global_var_goal     EQU #C0F5   ; Goal status (0=Failure, 1=Completed)

; ==================================================================
; SYSTEM VARIABLES
; ==================================================================
ROM_slot            EQU #C0F6   ; Expanded slot for normal page 1 ROM access
slot_primary_normal EQU #C0F7   ; Primary slot register snapshot for BIOS-ROM-ROM-RAM layout
page0_bios_slot     EQU #C0F8   ; Expanded slot for normal BIOS page 0
page2_normal_slot   EQU #C0F9   ; Expanded slot for normal page 2 layout
page3_normal_slot   EQU #C0FA   ; Expanded slot for normal RAM page 3
mapper_bank_p1_current EQU #C0FB   ; Mapper current bank for page/window 1
mapper_bank_p2_current EQU #C0FC   ; Mapper current bank for page/window 2
mapper_bank_p3_current EQU #C0FD   ; Mapper current bank for page/window 3
mapper_bank_p4_current EQU #C0FE   ; Mapper current bank for page/window 4
mapper_saved_bank    EQU #C0FF   ; Saved mapper bank for push/pop helpers
mapper_saved_bank_p1 EQU #C100   ; Saved mapper bank for page/window 1 helpers
mapper_saved_bank_p3 EQU #C101   ; Saved mapper bank for page/window 3 helpers
mapper_saved_bank_p4 EQU #C102   ; Saved mapper bank for page/window 4 helpers
resource_descriptor_ptr EQU #C103   ; Pointer to cached resource descriptor entry (16-bit)
resource_descriptor_id EQU #C105   ; Cached resource id
resource_descriptor_type EQU #C106   ; Cached resource type
resource_descriptor_group EQU #C107   ; Cached resource group
resource_descriptor_bank EQU #C108   ; Cached resource bank
resource_descriptor_addr EQU #C109   ; Cached resource visible address (16-bit)
resource_descriptor_size EQU #C10B   ; Cached resource size (16-bit)
vram_cache_tile_patterns_ready EQU #C10D   ; 1 when shared gameplay tile patterns are already resident in VRAM
vram_cache_tile_colors_ready EQU #C10E   ; 1 when shared gameplay tile colors are already resident in VRAM
vram_cache_font_ready EQU #C10F   ; 1 when shared font patterns/colors are already resident in VRAM
current_screen2_tilebank_id EQU #C110   ; Current SCREEN 2 shared tilebank loaded in VRAM (#FF=none/unknown)
frame_counter       EQU #C111   ; Frame counter (16-bit)

; Profiling counters (16-bit, cumulative)
prof_update_all_entities_calls EQU #C113   ; Calls to update_all_entities
prof_execute_sm_calls EQU #C115   ; Calls to execute_all_state_machines
prof_sm_update_calls  EQU #C117   ; Calls to SM_Update
prof_collision_calls  EQU #C119   ; Calls to update_collision_component
prof_wall_calls       EQU #C11B   ; Calls to update_wallcollision_component
prof_deadly_calls     EQU #C11D   ; Calls to update_deadly_tiles_component
prof_tile_interaction_calls EQU #C11F   ; Calls to check_tile_interaction
prof_animation_calls  EQU #C121   ; Calls to update_animation_component
prof_sprite_calls     EQU #C123   ; Calls to update_sprite_component
prof_music_task_calls EQU #C125   ; Calls to task_update_music
prof_deadly_behavior_reads EQU #C127   ; Deadly helper behavior-map reads
; page0_transfer_buffer shares the ZX0 scratch area declared near RAM_USAGE_END.

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C129   ; Pointer to current screen layout data (16-bit)
current_screen_layout_bank EQU #C12B   ; Mapper bank for current screen layout data
current_behavior_map    EQU #C12C   ; Pointer to current behavior map data (16-bit)
current_behavior_map_bank EQU #C12E   ; Mapper bank for current behavior map data
behavior_cache_row     EQU #C12F   ; Cached behavior row (255=invalid)
behavior_cache_map_l   EQU #C130   ; Cached behavior map pointer low byte
behavior_cache_map_h   EQU #C131   ; Cached behavior map pointer high byte
behavior_cache_row_base EQU #C132   ; Cached row base address in behavior map (16-bit)
RUNTIME_SCREEN_MAP_SIZE EQU 768
MAX_RUNTIME_EFFECT_ZONES EQU 0
runtime_background_layout EQU #C134   ; Immutable copy of current background layout (32x24)
runtime_screen_layout  EQU #C434   ; Mutable copy of current screen layout (32x24)
runtime_behavior_map   EQU #C734   ; Mutable copy of current behavior map (32x24)
runtime_interaction_type_map EQU #CA34   ; Mutable copy of current interaction type map (32x24)
runtime_interaction_value_map EQU #CD34   ; Mutable copy of current interaction value map (32x24)
runtime_interaction_target_map EQU #D034   ; Mutable copy of current interaction target map (32x24)
runtime_char_behavior_table EQU #D334   ; Current screen char -> behavior lookup table (256 bytes)
runtime_effects_layout EQU #D434   ; Alternate effects layout copy for secret zones (32x24)
screen_block_catalog_ptr EQU #D734   ; Scratch pointer to current screen block catalog during layout expansion
screen_block_map_ptr EQU #D736   ; Scratch pointer to current screen block index map during layout expansion
runtime_effect_zone_table EQU #D738   ; Current screen effect zone table (0 bytes)
current_effect_zone_count EQU #D738   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #D739   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #D73A   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #D73B   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #D73C   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #D73D   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #D73E   ; Camera X position in pixels (16-bit)
camera_y            EQU #D740   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #D742   ; Camera tile X (column)
camera_tile_y       EQU #D743   ; Camera tile Y (row)
world_width_tiles   EQU #D744   ; World width in tiles
world_height_tiles  EQU #D745   ; World height in tiles
scroll_dirty_flag   EQU #D746   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #D747   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #D748   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #D749   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #D74B   ; Animation frame timer
anim_tile_frame     EQU #D74C   ; Current animation frame (0-3)
anim_tile_speed     EQU #D74D   ; Frames between animation updates
anim_tile_transform_flags EQU #D74E   ; Runtime flags for transform-mode tile animation (byte0=flags, byte1=opcode scratch)
anim_tile_row_buffer EQU #D750   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #D758   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #D778   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_button_contact_active EQU #D798   ; 1 while entity stays on the same button tile (32 bytes)
entity_button_contact_x EQU #D7B8   ; Button tile X currently latched per entity (32 bytes)
entity_button_contact_y EQU #D7D8   ; Button tile Y currently latched per entity (32 bytes)
entity_on_ladder   EQU #D7F8   ; 1 while entity is centered on a ladder tile (32 bytes)
entity_gate_current_step EQU #D818   ; Current applied retract step (32 bytes)
entity_gate_step_timer EQU #D838   ; Countdown until next retract step (32 bytes)
entity_walljump_lock EQU #D858   ; Remaining horizontal lock frames after wall jump (32 bytes)
entity_walljump_locked_vx EQU #D878   ; Horizontal velocity preserved while wall jump lock is active (32 bytes)
entity_wallgrab_active EQU #D898   ; 1 if entity is currently grabbing a wall (32 bytes)
entity_wallgrab_grace EQU #D8B8   ; Frames to keep wall grab during transient wall flag gaps (32 bytes)
entity_wallgrab_timer EQU #D8D8   ; Remaining wall-grab frames until grounded reset (32 bytes)
entity_wallgrab_lockout EQU #D8F8   ; Wall grab disabled until grounded after timer is spent (32 bytes)
entity_walljump_anim_active EQU #D918   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
...
entity_template_token EQU #DC59   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #DC79   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #DC99   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #DCB9   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #DCD9   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #DCF9   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #DD19   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #DD39   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #DD59   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #DD79   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #DD99   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #DDB9   ; Number of sprites currently active
sprites_dirty      EQU #DDBA   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #DDBB   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #DDDB   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #DDFB   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_layer_y_offsets EQU #DE1B   ; HW sprite layer signed Y offsets - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #DE3B   ; Runtime base 16x16 slot per sprite asset (1 bytes)
sprite_placeholder_base_pattern_num EQU #DE3C   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #DE3D   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #DE3E   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #DEBE   ; Currently displayed screen ID
current_screen_engine EQU #DEBF   ; Runtime engine: 0=Player, 1=FakePlayer
screen_dirty_flag   EQU #DEC0   ; Screen needs redraw flag
screen_transition_cooldown EQU #DEC1   ; Cooldown frames after screen transition
current_world_id    EQU #DEC2   ; Current world ID (for multi-world support)
current_screen_index EQU #DEC3   ; Current screen index within world
current_screen_anim_group_count EQU #DEC4   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #DEC5   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #DEC6   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #DEC7   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #DEC8   ; Player X position (16-bit)
player_y            EQU #DECA   ; Player Y position (16-bit)
player_runtime_enabled EQU #DECC   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #DECD   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #DECE   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #DECF   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #DED0   ; Player health points
player_score        EQU #DED1   ; Player score (16-bit)
gem_count           EQU #DED3   ; Collectible tile counter (8-bit)
last_interaction_char EQU #DED4   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #DED5   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #DED6   ; Interaction type id of last interacted tile
last_interaction_value EQU #DED7   ; Interaction value byte of last interacted tile
last_interaction_target EQU #DED8   ; Interaction target id of last interacted tile
last_interaction_x  EQU #DED9   ; Tile X coordinate of last interaction
last_interaction_y  EQU #DEDA   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #DEDB   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #DEDC   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #DEDD   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #DF1D   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #DF5D   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #DF9D   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #DFDD   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #DFED   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #DFFD   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E00D   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E01D   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E02D   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E03D   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E03E   ; Temporary 16-bit storage
temp_word_2         EQU #E040   ; Temporary 16-bit storage
temp_byte_1         EQU #E042   ; Temporary 8-bit storage
temp_byte_2         EQU #E043   ; Temporary 8-bit storage
temp_byte_3         EQU #E044   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E064   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E084   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E0A4   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E0C4   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E0C5   ; Frames remaining for current SFX
sfx_fadeout         EQU #E0C6   ; Reserved fadeout flag/state
temp_byte_7         EQU #E0C7   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E0E7   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E107   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E127   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E147   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E167   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E187   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E1A7   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E1C7   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E1E7   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E207   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E227   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E247   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E267   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E287   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E2A7   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E2C7   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E2E7   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E307   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E327   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E367   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E3A7   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E3C7   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E3E7   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E407   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E408   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E409   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E40A   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E40B   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E40C   ; Cached entity X for wall checks
wall_temp_y         EQU #E40D   ; Cached entity Y for wall checks
wall_hit_left       EQU #E40E   ; Hitbox left edge cache
wall_hit_top        EQU #E40F   ; Hitbox top edge cache
wall_hit_right      EQU #E410   ; Hitbox right edge cache
wall_hit_bottom     EQU #E411   ; Hitbox bottom edge cache
wall_hit_w          EQU #E412   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E413   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E414   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E415   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E416   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E417   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E418   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E438   ; Number of entries in active_entity_list
hero_entity_id      EQU #E439   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E43A   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E43B   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E45B   ; Number of entries in input_entity_list
render_entity_list  EQU #E45C   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E47C   ; Number of entries in render_entity_list
collision_entity_list EQU #E47D   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E49D   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E49E   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E4BE   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E4BF   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E4DF   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E4E0   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E500   ; Number of entities in coll_list
coll_src_left       EQU #E501   ; Source AABB left edge (scratch)
coll_src_right      EQU #E502   ; Source AABB right edge (scratch)
coll_src_top        EQU #E503   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E504   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E505   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E505   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E507   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E509   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E50B   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E50D   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E50F   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E511   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E513   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E515   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E516   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E51B   ; Frame counter (16-bit)
task_exec_time          EQU #E51D   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E51F   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E520   ; 1 while the H.TIMI dispatcher is running
RAM_INTERRUPT_END       EQU #E521   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E521   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E522   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E523   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E524   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E525   ; 0=stopped, 1=track active
music_muted          EQU #E526   ; 0=audible, 1=muted/pause
music_loop           EQU #E527   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E528   ; Current ROM track index
music_row_frames     EQU #E529   ; Frames per tracker row
music_row_countdown  EQU #E52A   ; Countdown to next row
music_order_pos      EQU #E52B   ; Current order position
music_pattern_index  EQU #E52C   ; Current pattern index
music_pattern_row    EQU #E52D   ; Current row inside pattern
music_pattern_rows   EQU #E52E   ; Cached rows in current pattern
music_track_ptr_l    EQU #E52F   ; Current track pointer low byte
music_track_ptr_h    EQU #E530   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E531   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E532   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E533   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E534   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E535   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E536   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E537   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E537   ; Channel A
music_ch_b_note EQU #E538   ; Channel B
music_ch_c_note EQU #E539   ; Channel C
music_ch_instrument_base EQU #E53A   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E53A   ; Channel A
music_ch_b_instrument EQU #E53B   ; Channel B
music_ch_c_instrument EQU #E53C   ; Channel C
music_ch_ornament_base EQU #E53D   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E53D   ; Channel A
music_ch_b_ornament EQU #E53E   ; Channel B
music_ch_c_ornament EQU #E53F   ; Channel C
music_ch_volume_base EQU #E540   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E540   ; Channel A
music_ch_b_volume EQU #E541   ; Channel B
music_ch_c_volume EQU #E542   ; Channel C
music_ch_vol_step_base EQU #E543   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E543   ; Channel A
music_ch_b_vol_step EQU #E544   ; Channel B
music_ch_c_vol_step EQU #E545   ; Channel C
music_ch_tone_step_base EQU #E546   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E546   ; Channel A
music_ch_b_tone_step EQU #E547   ; Channel B
music_ch_c_tone_step EQU #E548   ; Channel C
music_ch_noise_step_base EQU #E549   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E549   ; Channel A
music_ch_b_noise_step EQU #E54A   ; Channel B
music_ch_c_noise_step EQU #E54B   ; Channel C
music_ch_orn_step_base EQU #E54C   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E54C   ; Channel A
music_ch_b_orn_step EQU #E54D   ; Channel B
music_ch_c_orn_step EQU #E54E   ; Channel C
music_ch_hw_env_step_base EQU #E54F   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E54F   ; Channel A
music_ch_b_hw_env_step EQU #E550   ; Channel B
music_ch_c_hw_env_step EQU #E551   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E552   ; End of project variables (9554 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E552: Project variables (9554 bytes)
;   #E552-#E600: Alignment padding/free RAM (174 bytes)
...
BOSS_ATTACK_RECORD_SIZE EQU 34
