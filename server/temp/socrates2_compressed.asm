...
; Estimated payload bytes: 48608
; Estimated banks used: 6
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (4333 bytes)
; BANK 00 @#114D : colors.asm (3763 bytes)
; BANK 01 @#0000 : colors.asm (41 bytes)
; BANK 01 @#0029 : components.asm (22 bytes)
; BANK 01 @#003F : entities.asm (311 bytes)
; BANK 01 @#0176 : worlds.asm (1809 bytes)
; BANK 01 @#0887 : screens.asm part 1/2 (6009 bytes)
; BANK 02 @#0000 : screens.asm part 2/2 (4800 bytes)
; BANK 02 @#12C0 : sprites.asm (2823 bytes)
; BANK 02 @#1DC7 : font.asm (177 bytes)
; BANK 02 @#1E78 : hud.asm (79 bytes)
; BANK 02 @#1EC7 : menus.asm (168 bytes)
; BANK 02 @#1F6F : sound.asm (145 bytes)
; BANK 03 @#0000 : sound.asm (4266 bytes)
; BANK 03 @#10AA : scroll.asm (2342 bytes)
; BANK 03 @#19D0 : animtiles.asm (1584 bytes)
; BANK 04 @#0000 : animtiles.asm (3037 bytes)
; BANK 04 @#0BDD : bosses.asm (5155 bytes)
; BANK 05 @#0000 : bosses.asm (2326 bytes)
; BANK 05 @#0916 : statemachine.asm (5 bytes)
; BANK 05 @#091B : gameflow.asm (5317 bytes)
...
anim_tile_transform_flags EQU #D76C   ; Runtime flags for transform-mode tile animation (byte0=flags, byte1=opcode scratch)
anim_tile_row_buffer EQU #D76E   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #D776   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #D796   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_button_contact_active EQU #D7B6   ; 1 while entity stays on the same button tile (32 bytes)
entity_button_contact_x EQU #D7D6   ; Button tile X currently latched per entity (32 bytes)
entity_button_contact_y EQU #D7F6   ; Button tile Y currently latched per entity (32 bytes)
entity_on_ladder   EQU #D816   ; 1 while entity is centered on a ladder tile (32 bytes)
entity_gate_current_step EQU #D836   ; Current applied retract step (32 bytes)
entity_gate_step_timer EQU #D856   ; Countdown until next retract step (32 bytes)
entity_walljump_lock EQU #D876   ; Remaining horizontal lock frames after wall jump (32 bytes)
entity_walljump_locked_vx EQU #D896   ; Horizontal velocity preserved while wall jump lock is active (32 bytes)
entity_wallgrab_active EQU #D8B6   ; 1 if entity is currently grabbing a wall (32 bytes)
entity_wallgrab_grace EQU #D8D6   ; Frames to keep wall grab during transient wall flag gaps (32 bytes)
entity_wallgrab_timer EQU #D8F6   ; Remaining wall-grab frames until grounded reset (32 bytes)
entity_wallgrab_lockout EQU #D916   ; Wall grab disabled until grounded after timer is spent (32 bytes)
entity_walljump_anim_active EQU #D936   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_x_pos        EQU #D956   ; Entity X positions (32 bytes)
entity_y_pos        EQU #D976   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #D996   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #D9B6   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #D9D6   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #D9F6   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DA16   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DA36   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DA56   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DA76   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DA77   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DA97   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DAB7   ; Entity health (32 bytes)
entity_anim_frame   EQU #DAD7   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DAF7   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DB17   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DB37   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DB57   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DB77   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DB97   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DBB7   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DBD7   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DBF7   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DC17   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_collectible_enabled EQU #DC37   ; 1 when entity has Collectible component (32 bytes)
entity_carried_by   EQU #DC57   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #DC77   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #DC97   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #DCB7   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #DCD7   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #DCF7   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #DD17   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #DD37   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #DD57   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #DD77   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #DD97   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #DDB7   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #DDD7   ; Number of sprites currently active
sprites_dirty      EQU #DDD8   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #DDD9   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #DDF9   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #DE19   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_layer_y_offsets EQU #DE39   ; HW sprite layer signed Y offsets - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #DE59   ; Runtime base 16x16 slot per sprite asset (1 bytes)
sprite_placeholder_base_pattern_num EQU #DE5A   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #DE5B   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #DE5C   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #DEDC   ; Currently displayed screen ID
current_screen_engine EQU #DEDD   ; Runtime engine: 0=Player, 1=FakePlayer
screen_dirty_flag   EQU #DEDE   ; Screen needs redraw flag
screen_transition_cooldown EQU #DEDF   ; Cooldown frames after screen transition
current_world_id    EQU #DEE0   ; Current world ID (for multi-world support)
current_screen_index EQU #DEE1   ; Current screen index within world
current_screen_anim_group_count EQU #DEE2   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #DEE3   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #DEE4   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #DEE5   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #DEE6   ; Player X position (16-bit)
player_y            EQU #DEE8   ; Player Y position (16-bit)
player_runtime_enabled EQU #DEEA   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #DEEB   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #DEEC   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #DEED   ; Cached player Y velocity (signed 8-bit)
player_dash_timer   EQU #DEEE   ; Frames remaining in current Player dash
player_dash_cooldown EQU #DEEF   ; Frames until Player can dash again
player_dash_dir     EQU #DEF0   ; Player dash direction (1=left,2=right,3=up,4=down)
player_dash_tile_x  EQU #DEF1   ; Dash front probe tile X scratch
player_dash_tile_y  EQU #DEF2   ; Dash front probe tile Y scratch
player_health       EQU #DEF3   ; Player health points
player_score        EQU #DEF4   ; Player score (16-bit)
gem_count           EQU #DEF6   ; Collectible tile counter (8-bit)
last_interaction_char EQU #DEF7   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #DEF8   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #DEF9   ; Interaction type id of last interacted tile
last_interaction_value EQU #DEFA   ; Interaction value byte of last interacted tile
last_interaction_target EQU #DEFB   ; Interaction target id of last interacted tile
last_interaction_x  EQU #DEFC   ; Tile X coordinate of last interaction
last_interaction_y  EQU #DEFD   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #DEFE   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #DEFF   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #DF00   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #DF40   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #DF80   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #DFC0   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E000   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E010   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E020   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E030   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E040   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E050   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E060   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E061   ; Temporary 16-bit storage
temp_word_2         EQU #E063   ; Temporary 16-bit storage
temp_byte_1         EQU #E065   ; Temporary 8-bit storage
temp_byte_2         EQU #E066   ; Temporary 8-bit storage
temp_byte_3         EQU #E067   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E087   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E0A7   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E0C7   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E0E7   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E0E8   ; Frames remaining for current SFX
sfx_fadeout         EQU #E0E9   ; Reserved fadeout flag/state
temp_byte_7         EQU #E0EA   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E10A   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E12A   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E14A   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E16A   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E18A   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E1AA   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E1CA   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E1EA   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E20A   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E22A   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E24A   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E26A   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E28A   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E2AA   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E2CA   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E2EA   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E30A   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E32A   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E34A   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E38A   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E3CA   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E3EA   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E40A   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E42A   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E42B   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E42C   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E42D   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E42E   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E42F   ; Cached entity X for wall checks
wall_temp_y         EQU #E430   ; Cached entity Y for wall checks
wall_hit_left       EQU #E431   ; Hitbox left edge cache
wall_hit_top        EQU #E432   ; Hitbox top edge cache
wall_hit_right      EQU #E433   ; Hitbox right edge cache
wall_hit_bottom     EQU #E434   ; Hitbox bottom edge cache
wall_hit_w          EQU #E435   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E436   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E437   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E438   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E439   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E43A   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E43B   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E45B   ; Number of entries in active_entity_list
hero_entity_id      EQU #E45C   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E45D   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E45E   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E47E   ; Number of entries in input_entity_list
render_entity_list  EQU #E47F   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E49F   ; Number of entries in render_entity_list
collision_entity_list EQU #E4A0   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E4C0   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E4C1   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E4E1   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E4E2   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E502   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E503   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E523   ; Number of entities in coll_list
coll_src_left       EQU #E524   ; Source AABB left edge (scratch)
coll_src_right      EQU #E525   ; Source AABB right edge (scratch)
coll_src_top        EQU #E526   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E527   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E528   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E528   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E52A   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E52C   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E52E   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E530   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E532   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E534   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E536   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E538   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E539   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E53E   ; Frame counter (16-bit)
task_exec_time          EQU #E540   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E542   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E543   ; 1 while the H.TIMI dispatcher is running
RAM_INTERRUPT_END       EQU #E544   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E544   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E545   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E546   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E547   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E548   ; 0=stopped, 1=track active
music_muted          EQU #E549   ; 0=audible, 1=muted/pause
music_loop           EQU #E54A   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E54B   ; Current ROM track index
music_row_frames     EQU #E54C   ; Frames per tracker row
music_row_countdown  EQU #E54D   ; Countdown to next row
music_order_pos      EQU #E54E   ; Current order position
music_pattern_index  EQU #E54F   ; Current pattern index
music_pattern_row    EQU #E550   ; Current row inside pattern
music_pattern_rows   EQU #E551   ; Cached rows in current pattern
music_track_ptr_l    EQU #E552   ; Current track pointer low byte
music_track_ptr_h    EQU #E553   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E554   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E555   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E556   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E557   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E558   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E559   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E55A   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E55A   ; Channel A
music_ch_b_note EQU #E55B   ; Channel B
music_ch_c_note EQU #E55C   ; Channel C
music_ch_instrument_base EQU #E55D   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E55D   ; Channel A
music_ch_b_instrument EQU #E55E   ; Channel B
music_ch_c_instrument EQU #E55F   ; Channel C
music_ch_ornament_base EQU #E560   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E560   ; Channel A
music_ch_b_ornament EQU #E561   ; Channel B
music_ch_c_ornament EQU #E562   ; Channel C
music_ch_volume_base EQU #E563   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E563   ; Channel A
music_ch_b_volume EQU #E564   ; Channel B
music_ch_c_volume EQU #E565   ; Channel C
music_ch_vol_step_base EQU #E566   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E566   ; Channel A
music_ch_b_vol_step EQU #E567   ; Channel B
music_ch_c_vol_step EQU #E568   ; Channel C
music_ch_tone_step_base EQU #E569   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E569   ; Channel A
music_ch_b_tone_step EQU #E56A   ; Channel B
music_ch_c_tone_step EQU #E56B   ; Channel C
music_ch_noise_step_base EQU #E56C   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E56C   ; Channel A
music_ch_b_noise_step EQU #E56D   ; Channel B
music_ch_c_noise_step EQU #E56E   ; Channel C
music_ch_orn_step_base EQU #E56F   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E56F   ; Channel A
music_ch_b_orn_step EQU #E570   ; Channel B
music_ch_c_orn_step EQU #E571   ; Channel C
music_ch_hw_env_step_base EQU #E572   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E572   ; Channel A
music_ch_b_hw_env_step EQU #E573   ; Channel B
music_ch_c_hw_env_step EQU #E574   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E575   ; End of project variables (9589 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E575: Project variables (9589 bytes)
;   #E575-#E600: Alignment padding/free RAM (139 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (792 -> 728 bytes)
...
load_pattern_bank0:
    ...
    ld bc, 792    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 792    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (792 -> 398 bytes)
    ...
    DB #FF,#49,#56,#AB,#67,#5A,#87,#C0,#E7,#F9,#80,#55,#55,#80
load_color_bank0:
    ...
    ld bc, 792     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
SCREEN_PAN1_0_BOSS_TABLE:
    ...
    db 13, 9, 0, 1, 1, 100, 0    ; xChar,yChar,initialPhase,flags,updateEveryNFrames,healthLo,healthHi
...
boss_0_new_boss_phase_0:
    db #00, #00, #09, #0C    ; healthThreshold,buildType,width,height
...
boss_0_new_boss_phase_0_tiles:
    db #80, #80, #80, #82, #83, #84, #85, #86, #80, #80, #80, #87, #88, #89, #8A, #8B
    db #8C, #8D, #80, #8E, #8F, #90, #91, #92, #93, #94, #95, #80, #96, #97, #98, #91
    db #9A, #9B, #9C, #9D, #80, #9E, #9F, #A0, #A1, #A2, #A3, #A4, #A5, #80, #A6, #A7
    db #A8, #A9, #AA, #AB, #AC, #AD, #80, #AE, #AF, #B0, #B1, #B2, #B3, #B4, #B5, #B6
    db #B7, #B8, #B9, #BA, #BB, #BC, #BD, #BE, #FF, #C0, #C1, #C2, #C3, #C4, #C5, #C6
    db #C7, #C8, #C9, #CA, #CB, #CC, #CD, #CE, #CF, #D0, #D1, #D2, #D3, #D4, #D5, #D6
    db #D7, #D8, #D9, #DA, #DB, #DC, #DD, #DE, #DF, #E0, #E1, #E2
...
boss_0_new_boss_phase_0_forms_1:
    db #80, #80, #80, #82, #83, #84, #85, #86, #80, #80, #80, #87, #88, #89, #8A, #8B
    db #8C, #8D, #80, #8E, #8F, #90, #91, #92, #93, #94, #95, #80, #96, #97, #98, #99
    db #9A, #9B, #9C, #9D, #80, #9E, #9F, #A0, #A1, #A2, #A3, #A4, #A5, #80, #A6, #A7
    db #A8, #A9, #AA, #AB, #AC, #AD, #80, #AE, #AF, #B0, #B1, #B2, #B3, #B4, #B5, #B6
...
gameflow_node_gfn_1777714943518_data:
    dw load_world_worldmap_1777714932973
    db ((load_world_worldmap_1777714932973 - #4000) / #2000)
...
load_world_worldmap_1777714932973:
    ...
    ld a, ((load_screen_pan1_777714750807 - #4000) / #2000)
    ld hl, load_screen_pan1_777714750807
    call mapper_call_hl_auto
