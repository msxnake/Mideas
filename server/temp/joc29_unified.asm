...
; Estimated payload bytes: 70224
; Estimated banks used: 9
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (1336 bytes)
; BANK 00 @#0598 : colors.asm (1232 bytes)
; BANK 00 @#0A68 : components.asm (22 bytes)
; BANK 00 @#0A7E : entities.asm (3465 bytes)
; BANK 00 @#1807 : worlds.asm (1793 bytes)
; BANK 00 @#1F08 : screens.asm part 1/2 (248 bytes)
; BANK 01 @#0000 : screens.asm part 2/2 (8192 bytes)
; BANK 02 @#0000 : screens.asm part 3/2 (1352 bytes)
; BANK 02 @#0548 : sprites.asm (4128 bytes)
; BANK 02 @#1568 : font.asm (2712 bytes)
; BANK 03 @#0000 : font.asm (744 bytes)
; BANK 03 @#02E8 : hud.asm (3480 bytes)
; BANK 03 @#1080 : menus.asm (168 bytes)
; BANK 03 @#1128 : sound.asm part 1/2 (3800 bytes)
; BANK 04 @#0000 : sound.asm part 2/2 (5748 bytes)
; BANK 04 @#1674 : scroll.asm (2353 bytes)
; BANK 04 @#1FA5 : animtiles.asm (91 bytes)
; BANK 05 @#0000 : animtiles.asm (5189 bytes)
; BANK 05 @#1445 : statemachine.asm part 1/3 (3003 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 07 @#0000 : statemachine.asm part 3/3 (6751 bytes)
; BANK 07 @#1A5F : gameflow.asm (1441 bytes)
; BANK 08 @#0000 : gameflow.asm (4688 bytes)
...
entity_x_pos        EQU #DD3A   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DD5A   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DD7A   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DD9A   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DDBA   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DDDA   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DDFA   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DE1A   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DE3A   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DE5A   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DE5B   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DE7B   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DE9B   ; Entity health (32 bytes)
entity_anim_frame   EQU #DEBB   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DEDB   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DEFB   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DF1B   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DF3B   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DF5B   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DF7B   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DF9B   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DFBB   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DFDB   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DFFB   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #E01B   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E03B   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E05B   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E07B   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E09B   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E0BB   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E0DB   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E0FB   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E11B   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E13B   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E15B   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E17B   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E19B   ; Number of sprites currently active
sprites_dirty      EQU #E19C   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E19D   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E1BD   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E1DD   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E1FD   ; Runtime base 16x16 slot per sprite asset (4 bytes)
sprite_placeholder_base_pattern_num EQU #E201   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E202   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E203   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #E283   ; Currently displayed screen ID
screen_dirty_flag   EQU #E284   ; Screen needs redraw flag
screen_transition_cooldown EQU #E285   ; Cooldown frames after screen transition
current_world_id    EQU #E286   ; Current world ID (for multi-world support)
current_screen_index EQU #E287   ; Current screen index within world
current_screen_anim_group_count EQU #E288   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E289   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E28A   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E28B   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E28C   ; Player X position (16-bit)
player_y            EQU #E28E   ; Player Y position (16-bit)
player_runtime_enabled EQU #E290   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E291   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E292   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E293   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E294   ; Player health points
player_score        EQU #E295   ; Player score (16-bit)
gem_count           EQU #E297   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E298   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E299   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E29A   ; Interaction type id of last interacted tile
last_interaction_value EQU #E29B   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E29C   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E29D   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E29E   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E29F   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E2A0   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E2A1   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E2E1   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E321   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E361   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E3A1   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E3B1   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E3C1   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E3D1   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E3E1   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E3F1   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E401   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E402   ; Temporary 16-bit storage
temp_word_2         EQU #E404   ; Temporary 16-bit storage
temp_byte_1         EQU #E406   ; Temporary 8-bit storage
temp_byte_2         EQU #E407   ; Temporary 8-bit storage
temp_byte_3         EQU #E408   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E428   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E448   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E468   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E488   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E489   ; Frames remaining for current SFX
sfx_fadeout         EQU #E48A   ; Reserved fadeout flag/state
temp_byte_7         EQU #E48B   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E4AB   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E4CB   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E4EB   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E50B   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E52B   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E54B   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E56B   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E58B   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E5AB   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E5CB   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E5EB   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E60B   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E62B   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E64B   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E66B   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E68B   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E6AB   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E6CB   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E6EB   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E72B   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E76B   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E78B   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E7AB   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E7CB   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E7CC   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E7CD   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E7CE   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E7CF   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E7D0   ; Cached entity X for wall checks
wall_temp_y         EQU #E7D1   ; Cached entity Y for wall checks
wall_hit_left       EQU #E7D2   ; Hitbox left edge cache
wall_hit_top        EQU #E7D3   ; Hitbox top edge cache
wall_hit_right      EQU #E7D4   ; Hitbox right edge cache
wall_hit_bottom     EQU #E7D5   ; Hitbox bottom edge cache
wall_hit_w          EQU #E7D6   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E7D7   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E7D8   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E7D9   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E7DA   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E7DB   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E7DC   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E7FC   ; Number of entries in active_entity_list
hero_entity_id      EQU #E7FD   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E7FE   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E7FF   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E81F   ; Number of entries in input_entity_list
render_entity_list  EQU #E820   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E840   ; Number of entries in render_entity_list
collision_entity_list EQU #E841   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E861   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E862   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E882   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E883   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E8A3   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E8A4   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E8C4   ; Number of entities in coll_list
coll_src_left       EQU #E8C5   ; Source AABB left edge (scratch)
coll_src_right      EQU #E8C6   ; Source AABB right edge (scratch)
coll_src_top        EQU #E8C7   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E8C8   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E8C9   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E8C9   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E8CB   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E8CD   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E8CF   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E8D1   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E8D3   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E8D5   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E8D7   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E8D9   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E8DA   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E8DF   ; Frame counter (16-bit)
task_exec_time          EQU #E8E1   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E8E3   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E8E4   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E8E4   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E8E5   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E8E6   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E8E7   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E8E8   ; 0=stopped, 1=track active
music_muted          EQU #E8E9   ; 0=audible, 1=muted/pause
music_loop           EQU #E8EA   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E8EB   ; Current ROM track index
music_row_frames     EQU #E8EC   ; Frames per tracker row
music_row_countdown  EQU #E8ED   ; Countdown to next row
music_order_pos      EQU #E8EE   ; Current order position
music_pattern_index  EQU #E8EF   ; Current pattern index
music_pattern_row    EQU #E8F0   ; Current row inside pattern
music_pattern_rows   EQU #E8F1   ; Cached rows in current pattern
music_track_ptr_l    EQU #E8F2   ; Current track pointer low byte
music_track_ptr_h    EQU #E8F3   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E8F4   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E8F5   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E8F6   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E8F7   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E8F7   ; Channel A
music_ch_b_note EQU #E8F8   ; Channel B
music_ch_c_note EQU #E8F9   ; Channel C
music_ch_instrument_base EQU #E8FA   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E8FA   ; Channel A
music_ch_b_instrument EQU #E8FB   ; Channel B
music_ch_c_instrument EQU #E8FC   ; Channel C
music_ch_ornament_base EQU #E8FD   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E8FD   ; Channel A
music_ch_b_ornament EQU #E8FE   ; Channel B
music_ch_c_ornament EQU #E8FF   ; Channel C
music_ch_volume_base EQU #E900   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E900   ; Channel A
music_ch_b_volume EQU #E901   ; Channel B
music_ch_c_volume EQU #E902   ; Channel C
music_ch_vol_step_base EQU #E903   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E903   ; Channel A
music_ch_b_vol_step EQU #E904   ; Channel B
music_ch_c_vol_step EQU #E905   ; Channel C
music_ch_tone_step_base EQU #E906   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E906   ; Channel A
music_ch_b_tone_step EQU #E907   ; Channel B
music_ch_c_tone_step EQU #E908   ; Channel C
music_ch_noise_step_base EQU #E909   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E909   ; Channel A
music_ch_b_noise_step EQU #E90A   ; Channel B
music_ch_c_noise_step EQU #E90B   ; Channel C
music_ch_orn_step_base EQU #E90C   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E90C   ; Channel A
music_ch_b_orn_step EQU #E90D   ; Channel B
music_ch_c_orn_step EQU #E90E   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E90F   ; End of project variables (10511 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E90F: Project variables (10511 bytes)
;   #E90F-#F37F: Free RAM (~2673 bytes available)
...
;   Active entities: 1
;   Used components: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors, WallCollision, StateMachine, comp_tile_collector, TileInteraction
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors, WallCollision, StateMachine, comp_tile_collector, TileInteraction 
...
sprite_asset_base_pattern_slot_worldmap_1776512078647:
    ...
    db 2 ; Sprite 1: hero_idle
    db 0 ; Sprite 2: cuadro
    db 3 ; Sprite 3: hero_walk_right
...
SCREEN_PAN1_0_BLOCK_CATALOG_COUNT EQU 29
SCREEN_PAN1_0_BLOCK_CATALOG_SIZE EQU 464
...
SCREEN_PAN1_0_BLOCK_TOTAL_SIZE EQU 512
SCREEN_PAN1_0_ANIM_GROUP_COUNT EQU 1
SCREEN_PAN1_0_ENTITY_COUNT EQU 1
SCREEN_PAN1_0_SPRITE_PATTERN_SLOTS EQU 6
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ...
    ; 29 unique blocks, 464 bytes total
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #80,#81,#80,#81,#82,#FF,#FF,#FF,#80,#FF,#FF,#FF,#82,#FF,#FF,#FF
    DB #80,#81,#80,#81,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #80,#81,#80,#81,#FF,#FF,#FF,#83,#FF,#FF,#FF,#81,#FF,#FF,#FF,#83
    DB #80,#FF,#FF,#FF,#82,#FF,#FF,#FF,#80,#FF,#FF,#FF,#82,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#84,#FF,#88,#FF,#84,#80,#81,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#85,#FF,#FF,#FF,#80,#81
    DB #FF,#FF,#FF,#FF,#80,#81,#FF,#FF,#82,#83,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#85,#FF,#FF,#80,#81,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #85,#FF,#FF,#81,#80,#81,#FF,#83,#FF,#FF,#FF,#81,#FF,#FF,#FF,#83
    DB #80,#FF,#FF,#88,#82,#FF,#80,#81,#80,#FF,#82,#83,#82,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#80,#81,#FF,#FF,#82,#83,#80,#81
    DB #84,#82,#83,#FF,#84,#FF,#FF,#FF,#84,#FF,#FF,#FF,#84,#FF,#FF,#FF
    DB #FF,#84,#FF,#FF,#FF,#84,#80,#81,#FF,#84,#82,#83,#FF,#84,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#80,#81,#FF,#FF,#82,#83,#FF,#FF
    DB #FF,#FF,#FF,#81,#FF,#FF,#FF,#83,#FF,#FF,#FF,#81,#FF,#FF,#FF,#83
    DB #FF,#FF,#82,#83,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    ...
    DB #80,#FF,#FF,#FF,#82,#FF,#FF,#FF,#80,#FF,#FF,#FF,#82,#83,#82,#83
    DB #FF,#FF,#FF,#FF,#85,#FF,#88,#FF,#80,#81,#80,#81,#82,#83,#82,#83
    DB #84,#FF,#FF,#FF,#84,#FF,#87,#FF,#80,#81,#80,#81,#82,#83,#82,#83
    DB #FF,#84,#FF,#FF,#FF,#84,#FF,#87,#80,#81,#80,#81,#82,#83,#82,#83
...
SCREEN_PAN1_0_BLOCK_MAP:
    ...
    ; 512 bytes optimized vs 768 raw (256 byte delta)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#02,#02,#02,#02,#02,#02,#03
    DB #04,#00,#05,#00,#06,#07,#08,#09,#0A,#0B,#0C,#0D,#00,#00,#0E,#0F
    DB #04,#10,#11,#12,#13,#14,#00,#0F,#15,#16,#17,#18,#19,#1A,#1B,#1C
...
SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #10,#10,#10,#10,#00,#08,#00,#08,#08,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_PAN1_0_INTERACTION_TYPE_MAP:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#07,#00,#00,#00,#00,#07,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#01,#00,#05,#00,#07,#00,#05,#00,#00,#07,#00,#05
...
SCREEN_PAN1_0_INTERACTION_VALUE_MAP:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    DB #01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#01
    DB #01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#01,#01,#01,#01,#00,#01
    DB #01,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00,#00,#00,#00,#00
    DB #00,#00,#01,#00,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    DB #01,#00,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#00,#00,#00
    DB #00,#00,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    DB #01,#00,#00,#01,#00,#00,#00,#00,#01,#01,#01,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    DB #01,#00,#01,#01,#00,#00,#00,#00,#01,#00,#00,#00,#00,#01,#01,#01
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    DB #01,#00,#01,#01,#01,#01,#00,#00,#01,#00,#00,#00,#00,#01,#01,#01
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#00,#01
    DB #01,#00,#00,#00,#01,#01,#01,#01,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#00,#01
    DB #01,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    ...
    DB #01,#00,#00,#00,#01,#00,#01,#00,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
...
SM_New_Statemachine_state_1776707744092_Transitions_Actions_2: 
    ...
    DB 16, 1        ; buttons_activated (ID 16)
    DB 0xFF; END
SM_New_Statemachine_state_1776707744092_Transitions_Actions_3: 
    DB 14; INCREMENT_VARIABLE 
    DB 15, 500        ; Score (ID 15)
    DB 13; SET_VARIABLE 
    DB 17, 1        ; buttons_reward_granted (ID 17)
    DB 0xFF; END
