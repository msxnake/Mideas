...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #02,#C0,#15,#FD,#CF,#C0,#57,#35,#C0,#99,#11,#11,#11,#1C,#84,#F8
    DB #78,#C6,#F0,#C0,#13,#58,#90,#5F,#EE,#2E,#08,#90,#43,#97,#98,#D5
...
BEHAVIOR_PAN3_3_DATA:
    ...
    DB #85,#00,#56,#95,#10,#7D,#82,#4E,#C0,#69,#08,#47,#F0,#C5,#58,#78
    DB #40,#46,#95,#00,#3D,#FA,#FE,#F6,#E8,#78,#40,#41,#CD,#54,#18,#95
    DB #08,#10,#7C,#C0,#00,#FF,#FE,#E0,#1E,#C0,#13,#DD,#96,#C0,#40,#F5
    DB #C0,#69,#08,#3D,#F1,#25,#82,#1E,#C0,#01,#35,#55,#58
