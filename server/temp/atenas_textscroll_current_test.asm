...
; Bank 2 [#8000-#A000]: components_tail, gameflow (20282/8192 bytes est.)
...
; Bank 7 [#6000-#8000]: screen_loaders (4557/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 8 [#6000-#8000]: gameflow_aux (4491/8192 bytes est.) [FAR — accessed via trampoline]
...
; ------------------------------------------------------------------
; Far code banks: bank4(font) bank5(entities) bank6(sound) bank7(screen_loaders) bank8(gameflow_aux) bank9(sprites) bank10(animtiles) bank11(scroll) bank12(worlds) bank13(screens_code) bank14(bosses) bank15(hud) bank16(patterns_code) bank17(colors_code)
; ------------------------------------------------------------------
...
; BANK 08 @#0000 : gameflow.asm part 3/3 (7197 bytes); ==================================================================
...
; - gameflow: 14377 estimated bytes
; - gameflow_aux: 4491 estimated bytes
...
;         {
;           "key": "screen_loaders",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 4; physical bank 7; executes through P1/#6000 after reserved asset-data banks; module screen_loaders is callable only through bank-0 far trampolines",
;           "estimatedBytes": 4557
;         }
;       ]
;     },
...
;       "estimatedUsedBytes": 4491,
;       "estimatedFreeBytes": 3701,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "gameflow_aux",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 5; physical bank 8; executes through P1/#6000 after reserved asset-data banks; module gameflow_aux is callable only through bank-0 far trampolines",
;           "estimatedBytes": 4491
;         }
;       ]
;     },
...
; The scroll then uses fixed pattern masks and animates color rows.
; ------------------------------------------------------------------
...
; ##################################################################
; FAR BANK 8 — [#6000h-#8000h] FAR CODE: gameflow_aux
; Accessed ONLY via trampolines in bank 0 (entrypoint_far labels).
