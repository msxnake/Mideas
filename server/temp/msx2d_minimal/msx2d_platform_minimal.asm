...
; BANK 06 @#0000 : components.asm part 7/7 (1270 bytes)
; BANK 06 @#04F6 : entities.asm (4481 bytes)
; BANK 06 @#1677 : worlds.asm (162 bytes)
; BANK 06 @#1719 : screens.asm part 1/2 (2279 bytes)
; BANK 07 @#0000 : screens.asm part 2/2 (8192 bytes)
; BANK 08 @#0000 : screens.asm part 3/2 (576 bytes)
; BANK 08 @#0240 : sprites.asm (3774 bytes)
; BANK 08 @#10FE : font.asm (174 bytes)
; BANK 08 @#11AC : hud.asm (79 bytes)
; BANK 08 @#11FB : menus.asm (168 bytes)
; BANK 08 @#12A3 : sound.asm part 1/2 (3421 bytes)
; BANK 09 @#0000 : sound.asm part 2/2 (6120 bytes)
; BANK 09 @#17E8 : scroll.asm (2072 bytes)
; BANK 10 @#0000 : scroll.asm (270 bytes)
; BANK 10 @#010E : animtiles.asm (4613 bytes)
; BANK 10 @#1313 : statemachine.asm (5 bytes)
; BANK 10 @#1318 : gameflow.asm (383 bytes)
...
;   Active entities: 1
;   Used components: Position, Sprite, Movement, Health, Collision, WallCollision, Input, Cursors, Gravity, Jump, AirControl, WallGrab, WallJump, DeadlyTiles, Animation, StateMachine
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Movement, Health, Collision, WallCollision, Input, Cursors, Gravity, Jump, AirControl, WallGrab, WallJump, DeadlyTiles, Animation, StateMachine 
