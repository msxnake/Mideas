...
; BANK 05 @#0000 : components.asm part 6/6 (743 bytes)
; BANK 05 @#02E7 : entities.asm (4424 bytes)
; BANK 05 @#142F : worlds.asm (162 bytes)
; BANK 05 @#14D1 : screens.asm part 1/2 (2863 bytes)
; BANK 06 @#0000 : screens.asm part 2/2 (8164 bytes)
; BANK 06 @#1FE4 : sprites.asm (28 bytes)
; BANK 07 @#0000 : sprites.asm (3741 bytes)
; BANK 07 @#0E9D : font.asm (174 bytes)
; BANK 07 @#0F4B : hud.asm (79 bytes)
; BANK 07 @#0F9A : menus.asm (168 bytes)
; BANK 07 @#1042 : sound.asm part 1/2 (4030 bytes)
; BANK 08 @#0000 : sound.asm part 2/2 (5511 bytes)
; BANK 08 @#1587 : scroll.asm (2342 bytes)
; BANK 08 @#1EAD : animtiles.asm (339 bytes)
; BANK 09 @#0000 : animtiles.asm (4274 bytes)
; BANK 09 @#10B2 : statemachine.asm (5 bytes)
; BANK 09 @#10B7 : gameflow.asm (383 bytes)
...
;   Active entities: 1
;   Used components: Position, Sprite, Movement, Health, Collision, WallCollision, Input, Cursors, TileInteraction, Animation, StateMachine
;   Filtered out: -3 unused component systems
    ;
; ==================================================================
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Movement, Health, Collision, WallCollision, Input, Cursors, TileInteraction, Animation, StateMachine 
