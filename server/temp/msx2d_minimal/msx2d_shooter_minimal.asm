...
; BANK 04 @#0000 : components.asm part 5/5 (4563 bytes)
; BANK 04 @#11D3 : entities.asm (3629 bytes)
; BANK 05 @#0000 : entities.asm (890 bytes)
; BANK 05 @#037A : worlds.asm (162 bytes)
; BANK 05 @#041C : screens.asm part 1/2 (7140 bytes)
; BANK 06 @#0000 : screens.asm part 2/2 (3887 bytes)
; BANK 06 @#0F2F : sprites.asm (3762 bytes)
; BANK 06 @#1DE1 : font.asm (174 bytes)
; BANK 06 @#1E8F : hud.asm (79 bytes)
; BANK 06 @#1EDE : menus.asm (168 bytes)
; BANK 06 @#1F86 : sound.asm part 1/2 (122 bytes)
; BANK 07 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 08 @#0000 : sound.asm part 3/2 (1227 bytes)
; BANK 08 @#04CB : scroll.asm (2342 bytes)
; BANK 08 @#0DF1 : animtiles.asm (4613 bytes)
; BANK 08 @#1FF6 : statemachine.asm (5 bytes)
; BANK 08 @#1FFB : gameflow.asm (5 bytes)
; BANK 09 @#0000 : gameflow.asm (378 bytes)
...
;   Active entities: 1
;   Used components: Position, Sprite, Movement, Health, Collision, Input, Cursors, Shoot, Animation, StateMachine
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Movement, Health, Collision, Input, Cursors, Shoot, Animation, StateMachine 
