; ==================================================================
; MSX2D_SHOOTER_MINIMAL - UNIFIED FILE
...
; BANK 04 @#0000 : components.asm part 5/5 (7243 bytes)
; BANK 04 @#1C4B : entities.asm (949 bytes)
; BANK 05 @#0000 : entities.asm (4340 bytes)
; BANK 05 @#10F4 : worlds.asm (172 bytes)
; BANK 05 @#11A0 : screens.asm part 1/2 (3680 bytes)
; BANK 06 @#0000 : screens.asm part 2/2 (7995 bytes)
; BANK 06 @#1F3B : sprites.asm (197 bytes)
; BANK 07 @#0000 : sprites.asm (4021 bytes)
; BANK 07 @#0FB5 : font.asm (177 bytes)
; BANK 07 @#1066 : hud.asm (114 bytes)
; BANK 07 @#10D8 : menus.asm (219 bytes)
; BANK 07 @#11B3 : sound.asm (3661 bytes)
; BANK 08 @#0000 : sound.asm (1102 bytes)
; BANK 08 @#044E : scroll.asm (2407 bytes)
; BANK 08 @#0DB5 : animtiles.asm (2640 bytes)
; BANK 08 @#1805 : bosses.asm (331 bytes)
; BANK 08 @#1950 : statemachine.asm (5 bytes)
; BANK 08 @#1955 : gameflow.asm (448 bytes)
...
load_sprite_patterns_default:
    ...
    ld a, 4
    ld (sprite_placeholder_base_pattern_num), a
    ; Sprite Asset 2: Ship frame 0 (1 layers)
    ld hl, SHIP_2_F0_LAYER1
    ld de, SPRPAT + (0 * 32)
    ld bc, 32
    call FAST_LDIRVM
...
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_ID EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_LAYOUT_BANK EQU ((SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_LAYOUT - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BEHAVIOR_SOURCE EQU 0
BEHAVIOR_MSX2D_SHOOTER_MINIMAL_SCREEN_0_DATA_BANK EQU ((BEHAVIOR_MSX2D_SHOOTER_MINIMAL_SCREEN_0_DATA - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_CHAR_BEHAVIOR_TABLE_BANK EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_CHAR_BEHAVIOR_TABLE_SIZE EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TYPE_MAP_BANK EQU ((SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TYPE_MAP - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_VALUE_MAP_BANK EQU ((SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_VALUE_MAP - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TARGET_MAP_BANK EQU ((SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TARGET_MAP - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECTS_LAYOUT_BANK EQU ((SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECTS_LAYOUT - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECTS_LAYOUT_PRESENT EQU 1
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECTS_LAYOUT_SIZE EQU 768
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECT_ZONE_TABLE_BANK EQU ((SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECT_ZONE_TABLE - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECT_ZONE_COUNT EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECT_ZONE_TABLE_SIZE EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BOSS_TABLE_BANK EQU ((SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BOSS_TABLE - #4000) / #2000)
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BOSS_COUNT EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BOSS_TABLE_SIZE EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_LAYOUT_PRESENT EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_LAYOUT_MODE EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_CATALOG_BANK EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_CATALOG_COUNT EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_CATALOG_SIZE EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_MAP_BANK EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_MAP_WIDTH EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_MAP_HEIGHT EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_MAP_SIZE EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BLOCK_TOTAL_SIZE EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_ANIM_GROUP_COUNT EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_ENTITY_COUNT EQU 1
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_SPRITE_PATTERN_SLOTS EQU 2
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_MUSIC_IN_GAME EQU 0
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_SUMMARY_FLAGS EQU #04
...
screen_runtime_summary_table:
    db 0, 1, 2, #04    ; Screen 0: msx2d_shooter_minimal_screen

; ==================================================================
; SCREEN MAP DATA
; ==================================================================

;; MAP: msx2d_shooter_minimal_screen_0 (32x24 tiles)
;; Total size: 768 bytes

;; --- TILE INDEX REFERENCES for MSX2D_SHOOTER_MINIMAL_SCREEN_0 ---
; Generated using exact Screen Editor layout export logic
; Byte values represent actual character codes in VRAM

SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_WIDTH     EQU 32
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_HEIGHT    EQU 24
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_SIZE      EQU 768

SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_LAYOUT:
...
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECTS_LAYOUT:
    ; Alternate Effects layer for msx2d_shooter_minimal_screen
...
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECT_ZONE_TABLE:
    ; No effect zones exported for msx2d_shooter_minimal_screen
    DB #00

SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BOSS_TABLE:
    db 0    ; No boss placements


;; BEHAVIOR MAP: msx2d_shooter_minimal_screen_0 (32x24 tiles)
;; Total size: 768 bytes (Map IDs 0-255)
;; Data format: HEX

BEHAVIOR_MSX2D_SHOOTER_MINIMAL_SCREEN_0_WIDTH     EQU 32
BEHAVIOR_MSX2D_SHOOTER_MINIMAL_SCREEN_0_HEIGHT    EQU 24
BEHAVIOR_MSX2D_SHOOTER_MINIMAL_SCREEN_0_SIZE      EQU 768

BEHAVIOR_MSX2D_SHOOTER_MINIMAL_SCREEN_0_DATA:
...
;; End of Behavior Map Data for msx2d_shooter_minimal_screen_0

SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TYPE_MAP:
    ; msx2d_shooter_minimal_screen - per-cell interaction type map
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_VALUE_MAP:
    ; msx2d_shooter_minimal_screen - per-cell interaction value map
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TARGET_MAP:
    ; msx2d_shooter_minimal_screen - per-cell interaction target map
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; @mideas:block id=runtime.screens.load_screen_msx2d_shooter_minimal_screen_nimal_screen.loader kind=routine owner=screens roots=load_screen_msx2d_shooter_minimal_screen_nimal_screen
load_screen_msx2d_shooter_minimal_screen_nimal_screen:
    ; Load msx2d_shooter_minimal_screen screen (fast direct port access)
    ld a, 1
    ...
    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_LAYOUT
    ld de, runtime_background_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_LAYOUT
    ...
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECTS_LAYOUT
    ld de, runtime_effects_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, BEHAVIOR_MSX2D_SHOOTER_MINIMAL_SCREEN_0_DATA
    ld de, runtime_behavior_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TYPE_MAP
    ld de, runtime_interaction_type_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_VALUE_MAP
    ld de, runtime_interaction_value_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_INTERACTION_TARGET_MAP
    ...
    or a
    jr z, .load_msx2d_shooter_minimal_screen_nimal_screen_zones_done
    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_EFFECT_ZONE_TABLE
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
.load_msx2d_shooter_minimal_screen_nimal_screen_zones_done:
    ...
    ld a, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_SUMMARY_FLAGS
    ld (current_screen_summary_flags), a
    ld a, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BOSS_COUNT
    ld (current_screen_boss_count), a
    or a
    jp z, load_msx2d_shooter_minimal_screen_nimal_screen_boss_done
    ld hl, SCREEN_MSX2D_SHOOTER_MINIMAL_SCREEN_0_BOSS_TABLE
...
load_msx2d_shooter_minimal_screen_nimal_screen_boss_done:
    ...
    ldir
    ret
; @mideas:endblock id=runtime.screens.load_screen_msx2d_shooter_minimal_screen_nimal_screen.loader
...
;   Active entities: 1
;   Used components: Position, Sprite, Movement, Health, Collision, Input, Cursors, LimitOn, Shoot, Animation, StateMachine
;   Dynamic platform riding: STUB
;   Filtered out: 17 unused component systems
    ;
; ==================================================================
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Movement, Health, Collision, Input, Cursors, LimitOn, Shoot, Animation, StateMachine 
...
.update_all_entities_player:
    ...
    call update_shoot_component         ; 2. Shooting
    ; Shooting may spawn entities, rebuild only if marked dirty
    call ensure_used_entity_list_current
...
; Entity: tpl_msx_shooter_player_instance (instance from template: tpl_msx_shooter_player)
ENTITY_TPL_MSX_SHOOTER_PLAYER_INSTANCE_ID EQU 0
ENTITY_TPL_MSX_SHOOTER_PLAYER_INSTANCE_COMP_MASK EQU #10DF  ; Component mask: 1000011011111b
; Template: tpl_msx_shooter_player
ENTITY_TPL_MSX_SHOOTER_PLAYER_INSTANCE_X EQU 4
ENTITY_TPL_MSX_SHOOTER_PLAYER_INSTANCE_Y EQU 10
...
init_entities:
    ...
    call init_tpl_msx_shooter_player_instance
...
update_entities:
    ...
    call update_tpl_msx_shooter_player_instance
.skip_update_0:
    ret

; @mideas:block id=data.entities.tpl_msx_shooter_player_instance.init kind=routine owner=entities roots=init_tpl_msx_shooter_player_instance
init_tpl_msx_shooter_player_instance:
    ; Initialize tpl_msx_shooter_player_instance at real position from JSON
    ; JSON position: (4, 10) tiles = (32, 80) pixels
    ; Template: tpl_msx_shooter_player
    ; Components: Position, Sprite, Movement, Collision, Input, Health, Animation
    ...
    ld hl, entity_shoot_speed
    add hl, de
    ld (hl), #04      ; projectile speed

    ld hl, entity_shoot_sprite_id
    add hl, de
    ld (hl), #03      ; projectile sprite asset index

    ld hl, entity_shoot_trigger
    add hl, de
    ld (hl), #00      ; shoot trigger action
...
.skip_force_show_0:
    ...
    ret
; @mideas:endblock id=data.entities.tpl_msx_shooter_player_instance.init

update_tpl_msx_shooter_player_instance:
    ; Update tpl_msx_shooter_player_instance logic with real behavior
