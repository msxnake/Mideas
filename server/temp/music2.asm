...
; BANK 02 @#0000 : sound.asm part 3/2 (701 bytes)
; BANK 02 @#02BD : scroll.asm (2407 bytes)
; BANK 02 @#0C24 : animtiles.asm (2549 bytes)
; BANK 02 @#1619 : bosses.asm (2535 bytes)
; BANK 03 @#0000 : bosses.asm (3247 bytes)
; BANK 03 @#0CAF : statemachine.asm (5 bytes)
; BANK 03 @#0CB4 : gameflow.asm (4913 bytes)
...
; Flow: Start → Music (gf_music2_music)
; ==================================================================
...
music_track_ptr_table:
    DW music_track_0_music2_data

; ------------------------------------------------------------------
; Tracker Song 0: music2
; ------------------------------------------------------------------
music_track_0_music2_data:
    DB #08
    DB #01
    DB #00
    DB #01
    DB #01
    DW music_track_0_music2_order_table
    DW music_track_0_music2_pattern_table
    DW music_track_0_music2_instrument_ptr_table
    DW music_track_0_music2_ornament_ptr_table
    DW #00D2
    DB #10

music_track_0_music2_order_table:
    DB #00

music_track_0_music2_pattern_table:
    DW music_track_0_music2_pattern_0_rows
    DB #40

music_track_0_music2_instrument_ptr_table:
    DW 0
    DW music_track_0_music2_inst_1
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_music2_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_music2_pattern_0_rows:
    ...
    DB #34,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #32,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    ...
    DB #32,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #35,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
...
music_track_0_music2_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_music2_inst_1_vol_env
    DB #0B
    DB #FF
    DW music_track_0_music2_inst_1_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_music2_inst_1_vol_env:
    DB #0F,#0E,#0D,#0B,#09,#07,#05,#03,#02,#01,#00
music_track_0_music2_inst_1_tone_env:
    DB #00
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_music2_start
...
; Node: Start - "gf_music2_start"
gameflow_node_gf_music2_start:
    db NODE_TYPE_START
    dw gameflow_node_gf_music2_start_data
    dw gameflow_node_gf_music2_start_conn

gameflow_node_gf_music2_start_data:
    dw gameflow_node_gf_music2_start_init    ; Initialization routine address
    db ((gameflow_node_gf_music2_start_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_music2_start_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_music2_music
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_music2_start_init
...
; Node: Music - "gf_music2_music"
gameflow_node_gf_music2_music:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gf_music2_music_data
    dw gameflow_node_gf_music2_music_conn

gameflow_node_gf_music2_music_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gf_music2_music_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_music2_end
    db CONNECTION_END

; Node: End - "gf_music2_end"
gameflow_node_gf_music2_end:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gf_music2_end_conn

gameflow_node_gf_music2_end_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
