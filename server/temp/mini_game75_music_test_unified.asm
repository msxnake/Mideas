; ==================================================================
; MINI_GAME75_MUSIC_TEST - UNIFIED FILE
...
; Estimated payload bytes: 125597
...
; BANK 02 @#0000 : entities.asm part 3/3 (4742 bytes)
; BANK 02 @#1286 : worlds.asm (3450 bytes)
; BANK 03 @#0000 : worlds.asm (3957 bytes)
; BANK 03 @#0F75 : screens.asm part 1/3 (4235 bytes)
; BANK 04 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 05 @#0000 : screens.asm part 3/3 (7329 bytes)
; BANK 05 @#1CA1 : sprites.asm part 1/2 (863 bytes)
; BANK 06 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 07 @#0000 : sprites.asm part 3/2 (1834 bytes)
; BANK 07 @#072A : font.asm (3474 bytes)
; BANK 07 @#14BC : hud.asm (79 bytes)
; BANK 07 @#150B : menus.asm (437 bytes)
; BANK 07 @#16C0 : sound.asm part 1/2 (2368 bytes)
; BANK 08 @#0000 : sound.asm part 2/2 (6826 bytes)
; BANK 08 @#1AAA : scroll.asm (1366 bytes)
; BANK 09 @#0000 : scroll.asm (987 bytes)
; BANK 09 @#03DB : animtiles.asm (3835 bytes)
; BANK 09 @#12D6 : particles.asm (3370 bytes)
; BANK 10 @#0000 : particles.asm (1593 bytes)
; BANK 10 @#0639 : statemachine.asm part 1/4 (6599 bytes)
; BANK 11 @#0000 : statemachine.asm part 2/4 (8192 bytes)
; BANK 12 @#0000 : statemachine.asm part 3/4 (8192 bytes)
; BANK 13 @#0000 : statemachine.asm part 4/4 (7150 bytes)
; BANK 13 @#1BEE : gameflow.asm part 1/2 (1042 bytes)
; BANK 14 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 15 @#0000 : gameflow.asm part 3/2 (2717 bytes)
...
last_gem_char       EQU #CB8D   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #CB8E   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #CB8F   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #CBCF   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #CC0F   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #CC4F   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #CC8F   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #CC9F   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #CCAF   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #CCBF   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #CCCF   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #CCDF   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #CCEF   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #CCF0   ; Temporary 16-bit storage
temp_word_2         EQU #CCF2   ; Temporary 16-bit storage
temp_byte_1         EQU #CCF4   ; Temporary 8-bit storage
temp_byte_2         EQU #CCF5   ; Temporary 8-bit storage
temp_byte_3         EQU #CCF6   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #CD16   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #CD36   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #CD56   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #CD76   ; 0=no SFX active, 1=playing
sfx_timer           EQU #CD77   ; Frames remaining for current SFX
sfx_fadeout         EQU #CD78   ; Reserved fadeout flag/state
temp_byte_7         EQU #CD79   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CD99   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CDB9   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CDD9   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CDF9   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CE19   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CE39   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CE59   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CE79   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CE99   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CEB9   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CED9   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CEF9   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CF19   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CF39   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CF59   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CF79   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CF99   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CFB9   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CFD9   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #D019   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #D059   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #D079   ; Temporary 8-bit storage (32 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #D099   ; Cached entity X for wall checks
wall_temp_y         EQU #D09A   ; Cached entity Y for wall checks
wall_hit_left       EQU #D09B   ; Hitbox left edge cache
wall_hit_top        EQU #D09C   ; Hitbox top edge cache
wall_hit_right      EQU #D09D   ; Hitbox right edge cache
wall_hit_bottom     EQU #D09E   ; Hitbox bottom edge cache
wall_hit_w          EQU #D09F   ; Hitbox width cache (min 1)
wall_hit_h          EQU #D0A0   ; Hitbox height cache (min 1)
wall_probe_left     EQU #D0A1   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #D0A2   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #D0A3   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #D0A4   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #D0A5   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #D0C5   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #D0C6   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #D0C7   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #D0E7   ; Number of entities in coll_list
coll_src_left       EQU #D0E8   ; Source AABB left edge (scratch)
coll_src_right      EQU #D0E9   ; Source AABB right edge (scratch)
coll_src_top        EQU #D0EA   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #D0EB   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #D0EC   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #D0EC   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #D0EE   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #D0F0   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #D0F2   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #D0F4   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #D0F6   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #D0F8   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #D0FA   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #D0FC   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #D0FD   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #D102   ; Frame counter (16-bit)
task_exec_time          EQU #D104   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #D106   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #D107   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #D107   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #D108   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #D109   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #D10A   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #D10B   ; 0=stopped, 1=track active
music_muted          EQU #D10C   ; 0=audible, 1=muted/pause
music_loop           EQU #D10D   ; 0=no loop, 1=loop enabled
music_track_index    EQU #D10E   ; Current ROM track index
music_row_frames     EQU #D10F   ; Frames per tracker row
music_row_countdown  EQU #D110   ; Countdown to next row
music_order_pos      EQU #D111   ; Current order position
music_pattern_index  EQU #D112   ; Current pattern index
music_pattern_row    EQU #D113   ; Current row inside pattern
music_pattern_rows   EQU #D114   ; Cached rows in current pattern
music_track_ptr_l    EQU #D115   ; Current track pointer low byte
music_track_ptr_h    EQU #D116   ; Current track pointer high byte
music_pattern_ptr_l  EQU #D117   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #D118   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #D119   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #D11A   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #D11A   ; Channel A
music_ch_b_note EQU #D11B   ; Channel B
music_ch_c_note EQU #D11C   ; Channel C
music_ch_instrument_base EQU #D11D   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #D11D   ; Channel A
music_ch_b_instrument EQU #D11E   ; Channel B
music_ch_c_instrument EQU #D11F   ; Channel C
music_ch_ornament_base EQU #D120   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #D120   ; Channel A
music_ch_b_ornament EQU #D121   ; Channel B
music_ch_c_ornament EQU #D122   ; Channel C
music_ch_volume_base EQU #D123   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #D123   ; Channel A
music_ch_b_volume EQU #D124   ; Channel B
music_ch_c_volume EQU #D125   ; Channel C
music_ch_vol_step_base EQU #D126   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #D126   ; Channel A
music_ch_b_vol_step EQU #D127   ; Channel B
music_ch_c_vol_step EQU #D128   ; Channel C
music_ch_tone_step_base EQU #D129   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #D129   ; Channel A
music_ch_b_tone_step EQU #D12A   ; Channel B
music_ch_c_tone_step EQU #D12B   ; Channel C
music_ch_orn_step_base EQU #D12C   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #D12C   ; Channel A
music_ch_b_orn_step EQU #D12D   ; Channel B
music_ch_c_orn_step EQU #D12E   ; Channel C

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D12F   ; End of project variables (4399 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D12F: Project variables (4399 bytes)
;   #D12F-#F37F: Free RAM (~8785 bytes available)
...
load_sprite_patterns:
    ...
    ld bc, 32 ; Load 1 layers (32 bytes each)
    call FAST_LDIRVM
    ; Entity 4: New Sprite_1 (2 layers)
    ; Base HW Sprite: 5
    ...
    ld bc, 64 ; Load 2 layers (32 bytes each)
    call FAST_LDIRVM
    ; Entity 5: New Sprite_1 (2 layers)
    ; Base HW Sprite: 7
    ld a, SPRITE_10_PATTERN_BANK
    call mapper_set_bank_p2
    ld hl, SPRITE_10_PATTERN
...
music_track_0_Oda1_inst_7_vol_env:
    DB #00,#28,#50,#78,#7F,#64,#5A,#50,#46,#3C
