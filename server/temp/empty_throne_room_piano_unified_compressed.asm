; ==================================================================
; EMPTY_THRONE_ROOM_PIANO - UNIFIED FILE
...
; BANK 02 @#0000 : sound.asm part 3/2 (2862 bytes)
; BANK 02 @#0B2E : scroll.asm (2407 bytes)
; BANK 02 @#1495 : animtiles.asm (2549 bytes)
; BANK 02 @#1E8A : bosses.asm (374 bytes)
; BANK 03 @#0000 : bosses.asm (5408 bytes)
; BANK 03 @#1520 : statemachine.asm (5 bytes)
; BANK 03 @#1525 : gameflow.asm (2779 bytes)
; BANK 04 @#0000 : gameflow.asm (2127 bytes)
...
; Flow: Start → Music (gf_piano_music)
; ==================================================================
...
music_track_ptr_table:
    DW music_track_0_The_Empty_Throne_Room_Piano_data

; ------------------------------------------------------------------
; Tracker Song 0: The Empty Throne Room Piano
; ------------------------------------------------------------------
music_track_0_The_Empty_Throne_Room_Piano_data:
    DB #0A
    DB #03
    DB #00
    DB #01
    DB #03
    DW music_track_0_The_Empty_Throne_Room_Piano_order_table
    DW music_track_0_The_Empty_Throne_Room_Piano_pattern_table
    DW music_track_0_The_Empty_Throne_Room_Piano_instrument_ptr_table
    DW music_track_0_The_Empty_Throne_Room_Piano_ornament_ptr_table
    DW #00D2
    DB #10

music_track_0_The_Empty_Throne_Room_Piano_order_table:
    DB #00,#01,#02

music_track_0_The_Empty_Throne_Room_Piano_pattern_table:
    DW music_track_0_The_Empty_Throne_Room_Piano_pattern_0_rows
    DB #40
    DW music_track_0_The_Empty_Throne_Room_Piano_pattern_1_rows
    DB #40
    DW music_track_0_The_Empty_Throne_Room_Piano_pattern_2_rows
    DB #40

music_track_0_The_Empty_Throne_Room_Piano_instrument_ptr_table:
    DW 0
    DW music_track_0_The_Empty_Throne_Room_Piano_inst_1
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_The_Empty_Throne_Room_Piano_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_The_Empty_Throne_Room_Piano_pattern_0_rows:
...
music_track_0_The_Empty_Throne_Room_Piano_pattern_1_rows:
...
music_track_0_The_Empty_Throne_Room_Piano_pattern_2_rows:
...
music_track_0_The_Empty_Throne_Room_Piano_inst_1:
    DB #05
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_The_Empty_Throne_Room_Piano_inst_1_vol_env
    DB #0C
    DB #FF
    DW music_track_0_The_Empty_Throne_Room_Piano_inst_1_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_The_Empty_Throne_Room_Piano_inst_1_vol_env:
    DB #0F,#0E,#0C,#0A,#08,#06,#05,#04,#03,#02,#01,#00
music_track_0_The_Empty_Throne_Room_Piano_inst_1_tone_env:
    DB #00
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_piano_start
...
; Node: Start - "gf_piano_start"
gameflow_node_gf_piano_start:
    db NODE_TYPE_START
    dw gameflow_node_gf_piano_start_data
    dw gameflow_node_gf_piano_start_conn

gameflow_node_gf_piano_start_data:
    dw gameflow_node_gf_piano_start_init    ; Initialization routine address
    db ((gameflow_node_gf_piano_start_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_piano_start_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_piano_music
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_piano_start_init
...
; Node: Music - "gf_piano_music"
gameflow_node_gf_piano_music:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gf_piano_music_data
    dw gameflow_node_gf_piano_music_conn

gameflow_node_gf_piano_music_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gf_piano_music_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_piano_end
    db CONNECTION_END

; Node: End - "gf_piano_end"
gameflow_node_gf_piano_end:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gf_piano_end_conn

gameflow_node_gf_piano_end_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
