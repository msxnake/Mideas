...
; BANK 02 @#0548 : sprites.asm (4168 bytes)
; BANK 02 @#1590 : font.asm (2672 bytes)
; BANK 03 @#0000 : font.asm (784 bytes)
; BANK 03 @#0310 : hud.asm (3480 bytes)
; BANK 03 @#10A8 : menus.asm (168 bytes)
; BANK 03 @#1150 : sound.asm part 1/2 (3760 bytes)
; BANK 04 @#0000 : sound.asm part 2/2 (5788 bytes)
; BANK 04 @#169C : scroll.asm (2353 bytes)
; BANK 04 @#1FCD : animtiles.asm (51 bytes)
; BANK 05 @#0000 : animtiles.asm (5229 bytes)
; BANK 05 @#146D : statemachine.asm part 1/3 (2963 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 07 @#0000 : statemachine.asm part 3/3 (8023 bytes)
; BANK 07 @#1F57 : gameflow.asm (169 bytes)
; BANK 08 @#0000 : gameflow.asm (5960 bytes)
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ...
    DB #80,#FF,#FF,#87,#82,#FF,#80,#81,#80,#FF,#82,#83,#82,#FF,#FF,#FF
    ...
    DB #FF,#FF,#FF,#FF,#85,#FF,#87,#FF,#80,#81,#80,#81,#82,#83,#82,#83
