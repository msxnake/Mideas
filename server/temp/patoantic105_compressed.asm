...
; Estimated payload bytes: 111477
; Estimated banks used: 14
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (1107 bytes)
; BANK 00 @#0453 : colors.asm (995 bytes)
; BANK 00 @#0836 : components.asm (22 bytes)
; BANK 00 @#084C : entities.asm (5372 bytes)
; BANK 00 @#1D48 : worlds.asm (696 bytes)
; BANK 01 @#0000 : worlds.asm (3304 bytes)
; BANK 01 @#0CE8 : screens.asm part 1/3 (4888 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (4446 bytes)
; BANK 03 @#115E : sprites.asm part 1/2 (3746 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (6019 bytes)
; BANK 04 @#1783 : font.asm (2173 bytes)
; BANK 05 @#0000 : font.asm (1374 bytes)
; BANK 05 @#055E : hud.asm (4339 bytes)
; BANK 05 @#1651 : menus.asm (444 bytes)
; BANK 05 @#180D : sound.asm (2035 bytes)
; BANK 06 @#0000 : sound.asm (1529 bytes)
; BANK 06 @#05F9 : scroll.asm (2353 bytes)
; BANK 06 @#0F2A : animtiles.asm (4310 bytes)
; BANK 07 @#0000 : animtiles.asm (1606 bytes)
; BANK 07 @#0646 : particles.asm (4963 bytes)
; BANK 07 @#19A9 : statemachine.asm part 1/4 (1623 bytes)
...
; BANK 11 @#0000 : statemachine.asm part 5/4 (4388 bytes)
; BANK 11 @#1124 : gameflow.asm part 1/3 (3804 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (4981 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (112 -> 101 bytes)
    ...
    DB #02,#10,#BA,#00,#F7,#09,#20,#A1,#40,#00,#04,#01,#ED,#00,#10,#38
    DB #7C,#38,#DC,#55,#56
load_pattern_bank0:
    ...
    ld bc, 112    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 112    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (112 -> 36 bytes)
...
load_color_bank0:
    ...
    ld bc, 112     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 127 bytes)
    DB #95,#84,#69,#00,#56,#95,#84,#6A,#80,#E3,#81,#FC,#E4,#FB,#FC,#6E
    DB #82,#50,#52,#39,#82,#83,#FC,#BD,#80,#02,#1F,#B1,#D0,#C4,#AE,#86
    DB #80,#57,#A0,#01,#81,#6B,#8D,#F9,#F6,#EE,#7E,#00,#94,#83,#77,#7E
    DB #79,#00,#5F,#8B,#9E,#FC,#80,#57,#88,#CD,#00,#85,#32,#C6,#57,#E7
    DB #FB,#C0,#F9,#76,#38,#1F,#80,#76,#08,#57,#DE,#80,#F6,#F4,#80,#4F
    DB #C0,#76,#BE,#03,#BF,#C0,#F0,#A8,#40,#86,#42,#9D,#82,#F9,#88,#A8
    DB #E0,#FE,#78,#80,#7B,#FC,#D4,#80,#FF,#FC,#80,#4A,#86,#47,#F4,#B0
    DB #D7,#50,#F0,#FB,#80,#F7,#B0,#83,#A0,#E3,#FB,#80,#55,#55,#80
BEHAVIOR_PAN1_0_WIDTH     EQU 32
BEHAVIOR_PAN1_0_HEIGHT    EQU 24
BEHAVIOR_PAN1_0_SIZE      EQU 768

BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 62 bytes)
    DB #85,#00,#56,#80,#10,#0F,#90,#57,#D5,#40,#F4,#C4,#2B,#08,#81,#40
    DB #7F,#B5,#F6,#E0,#EE,#F5,#00,#78,#C0,#14,#CD,#C0,#1F,#C0,#0F,#EE
    DB #F1,#70,#7C,#C0,#04,#D8,#C2,#5F,#EE,#2E,#08,#90,#43,#97,#98,#D5
    DB #C0,#7D,#BA,#7A,#C1,#08,#1F,#FE,#47,#84,#C0,#35,#55,#58
...
; Free RAM buffer for tile pattern data decompression (112 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D700

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (112 bytes)
; ==================================================================
