...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (48 -> 18 bytes)
    DB #81,#FF,#2E,#4C,#F0,#A0,#4E,#26,#4D,#4C,#4D,#98,#4F,#4E,#4F,#1D
    DB #55,#56
SCREEN_PAN1_0_BLOCK_MAP:
    ; ZX0 compressed screen_block_map (48 -> 9 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (664 -> 490 bytes)
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (664 -> 361 bytes)
...
ZX0_SPRITE_FRAME_NEW_SPRITE_0_F0_DATA:
    ; ZX0 compressed sprite frame NEW_SPRITE_0_F0 (32 -> 30 bytes)
