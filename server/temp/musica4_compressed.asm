...
; BANK 02 @#005A : sound.asm part 1/3 (8102 bytes)
; BANK 03 @#0000 : sound.asm part 2/3 (8192 bytes)
; BANK 04 @#0000 : sound.asm part 3/3 (1555 bytes)
; BANK 04 @#0613 : scroll.asm (2342 bytes)
; BANK 04 @#0F39 : animtiles.asm (4295 bytes)
; BANK 05 @#0000 : animtiles.asm (326 bytes)
; BANK 05 @#0146 : statemachine.asm (5 bytes)
; BANK 05 @#014B : gameflow.asm (5451 bytes)
...
music_track_ptr_table:
    ...
    DW music_track_1_New_Track_data
    DW music_track_2_track2_data
...
; ------------------------------------------------------------------
; Tracker Song 1: New Track
; ------------------------------------------------------------------
music_track_1_New_Track_data:
    DB #07
    DB #01
    DB #00
    DB #01
    DB #01
    DW music_track_1_New_Track_order_table
    DW music_track_1_New_Track_pattern_table
    DW music_track_1_New_Track_instrument_ptr_table
    DW music_track_1_New_Track_ornament_ptr_table
    DW #00D2
    DB #10

music_track_1_New_Track_order_table:
    DB #00

music_track_1_New_Track_pattern_table:
    DW music_track_1_New_Track_pattern_0_rows
    DB #20

music_track_1_New_Track_instrument_ptr_table:
    DW 0
    DW music_track_1_New_Track_inst_1
    DW music_track_1_New_Track_inst_2
    DW music_track_1_New_Track_inst_3
    DW music_track_1_New_Track_inst_4
    DW music_track_1_New_Track_inst_5
    DW music_track_1_New_Track_inst_6
    DW music_track_1_New_Track_inst_7
    DW music_track_1_New_Track_inst_8
    DW music_track_1_New_Track_inst_9
    DW music_track_1_New_Track_inst_10
    DW music_track_1_New_Track_inst_11
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_1_New_Track_ornament_ptr_table:
    DW 0
    DW music_track_1_New_Track_orn_1
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_1_New_Track_pattern_0_rows:
    DB #30,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #31,#09,#FF,#FF,#25,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#31,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #32,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#09,#FF,#FF,#33,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#09,#FF,#FF,#34,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #31,#09,#FF,#FF,#36,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#34,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #33,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #35,#09,#FF,#FF,#35,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #36,#09,#FF,#FF,#32,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #38,#09,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#09,#FF,#FF,#34,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #33,#09,#FF,#FF,#33,#01,#FF,#FF,#FF,#FF,#FF,#FF

music_track_1_New_Track_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_1_vol_env
    DB #0E
    DB #FF
    DW music_track_1_New_Track_inst_1_tone_env
    DB #04
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_1_vol_env:
    DB #0F,#0F,#0E,#0D,#0C,#0A,#08,#07,#05,#04,#03,#02,#01,#00
music_track_1_New_Track_inst_1_tone_env:
    DB #00,#00,#00,#00

music_track_1_New_Track_inst_2:
    DB #05
    DB #0F
    DB #0C
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_2_vol_env
    DB #08
    DB #03
    DW music_track_1_New_Track_inst_2_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_2_vol_env:
    DB #0F,#0E,#0D,#0C,#0B,#0A,#09,#08
music_track_1_New_Track_inst_2_tone_env:
    DB #00

music_track_1_New_Track_inst_3:
    DB #05
    DB #00
    DB #0D
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_3_vol_env
    DB #09
    DB #04
    DW music_track_1_New_Track_inst_3_tone_env
    DB #08
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_3_vol_env:
    DB #00,#05,#0A,#0F,#0F,#0F,#0E,#0D,#0C
music_track_1_New_Track_inst_3_tone_env:
    DB #00,#01,#02,#01,#00,#FF,#FE,#FF

music_track_1_New_Track_inst_4:
    DB #01
    DB #00
    DB #00
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_4_vol_env
    DB #0E
    DB #09
    DW music_track_1_New_Track_inst_4_tone_env
    DB #08
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_4_vol_env:
    DB #00,#01,#02,#04,#06,#08,#0A,#0C,#0D,#0E,#0F,#0E,#0D,#0E
music_track_1_New_Track_inst_4_tone_env:
    DB #00,#00,#01,#01,#00,#00,#FF,#FF

music_track_1_New_Track_inst_5:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_5_vol_env
    DB #07
    DB #FF
    DW music_track_1_New_Track_inst_5_tone_env
    DB #06
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_5_vol_env:
    DB #0F,#0D,#0A,#07,#04,#02,#00
music_track_1_New_Track_inst_5_tone_env:
    DB #0C,#07,#03,#00,#FD,#FA

music_track_1_New_Track_inst_6:
    DB #03
    DB #0F
    DB #00
    DB #08
    DW #00D2
    DW music_track_1_New_Track_inst_6_vol_env
    DB #08
    DB #FF
    DW music_track_1_New_Track_inst_6_tone_env
    DB #04
    DB #FF
    DW music_track_1_New_Track_inst_6_noise_env
    DB #07
    DB #FF
music_track_1_New_Track_inst_6_vol_env:
    DB #0F,#0D,#0A,#08,#06,#04,#02,#00
music_track_1_New_Track_inst_6_tone_env:
    DB #07,#04,#02,#00
music_track_1_New_Track_inst_6_noise_env:
    DB #03,#05,#08,#0C,#12,#18,#1F

music_track_1_New_Track_inst_7:
    DB #02
    DB #0C
    DB #00
    DB #02
    DW #00D2
    DW music_track_1_New_Track_inst_7_vol_env
    DB #07
    DB #FF
    DW music_track_1_New_Track_inst_7_tone_env
    DB #01
    DB #FF
    DW music_track_1_New_Track_inst_7_noise_env
    DB #07
    DB #FF
music_track_1_New_Track_inst_7_vol_env:
    DB #0C,#0A,#08,#06,#04,#02,#00
music_track_1_New_Track_inst_7_tone_env:
    DB #00
music_track_1_New_Track_inst_7_noise_env:
    DB #01,#01,#02,#04,#08,#10,#1F

music_track_1_New_Track_inst_8:
    DB #05
    DB #0F
    DB #0A
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_8_vol_env
    DB #08
    DB #00
    DW music_track_1_New_Track_inst_8_tone_env
    DB #07
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_8_vol_env:
    DB #0F,#0F,#0E,#0E,#0D,#0D,#0C,#0C
music_track_1_New_Track_inst_8_tone_env:
    DB #00,#04,#07,#0C,#07,#04,#00

music_track_1_New_Track_inst_9:
    DB #05
    DB #0F
    DB #0D
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_9_vol_env
    DB #05
    DB #00
    DW music_track_1_New_Track_inst_9_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_9_vol_env:
    DB #0F,#0F,#0F,#0F,#0F
music_track_1_New_Track_inst_9_tone_env:
    DB #00

music_track_1_New_Track_inst_10:
    DB #01
    DB #00
    DB #00
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_10_vol_env
    DB #0C
    DB #06
    DW music_track_1_New_Track_inst_10_tone_env
    DB #06
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_10_vol_env:
    DB #00,#02,#05,#08,#0B,#0D,#0E,#0D,#0C,#0D,#0E,#0D
music_track_1_New_Track_inst_10_tone_env:
    DB #00,#00,#01,#00,#00,#FF

music_track_1_New_Track_inst_11:
    DB #01
    DB #00
    DB #00
    DB #10
    DW #00D2
    DW music_track_1_New_Track_inst_11_vol_env
    DB #0C
    DB #06
    DW music_track_1_New_Track_inst_11_tone_env
    DB #06
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_1_New_Track_inst_11_vol_env:
    DB #00,#02,#05,#08,#0B,#0D,#0E,#0D,#0C,#0D,#0E,#0D
music_track_1_New_Track_inst_11_tone_env:
    DB #00,#00,#01,#00,#00,#FF

music_track_1_New_Track_orn_1:
    DW music_track_1_New_Track_orn_1_data
    DB #04
    DB #03
music_track_1_New_Track_orn_1_data:
    DB #00,#01,#02,#03

; ------------------------------------------------------------------
; Tracker Song 2: track2
; ------------------------------------------------------------------
music_track_2_track2_data:
    DB #07
    DB #01
    DB #00
    DB #01
    DB #01
    DW music_track_2_track2_order_table
    DW music_track_2_track2_pattern_table
    DW music_track_2_track2_instrument_ptr_table
    DW music_track_2_track2_ornament_ptr_table
    DW #00D2
    DB #10

music_track_2_track2_order_table:
    DB #00

music_track_2_track2_pattern_table:
    DW music_track_2_track2_pattern_0_rows
    DB #20

music_track_2_track2_instrument_ptr_table:
    DW 0
    DW music_track_2_track2_inst_1
    DW music_track_2_track2_inst_2
    DW music_track_2_track2_inst_3
    DW music_track_2_track2_inst_4
    DW music_track_2_track2_inst_5
    DW music_track_2_track2_inst_6
    DW music_track_2_track2_inst_7
    DW music_track_2_track2_inst_8
    DW music_track_2_track2_inst_9
    DW music_track_2_track2_inst_10
    DW music_track_2_track2_inst_11
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_2_track2_ornament_ptr_table:
    DW 0
    DW music_track_2_track2_orn_1
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_2_track2_pattern_0_rows:
    DB #FF,#FF,#FF,#FF,#3D,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#34,#09,#01,#FF
    DB #FF,#FF,#FF,#FF,#3F,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#40,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#34,#09,#01,#FF
    DB #FF,#FF,#FF,#FF,#41,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#3D,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#34,#09,#01,#FF
    DB #33,#01,#01,#FF,#3C,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#3D,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#33,#01,#01,#FF,#34,#09,#01,#FF
    DB #33,#01,#01,#FF,#33,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#34,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#34,#01,#01,#FF,#33,#09,#01,#FF
    DB #33,#01,#01,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#32,#01,#01,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#32,#01,#01,#FF,#33,#09,#01,#FF
    DB #33,#01,#01,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#33,#09,#01,#FF
    DB #33,#01,#01,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#3C,#09,#01,#FF
    DB #31,#01,#01,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_2_track2_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_1_vol_env
    DB #0E
    DB #FF
    DW music_track_2_track2_inst_1_tone_env
    DB #04
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_1_vol_env:
    DB #0F,#0F,#0E,#0D,#0C,#0A,#08,#07,#05,#04,#03,#02,#01,#00
music_track_2_track2_inst_1_tone_env:
    DB #00,#00,#00,#00

music_track_2_track2_inst_2:
    DB #05
    DB #0F
    DB #0C
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_2_vol_env
    DB #08
    DB #03
    DW music_track_2_track2_inst_2_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_2_vol_env:
    DB #0F,#0E,#0D,#0C,#0B,#0A,#09,#08
music_track_2_track2_inst_2_tone_env:
    DB #00

music_track_2_track2_inst_3:
    DB #05
    DB #00
    DB #0D
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_3_vol_env
    DB #09
    DB #04
    DW music_track_2_track2_inst_3_tone_env
    DB #08
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_3_vol_env:
    DB #00,#05,#0A,#0F,#0F,#0F,#0E,#0D,#0C
music_track_2_track2_inst_3_tone_env:
    DB #00,#01,#02,#01,#00,#FF,#FE,#FF

music_track_2_track2_inst_4:
    DB #01
    DB #00
    DB #00
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_4_vol_env
    DB #0E
    DB #09
    DW music_track_2_track2_inst_4_tone_env
    DB #08
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_4_vol_env:
    DB #00,#01,#02,#04,#06,#08,#0A,#0C,#0D,#0E,#0F,#0E,#0D,#0E
music_track_2_track2_inst_4_tone_env:
    DB #00,#00,#01,#01,#00,#00,#FF,#FF

music_track_2_track2_inst_5:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_5_vol_env
    DB #07
    DB #FF
    DW music_track_2_track2_inst_5_tone_env
    DB #06
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_5_vol_env:
    DB #0F,#0D,#0A,#07,#04,#02,#00
music_track_2_track2_inst_5_tone_env:
    DB #0C,#07,#03,#00,#FD,#FA

music_track_2_track2_inst_6:
    DB #03
    DB #0F
    DB #00
    DB #08
    DW #00D2
    DW music_track_2_track2_inst_6_vol_env
    DB #08
    DB #FF
    DW music_track_2_track2_inst_6_tone_env
    DB #04
    DB #FF
    DW music_track_2_track2_inst_6_noise_env
    DB #07
    DB #FF
music_track_2_track2_inst_6_vol_env:
    DB #0F,#0D,#0A,#08,#06,#04,#02,#00
music_track_2_track2_inst_6_tone_env:
    DB #07,#04,#02,#00
music_track_2_track2_inst_6_noise_env:
    DB #03,#05,#08,#0C,#12,#18,#1F

music_track_2_track2_inst_7:
    DB #02
    DB #0C
    DB #00
    DB #02
    DW #00D2
    DW music_track_2_track2_inst_7_vol_env
    DB #07
    DB #FF
    DW music_track_2_track2_inst_7_tone_env
    DB #01
    DB #FF
    DW music_track_2_track2_inst_7_noise_env
    DB #07
    DB #FF
music_track_2_track2_inst_7_vol_env:
    DB #0C,#0A,#08,#06,#04,#02,#00
music_track_2_track2_inst_7_tone_env:
    DB #00
music_track_2_track2_inst_7_noise_env:
    DB #01,#01,#02,#04,#08,#10,#1F

music_track_2_track2_inst_8:
    DB #05
    DB #0F
    DB #0A
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_8_vol_env
    DB #08
    DB #00
    DW music_track_2_track2_inst_8_tone_env
    DB #07
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_8_vol_env:
    DB #0F,#0F,#0E,#0E,#0D,#0D,#0C,#0C
music_track_2_track2_inst_8_tone_env:
    DB #00,#04,#07,#0C,#07,#04,#00

music_track_2_track2_inst_9:
    DB #05
    DB #0F
    DB #0D
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_9_vol_env
    DB #05
    DB #00
    DW music_track_2_track2_inst_9_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_9_vol_env:
    DB #0F,#0F,#0F,#0F,#0F
music_track_2_track2_inst_9_tone_env:
    DB #00

music_track_2_track2_inst_10:
    DB #05
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_10_vol_env
    DB #0B
    DB #FF
    DW music_track_2_track2_inst_10_tone_env
    DB #03
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_10_vol_env:
    DB #0F,#0E,#0C,#0A,#08,#06,#04,#03,#02,#01,#00
music_track_2_track2_inst_10_tone_env:
    DB #00,#0C,#00

music_track_2_track2_inst_11:
    DB #01
    DB #00
    DB #00
    DB #10
    DW #00D2
    DW music_track_2_track2_inst_11_vol_env
    DB #0C
    DB #06
    DW music_track_2_track2_inst_11_tone_env
    DB #06
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_2_track2_inst_11_vol_env:
    DB #00,#02,#05,#08,#0B,#0D,#0E,#0D,#0C,#0D,#0E,#0D
music_track_2_track2_inst_11_tone_env:
    DB #00,#00,#01,#00,#00,#FF

music_track_2_track2_orn_1:
    DW music_track_2_track2_orn_1_data
    DB #02
    DB #00
music_track_2_track2_orn_1_data:
    DB #00,#01
...
gameflow_node_gfn_1777464445317_data:
    db 1, 2, 1    ; command, track index, loop flag
