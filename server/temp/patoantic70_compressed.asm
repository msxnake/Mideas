...
; Estimated payload bytes: 105272
...
; BANK 04 @#0000 : sprites.asm part 3/2 (1893 bytes)
; BANK 04 @#0765 : font.asm (3547 bytes)
; BANK 04 @#1540 : hud.asm (2752 bytes)
; BANK 05 @#0000 : hud.asm (1084 bytes)
; BANK 05 @#043C : menus.asm (444 bytes)
; BANK 05 @#05F8 : sound.asm (3184 bytes)
; BANK 05 @#1268 : scroll.asm (2353 bytes)
; BANK 05 @#1B99 : animtiles.asm (1127 bytes)
; BANK 06 @#0000 : animtiles.asm (4789 bytes)
; BANK 06 @#12B5 : particles.asm (3403 bytes)
; BANK 07 @#0000 : particles.asm (1560 bytes)
; BANK 07 @#0618 : statemachine.asm part 1/4 (6632 bytes)
; BANK 08 @#0000 : statemachine.asm part 2/4 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 3/4 (8192 bytes)
; BANK 10 @#0000 : statemachine.asm part 4/4 (6468 bytes)
; BANK 10 @#1944 : gameflow.asm part 1/3 (1724 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (6968 bytes)
...
SPRITE_PANELL_RIGHT_2_WIDTH     EQU 16
SPRITE_PANELL_RIGHT_2_HEIGHT    EQU 16
SPRITE_PANELL_RIGHT_2_FRAMES    EQU 1

;; ---- Sprite Frame: panell_right_2_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PANELL_RIGHT_2_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PANELL_RIGHT_2_F0_DATA (32 bytes)
SPRITE_2_PATTERN EQU PANELL_RIGHT_2_F0_LAYER1
...
SPRITE_NINA_JUMP_RIGHT_4_FRAMES    EQU 2
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_4_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_4_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_4_F1_DATA (32 bytes)
...
SPRITE_NINA_LAND_RIGHT_5_FRAMES    EQU 4
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F3_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F3_DATA (32 bytes)
...
SPRITE_NINA_DEAD_RIGHT_6_FRAMES    EQU 3

;; ---- Sprite Frame: nina_dead_right_6_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F0_DATA (32 bytes)
...
;; ---- Sprite Frame: nina_dead_right_6_F2 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F2_DATA (32 bytes)
...
SPRITE_PANELL_LEFT_9_WIDTH     EQU 16
SPRITE_PANELL_LEFT_9_HEIGHT    EQU 16
SPRITE_PANELL_LEFT_9_FRAMES    EQU 1

;; ---- Sprite Frame: panell_left_9_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PANELL_LEFT_9_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PANELL_LEFT_9_F0_DATA (32 bytes)
SPRITE_9_PATTERN EQU PANELL_LEFT_9_F0_LAYER1
...
SPRITE_NINA_JUMP_LEFT_11_FRAMES    EQU 2
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_11_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_11_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_11_F1_DATA (32 bytes)
...
SPRITE_NINA_LAND_LEFT_12_FRAMES    EQU 4
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F3_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F3_DATA (32 bytes)
...
SPRITE_NINA_DEAD_LEFT_13_FRAMES    EQU 3

;; ---- Sprite Frame: nina_dead_left_13_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F0_DATA (32 bytes)
...
;; ---- Sprite Frame: nina_dead_left_13_F2 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F2_DATA (32 bytes)
...
sprite_asset_frame_count:
    ...
    db 2 ; Sprite 1: bola
    db 1 ; Sprite 2: panell_right
    db 2 ; Sprite 3: nina_walk_right
    db 2 ; Sprite 4: nina_jump_right
    db 4 ; Sprite 5: nina_land_right
    db 3 ; Sprite 6: nina_dead_right
    db 2 ; Sprite 7: nina_idle_right
    db 2 ; Sprite 8: anec_left
    db 1 ; Sprite 9: panell_left
    db 2 ; Sprite 10: nina_walk_left
    db 2 ; Sprite 11: nina_jump_left
    db 4 ; Sprite 12: nina_land_left
    db 3 ; Sprite 13: nina_dead_left
...
sprite_loop_flags:
    ...
    db 2 ; Sprite 8: anec_left
    db 0 ; Sprite 9: panell_left
    db 0 ; Sprite 10: nina_walk_left
...
; Sprite 2: panell_right frame pointers
SPRITE_2_FRAME_PTRS:
    dw PANELL_RIGHT_2_F0_LAYER1
...
SPRITE_4_FRAME_PTRS:
    ...
    dw NINA_JUMP_RIGHT_4_F1_LAYER0
...
; Sprite 9: panell_left frame pointers
SPRITE_9_FRAME_PTRS:
    dw PANELL_LEFT_9_F0_LAYER1
...
SPRITE_11_FRAME_PTRS:
    ...
    dw NINA_JUMP_LEFT_11_F1_LAYER0
...
sprite_dir_left_table:
    db 8, 1, 9, 10, 11, 12, 13, 14, 8, 9, 10, 11, 12, 13, 14

sprite_dir_right_table:
    db 0, 1, 2, 3, 4, 5, 6, 7, 0, 2, 3, 4, 5, 6, 7
...
.acs_dir_done:
    ...
    ;   - bit 2 (ONLY_WHEN_MOVING):
    ;       * Si loop     → se conserva (respetar config original de la entidad)
    ;       * Si one-shot → se fuerza a 0, para que la animación avance
    ;         aunque la entidad esté parada (ej: animación de "land")
    ; ------------------------------------------------------------------
    ld hl, entity_anim_flags
    ...
    bit 1, e                ; ¿el nuevo sprite es loop?
    jr nz, .acs_keep_only_moving
    and #FB                 ; one-shot: bit 2 = 0 → borrar ANIM_FLAG_ONLY_WHEN_MOVING
                            ; (garantiza que ANIMATION_COMPLETE se dispare aunque vel=0)
...
ZX0_SPRITE_FRAME_PANELL_RIGHT_2_F0_DATA:
    ; ZX0 compressed sprite frame PANELL_RIGHT_2_F0 (64 -> 29 bytes)
...
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_4_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_RIGHT_4_F0 (64 -> 51 bytes)
    DB #28,#03,#07,#29,#09,#14,#20,#40,#69,#03,#02,#07,#0F,#AB,#80,#00
    DB #86,#C0,#F8,#00,#49,#C0,#60,#C0,#E1,#AA,#00,#26,#02,#03,#01,#E6
    DB #CD,#08,#00,#54,#19,#2B,#F0,#D0,#D8,#F8,#F0,#80,#90,#A7,#C9,#55
    DB #55,#55,#80
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_4_F1_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_RIGHT_4_F1 (64 -> 53 bytes)
    DB #68,#00,#03,#07,#29,#09,#14,#20,#40,#69,#0B,#02,#27,#0F,#AB,#80
    DB #00,#86,#C0,#F8,#00,#49,#E8,#40,#C0,#E1,#AA,#00,#26,#02,#03,#01
    DB #8E,#00,#10,#E9,#9E,#54,#FD,#5B,#F0,#D0,#D8,#F8,#F0,#80,#14,#A3
    DB #E7,#55,#55,#55,#80
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_5_F0 (64 -> 51 bytes)
...
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_5_F1 (64 -> 53 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
...
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F2_DATA:
    ...
    DB #04,#F5,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F3_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_5_F3 (64 -> 17 bytes)
    DB #81,#00,#1E,#E3,#AA,#40,#80,#84,#20,#AA,#02,#01,#A0,#04,#D5,#55
    DB #60
ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F0_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_RIGHT_6_F0 (64 -> 59 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
    DB #01,#F8,#00,#9A,#C0,#40,#C0,#22,#E0,#00,#28,#40,#08,#2B,#1A,#31
    DB #24,#2E,#3C,#E3,#B4,#1E,#02,#80,#FF,#89,#04,#0C,#2C,#24,#04,#0C
    DB #78,#20,#35,#30,#10,#F0,#80,#E0,#20,#55,#58
ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F2_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_RIGHT_6_F2 (64 -> 56 bytes)
...
ZX0_SPRITE_FRAME_PANELL_LEFT_9_F0_DATA:
    ; ZX0 compressed sprite frame PANELL_LEFT_9_F0 (64 -> 29 bytes)
    DB #98,#00,#68,#0C,#1C,#3C,#7F,#FF,#20,#3C,#18,#08,#00,#68,#FC,#A5
    DB #00,#61,#85,#43,#24,#14,#0C,#00,#E7,#BE,#55,#55,#80
...
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_11_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_LEFT_11_F0 (64 -> 51 bytes)
    DB #61,#03,#1F,#00,#87,#03,#06,#03,#87,#55,#A0,#F0,#2A,#C0,#E0,#E0
    DB #90,#28,#04,#02,#02,#40,#9F,#F0,#D5,#01,#CC,#87,#0F,#0B,#1B,#1F
    DB #0F,#BA,#ED,#09,#E9,#AA,#E6,#FE,#6E,#40,#C0,#80,#E5,#A9,#10,#2A
    DB #D5,#55,#60
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_11_F1_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_LEFT_11_F1 (64 -> 53 bytes)
    DB #08,#00,#03,#1F,#00,#64,#88,#17,#02,#03,#87,#55,#00,#A0,#C0,#E0
    DB #A5,#90,#28,#04,#02,#99,#D0,#40,#E4,#F0,#D5,#01,#00,#7A,#0F,#0B
    DB #1B,#1F,#0F,#01,#28,#E8,#B9,#AA,#FE,#9A,#40,#C0,#80,#3A,#00,#08
    DB #EB,#2A,#35,#55,#58
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_12_F0 (64 -> 50 bytes)
...
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_12_F1 (64 -> 52 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
...
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F2_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_12_F2 (64 -> 52 bytes)
    ...
    DB #81,#04,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F3_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_12_F3 (64 -> 17 bytes)
    DB #81,#00,#0E,#DF,#AA,#40,#80,#90,#20,#AA,#02,#01,#A7,#04,#55,#55
    DB #80
ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F0_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_LEFT_13_F0 (64 -> 59 bytes)
...
ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F2_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_LEFT_13_F2 (64 -> 54 bytes)
...
; Frame group: PANELL_RIGHT_2_F0
PANELL_RIGHT_2_F0_LAYER1 EQU ZX0_SPRITE_FRAME_PANELL_RIGHT_2_F0_DATA
...
; Frame group: NINA_JUMP_RIGHT_4_F1
NINA_JUMP_RIGHT_4_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_4_F1_DATA
...
; Frame group: NINA_LAND_RIGHT_5_F3
NINA_LAND_RIGHT_5_F3_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_5_F3_DATA
; Frame group: NINA_DEAD_RIGHT_6_F0
NINA_DEAD_RIGHT_6_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F0_DATA
; Frame group: NINA_DEAD_RIGHT_6_F2
NINA_DEAD_RIGHT_6_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_RIGHT_6_F2_DATA
...
; Frame group: PANELL_LEFT_9_F0
PANELL_LEFT_9_F0_LAYER1 EQU ZX0_SPRITE_FRAME_PANELL_LEFT_9_F0_DATA
...
; Frame group: NINA_JUMP_LEFT_11_F1
NINA_JUMP_LEFT_11_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_11_F1_DATA
...
; Frame group: NINA_LAND_LEFT_12_F3
NINA_LAND_LEFT_12_F3_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_LEFT_12_F3_DATA
; Frame group: NINA_DEAD_LEFT_13_F0
NINA_DEAD_LEFT_13_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F0_DATA
; Frame group: NINA_DEAD_LEFT_13_F2
NINA_DEAD_LEFT_13_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_LEFT_13_F2_DATA
