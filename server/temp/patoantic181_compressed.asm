...
; BANK 11 @#0000 : statemachine.asm part 3/3 (2625 bytes)
; BANK 11 @#0A41 : gameflow.asm (5515 bytes)
...
SM_ActionTable:
    ...
    DW Action_Nop ; 39 [Action_ExitCurrentWorld stripped]
