set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas_textscroll_galious_pair_megarom_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas_textscroll_galious_pair_megarom_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set p1 [mem8 0xC150]; set p2 [mem8 0xC151]; set p3 [mem8 0xC152]; set p4 [mem8 0xC153]
    set flow [mem8 0xC11C]; set screen [mem8 0xDFA4]; set irq [mem16 0xE686]; set inirq [mem8 0xE68B]
    set px [mem16 0xDFAE]; set py [mem16 0xDFB0]
...
after time 12.0 { shot "atenas_textscroll_galious_pair_megarom_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "atenas_textscroll_galious_pair_megarom_t16.png" "t16" }
after time 22.0 { shot "atenas_textscroll_galious_pair_megarom_t22.png" "t22"; close $f; exit }
