...
; BANK 09 @#0000 : statemachine.asm part 4/4 (6750 bytes)
; BANK 09 @#1A5E : gameflow.asm part 1/3 (1442 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (7115 bytes)
