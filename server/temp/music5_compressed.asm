...
music_ch_noise_step_base EQU #D12C   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #D12C   ; Channel A
music_ch_b_noise_step EQU #D12D   ; Channel B
music_ch_c_noise_step EQU #D12E   ; Channel C
music_ch_orn_step_base EQU #D12F   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #D12F   ; Channel A
music_ch_b_orn_step EQU #D130   ; Channel B
music_ch_c_orn_step EQU #D131   ; Channel C

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D132   ; End of project variables (4402 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D132: Project variables (4402 bytes)
;   #D132-#F37F: Free RAM (~8782 bytes available)
...
music_track_0_New_Track_pattern_0_rows:
    ...
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#0A,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#0A,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
