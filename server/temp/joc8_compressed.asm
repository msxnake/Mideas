...
; BANK 01 @#0000 : screens.asm (4306 bytes)
; BANK 01 @#10D2 : sprites.asm (2569 bytes)
; BANK 01 @#1ADB : font.asm (1317 bytes)
; BANK 02 @#0000 : font.asm (2139 bytes)
; BANK 02 @#085B : hud.asm (3480 bytes)
; BANK 02 @#15F3 : menus.asm (168 bytes)
; BANK 02 @#169B : sound.asm part 1/2 (2405 bytes)
; BANK 03 @#0000 : sound.asm part 2/2 (7136 bytes)
; BANK 03 @#1BE0 : scroll.asm (1056 bytes)
; BANK 04 @#0000 : scroll.asm (1297 bytes)
; BANK 04 @#0511 : animtiles.asm (4613 bytes)
; BANK 04 @#1716 : statemachine.asm (5 bytes)
; BANK 04 @#171B : gameflow.asm (2277 bytes)
; BANK 05 @#0000 : gameflow.asm (3744 bytes)
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 69 bytes)
    DB #65,#80,#81,#FF,#09,#F4,#80,#82,#83,#C0,#2E,#82,#80,#11,#1A,#84
    DB #17,#E0,#BD,#FC,#3E,#C1,#80,#4F,#BD,#80,#FC,#F1,#80,#43,#75,#80
    DB #79,#C0,#0D,#D4,#00,#3F,#FC,#71,#80,#7F,#FC,#87,#80,#E1,#A7,#FC
    DB #78,#80,#7E,#A7,#FC,#17,#84,#00,#1F,#BD,#D1,#FC,#FD,#BD,#FC,#1F
    DB #84,#47,#55,#55,#80
