...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (160 -> 140 bytes)
    ...
    DB #AE,#DE,#BE,#DE,#FC,#C3,#FF,#BC,#F5,#FF,#55,#58
load_pattern_bank0:
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (160 -> 59 bytes)
    ...
    DB #F0,#6F,#41,#9E,#3A,#20,#FD,#F1,#FE,#55,#56
load_color_bank0:
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 152 bytes)
    DB #95,#84,#69,#00,#56,#95,#84,#6A,#80,#E3,#81,#FC,#F1,#FB,#FC,#88
    DB #88,#92,#FB,#F0,#82,#C4,#48,#8E,#82,#83,#FD,#F5,#80,#00,#3C,#80
    DB #5E,#FD,#BC,#86,#80,#18,#F4,#81,#81,#00,#62,#83,#83,#41,#BD,#93
    DB #FF,#DF,#6E,#80,#4B,#85,#DF,#C0,#8B,#9F,#FC,#80,#7F,#DD,#C0,#5E
    DB #D0,#72,#C6,#1B,#8E,#FF,#FF,#F0,#48,#3C,#FB,#87,#F8,#96,#38,#FE
    DB #88,#FE,#E0,#4F,#B1,#35,#C0,#29,#83,#43,#F8,#80,#C0,#47,#F4,#F1
    DB #FC,#F3,#D8,#AE,#40,#86,#10,#43,#73,#88,#DF,#A8,#FE,#5E,#80,#26
    DB #88,#92,#92,#FE,#F8,#80,#57,#4F,#B8,#4C,#B0,#F4,#80,#A9,#86,#80
    DB #93,#93,#85,#E7,#30,#C6,#FC,#EE,#82,#FB,#85,#80,#5F,#BD,#C6,#FC
    DB #EF,#80,#FB,#85,#D0,#D5,#55,#60
BEHAVIOR_PAN1_0_WIDTH     EQU 32
BEHAVIOR_PAN1_0_HEIGHT    EQU 24
BEHAVIOR_PAN1_0_SIZE      EQU 768

BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 75 bytes)
    DB #85,#00,#56,#80,#10,#0F,#88,#57,#D4,#40,#F4,#C0,#69,#08,#17,#9F
    DB #02,#C0,#10,#BF,#14,#FF,#CF,#90,#C0,#A4,#04,#0F,#DD,#D7,#C0,#35
    DB #C0,#BF,#19,#FF,#F2,#F3,#88,#C3,#C0,#31,#D8,#36,#BE,#43,#90,#C0
    DB #4D,#61,#90,#7C,#EE,#B9,#08,#90,#0E,#98,#5F,#C0,#41,#E5,#BA,#6C
    DB #08,#AB,#B0,#04,#D1,#FE,#E1,#C0,#0D,#55,#56
SCREEN_PAN2_1_WIDTH     EQU 32
SCREEN_PAN2_1_HEIGHT    EQU 24
SCREEN_PAN2_1_SIZE      EQU 768

SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 120 bytes)
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#BA,#F5,#3A,#2A,#80,#94,#86,#4F
    DB #46,#57,#C2,#C0,#81,#8D,#28,#82,#F4,#FC,#22,#89,#8A,#7C,#28,#E4
    DB #54,#E0,#00,#E5,#6A,#F5,#54,#39,#80,#77,#30,#13,#F8,#F6,#80,#75
    DB #C0,#80,#5D,#F7,#3D,#FC,#B3,#E4,#C4,#1B,#83,#E2,#FC,#8B,#8C,#02
    DB #FD,#88,#E5,#84,#3B,#98,#F3,#EE,#34,#03,#DD,#99,#68,#1F,#5C,#B2
    DB #86,#0E,#47,#68,#D8,#83,#8A,#81,#67,#B8,#89,#F5,#90,#91,#F9,#FB
    DB #E4,#F6,#4F,#E0,#AF,#8C,#F9,#77,#B8,#FB,#F9,#C1,#F4,#E3,#FB,#E4
    DB #BB,#50,#FD,#88,#D5,#F5,#55,#60
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #C0,#0A,#08,#54,#F5,#06,#78,#D4,#5F,#6A,#5F,#EA,#5F,#C0,#57,#D5
    DB #2A,#D7,#80,#40,#3D,#C4,#38,#C0,#13,#D6,#40,#95,#08,#F5,#00,#79
    DB #9E,#3D,#0A,#5E,#E6,#4E,#C0,#14,#D5,#55,#60
...
; Free RAM buffer for tile pattern data decompression (160 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D800

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (160 bytes)
; ==================================================================
