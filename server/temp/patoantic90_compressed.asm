...
; Estimated payload bytes: 110343
...
; BANK 11 @#0000 : statemachine.asm part 5/4 (3301 bytes)
; BANK 11 @#0CE5 : gameflow.asm part 1/3 (4891 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (3847 bytes)
...
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #CC8F   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #CC90   ; Temporary 16-bit storage
temp_word_2         EQU #CC92   ; Temporary 16-bit storage
temp_byte_1         EQU #CC94   ; Temporary 8-bit storage
temp_byte_2         EQU #CC95   ; Temporary 8-bit storage
temp_byte_3         EQU #CC96   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #CCB6   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #CCD6   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #CCF6   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #CD16   ; 0=no SFX active, 1=playing
sfx_timer           EQU #CD17   ; Frames remaining for current SFX
sfx_fadeout         EQU #CD18   ; Reserved fadeout flag/state
temp_byte_7         EQU #CD19   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CD39   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CD59   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CD79   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CD99   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CDB9   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CDD9   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CDF9   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CE19   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CE39   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CE59   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CE79   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CE99   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CEB9   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CED9   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CEF9   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CF19   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CF39   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CF59   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CF79   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #CFB9   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #CFF9   ; Cached entity X for wall checks
wall_temp_y         EQU #CFFA   ; Cached entity Y for wall checks
wall_hit_left       EQU #CFFB   ; Hitbox left edge cache
wall_hit_top        EQU #CFFC   ; Hitbox top edge cache
wall_hit_right      EQU #CFFD   ; Hitbox right edge cache
wall_hit_bottom     EQU #CFFE   ; Hitbox bottom edge cache
wall_hit_w          EQU #CFFF   ; Hitbox width cache (min 1)
wall_hit_h          EQU #D000   ; Hitbox height cache (min 1)
wall_probe_left     EQU #D001   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #D002   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #D003   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #D004   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #D005   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #D025   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #D026   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #D027   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #D047   ; Number of entities in coll_list
coll_src_left       EQU #D048   ; Source AABB left edge (scratch)
coll_src_right      EQU #D049   ; Source AABB right edge (scratch)
coll_src_top        EQU #D04A   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #D04B   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #D04C   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #D04C   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #D04E   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #D050   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #D052   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #D054   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #D056   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #D058   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #D05A   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #D05C   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #D05D   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #D062   ; Frame counter (16-bit)
task_exec_time          EQU #D064   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #D066   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #D067   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #D067   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #D068   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #D069   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #D06A   ; Next sound frame pointer high byte

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D06B   ; End of project variables (4203 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D06B: Project variables (4203 bytes)
;   #D06B-#F37F: Free RAM (~8981 bytes available)
