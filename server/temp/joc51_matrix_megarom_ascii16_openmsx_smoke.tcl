set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc51_matrix_megarom_ascii16_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc51_matrix_megarom_ascii16_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set flow [mem8 0xC104]; set screen [mem8 0xE16A]; set irq [mem16 0xE80C]; set inirq [mem8 0xE811]
    set px [mem16 0xE174]; set py [mem16 0xE176]
...
after time 12.0 { shot "joc51_matrix_megarom_ascii16_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "joc51_matrix_megarom_ascii16_t16.png" "t16" }
after time 22.0 { shot "joc51_matrix_megarom_ascii16_t22.png" "t22"; close $f; exit }
