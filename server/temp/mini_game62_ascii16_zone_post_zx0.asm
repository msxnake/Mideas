...
; ------------------------------------------------------------------
; Bank 1 [#6000-#8000]: components (51565/8192 bytes est.)
; Bank 2 [#8000-#A000]: statemachine (14435/8192 bytes est.)
; Bank 3 [#A000-#C000]: sprites (10058/8192 bytes est.)
; Bank 4 [#6000-#8000]: sound (9539/8192 bytes est.)
; Bank 5 [#8000-#A000]: gameflow (6665/8192 bytes est.)
; Bank 6 [#A000-#C000]: animtiles, scroll (6966/8192 bytes est.)
; Bank 7 [#6000-#8000]: entities (17510/8192 bytes est.) [FAR — accessed via trampoline]
...
; Bank 10 [#6000-#8000]: patterns_code (1121/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 11 [#8000-#A000]: colors_code (1093/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 4+ (data) [#C000+]: DATA (patterns, colors, screens, font, presentation)
; ------------------------------------------------------------------
; Far code banks: bank7(entities) bank8(screens_code) bank9(worlds) bank10(patterns_code) bank11(colors_code)
; ------------------------------------------------------------------
...
; Estimated payload bytes: 137088
; Estimated banks used: 17
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (1121 bytes)
; BANK 00 @#04C1 : colors.asm (1093 bytes)
; BANK 00 @#0906 : components.asm part 1/7 (5882 bytes)
...
; BANK 06 @#0000 : components.asm part 7/7 (4747 bytes)
; BANK 06 @#128B : entities.asm part 1/3 (3445 bytes)
; BANK 07 @#0000 : entities.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : entities.asm part 3/3 (5873 bytes)
; BANK 08 @#16F1 : worlds.asm (2319 bytes)
; BANK 09 @#0000 : worlds.asm (5254 bytes)
; BANK 09 @#1486 : screens.asm part 1/2 (2938 bytes)
; BANK 10 @#0000 : screens.asm part 2/2 (7048 bytes)
; BANK 10 @#1B88 : sprites.asm part 1/2 (1144 bytes)
; BANK 11 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 12 @#0000 : sprites.asm part 3/2 (722 bytes)
; BANK 12 @#02D2 : font.asm (174 bytes)
; BANK 12 @#0380 : hud.asm (79 bytes)
; BANK 12 @#03CF : menus.asm (168 bytes)
; BANK 12 @#0477 : sound.asm part 1/2 (7049 bytes)
; BANK 13 @#0000 : sound.asm part 2/2 (2490 bytes)
; BANK 13 @#09BA : scroll.asm (2353 bytes)
; BANK 13 @#12EB : animtiles.asm (3349 bytes)
; BANK 14 @#0000 : animtiles.asm (1264 bytes)
; BANK 14 @#04F0 : statemachine.asm part 1/2 (6928 bytes)
; BANK 15 @#0000 : statemachine.asm part 2/2 (7543 bytes)
; BANK 15 @#1D77 : gameflow.asm (649 bytes)
; BANK 16 @#0000 : gameflow.asm (6016 bytes); ==================================================================
...
sprite_asset_base_pattern_slot_runtime EQU #D444   ; Runtime base 16x16 slot per sprite asset (10 bytes)
sprite_placeholder_base_pattern_num EQU #D44E   ; Runtime placeholder pattern number (base slot * 4)
sprite_attributes   EQU #D44F   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (7 screens detected)
; ==================================================================
current_screen_id   EQU #D4CF   ; Currently displayed screen ID
screen_dirty_flag   EQU #D4D0   ; Screen needs redraw flag
screen_transition_cooldown EQU #D4D1   ; Cooldown frames after screen transition
current_world_id    EQU #D4D2   ; Current world ID (for multi-world support)
current_screen_index EQU #D4D3   ; Current screen index within world
current_screen_anim_group_count EQU #D4D4   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #D4D5   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #D4D6   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #D4D7   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #D4D8   ; Player X position (16-bit)
player_y            EQU #D4DA   ; Player Y position (16-bit)
player_runtime_enabled EQU #D4DC   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #D4DD   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #D4DE   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #D4DF   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #D4E0   ; Player health points
player_score        EQU #D4E1   ; Player score (16-bit)
gem_count           EQU #D4E3   ; Collectible tile counter (8-bit)
last_gem_char       EQU #D4E4   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #D4E5   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #D4E6   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #D526   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #D566   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #D5A6   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #D5E6   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #D5F6   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #D606   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #D616   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #D626   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #D636   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #D646   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #D647   ; Temporary 16-bit storage
temp_word_2         EQU #D649   ; Temporary 16-bit storage
temp_byte_1         EQU #D64B   ; Temporary 8-bit storage
temp_byte_2         EQU #D64C   ; Temporary 8-bit storage
temp_byte_3         EQU #D64D   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #D66D   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #D68D   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #D6AD   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #D6CD   ; 0=no SFX active, 1=playing
sfx_timer           EQU #D6CE   ; Frames remaining for current SFX
sfx_fadeout         EQU #D6CF   ; Reserved fadeout flag/state
temp_byte_7         EQU #D6D0   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #D6F0   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #D710   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #D730   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #D750   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #D770   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #D790   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #D7B0   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #D7D0   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #D7F0   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #D810   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #D830   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #D850   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #D870   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #D890   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #D8B0   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #D8D0   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #D8F0   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #D910   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #D930   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #D970   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #D9B0   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #D9D0   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #D9F0   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #DA10   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #DA11   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #DA12   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #DA13   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #DA14   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #DA15   ; Cached entity X for wall checks
wall_temp_y         EQU #DA16   ; Cached entity Y for wall checks
wall_hit_left       EQU #DA17   ; Hitbox left edge cache
wall_hit_top        EQU #DA18   ; Hitbox top edge cache
wall_hit_right      EQU #DA19   ; Hitbox right edge cache
wall_hit_bottom     EQU #DA1A   ; Hitbox bottom edge cache
wall_hit_w          EQU #DA1B   ; Hitbox width cache (min 1)
wall_hit_h          EQU #DA1C   ; Hitbox height cache (min 1)
wall_probe_left     EQU #DA1D   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #DA1E   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #DA1F   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #DA20   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #DA21   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #DA41   ; Number of entries in active_entity_list
hero_entity_id      EQU #DA42   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #DA43   ; 1=rebuild active_entity_list required
input_entity_list   EQU #DA44   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #DA64   ; Number of entries in input_entity_list
render_entity_list  EQU #DA65   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #DA85   ; Number of entries in render_entity_list
collision_entity_list EQU #DA86   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #DAA6   ; Number of entries in collision_entity_list
ground_entity_list  EQU #DAA7   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #DAC7   ; Number of entries in ground_entity_list
anim_entity_list    EQU #DAC8   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #DAE8   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #DAE9   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #DB09   ; Number of entities in coll_list
coll_src_left       EQU #DB0A   ; Source AABB left edge (scratch)
coll_src_right      EQU #DB0B   ; Source AABB right edge (scratch)
coll_src_top        EQU #DB0C   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #DB0D   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #DB0E   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #DB0E   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #DB10   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #DB12   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #DB14   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #DB16   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #DB18   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #DB1A   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #DB1C   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #DB1E   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #DB1F   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #DB24   ; Frame counter (16-bit)
task_exec_time          EQU #DB26   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #DB28   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #DB29   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #DB29   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #DB2A   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #DB2B   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #DB2C   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #DB2D   ; 0=stopped, 1=track active
music_muted          EQU #DB2E   ; 0=audible, 1=muted/pause
music_loop           EQU #DB2F   ; 0=no loop, 1=loop enabled
music_track_index    EQU #DB30   ; Current ROM track index
music_row_frames     EQU #DB31   ; Frames per tracker row
music_row_countdown  EQU #DB32   ; Countdown to next row
music_order_pos      EQU #DB33   ; Current order position
music_pattern_index  EQU #DB34   ; Current pattern index
music_pattern_row    EQU #DB35   ; Current row inside pattern
music_pattern_rows   EQU #DB36   ; Cached rows in current pattern
music_track_ptr_l    EQU #DB37   ; Current track pointer low byte
music_track_ptr_h    EQU #DB38   ; Current track pointer high byte
music_pattern_ptr_l  EQU #DB39   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #DB3A   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #DB3B   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #DB3C   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #DB3C   ; Channel A
music_ch_b_note EQU #DB3D   ; Channel B
music_ch_c_note EQU #DB3E   ; Channel C
music_ch_instrument_base EQU #DB3F   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #DB3F   ; Channel A
music_ch_b_instrument EQU #DB40   ; Channel B
music_ch_c_instrument EQU #DB41   ; Channel C
music_ch_ornament_base EQU #DB42   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #DB42   ; Channel A
music_ch_b_ornament EQU #DB43   ; Channel B
music_ch_c_ornament EQU #DB44   ; Channel C
music_ch_volume_base EQU #DB45   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #DB45   ; Channel A
music_ch_b_volume EQU #DB46   ; Channel B
music_ch_c_volume EQU #DB47   ; Channel C
music_ch_vol_step_base EQU #DB48   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #DB48   ; Channel A
music_ch_b_vol_step EQU #DB49   ; Channel B
music_ch_c_vol_step EQU #DB4A   ; Channel C
music_ch_tone_step_base EQU #DB4B   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #DB4B   ; Channel A
music_ch_b_tone_step EQU #DB4C   ; Channel B
music_ch_c_tone_step EQU #DB4D   ; Channel C
music_ch_noise_step_base EQU #DB4E   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #DB4E   ; Channel A
music_ch_b_noise_step EQU #DB4F   ; Channel B
music_ch_c_noise_step EQU #DB50   ; Channel C
music_ch_orn_step_base EQU #DB51   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #DB51   ; Channel A
music_ch_b_orn_step EQU #DB52   ; Channel B
music_ch_c_orn_step EQU #DB53   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #DB54   ; End of project variables (6996 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#DB54: Project variables (6996 bytes)
;   #DB54-#F37F: Free RAM (~6188 bytes available)
...
; ##################################################################
; BANK 3 — [#A000h-#C000h] PRIMARY: sprites
; (Always mapped at boot: bank1→P1, bank2→P2, bank3→P3)
; ##################################################################
    org #A000
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F3_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_LEFT_0_F3_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BIRD_1_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BIRD_1_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BIRD_1_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BIRD_1_F3_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BOT1_2_F0_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BOT2_RIGHT_3_F1_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F2_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F4_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F5_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F6_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F7_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F8_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F9_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F10_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F11_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F12_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_DEAD_4_F13_DATA (32 bytes)
...
;; Size: 32x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA (64 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_GEMA1_6_F0_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BOX_7_F0_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F3_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_8_F3_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_BOT2_LEFT_9_F1_DATA (32 bytes)
...
load_sprite_patterns_worldmap_1760724209990:
    ...
    call mapper_set_bank_p3
    ld hl, (HERO_LEFT_0_F0_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (0 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_0_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_LEFT_0_F1_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (2 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_0_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_LEFT_0_F2_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (4 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_0_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_LEFT_0_F3_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (6 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (BOT2_RIGHT_3_F0_LAYER0 & #3FFF) | #8000
    ld de, SPRPAT + (8 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_3_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (BOT2_RIGHT_3_F1_LAYER0 & #3FFF) | #8000
    ld de, SPRPAT + (9 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F0_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (10 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F1_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (11 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F2_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (12 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F3_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (13 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F4_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (14 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F5_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (15 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F6_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (16 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F7_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (17 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F8_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (18 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F9_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (19 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F10_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (20 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F11_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (21 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F12_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (22 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_4_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_DEAD_4_F13_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (23 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (NEW_SPRITE_5_F0_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (24 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (GEMA1_6_F0_LAYER2 & #3FFF) | #8000
    ld de, SPRPAT + (25 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_6_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (GEMA1_6_F1_LAYER2 & #3FFF) | #8000
    ld de, SPRPAT + (26 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (BOX_7_F0_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (27 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (HERO_RIGHT_8_F0_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (28 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_8_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_RIGHT_8_F1_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (30 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_8_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_RIGHT_8_F2_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (32 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_8_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (HERO_RIGHT_8_F3_LAYER1 & #3FFF) | #8000
    ld de, SPRPAT + (34 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (BOT2_LEFT_9_F0_LAYER0 & #3FFF) | #8000
    ld de, SPRPAT + (36 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_9_PATTERN_BANK
    call mapper_set_bank_p3
    ld hl, (BOT2_LEFT_9_F1_LAYER0 & #3FFF) | #8000
    ld de, SPRPAT + (37 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p3
    ld hl, (SPRITE_PLACEHOLDER_PATTERN & #3FFF) | #8000
    ld de, SPRPAT + (38 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    call mapper_pop_p3
...
ZX0_SPRITE_FRAME_HERO_LEFT_0_F0_DATA:
    ; ZX0 compressed sprite frame HERO_LEFT_0_F0 (64 -> 47 bytes)
    DB #A1,#00,#26,#03,#1F,#3B,#71,#FB,#DF,#87,#8F,#07,#00,#29,#03,#00
    DB #6B,#80,#F8,#D4,#EB,#DD,#F2,#E0,#C0,#BE,#EA,#FF,#C5,#FE,#20,#D0
    DB #C8,#3E,#C7,#FF,#7D,#C0,#E0,#70,#E0,#89,#C0,#C0,#D5,#55,#60
ZX0_SPRITE_FRAME_HERO_LEFT_0_F1_DATA:
    ; ZX0 compressed sprite frame HERO_LEFT_0_F1 (64 -> 50 bytes)
    DB #A4,#00,#2B,#03,#1F,#3B,#71,#FB,#DF,#87,#8F,#07,#00,#04,#08,#18
    DB #81,#E1,#A2,#80,#F8,#D4,#EB,#DD,#F2,#E0,#E0,#C0,#20,#10,#38,#C5
    DB #F2,#20,#00,#FE,#BA,#03,#F6,#7D,#C0,#E0,#70,#E0,#89,#C0,#C0,#D5
    DB #55,#60
ZX0_SPRITE_FRAME_HERO_LEFT_0_F2_DATA:
    ; ZX0 compressed sprite frame HERO_LEFT_0_F2 (64 -> 47 bytes)
    DB #88,#00,#48,#03,#1F,#3B,#71,#FB,#DF,#87,#80,#18,#10,#BA,#30,#E0
    DB #5E,#80,#D8,#EC,#D2,#ED,#F2,#E1,#EF,#38,#3F,#01,#C4,#BF,#20,#F7
    DB #FE,#AE,#07,#F0,#26,#C0,#E0,#70,#1A,#00,#A0,#E0,#D5,#55,#60
ZX0_SPRITE_FRAME_HERO_LEFT_0_F3_DATA:
    ; ZX0 compressed sprite frame HERO_LEFT_0_F3 (64 -> 47 bytes)
    DB #A1,#00,#26,#03,#1F,#3B,#71,#FB,#DF,#87,#80,#00,#04,#E1,#0C,#E1
    DB #3F,#80,#D8,#EC,#D2,#ED,#F2,#E0,#00,#1F,#01,#E9,#C4,#BF,#20,#F7
    DB #FE,#AE,#07,#F0,#26,#C0,#E0,#70,#1A,#00,#A1,#E0,#D5,#55,#60
ZX0_SPRITE_FRAME_BIRD_1_F0_DATA:
    ; ZX0 compressed sprite frame BIRD_1_F0 (32 -> 15 bytes)
    DB #86,#00,#09,#1E,#21,#01,#00,#09,#97,#F0,#08,#00,#55,#55,#80
ZX0_SPRITE_FRAME_BIRD_1_F1_DATA:
    ; ZX0 compressed sprite frame BIRD_1_F1 (32 -> 16 bytes)
    DB #86,#00,#09,#0E,#11,#21,#00,#09,#F3,#E0,#10,#08,#EC,#55,#55,#80
ZX0_SPRITE_FRAME_BIRD_1_F2_DATA:
    ; ZX0 compressed sprite frame BIRD_1_F2 (32 -> 17 bytes)
    DB #82,#00,#18,#06,#09,#11,#10,#00,#59,#F7,#C0,#20,#10,#E0,#55,#55
    DB #80
ZX0_SPRITE_FRAME_BIRD_1_F3_DATA:
    ; ZX0 compressed sprite frame BIRD_1_F3 (32 -> 17 bytes)
    DB #82,#00,#18,#06,#09,#11,#10,#00,#59,#F7,#C0,#20,#10,#E0,#55,#55
    DB #80
ZX0_SPRITE_FRAME_BOT1_2_F0_DATA:
    ; ZX0 compressed sprite frame BOT1_2_F0 (32 -> 5 bytes)
    DB #95,#FF,#75,#55,#58
ZX0_SPRITE_FRAME_BOT2_RIGHT_3_F1_DATA:
    ; ZX0 compressed sprite frame BOT2_RIGHT_3_F1 (32 -> 30 bytes)
    DB #02,#1F,#FF,#CF,#0F,#07,#00,#2F,#6F,#98,#6E,#00,#01,#22,#E0,#B0
    DB #82,#F0,#E0,#00,#F0,#26,#70,#00,#80,#2B,#E0,#55,#55,#80
ZX0_SPRITE_FRAME_HERO_DEAD_4_F2_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F2 (32 -> 31 bytes)
    DB #A5,#00,#A2,#03,#5F,#2B,#5B,#2F,#1F,#0F,#07,#00,#AA,#02,#00,#25
    DB #AE,#80,#FA,#B4,#AA,#F8,#F0,#E0,#C0,#E1,#2D,#40,#40,#55,#56
ZX0_SPRITE_FRAME_HERO_DEAD_4_F4_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F4 (32 -> 31 bytes)
    DB #02,#00,#06,#3E,#56,#36,#5E,#3E,#00,#AB,#1E,#0E,#B8,#F7,#04,#FB
    DB #2B,#40,#7C,#5A,#54,#78,#98,#E1,#70,#70,#60,#AD,#20,#55,#56
ZX0_SPRITE_FRAME_HERO_DEAD_4_F5_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F5 (32 -> 26 bytes)
    DB #59,#00,#7C,#2C,#6C,#3C,#7C,#00,#AB,#3C,#1C,#E1,#F2,#F9,#3E,#2C
    DB #2A,#3E,#3C,#E0,#9D,#38,#38,#30,#55,#56
ZX0_SPRITE_FRAME_HERO_DEAD_4_F6_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F6 (32 -> 26 bytes)
    DB #59,#00,#7C,#2C,#6C,#3C,#7C,#00,#AB,#3C,#1C,#E1,#F2,#F9,#3E,#2C
    DB #2A,#3E,#3C,#E0,#9D,#38,#38,#30,#55,#56
ZX0_SPRITE_FRAME_HERO_DEAD_4_F7_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F7 (32 -> 22 bytes)
    DB #2A,#00,#58,#78,#A1,#00,#EB,#F1,#38,#9B,#FF,#16,#14,#1E,#99,#E0
    DB #8D,#1C,#1C,#18,#55,#56
ZX0_SPRITE_FRAME_HERO_DEAD_4_F8_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F8 (32 -> 22 bytes)
    DB #2A,#00,#58,#78,#A1,#00,#EB,#F1,#38,#9B,#FF,#16,#14,#1E,#99,#E0
    DB #8D,#1C,#1C,#18,#55,#56
ZX0_SPRITE_FRAME_HERO_DEAD_4_F9_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F9 (32 -> 19 bytes)
    DB #6A,#00,#30,#70,#00,#5A,#70,#2A,#00,#2F,#0A,#0E,#E0,#7A,#ED,#0C
    DB #D5,#55,#60
ZX0_SPRITE_FRAME_HERO_DEAD_4_F10_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F10 (32 -> 15 bytes)
    DB #AA,#00,#30,#97,#00,#FA,#EC,#FF,#0C,#FF,#F4,#EC,#75,#55,#58
ZX0_SPRITE_FRAME_HERO_DEAD_4_F11_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F11 (32 -> 15 bytes)
    DB #2A,#00,#60,#00,#07,#E3,#E8,#06,#06,#DE,#E4,#E8,#35,#55,#58
ZX0_SPRITE_FRAME_HERO_DEAD_4_F12_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F12 (32 -> 13 bytes)
    DB #A2,#00,#20,#00,#5F,#EA,#28,#04,#69,#00,#75,#55,#58
ZX0_SPRITE_FRAME_HERO_DEAD_4_F13_DATA:
    ; ZX0 compressed sprite frame HERO_DEAD_4_F13 (32 -> 5 bytes)
    DB #95,#00,#75,#55,#58
ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA:
    ; ZX0 compressed sprite frame NEW_SPRITE_5_F0 (64 -> 15 bytes)
    DB #91,#00,#62,#7F,#FF,#89,#FE,#FF,#FE,#F0,#B8,#57,#55,#55,#80
ZX0_SPRITE_FRAME_GEMA1_6_F0_DATA:
    ; ZX0 compressed sprite frame GEMA1_6_F0 (32 -> 28 bytes)
    DB #89,#00,#29,#01,#03,#06,#05,#06,#07,#86,#03,#01,#00,#1A,#80,#C0
    DB #E0,#F0,#D0,#A7,#90,#20,#40,#80,#B5,#E4,#55,#58
ZX0_SPRITE_FRAME_BOX_7_F0_DATA:
    ; ZX0 compressed sprite frame BOX_7_F0 (32 -> 27 bytes)
    DB #62,#00,#7F,#40,#08,#7E,#41,#7E,#5F,#61,#88,#40,#7F,#00,#FE,#02
    DB #60,#7E,#82,#7E,#FE,#FA,#8D,#02,#FE,#55,#56
ZX0_SPRITE_FRAME_HERO_RIGHT_8_F0_DATA:
    ; ZX0 compressed sprite frame HERO_RIGHT_8_F0 (64 -> 46 bytes)
    DB #A5,#00,#AE,#01,#1F,#2B,#D7,#BB,#4F,#07,#03,#EA,#EA,#FF,#00,#12
    DB #C0,#F8,#DC,#8E,#DF,#FB,#E1,#F1,#E0,#00,#61,#96,#C0,#03,#07,#0E
    DB #00,#FE,#03,#BD,#C4,#F6,#04,#E0,#27,#C0,#C0,#55,#55,#80
ZX0_SPRITE_FRAME_HERO_RIGHT_8_F1_DATA:
    ; ZX0 compressed sprite frame HERO_RIGHT_8_F1 (64 -> 50 bytes)
    DB #A5,#00,#A5,#01,#1F,#2B,#D7,#BB,#4F,#07,#A4,#03,#00,#04,#08,#10
    DB #18,#00,#28,#C0,#F8,#DC,#8E,#DF,#FB,#E1,#F1,#E0,#00,#20,#10,#65
    DB #18,#03,#07,#0E,#00,#BF,#03,#BD,#C4,#BD,#04,#E0,#89,#C0,#C0,#D5
    DB #55,#60
ZX0_SPRITE_FRAME_HERO_RIGHT_8_F2_DATA:
    ; ZX0 compressed sprite frame HERO_RIGHT_8_F2 (64 -> 46 bytes)
    DB #88,#00,#0A,#01,#1B,#37,#4B,#B7,#4F,#87,#00,#60,#FC,#80,#00,#84
    DB #89,#C0,#F8,#DC,#8E,#DF,#FB,#E1,#01,#18,#08,#21,#0C,#00,#03,#07
    DB #0E,#00,#AF,#07,#C4,#2E,#04,#E0,#62,#E0,#E0,#0D,#55,#56
ZX0_SPRITE_FRAME_HERO_RIGHT_8_F3_DATA:
    ; ZX0 compressed sprite frame HERO_RIGHT_8_F3 (64 -> 44 bytes)
    DB #A1,#00,#61,#01,#1B,#37,#4B,#B7,#4F,#07,#00,#F8,#80,#00,#84,#98
    DB #C0,#F8,#DC,#8E,#DF,#FB,#E1,#01,#00,#20,#61,#30,#03,#07,#0E,#00
    DB #AF,#07,#C4,#2E,#04,#E0,#62,#E0,#E0,#1D,#55,#56
ZX0_SPRITE_FRAME_BOT2_LEFT_9_F1_DATA:
    ; ZX0 compressed sprite frame BOT2_LEFT_9_F1 (32 -> 30 bytes)
    DB #28,#07,#0D,#22,#0F,#07,#00,#0F,#62,#0E,#00,#01,#A0,#07,#29,#F8
    DB #FF,#F3,#F0,#E0,#00,#F4,#F6,#83,#76,#00,#80,#55,#55,#80
...
; ##################################################################
; BANK 5 — [#8000h-#A000h] PRIMARY: gameflow
; (Always mapped at boot: bank1→P1, bank2→P2, bank3→P3)
; ##################################################################
    org #8000
...
ANIM_TILE_DATA_BANK     EQU ((anim_tile_table - #4000) / #4000)
...
SCREEN_PAN1_0_LAYOUT_BANK EQU ((SCREEN_PAN1_0_LAYOUT - #4000) / #4000)
BEHAVIOR_PAN1_0_DATA_BANK EQU ((BEHAVIOR_PAN1_0_DATA - #4000) / #4000)
...
SCREEN_PAN2_1_LAYOUT_BANK EQU ((SCREEN_PAN2_1_LAYOUT - #4000) / #4000)
BEHAVIOR_PAN2_1_DATA_BANK EQU ((BEHAVIOR_PAN2_1_DATA - #4000) / #4000)
SCREEN_PAN2_1_EFFECTS_LAYOUT_BANK EQU ((SCREEN_PAN2_1_EFFECTS_LAYOUT - #4000) / #4000)
SCREEN_PAN2_1_EFFECTS_LAYOUT_PRESENT EQU 1
SCREEN_PAN2_1_EFFECTS_LAYOUT_SIZE EQU 768
SCREEN_PAN2_1_EFFECT_ZONE_TABLE_BANK EQU ((SCREEN_PAN2_1_EFFECT_ZONE_TABLE - #4000) / #4000)
...
SCREEN_PAN3_2_LAYOUT_BANK EQU ((SCREEN_PAN3_2_LAYOUT - #4000) / #4000)
BEHAVIOR_PAN3_2_DATA_BANK EQU ((BEHAVIOR_PAN3_2_DATA - #4000) / #4000)
SCREEN_PAN3_2_EFFECTS_LAYOUT_BANK EQU ((SCREEN_PAN3_2_EFFECTS_LAYOUT - #4000) / #4000)
SCREEN_PAN3_2_EFFECTS_LAYOUT_PRESENT EQU 1
SCREEN_PAN3_2_EFFECTS_LAYOUT_SIZE EQU 768
SCREEN_PAN3_2_EFFECT_ZONE_TABLE_BANK EQU ((SCREEN_PAN3_2_EFFECT_ZONE_TABLE - #4000) / #4000)
...
SCREEN_PAN4_3_LAYOUT_BANK EQU ((SCREEN_PAN4_3_LAYOUT - #4000) / #4000)
BEHAVIOR_PAN4_3_DATA_BANK EQU ((BEHAVIOR_PAN4_3_DATA - #4000) / #4000)
SCREEN_PAN4_3_EFFECTS_LAYOUT_BANK EQU ((SCREEN_PAN4_3_EFFECTS_LAYOUT - #4000) / #4000)
SCREEN_PAN4_3_EFFECTS_LAYOUT_PRESENT EQU 1
SCREEN_PAN4_3_EFFECTS_LAYOUT_SIZE EQU 768
SCREEN_PAN4_3_EFFECT_ZONE_TABLE_BANK EQU ((SCREEN_PAN4_3_EFFECT_ZONE_TABLE - #4000) / #4000)
...
SCREEN_PAN5_4_LAYOUT_BANK EQU ((SCREEN_PAN5_4_LAYOUT - #4000) / #4000)
BEHAVIOR_PAN5_4_DATA_BANK EQU ((BEHAVIOR_PAN5_4_DATA - #4000) / #4000)
SCREEN_PAN5_4_EFFECTS_LAYOUT_BANK EQU ((SCREEN_PAN5_4_EFFECTS_LAYOUT - #4000) / #4000)
SCREEN_PAN5_4_EFFECTS_LAYOUT_PRESENT EQU 1
SCREEN_PAN5_4_EFFECTS_LAYOUT_SIZE EQU 768
SCREEN_PAN5_4_EFFECT_ZONE_TABLE_BANK EQU ((SCREEN_PAN5_4_EFFECT_ZONE_TABLE - #4000) / #4000)
...
SCREEN_PAN62_5_LAYOUT_BANK EQU ((SCREEN_PAN62_5_LAYOUT - #4000) / #4000)
BEHAVIOR_PAN62_5_DATA_BANK EQU ((BEHAVIOR_PAN62_5_DATA - #4000) / #4000)
SCREEN_PAN62_5_EFFECTS_LAYOUT_BANK EQU ((SCREEN_PAN62_5_EFFECTS_LAYOUT - #4000) / #4000)
SCREEN_PAN62_5_EFFECTS_LAYOUT_PRESENT EQU 1
SCREEN_PAN62_5_EFFECTS_LAYOUT_SIZE EQU 768
SCREEN_PAN62_5_EFFECT_ZONE_TABLE_BANK EQU ((SCREEN_PAN62_5_EFFECT_ZONE_TABLE - #4000) / #4000)
...
SCREEN_PAN7_6_LAYOUT_BANK EQU ((SCREEN_PAN7_6_LAYOUT - #4000) / #4000)
BEHAVIOR_PAN7_6_DATA_BANK EQU ((BEHAVIOR_PAN7_6_DATA - #4000) / #4000)
SCREEN_PAN7_6_EFFECTS_LAYOUT_BANK EQU ((SCREEN_PAN7_6_EFFECTS_LAYOUT - #4000) / #4000)
SCREEN_PAN7_6_EFFECTS_LAYOUT_PRESENT EQU 1
SCREEN_PAN7_6_EFFECTS_LAYOUT_SIZE EQU 768
SCREEN_PAN7_6_EFFECT_ZONE_TABLE_BANK EQU ((SCREEN_PAN7_6_EFFECT_ZONE_TABLE - #4000) / #4000)
...
load_screen_pan1_760723005040:
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN1_0_LAYOUT & #3FFF) | #8000
    ld de, NAMETBL
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN1_0_EFFECTS_LAYOUT & #3FFF) | #8000
    ...
    call mapper_set_bank_p3
    ld hl, (BEHAVIOR_PAN1_0_DATA & #3FFF) | #8000
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN1_0_EFFECT_ZONE_TABLE & #3FFF) | #8000
...
load_screen_pan2_760784762679:
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN2_1_LAYOUT & #3FFF) | #8000
    ld de, NAMETBL
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN2_1_EFFECTS_LAYOUT & #3FFF) | #8000
    ld de, runtime_effects_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (BEHAVIOR_PAN2_1_DATA & #3FFF) | #8000
    ld de, runtime_behavior_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN2_1_EFFECT_ZONE_TABLE & #3FFF) | #8000
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
    call mapper_pop_p3
...
load_screen_pan3_760799152493:
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN3_2_LAYOUT & #3FFF) | #8000
    ld de, NAMETBL
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN3_2_EFFECTS_LAYOUT & #3FFF) | #8000
    ld de, runtime_effects_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (BEHAVIOR_PAN3_2_DATA & #3FFF) | #8000
    ld de, runtime_behavior_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN3_2_EFFECT_ZONE_TABLE & #3FFF) | #8000
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
    call mapper_pop_p3
...
load_screen_pan4_760799516565:
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN4_3_LAYOUT & #3FFF) | #8000
    ld de, NAMETBL
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN4_3_EFFECTS_LAYOUT & #3FFF) | #8000
    ld de, runtime_effects_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (BEHAVIOR_PAN4_3_DATA & #3FFF) | #8000
    ld de, runtime_behavior_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN4_3_EFFECT_ZONE_TABLE & #3FFF) | #8000
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
    call mapper_pop_p3
...
load_screen_pan5_760961565333:
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN5_4_LAYOUT & #3FFF) | #8000
    ld de, NAMETBL
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN5_4_EFFECTS_LAYOUT & #3FFF) | #8000
    ld de, runtime_effects_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (BEHAVIOR_PAN5_4_DATA & #3FFF) | #8000
    ld de, runtime_behavior_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN5_4_EFFECT_ZONE_TABLE & #3FFF) | #8000
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
    call mapper_pop_p3
...
load_screen_pan62_761237904051:
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN62_5_LAYOUT & #3FFF) | #8000
    ld de, NAMETBL
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN62_5_EFFECTS_LAYOUT & #3FFF) | #8000
    ld de, runtime_effects_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (BEHAVIOR_PAN62_5_DATA & #3FFF) | #8000
    ld de, runtime_behavior_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN62_5_EFFECT_ZONE_TABLE & #3FFF) | #8000
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
    call mapper_pop_p3
...
load_screen_pan7_761471728391:
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN7_6_LAYOUT & #3FFF) | #8000
    ld de, NAMETBL
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN7_6_EFFECTS_LAYOUT & #3FFF) | #8000
    ld de, runtime_effects_layout
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (BEHAVIOR_PAN7_6_DATA & #3FFF) | #8000
    ld de, runtime_behavior_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
    call mapper_pop_p3
    ...
    call mapper_set_bank_p3
    ld hl, (SCREEN_PAN7_6_EFFECT_ZONE_TABLE & #3FFF) | #8000
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
    call mapper_pop_p3
...
load_pattern_bank0:
    ...
    call mapper_set_bank_p3
    ld hl, (tile_pattern_bank0 & #3FFF) | #8000
...
load_pattern_bank1:
    ...
    ld a, PATTERN_DATA_BANK
    call mapper_set_bank_p3
    ld hl, (tile_pattern_bank0 & #3FFF) | #8000     ; Same source as Bank 0
...
tilebank_tilebank_1760723902303_load_pattern_bank0:
    ...
    ld a, PATTERN_DATA_BANK
    call mapper_set_bank_p3
    ld hl, (tilebank_pattern_data_0 & #3FFF) | #8000
    ld de, CHRTBL2 + (0 * 8)
    ld bc, 328
    call FAST_LDIRVM
    call mapper_pop_p3
...
; ##################################################################
; FAR BANK 11 — [#8000h-#A000h] FAR CODE: colors_code
; Accessed ONLY via trampolines in bank 0 (entrypoint_far labels).
...
load_color_bank0:
    ...
    call mapper_set_bank_p3
    ld hl, (tile_color_bank0 & #3FFF) | #8000
...
load_color_bank1:
    ...
    ld a, COLOR_DATA_BANK
    call mapper_set_bank_p3
    ld hl, (tile_color_bank0 & #3FFF) | #8000       ; Same source as Bank 0
...
tilebank_tilebank_1760723902303_load_color_bank0:
    ...
    ld a, COLOR_DATA_BANK
    call mapper_set_bank_p3
    ld hl, (tilebank_color_data_0 & #3FFF) | #8000
    ld de, CLRTBL2 + (0 * 8)
    ld bc, 328
    call FAST_LDIRVM
    call mapper_pop_p3
...
; Data start address: #1C000
; Total data bytes (post-ZX0 / final): 2248
; Zones used: 1
; ------------------------------------------------------------------
; ZONE 00 [#1C000-#20000] bank 6 used=2248 slack=14136
;   + tile_pattern_bank0, tilebank_pattern_data_0 @ +#0000 size=610
;   + tile_color_bank0, tilebank_color_data_0 @ +#0262 size=380
;   + SCREEN_PAN1_0_LAYOUT @ +#03DE size=101
;   + SCREEN_PAN1_0_EFFECTS_LAYOUT @ +#0443 size=6
;   + SCREEN_PAN1_0_EFFECT_ZONE_TABLE @ +#0449 size=1
;   + BEHAVIOR_PAN1_0_DATA @ +#044A size=53
;   + SCREEN_PAN2_1_LAYOUT @ +#047F size=79
;   + SCREEN_PAN2_1_EFFECTS_LAYOUT @ +#04CE size=6
;   + SCREEN_PAN2_1_EFFECT_ZONE_TABLE @ +#04D4 size=1
;   + BEHAVIOR_PAN2_1_DATA @ +#04D5 size=37
;   + SCREEN_PAN3_2_LAYOUT @ +#04FA size=118
;   + SCREEN_PAN3_2_EFFECTS_LAYOUT @ +#0570 size=6
;   + SCREEN_PAN3_2_EFFECT_ZONE_TABLE @ +#0576 size=1
;   + BEHAVIOR_PAN3_2_DATA @ +#0577 size=66
;   + SCREEN_PAN4_3_LAYOUT @ +#05B9 size=147
;   + SCREEN_PAN4_3_EFFECTS_LAYOUT @ +#064C size=6
;   + SCREEN_PAN4_3_EFFECT_ZONE_TABLE @ +#0652 size=1
;   + BEHAVIOR_PAN4_3_DATA @ +#0653 size=74
;   + SCREEN_PAN5_4_LAYOUT @ +#069D size=167
;   + SCREEN_PAN5_4_EFFECTS_LAYOUT @ +#0744 size=6
;   + SCREEN_PAN5_4_EFFECT_ZONE_TABLE @ +#074A size=1
;   + BEHAVIOR_PAN5_4_DATA @ +#074B size=76
;   + SCREEN_PAN62_5_LAYOUT @ +#0797 size=93
;   + SCREEN_PAN62_5_EFFECTS_LAYOUT @ +#07F4 size=6
;   + SCREEN_PAN62_5_EFFECT_ZONE_TABLE @ +#07FA size=1
;   + BEHAVIOR_PAN62_5_DATA @ +#07FB size=57
;   + SCREEN_PAN7_6_LAYOUT @ +#0834 size=97
;   + SCREEN_PAN7_6_EFFECTS_LAYOUT @ +#0895 size=6
;   + SCREEN_PAN7_6_EFFECT_ZONE_TABLE @ +#089B size=1
;   + BEHAVIOR_PAN7_6_DATA @ +#089C size=44

    org #1C000
; ==================================================================
; DATA ZONE 00 (bank 6) used=2248 slack=14136
; ==================================================================
; ==================================================================
; TILE PATTERN BANK 0 (Base patterns) - bank4 data
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (360 -> 282 bytes)
    DB #06,#03,#1F,#3F,#7F,#7E,#7D,#78,#F8,#FF,#86,#AB,#D4,#AA,#50,#00
    DB #96,#F2,#E8,#D0,#A0,#D0,#E0,#C0,#9A,#00,#20,#00,#46,#80,#00,#02
    DB #00,#2B,#57,#2B,#57,#5F,#7B,#7F,#7C,#FF,#82,#FB,#EF,#9D,#E7,#81
    DB #2A,#F7,#7F,#63,#4F,#7F,#77,#7D,#7F,#00,#EB,#D4,#EA,#D5,#2A,#C1
    DB #FF,#00,#10,#18,#A8,#38,#28,#7C,#AC,#00,#7F,#E8,#7A,#75,#FC,#67
    DB #00,#FE,#EE,#BE,#5E,#FF,#ED,#B7,#FF,#B1,#B9,#ED,#FE,#FF,#A9,#7E
    DB #F6,#00,#7F,#22,#00,#FB,#4F,#EF,#F9,#D3,#FE,#87,#FB,#00,#FF,#D5
    DB #80,#80,#6E,#DF,#FF,#EB,#5D,#A8,#10,#20,#24,#FB,#7F,#AD,#5B,#37
    DB #00,#00,#08,#01,#F6,#FB,#FB,#F2,#A8,#FD,#40,#56,#00,#02,#0F,#1F
    DB #3A,#7D,#70,#58,#60,#C8,#F8,#FC,#96,#03,#15,#01,#05,#0B,#AC,#C4
    DB #80,#C0,#C0,#A8,#C2,#A5,#05,#83,#AA,#03,#25,#05,#03,#01,#E0,#E0
    DB #50,#AD,#C4,#C0,#9E,#54,#FF,#E9,#A0,#C4,#FD,#F0,#A0,#C4,#E1,#E3
    DB #E8,#2B,#72,#0E,#1F,#7E,#FF,#BA,#D3,#F6,#EB,#BF,#83,#01,#A7,#7B
    DB #5D,#79,#FD,#79,#21,#FC,#A8,#E8,#9C,#DE,#6C,#3F,#00,#93,#25,#83
    DB #03,#0A,#FC,#68,#B4,#3B,#D5,#2B,#55,#22,#A9,#C0,#D9,#3F,#E3,#FE
    DB #BE,#1E,#1F,#97,#00,#A7,#40,#4F,#17,#0B,#9F,#27,#07,#03,#03,#57
    DB #79,#F0,#E7,#10,#00,#07,#FF,#0A,#07,#23,#F6,#DF,#5B,#B9,#9E,#80
    DB #0B,#E7,#07,#C3,#07,#85,#03,#55,#55,#80
...
tile_color_bank0:
    ; ZX0 compressed tile_color (360 -> 52 bytes)
    DB #8A,#51,#41,#0E,#F2,#E4,#FE,#7A,#CF,#51,#40,#FB,#CC,#81,#A6,#FF
    DB #71,#21,#57,#71,#08,#BD,#E1,#F1,#F0,#BD,#AF,#FE,#4F,#80,#57,#69
    DB #B1,#41,#47,#74,#70,#3D,#A8,#7C,#80,#13,#F1,#D1,#B0,#F5,#50,#7D
    DB #B2,#75,#55,#58
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 101 bytes)
    DB #91,#FF,#60,#F1,#00,#01,#11,#12,#C0,#60,#94,#02,#03,#13,#14,#23
    DB #19,#1A,#C5,#C4,#E2,#F9,#1B,#1C,#3D,#80,#55,#DF,#38,#88,#FC,#DC
    DB #21,#22,#18,#F9,#EF,#80,#77,#38,#E2,#FC,#37,#23,#24,#18,#3E,#EF
    DB #00,#89,#15,#16,#52,#25,#17,#18,#0F,#12,#79,#80,#5F,#12,#78,#80
    DB #4D,#DE,#A0,#FA,#BC,#01,#00,#D9,#90,#76,#A1,#93,#FF,#BD,#FA,#5E
    DB #37,#91,#77,#58,#D7,#60,#97,#FC,#D8,#59,#EE,#1E,#FC,#5F,#41,#C1
    DB #FE,#47,#55,#55,#80
...
BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 53 bytes)
    DB #91,#00,#69,#10,#F5,#C0,#1F,#F9,#85,#C0,#53,#E1,#F9,#FE,#D9,#58
    DB #7D,#C0,#5F,#F7,#C4,#40,#E0,#C0,#5F,#FE,#F0,#C0,#4F,#CE,#78,#C0
    DB #0F,#E4,#7F,#F7,#C6,#1F,#C0,#5F,#F5,#C0,#60,#E4,#18,#38,#C2,#1F
    DB #FE,#05,#1D,#55,#56
...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 79 bytes)
    DB #95,#FF,#55,#8E,#11,#12,#FC,#08,#E1,#21,#22,#C0,#23,#13,#14,#82
    DB #FC,#37,#23,#24,#00,#10,#48,#FF,#15,#16,#F8,#D4,#58,#CE,#00,#01
    DB #E7,#F4,#60,#F3,#17,#18,#08,#08,#F9,#C5,#C6,#FC,#33,#02,#03,#E7
    DB #F8,#D1,#F4,#F3,#19,#1A,#E5,#B4,#F1,#FC,#C9,#4C,#E0,#05,#94,#25
    DB #26,#1B,#1C,#23,#27,#28,#F0,#81,#C4,#7C,#80,#05,#D5,#55,#60
...
BEHAVIOR_PAN2_1_DATA:
    ; ZX0 compressed behavior (768 -> 37 bytes)
    DB #95,#00,#55,#A4,#10,#3D,#C0,#5D,#C4,#00,#43,#F6,#F8,#14,#17,#FE
    DB #F4,#FE,#A9,#04,#10,#5F,#D0,#5F,#AD,#D7,#C8,#DC,#4C,#D1,#96,#E0
    DB #C0,#05,#D5,#55,#60
...
SCREEN_PAN3_2_LAYOUT:
    ; ZX0 compressed layout (768 -> 118 bytes)
    DB #65,#25,#26,#FF,#19,#94,#27,#28,#FF,#7C,#80,#44,#BC,#08,#00,#58
    DB #64,#00,#01,#01,#21,#22,#58,#60,#02,#03,#03,#23,#24,#43,#8E,#6F
    DB #11,#12,#FC,#4E,#00,#4F,#6E,#63,#13,#14,#93,#FC,#F2,#81,#13,#80
    DB #15,#1B,#08,#F1,#FF,#C0,#37,#22,#DC,#7D,#91,#7E,#FD,#C8,#F3,#22
    DB #8F,#36,#7E,#FF,#02,#A6,#C6,#78,#C8,#D8,#F8,#22,#19,#1A,#0F,#A6
    DB #FF,#BF,#66,#DC,#C7,#78,#62,#1B,#1C,#4E,#74,#DE,#DF,#C6,#1F,#80
    DB #1F,#FE,#C9,#0E,#EE,#EE,#80,#43,#FF,#3A,#FC,#95,#80,#F7,#FE,#95
    DB #80,#F5,#FE,#D5,#55,#60
...
BEHAVIOR_PAN3_2_DATA:
    ; ZX0 compressed behavior (768 -> 66 bytes)
    DB #A9,#10,#00,#47,#81,#C0,#12,#91,#04,#7F,#F1,#FE,#F1,#C0,#0F,#DE
    DB #5F,#FE,#5F,#C0,#57,#C8,#FF,#80,#54,#6F,#04,#FF,#D0,#C0,#FC,#FE
    DB #91,#BE,#DC,#3C,#37,#22,#5E,#E6,#4F,#C0,#38,#D4,#3D,#66,#7D,#C0
    DB #F7,#90,#7D,#DF,#E6,#F5,#C0,#F7,#7A,#D0,#C0,#7D,#FE,#E1,#C0,#5D
    DB #55,#56
...
SCREEN_PAN4_3_LAYOUT:
    ; ZX0 compressed layout (768 -> 147 bytes)
    DB #99,#FF,#80,#25,#26,#FF,#98,#15,#16,#FF,#12,#38,#27,#28,#C0,#22
    DB #17,#18,#57,#D2,#80,#25,#19,#1A,#48,#90,#1B,#1C,#02,#3C,#11,#12
    DB #FC,#38,#80,#08,#F0,#13,#14,#FC,#E6,#80,#39,#1D,#1E,#60,#77,#E4
    DB #5E,#81,#39,#1F,#20,#BC,#0F,#65,#83,#00,#FC,#BC,#80,#1F,#F9,#9F
    DB #BC,#80,#07,#DE,#BC,#80,#57,#DF,#BC,#80,#17,#D1,#00,#DD,#80,#19
    DB #24,#FF,#00,#01,#01,#21,#22,#59,#61,#02,#03,#03,#23,#24,#21,#22
    DB #5F,#A8,#7B,#BC,#90,#80,#F7,#A8,#BC,#78,#80,#5F,#E8,#C7,#F4,#77
    DB #DA,#BD,#FF,#80,#3E,#E8,#F1,#08,#FF,#CD,#F4,#BD,#DB,#FF,#80,#7D
    DB #FF,#7F,#14,#DF,#CF,#02,#00,#4F,#FE,#D7,#14,#BF,#FF,#DE,#FD,#DA
    DB #D9,#55,#56
...
BEHAVIOR_PAN4_3_DATA:
    ...
    DB #9A,#00,#10,#A5,#00,#FF,#EA,#FE,#1E,#C0,#45,#5F,#FE,#5E,#C0,#11
    DB #FF,#F0,#4E,#07,#9F,#AC,#C0,#17,#9F,#B8,#C0,#17,#9F,#BC,#C0,#07
    DB #DF,#BC,#C0,#17,#F5,#FF,#C0,#7F,#FF,#C0,#40,#D8,#38,#F5,#C0,#79
    DB #00,#5D,#97,#36,#D4,#C0,#3D,#E8,#78,#C0,#49,#91,#04,#04,#04,#37
    DB #B0,#7D,#EA,#E4,#C0,#68,#00,#4D,#55,#56
...
SCREEN_PAN5_4_LAYOUT:
    ; ZX0 compressed layout (768 -> 167 bytes)
    DB #99,#FF,#88,#19,#26,#FF,#F7,#05,#04,#FC,#EF,#F6,#FF,#FE,#F6,#EE
    DB #3A,#1B,#28,#F6,#3D,#07,#06,#FC,#FE,#F6,#C0,#3F,#EE,#83,#80,#CF
    DB #86,#9A,#F7,#FE,#F8,#E4,#80,#3C,#86,#FF,#9A,#FE,#7F,#E4,#84,#00
    DB #FF,#DA,#00,#17,#83,#C0,#FF,#E4,#9E,#B9,#80,#FE,#0F,#87,#FF,#7B
    DB #9E,#81,#91,#C0,#BB,#07,#7A,#F9,#38,#80,#5F,#7A,#FE,#38,#80,#57
    DB #F6,#7A,#14,#4F,#F8,#F7,#EC,#60,#7A,#D9,#14,#3F,#F8,#DF,#EC,#B8
    DB #3D,#ED,#D3,#14,#DE,#EC,#B8,#3F,#B6,#74,#14,#E1,#EC,#F7,#B6,#C7
    DB #FE,#FC,#6A,#E0,#3D,#C0,#3F,#6A,#C3,#E0,#D3,#C0,#34,#00,#E4,#00
    DB #CC,#00,#1F,#FC,#5F,#80,#0F,#86,#4F,#00,#0F,#E6,#E0,#82,#67,#04
    DB #1D,#1E,#64,#E6,#E1,#00,#27,#1F,#20,#08,#9F,#FE,#E6,#FD,#BD,#FC
    DB #1F,#BD,#D1,#FC,#D5,#55,#60
...
BEHAVIOR_PAN5_4_DATA:
    ; ZX0 compressed behavior (768 -> 76 bytes)
    DB #9A,#00,#10,#FF,#F6,#FE,#0F,#E1,#CF,#DA,#C0,#04,#FF,#DA,#C0,#05
    DB #7D,#DA,#E4,#FE,#3B,#D2,#D4,#C0,#28,#00,#14,#F7,#BA,#FD,#F8,#EC
    DB #F5,#C0,#7F,#F8,#61,#7A,#79,#EC,#7F,#F6,#C1,#C0,#F7,#B6,#DE,#FE
    DB #C0,#42,#95,#00,#1D,#70,#1C,#C9,#00,#5C,#81,#D8,#E4,#C0,#1E,#FE
    DB #57,#D5,#C0,#B9,#04,#FE,#A0,#10,#05,#D5,#55,#60
...
SCREEN_PAN62_5_LAYOUT:
    ; ZX0 compressed layout (768 -> 93 bytes)
    DB #25,#04,#FF,#4B,#06,#D4,#C0,#F0,#80,#1E,#9B,#F3,#05,#FC,#F9,#E6
    DB #00,#54,#A1,#04,#2F,#08,#FF,#84,#42,#F7,#81,#DA,#7D,#FC,#F1,#80
    DB #F5,#00,#28,#06,#13,#C5,#80,#1D,#74,#80,#13,#31,#9C,#E5,#90,#6F
    DB #07,#FC,#22,#11,#12,#42,#3C,#21,#22,#C0,#F6,#82,#79,#04,#13,#14
    DB #FC,#63,#23,#24,#CF,#C0,#82,#7D,#00,#27,#1F,#20,#08,#9E,#FE,#00
    DB #53,#F1,#3D,#FC,#F5,#80,#FC,#3D,#FC,#6D,#04,#55,#56
...
BEHAVIOR_PAN62_5_DATA:
    ; ZX0 compressed behavior (768 -> 57 bytes)
    DB #25,#10,#00,#4E,#C0,#40,#7F,#DB,#FE,#7F,#E6,#95,#00,#4A,#10,#12
    DB #F9,#04,#FF,#C0,#5F,#F3,#93,#FE,#D7,#C0,#D7,#FE,#91,#C0,#42,#85
    DB #00,#03,#37,#A4,#C0,#C0,#E5,#FE,#79,#C0,#57,#D6,#52,#E7,#04,#FE
    DB #95,#C0,#F7,#FE,#85,#C0,#75,#55,#58
...
SCREEN_PAN7_6_LAYOUT:
    ; ZX0 compressed layout (768 -> 97 bytes)
    DB #7C,#04,#1D,#1E,#FC,#1B,#05,#8F,#FB,#06,#FF,#FE,#06,#6B,#0D,#0E
    DB #FF,#04,#C4,#C0,#88,#0F,#10,#E0,#80,#7B,#9B,#05,#83,#FC,#D1,#80
    DB #89,#07,#06,#0E,#6E,#17,#D1,#80,#89,#06,#07,#53,#DF,#00,#6C,#E1
    DB #FC,#F4,#00,#17,#75,#00,#7E,#2D,#FC,#17,#C0,#00,#1E,#3D,#F0,#06
    DB #48,#3F,#FD,#C5,#BC,#F8,#48,#0F,#FD,#E0,#C5,#80,#C8,#44,#0F,#83
    DB #FF,#FD,#BC,#00,#14,#CC,#D4,#F4,#80,#7F,#C5,#80,#47,#F5,#00,#55
    DB #58
...
BEHAVIOR_PAN7_6_DATA:
    ; ZX0 compressed behavior (768 -> 44 bytes)
    DB #80,#10,#0A,#00,#44,#AF,#11,#F9,#C1,#C0,#39,#46,#3D,#80,#1F,#C0
    DB #10,#76,#1E,#47,#61,#C0,#10,#F3,#FF,#80,#10,#7F,#FE,#C4,#C8,#E1
    DB #C0,#0E,#A2,#53,#48,#40,#17,#C0,#C0,#5D,#55,#56
...
; ==================================================================
; Frame group: HERO_LEFT_0_F0
HERO_LEFT_0_F0_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_LEFT_0_F0_DATA
; Frame group: HERO_LEFT_0_F1
HERO_LEFT_0_F1_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_LEFT_0_F1_DATA
; Frame group: HERO_LEFT_0_F2
HERO_LEFT_0_F2_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_LEFT_0_F2_DATA
; Frame group: HERO_LEFT_0_F3
HERO_LEFT_0_F3_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_LEFT_0_F3_DATA
; Frame group: BIRD_1_F0
BIRD_1_F0_LAYER1 EQU ZX0_SPRITE_FRAME_BIRD_1_F0_DATA
; Frame group: BIRD_1_F1
BIRD_1_F1_LAYER1 EQU ZX0_SPRITE_FRAME_BIRD_1_F1_DATA
; Frame group: BIRD_1_F2
BIRD_1_F2_LAYER1 EQU ZX0_SPRITE_FRAME_BIRD_1_F2_DATA
; Frame group: BIRD_1_F3
BIRD_1_F3_LAYER1 EQU ZX0_SPRITE_FRAME_BIRD_1_F3_DATA
; Frame group: BOT1_2_F0
BOT1_2_F0_LAYER1 EQU ZX0_SPRITE_FRAME_BOT1_2_F0_DATA
; Frame group: BOT2_RIGHT_3_F1
BOT2_RIGHT_3_F1_LAYER0 EQU ZX0_SPRITE_FRAME_BOT2_RIGHT_3_F1_DATA
; Frame group: HERO_DEAD_4_F2
HERO_DEAD_4_F2_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F2_DATA
; Frame group: HERO_DEAD_4_F4
HERO_DEAD_4_F4_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F4_DATA
; Frame group: HERO_DEAD_4_F5
HERO_DEAD_4_F5_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F5_DATA
; Frame group: HERO_DEAD_4_F6
HERO_DEAD_4_F6_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F6_DATA
; Frame group: HERO_DEAD_4_F7
HERO_DEAD_4_F7_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F7_DATA
; Frame group: HERO_DEAD_4_F8
HERO_DEAD_4_F8_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F8_DATA
; Frame group: HERO_DEAD_4_F9
HERO_DEAD_4_F9_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F9_DATA
; Frame group: HERO_DEAD_4_F10
HERO_DEAD_4_F10_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F10_DATA
; Frame group: HERO_DEAD_4_F11
HERO_DEAD_4_F11_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F11_DATA
; Frame group: HERO_DEAD_4_F12
HERO_DEAD_4_F12_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F12_DATA
; Frame group: HERO_DEAD_4_F13
HERO_DEAD_4_F13_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_DEAD_4_F13_DATA
; Frame group: NEW_SPRITE_5_F0
NEW_SPRITE_5_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA
; Frame group: GEMA1_6_F0
GEMA1_6_F0_LAYER2 EQU ZX0_SPRITE_FRAME_GEMA1_6_F0_DATA
; Frame group: BOX_7_F0
BOX_7_F0_LAYER1 EQU ZX0_SPRITE_FRAME_BOX_7_F0_DATA
; Frame group: HERO_RIGHT_8_F0
HERO_RIGHT_8_F0_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_RIGHT_8_F0_DATA
; Frame group: HERO_RIGHT_8_F1
HERO_RIGHT_8_F1_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_RIGHT_8_F1_DATA
; Frame group: HERO_RIGHT_8_F2
HERO_RIGHT_8_F2_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_RIGHT_8_F2_DATA
; Frame group: HERO_RIGHT_8_F3
HERO_RIGHT_8_F3_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_RIGHT_8_F3_DATA
; Frame group: BOT2_LEFT_9_F1
BOT2_LEFT_9_F1_LAYER0 EQU ZX0_SPRITE_FRAME_BOT2_LEFT_9_F1_DATA
