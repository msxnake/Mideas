...
tile_color_bank0:
    ...
    DB #F0,#6F,#41,#9E,#3A,#20,#FE,#F1,#FE,#AA,#F8,#9D,#FC,#1A,#81,#39
    DB #FE,#D5,#55,#60
load_color_bank0:
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #4F,#B8,#4C,#B0,#F4,#80,#A6,#86,#80,#85,#E7,#30,#C6,#FC,#FC,#82
    DB #FB,#80,#3F,#BD,#FC,#1B,#80,#E3,#FB,#D0,#55,#55,#80
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #FF,#10,#68,#14,#E5,#94,#F3,#78,#C4,#E0,#E1,#42,#39,#C0,#04,#D6
    DB #90,#13,#D7,#D9,#BE,#07,#E5,#C9,#98,#F1,#C0,#1A,#04,#79,#BA,#5B
    DB #08,#8F,#C0,#FE,#47,#E0,#C1,#FE,#4D,#55,#56
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #C0,#0A,#08,#54,#F5,#06,#78,#D4,#5E,#AA,#5F,#54,#47,#A0,#2B,#14
    DB #22,#14,#10,#01,#36,#AA,#54,#CC,#30,#57,#34,#60,#73,#20,#57,#61
