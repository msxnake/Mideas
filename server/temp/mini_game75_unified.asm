; ==================================================================
; MINI_GAME75 - MEGAROM UNIFIED FILE
...
; ------------------------------------------------------------------
; Bank 1 [#6000-#8000]: components (51818/8192 bytes est.)
; Bank 2 [#8000-#A000]: statemachine (18222/8192 bytes est.)
; Bank 3 [#A000-#C000]: gameflow (13657/8192 bytes est.)
; Bank 4 [#6000-#8000]: entities (19757/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 5 [#8000-#A000]: sound (9787/8192 bytes est.) [FAR — accessed via trampoline]
...
; Bank 8 [#8000-#A000]: sprites (6306/8192 bytes est.) [FAR — accessed via trampoline]
...
; Bank 11 [#8000-#A000]: font (1919/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 12 [#A000-#C000]: patterns_code (838/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 13 [#6000-#8000]: colors_code (814/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 14 [#8000-#A000]: menus (437/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 15 [#A000-#C000]: hud (79/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 4+ (data) [#C000+]: DATA (patterns, colors, screens, font, presentation)
; ------------------------------------------------------------------
; Far code banks: bank4(entities) bank5(sound) bank6(screens_code) bank7(worlds) bank8(sprites) bank9(animtiles) bank10(scroll) bank11(font) bank12(patterns_code) bank13(colors_code) bank14(menus) bank15(hud)
; ------------------------------------------------------------------
...
; Estimated payload bytes: 147760
; Estimated banks used: 19
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (838 bytes)
; BANK 00 @#03A6 : colors.asm (814 bytes)
; BANK 00 @#06D4 : components.asm part 1/7 (6444 bytes)
...
; BANK 06 @#0000 : components.asm part 7/7 (4439 bytes)
; BANK 06 @#1157 : entities.asm part 1/3 (3753 bytes)
; BANK 07 @#0000 : entities.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : entities.asm part 3/3 (7812 bytes)
; BANK 08 @#1E84 : worlds.asm (380 bytes)
; BANK 09 @#0000 : worlds.asm (7681 bytes)
; BANK 09 @#1E01 : screens.asm part 1/2 (511 bytes)
; BANK 10 @#0000 : screens.asm part 2/2 (8192 bytes)
; BANK 11 @#0000 : screens.asm part 3/2 (237 bytes)
; BANK 11 @#00ED : sprites.asm (6306 bytes)
; BANK 11 @#198F : font.asm (1649 bytes)
; BANK 12 @#0000 : font.asm (270 bytes)
; BANK 12 @#010E : hud.asm (79 bytes)
; BANK 12 @#015D : menus.asm (437 bytes)
; BANK 12 @#0312 : sound.asm part 1/2 (7406 bytes)
; BANK 13 @#0000 : sound.asm part 2/2 (2381 bytes)
; BANK 13 @#094D : scroll.asm (2353 bytes)
; BANK 13 @#127E : animtiles.asm (3458 bytes)
; BANK 14 @#0000 : animtiles.asm (1155 bytes)
; BANK 14 @#0483 : statemachine.asm part 1/3 (7037 bytes)
; BANK 15 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 16 @#0000 : statemachine.asm part 3/3 (3029 bytes)
; BANK 16 @#0BD5 : gameflow.asm part 1/2 (5163 bytes)
; BANK 17 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 18 @#0000 : gameflow.asm part 3/2 (304 bytes); ==================================================================
...
; RESOURCE_ID_FIRE_8_F0_LAYER1             EQU 33
; RESOURCE_ID_FIRE_8_F1_LAYER1             EQU 34
; RESOURCE_ID_FIRE2_LEFT_9_F0_LAYER1       EQU 35
; RESOURCE_ID_FIRE2_LEFT_9_F1_LAYER1       EQU 36
; RESOURCE_ID_FIRE2_LEFT_9_F2_LAYER1       EQU 37
; RESOURCE_ID_FIRE2_LEFT_9_F3_LAYER1       EQU 38
; RESOURCE_ID_FIRE2_LEFT_9_F4_LAYER1       EQU 39
; RESOURCE_ID_NEW_SPRITE_1_10_F0_LAYER1    EQU 40
; RESOURCE_ID_NEW_SPRITE_1_10_F0_LAYER3    EQU 41
; RESOURCE_ID_HERO_RIGHT_11_F0_LAYER1      EQU 42
; RESOURCE_ID_HERO_RIGHT_11_F0_LAYER2      EQU 43
; RESOURCE_ID_HERO_RIGHT_11_F1_LAYER1      EQU 44
; RESOURCE_ID_HERO_RIGHT_11_F1_LAYER2      EQU 45
; RESOURCE_ID_HERO_RIGHT_11_F2_LAYER1      EQU 46
; RESOURCE_ID_HERO_RIGHT_11_F2_LAYER2      EQU 47
; RESOURCE_ID_HERO_RIGHT_11_F3_LAYER1      EQU 48
; RESOURCE_ID_HERO_RIGHT_11_F3_LAYER2      EQU 49
; RESOURCE_ID_BOT2_LEFT_12_F0_LAYER0       EQU 50
; RESOURCE_ID_BOT2_LEFT_12_F1_LAYER0       EQU 51
; RESOURCE_ID_FIRE2_RIGHT_13_F0_LAYER1     EQU 52
; RESOURCE_ID_FIRE2_RIGHT_13_F1_LAYER1     EQU 53
; RESOURCE_ID_FIRE2_RIGHT_13_F2_LAYER1     EQU 54
; RESOURCE_ID_FIRE2_RIGHT_13_F3_LAYER1     EQU 55
; RESOURCE_ID_FIRE2_RIGHT_13_F4_LAYER1     EQU 56
; RESOURCE_ID_SPRITE_PLACEHOLDER_PATTERN   EQU 57
; RESOURCE_ID_TILE_PATTERN_BANK0           EQU 58
; RESOURCE_ID_TILEBANK_PATTERN_DATA_0      EQU 59
; RESOURCE_ID_TILE_COLOR_BANK0             EQU 60
; RESOURCE_ID_TILEBANK_COLOR_DATA_0        EQU 61
; RESOURCE_ID_SCREEN_PAN1_0_LAYOUT         EQU 62
; RESOURCE_ID_SCREEN_PAN1_0_EFFECTS_LAYOUT EQU 63
; RESOURCE_ID_SCREEN_PAN1_0_EFFECT_ZONE_TABLE EQU 64
; RESOURCE_ID_BEHAVIOR_PAN1_0_DATA         EQU 65
; RESOURCE_ID_SCREEN_PAN2_1_LAYOUT         EQU 66
; RESOURCE_ID_SCREEN_PAN2_1_EFFECTS_LAYOUT EQU 67
; RESOURCE_ID_SCREEN_PAN2_1_EFFECT_ZONE_TABLE EQU 68
; RESOURCE_ID_BEHAVIOR_PAN2_1_DATA         EQU 69
; RESOURCE_ID_SCREEN_PAN3_2_LAYOUT         EQU 70
; RESOURCE_ID_SCREEN_PAN3_2_EFFECTS_LAYOUT EQU 71
; RESOURCE_ID_SCREEN_PAN3_2_EFFECT_ZONE_TABLE EQU 72
; RESOURCE_ID_BEHAVIOR_PAN3_2_DATA         EQU 73
; RESOURCE_ID_SCREEN_PAN4_3_LAYOUT         EQU 74
; RESOURCE_ID_SCREEN_PAN4_3_EFFECTS_LAYOUT EQU 75
; RESOURCE_ID_SCREEN_PAN4_3_EFFECT_ZONE_TABLE EQU 76
; RESOURCE_ID_BEHAVIOR_PAN4_3_DATA         EQU 77
; RESOURCE_ID_SCREEN_PAN5_4_LAYOUT         EQU 78
; RESOURCE_ID_SCREEN_PAN5_4_EFFECTS_LAYOUT EQU 79
; RESOURCE_ID_SCREEN_PAN5_4_EFFECT_ZONE_TABLE EQU 80
; RESOURCE_ID_BEHAVIOR_PAN5_4_DATA         EQU 81
; RESOURCE_ID_SCREEN_PAN62_5_LAYOUT        EQU 82
; RESOURCE_ID_SCREEN_PAN62_5_EFFECTS_LAYOUT EQU 83
; RESOURCE_ID_SCREEN_PAN62_5_EFFECT_ZONE_TABLE EQU 84
; RESOURCE_ID_BEHAVIOR_PAN62_5_DATA        EQU 85
; RESOURCE_ID_SCREEN_PAN7_6_LAYOUT         EQU 86
; RESOURCE_ID_SCREEN_PAN7_6_EFFECTS_LAYOUT EQU 87
; RESOURCE_ID_SCREEN_PAN7_6_EFFECT_ZONE_TABLE EQU 88
; RESOURCE_ID_BEHAVIOR_PAN7_6_DATA         EQU 89
; RESOURCE_ID_MUSIC_TRACK_0_ODA1_DATA      EQU 90
; RESOURCE_ID_FONT_PATTERN_DATA            EQU 91
; RESOURCE_ID_FONT_COLOR_DATA              EQU 92
...
;     dw 32
;     ; BIRD_1_F3_LAYER1
;     db RESOURCE_ID_BIRD_1_F3_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9028
;     dw 32
;     ; BOT1_2_F0_LAYER1
;     db RESOURCE_ID_BOT1_2_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9048
;     dw 32
;     ; BOT2_RIGHT_3_F0_LAYER0
;     db RESOURCE_ID_BOT2_RIGHT_3_F0_LAYER0, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9068
;     dw 32
;     ; BOT2_RIGHT_3_F1_LAYER0
;     db RESOURCE_ID_BOT2_RIGHT_3_F1_LAYER0, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9088
;     dw 32
;     ; HERO_DEAD_4_F0_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #90A8
;     dw 32
;     ; HERO_DEAD_4_F1_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F1_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #90C8
;     dw 32
;     ; HERO_DEAD_4_F2_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F2_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #90E8
;     dw 32
;     ; HERO_DEAD_4_F3_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F3_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9108
;     dw 32
;     ; HERO_DEAD_4_F4_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F4_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9128
;     dw 32
;     ; HERO_DEAD_4_F5_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F5_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9148
;     dw 32
;     ; HERO_DEAD_4_F6_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F6_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9168
;     dw 32
;     ; HERO_DEAD_4_F7_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F7_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9188
;     dw 32
;     ; HERO_DEAD_4_F8_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F8_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #91A8
;     dw 32
;     ; HERO_DEAD_4_F9_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F9_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #91C8
;     dw 32
;     ; HERO_DEAD_4_F10_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F10_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #91E8
;     dw 32
;     ; HERO_DEAD_4_F11_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F11_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9208
;     dw 32
;     ; HERO_DEAD_4_F12_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F12_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9228
;     dw 32
;     ; HERO_DEAD_4_F13_LAYER1
;     db RESOURCE_ID_HERO_DEAD_4_F13_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9248
;     dw 32
...
;     dw 64
;     ; GEMA1_6_F0_LAYER2
;     db RESOURCE_ID_GEMA1_6_F0_LAYER2, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9268
;     dw 32
;     ; GEMA1_6_F1_LAYER2
;     db RESOURCE_ID_GEMA1_6_F1_LAYER2, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9288
;     dw 32
;     ; BOX_7_F0_LAYER1
;     db RESOURCE_ID_BOX_7_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #92A8
;     dw 32
;     ; FIRE_8_F0_LAYER1
;     db RESOURCE_ID_FIRE_8_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #92C8
;     dw 32
;     ; FIRE_8_F1_LAYER1
;     db RESOURCE_ID_FIRE_8_F1_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #92E8
;     dw 32
;     ; FIRE2_LEFT_9_F0_LAYER1
;     db RESOURCE_ID_FIRE2_LEFT_9_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9308
;     dw 32
;     ; FIRE2_LEFT_9_F1_LAYER1
;     db RESOURCE_ID_FIRE2_LEFT_9_F1_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9328
;     dw 32
;     ; FIRE2_LEFT_9_F2_LAYER1
;     db RESOURCE_ID_FIRE2_LEFT_9_F2_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9348
;     dw 32
;     ; FIRE2_LEFT_9_F3_LAYER1
;     db RESOURCE_ID_FIRE2_LEFT_9_F3_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9368
;     dw 32
;     ; FIRE2_LEFT_9_F4_LAYER1
;     db RESOURCE_ID_FIRE2_LEFT_9_F4_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9388
;     dw 32
;     ; NEW_SPRITE_1_10_F0_LAYER1
;     db RESOURCE_ID_NEW_SPRITE_1_10_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #93A8
;     dw 32
;     ; NEW_SPRITE_1_10_F0_LAYER3
;     db RESOURCE_ID_NEW_SPRITE_1_10_F0_LAYER3, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #93C8
;     dw 32
;     ; HERO_RIGHT_11_F0_LAYER1
;     db RESOURCE_ID_HERO_RIGHT_11_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #93E8
;     dw 32
;     ; HERO_RIGHT_11_F0_LAYER2
;     db RESOURCE_ID_HERO_RIGHT_11_F0_LAYER2, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9408
;     dw 32
;     ; HERO_RIGHT_11_F1_LAYER1
;     db RESOURCE_ID_HERO_RIGHT_11_F1_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9428
;     dw 32
;     ; HERO_RIGHT_11_F1_LAYER2
;     db RESOURCE_ID_HERO_RIGHT_11_F1_LAYER2, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9448
;     dw 32
;     ; HERO_RIGHT_11_F2_LAYER1
;     db RESOURCE_ID_HERO_RIGHT_11_F2_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9468
;     dw 32
;     ; HERO_RIGHT_11_F2_LAYER2
;     db RESOURCE_ID_HERO_RIGHT_11_F2_LAYER2, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9488
;     dw 32
;     ; HERO_RIGHT_11_F3_LAYER1
;     db RESOURCE_ID_HERO_RIGHT_11_F3_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #94A8
;     dw 32
;     ; HERO_RIGHT_11_F3_LAYER2
;     db RESOURCE_ID_HERO_RIGHT_11_F3_LAYER2, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #94C8
;     dw 32
;     ; BOT2_LEFT_12_F0_LAYER0
;     db RESOURCE_ID_BOT2_LEFT_12_F0_LAYER0, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #94E8
;     dw 32
;     ; BOT2_LEFT_12_F1_LAYER0
;     db RESOURCE_ID_BOT2_LEFT_12_F1_LAYER0, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9508
;     dw 32
;     ; FIRE2_RIGHT_13_F0_LAYER1
;     db RESOURCE_ID_FIRE2_RIGHT_13_F0_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9528
;     dw 32
;     ; FIRE2_RIGHT_13_F1_LAYER1
;     db RESOURCE_ID_FIRE2_RIGHT_13_F1_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9548
;     dw 32
;     ; FIRE2_RIGHT_13_F2_LAYER1
;     db RESOURCE_ID_FIRE2_RIGHT_13_F2_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9568
;     dw 32
;     ; FIRE2_RIGHT_13_F3_LAYER1
;     db RESOURCE_ID_FIRE2_RIGHT_13_F3_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #9588
;     dw 32
;     ; FIRE2_RIGHT_13_F4_LAYER1
;     db RESOURCE_ID_FIRE2_RIGHT_13_F4_LAYER1, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #95A8
;     dw 32
;     ; SPRITE_PLACEHOLDER_PATTERN
;     db RESOURCE_ID_SPRITE_PLACEHOLDER_PATTERN, RESOURCE_TYPE_SPRITE_PATTERNS, RESOURCE_GROUP_SPRITES, 18
;     dw #95C8
;     dw 32
;     ; tile_pattern_bank0
...
;     db RESOURCE_ID_TILEBANK_PATTERN_DATA_0, RESOURCE_TYPE_TILE_PATTERNS, RESOURCE_GROUP_PATTERNS, 18
;     dw #8D18
;     dw 328
;     ; tile_color_bank0
...
;     db RESOURCE_ID_TILEBANK_COLOR_DATA_0, RESOURCE_TYPE_TILE_COLORS, RESOURCE_GROUP_COLORS, 18
;     dw #8E60
;     dw 328
...
;     db RESOURCE_ID_SCREEN_PAN3_2_LAYOUT, RESOURCE_TYPE_SCREEN_LAYOUT, RESOURCE_GROUP_SCREENS, 16
;     dw #994D
;     dw 768
;     ; SCREEN_PAN3_2_EFFECTS_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN3_2_EFFECTS_LAYOUT, RESOURCE_TYPE_SCREEN_EFFECTS_LAYOUT, RESOURCE_GROUP_SCREENS, 16
;     dw #9C4D
;     dw 768
...
;     db RESOURCE_ID_SCREEN_PAN4_3_LAYOUT, RESOURCE_TYPE_SCREEN_LAYOUT, RESOURCE_GROUP_SCREENS, 17
;     dw #8300
;     dw 768
;     ; SCREEN_PAN4_3_EFFECTS_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN4_3_EFFECTS_LAYOUT, RESOURCE_TYPE_SCREEN_EFFECTS_LAYOUT, RESOURCE_GROUP_SCREENS, 17
;     dw #8600
;     dw 768
...
;     db RESOURCE_ID_BEHAVIOR_PAN4_3_DATA, RESOURCE_TYPE_SCREEN_BEHAVIOR_MAP, RESOURCE_GROUP_SCREENS, 17
;     dw #8900
;     dw 768
;     ; SCREEN_PAN5_4_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN5_4_LAYOUT, RESOURCE_TYPE_SCREEN_LAYOUT, RESOURCE_GROUP_SCREENS, 17
;     dw #8C00
;     dw 768
;     ; SCREEN_PAN5_4_EFFECTS_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN5_4_EFFECTS_LAYOUT, RESOURCE_TYPE_SCREEN_EFFECTS_LAYOUT, RESOURCE_GROUP_SCREENS, 17
;     dw #8F00
;     dw 768
...
;     db RESOURCE_ID_BEHAVIOR_PAN5_4_DATA, RESOURCE_TYPE_SCREEN_BEHAVIOR_MAP, RESOURCE_GROUP_SCREENS, 17
;     dw #9200
;     dw 768
;     ; SCREEN_PAN62_5_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN62_5_LAYOUT, RESOURCE_TYPE_SCREEN_LAYOUT, RESOURCE_GROUP_SCREENS, 17
;     dw #9500
;     dw 768
;     ; SCREEN_PAN62_5_EFFECTS_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN62_5_EFFECTS_LAYOUT, RESOURCE_TYPE_SCREEN_EFFECTS_LAYOUT, RESOURCE_GROUP_SCREENS, 17
;     dw #9800
;     dw 768
...
;     db RESOURCE_ID_BEHAVIOR_PAN62_5_DATA, RESOURCE_TYPE_SCREEN_BEHAVIOR_MAP, RESOURCE_GROUP_SCREENS, 17
;     dw #9B00
;     dw 768
;     ; SCREEN_PAN7_6_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN7_6_LAYOUT, RESOURCE_TYPE_SCREEN_LAYOUT, RESOURCE_GROUP_SCREENS, 18
;     dw #8000
;     dw 768
;     ; SCREEN_PAN7_6_EFFECTS_LAYOUT
;     db RESOURCE_ID_SCREEN_PAN7_6_EFFECTS_LAYOUT, RESOURCE_TYPE_SCREEN_EFFECTS_LAYOUT, RESOURCE_GROUP_SCREENS, 18
;     dw #8300
;     dw 768
...
;     db RESOURCE_ID_BEHAVIOR_PAN7_6_DATA, RESOURCE_TYPE_SCREEN_BEHAVIOR_MAP, RESOURCE_GROUP_SCREENS, 18
;     dw #8600
;     dw 768
...
;     dw 344
;     ; FONT_COLOR_DATA
;     db RESOURCE_ID_FONT_COLOR_DATA, RESOURCE_TYPE_FONT_COLORS, RESOURCE_GROUP_FONT, 18
;     dw #8BC0
;     dw 344
...
; Total resource blocks: 93
;
; BANK 16 used 8180 / 8192
; - music_track_0_Oda1_data           1869 bytes @ #8000 (rom #24000, offset +#0000) [SOUND/MUSIC_TRACK]
; - SCREEN_PAN1_0_LAYOUT               768 bytes @ #874D (rom #2474D, offset +#074D) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PAN1_0_EFFECTS_LAYOUT       768 bytes @ #8A4D (rom #24A4D, offset +#0A4D) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - BEHAVIOR_PAN1_0_DATA               768 bytes @ #8D4D (rom #24D4D, offset +#0D4D) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - SCREEN_PAN2_1_LAYOUT               768 bytes @ #904D (rom #2504D, offset +#104D) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PAN2_1_EFFECTS_LAYOUT       768 bytes @ #934D (rom #2534D, offset +#134D) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - BEHAVIOR_PAN2_1_DATA               768 bytes @ #964D (rom #2564D, offset +#164D) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - SCREEN_PAN3_2_LAYOUT               768 bytes @ #994D (rom #2594D, offset +#194D) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PAN3_2_EFFECTS_LAYOUT       768 bytes @ #9C4D (rom #25C4D, offset +#1C4D) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - NEW_SPRITE_5_F0_LAYER1              64 bytes @ #9F4D (rom #25F4D, offset +#1F4D) [SPRITES/SPRITE_PATTERNS]
; - HERO_LEFT_0_F0_LAYER1               32 bytes @ #9F8D (rom #25F8D, offset +#1F8D) [SPRITES/SPRITE_PATTERNS]
; - HERO_LEFT_0_F0_LAYER2               32 bytes @ #9FAD (rom #25FAD, offset +#1FAD) [SPRITES/SPRITE_PATTERNS]
; - HERO_LEFT_0_F1_LAYER1               32 bytes @ #9FCD (rom #25FCD, offset +#1FCD) [SPRITES/SPRITE_PATTERNS]
; - SCREEN_PAN1_0_EFFECT_ZONE_TABLE      1 bytes @ #9FED (rom #25FED, offset +#1FED) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; - SCREEN_PAN2_1_EFFECT_ZONE_TABLE      1 bytes @ #9FEE (rom #25FEE, offset +#1FEE) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; - SCREEN_PAN3_2_EFFECT_ZONE_TABLE      1 bytes @ #9FEF (rom #25FEF, offset +#1FEF) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; - SCREEN_PAN4_3_EFFECT_ZONE_TABLE      1 bytes @ #9FF0 (rom #25FF0, offset +#1FF0) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; - SCREEN_PAN5_4_EFFECT_ZONE_TABLE      1 bytes @ #9FF1 (rom #25FF1, offset +#1FF1) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; - SCREEN_PAN62_5_EFFECT_ZONE_TABLE     1 bytes @ #9FF2 (rom #25FF2, offset +#1FF2) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; - SCREEN_PAN7_6_EFFECT_ZONE_TABLE      1 bytes @ #9FF3 (rom #25FF3, offset +#1FF3) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; FREE 12
;
; BANK 17 used 8168 / 8192
; - BEHAVIOR_PAN3_2_DATA               768 bytes @ #8000 (rom #26000, offset +#0000) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - SCREEN_PAN4_3_LAYOUT               768 bytes @ #8300 (rom #26300, offset +#0300) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PAN4_3_EFFECTS_LAYOUT       768 bytes @ #8600 (rom #26600, offset +#0600) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - BEHAVIOR_PAN4_3_DATA               768 bytes @ #8900 (rom #26900, offset +#0900) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - SCREEN_PAN5_4_LAYOUT               768 bytes @ #8C00 (rom #26C00, offset +#0C00) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PAN5_4_EFFECTS_LAYOUT       768 bytes @ #8F00 (rom #26F00, offset +#0F00) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - BEHAVIOR_PAN5_4_DATA               768 bytes @ #9200 (rom #27200, offset +#1200) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - SCREEN_PAN62_5_LAYOUT              768 bytes @ #9500 (rom #27500, offset +#1500) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PAN62_5_EFFECTS_LAYOUT      768 bytes @ #9800 (rom #27800, offset +#1800) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - BEHAVIOR_PAN62_5_DATA              768 bytes @ #9B00 (rom #27B00, offset +#1B00) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - tile_pattern_bank0                 360 bytes @ #9E00 (rom #27E00, offset +#1E00) [PATTERNS/TILE_PATTERNS]
; - HERO_LEFT_0_F1_LAYER2               32 bytes @ #9F68 (rom #27F68, offset +#1F68) [SPRITES/SPRITE_PATTERNS]
; - HERO_LEFT_0_F2_LAYER1               32 bytes @ #9F88 (rom #27F88, offset +#1F88) [SPRITES/SPRITE_PATTERNS]
; - HERO_LEFT_0_F2_LAYER2               32 bytes @ #9FA8 (rom #27FA8, offset +#1FA8) [SPRITES/SPRITE_PATTERNS]
; - HERO_LEFT_0_F3_LAYER1               32 bytes @ #9FC8 (rom #27FC8, offset +#1FC8) [SPRITES/SPRITE_PATTERNS]
; FREE 24
;
; BANK 18 used 5608 / 8192
; - SCREEN_PAN7_6_LAYOUT               768 bytes @ #8000 (rom #28000, offset +#0000) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PAN7_6_EFFECTS_LAYOUT       768 bytes @ #8300 (rom #28300, offset +#0300) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - BEHAVIOR_PAN7_6_DATA               768 bytes @ #8600 (rom #28600, offset +#0600) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - tile_color_bank0                   360 bytes @ #8900 (rom #28900, offset +#0900) [COLORS/TILE_COLORS]
; - FONT_PATTERN_DATA                  344 bytes @ #8A68 (rom #28A68, offset +#0A68) [FONT/FONT_PATTERNS]
; - FONT_COLOR_DATA                    344 bytes @ #8BC0 (rom #28BC0, offset +#0BC0) [FONT/FONT_COLORS]
; - tilebank_pattern_data_0            328 bytes @ #8D18 (rom #28D18, offset +#0D18) [PATTERNS/TILE_PATTERNS]
; - tilebank_color_data_0              328 bytes @ #8E60 (rom #28E60, offset +#0E60) [COLORS/TILE_COLORS]
; - HERO_LEFT_0_F3_LAYER2               32 bytes @ #8FA8 (rom #28FA8, offset +#0FA8) [SPRITES/SPRITE_PATTERNS]
; - BIRD_1_F0_LAYER1                    32 bytes @ #8FC8 (rom #28FC8, offset +#0FC8) [SPRITES/SPRITE_PATTERNS]
; - BIRD_1_F1_LAYER1                    32 bytes @ #8FE8 (rom #28FE8, offset +#0FE8) [SPRITES/SPRITE_PATTERNS]
; - BIRD_1_F2_LAYER1                    32 bytes @ #9008 (rom #29008, offset +#1008) [SPRITES/SPRITE_PATTERNS]
; - BIRD_1_F3_LAYER1                    32 bytes @ #9028 (rom #29028, offset +#1028) [SPRITES/SPRITE_PATTERNS]
; - BOT1_2_F0_LAYER1                    32 bytes @ #9048 (rom #29048, offset +#1048) [SPRITES/SPRITE_PATTERNS]
; - BOT2_RIGHT_3_F0_LAYER0              32 bytes @ #9068 (rom #29068, offset +#1068) [SPRITES/SPRITE_PATTERNS]
; - BOT2_RIGHT_3_F1_LAYER0              32 bytes @ #9088 (rom #29088, offset +#1088) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F0_LAYER1               32 bytes @ #90A8 (rom #290A8, offset +#10A8) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F1_LAYER1               32 bytes @ #90C8 (rom #290C8, offset +#10C8) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F2_LAYER1               32 bytes @ #90E8 (rom #290E8, offset +#10E8) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F3_LAYER1               32 bytes @ #9108 (rom #29108, offset +#1108) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F4_LAYER1               32 bytes @ #9128 (rom #29128, offset +#1128) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F5_LAYER1               32 bytes @ #9148 (rom #29148, offset +#1148) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F6_LAYER1               32 bytes @ #9168 (rom #29168, offset +#1168) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F7_LAYER1               32 bytes @ #9188 (rom #29188, offset +#1188) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F8_LAYER1               32 bytes @ #91A8 (rom #291A8, offset +#11A8) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F9_LAYER1               32 bytes @ #91C8 (rom #291C8, offset +#11C8) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F10_LAYER1              32 bytes @ #91E8 (rom #291E8, offset +#11E8) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F11_LAYER1              32 bytes @ #9208 (rom #29208, offset +#1208) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F12_LAYER1              32 bytes @ #9228 (rom #29228, offset +#1228) [SPRITES/SPRITE_PATTERNS]
; - HERO_DEAD_4_F13_LAYER1              32 bytes @ #9248 (rom #29248, offset +#1248) [SPRITES/SPRITE_PATTERNS]
; - GEMA1_6_F0_LAYER2                   32 bytes @ #9268 (rom #29268, offset +#1268) [SPRITES/SPRITE_PATTERNS]
; - GEMA1_6_F1_LAYER2                   32 bytes @ #9288 (rom #29288, offset +#1288) [SPRITES/SPRITE_PATTERNS]
; - BOX_7_F0_LAYER1                     32 bytes @ #92A8 (rom #292A8, offset +#12A8) [SPRITES/SPRITE_PATTERNS]
; - FIRE_8_F0_LAYER1                    32 bytes @ #92C8 (rom #292C8, offset +#12C8) [SPRITES/SPRITE_PATTERNS]
; - FIRE_8_F1_LAYER1                    32 bytes @ #92E8 (rom #292E8, offset +#12E8) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_LEFT_9_F0_LAYER1              32 bytes @ #9308 (rom #29308, offset +#1308) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_LEFT_9_F1_LAYER1              32 bytes @ #9328 (rom #29328, offset +#1328) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_LEFT_9_F2_LAYER1              32 bytes @ #9348 (rom #29348, offset +#1348) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_LEFT_9_F3_LAYER1              32 bytes @ #9368 (rom #29368, offset +#1368) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_LEFT_9_F4_LAYER1              32 bytes @ #9388 (rom #29388, offset +#1388) [SPRITES/SPRITE_PATTERNS]
; - NEW_SPRITE_1_10_F0_LAYER1           32 bytes @ #93A8 (rom #293A8, offset +#13A8) [SPRITES/SPRITE_PATTERNS]
; - NEW_SPRITE_1_10_F0_LAYER3           32 bytes @ #93C8 (rom #293C8, offset +#13C8) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F0_LAYER1             32 bytes @ #93E8 (rom #293E8, offset +#13E8) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F0_LAYER2             32 bytes @ #9408 (rom #29408, offset +#1408) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F1_LAYER1             32 bytes @ #9428 (rom #29428, offset +#1428) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F1_LAYER2             32 bytes @ #9448 (rom #29448, offset +#1448) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F2_LAYER1             32 bytes @ #9468 (rom #29468, offset +#1468) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F2_LAYER2             32 bytes @ #9488 (rom #29488, offset +#1488) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F3_LAYER1             32 bytes @ #94A8 (rom #294A8, offset +#14A8) [SPRITES/SPRITE_PATTERNS]
; - HERO_RIGHT_11_F3_LAYER2             32 bytes @ #94C8 (rom #294C8, offset +#14C8) [SPRITES/SPRITE_PATTERNS]
; - BOT2_LEFT_12_F0_LAYER0              32 bytes @ #94E8 (rom #294E8, offset +#14E8) [SPRITES/SPRITE_PATTERNS]
; - BOT2_LEFT_12_F1_LAYER0              32 bytes @ #9508 (rom #29508, offset +#1508) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_RIGHT_13_F0_LAYER1            32 bytes @ #9528 (rom #29528, offset +#1528) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_RIGHT_13_F1_LAYER1            32 bytes @ #9548 (rom #29548, offset +#1548) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_RIGHT_13_F2_LAYER1            32 bytes @ #9568 (rom #29568, offset +#1568) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_RIGHT_13_F3_LAYER1            32 bytes @ #9588 (rom #29588, offset +#1588) [SPRITES/SPRITE_PATTERNS]
; - FIRE2_RIGHT_13_F4_LAYER1            32 bytes @ #95A8 (rom #295A8, offset +#15A8) [SPRITES/SPRITE_PATTERNS]
; - SPRITE_PLACEHOLDER_PATTERN          32 bytes @ #95C8 (rom #295C8, offset +#15C8) [SPRITES/SPRITE_PATTERNS]
; FREE 2584
...
;   6: gema1 @ slot 25
;   7: Box @ slot 27
;   10: New Sprite_1 @ slot 28
;   11: hero_right @ slot 30
;   12: bot2_left @ slot 38
;
; WORLD -> PACK
...
sprite_asset_base_pattern_slot_runtime EQU #D44E   ; Runtime base 16x16 slot per sprite asset (14 bytes)
sprite_placeholder_base_pattern_num EQU #D45C   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #D45D   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #D45E   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (7 screens detected)
; ==================================================================
current_screen_id   EQU #D4DE   ; Currently displayed screen ID
screen_dirty_flag   EQU #D4DF   ; Screen needs redraw flag
screen_transition_cooldown EQU #D4E0   ; Cooldown frames after screen transition
current_world_id    EQU #D4E1   ; Current world ID (for multi-world support)
current_screen_index EQU #D4E2   ; Current screen index within world
current_screen_anim_group_count EQU #D4E3   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #D4E4   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #D4E5   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #D4E6   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #D4E7   ; Player X position (16-bit)
player_y            EQU #D4E9   ; Player Y position (16-bit)
player_runtime_enabled EQU #D4EB   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #D4EC   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #D4ED   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #D4EE   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #D4EF   ; Player health points
player_score        EQU #D4F0   ; Player score (16-bit)
gem_count           EQU #D4F2   ; Collectible tile counter (8-bit)
last_gem_char       EQU #D4F3   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #D4F4   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #D4F5   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #D535   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #D575   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #D5B5   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #D5F5   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #D605   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #D615   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #D625   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #D635   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #D645   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #D655   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #D656   ; Temporary 16-bit storage
temp_word_2         EQU #D658   ; Temporary 16-bit storage
temp_byte_1         EQU #D65A   ; Temporary 8-bit storage
temp_byte_2         EQU #D65B   ; Temporary 8-bit storage
temp_byte_3         EQU #D65C   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #D67C   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #D69C   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #D6BC   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #D6DC   ; 0=no SFX active, 1=playing
sfx_timer           EQU #D6DD   ; Frames remaining for current SFX
sfx_fadeout         EQU #D6DE   ; Reserved fadeout flag/state
temp_byte_7         EQU #D6DF   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #D6FF   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #D71F   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #D73F   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #D75F   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #D77F   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #D79F   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #D7BF   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #D7DF   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #D7FF   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #D81F   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #D83F   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #D85F   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #D87F   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #D89F   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #D8BF   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #D8DF   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #D8FF   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #D91F   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #D93F   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #D97F   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #D9BF   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #D9DF   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #D9FF   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #DA1F   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #DA20   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #DA21   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #DA22   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #DA23   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #DA24   ; Cached entity X for wall checks
wall_temp_y         EQU #DA25   ; Cached entity Y for wall checks
wall_hit_left       EQU #DA26   ; Hitbox left edge cache
wall_hit_top        EQU #DA27   ; Hitbox top edge cache
wall_hit_right      EQU #DA28   ; Hitbox right edge cache
wall_hit_bottom     EQU #DA29   ; Hitbox bottom edge cache
wall_hit_w          EQU #DA2A   ; Hitbox width cache (min 1)
wall_hit_h          EQU #DA2B   ; Hitbox height cache (min 1)
wall_probe_left     EQU #DA2C   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #DA2D   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #DA2E   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #DA2F   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #DA30   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #DA50   ; Number of entries in active_entity_list
hero_entity_id      EQU #DA51   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #DA52   ; 1=rebuild active_entity_list required
input_entity_list   EQU #DA53   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #DA73   ; Number of entries in input_entity_list
render_entity_list  EQU #DA74   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #DA94   ; Number of entries in render_entity_list
collision_entity_list EQU #DA95   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #DAB5   ; Number of entries in collision_entity_list
ground_entity_list  EQU #DAB6   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #DAD6   ; Number of entries in ground_entity_list
anim_entity_list    EQU #DAD7   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #DAF7   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #DAF8   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #DB18   ; Number of entities in coll_list
coll_src_left       EQU #DB19   ; Source AABB left edge (scratch)
coll_src_right      EQU #DB1A   ; Source AABB right edge (scratch)
coll_src_top        EQU #DB1B   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #DB1C   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #DB1D   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #DB1D   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #DB1F   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #DB21   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #DB23   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #DB25   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #DB27   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #DB29   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #DB2B   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #DB2D   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #DB2E   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #DB33   ; Frame counter (16-bit)
task_exec_time          EQU #DB35   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #DB37   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #DB38   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #DB38   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #DB39   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #DB3A   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #DB3B   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #DB3C   ; 0=stopped, 1=track active
music_muted          EQU #DB3D   ; 0=audible, 1=muted/pause
music_loop           EQU #DB3E   ; 0=no loop, 1=loop enabled
music_track_index    EQU #DB3F   ; Current ROM track index
music_loaded_track_index EQU #DB40   ; Cached tracker track index loaded in RAM (#FF=none)
music_row_frames     EQU #DB41   ; Frames per tracker row
music_row_countdown  EQU #DB42   ; Countdown to next row
music_order_pos      EQU #DB43   ; Current order position
music_pattern_index  EQU #DB44   ; Current pattern index
music_pattern_row    EQU #DB45   ; Current row inside pattern
music_pattern_rows   EQU #DB46   ; Cached rows in current pattern
music_track_ptr_l    EQU #DB47   ; Current track pointer low byte
music_track_ptr_h    EQU #DB48   ; Current track pointer high byte
music_pattern_ptr_l  EQU #DB49   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #DB4A   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #DB4B   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #DB4C   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #DB4C   ; Channel A
music_ch_b_note EQU #DB4D   ; Channel B
music_ch_c_note EQU #DB4E   ; Channel C
music_ch_instrument_base EQU #DB4F   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #DB4F   ; Channel A
music_ch_b_instrument EQU #DB50   ; Channel B
music_ch_c_instrument EQU #DB51   ; Channel C
music_ch_ornament_base EQU #DB52   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #DB52   ; Channel A
music_ch_b_ornament EQU #DB53   ; Channel B
music_ch_c_ornament EQU #DB54   ; Channel C
music_ch_volume_base EQU #DB55   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #DB55   ; Channel A
music_ch_b_volume EQU #DB56   ; Channel B
music_ch_c_volume EQU #DB57   ; Channel C
music_ch_vol_step_base EQU #DB58   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #DB58   ; Channel A
music_ch_b_vol_step EQU #DB59   ; Channel B
music_ch_c_vol_step EQU #DB5A   ; Channel C
music_ch_tone_step_base EQU #DB5B   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #DB5B   ; Channel A
music_ch_b_tone_step EQU #DB5C   ; Channel B
music_ch_c_tone_step EQU #DB5D   ; Channel C
music_ch_noise_step_base EQU #DB5E   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #DB5E   ; Channel A
music_ch_b_noise_step EQU #DB5F   ; Channel B
music_ch_c_noise_step EQU #DB60   ; Channel C
music_ch_orn_step_base EQU #DB61   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #DB61   ; Channel A
music_ch_b_orn_step EQU #DB62   ; Channel B
music_ch_c_orn_step EQU #DB63   ; Channel C
music_track_buffer   EQU #DB64   ; Serialized tracker song buffer (1869 bytes)
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E2B1   ; End of project variables (8881 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E2B1: Project variables (8881 bytes)
;   #E2B1-#F37F: Free RAM (~4303 bytes available)
...
gameflow_node_gfn_1762369379990_data:
    ...
    ; WARNING: Music node has no trackAssetId -> no-op
...
music_track_resource_id_table:
    DB RESOURCE_ID_MUSIC_TRACK_0_ODA1_DATA
...
load_sprite_patterns_worldmap_1760724209990:
    ...
    ld a, RESOURCE_ID_NEW_SPRITE_1_10_F0_LAYER1
    ld de, SPRPAT + (28 * 32)
    call resource_load_to_vram_by_id
    ld a, RESOURCE_ID_NEW_SPRITE_1_10_F0_LAYER3
    ld de, SPRPAT + (29 * 32)
    call resource_load_to_vram_by_id
    ; Sprite Asset 11: hero_right frame 0 (2 layers)
    ld a, RESOURCE_ID_HERO_RIGHT_11_F0_LAYER1
    ld de, SPRPAT + (30 * 32)
    call resource_load_to_vram_by_id
    ld a, RESOURCE_ID_HERO_RIGHT_11_F0_LAYER2
    ld de, SPRPAT + (31 * 32)
    call resource_load_to_vram_by_id
    ; Sprite Asset 11: hero_right frame 1 (2 layers)
    ld a, RESOURCE_ID_HERO_RIGHT_11_F1_LAYER1
    ld de, SPRPAT + (32 * 32)
    call resource_load_to_vram_by_id
    ld a, RESOURCE_ID_HERO_RIGHT_11_F1_LAYER2
    ld de, SPRPAT + (33 * 32)
    call resource_load_to_vram_by_id
    ; Sprite Asset 11: hero_right frame 2 (2 layers)
    ld a, RESOURCE_ID_HERO_RIGHT_11_F2_LAYER1
    ld de, SPRPAT + (34 * 32)
    call resource_load_to_vram_by_id
    ld a, RESOURCE_ID_HERO_RIGHT_11_F2_LAYER2
    ld de, SPRPAT + (35 * 32)
    call resource_load_to_vram_by_id
    ; Sprite Asset 11: hero_right frame 3 (2 layers)
    ld a, RESOURCE_ID_HERO_RIGHT_11_F3_LAYER1
    ld de, SPRPAT + (36 * 32)
    call resource_load_to_vram_by_id
    ld a, RESOURCE_ID_HERO_RIGHT_11_F3_LAYER2
    ld de, SPRPAT + (37 * 32)
    call resource_load_to_vram_by_id
    ; Sprite Asset 12: bot2_left frame 0 (1 layers)
    ld a, RESOURCE_ID_BOT2_LEFT_12_F0_LAYER0
    ld de, SPRPAT + (38 * 32)
    call resource_load_to_vram_by_id
    ; Sprite Asset 12: bot2_left frame 1 (1 layers)
    ld a, RESOURCE_ID_BOT2_LEFT_12_F1_LAYER0
    ld de, SPRPAT + (39 * 32)
    call resource_load_to_vram_by_id
...
; ##################################################################
; FAR BANK 15 — [#A000h-#C000h] FAR CODE: hud
; Accessed ONLY via trampolines in bank 0 (entrypoint_far labels).
...
; Data start address: #24000
; Total data bytes (source blocks): 21956
; Zones used: 3
; Placement policy: sort blocks by size descending, then first-fit by zone.
; ------------------------------------------------------------------
; ZONE 00 [#24000-#26000] bank 16 used=8180 slack=12
;   + music_track_0_Oda1_data (sound) @ +#0000 size=1869
;   + SCREEN_PAN1_0_LAYOUT (screens) @ +#074D size=768
;   + SCREEN_PAN1_0_EFFECTS_LAYOUT (screens) @ +#0A4D size=768
;   + BEHAVIOR_PAN1_0_DATA (screens) @ +#0D4D size=768
;   + SCREEN_PAN2_1_LAYOUT (screens) @ +#104D size=768
;   + SCREEN_PAN2_1_EFFECTS_LAYOUT (screens) @ +#134D size=768
;   + BEHAVIOR_PAN2_1_DATA (screens) @ +#164D size=768
;   + SCREEN_PAN3_2_LAYOUT (screens) @ +#194D size=768
;   + SCREEN_PAN3_2_EFFECTS_LAYOUT (screens) @ +#1C4D size=768
;   + NEW_SPRITE_5_F0_LAYER1 (sprites) @ +#1F4D size=64
;   + HERO_LEFT_0_F0_LAYER1 (sprites) @ +#1F8D size=32
;   + HERO_LEFT_0_F0_LAYER2 (sprites) @ +#1FAD size=32
;   + HERO_LEFT_0_F1_LAYER1 (sprites) @ +#1FCD size=32
;   + SCREEN_PAN1_0_EFFECT_ZONE_TABLE (screens) @ +#1FED size=1
;   + SCREEN_PAN2_1_EFFECT_ZONE_TABLE (screens) @ +#1FEE size=1
;   + SCREEN_PAN3_2_EFFECT_ZONE_TABLE (screens) @ +#1FEF size=1
;   + SCREEN_PAN4_3_EFFECT_ZONE_TABLE (screens) @ +#1FF0 size=1
;   + SCREEN_PAN5_4_EFFECT_ZONE_TABLE (screens) @ +#1FF1 size=1
;   + SCREEN_PAN62_5_EFFECT_ZONE_TABLE (screens) @ +#1FF2 size=1
;   + SCREEN_PAN7_6_EFFECT_ZONE_TABLE (screens) @ +#1FF3 size=1
; ZONE 01 [#26000-#28000] bank 17 used=8168 slack=24
...
;   + BEHAVIOR_PAN4_3_DATA (screens) @ +#0900 size=768
;   + SCREEN_PAN5_4_LAYOUT (screens) @ +#0C00 size=768
;   + SCREEN_PAN5_4_EFFECTS_LAYOUT (screens) @ +#0F00 size=768
;   + BEHAVIOR_PAN5_4_DATA (screens) @ +#1200 size=768
;   + SCREEN_PAN62_5_LAYOUT (screens) @ +#1500 size=768
;   + SCREEN_PAN62_5_EFFECTS_LAYOUT (screens) @ +#1800 size=768
;   + BEHAVIOR_PAN62_5_DATA (screens) @ +#1B00 size=768
;   + tile_pattern_bank0 (patterns) @ +#1E00 size=360
;   + HERO_LEFT_0_F1_LAYER2 (sprites) @ +#1F68 size=32
;   + HERO_LEFT_0_F2_LAYER1 (sprites) @ +#1F88 size=32
;   + HERO_LEFT_0_F2_LAYER2 (sprites) @ +#1FA8 size=32
;   + HERO_LEFT_0_F3_LAYER1 (sprites) @ +#1FC8 size=32
; ZONE 02 [#28000-#2A000] bank 18 used=5608 slack=2584
;   + SCREEN_PAN7_6_LAYOUT (screens) @ +#0000 size=768
;   + SCREEN_PAN7_6_EFFECTS_LAYOUT (screens) @ +#0300 size=768
;   + BEHAVIOR_PAN7_6_DATA (screens) @ +#0600 size=768
;   + tile_color_bank0 (colors) @ +#0900 size=360
;   + FONT_PATTERN_DATA (font) @ +#0A68 size=344
;   + FONT_COLOR_DATA (font) @ +#0BC0 size=344
;   + tilebank_pattern_data_0 (patterns) @ +#0D18 size=328
;   + tilebank_color_data_0 (colors) @ +#0E60 size=328
;   + HERO_LEFT_0_F3_LAYER2 (sprites) @ +#0FA8 size=32
;   + BIRD_1_F0_LAYER1 (sprites) @ +#0FC8 size=32
;   + BIRD_1_F1_LAYER1 (sprites) @ +#0FE8 size=32
;   + BIRD_1_F2_LAYER1 (sprites) @ +#1008 size=32
;   + BIRD_1_F3_LAYER1 (sprites) @ +#1028 size=32
;   + BOT1_2_F0_LAYER1 (sprites) @ +#1048 size=32
;   + BOT2_RIGHT_3_F0_LAYER0 (sprites) @ +#1068 size=32
;   + BOT2_RIGHT_3_F1_LAYER0 (sprites) @ +#1088 size=32
;   + HERO_DEAD_4_F0_LAYER1 (sprites) @ +#10A8 size=32
;   + HERO_DEAD_4_F1_LAYER1 (sprites) @ +#10C8 size=32
;   + HERO_DEAD_4_F2_LAYER1 (sprites) @ +#10E8 size=32
;   + HERO_DEAD_4_F3_LAYER1 (sprites) @ +#1108 size=32
;   + HERO_DEAD_4_F4_LAYER1 (sprites) @ +#1128 size=32
;   + HERO_DEAD_4_F5_LAYER1 (sprites) @ +#1148 size=32
;   + HERO_DEAD_4_F6_LAYER1 (sprites) @ +#1168 size=32
;   + HERO_DEAD_4_F7_LAYER1 (sprites) @ +#1188 size=32
;   + HERO_DEAD_4_F8_LAYER1 (sprites) @ +#11A8 size=32
;   + HERO_DEAD_4_F9_LAYER1 (sprites) @ +#11C8 size=32
;   + HERO_DEAD_4_F10_LAYER1 (sprites) @ +#11E8 size=32
;   + HERO_DEAD_4_F11_LAYER1 (sprites) @ +#1208 size=32
;   + HERO_DEAD_4_F12_LAYER1 (sprites) @ +#1228 size=32
;   + HERO_DEAD_4_F13_LAYER1 (sprites) @ +#1248 size=32
;   + GEMA1_6_F0_LAYER2 (sprites) @ +#1268 size=32
;   + GEMA1_6_F1_LAYER2 (sprites) @ +#1288 size=32
;   + BOX_7_F0_LAYER1 (sprites) @ +#12A8 size=32
;   + FIRE_8_F0_LAYER1 (sprites) @ +#12C8 size=32
;   + FIRE_8_F1_LAYER1 (sprites) @ +#12E8 size=32
;   + FIRE2_LEFT_9_F0_LAYER1 (sprites) @ +#1308 size=32
;   + FIRE2_LEFT_9_F1_LAYER1 (sprites) @ +#1328 size=32
;   + FIRE2_LEFT_9_F2_LAYER1 (sprites) @ +#1348 size=32
;   + FIRE2_LEFT_9_F3_LAYER1 (sprites) @ +#1368 size=32
;   + FIRE2_LEFT_9_F4_LAYER1 (sprites) @ +#1388 size=32
;   + NEW_SPRITE_1_10_F0_LAYER1 (sprites) @ +#13A8 size=32
;   + NEW_SPRITE_1_10_F0_LAYER3 (sprites) @ +#13C8 size=32
;   + HERO_RIGHT_11_F0_LAYER1 (sprites) @ +#13E8 size=32
;   + HERO_RIGHT_11_F0_LAYER2 (sprites) @ +#1408 size=32
;   + HERO_RIGHT_11_F1_LAYER1 (sprites) @ +#1428 size=32
;   + HERO_RIGHT_11_F1_LAYER2 (sprites) @ +#1448 size=32
;   + HERO_RIGHT_11_F2_LAYER1 (sprites) @ +#1468 size=32
;   + HERO_RIGHT_11_F2_LAYER2 (sprites) @ +#1488 size=32
;   + HERO_RIGHT_11_F3_LAYER1 (sprites) @ +#14A8 size=32
;   + HERO_RIGHT_11_F3_LAYER2 (sprites) @ +#14C8 size=32
;   + BOT2_LEFT_12_F0_LAYER0 (sprites) @ +#14E8 size=32
;   + BOT2_LEFT_12_F1_LAYER0 (sprites) @ +#1508 size=32
;   + FIRE2_RIGHT_13_F0_LAYER1 (sprites) @ +#1528 size=32
;   + FIRE2_RIGHT_13_F1_LAYER1 (sprites) @ +#1548 size=32
;   + FIRE2_RIGHT_13_F2_LAYER1 (sprites) @ +#1568 size=32
;   + FIRE2_RIGHT_13_F3_LAYER1 (sprites) @ +#1588 size=32
;   + FIRE2_RIGHT_13_F4_LAYER1 (sprites) @ +#15A8 size=32
;   + SPRITE_PLACEHOLDER_PATTERN (sprites) @ +#15C8 size=32

    org #24000
; ==================================================================
; DATA ZONE 00 (bank 16) used=8180 slack=12
; ==================================================================
; ==================================================================
...
music_track_0_Oda1_data:
    ...
    DB #01
    DB #02
    DW .order_table - music_track_0_Oda1_data
    DW .pattern_table - music_track_0_Oda1_data
    DW .instrument_ptr_table - music_track_0_Oda1_data
    DW .ornament_ptr_table - music_track_0_Oda1_data
    DW #5208
    DB #10
...
.pattern_table:
    DW .pattern_0_rows - music_track_0_Oda1_data
    DB #40
    DW .pattern_1_rows - music_track_0_Oda1_data
    DB #40

.instrument_ptr_table:
    DW 0
    DW .inst_1 - music_track_0_Oda1_data
    DW .inst_2 - music_track_0_Oda1_data
    DW .inst_3 - music_track_0_Oda1_data
    DW .inst_4 - music_track_0_Oda1_data
    DW .inst_5 - music_track_0_Oda1_data
    DW .inst_6 - music_track_0_Oda1_data
    DW .inst_7 - music_track_0_Oda1_data
    DW 0
    DW 0
    DW 0
    DW 0
...
.inst_1:
    ...
    DB #10
    DW #5208
    DW .inst_1_vol_env - music_track_0_Oda1_data
    DB #07
    DB #03
    DW .inst_1_tone_env - music_track_0_Oda1_data
    DB #01
    DB #FF
    DW 0
    DB #00
...
.inst_2:
    ...
    DB #10
    DW #5208
    DW .inst_2_vol_env - music_track_0_Oda1_data
    DB #06
    DB #FF
    DW .inst_2_tone_env - music_track_0_Oda1_data
    DB #01
    DB #FF
    DW 0
    DB #00
...
.inst_3:
    ...
    DB #10
    DW #5208
    DW .inst_3_vol_env - music_track_0_Oda1_data
    DB #06
    DB #FF
    DW .inst_3_tone_env - music_track_0_Oda1_data
    DB #0B
    DB #FF
    DW 0
    DB #00
...
.inst_4:
    ...
    DB #10
    DW #5208
    DW .inst_4_vol_env - music_track_0_Oda1_data
    DB #06
    DB #FF
    DW .inst_4_tone_env - music_track_0_Oda1_data
    DB #01
    DB #FF
    DW 0
    DB #00
...
.inst_5:
    ...
    DB #10
    DW #5208
    DW .inst_5_vol_env - music_track_0_Oda1_data
    DB #07
    DB #02
    DW .inst_5_tone_env - music_track_0_Oda1_data
    DB #08
    DB #00
    DW 0
    DB #00
...
.inst_6:
    ...
    DB #10
    DW #5208
    DW .inst_6_vol_env - music_track_0_Oda1_data
    DB #08
    DB #00
    DW .inst_6_tone_env - music_track_0_Oda1_data
    DB #07
    DB #00
    DW 0
    DB #00
...
.inst_7:
    ...
    DB #10
    DW #5208
    DW .inst_7_vol_env - music_track_0_Oda1_data
    DB #0A
    DB #04
    DW .inst_7_tone_env - music_track_0_Oda1_data
    DB #08
    DB #00
    DW 0
    DB #00
...
BEHAVIOR_PAN7_6_SIZE      EQU 768
    ...
    org #26000
; ==================================================================
; DATA ZONE 01 (bank 17) used=8168 slack=24
; ==================================================================
BEHAVIOR_PAN3_2_DATA:
    DB #10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
HERO_LEFT_0_F3_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    ...
    org #28000
; ==================================================================
; DATA ZONE 02 (bank 18) used=5608 slack=2584
; ==================================================================
SCREEN_PAN7_6_LAYOUT:
