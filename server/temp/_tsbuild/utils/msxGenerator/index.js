...
function generateModularASM(projectName, assets, config = {}) {
    ...
    const interruptDrivenComponents = (_a = config.interruptDrivenComponents) !== null && _a !== void 0 ? _a : true;
    ...
    const autoMegaROM = (_b = config.autoMegaROM) !== null && _b !== void 0 ? _b : true;
    ...
    console.log('🎯 [DEBUG] interrupt.asm length:', ((_c = files['interrupt.asm']) === null || _c === void 0 ? void 0 : _c.length) || 'MISSING!');
    return files;
}
/**
...
function generateModularASMFromSummary(summary, config = {}) {
    ...
    // Validate summary
    if (!((_a = summary.projectInfo) === null || _a === void 0 ? void 0 : _a.name)) {
    ...
    const interruptDrivenComponents = (_b = config.interruptDrivenComponents) !== null && _b !== void 0 ? _b : true;
    const hardwareMode = config.hardwareMode || 'hybrid'; // Default to hybrid mode
    const optimizeLevel = config.optimizeLevel || 'safe';
    console.log(`🔧 Hardware Mode: ${hardwareMode.toUpperCase()}, Optimize: ${optimizeLevel}`);
    const targetFormat = config.targetFormat || 'konami';
    const romMode = config.romMode || 'auto';
    const autoMegaROM = (_c = config.autoMegaROM) !== null && _c !== void 0 ? _c : true;
    console.log(`[MSX GENERATOR] ROM config: mode=${romMode}, mapper=${targetFormat}, autoMegaROM=${autoMegaROM}`);
