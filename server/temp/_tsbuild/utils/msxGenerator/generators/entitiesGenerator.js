...
function generateEntitiesFile(analysis) {
    ...
    const parseByte = (value, defaultValue) => {
        const num = typeof value === 'number' ? value : parseInt(String(value !== null && value !== void 0 ? value : ''), 10);
        if (Number.isNaN(num))
            return defaultValue;
    ...
    const resolveEntityScreenId = (entity) => {
        const directScreenAssetId = (entity === null || entity === void 0 ? void 0 : entity.screenAssetId) || (entity === null || entity === void 0 ? void 0 : entity.screenId) || (entity === null || entity === void 0 ? void 0 : entity.screenMapId);
        if (directScreenAssetId) {
            const worldMaps = (analysis.worldmaps || []);
            for (const world of worldMaps) {
                const nodes = (world === null || world === void 0 ? void 0 : world.nodes) || [];
                const nodeIndex = nodes.findIndex((n) => (n === null || n === void 0 ? void 0 : n.screenAssetId) === directScreenAssetId);
                if (nodeIndex >= 0)
                    return nodeIndex;
            }
        }
        if (typeof (entity === null || entity === void 0 ? void 0 : entity.screenIndex) === 'number' && entity.screenIndex >= 0) {
        ...
        if (analysis.screenMaps) {
            analysis.screenMaps.forEach((screen, sIndex) => {
                var _a;
                const screenEntities = ((_a = screen === null || screen === void 0 ? void 0 : screen.layers) === null || _a === void 0 ? void 0 : _a.entities) || [];
        ...
        for (const world of worldMaps) {
            const nodes = (world === null || world === void 0 ? void 0 : world.nodes) || [];
            const nodeIndex = nodes.findIndex((n) => (n === null || n === void 0 ? void 0 : n.screenAssetId) === entityScreenAssetId);
            if (nodeIndex >= 0) {
                return nodeIndex;
            }
        }
    ...
    const sanitizeEntityName = (rawName) => {
        const safe = String(rawName !== null && rawName !== void 0 ? rawName : 'entity')
            .toUpperCase()
            .replace(/[^A-Z0-9]/g, '_')
            .replace(/^_+|_+$/g, '');
        return safe || 'ENTITY';
    ...
    const entityLabelNames = activeEntities.map((entity, index) => {
        const base = sanitizeEntityName((entity === null || entity === void 0 ? void 0 : entity.name) || `ENTITY_${index}`);
    ...
    console.log(`  - Total entity templates in JSON: ${((_a = analysis.templates) === null || _a === void 0 ? void 0 : _a.length) || 0}`);
    console.log(`  - Actually instantiated entities: ${activeEntities.length}`);
    console.log(`  - Filtered out: ${(((_b = analysis.templates) === null || _b === void 0 ? void 0 : _b.length) || 0) - activeEntities.length} unused templates`);
    let code = `; ==================================================================
; GAME ENTITIES
; File: entities.asm
...
;   Entity templates in project: ${((_c = analysis.templates) === null || _c === void 0 ? void 0 : _c.length) || 0}
;   Actually instantiated: ${activeEntities.length}
;   Filtered out: ${(((_d = analysis.templates) === null || _d === void 0 ? void 0 : _d.length) || 0) - activeEntities.length} unused templates
;
; ==================================================================
...
`;
        ...
        activeEntities.forEach((entity, index) => {
            ...
            const template = (_a = analysis.templates) === null || _a === void 0 ? void 0 : _a.find((t) => t.id === entity.entityTemplateId);
...
`;
        ...
        activeEntities.forEach((entity, index) => {
            ...
            const realX = ((_b = entity.position) === null || _b === void 0 ? void 0 : _b.x) || 100;
            const realY = ((_c = entity.position) === null || _c === void 0 ? void 0 : _c.y) || 100;
            ...
            if (componentMask & 0x10) { // Has Input component
                ...
                const cursorsComp = template === null || template === void 0 ? void 0 : template.components.find((c) => c.definitionId === 'comp_cursors' || c.definitionId === 'comp_input' || c.definitionId === 'comp_player_input');
                if (cursorsComp) {
                    ...
                    const overrides = ((_d = entity.componentOverrides) === null || _d === void 0 ? void 0 : _d['comp_cursors']) || {};
            ...
            if (componentMask & 0x80) {
                const animComp = (_e = template === null || template === void 0 ? void 0 : template.components) === null || _e === void 0 ? void 0 : _e.find((c) => c.definitionId === 'comp_animation' || c.definitionName === 'Animation');
                const defaultValues = (animComp === null || animComp === void 0 ? void 0 : animComp.defaultValues) || (animComp === null || animComp === void 0 ? void 0 : animComp.values) || {};
                const overrides = ((_f = entity.componentOverrides) === null || _f === void 0 ? void 0 : _f['comp_animation']) || {};
                const finalValues = { ...defaultValues, ...overrides };
                const frameIndex = parseByte((_h = (_g = finalValues.currentFrameIndex) !== null && _g !== void 0 ? _g : finalValues.currentFrame) !== null && _h !== void 0 ? _h : 0, 0);
                const speed = Math.max(1, parseByte((_j = finalValues.animationSpeed) !== null && _j !== void 0 ? _j : 6, 6));
...
`;
            ...
            const patrolTemplateComp = (_k = template === null || template === void 0 ? void 0 : template.components) === null || _k === void 0 ? void 0 : _k.find((c) => c.definitionId === 'comp_patrol');
            if (patrolTemplateComp) {
                hasPatrol = true;
                const patrolDefaults = patrolTemplateComp.defaultValues || {};
                const patrolOverrides = ((_l = entity.componentOverrides) === null || _l === void 0 ? void 0 : _l['comp_patrol']) || {};
                ...
                patrolWp2x = Math.max(0, Math.min(255, Number((_m = patrolValues.waypoint2_x) !== null && _m !== void 0 ? _m : patrolWp1x)));
                patrolWp2y = Math.max(0, Math.min(191, Number((_o = patrolValues.waypoint2_y) !== null && _o !== void 0 ? _o : patrolWp1y)));
...
`;
            ...
            if (componentMask & 0x08) { // COMP_MASK_COLLISION
                const collisionTemplateComp = (_p = template === null || template === void 0 ? void 0 : template.components) === null || _p === void 0 ? void 0 : _p.find((c) => c.definitionId === 'comp_collision' || c.definitionName === 'Collision');
                const collisionDefaults = (collisionTemplateComp === null || collisionTemplateComp === void 0 ? void 0 : collisionTemplateComp.defaultValues) || {};
                const collisionOverrides = ((_q = entity.componentOverrides) === null || _q === void 0 ? void 0 : _q['comp_collision']) || {};
...
`;
            ...
            let smInitAsm = '';
            const smOverride = (_r = entity.componentOverrides) === null || _r === void 0 ? void 0 : _r['comp_statemachine'];
            const smTemplateComp = (_s = template === null || template === void 0 ? void 0 : template.components) === null || _s === void 0 ? void 0 : _s.find((c) => c.definitionId === 'comp_statemachine');
            const smAssetId = (smOverride === null || smOverride === void 0 ? void 0 : smOverride.stateMachineAssetId) || ((_t = smTemplateComp === null || smTemplateComp === void 0 ? void 0 : smTemplateComp.defaultValues) === null || _t === void 0 ? void 0 : _t.stateMachineAssetId);
