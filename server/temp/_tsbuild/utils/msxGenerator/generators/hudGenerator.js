...
function generateHudFile(analysis) {
    ...
    console.log(`🎯 [HUD Generator] Total screens: ${((_a = analysis.screenMaps) === null || _a === void 0 ? void 0 : _a.length) || 0}`);
    (_b = analysis.screenMaps) === null || _b === void 0 ? void 0 : _b.forEach(screen => {
        var _a;
        const hasHudConfig = !!screen.hudConfiguration;
        const hudElements = ((_a = screen.hudConfiguration) === null || _a === void 0 ? void 0 : _a.elements) || [];
...
`;
    ...
    let hudRows = 0;
    (_c = analysis.screenMaps) === null || _c === void 0 ? void 0 : _c.forEach(screen => {
        var _a;
        const areaY = (_a = screen.activeAreaY) !== null && _a !== void 0 ? _a : 0;
        if (areaY > hudRows)
            hudRows = areaY;
    });
