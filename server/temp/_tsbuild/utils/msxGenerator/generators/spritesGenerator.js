...
function generateSpritesFile(analysis) {
    ...
    console.log(`  - analysis.entities.length: ${((_a = analysis.entities) === null || _a === void 0 ? void 0 : _a.length) || 0}`);
    console.log(`  - analysis.templates.length: ${((_b = analysis.templates) === null || _b === void 0 ? void 0 : _b.length) || 0}`);
    ...
    const getEntitySpriteInfo = (entity) => {
        ...
        console.log(`   Template components: ${((_b = template.components) === null || _b === void 0 ? void 0 : _b.map((c) => c.definitionId).join(', ')) || 'NONE'}`);
        ...
        if (entity.componentOverrides) {
            for (const compId in entity.componentOverrides) {
                ...
                const spriteProp = (_c = compDef === null || compDef === void 0 ? void 0 : compDef.properties) === null || _c === void 0 ? void 0 : _c.find((p) => p.type === 'sprite_ref');
                if (spriteProp && ((_d = entity.componentOverrides[compId]) === null || _d === void 0 ? void 0 : _d[spriteProp.name])) {
        ...
        if (!spriteAssetId) {
            for (const comp of template.components || []) {
                ...
                const spriteProp = (_e = compDef === null || compDef === void 0 ? void 0 : compDef.properties) === null || _e === void 0 ? void 0 : _e.find((p) => p.type === 'sprite_ref');
                if (spriteProp && ((_f = comp.defaultValues) === null || _f === void 0 ? void 0 : _f[spriteProp.name])) {
        ...
        if (foundIndex === undefined) {
            ...
            foundIndex = sprites.findIndex(s => {
                var _a, _b;
                return ((_a = s.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(spriteIdLower)) ||
                    spriteIdLower.includes(((_b = s.name) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || '');
            });
        }
...
`;
    sprites.forEach((sprite, index) => {
        var _a;
        const frames = ((_a = sprite.frames) === null || _a === void 0 ? void 0 : _a.length) || 1;
...
`;
            ...
            sprites.forEach((sprite, index) => {
                ...
                const frameCount = ((_a = sprite.frames) === null || _a === void 0 ? void 0 : _a.length) || 1;
