...
; END OF COMPONENTS(MINIMAL VERSION)
    ...
    const needsCollisionFromStateMachine = stateMachines.some((stateMachine) => {
        const transitions = Array.isArray(stateMachine === null || stateMachine === void 0 ? void 0 : stateMachine.transitions) ? stateMachine.transitions : [];
        return transitions.some((transition) => conditionTreeHas(transition === null || transition === void 0 ? void 0 : transition.conditions, collisionConditionTypes));
    });
