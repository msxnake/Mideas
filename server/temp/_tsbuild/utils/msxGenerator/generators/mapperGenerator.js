...
exports.generateMapperFile = generateMapperFile;
function resolveMapperRegisterLayout(format) {
    if (format === 'ascii8') {
        return {
            regP1: '#6000',
            regP2: '#6800',
...
function generateMapperFile(options = {}) {
    ...
    const autoMegaROM = (_a = options.autoMegaROM) !== null && _a !== void 0 ? _a : true;
