...
`;
        analysis.screenMaps.forEach((screen) => {
            ...
            if (screen.layers && screen.layers.background) {
                ...
                const mapIndices = [];
                const activeX = (_a = screen.activeAreaX) !== null && _a !== void 0 ? _a : 0;
                const activeY = (_b = screen.activeAreaY) !== null && _b !== void 0 ? _b : 0;
                const activeW = (_c = screen.activeAreaWidth) !== null && _c !== void 0 ? _c : screen.width;
                const activeH = (_d = screen.activeAreaHeight) !== null && _d !== void 0 ? _d : screen.height;
                ...
                for (let r = 0; r < SCREEN_HEIGHT; r++) {
                    for (let c = 0; c < SCREEN_WIDTH; c++) {
                        ...
                        const screenTile = (_e = screen.layers.background[r]) === null || _e === void 0 ? void 0 : _e[c];
                        if (!screenTile || !screenTile.tileId) {
                            mapIndices.push(0); // Empty tile
                        }
                        else {
                            let actualCharCodeForCell = 0; // Default to 0 instead of 255
                            const tileAsset = (_f = analysis.tiles) === null || _f === void 0 ? void 0 : _f.find(t => t.id === screenTile.tileId);
                            ...
                            if (currentScreenMode === "SCREEN 2 (Graphics I)" && tileBanksList && tileAsset) {
                                ...
                                for (const bank of tileBanksList) {
                                    ...
                                    if (((_g = bank.enabled) !== null && _g !== void 0 ? _g : true) && bank.assignedTiles[screenTile.tileId]) {
...
`;
        analysis.screenMaps.forEach((screen, index) => {
            ...
            const rawActiveAreaX = (_a = screen.activeAreaX) !== null && _a !== void 0 ? _a : 0;
            const rawActiveAreaY = (_b = screen.activeAreaY) !== null && _b !== void 0 ? _b : 0;
            const rawActiveAreaWidth = (_d = (_c = screen.activeAreaWidth) !== null && _c !== void 0 ? _c : screen.width) !== null && _d !== void 0 ? _d : 32;
            const rawActiveAreaHeight = (_f = (_e = screen.activeAreaHeight) !== null && _e !== void 0 ? _e : screen.height) !== null && _f !== void 0 ? _f : 24;
            ...
            const importedHudFrameCells = (((_h = (_g = screen.hudConfiguration) === null || _g === void 0 ? void 0 : _g.importedFrame) === null || _h === void 0 ? void 0 : _h.cells) || [])
                .filter((cell) => typeof (cell === null || cell === void 0 ? void 0 : cell.x) === 'number' &&
                typeof (cell === null || cell === void 0 ? void 0 : cell.y) === 'number' &&
                typeof (cell === null || cell === void 0 ? void 0 : cell.charCode) === 'number' &&
                cell.x >= 0 && cell.x < 32 &&
                cell.y >= 0 && cell.y < 24)
                .map((cell) => ({
                x: cell.x | 0,
