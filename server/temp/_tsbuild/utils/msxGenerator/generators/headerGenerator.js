...
function generateHeaderFile(projectName, analysis) {
    ...
    let gameFlowComment = '';
    if (analysis === null || analysis === void 0 ? void 0 : analysis.gameFlow) {
        ...
        if (startNode) {
            ...
            const firstConnection = gameFlow.connections.find(c => { var _a; return ((_a = c.from) === null || _a === void 0 ? void 0 : _a.nodeId) === startNode.id || (typeof c.from === 'string' && c.from === startNode.id); });
            if (firstConnection) {
                // Find the target node
                const targetNodeId = ((_a = firstConnection.to) === null || _a === void 0 ? void 0 : _a.nodeId) || firstConnection.to;
