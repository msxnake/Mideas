...
function resolveSpriteId(entity, template) {
    var _a, _b, _c;
    const spriteComp = (_a = template === null || template === void 0 ? void 0 : template.components) === null || _a === void 0 ? void 0 : _a.find((c) => c.definitionId === 'comp_sprite' || c.definitionId === 'comp_render');
    if (!spriteComp)
        return undefined;
    const defaults = spriteComp.defaultValues || {};
    const overrides = ((_b = entity.componentOverrides) === null || _b === void 0 ? void 0 : _b['comp_sprite']) || ((_c = entity.componentOverrides) === null || _c === void 0 ? void 0 : _c['comp_render']) || {};
...
function analyzeComponentUsage(analysis) {
    ...
    console.log(`📊 Total entities in project: ${((_a = analysis.entities) === null || _a === void 0 ? void 0 : _a.length) || 0}`);
    ...
    usedComponents.forEach(comp => {
        ...
        console.log(`    • ${comp}: ${(entities === null || entities === void 0 ? void 0 : entities.size) || 0} entities`);
    });
    return {
        usedComponents,
        usedTemplates,
...
function generateEntityComponentMask(entity, template, analysis) {
    ...
    if (hasSpriteComponent) {
        ...
        const hasValidSpriteAsset = spriteId &&
            ((_a = analysis.sprites) === null || _a === void 0 ? void 0 : _a.some((s) => s.id === spriteId || s.name === spriteId));
