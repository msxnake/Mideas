...
const getBackgroundColorHex = (colorIndex, screenMode) => {
    ...
    return (_a = entry === null || entry === void 0 ? void 0 : entry.hex) !== null && _a !== void 0 ? _a : ((0, exports.isScreen2Mode)(screenMode) ? constants_1.MSX1_PALETTE[1].hex : constants_1.MSX_SCREEN5_PALETTE[4].hex);
};
