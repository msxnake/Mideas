...
function getAllGlobalVariables(assets) {
    ...
    const defaultNames = constants_1.MIDEAS_GLOBAL_VARIABLES.map(v => v.name);
    const result = [];
...
function getUsedGlobalVariables(assets) {
    ...
    screenMaps.forEach(screenMap => {
        var _a, _b;
        const entities = ((_b = (_a = screenMap.data) === null || _a === void 0 ? void 0 : _a.layers) === null || _b === void 0 ? void 0 : _b.entities) || [];
        entities.forEach((entity) => {
            var _a, _b;
            // Check Behavior component
            if ((_b = (_a = entity.components) === null || _a === void 0 ? void 0 : _a.Behavior) === null || _b === void 0 ? void 0 : _b.behaviorCode) {
    ...
    if (gameFlowAsset === null || gameFlowAsset === void 0 ? void 0 : gameFlowAsset.data) {
        ...
        if (gameFlow.nodes && Array.isArray(gameFlow.nodes)) {
            gameFlow.nodes.forEach((node) => {
                ...
                if (node.type === 'StateMachine' && ((_a = node.data) === null || _a === void 0 ? void 0 : _a.customCode)) {
