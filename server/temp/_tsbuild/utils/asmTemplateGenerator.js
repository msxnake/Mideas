...
function analyzeProject(projectName, assets) {
    ...
    const buildEntityKey = (entity, screenMap, screenIndex) => {
        ...
        const posX = (_b = (_a = entity === null || entity === void 0 ? void 0 : entity.position) === null || _a === void 0 ? void 0 : _a.x) !== null && _b !== void 0 ? _b : '';
        const posY = (_d = (_c = entity === null || entity === void 0 ? void 0 : entity.position) === null || _c === void 0 ? void 0 : _c.y) !== null && _d !== void 0 ? _d : '';
        const tpl = (_e = entity === null || entity === void 0 ? void 0 : entity.entityTemplateId) !== null && _e !== void 0 ? _e : '';
        const name = (_f = entity === null || entity === void 0 ? void 0 : entity.name) !== null && _f !== void 0 ? _f : '';
        const screenId = (_g = screenMap === null || screenMap === void 0 ? void 0 : screenMap.id) !== null && _g !== void 0 ? _g : `screen_${screenIndex}`;
    ...
    const addEntityFromScreen = (entity, screenMap, screenIndex) => {
        ...
        entities.push({
            ...
            screenAssetId: entity.screenAssetId || (screenMap === null || screenMap === void 0 ? void 0 : screenMap.id),
    ...
    screenMaps.forEach((screenMap, screenIndex) => {
        ...
        if (((_a = screenMap.layers) === null || _a === void 0 ? void 0 : _a.entities) && Array.isArray(screenMap.layers.entities)) {
    ...
    const gameFlow = gameFlowAsset === null || gameFlowAsset === void 0 ? void 0 : gameFlowAsset.data;
