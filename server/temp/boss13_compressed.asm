...
; BANK 06 @#0000 : bosses.asm part 3/2 (3680 bytes)
; BANK 06 @#0E60 : statemachine.asm (5 bytes)
; BANK 06 @#0E65 : gameflow.asm (4507 bytes)
; BANK 07 @#0000 : gameflow.asm (1557 bytes)
...
; Register Contract:
; input: none
; output: boss_runtime_tick increments; active boss behavior is stepped and redrawn only when moved
