...
; Estimated payload bytes: 36540
; Estimated banks used: 5
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (836 bytes)
; BANK 00 @#0344 : colors.asm (785 bytes)
; BANK 00 @#0655 : components.asm (1146 bytes)
; BANK 00 @#0ACF : entities.asm (303 bytes)
; BANK 00 @#0BFE : worlds.asm (1172 bytes)
; BANK 00 @#1092 : screens.asm (3950 bytes)
; BANK 01 @#0000 : screens.asm (151 bytes)
; BANK 01 @#0097 : sprites.asm (1813 bytes)
; BANK 01 @#07AC : font.asm (174 bytes)
; BANK 01 @#085A : hud.asm (79 bytes)
; BANK 01 @#08A9 : menus.asm (168 bytes)
; BANK 01 @#0951 : sound.asm part 1/2 (5807 bytes)
; BANK 02 @#0000 : sound.asm part 2/2 (3666 bytes)
; BANK 02 @#0E52 : scroll.asm (2353 bytes)
; BANK 02 @#1783 : animtiles.asm (2173 bytes)
; BANK 03 @#0000 : animtiles.asm (1662 bytes)
; BANK 03 @#067E : particles.asm (4963 bytes)
; BANK 03 @#19E1 : statemachine.asm (5 bytes)
; BANK 03 @#19E6 : gameflow.asm (1562 bytes)
; BANK 04 @#0000 : gameflow.asm (3772 bytes)
...
SCREEN_NEW_SCREENMAP_0_LAYOUT:
    ...
    DB #80,#81,#80,#81,#80,#81,#80,#81,#80,#81,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#82,#83,#82,#83,#82,#83,#82,#83,#82,#83
    DB #82,#83,#82,#83,#82,#83,#82,#83,#82,#83,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#80,#81,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#80,#81,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#82,#83,#00,#00,#00,#00,#00,#00,#00,#00
