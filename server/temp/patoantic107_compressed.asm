...
; Estimated payload bytes: 111789
; Estimated banks used: 14
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (1288 bytes)
; BANK 00 @#0508 : colors.asm (1126 bytes)
; BANK 00 @#096E : components.asm (22 bytes)
; BANK 00 @#0984 : entities.asm (5372 bytes)
; BANK 00 @#1E80 : worlds.asm (384 bytes)
; BANK 01 @#0000 : worlds.asm (3616 bytes)
; BANK 01 @#0E20 : screens.asm part 1/3 (4576 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (4758 bytes)
; BANK 03 @#1296 : sprites.asm part 1/2 (3434 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (6331 bytes)
; BANK 04 @#18BB : font.asm (1861 bytes)
; BANK 05 @#0000 : font.asm (1686 bytes)
; BANK 05 @#0696 : hud.asm (4339 bytes)
; BANK 05 @#1789 : menus.asm (444 bytes)
; BANK 05 @#1945 : sound.asm (1723 bytes)
; BANK 06 @#0000 : sound.asm (1841 bytes)
; BANK 06 @#0731 : scroll.asm (2353 bytes)
; BANK 06 @#1062 : animtiles.asm (3998 bytes)
; BANK 07 @#0000 : animtiles.asm (1918 bytes)
; BANK 07 @#077E : particles.asm (4963 bytes)
; BANK 07 @#1AE1 : statemachine.asm part 1/4 (1311 bytes)
...
; BANK 11 @#0000 : statemachine.asm part 5/4 (4700 bytes)
; BANK 11 @#125C : gameflow.asm part 1/3 (3492 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (5293 bytes)
...
; Tile 8: New Tile = 16x32px (2x4 MSX chars)
; Tile 9: rajol_vermell = 8x8px (1x1 MSX chars)
...
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #CC90   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #CC91   ; Temporary 16-bit storage
temp_word_2         EQU #CC93   ; Temporary 16-bit storage
temp_byte_1         EQU #CC95   ; Temporary 8-bit storage
temp_byte_2         EQU #CC96   ; Temporary 8-bit storage
temp_byte_3         EQU #CC97   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #CCB7   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #CCD7   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #CCF7   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #CD17   ; 0=no SFX active, 1=playing
sfx_timer           EQU #CD18   ; Frames remaining for current SFX
sfx_fadeout         EQU #CD19   ; Reserved fadeout flag/state
temp_byte_7         EQU #CD1A   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CD3A   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CD5A   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CD7A   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CD9A   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CDBA   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CDDA   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CDFA   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CE1A   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CE3A   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CE5A   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CE7A   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CE9A   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CEBA   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CEDA   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CEFA   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CF1A   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CF3A   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CF5A   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CF7A   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #CFBA   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #CFFA   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #D01A   ; Temporary 8-bit storage (32 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #D03A   ; Cached entity X for wall checks
wall_temp_y         EQU #D03B   ; Cached entity Y for wall checks
wall_hit_left       EQU #D03C   ; Hitbox left edge cache
wall_hit_top        EQU #D03D   ; Hitbox top edge cache
wall_hit_right      EQU #D03E   ; Hitbox right edge cache
wall_hit_bottom     EQU #D03F   ; Hitbox bottom edge cache
wall_hit_w          EQU #D040   ; Hitbox width cache (min 1)
wall_hit_h          EQU #D041   ; Hitbox height cache (min 1)
wall_probe_left     EQU #D042   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #D043   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #D044   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #D045   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #D046   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #D066   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #D067   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #D068   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #D088   ; Number of entities in coll_list
coll_src_left       EQU #D089   ; Source AABB left edge (scratch)
coll_src_right      EQU #D08A   ; Source AABB right edge (scratch)
coll_src_top        EQU #D08B   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #D08C   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #D08D   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #D08D   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #D08F   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #D091   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #D093   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #D095   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #D097   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #D099   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #D09B   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #D09D   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #D09E   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #D0A3   ; Frame counter (16-bit)
task_exec_time          EQU #D0A5   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #D0A7   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #D0A8   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #D0A8   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #D0A9   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #D0AA   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #D0AB   ; Next sound frame pointer high byte

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D0AC   ; End of project variables (4268 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D0AC: Project variables (4268 bytes)
;   #D0AC-#F37F: Free RAM (~8916 bytes available)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (184 -> 159 bytes)
    ...
    DB #02,#10,#BA,#00,#F7,#09,#20,#E1,#40,#00,#04,#01,#F5,#B8,#10,#38
    DB #7C,#38,#10,#FF,#52,#1F,#3F,#61,#44,#92,#C2,#7C,#00,#F8,#FC,#C6
    DB #22,#49,#43,#3E,#1F,#16,#1F,#12,#1E,#1C,#1E,#82,#F8,#28,#F8,#48
    DB #8A,#68,#08,#8A,#1E,#16,#8A,#12,#16,#86,#48,#A3,#68,#14,#1E,#FA
    DB #C4,#E1,#28,#3E,#FC,#0A,#28,#00,#FF,#A9,#BD,#A5,#73,#55,#56
load_pattern_bank0:
    ...
    ld bc, 184    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 184    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
load_color_bank0:
    ...
    ld bc, 184     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #1B,#96,#C9,#FF,#BE,#3E,#FB,#C0,#7F,#76,#91,#38,#F7,#80,#65,#08
