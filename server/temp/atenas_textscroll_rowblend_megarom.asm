...
; Bank 2 [#8000-#A000]: components_tail, gameflow (21135/8192 bytes est.)
; Bank 4 [#6000-#8000]: font (6704/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 5 [#6000-#8000]: gameflow_aux (5061/8192 bytes est.) [FAR — accessed via trampoline]
...
; BANK 09 @#0000 : gameflow.asm part 4/3 (432 bytes); ==================================================================
...
;
; BANK 03 used 4674 / 8192
; - SCREEN_PANTALLA1_0_LAYOUT          768 stored /   768 raw bytes @ #A000 (rom #A000, offset +#0000) [SCREENS/SCREEN_LAYOUT]
; - SCREEN_PANTALLA1_0_EFFECTS_LAYOUT   768 stored /   768 raw bytes @ #A300 (rom #A300, offset +#0300) [SCREENS/SCREEN_EFFECTS_LAYOUT]
; - BEHAVIOR_PANTALLA1_0_DATA          768 stored /   768 raw bytes @ #A600 (rom #A600, offset +#0600) [SCREENS/SCREEN_BEHAVIOR_MAP]
; - SCREEN_PANTALLA1_0_INTERACTION_TYPE_MAP   768 stored /   768 raw bytes @ #A900 (rom #A900, offset +#0900) [SCREENS/SCREEN_DATA]
; - SCREEN_PANTALLA1_0_INTERACTION_VALUE_MAP   768 stored /   768 raw bytes @ #AC00 (rom #AC00, offset +#0C00) [SCREENS/SCREEN_DATA]
; - SCREEN_PANTALLA1_0_INTERACTION_TARGET_MAP   768 stored /   768 raw bytes @ #AF00 (rom #AF00, offset +#0F00) [SCREENS/SCREEN_DATA]
; - NEW_SPRITE_0_F0_LAYER1              32 stored /    32 raw bytes @ #B200 (rom #B200, offset +#1200) [SPRITES/SPRITE_PATTERNS]
; - SPRITE_PLACEHOLDER_PATTERN          32 stored /    32 raw bytes @ #B220 (rom #B220, offset +#1220) [SPRITES/SPRITE_PATTERNS]
; - SCREEN_PANTALLA1_0_EFFECT_ZONE_TABLE     1 stored /     1 raw bytes @ #B240 (rom #B240, offset +#1240) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; - SCREEN_PANTALLA1_0_BOSS_TABLE        1 stored /     1 raw bytes @ #B241 (rom #B241, offset +#1241) [SCREENS/SCREEN_DATA]
; FREE 3518
...
;         "metadataChecksum": "fnv1a32:7C4CBE9C",
;         "resourceCount": 10,
;         "storedBytes": 4674
;       },
;       "resources": [
...
;           "flags": 0,
;           "sourceIndex": 2,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=768; zoneSize=8192; bank=3; offset=#0000-#02FF; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 3,
...
;           "flags": 0,
;           "sourceIndex": 3,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=768; zoneSize=8192; bank=3; offset=#0300-#05FF; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 6,
...
;           "flags": 0,
;           "sourceIndex": 6,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=768; zoneSize=8192; bank=3; offset=#0600-#08FF; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 7,
...
;           "flags": 0,
;           "sourceIndex": 7,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=768; zoneSize=8192; bank=3; offset=#0900-#0BFF; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 8,
...
;           "flags": 0,
;           "sourceIndex": 8,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=768; zoneSize=8192; bank=3; offset=#0C00-#0EFF; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 9,
...
;           "flags": 0,
;           "sourceIndex": 9,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=768; zoneSize=8192; bank=3; offset=#0F00-#11FF; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 0,
...
;           "flags": 0,
;           "sourceIndex": 0,
;           "placementReason": "konami first-fit data-zone placement; group=sprites; stored=32; zoneSize=8192; bank=3; offset=#1200-#121F; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 1,
...
;           "flags": 0,
;           "sourceIndex": 1,
;           "placementReason": "konami first-fit data-zone placement; group=sprites; stored=32; zoneSize=8192; bank=3; offset=#1220-#123F; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 4,
...
;           "flags": 0,
;           "sourceIndex": 4,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=1; zoneSize=8192; bank=3; offset=#1240-#1240; window=p3/#A000; slackAfter=3518"
;         },
;         {
;           "id": 5,
...
;           "flags": 0,
;           "sourceIndex": 5,
;           "placementReason": "konami first-fit data-zone placement; group=screens; stored=1; zoneSize=8192; bank=3; offset=#1241-#1241; window=p3/#A000; slackAfter=3518"
;         }
;       ]
;     }
;   ],
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 45568,
;         "bank_offset": 4608,
;         "file_offset": 29184,
;         "physical_address": 45568,
;         "align": 1
;       },
;       "size": {
;         "stored": 32,
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 45600,
;         "bank_offset": 4640,
;         "file_offset": 29216,
;         "physical_address": 45600,
;         "align": 1
;       },
;       "size": {
;         "stored": 32,
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 45632,
;         "bank_offset": 4672,
;         "file_offset": 29248,
;         "physical_address": 45632,
;         "align": 1
;       },
;       "size": {
;         "stored": 1,
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 45633,
;         "bank_offset": 4673,
;         "file_offset": 29249,
;         "physical_address": 45633,
;         "align": 1
;       },
;       "size": {
;         "stored": 1,
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 42496,
;         "bank_offset": 1536,
;         "file_offset": 26112,
;         "physical_address": 42496,
;         "align": 1
;       },
;       "size": {
;         "stored": 768,
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 43264,
;         "bank_offset": 2304,
;         "file_offset": 26880,
;         "physical_address": 43264,
;         "align": 1
;       },
;       "size": {
;         "stored": 768,
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 44032,
;         "bank_offset": 3072,
;         "file_offset": 27648,
;         "physical_address": 44032,
;         "align": 1
;       },
;       "size": {
;         "stored": 768,
...
;         "rom_bank_index": 3,
;         "window": "#A000",
;         "window_address": 44800,
;         "bank_offset": 3840,
;         "file_offset": 28416,
;         "physical_address": 44800,
;         "align": 1
;       },
;       "size": {
;         "stored": 768,
...
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#0000; window=p3/#A000"
;       },
;       {
;         "id": 3,
;         "label": "SCREEN_PANTALLA1_0_EFFECTS_LAYOUT",
...
;         "sceneId": "screenmap_1767095338721",
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#0300; window=p3/#A000"
;       },
;       {
;         "id": 6,
;         "label": "BEHAVIOR_PANTALLA1_0_DATA",
...
;         "sceneId": "screenmap_1767095338721",
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#0600; window=p3/#A000"
;       },
;       {
;         "id": 7,
;         "label": "SCREEN_PANTALLA1_0_INTERACTION_TYPE_MAP",
...
;         "sceneId": "screenmap_1767095338721",
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#0900; window=p3/#A000"
;       },
;       {
;         "id": 8,
;         "label": "SCREEN_PANTALLA1_0_INTERACTION_VALUE_MAP",
...
;         "sceneId": "screenmap_1767095338721",
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#0C00; window=p3/#A000"
;       },
;       {
;         "id": 9,
;         "label": "SCREEN_PANTALLA1_0_INTERACTION_TARGET_MAP",
...
;         "sceneId": "screenmap_1767095338721",
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#0F00; window=p3/#A000"
;       },
;       {
;         "id": 4,
;         "label": "SCREEN_PANTALLA1_0_EFFECT_ZONE_TABLE",
...
;         "sceneId": "screenmap_1767095338721",
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#1200; window=p3/#A000"
;       },
;       {
;         "id": 5,
;         "label": "SCREEN_PANTALLA1_0_BOSS_TABLE",
...
;         "sceneId": "screenmap_1767095338721",
;         "sceneName": "pantalla1",
;         "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192; proposedBank=3; offset=#1201; window=p3/#A000"
;       },
;       {
;         "id": 0,
;         "label": "NEW_SPRITE_0_F0_LAYER1",
...
;         "sceneId": null,
;         "sceneName": null,
;         "placementReason": "shared/global first-fit unit; resources=1; stored=32; zoneSize=8192; proposedBank=3; offset=#1202; window=p3/#A000"
;       },
;       {
;         "id": 1,
;         "label": "SPRITE_PLACEHOLDER_PATTERN",
...
;         "sceneId": null,
;         "sceneName": null,
;         "placementReason": "shared/global first-fit unit; resources=1; stored=32; zoneSize=8192; proposedBank=3; offset=#1222; window=p3/#A000"
;       }
;     ],
;     "banks": [
;       {
...
;             "storedBytes": 4610,
;             "rawBytes": 4610,
;             "placementReason": "scene-aware first-fit unit; scene=pantalla1; resources=8; stored=4610; zoneSize=8192"
;           },
;           {
;             "kind": "shared",
;             "sceneIndex": null,
...
; - gameflow: 15230 estimated bytes
; - gameflow_aux: 5061 estimated bytes
...
;       "estimatedUsedBytes": 5061,
;       "estimatedFreeBytes": 3131,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "gameflow_aux",
...
gameflow_textscroll_base_line EQU #C134   ; TextScroll signed source line for current row
gameflow_textscroll_col EQU #C135   ; TextScroll current screen column
gameflow_textscroll_scan EQU #C136   ; TextScroll destination tile scanline
gameflow_textscroll_font_scan EQU #C137   ; TextScroll source font scanline
gameflow_textscroll_top_char EQU #C138   ; TextScroll cached source character
gameflow_textscroll_bottom_char EQU #C139   ; TextScroll cached next source character
gameflow_textscroll_row_visible_flags EQU #C13A   ; TextScroll per-screen-row visible flags (24 bytes)
gameflow_textscroll2_text_ptr EQU #C152   ; TextScroll2 active fixed-width line pointer (16-bit)
gameflow_textscroll2_text_pix EQU #C154   ; TextScroll2 active font scanline 0..7
gameflow_textscroll2_line_count EQU #C155   ; TextScroll2 generated text line count
gameflow_textscroll2_speed EQU #C156   ; TextScroll2 frames per pixel step
gameflow_textscroll2_bg_color EQU #C157   ; TextScroll2 screen background color
gameflow_textscroll2_stripe_color EQU #C158   ; TextScroll2 pattern background color
gameflow_textscroll2_steps_left EQU #C159   ; TextScroll2 remaining pixel scroll steps (16-bit)
transition_delay_var    EQU #C15B   ; Frames per step for active transition effect
transition_effect_id    EQU #C15C   ; Last Transition effect id for target reveal
transition_fill_char    EQU #C15D   ; Name Table char for active transition wipe (#FE/#FF)
transition_diag_index   EQU #C15E   ; Diagonal clear current diagonal (0..54)
transition_diag_len     EQU #C15F   ; Diagonal clear remaining cells in current diagonal
transition_diag_done    EQU #C160   ; 1 when diagonal clear is complete
transition_diag_addr    EQU #C161   ; Diagonal clear current VRAM address

; ==================================================================
; MIDEAS GLOBAL VARIABLES (DEFAULTS + CUSTOM)
; ==================================================================
global_var_goal     EQU #C163   ; Goal status (0=Failure, 1=Completed)

; ==================================================================
; SYSTEM VARIABLES
; ==================================================================
ROM_slot            EQU #C164   ; Expanded slot for normal page 1 ROM access
slot_primary_normal EQU #C165   ; Primary slot register snapshot for BIOS-ROM-ROM-RAM layout
page0_bios_slot     EQU #C166   ; Expanded slot for normal BIOS page 0
page2_normal_slot   EQU #C167   ; Expanded slot for normal page 2 layout
page3_normal_slot   EQU #C168   ; Expanded slot for normal RAM page 3
slot_subslot_normal EQU #C169   ; Raw subslot register snapshot for normal page 3 expanded slot
mapper_bank_p1_current EQU #C16A   ; Mapper current bank for page/window 1
mapper_bank_p2_current EQU #C16B   ; Mapper current bank for page/window 2
mapper_bank_p3_current EQU #C16C   ; Mapper current bank for page/window 3
mapper_bank_p4_current EQU #C16D   ; Mapper current bank for page/window 4
mapper_saved_bank    EQU #C16E   ; Saved mapper bank for push/pop helpers
mapper_saved_bank_p1 EQU #C16F   ; Saved mapper bank for page/window 1 helpers
mapper_saved_bank_p3 EQU #C170   ; Saved mapper bank for page/window 3 helpers
mapper_saved_bank_p4 EQU #C171   ; Saved mapper bank for page/window 4 helpers
resource_descriptor_ptr EQU #C172   ; Pointer to cached resource descriptor entry (16-bit)
resource_descriptor_id EQU #C174   ; Cached resource id
resource_descriptor_type EQU #C175   ; Cached resource type
resource_descriptor_group EQU #C176   ; Cached resource group
resource_descriptor_bank EQU #C177   ; Cached resource bank
resource_descriptor_addr EQU #C178   ; Cached resource visible address (16-bit)
resource_descriptor_size EQU #C17A   ; Cached resource size (16-bit)
resource_descriptor_uncompressed_size EQU #C17C   ; Cached resource uncompressed size (16-bit)
resource_descriptor_flags EQU #C17E   ; Cached resource flags
vram_cache_tile_patterns_ready EQU #C17F   ; 1 when shared gameplay tile patterns are already resident in VRAM
vram_cache_tile_colors_ready EQU #C180   ; 1 when shared gameplay tile colors are already resident in VRAM
vram_cache_font_ready EQU #C181   ; 1 when shared font patterns/colors are already resident in VRAM
resource_ram_cache_effects_layout_id EQU #C182   ; Cached resource id for runtime_effects_layout source
resource_ram_cache_effect_zone_table_id EQU #C183   ; Cached resource id for runtime_effect_zone_table source
current_screen2_tilebank_id EQU #C184   ; Current SCREEN 2 shared tilebank loaded in VRAM (#FF=none/unknown)

; ASCII16 lower-window far-call bridge copied to RAM at boot
ASCII16_FAR_CALL_P1_RAM EQU #C185   ; RAM routine: map ASCII16 lower 16KB page, call target, restore page
ASCII16_FAR_CALL_P1_PRESERVE_A_RAM EQU #C1E5   ; RAM routine variant preserving caller/result A through AF'
ASCII16_RESIDENT_CALL_P1_RAM EQU #C245   ; RAM routine: call resident lower-page routine from ASCII16 P1 far code
ASCII16_TAIL_JUMP_P1_RAM EQU #C2A5   ; RAM routine: map ASCII16 lower page and JP without restoring
ASCII16_IRQ_ENTRY_RAM EQU #C2C5   ; RAM H.TIMI entry: map ASCII16 bank0 before interrupt_dispatcher
ASCII16_IRQ_EXIT_RAM EQU #C305   ; RAM H.TIMI exit: restore interrupted ASCII16 lower-page bank
ascii16_far_target_bank EQU #C345   ; Target ASCII16 bank for RAM far-call bridge
ascii16_far_old_bank EQU #C346   ; Previous ASCII16 lower-page bank for RAM far-call restore
ascii16_far_call_depth EQU #C347   ; Non-zero while executing inside ASCII16 RAM far-call target
ascii16_far_target_addr EQU #C348   ; Target entry address for RAM far-call bridge (16-bit)
ascii16_resident_call_target_addr EQU #C34A   ; Resident target address for RAM bridge (16-bit)
ascii16_resident_call_saved_hl EQU #C34C   ; Saved HL input while RAM resident-call bridge stages target address
ascii16_resident_call_saved_de EQU #C34E   ; Saved DE input while RAM resident-call bridge stages return address
ascii16_resident_call_old_bank EQU #C350   ; Previous far lower-page bank for RAM resident-call restore
ascii16_irq_saved_bank EQU #C351   ; Interrupted lower-page bank restored after ASCII16 RAM ISR
frame_counter       EQU #C352   ; Frame counter (16-bit)

; Profiling counters (16-bit, cumulative)
prof_update_all_entities_calls EQU #C354   ; Calls to update_all_entities
prof_execute_sm_calls EQU #C356   ; Calls to execute_all_state_machines
prof_sm_update_calls  EQU #C358   ; Calls to SM_Update
prof_collision_calls  EQU #C35A   ; Calls to update_collision_component
prof_wall_calls       EQU #C35C   ; Calls to update_wallcollision_component
prof_deadly_calls     EQU #C35E   ; Calls to update_deadly_tiles_component
prof_tile_interaction_calls EQU #C360   ; Calls to check_tile_interaction
prof_animation_calls  EQU #C362   ; Calls to update_animation_component
prof_sprite_calls     EQU #C364   ; Calls to update_sprite_component
prof_music_task_calls EQU #C366   ; Calls to task_update_music
prof_deadly_behavior_reads EQU #C368   ; Deadly helper behavior-map reads
; page0_transfer_buffer shares the ZX0 scratch area declared near RAM_USAGE_END.

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C36A   ; Pointer to current screen layout data (16-bit)
current_screen_layout_bank EQU #C36C   ; Mapper bank for current screen layout data
current_behavior_map    EQU #C36D   ; Pointer to current behavior map data (16-bit)
current_behavior_map_bank EQU #C36F   ; Mapper bank for current behavior map data
behavior_cache_row     EQU #C370   ; Cached behavior row (255=invalid)
behavior_cache_map_l   EQU #C371   ; Cached behavior map pointer low byte
behavior_cache_map_h   EQU #C372   ; Cached behavior map pointer high byte
behavior_cache_row_base EQU #C373   ; Cached row base address in behavior map (16-bit)
RUNTIME_SCREEN_MAP_SIZE EQU 768
MAX_RUNTIME_EFFECT_ZONES EQU 0
RUNTIME_KEEP_BACKGROUND_LAYOUT EQU 0
runtime_screen_layout  EQU #C375   ; Mutable copy of current screen layout (32x24)
runtime_behavior_map   EQU #C675   ; Mutable copy of current behavior map (32x24)
runtime_interaction_type_map EQU #C975   ; Mutable copy of current interaction type map (32x24)
runtime_interaction_value_map EQU #CC75   ; Mutable copy of current interaction value map (32x24)
runtime_interaction_target_map EQU #CF75   ; Mutable copy of current interaction target map (32x24)
runtime_char_behavior_table EQU #D275   ; Current screen char -> behavior lookup table (256 bytes)
runtime_effects_layout EQU #D375   ; Alternate effects layout copy for secret zones (32x24)
screen_block_catalog_ptr EQU #D675   ; Scratch pointer to current screen block catalog during layout expansion
screen_block_map_ptr EQU #D677   ; Scratch pointer to current screen block index map during layout expansion
runtime_effect_zone_table EQU #D679   ; Current screen effect zone table (0 bytes)
current_effect_zone_count EQU #D679   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #D67A   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #D67B   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #D67C   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #D67D   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #D67E   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #D67F   ; Camera X position in pixels (16-bit)
camera_y            EQU #D681   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #D683   ; Camera tile X (column)
camera_tile_y       EQU #D684   ; Camera tile Y (row)
world_width_tiles   EQU #D685   ; World width in tiles
world_height_tiles  EQU #D686   ; World height in tiles
scroll_dirty_flag   EQU #D687   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #D688   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #D689   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #D68A   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #D68C   ; Animation frame timer
anim_tile_frame     EQU #D68D   ; Current animation frame (0-3)
anim_tile_speed     EQU #D68E   ; Frames between animation updates

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #D68F   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #D6AF   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_limit_on     EQU #D6CF   ; Limit_on screen-edge clamp flag (32 bytes, 0=no, 1=yes)
entity_button_contact_active EQU #D6EF   ; 1 while entity stays on the same button tile (32 bytes)
entity_button_contact_x EQU #D70F   ; Button tile X currently latched per entity (32 bytes)
entity_button_contact_y EQU #D72F   ; Button tile Y currently latched per entity (32 bytes)
entity_on_ladder   EQU #D74F   ; 1 while entity is centered on a ladder tile (32 bytes)
entity_gate_current_step EQU #D76F   ; Current applied retract step (32 bytes)
entity_gate_step_timer EQU #D78F   ; Countdown until next retract step (32 bytes)
entity_walljump_lock EQU #D7AF   ; Remaining horizontal lock frames after wall jump (32 bytes)
entity_walljump_locked_vx EQU #D7CF   ; Horizontal velocity preserved while wall jump lock is active (32 bytes)
entity_wallgrab_active EQU #D7EF   ; 1 if entity is currently grabbing a wall (32 bytes)
entity_wallgrab_grace EQU #D80F   ; Frames to keep wall grab during transient wall flag gaps (32 bytes)
entity_wallgrab_timer EQU #D82F   ; Remaining wall-grab frames until grounded reset (32 bytes)
entity_wallgrab_lockout EQU #D84F   ; Wall grab disabled until grounded after timer is spent (32 bytes)
entity_wallgrab_cfg_enabled EQU #D86F   ; Runtime WallGrab enabled flag per entity (32 bytes)
entity_wallgrab_cfg_fall_speed EQU #D88F   ; Runtime WallGrab fall speed per entity (32 bytes)
entity_wallgrab_cfg_climb_speed EQU #D8AF   ; Runtime WallGrab climb speed per entity (32 bytes)
entity_wallgrab_cfg_duration_frames EQU #D8CF   ; Runtime WallGrab duration per entity (32 bytes)
entity_wallgrab_cfg_grab_sprite EQU #D8EF   ; Runtime WallGrab sprite index per entity (32 bytes)
entity_walljump_anim_active EQU #D90F   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_dash_cfg_enabled EQU #D92F   ; Runtime Dash enabled flag per entity (32 bytes)
...
entity_carry_held   EQU #DC70   ; Entity carried by this carrier (32 bytes, 255=none)
entity_carry_base_sprite EQU #DC90   ; Sprite asset to restore after carrying (32 bytes, 255=none)
entity_box_state    EQU #DCB0   ; Box runtime state (0=sprite,1=carried,2=dropped tiles) (32 bytes)
entity_box_tile_x   EQU #DCD0   ; Dropped box tile X (32 bytes)
entity_box_tile_y   EQU #DCF0   ; Dropped box tile Y (32 bytes)
entity_template_token EQU #DD10   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #DD30   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #DD50   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #DD70   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #DD90   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #DDB0   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #DDD0   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #DDF0   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #DE10   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #DE30   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #DE50   ; Entity sprite asset index - RAM copy (32 bytes)
entity_sprite_config EQU #DE70   ; Entity sprite config RAM copy (base HW sprite + layer count, 64 bytes)
sprite_asset_frame_count EQU #DEB0   ; Sprite asset frame counts RAM copy (1 bytes)
sprite_asset_layer_count EQU #DEB1   ; Sprite asset layer counts RAM copy (1 bytes)
sprite_loop_flags EQU #DEB2   ; Sprite loop flags RAM copy (1 bytes)
sprite_dir_left_table EQU #DEB3   ; Directional sprite lookup RAM copy (1 bytes)
sprite_dir_right_table EQU #DEB4   ; Directional sprite lookup RAM copy (1 bytes)
sprite_dir_up_table EQU #DEB5   ; Directional sprite lookup RAM copy (1 bytes)
sprite_dir_down_table EQU #DEB6   ; Directional sprite lookup RAM copy (1 bytes)
SM_SpriteLayerColorTable EQU #DEB7   ; Runtime SM sprite layer colors (1*1 bytes)
SM_SpriteLayerYOffsetTable EQU #DEB8   ; Runtime SM sprite layer Y offsets (1*1 bytes)
active_sprite_count EQU #DEB9   ; Number of sprites currently active
sprites_dirty      EQU #DEBA   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #DEBB   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #DEDB   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #DEFB   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_layer_y_offsets EQU #DF1B   ; HW sprite layer signed Y offsets - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #DF3B   ; Runtime base 16x16 slot per sprite asset (1 bytes)
sprite_placeholder_base_pattern_num EQU #DF3C   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #DF3D   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #DF3E   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #DFBE   ; Currently displayed screen ID
current_screen_engine EQU #DFBF   ; Runtime engine: 0=Player, 1=FakePlayer
screen_dirty_flag   EQU #DFC0   ; Screen needs redraw flag
screen_transition_cooldown EQU #DFC1   ; Cooldown frames after screen transition
current_world_id    EQU #DFC2   ; Current world ID (for multi-world support)
current_screen_index EQU #DFC3   ; Current screen index within world
current_screen_anim_group_count EQU #DFC4   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #DFC5   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #DFC6   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #DFC7   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #DFC8   ; Player X position (16-bit)
player_y            EQU #DFCA   ; Player Y position (16-bit)
player_runtime_enabled EQU #DFCC   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #DFCD   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #DFCE   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #DFCF   ; Cached player Y velocity (signed 8-bit)
player_dash_timer   EQU #DFD0   ; Frames remaining in current Player dash
player_dash_cooldown EQU #DFD1   ; Frames until Player can dash again
player_dash_dir     EQU #DFD2   ; Player dash direction (1=left,2=right,3=up,4=down)
player_dash_tile_x  EQU #DFD3   ; Dash front probe tile X scratch
player_dash_tile_y  EQU #DFD4   ; Dash front probe tile Y scratch
player_health       EQU #DFD5   ; Player health points
player_score        EQU #DFD6   ; Player score (16-bit)
gem_count           EQU #DFD8   ; Collectible tile counter (8-bit)
last_interaction_char EQU #DFD9   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #DFDA   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #DFDB   ; Interaction type id of last interacted tile
last_interaction_value EQU #DFDC   ; Interaction value byte of last interacted tile
last_interaction_target EQU #DFDD   ; Interaction target id of last interacted tile
last_interaction_x  EQU #DFDE   ; Tile X coordinate of last interaction
last_interaction_y  EQU #DFDF   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #DFE0   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #DFE1   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #DFE2   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E022   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E062   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E0A2   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E0E2   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E0F2   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E102   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E112   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E122   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E132   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E142   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E143   ; Temporary 16-bit storage
temp_word_2         EQU #E145   ; Temporary 16-bit storage
temp_byte_1         EQU #E147   ; Temporary 8-bit storage
temp_byte_2         EQU #E148   ; Temporary 8-bit storage
temp_byte_3         EQU #E149   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E169   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E189   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E1A9   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E1C9   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E1CA   ; Frames remaining for current SFX
sfx_fadeout         EQU #E1CB   ; Reserved fadeout flag/state
temp_byte_7         EQU #E1CC   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E1EC   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E20C   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E22C   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E24C   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E26C   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E28C   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E2AC   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E2CC   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E2EC   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E30C   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E32C   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E34C   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E36C   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E38C   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E3AC   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E3CC   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E3EC   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E40C   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E42C   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E46C   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E4AC   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E4CC   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E4EC   ; Temporary 8-bit storage (32 bytes)
temp_byte_29        EQU #E50C   ; Temporary 8-bit storage (32 bytes)
temp_byte_30        EQU #E52C   ; Temporary 8-bit storage (32 bytes)
temp_byte_31        EQU #E54C   ; Temporary 8-bit storage (32 bytes)
temp_byte_32        EQU #E56C   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E58C   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E58D   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E58E   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E58F   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E590   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E591   ; Cached entity X for wall checks
wall_temp_y         EQU #E592   ; Cached entity Y for wall checks
wall_hit_left       EQU #E593   ; Hitbox left edge cache
wall_hit_top        EQU #E594   ; Hitbox top edge cache
wall_hit_right      EQU #E595   ; Hitbox right edge cache
wall_hit_bottom     EQU #E596   ; Hitbox bottom edge cache
wall_hit_w          EQU #E597   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E598   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E599   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E59A   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E59B   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E59C   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E59D   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E5BD   ; Number of entries in active_entity_list
hero_entity_id      EQU #E5BE   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E5BF   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E5C0   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E5E0   ; Number of entries in input_entity_list
render_entity_list  EQU #E5E1   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E601   ; Number of entries in render_entity_list
collision_entity_list EQU #E602   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E622   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E623   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E643   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E644   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E664   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E665   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E685   ; Number of entities in coll_list
coll_src_left       EQU #E686   ; Source AABB left edge (scratch)
coll_src_right      EQU #E687   ; Source AABB right edge (scratch)
coll_src_top        EQU #E688   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E689   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E68A   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E68A   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E68C   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E68E   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E690   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E692   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E694   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E696   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E698   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E69A   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E69B   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E6A0   ; Frame counter (16-bit)
task_exec_time          EQU #E6A2   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E6A4   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E6A5   ; 1 while the H.TIMI dispatcher is running
far_call_irq_lock_depth EQU #E6A6   ; Nonzero while far trampolines own an IRQ-masked mapper window
RAM_INTERRUPT_END       EQU #E6A7   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E6A7   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E6A8   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E6A9   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E6AA   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E6AB   ; 0=stopped, 1=track active
music_muted          EQU #E6AC   ; 0=audible, 1=muted/pause
music_loop           EQU #E6AD   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E6AE   ; Current ROM track index
music_row_frames     EQU #E6AF   ; Frames per tracker row
music_row_countdown  EQU #E6B0   ; Countdown to next row
music_order_pos      EQU #E6B1   ; Current order position
music_pattern_index  EQU #E6B2   ; Current pattern index
music_pattern_row    EQU #E6B3   ; Current row inside pattern
music_pattern_rows   EQU #E6B4   ; Cached rows in current pattern
music_track_ptr_l    EQU #E6B5   ; Current track pointer low byte
music_track_ptr_h    EQU #E6B6   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E6B7   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E6B8   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E6B9   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E6BA   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E6BB   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E6BC   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E6BD   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E6BD   ; Channel A
music_ch_b_note EQU #E6BE   ; Channel B
music_ch_c_note EQU #E6BF   ; Channel C
music_ch_instrument_base EQU #E6C0   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E6C0   ; Channel A
music_ch_b_instrument EQU #E6C1   ; Channel B
music_ch_c_instrument EQU #E6C2   ; Channel C
music_ch_ornament_base EQU #E6C3   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E6C3   ; Channel A
music_ch_b_ornament EQU #E6C4   ; Channel B
music_ch_c_ornament EQU #E6C5   ; Channel C
music_ch_volume_base EQU #E6C6   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E6C6   ; Channel A
music_ch_b_volume EQU #E6C7   ; Channel B
music_ch_c_volume EQU #E6C8   ; Channel C
music_ch_vol_step_base EQU #E6C9   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E6C9   ; Channel A
music_ch_b_vol_step EQU #E6CA   ; Channel B
music_ch_c_vol_step EQU #E6CB   ; Channel C
music_ch_tone_step_base EQU #E6CC   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E6CC   ; Channel A
music_ch_b_tone_step EQU #E6CD   ; Channel B
music_ch_c_tone_step EQU #E6CE   ; Channel C
music_ch_noise_step_base EQU #E6CF   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E6CF   ; Channel A
music_ch_b_noise_step EQU #E6D0   ; Channel B
music_ch_c_noise_step EQU #E6D1   ; Channel C
music_ch_orn_step_base EQU #E6D2   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E6D2   ; Channel A
music_ch_b_orn_step EQU #E6D3   ; Channel B
music_ch_c_orn_step EQU #E6D4   ; Channel C
music_ch_hw_env_step_base EQU #E6D5   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E6D5   ; Channel A
music_ch_b_hw_env_step EQU #E6D6   ; Channel B
music_ch_c_hw_env_step EQU #E6D7   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E6D8   ; End of project variables (9944 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E6D8: Project variables (9944 bytes)
;   #E6D8-#E700: Alignment padding/free RAM (40 bytes)
...
.ts2_speed_ok:
    ...
    call textscroll_clear_row_visible_flags
    call ENASCR
...
gameflow_node_scroll_data:
    ...
    db 1                  ; Stripe color (MSX index from #000000)
    db 1                  ; Frames per pixel step
    db 38                  ; Number of lines
    db 13
    dw textscroll_scroll_title
    db 16
    dw textscroll_scroll_blank0
    db 2
    dw textscroll_scroll_line0
    db 10
    dw textscroll_scroll_line1
    db 16
    dw textscroll_scroll_line2
    db 3
    dw textscroll_scroll_line3
    db 4
    dw textscroll_scroll_line4
    db 5
    dw textscroll_scroll_line5
    db 12
    dw textscroll_scroll_line6
    db 16
    dw textscroll_scroll_line7
    db 2
    dw textscroll_scroll_line8
    db 2
    dw textscroll_scroll_line9
    db 7
    dw textscroll_scroll_line10
    db 16
    dw textscroll_scroll_line11
    db 5
    dw textscroll_scroll_line12
    db 2
    dw textscroll_scroll_line13
    db 6
    dw textscroll_scroll_line14
    db 16
    dw textscroll_scroll_line15
    db 3
    dw textscroll_scroll_line16
    db 3
    dw textscroll_scroll_line17
    db 6
    dw textscroll_scroll_line18
    db 12
    dw textscroll_scroll_line19
    db 16
    dw textscroll_scroll_line20
    db 3
    dw textscroll_scroll_line21
    db 5
    dw textscroll_scroll_line22
    db 16
    dw textscroll_scroll_line23
    db 2
    dw textscroll_scroll_line24
    db 4
    dw textscroll_scroll_line25
    db 2
    dw textscroll_scroll_line26
    db 5
    dw textscroll_scroll_line27
    db 12
    dw textscroll_scroll_line28
    db 16
    dw textscroll_scroll_line29
    db 2
    dw textscroll_scroll_line30
    db 4
    dw textscroll_scroll_line31
    db 4
    dw textscroll_scroll_line32
    db 16
    dw textscroll_scroll_line33
    db 3
    dw textscroll_scroll_line34
    db 6
    dw textscroll_scroll_line35

textscroll_scroll_title:
    db "ELANA", 0
textscroll_scroll_blank0:
    db 0
textscroll_scroll_line0:
    db "ATENAS ARDE BAJO LA FURIA DE", 0
textscroll_scroll_line1:
    db "LOS TITANES.", 0
textscroll_scroll_line2:
    db 0
textscroll_scroll_line3:
    db "ELANA, HIJA DE UN HERRERO,", 0
textscroll_scroll_line4:
    db "HUYE ENTRE EL HUMO PARA", 0
textscroll_scroll_line5:
    db "ENCONTRAR A SU HERMANO", 0
textscroll_scroll_line6:
    db "PEQUENO.", 0
textscroll_scroll_line7:
    db 0
textscroll_scroll_line8:
    db "UNA SACERDOTISA LO ESCONDIO", 0
textscroll_scroll_line9:
    db "EN LA ACROPOLIS ANTES DE QUE", 0
textscroll_scroll_line10:
    db "LA CIUDAD CAYERA.", 0
textscroll_scroll_line11:
    db 0
textscroll_scroll_line12:
    db "EN EL TEMPLO DERRUIDO,", 0
textscroll_scroll_line13:
    db "CALIOPE LE ENTREGA UN PAPIRO", 0
textscroll_scroll_line14:
    db "Y UNA ULTIMA PISTA.", 0
textscroll_scroll_line15:
    db 0
textscroll_scroll_line16:
    db "BAJO EL TEMPLO HAY UN FOSO", 0
textscroll_scroll_line17:
    db "ANTIGUO, Y EN SU OSCURIDAD", 0
textscroll_scroll_line18:
    db "PUEDE SEGUIR VIVO SU", 0
textscroll_scroll_line19:
    db "HERMANO.", 0
textscroll_scroll_line20:
    db 0
textscroll_scroll_line21:
    db "PERO LA BUSQUEDA REVELARA", 0
textscroll_scroll_line22:
    db "UNA MALDICION DIVINA.", 0
textscroll_scroll_line23:
    db 0
textscroll_scroll_line24:
    db "LOS DIOSES HAN CONVERTIDO A", 0
textscroll_scroll_line25:
    db "LOS GRANDES FILOSOFOS EN", 0
textscroll_scroll_line26:
    db "TITANES PARA CASTIGAR A LOS", 0
textscroll_scroll_line27:
    db "HOMBRES POR BUSCAR LA", 0
textscroll_scroll_line28:
    db "VERDAD.", 0
textscroll_scroll_line29:
    db 0
textscroll_scroll_line30:
    db "CON LA HOJA DE SU PADRE Y EL", 0
textscroll_scroll_line31:
    db "VALOR NACIDO DEL FUEGO,", 0
textscroll_scroll_line32:
    db "ELANA DEBERA LIBERARLOS.", 0
textscroll_scroll_line33:
    db 0
textscroll_scroll_line34:
    db "SI ATENAS ESTA ROTA, ELANA", 0
textscroll_scroll_line35:
    db "LA VOLVERA A FORJAR.", 0
...
; Data start address: #A000
; Total data bytes (source blocks): 4674
; Zones used: 1
; Placement policy: sort blocks by size descending, then first-fit by zone.
; ------------------------------------------------------------------
; ZONE 00 [#A000-#C000] bank 3 used=4674 slack=3518
;   + SCREEN_PANTALLA1_0_LAYOUT (screens) @ +#0000 size=768
;   + SCREEN_PANTALLA1_0_EFFECTS_LAYOUT (screens) @ +#0300 size=768
;   + BEHAVIOR_PANTALLA1_0_DATA (screens) @ +#0600 size=768
;   + SCREEN_PANTALLA1_0_INTERACTION_TYPE_MAP (screens) @ +#0900 size=768
;   + SCREEN_PANTALLA1_0_INTERACTION_VALUE_MAP (screens) @ +#0C00 size=768
;   + SCREEN_PANTALLA1_0_INTERACTION_TARGET_MAP (screens) @ +#0F00 size=768
;   + NEW_SPRITE_0_F0_LAYER1 (sprites) @ +#1200 size=32
;   + SPRITE_PLACEHOLDER_PATTERN (sprites) @ +#1220 size=32
;   + SCREEN_PANTALLA1_0_EFFECT_ZONE_TABLE (screens) @ +#1240 size=1
;   + SCREEN_PANTALLA1_0_BOSS_TABLE (screens) @ +#1241 size=1

    org #A000
; ==================================================================
; DATA ZONE 00 (bank 3) used=4674 slack=3518
; ==================================================================
; ==================================================================
...
;; MSX1 HW Layer Order (front to back): C1=#FFFFFF

;; ---- Sprite Frame: New Sprite_0_F0 ----
;; Size: 16x16
NEW_SPRITE_0_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#01,#02,#01,#01,#11,#2E,#11,#01,#01,#02,#01,#00,#00,#00
    DB #00,#00,#00,#80,#00,#00,#10,#E8,#10,#00,#00,#80,#00,#00,#00,#00
...
textscroll_clear_row_visible_flags:
    xor a
    ld hl, gameflow_textscroll_row_visible_flags
    ld b, 24
.flag_loop:
    ld (hl), a
    inc hl
...
; ------------------------------------------------------------------
; Compose the visible pattern rows from the text stream.
; This is a true pixel scroll: each scanline uses the virtual coordinate
; y + step*8 + fine, so glyphs cross tile-row boundaries without distortion.
; ------------------------------------------------------------------
...
.row_loop:
    ...
    call textscroll_row_has_visible_text
    jr z, .clear_row
    call textscroll_mark_row_visible
    call textscroll_build_row_buffer
    call textscroll_upload_row_buffer
    jr .next_row

.clear_row:
    call textscroll_clear_row_if_needed
...
textscroll_row_has_visible_text:
    ld a, (gameflow_textscroll_base_line)
    call textscroll_line_index_visible
    ret nz
...
; Output: Z reset when A is a visible text line, Z set otherwise.
textscroll_line_index_visible:
    bit 7, a
    jr nz, .line_not_visible
    ld hl, gameflow_textscroll_line_count
    cp (hl)
    jr nc, .line_not_visible
    or 1
    ret
.line_not_visible:
    xor a
...
.col_loop:
    ...
    ld a, (gameflow_textscroll_base_line)
    push hl
    call textscroll_get_line_char
    pop hl
    ld (gameflow_textscroll_top_char), a
    ld a, (gameflow_textscroll_base_line)
    inc a
    ld c, a
    ld a, (gameflow_textscroll_col)
    ...
    call textscroll_get_line_char
    pop hl
    ld (gameflow_textscroll_bottom_char), a
    xor a
...
.scan_loop:
    ...
    ld a, (gameflow_textscroll_bottom_char)
    jr .have_char
.same_line:
    ld (gameflow_textscroll_font_scan), a
    ld a, (gameflow_textscroll_top_char)
.have_char:
    push hl
    call textscroll_get_font_byte
    pop hl
    ld (hl), a
    inc hl
    ld a, (gameflow_textscroll_scan)
...
; Output: A = character code, or 0 when outside the text range.
textscroll_get_line_char:
    bit 7, a
    jr nz, .line_char_blank
    ld e, a
    ld hl, gameflow_textscroll_line_count
    cp (hl)
    jr nc, .line_char_blank
    push bc
    push hl
    ld a, e
...
.line_char_loop:
    ld a, (hl)
    or a
    jr z, .line_char_blank
    ld a, e
    or a
    jr z, .line_char_have_char
    inc hl
    dec e
    jr .line_char_loop
.line_char_have_char:
...
; Input: A = character code, gameflow_textscroll_font_scan = 0..7.
; Output: A = pattern byte, or 0 when outside the captured font range.
textscroll_get_font_byte:
    cp TEXTSCROLL_FONT_FIRST
    jr c, .font_byte_blank
    cp TEXTSCROLL_FONT_FIRST + TEXTSCROLL_FONT_COUNT
    jr nc, .font_byte_blank
...
textscroll_upload_row_buffer:
    call textscroll_get_row_vram_addr
    push hl
    ld hl, TEXTSCROLL_ROW_BUF
    pop de
...
textscroll_mark_row_visible:
    call textscroll_get_row_flag_addr
    ld (hl), 1
    ret

textscroll_clear_row_if_needed:
    call textscroll_get_row_flag_addr
    ld a, (hl)
    or a
    ret z
    xor a
    ld (hl), a
    jp textscroll_clear_row_vram

textscroll_get_row_flag_addr:
    ld a, (gameflow_textscroll_row)
    ld e, a
    ld d, 0
    ld hl, gameflow_textscroll_row_visible_flags
...
textscroll_clear_row_vram:
    call textscroll_get_row_vram_addr
    xor a
    ld bc, TEXTSCROLL_ROW_BYTES
    jp FAST_FILLVRM

textscroll_get_row_vram_addr:
    ld a, (gameflow_textscroll_row)
    cp 8
    jr c, .bank0
    cp 16
