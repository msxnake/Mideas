; ==================================================================
; MUSIC1_INSTPTR_FIX - UNIFIED FILE
...
; BANK 03 @#0000 : sound.asm part 2/2 (5220 bytes)
; BANK 03 @#1464 : scroll.asm (2342 bytes)
; BANK 03 @#1D8A : animtiles.asm (630 bytes)
; BANK 04 @#0000 : animtiles.asm (3991 bytes)
; BANK 04 @#0F97 : statemachine.asm (5 bytes)
; BANK 04 @#0F9C : gameflow.asm (4196 bytes)
; BANK 05 @#0000 : gameflow.asm (1255 bytes)
