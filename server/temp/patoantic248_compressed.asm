...
; Estimated payload bytes: 148380
...
; BANK 03 @#0000 : entities.asm part 3/2 (849 bytes)
; BANK 03 @#0351 : worlds.asm part 1/2 (7343 bytes)
; BANK 04 @#0000 : worlds.asm part 2/2 (1252 bytes)
; BANK 04 @#04E4 : screens.asm part 1/5 (6940 bytes)
; BANK 05 @#0000 : screens.asm part 2/5 (8192 bytes)
; BANK 06 @#0000 : screens.asm part 3/5 (8192 bytes)
; BANK 07 @#0000 : screens.asm part 4/5 (8192 bytes)
; BANK 08 @#0000 : screens.asm part 5/5 (7522 bytes)
; BANK 08 @#1D62 : sprites.asm part 1/2 (670 bytes)
; BANK 09 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 10 @#0000 : sprites.asm part 3/2 (4920 bytes)
; BANK 10 @#1338 : font.asm (1833 bytes)
; BANK 10 @#1A61 : hud.asm (1439 bytes)
; BANK 11 @#0000 : hud.asm (2851 bytes)
; BANK 11 @#0B23 : menus.asm (454 bytes)
; BANK 11 @#0CE9 : sound.asm (4887 bytes)
; BANK 12 @#0000 : sound.asm (2360 bytes)
; BANK 12 @#0938 : scroll.asm (2353 bytes)
; BANK 12 @#1269 : animtiles.asm (3479 bytes)
; BANK 13 @#0000 : animtiles.asm (2760 bytes)
; BANK 13 @#0AC8 : statemachine.asm part 1/3 (5432 bytes)
; BANK 14 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 15 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 16 @#0000 : statemachine.asm part 4/3 (97 bytes)
; BANK 16 @#0061 : gameflow.asm part 1/3 (8095 bytes)
; BANK 17 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 18 @#0000 : gameflow.asm part 3/3 (924 bytes)
...
frame_counter       EQU #C026   ; Frame counter (16-bit)

; Profiling counters (16-bit, cumulative)
prof_update_all_entities_calls EQU #C028   ; Calls to update_all_entities
prof_execute_sm_calls EQU #C02A   ; Calls to execute_all_state_machines
prof_sm_update_calls  EQU #C02C   ; Calls to SM_Update
prof_collision_calls  EQU #C02E   ; Calls to update_collision_component
prof_wall_calls       EQU #C030   ; Calls to update_wallcollision_component
prof_deadly_calls     EQU #C032   ; Calls to update_deadly_tiles_component
prof_tile_interaction_calls EQU #C034   ; Calls to check_tile_interaction
prof_animation_calls  EQU #C036   ; Calls to update_animation_component
prof_sprite_calls     EQU #C038   ; Calls to update_sprite_component
prof_music_task_calls EQU #C03A   ; Calls to task_update_music
prof_deadly_behavior_reads EQU #C03C   ; Deadly helper behavior-map reads
page0_transfer_buffer EQU #C03E   ; Temporary RAM buffer for page0 -> VRAM copies

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C13E   ; Pointer to current screen layout data (16-bit)
current_screen_layout_bank EQU #C140   ; Mapper bank for current screen layout data
current_behavior_map    EQU #C141   ; Pointer to current behavior map data (16-bit)
current_behavior_map_bank EQU #C143   ; Mapper bank for current behavior map data
behavior_cache_row     EQU #C144   ; Cached behavior row (255=invalid)
behavior_cache_map_l   EQU #C145   ; Cached behavior map pointer low byte
behavior_cache_map_h   EQU #C146   ; Cached behavior map pointer high byte
behavior_cache_row_base EQU #C147   ; Cached row base address in behavior map (16-bit)
RUNTIME_SCREEN_MAP_SIZE EQU 768
MAX_RUNTIME_EFFECT_ZONES EQU 64
runtime_background_layout EQU #C149   ; Immutable copy of current background layout (32x24)
runtime_screen_layout  EQU #C449   ; Mutable copy of current screen layout (32x24)
runtime_behavior_map   EQU #C749   ; Mutable copy of current behavior map (32x24)
runtime_effects_layout EQU #CA49   ; Alternate effects layout copy for secret zones (32x24)
runtime_effect_zone_table EQU #CD49   ; Current screen effect zone table (MAX_RUNTIME_EFFECT_ZONES * 8 bytes)
current_effect_zone_count EQU #CF49   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #CF4A   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #CF4B   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #CF4C   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #CF4D   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #CF4E   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #CF4F   ; Camera X position in pixels (16-bit)
camera_y            EQU #CF51   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #CF53   ; Camera tile X (column)
camera_tile_y       EQU #CF54   ; Camera tile Y (row)
world_width_tiles   EQU #CF55   ; World width in tiles
world_height_tiles  EQU #CF56   ; World height in tiles
scroll_dirty_flag   EQU #CF57   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #CF58   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #CF59   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #CF5A   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #CF5C   ; Animation frame timer
anim_tile_frame     EQU #CF5D   ; Current animation frame (0-3)
anim_tile_speed     EQU #CF5E   ; Frames between animation updates
anim_tile_transform_flags EQU #CF5F   ; Runtime flags for transform-mode tile animation (byte0=flags, byte1=opcode scratch)
anim_tile_row_buffer EQU #CF61   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #CF69   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #CF89   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_x_pos        EQU #CFA9   ; Entity X positions (32 bytes)
entity_y_pos        EQU #CFC9   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #CFE9   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #D009   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #D029   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #D049   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #D069   ; Entity screen ID (32 bytes)
entity_job_period   EQU #D089   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #D0A9   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #D0C9   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #D0CA   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #D0EA   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #D10A   ; Entity health (32 bytes)
entity_anim_frame   EQU #D12A   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #D14A   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #D16A   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #D18A   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #D1AA   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #D1CA   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #D1EA   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #D20A   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #D22A   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #D24A   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #D26A   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #D28A   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #D2AA   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #D2CA   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #D2EA   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #D30A   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #D32A   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #D34A   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #D36A   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #D38A   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #D3AA   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #D3CA   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #D3EA   ; Number of sprites currently active
sprites_dirty      EQU #D3EB   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #D3EC   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #D40C   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #D42C   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #D44C   ; Runtime base 16x16 slot per sprite asset (18 bytes)
sprite_placeholder_base_pattern_num EQU #D45E   ; Runtime placeholder pattern number (base slot * 4)
sprite_attributes   EQU #D45F   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (8 screens detected)
; ==================================================================
current_screen_id   EQU #D4DF   ; Currently displayed screen ID
screen_dirty_flag   EQU #D4E0   ; Screen needs redraw flag
screen_transition_cooldown EQU #D4E1   ; Cooldown frames after screen transition
current_world_id    EQU #D4E2   ; Current world ID (for multi-world support)
current_screen_index EQU #D4E3   ; Current screen index within world
current_screen_anim_group_count EQU #D4E4   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #D4E5   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #D4E6   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #D4E7   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #D4E8   ; Player X position (16-bit)
player_y            EQU #D4EA   ; Player Y position (16-bit)
player_runtime_enabled EQU #D4EC   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #D4ED   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #D4EE   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #D4EF   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #D4F0   ; Player health points
player_score        EQU #D4F1   ; Player score (16-bit)
gem_count           EQU #D4F3   ; Collectible tile counter (8-bit)
last_gem_char       EQU #D4F4   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #D4F5   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #D4F6   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #D536   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #D576   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #D5B6   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #D5F6   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #D606   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #D616   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #D626   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #D636   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #D646   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #D656   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #D657   ; Temporary 16-bit storage
temp_word_2         EQU #D659   ; Temporary 16-bit storage
temp_byte_1         EQU #D65B   ; Temporary 8-bit storage
temp_byte_2         EQU #D65C   ; Temporary 8-bit storage
temp_byte_3         EQU #D65D   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #D67D   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #D69D   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #D6BD   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #D6DD   ; 0=no SFX active, 1=playing
sfx_timer           EQU #D6DE   ; Frames remaining for current SFX
sfx_fadeout         EQU #D6DF   ; Reserved fadeout flag/state
temp_byte_7         EQU #D6E0   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #D700   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #D720   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #D740   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #D760   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #D780   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #D7A0   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #D7C0   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #D7E0   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #D800   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #D820   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #D840   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #D860   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #D880   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #D8A0   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #D8C0   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #D8E0   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #D900   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #D920   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #D940   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #D980   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #D9C0   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #D9E0   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #DA00   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #DA20   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #DA21   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #DA22   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #DA23   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #DA24   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #DA25   ; Cached entity X for wall checks
wall_temp_y         EQU #DA26   ; Cached entity Y for wall checks
wall_hit_left       EQU #DA27   ; Hitbox left edge cache
wall_hit_top        EQU #DA28   ; Hitbox top edge cache
wall_hit_right      EQU #DA29   ; Hitbox right edge cache
wall_hit_bottom     EQU #DA2A   ; Hitbox bottom edge cache
wall_hit_w          EQU #DA2B   ; Hitbox width cache (min 1)
wall_hit_h          EQU #DA2C   ; Hitbox height cache (min 1)
wall_probe_left     EQU #DA2D   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #DA2E   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #DA2F   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #DA30   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #DA31   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #DA51   ; Number of entries in active_entity_list
hero_entity_id      EQU #DA52   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #DA53   ; 1=rebuild active_entity_list required
input_entity_list   EQU #DA54   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #DA74   ; Number of entries in input_entity_list
render_entity_list  EQU #DA75   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #DA95   ; Number of entries in render_entity_list
collision_entity_list EQU #DA96   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #DAB6   ; Number of entries in collision_entity_list
ground_entity_list  EQU #DAB7   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #DAD7   ; Number of entries in ground_entity_list
anim_entity_list    EQU #DAD8   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #DAF8   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #DAF9   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #DB19   ; Number of entities in coll_list
coll_src_left       EQU #DB1A   ; Source AABB left edge (scratch)
coll_src_right      EQU #DB1B   ; Source AABB right edge (scratch)
coll_src_top        EQU #DB1C   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #DB1D   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #DB1E   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #DB1E   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #DB20   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #DB22   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #DB24   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #DB26   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #DB28   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #DB2A   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #DB2C   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #DB2E   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #DB2F   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #DB34   ; Frame counter (16-bit)
task_exec_time          EQU #DB36   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #DB38   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #DB39   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #DB39   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #DB3A   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #DB3B   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #DB3C   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #DB3D   ; 0=stopped, 1=track active
music_muted          EQU #DB3E   ; 0=audible, 1=muted/pause
music_loop           EQU #DB3F   ; 0=no loop, 1=loop enabled
music_track_index    EQU #DB40   ; Current ROM track index
...
; ==================================================================
PT3_SETUP       EQU #DB64   ; PT3 state flags (bit0=loop, bit7=song_ended)
PT3_MODADDR     EQU #DB65   ; Module address pointer (2 bytes)
PT3_CrPsPtr     EQU #DB67   ; Current position pointer
PT3_SAMPTRS     EQU #DB69   ; Sample pointers base
PT3_OrnPtrs     EQU #DB6B   ; Ornament pointers base
PT3_PDSP        EQU #DB6D   ; Pattern data start pointer
PT3_CSP         EQU #DB6F   ; Saved SP (CHREGS SP trick)
PT3_PSP         EQU #DB71   ; PT3 stack pointer save
PT3_PrNote      EQU #DB73   ; Previous note
PT3_PrSlide     EQU #DB74   ; Previous slide (2 bytes)
PT3_AdInPtA     EQU #DB76   ; Channel A inline pointer
PT3_AdInPtB     EQU #DB78   ; Channel B inline pointer
PT3_AdInPtC     EQU #DB7A   ; Channel C inline pointer
PT3_LPosPtr     EQU #DB7C   ; Loop position pointer
PT3_PatsPtr     EQU #DB7E   ; Patterns table pointer
PT3_Delay       EQU #DB80   ; Song speed/delay
PT3_AddToEn     EQU #DB81   ; Add to envelope
PT3_Env_Del     EQU #DB82   ; Envelope delay
PT3_ESldAdd     EQU #DB83   ; Envelope slide add (2 bytes)
PT3_NTL3        EQU #DB85   ; Note table link 3
VARS            EQU #DB87   ; Channel vars base
ChanA           EQU #DB87   ; Channel A data (29 bytes)
ChanB           EQU #DBA4   ; Channel B data (29 bytes)
ChanC           EQU #DBC1   ; Channel C data (29 bytes)
DelyCnt         EQU #DBDE   ; Delay counter
CurESld         EQU #DBDF   ; Current envelope slide (2 bytes)
CurEDel         EQU #DBE1   ; Current envelope delay
Ns_Base_AddToNs EQU #DBE2   ; Noise base + add to noise (combined)
Ns_Base         EQU #DBE2   ; Noise base
AddToNs         EQU #DBE3   ; Add to noise
NT_             EQU #DBE4   ; Note table (192 bytes)
AYREGS          EQU #DCA4  ; AY registers mirror (14 bytes)
VT_             EQU #DCA4  ; Volume table base (alias for AYREGS)
EnvBase         EQU #DCB2  ; Envelope base
VAR0END         EQU #DCB4  ; End of fixed workspace
T1_             EQU #DCB4  ; Tone tables start (unpacked by PT3_INIT)
T_NEW_1         EQU #DCB4  ; Tone table new 1
T_OLD_1         EQU #DCB4  ; Tone table old 1
T_OLD_2         EQU #DCCC  ; Tone table old 2
T_NEW_3         EQU #DCE4  ; Tone table new 3
T_OLD_3         EQU #DCE4  ; Tone table old 3
T_OLD_0         EQU #DCE6  ; Tone table old 0
T_NEW_0         EQU #DCE6  ; Tone table new 0
T_NEW_2         EQU #DCFE  ; Tone table new 2 (last, ends at +0x1B2)
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #DDA4   ; End of project variables (7588 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#DDA4: Project variables (7588 bytes)
;   #DDA4-#F37F: Free RAM (~5596 bytes available)
