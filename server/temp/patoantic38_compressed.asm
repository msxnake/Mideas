...
; BANK 03 @#0000 : sprites.asm (5992 bytes)
; BANK 03 @#1768 : font.asm (2200 bytes)
; BANK 04 @#0000 : font.asm (1347 bytes)
; BANK 04 @#0543 : hud.asm (3836 bytes)
; BANK 04 @#143F : menus.asm (444 bytes)
; BANK 04 @#15FB : sound.asm (2565 bytes)
; BANK 05 @#0000 : sound.asm (619 bytes)
; BANK 05 @#026B : scroll.asm (2353 bytes)
; BANK 05 @#0B9C : animtiles.asm (3349 bytes)
; BANK 05 @#18B1 : particles.asm (1871 bytes)
; BANK 06 @#0000 : particles.asm (3092 bytes)
; BANK 06 @#0C14 : statemachine.asm part 1/3 (5100 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 4/3 (2757 bytes)
; BANK 09 @#0AC5 : gameflow.asm part 1/3 (5435 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (3097 bytes)
