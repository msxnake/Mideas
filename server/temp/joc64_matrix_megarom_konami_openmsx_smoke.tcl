set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc64_matrix_megarom_konami_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc64_matrix_megarom_konami_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set flow [mem8 0xC11C]; set screen [mem8 0xE277]; set irq [mem16 0xE939]; set inirq [mem8 0xE93E]
    set px [mem16 0xE281]; set py [mem16 0xE283]
...
after time 12.0 { shot "joc64_matrix_megarom_konami_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "joc64_matrix_megarom_konami_t16.png" "t16" }
after time 22.0 { shot "joc64_matrix_megarom_konami_t22.png" "t22"; close $f; exit }
