...
; Bank 2 [#8000-#A000]: components_tail, gameflow (21005/8192 bytes est.)
...
; BANK 09 @#0000 : gameflow.asm part 4/3 (486 bytes); ==================================================================
...
; - gameflow: 15100 estimated bytes
