...
; Bank 5 [#6000-#8000]: gameflow_aux (6181/8192 bytes est.) [FAR — accessed via trampoline]
...
; BANK 09 @#0000 : gameflow.asm part 4/3 (821 bytes); ==================================================================
...
; - gameflow_aux: 6181 estimated bytes
...
;       "estimatedUsedBytes": 6181,
;       "estimatedFreeBytes": 2011,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "gameflow_aux",
