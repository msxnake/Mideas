set __rom "C:/Users/salam/Documents/Programacion/Mideas/server/temp/fakeplayer_dialog_top_fixed_unified.rom"
set __log "C:/Users/salam/Documents/Programacion/Mideas/server/temp/fakeplayer_dialog_top_probe.log"
...
after realtime 5 {
    ...
    dump_ram
    dump_nt_rows
    if {[catch {screenshot "C:/Users/salam/Documents/Programacion/Mideas/server/temp/fakeplayer_dialog_top_probe.png"} serr]} { logline "screenshot error $serr" } else { logline "screenshot ok" }
