...
; Estimated payload bytes: 111536
; Estimated banks used: 14
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (1139 bytes)
; BANK 00 @#0473 : colors.asm (1022 bytes)
; BANK 00 @#0871 : components.asm (22 bytes)
; BANK 00 @#0887 : entities.asm (5372 bytes)
; BANK 00 @#1D83 : worlds.asm (637 bytes)
; BANK 01 @#0000 : worlds.asm (3363 bytes)
; BANK 01 @#0D23 : screens.asm part 1/3 (4829 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (4505 bytes)
; BANK 03 @#1199 : sprites.asm part 1/2 (3687 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (6078 bytes)
; BANK 04 @#17BE : font.asm (2114 bytes)
; BANK 05 @#0000 : font.asm (1433 bytes)
; BANK 05 @#0599 : hud.asm (4339 bytes)
; BANK 05 @#168C : menus.asm (444 bytes)
; BANK 05 @#1848 : sound.asm (1976 bytes)
; BANK 06 @#0000 : sound.asm (1588 bytes)
; BANK 06 @#0634 : scroll.asm (2353 bytes)
; BANK 06 @#0F65 : animtiles.asm (4251 bytes)
; BANK 07 @#0000 : animtiles.asm (1665 bytes)
; BANK 07 @#0681 : particles.asm (4963 bytes)
; BANK 07 @#19E4 : statemachine.asm part 1/4 (1564 bytes)
...
; BANK 11 @#0000 : statemachine.asm part 5/4 (4447 bytes)
; BANK 11 @#115F : gameflow.asm part 1/3 (3745 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (5040 bytes)
...
entity_dir_mask     EQU #C77F   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #C79F   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #C7BF   ; Entity health (32 bytes)
entity_anim_frame   EQU #C7DF   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #C7FF   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #C81F   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #C83F   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #C85F   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C87F   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C89F   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C8BF   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C8DF   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #C8FF   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #C91F   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #C93F   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #C95F   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #C97F   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C99F   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C9BF   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C9DF   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C9FF   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #CA1F   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #CA3F   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #CA5F   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #CA7F   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #CA9F   ; Number of sprites currently active
sprites_dirty      EQU #CAA0   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #CAA1   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #CAC1   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #CAE1   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_attributes   EQU #CB01   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (5 screens detected)
; ==================================================================
current_screen_id   EQU #CB81   ; Currently displayed screen ID
screen_dirty_flag   EQU #CB82   ; Screen needs redraw flag
screen_transition_cooldown EQU #CB83   ; Cooldown frames after screen transition
current_world_id    EQU #CB84   ; Current world ID (for multi-world support)
current_screen_index EQU #CB85   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #CB86   ; Player X position (16-bit)
player_y            EQU #CB88   ; Player Y position (16-bit)
player_health       EQU #CB8A   ; Player health points
player_score        EQU #CB8B   ; Player score (16-bit)
gem_count           EQU #CB8D   ; Collectible tile counter (8-bit)
last_gem_char       EQU #CB8E   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #CB8F   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #CB90   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #CBD0   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #CC10   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #CC50   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #CC90   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #CCA0   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #CCB0   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #CCC0   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #CCD0   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #CCE0   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #CCF0   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #CCF1   ; Temporary 16-bit storage
temp_word_2         EQU #CCF3   ; Temporary 16-bit storage
temp_byte_1         EQU #CCF5   ; Temporary 8-bit storage
temp_byte_2         EQU #CCF6   ; Temporary 8-bit storage
temp_byte_3         EQU #CCF7   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #CD17   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #CD37   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #CD57   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #CD77   ; 0=no SFX active, 1=playing
sfx_timer           EQU #CD78   ; Frames remaining for current SFX
sfx_fadeout         EQU #CD79   ; Reserved fadeout flag/state
temp_byte_7         EQU #CD7A   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CD9A   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CDBA   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CDDA   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CDFA   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CE1A   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CE3A   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CE5A   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CE7A   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CE9A   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CEBA   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CEDA   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CEFA   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CF1A   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CF3A   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CF5A   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CF7A   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CF9A   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CFBA   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CFDA   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #D01A   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #D05A   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #D07A   ; Temporary 8-bit storage (32 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #D09A   ; Cached entity X for wall checks
wall_temp_y         EQU #D09B   ; Cached entity Y for wall checks
wall_hit_left       EQU #D09C   ; Hitbox left edge cache
wall_hit_top        EQU #D09D   ; Hitbox top edge cache
wall_hit_right      EQU #D09E   ; Hitbox right edge cache
wall_hit_bottom     EQU #D09F   ; Hitbox bottom edge cache
wall_hit_w          EQU #D0A0   ; Hitbox width cache (min 1)
wall_hit_h          EQU #D0A1   ; Hitbox height cache (min 1)
wall_probe_left     EQU #D0A2   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #D0A3   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #D0A4   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #D0A5   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #D0A6   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #D0C6   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #D0C7   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #D0C8   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #D0E8   ; Number of entities in coll_list
coll_src_left       EQU #D0E9   ; Source AABB left edge (scratch)
coll_src_right      EQU #D0EA   ; Source AABB right edge (scratch)
coll_src_top        EQU #D0EB   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #D0EC   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #D0ED   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #D0ED   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #D0EF   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #D0F1   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #D0F3   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #D0F5   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #D0F7   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #D0F9   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #D0FB   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #D0FD   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #D0FE   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #D103   ; Frame counter (16-bit)
task_exec_time          EQU #D105   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #D107   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #D108   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #D108   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #D109   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #D10A   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #D10B   ; Next sound frame pointer high byte

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D10C   ; End of project variables (4364 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D10C: Project variables (4364 bytes)
;   #D10C-#F37F: Free RAM (~8820 bytes available)
...
;   Active entities: 3
;   Used components: Position, Sprite, Input, Cursors, Gravity, WallCollision, Animation, Jump, StateMachine, Collision, comp_tile_collector, Patrol
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Input, Cursors, Gravity, WallCollision, Animation, Jump, StateMachine, Collision, comp_tile_collector, Patrol 
...
apply_collected_tiles:
    ld a, (collected_count)
    or a
    jp z, .apply_ct_after_persistent
...
.apply_ct_loop:
    ...
    jp nz, .apply_ct_skip          ; Different world - skip
    ...
    jp nz, .apply_ct_skip          ; Different screen - skip
...
.apply_ct_after_persistent:

    ; Re-hide timed bonus tiles that are still waiting to respawn on this screen.
    ld b, MAX_BONUS_RESPAWNS
    ld c, 0
.apply_bonus_respawn_loop:
    ld d, 0
    ld e, c
    ld hl, bonus_respawn_secs
    add hl, de
    ...
    ld a, (current_world_id)
    cp (hl)
    jp nz, .apply_bonus_respawn_next
...
.apply_bonus_respawn_next:
    inc c
    dec b
    jp nz, .apply_bonus_respawn_loop
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (120 -> 108 bytes)
    ...
    DB #02,#10,#BA,#00,#F7,#09,#20,#A1,#40,#00,#04,#01,#F8,#00,#10,#38
    DB #7C,#38,#DC,#7D,#FF,#A9,#FF,#A5,#FF,#F3,#55,#56
load_pattern_bank0:
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (120 -> 41 bytes)
    DB #8A,#41,#51,#FF,#FA,#F0,#F7,#FE,#E0,#E9,#F0,#BA,#C1,#FF,#31,#A2
    DB #C1,#8A,#81,#91,#A0,#A1,#4F,#9A,#7D,#70,#5B,#F1,#98,#FF,#71,#E1
    DB #F1,#A3,#61,#BD,#71,#81,#F1,#55,#56
load_color_bank0:
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #7A,#FD,#86,#E4,#80,#6B,#8D,#FC,#0D,#FF,#00,#5F,#0D,#F1,#FF,#00
    DB #77,#6E,#79,#80,#5F,#8B,#9E,#FC,#80,#57,#88,#CD,#00,#85,#32,#C6
    DB #1B,#8E,#C9,#FF,#BE,#3E,#FB,#C0,#7F,#76,#91,#38,#F7,#80,#65,#08
    DB #7D,#80,#EF,#F6,#80,#44,#F7,#C0,#F4,#F1,#FC,#EF,#C0,#F0,#EA,#40
    DB #86,#10,#A7,#82,#7E,#88,#A8,#78,#FE,#1E,#80,#1E,#FC,#F5,#80,#3F
    DB #FC,#D2,#80,#90,#86,#E5,#B0,#CD,#7E,#A3,#82,#C3,#80,#DE,#B0,#A0
    DB #0F,#FB,#8D,#80,#55,#56
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #85,#00,#56,#80,#10,#0F,#88,#57,#D4,#40,#F4,#C0,#68,#08,#57,#F5
    DB #D1,#00,#3C,#C0,#04,#CD,#C0,#66,#11,#11,#11,#47,#21,#F8,#1E,#C6
    DB #3C,#C0,#04,#D6,#90,#17,#CB,#EE,#08,#90,#90,#E5,#98,#F5,#C0,#5F
    DB #BA,#5E,#C1,#87,#08,#D1,#FE,#E1,#C0,#0D,#55,#56
SCREEN_PAN2_1_WIDTH     EQU 32
SCREEN_PAN2_1_HEIGHT    EQU 24
SCREEN_PAN2_1_SIZE      EQU 768

SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 86 bytes)
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#BA,#F5,#3A,#2A,#80,#94,#86,#4D
    DB #95,#46,#0F,#00,#55,#77,#46,#05,#23,#89,#8A,#DD,#FC,#D6,#5E,#3E
    DB #82,#83,#FC,#20,#8B,#8C,#3B,#E4,#D3,#84,#BD,#98,#40,#0E,#98,#F4
    DB #C0,#3B,#5C,#59,#02,#1E,#4F,#EF,#8A,#FA,#40,#CF,#32,#8D,#F0,#8F
    DB #BC,#FB,#9F,#E4,#4F,#6A,#E0,#8C,#F7,#F9,#B8,#7F,#F8,#BF,#F4,#FB
    DB #E4,#39,#FC,#D5,#55,#60
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #3D,#00,#55,#DD,#46,#05,#F4,#C4,#E0,#C0,#4F,#40,#43,#81,#C0,#6E
    DB #08,#CE,#43,#81,#FE,#1D,#55,#56
...
SCREEN_PAN3_3_LAYOUT:
    ; ZX0 compressed layout (768 -> 84 bytes)
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#82,#57,#8A,#C0,#86,#41,#B9,#82
    DB #F4,#BC,#83,#FC,#38,#80,#0A,#00,#54,#F5,#FE,#E0,#80,#41,#AC,#86
    DB #D4,#54,#E5,#80,#32,#EB,#93,#88,#D0,#80,#A4,#88,#5A,#82,#5F,#F4
    DB #F5,#E1,#97,#9A,#C7,#00,#F8,#2C,#56,#37,#00,#46,#24,#80,#81,#1B
    DB #86,#9F,#16,#F1,#80,#80,#D3,#84,#43,#68,#2D,#82,#79,#FC,#5E,#80
    DB #04,#D5,#55,#60
...
BEHAVIOR_PAN3_3_DATA:
    ; ZX0 compressed behavior (768 -> 50 bytes)
    DB #85,#00,#56,#95,#10,#7D,#82,#4E,#C0,#69,#08,#57,#C1,#58,#E4,#40
    DB #39,#C0,#10,#6B,#08,#35,#54,#3C,#C0,#00,#FF,#FE,#E0,#1E,#C0,#13
    DB #DD,#96,#C0,#40,#F5,#C0,#69,#08,#3D,#F1,#25,#82,#1E,#C0,#01,#35
    DB #55,#58
...
SCREEN_PAN4_4_LAYOUT:
    ...
    DB #DC,#E1,#80,#39,#C0,#3E,#E7,#80,#50,#7F,#EF,#80,#47,#F1,#EF,#80
    DB #A5,#86,#43,#E1,#ED,#00,#3E,#FD,#80,#1A,#88,#05,#FC,#FD,#80,#5D
    DB #75,#C0,#E9,#81,#82,#79,#FE,#1E,#81,#91,#80,#68,#00,#15,#F0,#C6
    DB #6E,#81,#80,#3C,#46,#0D,#B4,#26,#D0,#00,#DB,#26,#55,#55,#80
...
BEHAVIOR_PAN4_4_DATA:
    ...
    DB #C0,#3D,#34,#3D,#C0,#45,#F9,#EF,#C0,#46,#80,#08,#7D,#40,#57,#F4
    DB #FF,#C0,#1F,#FE,#78,#C0,#56,#80,#00,#43,#4D,#48,#4F,#C0,#57,#D5
    DB #FE,#D5,#55,#60
color_shift_table:
...
SM_SoundAsset_0_Frames:
    DB 232, 3, 10, 0, 0, 0, 0, 0, 0, 16, 62
    DB 232, 3, 10, 0, 0, 0, 0, 0, 0, 16, 62
    DB 232, 3, 10, 0, 0, 0, 0, 0, 0, 16, 62
    DB 19, 6, 10, 0, 0, 0, 0, 0, 0, 16, 62
    DB 19, 6, 10, 0, 0, 0, 0, 0, 0, 16, 62
    DB 19, 6, 10, 0, 0, 0, 0, 0, 0, 16, 62
    DB 19, 6, 10, 0, 0, 0, 0, 0, 0, 16, 62
    DB 19, 6, 10, 0, 0, 0, 0, 0, 0, 16, 62
...
; Free RAM buffer for tile pattern data decompression (120 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D800

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (120 bytes)
; ==================================================================
