...
; Estimated payload bytes: 133376
...
; BANK 10 @#0E86 : statemachine.asm part 1/4 (4474 bytes)
; BANK 11 @#0000 : statemachine.asm part 2/4 (8192 bytes)
; BANK 12 @#0000 : statemachine.asm part 3/4 (8192 bytes)
; BANK 13 @#0000 : statemachine.asm part 4/4 (8192 bytes)
; BANK 14 @#0000 : statemachine.asm part 5/4 (1306 bytes)
; BANK 14 @#051A : gameflow.asm part 1/3 (6886 bytes)
; BANK 15 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 16 @#0000 : gameflow.asm part 3/3 (2304 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (144 -> 125 bytes)
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (144 -> 51 bytes)
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 136 bytes)
    DB #95,#84,#69,#00,#56,#95,#84,#6A,#80,#E3,#81,#FC,#F1,#FB,#FC,#BB
    DB #88,#FE,#EF,#F0,#82,#48,#48,#84,#91,#90,#8E,#82,#83,#FD,#E5,#80
    DB #C0,#7D,#B8,#F4,#C0,#2B,#86,#C1,#80,#8F,#81,#81,#00,#46,#25,#83
    DB #83,#0D,#DE,#6E,#80,#57,#E7,#8B,#FC,#95,#80,#E2,#CD,#00,#85,#0C
...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 87 bytes)
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#BA,#F5,#3A,#2A,#80,#94,#86,#4D
...
BEHAVIOR_PAN2_1_DATA:
    ; ZX0 compressed behavior (768 -> 42 bytes)
...
SCREEN_PAN3_3_LAYOUT:
    ...
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#82,#57,#96,#C0,#81,#86,#29,#82
    DB #BB,#8D,#F5,#83,#C3,#FC,#95,#80,#A1,#00,#1F,#00,#57,#E0,#41,#FA
...
SCREEN_PAN4_4_LAYOUT:
    ; ZX0 compressed layout (768 -> 109 bytes)
    DB #85,#00,#56,#3C,#80,#81,#FC,#4F,#C3,#F1,#F9,#88,#7A,#FA,#FA,#82
    DB #40,#86,#14,#A2,#82,#B8,#82,#EE,#BC,#83,#FC,#38,#80,#0F,#2B,#70
    DB #DC,#F5,#80,#A3,#8D,#93,#C0,#E5,#E7,#80,#5A,#00,#55,#A0,#8D,#7F
    DB #EF,#80,#47,#F1,#EF,#00,#A4,#86,#F5,#80,#28,#8D,#53,#F8,#C0,#80
    DB #0F,#FD,#86,#00,#81,#88,#7E,#FD,#80,#06,#8D,#8D,#65,#C0,#3A,#81
    DB #82,#07,#91,#BA,#E3,#40,#94,#80,#A5,#00,#A5,#8D,#5F,#C6,#06,#E3
...
; Free RAM buffer for tile pattern data decompression (144 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #DA00

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (144 bytes)
; ==================================================================
