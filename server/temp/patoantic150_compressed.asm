...
; BANK 01 @#0000 : entities.asm (1327 bytes)
; BANK 01 @#052F : worlds.asm (3978 bytes)
; BANK 01 @#14B9 : screens.asm part 1/3 (2887 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (6528 bytes)
; BANK 03 @#1980 : sprites.asm part 1/2 (1664 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 05 @#0000 : sprites.asm part 3/2 (1154 bytes)
; BANK 05 @#0482 : font.asm (3547 bytes)
; BANK 05 @#125D : hud.asm (3491 bytes)
; BANK 06 @#0000 : hud.asm (976 bytes)
; BANK 06 @#03D0 : menus.asm (168 bytes)
; BANK 06 @#0478 : sound.asm part 1/2 (7048 bytes)
; BANK 07 @#0000 : sound.asm part 2/2 (2490 bytes)
; BANK 07 @#09BA : scroll.asm (2353 bytes)
; BANK 07 @#12EB : animtiles.asm (3349 bytes)
; BANK 08 @#0000 : animtiles.asm (3538 bytes)
; BANK 08 @#0DD2 : particles.asm (4654 bytes)
; BANK 09 @#0000 : particles.asm (309 bytes)
; BANK 09 @#0135 : statemachine.asm part 1/2 (7883 bytes)
; BANK 10 @#0000 : statemachine.asm part 2/2 (7734 bytes)
; BANK 10 @#1E36 : gameflow.asm (458 bytes)
; BANK 11 @#0000 : gameflow.asm (5058 bytes)
...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 98 bytes)
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#BA,#F5,#3A,#2A,#80,#94,#86,#4D
    DB #80,#C0,#3D,#C0,#4A,#82,#55,#8E,#89,#8A,#FC,#F1,#00,#79,#FE,#55
    DB #37,#76,#DF,#3D,#FC,#77,#5E,#49,#F8,#8D,#82,#83,#FC,#80,#8B,#8C
    DB #EF,#E4,#84,#4E,#98,#F4,#40,#3B,#98,#D0,#C0,#FB,#5C,#86,#24,#0E
    DB #76,#D8,#88,#8A,#81,#36,#B8,#78,#F5,#9F,#90,#91,#FB,#9F,#E4,#4F
    DB #6A,#E0,#8C,#F7,#F9,#B8,#7F,#F9,#C1,#BF,#F4,#FB,#E4,#39,#FC,#D5
    DB #55,#60
...
BEHAVIOR_PAN2_1_DATA:
    ; ZX0 compressed behavior (768 -> 47 bytes)
    DB #85,#00,#56,#95,#10,#7F,#BA,#D4,#3A,#AA,#10,#08,#51,#3D,#8C,#0E
    DB #06,#05,#DD,#40,#57,#95,#FE,#53,#74,#5E,#2D,#08,#D5,#1E,#C8,#FA
    DB #07,#81,#C0,#6C,#08,#85,#0E,#3C,#D6,#38,#C0,#53,#55,#55,#80
