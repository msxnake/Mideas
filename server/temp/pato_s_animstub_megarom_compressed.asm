...
; Bank 4 [#6000-#8000]: screens_code (14827/8192 bytes est.) [FAR — accessed via trampoline]
...
; Bank 10 [#6000-#8000]: animtiles (4143/8192 bytes est.) [FAR — accessed via trampoline]
...
; Estimated payload bytes: 136515
...
; BANK 10 @#0000 : screens.asm part 3/2 (1542 bytes)
; BANK 10 @#0606 : sprites.asm part 1/2 (6650 bytes)
; BANK 11 @#0000 : sprites.asm part 2/2 (1693 bytes)
; BANK 11 @#069D : font.asm (3576 bytes)
; BANK 11 @#1495 : hud.asm (2923 bytes)
; BANK 12 @#0000 : hud.asm (717 bytes)
; BANK 12 @#02CD : menus.asm (168 bytes)
; BANK 12 @#0375 : sound.asm (4418 bytes)
; BANK 12 @#14B7 : scroll.asm (2353 bytes)
; BANK 12 @#1DE8 : animtiles.asm (536 bytes)
; BANK 13 @#0000 : animtiles.asm (3607 bytes)
; BANK 13 @#0E17 : bosses.asm (4585 bytes)
; BANK 14 @#0000 : bosses.asm (1081 bytes)
; BANK 14 @#0439 : statemachine.asm part 1/2 (7111 bytes)
; BANK 15 @#0000 : statemachine.asm part 2/2 (7969 bytes)
; BANK 15 @#1F21 : gameflow.asm (223 bytes)
; BANK 16 @#0000 : gameflow.asm (5443 bytes); ==================================================================
...
;
; Retained modules:
; - animtiles: 4143 estimated bytes
...
; - screens_code: 14827 estimated bytes
