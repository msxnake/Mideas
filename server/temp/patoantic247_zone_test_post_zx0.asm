...
ZX0_SPRITE_FRAME_PANELL_2_F0_DATA:
    ; ZX0 compressed sprite frame PANELL_2_F0 (32 -> 23 bytes)
    DB #86,#00,#28,#FF,#80,#80,#FF,#00,#86,#80,#C0,#E0,#B0,#18,#86,#B0
    DB #E0,#C0,#80,#00,#35,#55,#58
...
ZX0_SPRITE_FRAME_CAPCUADRAT1_RIGHT_9_F0_DATA:
    ; ZX0 compressed sprite frame CAPCUADRAT1_RIGHT_9_F0 (32 -> 31 bytes)
    DB #49,#00,#07,#0F,#1F,#1D,#3B,#82,#1D,#0F,#07,#03,#61,#28,#00,#80
    DB #E0,#F0,#F8,#98,#F8,#F0,#C0,#F0,#8B,#E0,#00,#C0,#55,#55,#80
...
ZX0_SPRITE_FRAME_CAPCUADRAT1_LEFT_17_F0_DATA:
    ; ZX0 compressed sprite frame CAPCUADRAT1_LEFT_17_F0 (32 -> 30 bytes)
    DB #12,#00,#01,#07,#0F,#1F,#19,#1F,#0F,#03,#0F,#88,#07,#00,#96,#03
    DB #00,#E0,#F0,#F8,#B8,#DC,#60,#9D,#B8,#F0,#E0,#C0,#55,#56
...
; Total data bytes (post-ZX0 / final): 6206
; Zones used: 1
; ------------------------------------------------------------------
; ZONE 00 [#22000-#24000] bank 15 used=6206 slack=1986
;   + tile_pattern_bank0, tilebank_pattern_data_0 @ +#0000 size=563
;   + tile_color_bank0, tilebank_color_data_0 @ +#0233 size=399
;   + SCREEN_PAN1_0_LAYOUT @ +#03C2 size=174
;   + SCREEN_PAN1_0_EFFECTS_LAYOUT @ +#0470 size=6
;   + SCREEN_PAN1_0_EFFECT_ZONE_TABLE @ +#0476 size=1
;   + BEHAVIOR_PAN1_0_DATA @ +#0477 size=77
;   + SCREEN_PAN2_1_LAYOUT @ +#04C4 size=128
;   + SCREEN_PAN2_1_EFFECTS_LAYOUT @ +#0544 size=6
;   + SCREEN_PAN2_1_EFFECT_ZONE_TABLE @ +#054A size=1
;   + BEHAVIOR_PAN2_1_DATA @ +#054B size=69
;   + SCREEN_BACKGROUND1_2_LAYOUT @ +#0590 size=10
;   + SCREEN_BACKGROUND1_2_EFFECTS_LAYOUT @ +#059A size=6
;   + SCREEN_BACKGROUND1_2_EFFECT_ZONE_TABLE @ +#05A0 size=1
;   + BEHAVIOR_BACKGROUND1_2_DATA @ +#05A1 size=6
;   + SCREEN_PAN3_3_LAYOUT @ +#05A7 size=103
;   + SCREEN_PAN3_3_EFFECTS_LAYOUT @ +#060E size=6
;   + SCREEN_PAN3_3_EFFECT_ZONE_TABLE @ +#0614 size=1
;   + BEHAVIOR_PAN3_3_DATA @ +#0615 size=60
;   + SCREEN_PAN4_4_LAYOUT @ +#0651 size=129
;   + SCREEN_PAN4_4_EFFECTS_LAYOUT @ +#06D2 size=6
;   + SCREEN_PAN4_4_EFFECT_ZONE_TABLE @ +#06D8 size=1
;   + BEHAVIOR_PAN4_4_DATA @ +#06D9 size=74
;   + SCREEN_PAN5_5_LAYOUT @ +#0723 size=157
;   + SCREEN_PAN5_5_EFFECTS_LAYOUT @ +#07C0 size=132
;   + SCREEN_PAN5_5_EFFECT_ZONE_TABLE @ +#0844 size=8
;   + BEHAVIOR_PAN5_5_DATA @ +#084C size=67
;   + SCREEN_PAN6_6_LAYOUT @ +#088F size=122
;   + SCREEN_PAN6_6_EFFECTS_LAYOUT @ +#0909 size=6
;   + SCREEN_PAN6_6_EFFECT_ZONE_TABLE @ +#090F size=1
;   + BEHAVIOR_PAN6_6_DATA @ +#0910 size=73
;   + SCREEN_PAN1_2_7_LAYOUT @ +#0959 size=62
;   + SCREEN_PAN1_2_7_EFFECTS_LAYOUT @ +#0997 size=6
;   + SCREEN_PAN1_2_7_EFFECT_ZONE_TABLE @ +#099D size=1
;   + BEHAVIOR_PAN1_2_7_DATA @ +#099E size=13
;   + FONT_PATTERN_DATA @ +#09AB size=215
;   + FONT_COLOR_DATA @ +#0A82 size=25
;   + PRESENTATION_SCREEN_NAMETBL @ +#0A9B size=260
;   + PRESENTATION_SCREEN_PATTERNS_B0 @ +#0B9F size=461
;   + PRESENTATION_SCREEN_PATTERNS_B1 @ +#0D6C size=992
;   + PRESENTATION_SCREEN_PATTERNS_B2 @ +#114C size=291
;   + PRESENTATION_SCREEN_COLORS_B0 @ +#126F size=368
;   + PRESENTATION_SCREEN_COLORS_B1 @ +#13DF size=835
;   + PRESENTATION_SCREEN_COLORS_B2 @ +#1722 size=284

    org #22000
; ==================================================================
; DATA ZONE 00 (bank 15) used=6206 slack=1986
; ==================================================================
; ==================================================================
...
tile_color_bank0:
    ; ZX0 compressed tile_color (304 -> 95 bytes)
    ...
    DB #77,#C0,#CF,#F0,#F7,#FF,#F8,#F4,#CD,#E2,#D5,#70,#D5,#55,#60
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #84,#FF,#5B,#9B,#A6,#F3,#9C,#8E,#9D,#FC,#41,#98,#80,#80,#81,#7F
    DB #FB,#FC,#18,#8F,#88,#90,#F0,#BC,#82,#88,#48,#EF,#82,#83,#FD,#80
    ...
    DB #91,#FF,#B3,#F4,#F8,#0E,#38,#5B,#88,#FC,#FE,#2C,#33,#C0,#52,#90
    DB #83,#3D,#80,#6D,#89,#D6,#65,#C8,#79,#C0,#0E,#D1,#80,#8B,#E0,#B4
    DB #D6,#80,#28,#83,#12,#19,#9A,#96,#97,#98,#82,#7D,#5C,#7E,#FE,#9E
    DB #99,#80,#26,#88,#90,#90,#FF,#F8,#C0,#5E,#FA,#EA,#80,#85,#D3,#B8
...
SCREEN_PAN2_1_LAYOUT:
    ...
    DB #54,#E0,#00,#E5,#6A,#F4,#54,#7B,#97,#91,#DA,#EA,#91,#DC,#30,#4F
...
SCREEN_PAN4_4_LAYOUT:
    ...
    DB #FF,#66,#8D,#82,#83,#16,#96,#8D,#24,#94,#95,#7D,#D1,#96,#56,#2F
    DB #89,#8A,#FB,#DA,#80,#FF,#17,#C9,#E0,#FE,#8B,#8C,#82,#FB,#00,#91
    DB #82,#F6,#EF,#80,#43,#F8,#80,#6E,#4E,#81,#95,#86,#77,#80,#5F,#EF
    DB #D3,#C0,#F4,#7B,#80,#BE,#91,#FF,#78,#0B,#88,#FD,#BA,#00,#3F,#FC
...
SCREEN_PAN5_5_EFFECTS_LAYOUT:
    ...
    DB #D6,#ED,#5D,#11,#61,#00,#FA,#F0,#88,#09,#FF,#88,#90,#88,#F5,#F9
...
SCREEN_PAN6_6_LAYOUT:
    ...
    DB #90,#88,#43,#DF,#78,#80,#45,#F7,#78,#D4,#80,#3D,#78,#73,#80,#15
    DB #A1,#8D,#42,#F7,#86,#E4,#FC,#EC,#E8,#63,#89,#91,#D6,#FF,#2C,#2E
...
SCREEN_PAN1_2_7_LAYOUT:
    ...
    DB #81,#FF,#45,#1B,#86,#F4,#FB,#FC,#82,#80,#81,#89,#8A,#44,#96,#9E
    DB #9F,#82,#83,#8B,#A2,#A3,#5F,#FB,#F4,#F9,#FC,#8E,#A1,#80,#D7,#63
    DB #A4,#A5,#A4,#FE,#F9,#FD,#FB,#F4,#FF,#EB,#E8,#FF,#D4,#FC,#FB,#81
    DB #F9,#B2,#FC,#DE,#FC,#EE,#B6,#F4,#39,#E4,#B5,#A1,#55,#58
...
BEHAVIOR_PAN1_2_7_DATA:
    ; ZX0 compressed behavior (768 -> 13 bytes)
    DB #81,#00,#45,#18,#80,#08,#00,#29,#10,#55,#75,#55,#58
...
; ==================================================================
ZX0_SPRITE_FRAME_BUFFER EQU #DE00
...
CAPCUADRAT1_RIGHT_9_F0_LAYER3 EQU ZX0_SPRITE_FRAME_CAPCUADRAT1_RIGHT_9_F0_DATA
...
CAPCUADRAT1_LEFT_17_F0_LAYER3 EQU ZX0_SPRITE_FRAME_CAPCUADRAT1_LEFT_17_F0_DATA
