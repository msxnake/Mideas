...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (120 -> 71 bytes)
    DB #69,#FF,#00,#7F,#A6,#78,#03,#FB,#F0,#07,#F7,#88,#00,#FF,#8E,#38
    DB #81,#E1,#49,#7C,#01,#FD,#FD,#00,#F7,#23,#7E,#42,#F9,#FF,#F9,#FF
    DB #99,#81,#3C,#7E,#FB,#3C,#81,#00,#F1,#D4,#AF,#EF,#00,#ED,#BF,#C1
    DB #AB,#83,#EE,#E8,#F0,#F9,#3C,#66,#B5,#FB,#EB,#66,#5A,#5A,#F6,#42
    DB #BD,#FB,#3C,#50,#5D,#55,#56
load_pattern_bank0:
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (120 -> 30 bytes)
    DB #95,#61,#69,#A1,#68,#B1,#AA,#F1,#B1,#7E,#F7,#F2,#78,#FE,#89,#81
    DB #F1,#26,#C1,#F1,#41,#0A,#51,#1E,#EA,#3D,#50,#5D,#55,#56
load_color_bank0:
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (432 -> 131 bytes)
    DB #95,#FF,#8E,#80,#81,#FD,#F9,#82,#F0,#AF,#FF,#85,#FF,#8E,#FF,#FD
    DB #E0,#C0,#7A,#EA,#9F,#83,#D0,#89,#89,#80,#FF,#A0,#F0,#7D,#FC,#AB
    DB #84,#87,#F0,#F9,#8A,#FF,#61,#84,#9F,#EE,#58,#0A,#8A,#2F,#8C,#60
    DB #69,#83,#A9,#87,#9A,#8C,#8E,#8E,#8E,#42,#F9,#8C,#D9,#50,#88,#82
    DB #83,#FC,#F3,#F8,#F7,#EE,#E1,#7D,#DE,#EA,#3C,#87,#4F,#AB,#F7,#F9
    DB #50,#DB,#F0,#84,#97,#9A,#FC,#BE,#DE,#E5,#80,#DC,#62,#3D,#8E,#F1
    DB #CE,#E8,#41,#87,#3D,#FD,#87,#4C,#FF,#FD,#E0,#72,#7D,#E0,#F7,#50
    DB #DD,#E0,#C7,#C0,#C9,#FD,#E8,#7F,#E0,#F9,#E4,#E0,#76,#80,#5F,#E0
    DB #D5,#55,#60
SCREEN_PAN1_0_BLOCK_MAP:
    ; ZX0 compressed screen_block_map (48 -> 42 bytes)
    DB #96,#00,#21,#01,#02,#94,#A3,#03,#04,#00,#05,#00,#06,#00,#07,#08
    DB #09,#0A,#0B,#0C,#00,#0D,#0E,#94,#E1,#D5,#0F,#10,#11,#12,#00,#0E
    DB #13,#14,#15,#16,#17,#18,#19,#1A,#55,#60
...
ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F1_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_LEFT_0_F1 (32 -> 31 bytes)
    DB #A0,#00,#22,#03,#04,#03,#05,#03,#21,#1B,#03,#66,#43,#78,#00,#02
    DB #80,#40,#A0,#D8,#80,#04,#B8,#80,#67,#7C,#04,#00,#55,#55,#80
...
ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_3_F0_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_RIGHT_3_F0 (32 -> 31 bytes)
    DB #4E,#00,#01,#02,#05,#0B,#09,#F5,#0B,#05,#09,#11,#01,#E2,#FF,#FD
    DB #C0,#20,#AA,#A0,#80,#9F,#D0,#CC,#C0,#F5,#B5,#FF,#C0,#55,#58
ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_3_F1_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_RIGHT_3_F1 (32 -> 31 bytes)
    DB #A0,#00,#26,#01,#02,#05,#1B,#01,#20,#1D,#01,#62,#3E,#20,#00,#02
    DB #C0,#20,#C0,#A0,#C0,#84,#D8,#C0,#26,#C2,#1E,#00,#D5,#55,#60
ZX0_SPRITE_FRAME_DATA_END_LABEL:
    DB #00

; ==================================================================
; ZX0 SPRITE FRAME BUFFER (AUTO-INJECTED)
; Shared RAM buffer for per-frame sprite decompression before VRAM upload (32 bytes)
; ==================================================================
