...
; Estimated payload bytes: 154616
...
; BANK 01 @#12E1 : entities.asm part 1/2 (3359 bytes)
; BANK 02 @#0000 : entities.asm part 2/2 (5965 bytes)
; BANK 02 @#174D : worlds.asm part 1/2 (2227 bytes)
; BANK 03 @#0000 : worlds.asm part 2/2 (6441 bytes)
; BANK 03 @#1929 : screens.asm part 1/7 (1751 bytes)
...
; BANK 09 @#0000 : screens.asm part 7/7 (8192 bytes)
; BANK 10 @#0000 : screens.asm part 8/7 (1073 bytes)
; BANK 10 @#0431 : sprites.asm part 1/2 (7119 bytes)
; BANK 11 @#0000 : sprites.asm part 2/2 (5957 bytes)
; BANK 11 @#1745 : font.asm (1861 bytes)
; BANK 11 @#1E8A : hud.asm (374 bytes)
; BANK 12 @#0000 : hud.asm (3916 bytes)
; BANK 12 @#0F4C : menus.asm (454 bytes)
; BANK 12 @#1112 : sound.asm part 1/2 (3822 bytes)
; BANK 13 @#0000 : sound.asm part 2/2 (5726 bytes)
; BANK 13 @#165E : scroll.asm (2353 bytes)
; BANK 13 @#1F8F : animtiles.asm (113 bytes)
; BANK 14 @#0000 : animtiles.asm (6126 bytes)
; BANK 14 @#17EE : statemachine.asm part 1/3 (2066 bytes)
; BANK 15 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 16 @#0000 : statemachine.asm part 3/3 (7923 bytes)
; BANK 16 @#1EF3 : gameflow.asm part 1/2 (269 bytes)
; BANK 17 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 18 @#0000 : gameflow.asm part 3/2 (7160 bytes)
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E9E0   ; End of project variables (10720 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E9E0: Project variables (10720 bytes)
;   #E9E0-#F37F: Free RAM (~2464 bytes available)
...
SCREEN_PAN6_5_BEHAVIOR_SOURCE EQU 0
BEHAVIOR_PAN6_5_DATA_BANK EQU ((BEHAVIOR_PAN6_5_DATA - #4000) / #2000)
SCREEN_PAN6_5_CHAR_BEHAVIOR_TABLE_BANK EQU 0
SCREEN_PAN6_5_CHAR_BEHAVIOR_TABLE_SIZE EQU 0
SCREEN_PAN6_5_INTERACTION_TYPE_MAP_BANK EQU ((SCREEN_PAN6_5_INTERACTION_TYPE_MAP - #4000) / #2000)
SCREEN_PAN6_5_INTERACTION_VALUE_MAP_BANK EQU ((SCREEN_PAN6_5_INTERACTION_VALUE_MAP - #4000) / #2000)
SCREEN_PAN6_5_INTERACTION_TARGET_MAP_BANK EQU ((SCREEN_PAN6_5_INTERACTION_TARGET_MAP - #4000) / #2000)
...
SCREEN_PAN6_5_BLOCK_LAYOUT_PRESENT EQU 0
SCREEN_PAN6_5_BLOCK_LAYOUT_MODE EQU 0
SCREEN_PAN6_5_BLOCK_CATALOG_BANK EQU 0
SCREEN_PAN6_5_BLOCK_CATALOG_COUNT EQU 0
SCREEN_PAN6_5_BLOCK_CATALOG_SIZE EQU 0
SCREEN_PAN6_5_BLOCK_MAP_BANK EQU 0
SCREEN_PAN6_5_BLOCK_MAP_WIDTH EQU 0
SCREEN_PAN6_5_BLOCK_MAP_HEIGHT EQU 0
SCREEN_PAN6_5_BLOCK_MAP_SIZE EQU 0
SCREEN_PAN6_5_BLOCK_TOTAL_SIZE EQU 0
...
.load_pan6_773382451315_tilebank_ready:
    ...
    ld hl, SCREEN_PAN6_5_INTERACTION_TYPE_MAP
    ld de, runtime_interaction_type_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, SCREEN_PAN6_5_INTERACTION_VALUE_MAP
    ld de, runtime_interaction_value_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, SCREEN_PAN6_5_INTERACTION_TARGET_MAP
    ld de, runtime_interaction_target_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir
...
; ==================================================================
ZX0_SPRITE_FRAME_BUFFER EQU #EE00
