...
; ------------------------------------------------------------------
; Bank 1 [#6000-#8000]: components (45535/8192 bytes est.)
...
; Bank 7 [#6000-#8000]: entities (5025/8192 bytes est.) [FAR — accessed via trampoline]
...
; BANK 06 @#0000 : components.asm part 7/7 (3576 bytes)
; BANK 06 @#0DF8 : entities.asm (4616 bytes)
; BANK 07 @#0000 : entities.asm (409 bytes)
; BANK 07 @#0199 : worlds.asm (1526 bytes)
; BANK 07 @#078F : screens.asm (5697 bytes)
; BANK 07 @#1DD0 : sprites.asm (560 bytes)
; BANK 08 @#0000 : sprites.asm (2538 bytes)
; BANK 08 @#09EA : font.asm (177 bytes)
; BANK 08 @#0A9B : hud.asm (114 bytes)
; BANK 08 @#0B0D : menus.asm (219 bytes)
; BANK 08 @#0BE8 : sound.asm (4769 bytes)
; BANK 08 @#1E89 : scroll.asm (375 bytes)
; BANK 09 @#0000 : scroll.asm (2032 bytes)
; BANK 09 @#07F0 : animtiles.asm (2586 bytes)
; BANK 09 @#120A : bosses.asm (3574 bytes)
; BANK 10 @#0000 : bosses.asm (2678 bytes)
; BANK 10 @#0A76 : statemachine.asm (5514 bytes)
; BANK 11 @#0000 : statemachine.asm (2558 bytes)
; BANK 11 @#09FE : gameflow.asm (5579 bytes); ==================================================================
...
; - components: 45535 estimated bytes
; - components_tail: 5444 estimated bytes
; - entities: 5025 estimated bytes
...
;       "estimatedUsedBytes": 5025,
;       "estimatedFreeBytes": 3167,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "entities",
