...
; BANK 04 @#0000 : statemachine.asm part 3/3 (6505 bytes)
; BANK 04 @#1969 : gameflow.asm (1687 bytes)
; BANK 05 @#0000 : gameflow.asm (2968 bytes)
...
temp_byte_25        EQU #CDE4   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CE04   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #CE44   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #CE84   ; Cached entity X for wall checks
wall_temp_y         EQU #CE85   ; Cached entity Y for wall checks

; Unified update helpers
active_entity_list  EQU #CE86   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #CEA6   ; Number of entries in active_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #CEA7   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #CEC7   ; Number of entities in coll_list
coll_src_left       EQU #CEC8   ; Source AABB left edge (scratch)
coll_src_right      EQU #CEC9   ; Source AABB right edge (scratch)
coll_src_top        EQU #CECA   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #CECB   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #CECC   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #CECC   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #CECE   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #CED0   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #CED2   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #CED4   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #CED6   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #CED8   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #CEDA   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #CEDC   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #CEDD   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #CEE2   ; Frame counter (16-bit)
task_exec_time          EQU #CEE4   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #CEE6   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #CEE7   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #CEE7   ; End of project variables (3815 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#CEE7: Project variables (3815 bytes)
;   #CEE7-#F37F: Free RAM (~9369 bytes available)
...
; [worlds.asm skipped - no WorldMaps]
