...
; BANK 02 @#0000 : font.asm (1601 bytes)
; BANK 02 @#0641 : hud.asm (3480 bytes)
; BANK 02 @#13D9 : menus.asm (168 bytes)
; BANK 02 @#1481 : sound.asm part 1/2 (2943 bytes)
; BANK 03 @#0000 : sound.asm part 2/2 (6598 bytes)
; BANK 03 @#19C6 : scroll.asm (1594 bytes)
; BANK 04 @#0000 : scroll.asm (759 bytes)
; BANK 04 @#02F7 : animtiles.asm (4613 bytes)
; BANK 04 @#14FC : statemachine.asm (5 bytes)
; BANK 04 @#1501 : gameflow.asm (2815 bytes)
; BANK 05 @#0000 : gameflow.asm (3206 bytes)
...
tile_pattern_bank0:
    ...
    DB #09,#FF,#F7,#E7,#F7,#A9,#FF,#26,#E3,#FD,#F3,#EF,#F1,#FF,#0A,#87
    DB #FB,#E7,#FB,#69,#C7,#FF,#BF,#88,#B7,#87,#F7,#8F,#7E,#42,#F8,#D5
    DB #55,#60
load_pattern_bank0:
...
tilebank_pattern_data_0:
    db #FF, #F7, #E7, #F7, #F7, #F7, #F7, #FF, #FF, #E3, #FD, #F3, #EF, #F1, #FF, #FF
    db #FF, #FF, #87, #FB, #E7, #FB, #FB, #C7, #FF, #BF, #BF, #B7, #87, #F7, #F7, #F7
