...
NEW_SPRITE_2_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #1A,#3D,#3F,#7F,#73,#77,#7E,#7F,#3F,#3F,#5B,#7C,#7F,#3F,#1F,#00
    DB #A8,#5C,#FE,#FE,#CE,#DE,#7E,#FE,#FD,#FB,#DF,#3F,#FE,#FE,#FC,#00

;; ---- End of Frame: New Sprite_2_F0 ----


; Unified pattern label for sprite 2
SPRITE_2_PATTERN EQU NEW_SPRITE_2_F0_LAYER3

; Sprite Asset 3: anec_left
;; Sprite: anec_left
;; Total Frames: 2
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_ANEC_LEFT_3_WIDTH     EQU 16
SPRITE_ANEC_LEFT_3_HEIGHT    EQU 16
SPRITE_ANEC_LEFT_3_FRAMES    EQU 2

;; ---- Sprite Frame: anec_left_3_F0 ----
;; Size: 16x16
ANEC_LEFT_3_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#03,#0D,#0B,#1A,#3B,#EF,#07,#02,#00,#07,#1F,#1F,#0F,#10,#28
    DB #00,#00,#80,#80,#C0,#40,#C0,#80,#00,#00,#00,#90,#70,#E0,#20,#50

ANEC_LEFT_3_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #42EBF5)
    DB #00,#00,#00,#04,#05,#04,#00,#00,#00,#07,#18,#20,#20,#10,#00,#10
    DB #00,#00,#00,#00,#00,#80,#00,#02,#06,#0C,#98,#68,#88,#10,#00,#20

ANEC_LEFT_3_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: anec_left_3_F0 ----

;; ---- Sprite Frame: anec_left_3_F1 ----
;; Size: 16x16
ANEC_LEFT_3_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#03,#0D,#0B,#1A,#3B,#EF,#07,#02,#00,#07,#1E,#1F,#0F,#02,#05
    DB #00,#00,#80,#80,#C0,#40,#C0,#80,#00,#04,#08,#90,#70,#C0,#00,#00

ANEC_LEFT_3_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #42EBF5)
    DB #00,#00,#00,#04,#05,#04,#00,#00,#00,#07,#18,#21,#20,#10,#00,#02
    DB #00,#00,#00,#00,#00,#80,#00,#00,#07,#0B,#94,#68,#80,#20,#00,#00

ANEC_LEFT_3_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: anec_left_3_F1 ----


; Unified pattern label for sprite 3
SPRITE_3_PATTERN EQU ANEC_LEFT_3_F0_LAYER1
...
SPRITE_2_FRAME_PTRS:
    dw NEW_SPRITE_2_F0_LAYER3

; Sprite 3: anec_left frame pointers
SPRITE_3_FRAME_PTRS:
    dw ANEC_LEFT_3_F0_LAYER1
    dw ANEC_LEFT_3_F1_LAYER1
...
entity_sprite_config: 
    ...
    db 3, 1 ; Entity 2 (New Sprite)
    db 4, 2 ; Entity 3 (anec_right)
    ds 56, 0 ; Padding
...
ENTITY_PATO_2_COMP_MASK EQU #87  ; Component mask: 10000111b
; Template: tpl_1770837237607_l05j9
ENTITY_PATO_2_X EQU 22
ENTITY_PATO_2_Y EQU 14

; Entity: pato 2 (instance from template: tpl_1770837237607_l05j9)
ENTITY_PATO_2_2_ID EQU 3
ENTITY_PATO_2_2_COMP_MASK EQU #87  ; Component mask: 10000111b
; Template: tpl_1770837237607_l05j9
ENTITY_PATO_2_2_X EQU 21
ENTITY_PATO_2_2_Y EQU 14
...
init_pato_2:
    ...
    ; === Patrol Component Init ===
    ; Waypoints: (168, 112) -> (240, 112)
    ; Override position with waypoint1
    ld hl, entity_x_pos
    add hl, de
    ld (hl), 168         ; Start X = waypoint1_x

    ld hl, entity_y_pos
    add hl, de
    ld (hl), 112         ; Start Y = waypoint1_y
...
init_pato_2_2:
    ; Initialize pato 2 at real position from JSON
    ; JSON position: (21, 14) tiles = (168, 112) pixels
    ; Template: tpl_1770837237607_l05j9
    ; Components: Position, Sprite, Movement, Animation
    ; Direction mask: #0F (1111b) = All directions
