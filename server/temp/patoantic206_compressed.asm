...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 160 bytes)
    ...
    DB #FF,#B3,#F4,#F8,#0E,#38,#5B,#88,#FC,#FE,#2C,#35,#D1,#C0,#FD,#85
    DB #C0,#1F,#81,#84,#C0,#7F,#F1,#FC,#4F,#D8,#3A,#40,#E4,#86,#10,#37
    DB #88,#3D,#A8,#F5,#FE,#E2,#80,#6F,#88,#92,#92,#F8,#E4,#80,#6B,#85
    DB #4F,#B8,#4C,#B0,#F4,#80,#A6,#86,#80,#85,#FE,#30,#D8,#DC,#C0,#2F
    DB #82,#FB,#C3,#80,#2F,#44,#B5,#92,#FC,#F8,#80,#FB,#D0,#D5,#55,#60
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #08,#10,#55,#F1,#C0,#5D,#D1,#80,#F8,#D3,#C0,#03,#80,#AC,#BF,#20
    DB #FF,#E2,#BE,#04,#FF,#94,#5F,#78,#3C,#E0,#4E,#42,#13,#90,#C0,#4F
    DB #12,#DD,#10,#3D,#E9,#70,#BE,#7E,#C9,#A8,#5F,#C0,#11,#A7,#04,#95
    DB #BA,#B8,#08,#C0,#4D,#C7,#C0,#EC,#FF,#C0,#C3,#44,#9F,#C0,#FE,#4D
    DB #55,#56
