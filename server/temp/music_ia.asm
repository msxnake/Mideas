...
; BANK 00 @#1009 : sound.asm part 1/2 (4087 bytes)
; BANK 01 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 02 @#0000 : sound.asm part 3/2 (1323 bytes)
; BANK 02 @#052B : scroll.asm (2407 bytes)
; BANK 02 @#0E92 : animtiles.asm (2604 bytes)
; BANK 02 @#18BE : bosses.asm (331 bytes)
; BANK 02 @#1A09 : statemachine.asm (5 bytes)
; BANK 02 @#1A0E : gameflow.asm part 1/3 (1522 bytes)
; BANK 03 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 04 @#0000 : gameflow.asm part 3/3 (8001 bytes)
...
temp_byte_32        EQU #E577   ; Temporary 8-bit storage (32 bytes)
...
far_call_irq_lock_depth EQU #E6B1   ; Nonzero while far trampolines own an IRQ-masked mapper window
RAM_INTERRUPT_END       EQU #E6B2   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E6B2   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E6B3   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E6B4   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E6B5   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E6B6   ; 0=stopped, 1=track active
music_muted          EQU #E6B7   ; 0=audible, 1=muted/pause
music_loop           EQU #E6B8   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E6B9   ; Current ROM track index
music_row_frames     EQU #E6BA   ; Frames per tracker row
music_row_countdown  EQU #E6BB   ; Countdown to next row
music_order_pos      EQU #E6BC   ; Current order position
music_pattern_index  EQU #E6BD   ; Current pattern index
music_pattern_row    EQU #E6BE   ; Current row inside pattern
music_pattern_rows   EQU #E6BF   ; Cached rows in current pattern
music_track_ptr_l    EQU #E6C0   ; Current track pointer low byte
music_track_ptr_h    EQU #E6C1   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E6C2   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E6C3   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E6C4   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E6C5   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E6C6   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E6C7   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E6C8   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E6C8   ; Channel A
music_ch_b_note EQU #E6C9   ; Channel B
music_ch_c_note EQU #E6CA   ; Channel C
music_ch_instrument_base EQU #E6CB   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E6CB   ; Channel A
music_ch_b_instrument EQU #E6CC   ; Channel B
music_ch_c_instrument EQU #E6CD   ; Channel C
music_ch_ornament_base EQU #E6CE   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E6CE   ; Channel A
music_ch_b_ornament EQU #E6CF   ; Channel B
music_ch_c_ornament EQU #E6D0   ; Channel C
music_ch_volume_base EQU #E6D1   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E6D1   ; Channel A
music_ch_b_volume EQU #E6D2   ; Channel B
music_ch_c_volume EQU #E6D3   ; Channel C
music_ch_vol_step_base EQU #E6D4   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E6D4   ; Channel A
music_ch_b_vol_step EQU #E6D5   ; Channel B
music_ch_c_vol_step EQU #E6D6   ; Channel C
music_ch_tone_step_base EQU #E6D7   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E6D7   ; Channel A
music_ch_b_tone_step EQU #E6D8   ; Channel B
music_ch_c_tone_step EQU #E6D9   ; Channel C
music_ch_noise_step_base EQU #E6DA   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E6DA   ; Channel A
music_ch_b_noise_step EQU #E6DB   ; Channel B
music_ch_c_noise_step EQU #E6DC   ; Channel C
music_ch_orn_step_base EQU #E6DD   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E6DD   ; Channel A
music_ch_b_orn_step EQU #E6DE   ; Channel B
music_ch_c_orn_step EQU #E6DF   ; Channel C
music_ch_hw_env_step_base EQU #E6E0   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E6E0   ; Channel A
music_ch_b_hw_env_step EQU #E6E1   ; Channel B
music_ch_c_hw_env_step EQU #E6E2   ; Channel C
...
;   #E6E3-#E700: Alignment padding/free RAM (29 bytes)
