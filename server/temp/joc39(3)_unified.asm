...
;; Size: 16x16
HERO_WALK_LEFT_0_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#03,#04,#03,#05,#03,#01,#03,#0B,#33,#03,#03,#01,#01,#01,#03
    DB #00,#80,#40,#A0,#D0,#90,#00,#80,#A0,#90,#88,#80,#00,#00,#00,#00

HERO_WALK_LEFT_0_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #03,#04,#0B,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #80,#40,#A0,#50,#28,#28,#38,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: hero_walk_left_0_F0 ----

;; ---- Sprite Frame: hero_walk_left_0_F1 ----
;; Size: 16x16
HERO_WALK_LEFT_0_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#03,#04,#03,#05,#03,#21,#1B,#03,#03,#03,#43,#78,#00,#00
    DB #00,#00,#80,#40,#A0,#D8,#80,#04,#B8,#80,#80,#80,#80,#7C,#04,#00

HERO_WALK_LEFT_0_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#07,#0C,#0B,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#C0,#60,#B0,#58,#24,#38,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: hero_walk_left_0_F1 ----


; Sprite Asset 1: hero_idle
;; Sprite: hero_idle
;; Total Frames: 1
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
;; Size: 16x16
CUADRO_2_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#0F,#0D,#0F,#0F,#0E,#0F,#0F,#0F,#0F,#00,#00,#00,#00,#00
    DB #00,#00,#F0,#F0,#F0,#F0,#F0,#F0,#F0,#B0,#F0,#00,#00,#00,#00,#00

;; ---- End of Frame: cuadro_2_F0 ----
...
; Sprite Asset 4: nina_grub_right
...
;; Size: 16x16
NINA_GRUB_RIGHT_4_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#3C,#34,#B6,#FE,#7C,#60,#00,#25,#00,#00,#00,#08,#04,#02

NINA_GRUB_RIGHT_4_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #00,#01,#01,#01,#07,#04,#08,#08,#00,#00,#00,#01,#03,#03,#00,#00
    DB #F8,#FE,#C0,#40,#00,#00,#00,#00,#F0,#DA,#F0,#F0,#F8,#F0,#00,#01

;; ---- End of Frame: nina_grub_right_4_F0 ----

;; ---- Sprite Frame: nina_grub_right_4_F1 ----
;; Size: 16x16
NINA_GRUB_RIGHT_4_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #20,#00,#00,#80,#00,#00,#20,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#3C,#34,#B6,#FE,#7C,#61,#04,#20,#00,#00,#00,#08,#05

NINA_GRUB_RIGHT_4_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #00,#00,#01,#01,#01,#07,#04,#08,#08,#00,#00,#00,#01,#03,#03,#00
    DB #00,#F8,#FE,#C0,#40,#00,#00,#00,#00,#F2,#D8,#F0,#F0,#F0,#F1,#0A

;; ---- End of Frame: nina_grub_right_4_F1 ----
...
; Sprite Asset 6: nina_jump_right
...
;; Size: 16x16
NINA_JUMP_RIGHT_6_F0_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #07,#07,#09,#14,#20,#10,#20,#03,#02,#07,#07,#06,#07,#06,#07,#00
    DB #F8,#00,#00,#00,#00,#00,#00,#C0,#40,#C0,#E0,#E0,#E0,#E0,#E0,#00

NINA_JUMP_RIGHT_6_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#02,#03,#01,#01,#00,#00,#00,#00,#01,#00,#01,#00,#01
    DB #00,#F0,#D0,#D8,#F8,#F0,#80,#00,#80,#00,#00,#00,#00,#00,#00,#80

;; ---- End of Frame: nina_jump_right_6_F0 ----


; Sprite Asset 7: hero_walk_right
;; Sprite: hero_walk_right
;; Total Frames: 2
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
;; Drawable Palette (Hex): C0=rgba(0,0,0,0), C1=#FFFFFF, C2=#FF0000, C3=#00FF00
...
;; Size: 16x16
HERO_WALK_RIGHT_7_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#01,#02,#05,#0B,#09,#00,#01,#05,#09,#11,#01,#00,#00,#00,#00
    DB #00,#C0,#20,#C0,#A0,#C0,#80,#C0,#D0,#CC,#C0,#C0,#80,#80,#80,#C0

HERO_WALK_RIGHT_7_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #01,#02,#05,#0A,#14,#14,#1C,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #C0,#20,#D0,#20,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: hero_walk_right_7_F0 ----

;; ---- Sprite Frame: hero_walk_right_7_F1 ----
;; Size: 16x16
HERO_WALK_RIGHT_7_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#01,#02,#05,#1B,#01,#20,#1D,#01,#01,#01,#01,#3E,#20,#00
    DB #00,#00,#C0,#20,#C0,#A0,#C0,#84,#D8,#C0,#C0,#C0,#C2,#1E,#00,#00

HERO_WALK_RIGHT_7_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#03,#06,#0D,#1A,#24,#1C,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#E0,#30,#D0,#20,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: hero_walk_right_7_F1 ----


; Sprite Asset 8: nina_walk_left
...
;; Size: 16x16
NINA_GRUB_LEFT_9_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#3C,#2C,#6D,#7F,#3E,#06,#00,#A4,#00,#00,#00,#10,#20,#40
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

NINA_GRUB_LEFT_9_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #1F,#7F,#03,#02,#00,#00,#00,#00,#0F,#5B,#0F,#0F,#1F,#0F,#00,#80
    DB #00,#80,#80,#80,#E0,#20,#10,#10,#00,#00,#00,#80,#C0,#C0,#00,#00

;; ---- End of Frame: nina_grub_left_9_F0 ----

;; ---- Sprite Frame: nina_grub_left_9_F1 ----
;; Size: 16x16
NINA_GRUB_LEFT_9_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#3C,#2C,#6D,#7F,#3E,#86,#20,#04,#00,#00,#00,#10,#A0
    DB #04,#00,#00,#01,#00,#00,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00

NINA_GRUB_LEFT_9_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #00,#1F,#7F,#03,#02,#00,#00,#00,#00,#4F,#1B,#0F,#0F,#0F,#8F,#50
    DB #00,#00,#80,#80,#80,#E0,#20,#10,#10,#00,#00,#00,#80,#C0,#C0,#00

;; ---- End of Frame: nina_grub_left_9_F1 ----


; Sprite Asset 10: nina_jump_left
