...
; BANK 05 @#1445 : statemachine.asm part 1/2 (3003 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 07 @#0000 : statemachine.asm part 3/2 (3641 bytes)
; BANK 07 @#0E39 : gameflow.asm (4551 bytes)
; BANK 08 @#0000 : gameflow.asm (1470 bytes)
...
SM_New_Statemachine_state_1776707744092_Transitions_Actions_2: 
    DB 28; REPLACE_TILE 
    DB 136, 2        ; REPLACE_TILE tile=tile_1776787670830=>136, dir=down
    DB 0xFF; END
