...
; Bank 8 [#6000-#8000]: gameflow_aux (4495/8192 bytes est.) [FAR — accessed via trampoline]
...
; BANK 08 @#0000 : gameflow.asm part 3/3 (7222 bytes); ==================================================================
...
; - gameflow_aux: 4495 estimated bytes
...
;       "estimatedUsedBytes": 4495,
;       "estimatedFreeBytes": 3697,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "gameflow_aux",
