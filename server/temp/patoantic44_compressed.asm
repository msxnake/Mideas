...
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #CB2C   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #CB2D   ; Temporary 16-bit storage
temp_word_2         EQU #CB2F   ; Temporary 16-bit storage
temp_byte_1         EQU #CB31   ; Temporary 8-bit storage
temp_byte_2         EQU #CB32   ; Temporary 8-bit storage
temp_byte_3         EQU #CB33   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #CB53   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #CB73   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #CB93   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #CBB3   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CBD3   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CBF3   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CC13   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CC33   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CC53   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CC73   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CC93   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CCB3   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CCD3   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CCF3   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CD13   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CD33   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CD53   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CD73   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CD93   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CDB3   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CDD3   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CDF3   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CE13   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #CE53   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #CE93   ; Cached entity X for wall checks
wall_temp_y         EQU #CE94   ; Cached entity Y for wall checks
wall_hit_left       EQU #CE95   ; Hitbox left edge cache
wall_hit_top        EQU #CE96   ; Hitbox top edge cache
wall_hit_right      EQU #CE97   ; Hitbox right edge cache
wall_hit_bottom     EQU #CE98   ; Hitbox bottom edge cache
wall_hit_w          EQU #CE99   ; Hitbox width cache (min 1)
wall_hit_h          EQU #CE9A   ; Hitbox height cache (min 1)
wall_probe_left     EQU #CE9B   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #CE9C   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #CE9D   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #CE9E   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #CE9F   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #CEBF   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #CEC0   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #CEC1   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #CEE1   ; Number of entities in coll_list
coll_src_left       EQU #CEE2   ; Source AABB left edge (scratch)
coll_src_right      EQU #CEE3   ; Source AABB right edge (scratch)
coll_src_top        EQU #CEE4   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #CEE5   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #CEE6   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #CEE6   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #CEE8   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #CEEA   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #CEEC   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #CEEE   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #CEF0   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #CEF2   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #CEF4   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #CEF6   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #CEF7   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #CEFC   ; Frame counter (16-bit)
task_exec_time          EQU #CEFE   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #CF00   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #CF01   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #CF01   ; End of project variables (3841 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#CF01: Project variables (3841 bytes)
;   #CF01-#F37F: Free RAM (~9343 bytes available)
...
;   Active entities: 3
;   Used components: Position, Sprite, Animation, Patrol, Collision, Input, Cursors, Gravity, WallCollision, Jump, StateMachine
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Animation, Patrol, Collision, Input, Cursors, Gravity, WallCollision, Jump, StateMachine 
