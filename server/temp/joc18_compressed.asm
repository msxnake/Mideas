...
; BANK 00 @#093E : entities.asm (4880 bytes)
; BANK 00 @#1C4E : worlds.asm (946 bytes)
; BANK 01 @#0000 : worlds.asm (847 bytes)
; BANK 01 @#034F : screens.asm (6500 bytes)
; BANK 01 @#1CB3 : sprites.asm (845 bytes)
; BANK 02 @#0000 : sprites.asm (3039 bytes)
; BANK 02 @#0BDF : font.asm (3456 bytes)
; BANK 02 @#195F : hud.asm (1697 bytes)
; BANK 03 @#0000 : hud.asm (1783 bytes)
; BANK 03 @#06F7 : menus.asm (168 bytes)
; BANK 03 @#079F : sound.asm part 1/2 (6241 bytes)
; BANK 04 @#0000 : sound.asm part 2/2 (3307 bytes)
; BANK 04 @#0CEB : scroll.asm (2353 bytes)
; BANK 04 @#161C : animtiles.asm (2532 bytes)
; BANK 05 @#0000 : animtiles.asm (2081 bytes)
; BANK 05 @#0821 : statemachine.asm part 1/2 (6111 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/2 (4913 bytes)
; BANK 06 @#1331 : gameflow.asm (3279 bytes)
; BANK 07 @#0000 : gameflow.asm (2742 bytes)
...
;   Active entities: 2
;   Used components: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors, WallCollision, StateMachine
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors, WallCollision, StateMachine 
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (40 -> 13 bytes)
    DB #96,#21,#96,#61,#96,#51,#96,#F1,#97,#A1,#55,#55,#80
load_color_bank0:
...
SCREEN_PAN1_0_BLOCK_CATALOG_COUNT EQU 23
SCREEN_PAN1_0_BLOCK_CATALOG_SIZE EQU 368
...
SCREEN_PAN1_0_BLOCK_TOTAL_SIZE EQU 416
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (368 -> 72 bytes)
    DB #95,#FF,#8E,#80,#81,#FD,#23,#82,#83,#FE,#F5,#E9,#F5,#E0,#1F,#C0
    DB #5F,#EC,#F9,#F9,#B0,#7F,#F0,#80,#66,#FF,#F4,#C6,#4F,#DE,#5F,#E8
    DB #F5,#60,#F5,#14,#E4,#C4,#FE,#D6,#6C,#47,#90,#D0,#E5,#C4,#F0,#8E
    DB #7F,#E5,#AE,#F6,#E6,#9F,#81,#CC,#73,#F0,#57,#E9,#EE,#FF,#F7,#E0
    DB #DC,#88,#D7,#B0,#DD,#E0,#55,#56
SCREEN_PAN1_0_BLOCK_MAP:
    ; ZX0 compressed screen_block_map (48 -> 41 bytes)
    DB #96,#00,#21,#01,#02,#86,#03,#04,#00,#05,#00,#90,#22,#06,#07,#08
    DB #09,#0A,#0B,#07,#0C,#00,#0D,#08,#04,#0E,#0F,#00,#10,#11,#00,#08
    DB #12,#13,#14,#15,#13,#D5,#16,#55,#60
...
; Entity: Player 2 (instance from template: tpl_player)
ENTITY_PLAYER_2_ID EQU 1
ENTITY_PLAYER_2_COMP_MASK EQU #23DB  ; Component mask: 10001111011011b
; Template: tpl_player
ENTITY_PLAYER_2_X EQU 5
ENTITY_PLAYER_2_Y EQU 11
...
init_player_2:
    ; Initialize Player 2 at real position from JSON
    ; JSON position: (5, 11) tiles = (40, 88) pixels
    ; Template: tpl_player
    ; Components: Position, Sprite, Collision, Input, Health, Animation, Jump, Gravity, DeadlyTiles
    ; Direction mask: #0F (1111b) = All directions
...
update_player_2:
    ; Update Player 2 logic with real behavior
    ; Check if entity has input component (player entities)
    ld a, 1
    ld hl, entity_comp_masks
    ld e, a
