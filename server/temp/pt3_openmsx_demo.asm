...
; PT3 workspace in RAM. These are address labels only; no ROM bytes are emitted.
PT3_SETUP       equ     #D174
...
MainLoop:
        ...
        push    ix
        push    iy
        ; PT3_PLAY uses SP as a temporary pointer inside CHREGS, so the whole
        ; PT3 update and PSG flush must run with interrupts disabled.
        di
        call    PT3_PLAY
        call    PT3_ROUT
        ei
...
MusicData:
        incbin  "itscomefromthedark_stripped.pt3"
