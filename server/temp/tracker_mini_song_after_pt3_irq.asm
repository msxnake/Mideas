; ==================================================================
; TRACKER_MINI_SONG_AFTER_PT3_IRQ - UNIFIED FILE
...
; BANK 00 @#0238 : worlds.asm (162 bytes)
; BANK 00 @#02DA : screens.asm (185 bytes)
; BANK 00 @#0393 : sprites.asm (2613 bytes)
; BANK 00 @#0DC8 : font.asm (177 bytes)
; BANK 00 @#0E79 : hud.asm (79 bytes)
; BANK 00 @#0EC8 : menus.asm (168 bytes)
; BANK 00 @#0F70 : sound.asm part 1/2 (4240 bytes)
; BANK 01 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 02 @#0000 : sound.asm part 3/2 (358 bytes)
; BANK 02 @#0166 : scroll.asm (2342 bytes)
; BANK 02 @#0A8C : animtiles.asm (4585 bytes)
; BANK 02 @#1C75 : statemachine.asm (5 bytes)
; BANK 02 @#1C7A : gameflow.asm (401 bytes)
...
; ==================================================================
player_x            EQU #DE0F   ; Player X position (16-bit)
player_y            EQU #DE11   ; Player Y position (16-bit)
player_runtime_enabled EQU #DE13   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #DE14   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #DE15   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #DE16   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #DE17   ; Player health points
player_score        EQU #DE18   ; Player score (16-bit)
gem_count           EQU #DE1A   ; Collectible tile counter (8-bit)
last_interaction_char EQU #DE1B   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #DE1C   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #DE1D   ; Interaction type id of last interacted tile
last_interaction_value EQU #DE1E   ; Interaction value byte of last interacted tile
last_interaction_target EQU #DE1F   ; Interaction target id of last interacted tile
last_interaction_x  EQU #DE20   ; Tile X coordinate of last interaction
last_interaction_y  EQU #DE21   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #DE22   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #DE23   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #DE24   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #DE64   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #DEA4   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #DEE4   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #DF24   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #DF34   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #DF44   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #DF54   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #DF64   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #DF74   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #DF84   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #DF85   ; Temporary 16-bit storage
temp_word_2         EQU #DF87   ; Temporary 16-bit storage
temp_byte_1         EQU #DF89   ; Temporary 8-bit storage
temp_byte_2         EQU #DF8A   ; Temporary 8-bit storage
temp_byte_3         EQU #DF8B   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #DFAB   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #DFCB   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #DFEB   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E00B   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E00C   ; Frames remaining for current SFX
sfx_fadeout         EQU #E00D   ; Reserved fadeout flag/state
temp_byte_7         EQU #E00E   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E02E   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E04E   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E06E   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E08E   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E0AE   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E0CE   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E0EE   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E10E   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E12E   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E14E   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E16E   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E18E   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E1AE   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E1CE   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E1EE   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E20E   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E22E   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E24E   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E26E   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E2AE   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E2EE   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E30E   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E32E   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E34E   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E34F   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E350   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E351   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E352   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E353   ; Cached entity X for wall checks
wall_temp_y         EQU #E354   ; Cached entity Y for wall checks
wall_hit_left       EQU #E355   ; Hitbox left edge cache
wall_hit_top        EQU #E356   ; Hitbox top edge cache
wall_hit_right      EQU #E357   ; Hitbox right edge cache
wall_hit_bottom     EQU #E358   ; Hitbox bottom edge cache
wall_hit_w          EQU #E359   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E35A   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E35B   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E35C   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E35D   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E35E   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E35F   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E37F   ; Number of entries in active_entity_list
hero_entity_id      EQU #E380   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E381   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E382   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E3A2   ; Number of entries in input_entity_list
render_entity_list  EQU #E3A3   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E3C3   ; Number of entries in render_entity_list
collision_entity_list EQU #E3C4   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E3E4   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E3E5   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E405   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E406   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E426   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E427   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E447   ; Number of entities in coll_list
coll_src_left       EQU #E448   ; Source AABB left edge (scratch)
coll_src_right      EQU #E449   ; Source AABB right edge (scratch)
coll_src_top        EQU #E44A   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E44B   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E44C   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E44C   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E44E   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E450   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E452   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E454   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E456   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E458   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E45A   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E45C   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E45D   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E462   ; Frame counter (16-bit)
task_exec_time          EQU #E464   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E466   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E467   ; 1 while the H.TIMI dispatcher is running
RAM_INTERRUPT_END       EQU #E468   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E468   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E469   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E46A   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E46B   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E46C   ; 0=stopped, 1=track active
music_muted          EQU #E46D   ; 0=audible, 1=muted/pause
music_loop           EQU #E46E   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E46F   ; Current ROM track index
music_row_frames     EQU #E470   ; Frames per tracker row
music_row_countdown  EQU #E471   ; Countdown to next row
music_order_pos      EQU #E472   ; Current order position
music_pattern_index  EQU #E473   ; Current pattern index
music_pattern_row    EQU #E474   ; Current row inside pattern
music_pattern_rows   EQU #E475   ; Cached rows in current pattern
music_track_ptr_l    EQU #E476   ; Current track pointer low byte
music_track_ptr_h    EQU #E477   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E478   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E479   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E47A   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E47B   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E47C   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E47D   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E47E   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E47E   ; Channel A
music_ch_b_note EQU #E47F   ; Channel B
music_ch_c_note EQU #E480   ; Channel C
music_ch_instrument_base EQU #E481   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E481   ; Channel A
music_ch_b_instrument EQU #E482   ; Channel B
music_ch_c_instrument EQU #E483   ; Channel C
music_ch_ornament_base EQU #E484   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E484   ; Channel A
music_ch_b_ornament EQU #E485   ; Channel B
music_ch_c_ornament EQU #E486   ; Channel C
music_ch_volume_base EQU #E487   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E487   ; Channel A
music_ch_b_volume EQU #E488   ; Channel B
music_ch_c_volume EQU #E489   ; Channel C
music_ch_vol_step_base EQU #E48A   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E48A   ; Channel A
music_ch_b_vol_step EQU #E48B   ; Channel B
music_ch_c_vol_step EQU #E48C   ; Channel C
music_ch_tone_step_base EQU #E48D   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E48D   ; Channel A
music_ch_b_tone_step EQU #E48E   ; Channel B
music_ch_c_tone_step EQU #E48F   ; Channel C
music_ch_noise_step_base EQU #E490   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E490   ; Channel A
music_ch_b_noise_step EQU #E491   ; Channel B
music_ch_c_noise_step EQU #E492   ; Channel C
music_ch_orn_step_base EQU #E493   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E493   ; Channel A
music_ch_b_orn_step EQU #E494   ; Channel B
music_ch_c_orn_step EQU #E495   ; Channel C
music_ch_hw_env_step_base EQU #E496   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E496   ; Channel A
music_ch_b_hw_env_step EQU #E497   ; Channel B
music_ch_c_hw_env_step EQU #E498   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E499   ; End of project variables (9369 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E499: Project variables (9369 bytes)
;   #E499-#F37F: Free RAM (~3815 bytes available)
