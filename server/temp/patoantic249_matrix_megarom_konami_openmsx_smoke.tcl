set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/patoantic249_matrix_megarom_konami_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/patoantic249_matrix_megarom_konami_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set p1 [mem8 0xC128]; set p2 [mem8 0xC129]; set p3 [mem8 0xC12A]; set p4 [mem8 0xC12B]
    set flow [mem8 0xC10F]; set screen [mem8 0xE1D3]; set irq [mem16 0xE895]; set inirq [mem8 0xE89A]
    set px [mem16 0xE1DD]; set py [mem16 0xE1DF]
...
after time 12.0 { shot "patoantic249_matrix_megarom_konami_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "patoantic249_matrix_megarom_konami_t16.png" "t16" }
after time 22.0 { shot "patoantic249_matrix_megarom_konami_t22.png" "t22"; close $f; exit }
