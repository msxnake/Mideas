; ==================================================================
; C_MAJOR_CHIPTUNE_LOOP - UNIFIED FILE
...
; BANK 02 @#0000 : sound.asm part 3/2 (2457 bytes)
; BANK 02 @#0999 : scroll.asm (2407 bytes)
; BANK 02 @#1300 : animtiles.asm (2549 bytes)
; BANK 02 @#1CF5 : bosses.asm (779 bytes)
; BANK 03 @#0000 : bosses.asm (5003 bytes)
; BANK 03 @#138B : statemachine.asm (5 bytes)
; BANK 03 @#1390 : gameflow.asm (3184 bytes)
; BANK 04 @#0000 : gameflow.asm (1716 bytes)
...
; Flow: Start → Music (gf_cmaj_music)
; ==================================================================
...
music_track_ptr_table:
    DW music_track_0_C_Major_Chiptune_Loop_data

; ------------------------------------------------------------------
; Tracker Song 0: C Major Chiptune Loop
; ------------------------------------------------------------------
music_track_0_C_Major_Chiptune_Loop_data:
    DB #05
    DB #02
    DB #00
    DB #01
    DB #02
    DW music_track_0_C_Major_Chiptune_Loop_order_table
    DW music_track_0_C_Major_Chiptune_Loop_pattern_table
    DW music_track_0_C_Major_Chiptune_Loop_instrument_ptr_table
    DW music_track_0_C_Major_Chiptune_Loop_ornament_ptr_table
    DW #00D2
    DB #0C

music_track_0_C_Major_Chiptune_Loop_order_table:
    DB #00,#01

music_track_0_C_Major_Chiptune_Loop_pattern_table:
    DW music_track_0_C_Major_Chiptune_Loop_pattern_0_rows
    DB #40
    DW music_track_0_C_Major_Chiptune_Loop_pattern_1_rows
    DB #40

music_track_0_C_Major_Chiptune_Loop_instrument_ptr_table:
    DW 0
    DW music_track_0_C_Major_Chiptune_Loop_inst_1
    DW music_track_0_C_Major_Chiptune_Loop_inst_2
    DW 0
    DW 0
    DW music_track_0_C_Major_Chiptune_Loop_inst_5
    DW music_track_0_C_Major_Chiptune_Loop_inst_6
    DW music_track_0_C_Major_Chiptune_Loop_inst_7
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_C_Major_Chiptune_Loop_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_C_Major_Chiptune_Loop_pattern_0_rows:
    DB #3C,#01,#FF,#0F,#18,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#18,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #35,#01,#FF,#0F,#13,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#18,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#1D,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#1D,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#18,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#1D,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#1F,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#1F,#02,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #35,#01,#FF,#0F,#1A,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #32,#01,#FF,#0F,#1F,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #30,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#18,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#13,#02,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#18,#02,#FF,#0F,#18,#05,#FF,#0F
    ...
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#13,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_C_Major_Chiptune_Loop_pattern_1_rows:
    DB #3C,#01,#FF,#0F,#18,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#1C,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#1F,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    ...
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#21,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    ...
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#17,#02,#FF,#0F,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#1A,#02,#FF,#0F,#18,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#1F,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#18,#02,#FF,#0F,#18,#05,#FF,#0F
    ...
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#18,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_C_Major_Chiptune_Loop_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #0C
    DW #00D2
    DW music_track_0_C_Major_Chiptune_Loop_inst_1_vol_env
    DB #0B
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_1_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_C_Major_Chiptune_Loop_inst_1_vol_env:
    DB #0F,#0F,#0E,#0D,#0B,#09,#07,#05,#03,#01,#00
music_track_0_C_Major_Chiptune_Loop_inst_1_tone_env:
    DB #00

music_track_0_C_Major_Chiptune_Loop_inst_2:
    DB #01
    DB #0F
    DB #00
    DB #0C
    DW #00D2
    DW music_track_0_C_Major_Chiptune_Loop_inst_2_vol_env
    DB #09
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_2_tone_env
    DB #03
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_C_Major_Chiptune_Loop_inst_2_vol_env:
    DB #0F,#0E,#0D,#0C,#0A,#08,#05,#02,#00
music_track_0_C_Major_Chiptune_Loop_inst_2_tone_env:
    DB #00,#FF,#00

music_track_0_C_Major_Chiptune_Loop_inst_5:
    DB #03
    DB #0F
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_C_Major_Chiptune_Loop_inst_5_vol_env
    DB #06
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_5_tone_env
    DB #04
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_5_noise_env
    DB #04
    DB #FF
music_track_0_C_Major_Chiptune_Loop_inst_5_vol_env:
    DB #0F,#0D,#0A,#06,#02,#00
music_track_0_C_Major_Chiptune_Loop_inst_5_tone_env:
    DB #E4,#F0,#F9,#00
music_track_0_C_Major_Chiptune_Loop_inst_5_noise_env:
    DB #02,#04,#08,#0E

music_track_0_C_Major_Chiptune_Loop_inst_6:
    DB #02
    DB #0E
    DB #00
    DB #08
    DW #00D2
    DW music_track_0_C_Major_Chiptune_Loop_inst_6_vol_env
    DB #06
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_6_tone_env
    DB #01
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_6_noise_env
    DB #04
    DB #FF
music_track_0_C_Major_Chiptune_Loop_inst_6_vol_env:
    DB #0E,#0B,#08,#04,#01,#00
music_track_0_C_Major_Chiptune_Loop_inst_6_tone_env:
    DB #00
music_track_0_C_Major_Chiptune_Loop_inst_6_noise_env:
    DB #08,#0C,#12,#18

music_track_0_C_Major_Chiptune_Loop_inst_7:
    DB #02
    DB #09
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_C_Major_Chiptune_Loop_inst_7_vol_env
    DB #05
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_7_tone_env
    DB #01
    DB #FF
    DW music_track_0_C_Major_Chiptune_Loop_inst_7_noise_env
    DB #04
    DB #FF
music_track_0_C_Major_Chiptune_Loop_inst_7_vol_env:
    DB #09,#07,#04,#01,#00
music_track_0_C_Major_Chiptune_Loop_inst_7_tone_env:
    DB #00
music_track_0_C_Major_Chiptune_Loop_inst_7_noise_env:
    DB #02,#03,#04,#06
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_cmaj_start
...
; Node: Start - "gf_cmaj_start"
gameflow_node_gf_cmaj_start:
    db NODE_TYPE_START
    dw gameflow_node_gf_cmaj_start_data
    dw gameflow_node_gf_cmaj_start_conn

gameflow_node_gf_cmaj_start_data:
    dw gameflow_node_gf_cmaj_start_init    ; Initialization routine address
    db ((gameflow_node_gf_cmaj_start_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_cmaj_start_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_cmaj_music
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_cmaj_start_init
...
; Node: Music - "gf_cmaj_music"
gameflow_node_gf_cmaj_music:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gf_cmaj_music_data
    dw gameflow_node_gf_cmaj_music_conn

gameflow_node_gf_cmaj_music_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gf_cmaj_music_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_cmaj_end
    db CONNECTION_END

; Node: End - "gf_cmaj_end"
gameflow_node_gf_cmaj_end:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gf_cmaj_end_conn

gameflow_node_gf_cmaj_end_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
