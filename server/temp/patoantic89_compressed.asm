...
; Estimated payload bytes: 109242
...
; BANK 06 @#0000 : sound.asm (395 bytes)
; BANK 06 @#018B : scroll.asm (2353 bytes)
; BANK 06 @#0ABC : animtiles.asm (5444 bytes)
; BANK 07 @#0000 : animtiles.asm (472 bytes)
; BANK 07 @#01D8 : particles.asm (4963 bytes)
; BANK 07 @#153B : statemachine.asm part 1/4 (2757 bytes)
...
; BANK 11 @#0000 : statemachine.asm part 5/4 (2239 bytes)
; BANK 11 @#08BF : gameflow.asm part 1/3 (5953 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (2746 bytes)
...
temp_byte_7         EQU #CD16   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CD36   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CD56   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CD76   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CD96   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CDB6   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CDD6   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CDF6   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CE16   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CE36   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CE56   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CE76   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CE96   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CEB6   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CED6   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CEF6   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CF16   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CF36   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CF56   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CF76   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #CFB6   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #CFF6   ; Cached entity X for wall checks
wall_temp_y         EQU #CFF7   ; Cached entity Y for wall checks
wall_hit_left       EQU #CFF8   ; Hitbox left edge cache
wall_hit_top        EQU #CFF9   ; Hitbox top edge cache
wall_hit_right      EQU #CFFA   ; Hitbox right edge cache
wall_hit_bottom     EQU #CFFB   ; Hitbox bottom edge cache
wall_hit_w          EQU #CFFC   ; Hitbox width cache (min 1)
wall_hit_h          EQU #CFFD   ; Hitbox height cache (min 1)
wall_probe_left     EQU #CFFE   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #CFFF   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #D000   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #D001   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #D002   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #D022   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #D023   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #D024   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #D044   ; Number of entities in coll_list
coll_src_left       EQU #D045   ; Source AABB left edge (scratch)
coll_src_right      EQU #D046   ; Source AABB right edge (scratch)
coll_src_top        EQU #D047   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #D048   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #D049   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #D049   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #D04B   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #D04D   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #D04F   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #D051   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #D053   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #D055   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #D057   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #D059   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #D05A   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #D05F   ; Frame counter (16-bit)
task_exec_time          EQU #D061   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #D063   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #D064   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D064   ; End of project variables (4196 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D064: Project variables (4196 bytes)
;   #D064-#F37F: Free RAM (~8988 bytes available)
