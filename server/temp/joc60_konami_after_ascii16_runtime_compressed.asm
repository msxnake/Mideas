; ==================================================================
; JOC60_KONAMI_AFTER_ASCII16_RUNTIME - MEGAROM UNIFIED FILE
...
; ------------------------------------------------------------------
; Bank 1 [#6000-#8000]: components (54828/8192 bytes est.)
; Bank 2 [#8000-#A000]: statemachine, gameflow (28587/8192 bytes est.)
; Bank 5 [#6000-#8000]: bosses (7430/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 6 [#6000-#8000]: screens_code (7208/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 7 [#6000-#8000]: entities (6025/8192 bytes est.) [FAR — accessed via trampoline]
...
; Estimated payload bytes: 131148
...
; BANK 06 @#0000 : components.asm part 7/7 (7538 bytes)
; BANK 06 @#1D72 : entities.asm (654 bytes)
; BANK 07 @#0000 : entities.asm (5371 bytes)
; BANK 07 @#14FB : worlds.asm (2092 bytes)
; BANK 07 @#1D27 : screens.asm (729 bytes)
; BANK 08 @#0000 : screens.asm (6480 bytes)
; BANK 08 @#1950 : sprites.asm (1712 bytes)
; BANK 09 @#0000 : sprites.asm (3521 bytes)
; BANK 09 @#0DC1 : font.asm (3503 bytes)
; BANK 09 @#1B70 : hud.asm (1168 bytes)
; BANK 10 @#0000 : hud.asm (2779 bytes)
; BANK 10 @#0ADB : menus.asm (168 bytes)
; BANK 10 @#0B83 : sound.asm (4463 bytes)
; BANK 10 @#1CF2 : scroll.asm (782 bytes)
; BANK 11 @#0000 : scroll.asm (1571 bytes)
; BANK 11 @#0623 : animtiles.asm (3410 bytes)
; BANK 11 @#1375 : bosses.asm (3211 bytes)
; BANK 12 @#0000 : bosses.asm (4219 bytes)
; BANK 12 @#107B : statemachine.asm part 1/3 (3973 bytes)
; BANK 13 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 15 @#0000 : statemachine.asm part 4/3 (1028 bytes)
; BANK 15 @#0404 : gameflow.asm (7164 bytes)
; BANK 16 @#0000 : gameflow.asm (76 bytes); ==================================================================
...
; - components: 54828 estimated bytes
; - entities: 6025 estimated bytes
; - font: 3503 estimated bytes
; - gameflow: 7239 estimated bytes
; - hud: 3947 estimated bytes
; - patterns_code: 894 estimated bytes
; - screens_code: 7208 estimated bytes
; - sprites: 5232 estimated bytes
; - statemachine: 21348 estimated bytes
...
;       "estimatedUsedBytes": 7208,
;       "estimatedFreeBytes": 984,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "screens_code",
...
;       "estimatedUsedBytes": 6025,
;       "estimatedFreeBytes": 2167,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "entities",
...
ASCII16_FAR_CALL_P1_PRESERVE_A_RAM EQU #C177   ; RAM routine variant preserving caller/result A through AF'
ASCII16_RESIDENT_CALL_P1_RAM EQU #C1B7   ; RAM routine: call resident lower-page routine from ASCII16 P1 far code
ascii16_far_target_bank EQU #C217   ; Target ASCII16 bank for RAM far-call bridge
ascii16_far_old_bank EQU #C218   ; Previous ASCII16 lower-page bank for RAM far-call restore
ascii16_far_target_addr EQU #C219   ; Target entry address for RAM far-call bridge (16-bit)
ascii16_resident_call_target_addr EQU #C21B   ; Resident target address for RAM bridge (16-bit)
ascii16_resident_call_saved_hl EQU #C21D   ; Saved HL input while RAM resident-call bridge stages target address
ascii16_resident_call_saved_de EQU #C21F   ; Saved DE input while RAM resident-call bridge stages return address
ascii16_resident_call_old_bank EQU #C221   ; Previous far lower-page bank for RAM resident-call restore
frame_counter       EQU #C222   ; Frame counter (16-bit)

; Profiling counters (16-bit, cumulative)
prof_update_all_entities_calls EQU #C224   ; Calls to update_all_entities
prof_execute_sm_calls EQU #C226   ; Calls to execute_all_state_machines
prof_sm_update_calls  EQU #C228   ; Calls to SM_Update
prof_collision_calls  EQU #C22A   ; Calls to update_collision_component
prof_wall_calls       EQU #C22C   ; Calls to update_wallcollision_component
prof_deadly_calls     EQU #C22E   ; Calls to update_deadly_tiles_component
prof_tile_interaction_calls EQU #C230   ; Calls to check_tile_interaction
prof_animation_calls  EQU #C232   ; Calls to update_animation_component
prof_sprite_calls     EQU #C234   ; Calls to update_sprite_component
prof_music_task_calls EQU #C236   ; Calls to task_update_music
prof_deadly_behavior_reads EQU #C238   ; Deadly helper behavior-map reads
; page0_transfer_buffer shares the ZX0 scratch area declared near RAM_USAGE_END.

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C23A   ; Pointer to current screen layout data (16-bit)
current_screen_layout_bank EQU #C23C   ; Mapper bank for current screen layout data
current_behavior_map    EQU #C23D   ; Pointer to current behavior map data (16-bit)
current_behavior_map_bank EQU #C23F   ; Mapper bank for current behavior map data
behavior_cache_row     EQU #C240   ; Cached behavior row (255=invalid)
behavior_cache_map_l   EQU #C241   ; Cached behavior map pointer low byte
behavior_cache_map_h   EQU #C242   ; Cached behavior map pointer high byte
behavior_cache_row_base EQU #C243   ; Cached row base address in behavior map (16-bit)
RUNTIME_SCREEN_MAP_SIZE EQU 768
MAX_RUNTIME_EFFECT_ZONES EQU 0
runtime_background_layout EQU #C245   ; Immutable copy of current background layout (32x24)
runtime_screen_layout  EQU #C545   ; Mutable copy of current screen layout (32x24)
runtime_behavior_map   EQU #C845   ; Mutable copy of current behavior map (32x24)
runtime_interaction_type_map EQU #CB45   ; Mutable copy of current interaction type map (32x24)
runtime_interaction_value_map EQU #CE45   ; Mutable copy of current interaction value map (32x24)
runtime_interaction_target_map EQU #D145   ; Mutable copy of current interaction target map (32x24)
runtime_char_behavior_table EQU #D445   ; Current screen char -> behavior lookup table (256 bytes)
runtime_effects_layout EQU #D545   ; Alternate effects layout copy for secret zones (32x24)
screen_block_catalog_ptr EQU #D845   ; Scratch pointer to current screen block catalog during layout expansion
screen_block_map_ptr EQU #D847   ; Scratch pointer to current screen block index map during layout expansion
runtime_effect_zone_table EQU #D849   ; Current screen effect zone table (0 bytes)
current_effect_zone_count EQU #D849   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #D84A   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #D84B   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #D84C   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #D84D   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #D84E   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #D84F   ; Camera X position in pixels (16-bit)
camera_y            EQU #D851   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #D853   ; Camera tile X (column)
camera_tile_y       EQU #D854   ; Camera tile Y (row)
world_width_tiles   EQU #D855   ; World width in tiles
world_height_tiles  EQU #D856   ; World height in tiles
scroll_dirty_flag   EQU #D857   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #D858   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #D859   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #D85A   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #D85C   ; Animation frame timer
anim_tile_frame     EQU #D85D   ; Current animation frame (0-3)
anim_tile_speed     EQU #D85E   ; Frames between animation updates

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #D85F   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #D87F   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_button_contact_active EQU #D89F   ; 1 while entity stays on the same button tile (32 bytes)
entity_button_contact_x EQU #D8BF   ; Button tile X currently latched per entity (32 bytes)
entity_button_contact_y EQU #D8DF   ; Button tile Y currently latched per entity (32 bytes)
entity_on_ladder   EQU #D8FF   ; 1 while entity is centered on a ladder tile (32 bytes)
entity_gate_current_step EQU #D91F   ; Current applied retract step (32 bytes)
entity_gate_step_timer EQU #D93F   ; Countdown until next retract step (32 bytes)
entity_walljump_lock EQU #D95F   ; Remaining horizontal lock frames after wall jump (32 bytes)
entity_walljump_locked_vx EQU #D97F   ; Horizontal velocity preserved while wall jump lock is active (32 bytes)
entity_wallgrab_active EQU #D99F   ; 1 if entity is currently grabbing a wall (32 bytes)
entity_wallgrab_grace EQU #D9BF   ; Frames to keep wall grab during transient wall flag gaps (32 bytes)
entity_wallgrab_timer EQU #D9DF   ; Remaining wall-grab frames until grounded reset (32 bytes)
entity_wallgrab_lockout EQU #D9FF   ; Wall grab disabled until grounded after timer is spent (32 bytes)
entity_walljump_anim_active EQU #DA1F   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_x_pos        EQU #DA3F   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DA5F   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DA7F   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DA9F   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DABF   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DADF   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DAFF   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DB1F   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DB3F   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DB5F   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DB60   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DB80   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DBA0   ; Entity health (32 bytes)
entity_anim_frame   EQU #DBC0   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DBE0   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DC00   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DC20   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DC40   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DC60   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DC80   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DCA0   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DCC0   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DCE0   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DD00   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_collectible_enabled EQU #DD20   ; 1 when entity has Collectible component (32 bytes)
entity_carried_by   EQU #DD40   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #DD60   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #DD80   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #DDA0   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #DDC0   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #DDE0   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #DE00   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #DE20   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #DE40   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #DE60   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #DE80   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #DEA0   ; Entity sprite asset index - RAM copy (32 bytes)
entity_sprite_config EQU #DEC0   ; Entity sprite config RAM copy (base HW sprite + layer count, 64 bytes)
sprite_asset_frame_count EQU #DF00   ; Sprite asset frame counts RAM copy (11 bytes)
sprite_asset_layer_count EQU #DF0B   ; Sprite asset layer counts RAM copy (11 bytes)
sprite_loop_flags EQU #DF16   ; Sprite loop flags RAM copy (11 bytes)
sprite_dir_left_table EQU #DF21   ; Directional sprite lookup RAM copy (11 bytes)
sprite_dir_right_table EQU #DF2C   ; Directional sprite lookup RAM copy (11 bytes)
sprite_dir_up_table EQU #DF37   ; Directional sprite lookup RAM copy (11 bytes)
sprite_dir_down_table EQU #DF42   ; Directional sprite lookup RAM copy (11 bytes)
SM_SpriteLayerColorTable EQU #DF4D   ; Runtime SM sprite layer colors (11*2 bytes)
SM_SpriteLayerYOffsetTable EQU #DF63   ; Runtime SM sprite layer Y offsets (11*2 bytes)
active_sprite_count EQU #DF79   ; Number of sprites currently active
sprites_dirty      EQU #DF7A   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #DF7B   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #DF9B   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #DFBB   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_layer_y_offsets EQU #DFDB   ; HW sprite layer signed Y offsets - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #DFFB   ; Runtime base 16x16 slot per sprite asset (11 bytes)
sprite_placeholder_base_pattern_num EQU #E006   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E007   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E008   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (2 screens detected)
; ==================================================================
current_screen_id   EQU #E088   ; Currently displayed screen ID
current_screen_engine EQU #E089   ; Runtime engine: 0=Player, 1=FakePlayer
screen_dirty_flag   EQU #E08A   ; Screen needs redraw flag
screen_transition_cooldown EQU #E08B   ; Cooldown frames after screen transition
current_world_id    EQU #E08C   ; Current world ID (for multi-world support)
current_screen_index EQU #E08D   ; Current screen index within world
current_screen_anim_group_count EQU #E08E   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E08F   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E090   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E091   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E092   ; Player X position (16-bit)
player_y            EQU #E094   ; Player Y position (16-bit)
player_runtime_enabled EQU #E096   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E097   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E098   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E099   ; Cached player Y velocity (signed 8-bit)
player_dash_timer   EQU #E09A   ; Frames remaining in current Player dash
player_dash_cooldown EQU #E09B   ; Frames until Player can dash again
player_dash_dir     EQU #E09C   ; Player dash direction (1=left,2=right,3=up,4=down)
player_dash_tile_x  EQU #E09D   ; Dash front probe tile X scratch
player_dash_tile_y  EQU #E09E   ; Dash front probe tile Y scratch
player_health       EQU #E09F   ; Player health points
player_score        EQU #E0A0   ; Player score (16-bit)
gem_count           EQU #E0A2   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E0A3   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E0A4   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E0A5   ; Interaction type id of last interacted tile
last_interaction_value EQU #E0A6   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E0A7   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E0A8   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E0A9   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E0AA   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E0AB   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E0AC   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E0EC   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E12C   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E16C   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E1AC   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E1BC   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E1CC   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E1DC   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E1EC   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E1FC   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E20C   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E20D   ; Temporary 16-bit storage
temp_word_2         EQU #E20F   ; Temporary 16-bit storage
temp_byte_1         EQU #E211   ; Temporary 8-bit storage
temp_byte_2         EQU #E212   ; Temporary 8-bit storage
temp_byte_3         EQU #E213   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E233   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E253   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E273   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E293   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E294   ; Frames remaining for current SFX
sfx_fadeout         EQU #E295   ; Reserved fadeout flag/state
temp_byte_7         EQU #E296   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E2B6   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E2D6   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E2F6   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E316   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E336   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E356   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E376   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E396   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E3B6   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E3D6   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E3F6   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E416   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E436   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E456   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E476   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E496   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E4B6   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E4D6   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E4F6   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E536   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E576   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E596   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E5B6   ; Temporary 8-bit storage (32 bytes)
temp_byte_29        EQU #E5D6   ; Temporary 8-bit storage (32 bytes)
temp_byte_30        EQU #E5F6   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E616   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E617   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E618   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E619   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E61A   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E61B   ; Cached entity X for wall checks
wall_temp_y         EQU #E61C   ; Cached entity Y for wall checks
wall_hit_left       EQU #E61D   ; Hitbox left edge cache
wall_hit_top        EQU #E61E   ; Hitbox top edge cache
wall_hit_right      EQU #E61F   ; Hitbox right edge cache
wall_hit_bottom     EQU #E620   ; Hitbox bottom edge cache
wall_hit_w          EQU #E621   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E622   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E623   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E624   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E625   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E626   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E627   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E647   ; Number of entries in active_entity_list
hero_entity_id      EQU #E648   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E649   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E64A   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E66A   ; Number of entries in input_entity_list
render_entity_list  EQU #E66B   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E68B   ; Number of entries in render_entity_list
collision_entity_list EQU #E68C   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E6AC   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E6AD   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E6CD   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E6CE   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E6EE   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E6EF   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E70F   ; Number of entities in coll_list
coll_src_left       EQU #E710   ; Source AABB left edge (scratch)
coll_src_right      EQU #E711   ; Source AABB right edge (scratch)
coll_src_top        EQU #E712   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E713   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E714   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E714   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E716   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E718   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E71A   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E71C   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E71E   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E720   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E722   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E724   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E725   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E72A   ; Frame counter (16-bit)
task_exec_time          EQU #E72C   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E72E   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E72F   ; 1 while the H.TIMI dispatcher is running
RAM_INTERRUPT_END       EQU #E730   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E730   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E731   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E732   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E733   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E734   ; 0=stopped, 1=track active
music_muted          EQU #E735   ; 0=audible, 1=muted/pause
music_loop           EQU #E736   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E737   ; Current ROM track index
music_row_frames     EQU #E738   ; Frames per tracker row
music_row_countdown  EQU #E739   ; Countdown to next row
music_order_pos      EQU #E73A   ; Current order position
music_pattern_index  EQU #E73B   ; Current pattern index
music_pattern_row    EQU #E73C   ; Current row inside pattern
music_pattern_rows   EQU #E73D   ; Cached rows in current pattern
music_track_ptr_l    EQU #E73E   ; Current track pointer low byte
music_track_ptr_h    EQU #E73F   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E740   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E741   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E742   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E743   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E744   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E745   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E746   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E746   ; Channel A
music_ch_b_note EQU #E747   ; Channel B
music_ch_c_note EQU #E748   ; Channel C
music_ch_instrument_base EQU #E749   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E749   ; Channel A
music_ch_b_instrument EQU #E74A   ; Channel B
music_ch_c_instrument EQU #E74B   ; Channel C
music_ch_ornament_base EQU #E74C   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E74C   ; Channel A
music_ch_b_ornament EQU #E74D   ; Channel B
music_ch_c_ornament EQU #E74E   ; Channel C
music_ch_volume_base EQU #E74F   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E74F   ; Channel A
music_ch_b_volume EQU #E750   ; Channel B
music_ch_c_volume EQU #E751   ; Channel C
music_ch_vol_step_base EQU #E752   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E752   ; Channel A
music_ch_b_vol_step EQU #E753   ; Channel B
music_ch_c_vol_step EQU #E754   ; Channel C
music_ch_tone_step_base EQU #E755   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E755   ; Channel A
music_ch_b_tone_step EQU #E756   ; Channel B
music_ch_c_tone_step EQU #E757   ; Channel C
music_ch_noise_step_base EQU #E758   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E758   ; Channel A
music_ch_b_noise_step EQU #E759   ; Channel B
music_ch_c_noise_step EQU #E75A   ; Channel C
music_ch_orn_step_base EQU #E75B   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E75B   ; Channel A
music_ch_b_orn_step EQU #E75C   ; Channel B
music_ch_c_orn_step EQU #E75D   ; Channel C
music_ch_hw_env_step_base EQU #E75E   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E75E   ; Channel A
music_ch_b_hw_env_step EQU #E75F   ; Channel B
music_ch_c_hw_env_step EQU #E760   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E761   ; End of project variables (10081 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E761: Project variables (10081 bytes)
;   #E761-#E800: Alignment padding/free RAM (159 bytes)
