...
; Estimated payload bytes: 102118
...
; BANK 01 @#0633 : worlds.asm (5259 bytes)
; BANK 01 @#1ABE : screens.asm part 1/3 (1346 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (8192 bytes)
; BANK 04 @#0000 : screens.asm part 4/3 (2526 bytes)
; BANK 04 @#09DE : sprites.asm part 1/2 (5666 bytes)
; BANK 05 @#0000 : sprites.asm part 2/2 (5344 bytes)
; BANK 05 @#14E0 : font.asm (2848 bytes)
; BANK 06 @#0000 : font.asm (699 bytes)
; BANK 06 @#02BB : hud.asm (4467 bytes)
; BANK 06 @#142E : menus.asm (168 bytes)
; BANK 06 @#14D6 : sound.asm part 1/2 (2858 bytes)
; BANK 07 @#0000 : sound.asm part 2/2 (6679 bytes)
; BANK 07 @#1A17 : scroll.asm (1513 bytes)
; BANK 08 @#0000 : scroll.asm (840 bytes)
; BANK 08 @#0348 : animtiles.asm (6887 bytes)
; BANK 08 @#1E2F : particles.asm (465 bytes)
; BANK 09 @#0000 : particles.asm (4498 bytes)
; BANK 09 @#1192 : statemachine.asm part 1/3 (3694 bytes)
; BANK 10 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : statemachine.asm part 3/3 (5636 bytes)
; BANK 11 @#1604 : gameflow.asm (2556 bytes)
; BANK 12 @#0000 : gameflow.asm (3814 bytes)
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #A8,#7F,#35,#BC,#4C,#D5,#40,#E4,#9E,#F5,#0A,#79,#E6,#38,#C0,#53
    DB #55,#55,#80
...
SCREEN_PAN4_4_LAYOUT:
    ...
    DB #40,#86,#14,#A2,#82,#B8,#82,#EE,#BC,#83,#FC,#39,#80,#77,#F6,#37
    DB #DC,#0E,#80,#5A,#00,#68,#8D,#E4,#C0,#F9,#E7,#80,#56,#91,#00,#69
    DB #82,#A0,#8D,#7F,#EF,#80,#5A,#80,#47,#F1,#EF,#80,#A1,#86,#A4,#00
    DB #5A,#00,#68,#8D,#57,#DD,#C7,#80,#73,#14,#D8,#80,#69,#88,#5C,#DF
    DB #6E,#80,#5A,#8D,#35,#91,#C0,#F0,#80,#E4,#BA,#78,#7E,#E5,#80,#3F
    DB #8C,#23,#C0,#D4,#80,#F0,#C6,#6E,#81,#80,#3C,#46,#0D,#B4,#26,#D0
    DB #00,#DB,#26,#55,#55,#80
...
BEHAVIOR_PAN4_4_DATA:
    ...
    DB #85,#00,#56,#94,#10,#3F,#C2,#C5,#88,#F6,#C0,#95,#08,#7D,#52,#39
    DB #C0,#7B,#F2,#D3,#34,#81,#C0,#A5,#08,#5A,#00,#51,#3F,#E7,#40,#0F
    DB #EF,#85,#C0,#A4,#00,#1A,#08,#55,#E9,#41,#00,#56,#95,#00,#FC,#FF
    DB #C0,#07,#FD,#40,#FE,#3D,#80,#75,#C1,#02,#E0,#C0,#4A,#08,#50,#D3
    DB #48,#53,#D5,#C0,#F5,#FE,#75,#55,#58
...
WORLD_NEW_WORLDMAP_SCREEN_COUNT EQU 5
