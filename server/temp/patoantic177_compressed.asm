...
; BANK 11 @#0000 : statemachine.asm part 3/3 (2562 bytes)
; BANK 11 @#0A02 : gameflow.asm (5502 bytes)
...
SM_New_Statemachine_state_1771533526010_Transitions_Actions_2: 
    ...
    DB 5, 10, 1        ; comp=comp_health=>5, prop=current=>10, value=1
    DB 0xFF; END
