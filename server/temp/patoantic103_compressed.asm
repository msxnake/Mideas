...
SCREEN_PAN3_3_LAYOUT:
    ; ZX0 compressed layout (768 -> 85 bytes)
    ...
    DB #35,#C3,#9A,#C7,#00,#9F,#2C,#56,#38,#2E,#4E,#B0,#7C,#C0,#0E,#80
    DB #FB,#FC,#86,#9D,#16,#E1,#21,#80,#3C,#FC,#4F,#C1,#9E,#00,#FC,#57
    DB #81,#80,#35,#55,#58
