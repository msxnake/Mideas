...
; ==================================================================
camera_x            EQU #C018   ; Camera X position in pixels (16-bit)
camera_y            EQU #C01A   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #C01C   ; Camera tile X (column)
camera_tile_y       EQU #C01D   ; Camera tile Y (row)
world_width_tiles   EQU #C01E   ; World width in tiles
world_height_tiles  EQU #C01F   ; World height in tiles
scroll_dirty_flag   EQU #C020   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #C021   ; 1=HUD needs redraw, 0=clean

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #C022   ; Animation frame timer
anim_tile_frame     EQU #C023   ; Current animation frame (0-3)
anim_tile_speed     EQU #C024   ; Frames between animation updates

; ==================================================================
; PARTICLE SYSTEM VARIABLES
; ==================================================================
particle_pool       EQU #C025   ; Particle pool (8 particles * 8 bytes = 64 bytes)

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #C065   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_x_pos        EQU #C085   ; Entity X positions (32 bytes)
entity_y_pos        EQU #C0A5   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #C0C5   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #C0E5   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #C105   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #C125   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #C145   ; Entity screen ID (32 bytes)
entity_dir_mask     EQU #C165   ; Entity direction mask (32 bytes)
entity_health       EQU #C185   ; Entity health (32 bytes)
entity_anim_frame   EQU #C1A5   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #C1C5   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #C1E5   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #C205   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #C225   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C245   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C265   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C285   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C2A5   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #C2C5   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #C2E5   ; Entity carrier ID (32 bytes, 255=not carried)
entity_sm_var_0     EQU #C305   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C325   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C345   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C365   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C385   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #C3A5   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #C3C5   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #C3E5   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #C405   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #C425   ; Number of sprites currently active
sprite_pattern      EQU #C426   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #C446   ; Sprite colors (32 bytes)
sprite_attributes   EQU #C466   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (3 screens detected)
; ==================================================================
current_screen_id   EQU #C4E6   ; Currently displayed screen ID
screen_dirty_flag   EQU #C4E7   ; Screen needs redraw flag
screen_transition_cooldown EQU #C4E8   ; Cooldown frames after screen transition
current_world_id    EQU #C4E9   ; Current world ID (for multi-world support)
current_screen_index EQU #C4EA   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #C4EB   ; Player X position (16-bit)
player_y            EQU #C4ED   ; Player Y position (16-bit)
player_health       EQU #C4EF   ; Player health points
player_score        EQU #C4F0   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #C4F2   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #C4F3   ; Temporary 16-bit storage
temp_word_2         EQU #C4F5   ; Temporary 16-bit storage
temp_byte_1         EQU #C4F7   ; Temporary 8-bit storage
temp_byte_2         EQU #C4F8   ; Temporary 8-bit storage
temp_byte_3         EQU #C4F9   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #C519   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #C539   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #C559   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #C579   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #C599   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #C5B9   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #C5D9   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #C5F9   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #C619   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #C639   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #C659   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #C679   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #C699   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #C6B9   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #C6D9   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #C6F9   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #C719   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #C739   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #C759   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #C779   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #C799   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C7B9   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C7F9   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #C839   ; Cached entity X for wall checks
wall_temp_y         EQU #C83A   ; Cached entity Y for wall checks
wall_entity_idx     EQU #C83B   ; Current entity index in wall loop

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #C83C   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #C83C   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #C83E   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #C840   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #C842   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #C844   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #C846   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #C848   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #C84A   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #C84C   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #C84D   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #C852   ; Frame counter (16-bit)
task_exec_time          EQU #C854   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #C856   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #C857   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C857   ; End of project variables (2135 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#C857: Project variables (2135 bytes)
;   #C857-#F37F: Free RAM (~11049 bytes available)
...
BOLA_DEAD_4_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

BOLA_DEAD_4_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
BOLA_DEAD_4_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

BOLA_DEAD_4_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
BOLA_DEAD_4_F2_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

BOLA_DEAD_4_F2_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
BOLA_DEAD_4_F3_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

BOLA_DEAD_4_F3_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
BOLA_DEAD_4_F4_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

BOLA_DEAD_4_F4_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
ANEC_LEFT_5_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
ANEC_LEFT_5_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
