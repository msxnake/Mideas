...
; Bank 2 [#8000-#A000]: components_tail (1376/8192 bytes est.)
; Bank 5 [#6000-#8000]: bosses (6262/8192 bytes est.) [FAR — accessed via trampoline]
...
; Bank 8 [#6000-#8000]: animtiles (2604/8192 bytes est.) [FAR — accessed via trampoline]
...
;
; BANK 03 used 2048 / 8192
; - tile_pattern_bank0                1008 stored /  1008 raw bytes @ #8000 (rom #A000, offset +#0000) [PATTERNS/TILE_PATTERNS]
; - tile_color_bank0                  1008 stored /  1008 raw bytes @ #83F0 (rom #A3F0, offset +#03F0) [COLORS/TILE_COLORS]
; - SPRITE_PLACEHOLDER_PATTERN          32 stored /    32 raw bytes @ #87E0 (rom #A7E0, offset +#07E0) [SPRITES/SPRITE_PATTERNS]
; FREE 6144
...
;           "flags": 0,
;           "sourceIndex": 1,
;           "placementReason": "ascii8 first-fit data-zone placement; group=patterns; stored=1008; zoneSize=8192; bank=3; offset=#0000-#03EF; window=p3/#8000; slackAfter=6144"
;         },
;         {
;           "id": 2,
...
;           "flags": 0,
;           "sourceIndex": 2,
;           "placementReason": "ascii8 first-fit data-zone placement; group=colors; stored=1008; zoneSize=8192; bank=3; offset=#03F0-#07DF; window=p3/#8000; slackAfter=6144"
;         },
;         {
;           "id": 0,
...
;           "flags": 0,
;           "sourceIndex": 0,
;           "placementReason": "ascii8 first-fit data-zone placement; group=sprites; stored=32; zoneSize=8192; bank=3; offset=#07E0-#07FF; window=p3/#8000; slackAfter=6144"
;         }
;       ]
;     }
;   ],
...
;         "sceneId": null,
;         "sceneName": null,
;         "placementReason": "shared/global first-fit unit; resources=1; stored=1008; zoneSize=8192; proposedBank=3; offset=#0000; window=p3/#8000"
;       },
;       {
;         "id": 2,
;         "label": "tile_color_bank0",
...
;         "sceneId": null,
;         "sceneName": null,
;         "placementReason": "shared/global first-fit unit; resources=1; stored=1008; zoneSize=8192; proposedBank=3; offset=#03F0; window=p3/#8000"
;       },
;       {
;         "id": 0,
;         "label": "SPRITE_PLACEHOLDER_PATTERN",
...
;         "sceneId": null,
;         "sceneName": null,
;         "placementReason": "shared/global first-fit unit; resources=1; stored=32; zoneSize=8192; proposedBank=3; offset=#07E0; window=p3/#8000"
;       }
;     ],
;     "banks": [
;       {
...
; - components_tail: 1376 estimated bytes
...
;       "estimatedUsedBytes": 1376,
;       "estimatedFreeBytes": 6816,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "components_tail",
...
;       "estimatedUsedBytes": 6262,
;       "estimatedFreeBytes": 1930,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "bosses",
...
;         {
;           "key": "sound",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 2; physical bank 6; executes through P2/#6000 after reserved asset-data banks; module sound is callable only through bank-0 far trampolines",
;           "estimatedBytes": 4763
;         }
;       ]
;     },
...
;         {
;           "key": "sprites",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 3; physical bank 7; executes through P2/#6000 after reserved asset-data banks; module sprites is callable only through bank-0 far trampolines",
;           "estimatedBytes": 2796
;         }
;       ]
;     },
...
;         {
;           "key": "animtiles",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 4; physical bank 8; executes through P2/#6000 after reserved asset-data banks; module animtiles is callable only through bank-0 far trampolines",
;           "estimatedBytes": 2604
;         }
;       ]
;     },
...
;         {
;           "key": "scroll",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 5; physical bank 9; executes through P2/#6000 after reserved asset-data banks; module scroll is callable only through bank-0 far trampolines",
;           "estimatedBytes": 2407
;         }
;       ]
;     },
...
;         {
;           "key": "patterns_code",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 6; physical bank 10; executes through P2/#6000 after reserved asset-data banks; module patterns_code is callable only through bank-0 far trampolines",
;           "estimatedBytes": 606
;         }
;       ]
;     },
...
;         {
;           "key": "colors_code",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 7; physical bank 11; executes through P2/#6000 after reserved asset-data banks; module colors_code is callable only through bank-0 far trampolines",
;           "estimatedBytes": 578
;         }
;       ]
;     },
...
;         {
;           "key": "screens_code",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 8; physical bank 12; executes through P2/#6000 after reserved asset-data banks; module screens_code is callable only through bank-0 far trampolines",
;           "estimatedBytes": 196
;         }
;       ]
;     },
...
;         {
;           "key": "worlds",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 9; physical bank 13; executes through P2/#6000 after reserved asset-data banks; module worlds is callable only through bank-0 far trampolines",
;           "estimatedBytes": 172
;         }
;       ]
;     },
...
;         {
;           "key": "hud",
;           "placementReason": "far-call module; sorted by estimated size at overlay index 10; physical bank 14; executes through P2/#6000 after reserved asset-data banks; module hud is callable only through bank-0 far trampolines",
;           "estimatedBytes": 114
;         }
;       ]
;     }
...
; ------------------------------------------------------------------
; ZONE 00 [#A000-#C000] bank 3 used=2048 slack=6144
...
;   + SPRITE_PLACEHOLDER_PATTERN (sprites) @ +#07E0 size=32
    ...
    org #A000
; ==================================================================
; DATA ZONE 00 (bank 3) used=2048 slack=6144
; ==================================================================
; ==================================================================
...
boss_0_new_boss_phase_table:
    dw ((boss_0_new_boss_phase_0 & #1FFF) | #8000)
boss_0_new_boss_attack_table:
    dw #FFFF
boss_0_new_boss_phase_0:
    db #00, #00, #13, #0E    ; healthThreshold,buildType,width,height
    dw ((boss_0_new_boss_phase_0_tiles & #1FFF) | #8000), #FFFF, #FFFF, #FFFF, #FFFF, ((boss_0_new_boss_phase_0_behavior & #1FFF) | #8000), #FFFF, ((boss_empty_weak_matrix & #1FFF) | #8000)    ; tileMatrix,collision,neck,crush,attacks,behavior,forms,weak
