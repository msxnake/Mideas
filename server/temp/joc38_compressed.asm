...
; BANK 03 @#0000 : sprites.asm (3224 bytes)
; BANK 03 @#0C98 : font.asm (3456 bytes)
; BANK 03 @#1A18 : hud.asm (1512 bytes)
; BANK 04 @#0000 : hud.asm (2435 bytes)
; BANK 04 @#0983 : menus.asm (168 bytes)
; BANK 04 @#0A2B : sound.asm part 1/2 (5589 bytes)
; BANK 05 @#0000 : sound.asm part 2/2 (3959 bytes)
; BANK 05 @#0F77 : scroll.asm (2353 bytes)
; BANK 05 @#18A8 : animtiles.asm (1880 bytes)
; BANK 06 @#0000 : animtiles.asm (3513 bytes)
; BANK 06 @#0DB9 : statemachine.asm part 1/3 (4679 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (6513 bytes)
; BANK 08 @#1971 : gameflow.asm (1679 bytes)
; BANK 09 @#0000 : gameflow.asm (5455 bytes)
...
wallgrab_commit_grab_sprite_if_needed_c:
    ...
    cp SPRITE_ASSET_COUNT
    ret nc
    ld b, a                       ; B = grab sprite asset index

    ld hl, entity_sprite_asset_index
    add hl, de
    ld a, (hl)
    cp b
    ret z                         ; Already showing grab animation.
...
.not_grabbing:
    ...
    ; BC = (0, entity_index) is needed for address lookups.
    ; C was entity index on entry and preserved across calls.
    ld b, 0
    ld hl, entity_sprite_asset_index_init
    add hl, bc
    ld a, (hl)
    ...
    jr z, .restore_right
    ld a, d
    call wj_anim_restore_commit
    ret

.restore_left:
    ld hl, sprite_dir_left_table
    jr .restore_lookup_call
...
sprite_asset_base_pattern_slot_worldmap_1776512078647:
    ...
    db 1 ; Sprite 2: cuadro
    db 2 ; Sprite 3: nina_walk_right
    db 0 ; Sprite 4: nina_grub_right
    db 0 ; Sprite 5: New Sprite
    db 0 ; Sprite 6: nina_jump_right
    db 0 ; Sprite 7: hero_walk_right
    db 6 ; Sprite 8: nina_walk_left
    db 0 ; Sprite 9: nina_grub_left
...
SCREEN_PAN1_0_SPRITE_PATTERN_SLOTS EQU 11
