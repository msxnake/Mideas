...
; Estimated payload bytes: 100481
...
; BANK 04 @#0000 : sprites.asm part 3/2 (102 bytes)
; BANK 04 @#0066 : font.asm (3547 bytes)
; BANK 04 @#0E41 : hud.asm (3836 bytes)
; BANK 04 @#1D3D : menus.asm (444 bytes)
; BANK 04 @#1EF9 : sound.asm (263 bytes)
; BANK 05 @#0000 : sound.asm (2921 bytes)
; BANK 05 @#0B69 : scroll.asm (2353 bytes)
; BANK 05 @#149A : animtiles.asm (2918 bytes)
; BANK 06 @#0000 : animtiles.asm (2998 bytes)
; BANK 06 @#0BB6 : particles.asm (4963 bytes)
; BANK 06 @#1F19 : statemachine.asm part 1/4 (231 bytes)
...
; BANK 10 @#0000 : statemachine.asm part 5/4 (1798 bytes)
; BANK 10 @#0706 : gameflow.asm part 1/3 (6394 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (2177 bytes)
...
SPRITE_NINA_JUMP_LEFT_5_WIDTH     EQU 16
SPRITE_NINA_JUMP_LEFT_5_HEIGHT    EQU 16
SPRITE_NINA_JUMP_LEFT_5_FRAMES    EQU 1

;; ---- Sprite Frame: nina_jump_left_5_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_5_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_5_F0_DATA (32 bytes)
SPRITE_5_PATTERN EQU NINA_JUMP_LEFT_5_F0_LAYER1
SPRITE_5_PATTERN_BANK EQU ((SPRITE_5_PATTERN - #4000) / #2000)

; Sprite Asset 6: nina_land_left
...
SPRITE_NINA_LAND_LEFT_6_WIDTH     EQU 16
SPRITE_NINA_LAND_LEFT_6_HEIGHT    EQU 16
SPRITE_NINA_LAND_LEFT_6_FRAMES    EQU 3

;; ---- Sprite Frame: nina_land_left_6_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F2_DATA (32 bytes)
SPRITE_6_PATTERN EQU NINA_LAND_LEFT_6_F0_LAYER0
SPRITE_6_PATTERN_BANK EQU ((SPRITE_6_PATTERN - #4000) / #2000)

; Sprite Asset 7: nina_dead
;; Sprite: nina_dead
;; Total Frames: 3
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_NINA_DEAD_7_WIDTH     EQU 16
SPRITE_NINA_DEAD_7_HEIGHT    EQU 16
SPRITE_NINA_DEAD_7_FRAMES    EQU 3

;; ---- Sprite Frame: nina_dead_7_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_7_F0_DATA (32 bytes)
NINA_DEAD_7_F1_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #5F,#4F,#4B,#5B,#5F,#4F,#61,#3B,#0B,#1B,#13,#17,#10,#1E,#08,#0B
    DB #E8,#EC,#A6,#72,#DA,#8A,#8A,#C2,#5E,#CC,#E4,#F4,#84,#BC,#A0,#A0

NINA_DEAD_7_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #000000)
    DB #20,#30,#34,#24,#20,#30,#1E,#04,#04,#04,#0C,#08,#0F,#01,#07,#04
    DB #10,#10,#58,#8C,#24,#74,#74,#3C,#A0,#30,#18,#08,#78,#40,#40,#40

;; ---- End of Frame: nina_dead_7_F1 ----

;; ---- Sprite Frame: nina_dead_7_F2 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_7_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_7_F2_DATA (32 bytes)
SPRITE_7_PATTERN EQU NINA_DEAD_7_F0_LAYER0
SPRITE_7_PATTERN_BANK EQU ((SPRITE_7_PATTERN - #4000) / #2000)

; Sprite Asset 8: nina_idle
;; Sprite: nina_idle
;; Total Frames: 1
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_NINA_IDLE_8_WIDTH     EQU 16
SPRITE_NINA_IDLE_8_HEIGHT    EQU 16
SPRITE_NINA_IDLE_8_FRAMES    EQU 1

;; ---- Sprite Frame: nina_idle_8_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_8_F0_DATA (32 bytes)
SPRITE_8_PATTERN EQU NINA_IDLE_8_F0_LAYER0
...
; Sprite Asset 11: nina_jump_right
...
SPRITE_NINA_JUMP_RIGHT_11_WIDTH     EQU 16
SPRITE_NINA_JUMP_RIGHT_11_HEIGHT    EQU 16
SPRITE_NINA_JUMP_RIGHT_11_FRAMES    EQU 1

;; ---- Sprite Frame: nina_jump_right_11_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_11_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_11_F0_DATA (32 bytes)
SPRITE_11_PATTERN EQU NINA_JUMP_RIGHT_11_F0_LAYER1
SPRITE_11_PATTERN_BANK EQU ((SPRITE_11_PATTERN - #4000) / #2000)

; Sprite Asset 12: nina_land_right
...
SPRITE_NINA_LAND_RIGHT_12_WIDTH     EQU 16
SPRITE_NINA_LAND_RIGHT_12_HEIGHT    EQU 16
SPRITE_NINA_LAND_RIGHT_12_FRAMES    EQU 3

;; ---- Sprite Frame: nina_land_right_12_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F2_DATA (32 bytes)
SPRITE_12_PATTERN EQU NINA_LAND_RIGHT_12_F0_LAYER0
...
sprite_asset_frame_count:
    ...
    db 1 ; Sprite 5: nina_jump_left
    db 3 ; Sprite 6: nina_land_left
    db 3 ; Sprite 7: nina_dead
    db 1 ; Sprite 8: nina_idle
    db 2 ; Sprite 9: anec_left
    db 2 ; Sprite 10: nina_walk_right
    db 1 ; Sprite 11: nina_jump_right
    db 3 ; Sprite 12: nina_land_right
...
sprite_loop_flags:
    ...
    db 0 ; Sprite 5: nina_jump_left
    db 0 ; Sprite 6: nina_land_left
    db 2 ; Sprite 7: nina_dead
    db 2 ; Sprite 8: nina_idle
    db 2 ; Sprite 9: anec_left
    db 0 ; Sprite 10: nina_walk_right
    db 0 ; Sprite 11: nina_jump_right
    db 0 ; Sprite 12: nina_land_right
...
; Sprite 5: nina_jump_left frame pointers
SPRITE_5_FRAME_PTRS:
    dw NINA_JUMP_LEFT_5_F0_LAYER1

; Sprite 6: nina_land_left frame pointers
SPRITE_6_FRAME_PTRS:
    dw NINA_LAND_LEFT_6_F0_LAYER0
    dw NINA_LAND_LEFT_6_F1_LAYER0
    dw NINA_LAND_LEFT_6_F2_LAYER0

; Sprite 7: nina_dead frame pointers
SPRITE_7_FRAME_PTRS:
    dw NINA_DEAD_7_F0_LAYER0
    dw NINA_DEAD_7_F1_LAYER0
    dw NINA_DEAD_7_F2_LAYER0

; Sprite 8: nina_idle frame pointers
SPRITE_8_FRAME_PTRS:
    dw NINA_IDLE_8_F0_LAYER0
...
; Sprite 11: nina_jump_right frame pointers
SPRITE_11_FRAME_PTRS:
    dw NINA_JUMP_RIGHT_11_F0_LAYER1

; Sprite 12: nina_land_right frame pointers
SPRITE_12_FRAME_PTRS:
    dw NINA_LAND_RIGHT_12_F0_LAYER0
    dw NINA_LAND_RIGHT_12_F1_LAYER0
    dw NINA_LAND_RIGHT_12_F2_LAYER0
...
sprite_dir_left_table:
    db 9, 1, 2, 3, 4, 5, 6, 7, 8, 9, 4, 5, 6

sprite_dir_right_table:
    db 0, 1, 2, 3, 10, 11, 12, 7, 8, 0, 10, 11, 12
...
entity_sprite_config: 
    db 0, 1 ; Entity 0 (MISSING_sprite_1771967685919)
...
entity_sprite_asset_index_init:
    db #FF ; Entity 0 (MISSING_sprite_1771967685919)
...
sprite_layer_colors_init:
    ; Entity 0 (MISSING_sprite_1771967685919) layers:
    db 15 ; Layer 0
...
SM_SpriteLayerColorTable:
    ...
    db 15, 2 ; Sprite 5: nina_jump_left
    db 6, 15 ; Sprite 6: nina_land_left
    db 6, 1 ; Sprite 7: nina_dead
    db 6, 15 ; Sprite 8: nina_idle
    db 15, 7 ; Sprite 9: anec_left
    db 6, 15 ; Sprite 10: nina_walk_right
    db 15, 2 ; Sprite 11: nina_jump_right
    db 6, 15 ; Sprite 12: nina_land_right
...
load_sprite_patterns:
    ...
    call mapper_push_p2
    ; Entity 0: MISSING_sprite_1771967685919 (1 layers)
    ; Base HW Sprite: 0
...
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_5_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_LEFT_5_F0 (64 -> 55 bytes)
...
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_6_F0 (64 -> 50 bytes)
    ...
    DB #55,#58
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_6_F1 (64 -> 52 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#58,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#F8,#FE,#F9,#40,#11,#F6,#BF,#C0,#80,#80,#FE,#8D,#F5
    DB #81,#04,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F2_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_6_F2 (64 -> 52 bytes)
    ...
    DB #81,#04,#55,#56
ZX0_SPRITE_FRAME_NINA_DEAD_7_F0_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_7_F0 (64 -> 59 bytes)
...
ZX0_SPRITE_FRAME_NINA_DEAD_7_F2_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_7_F2 (64 -> 54 bytes)
...
ZX0_SPRITE_FRAME_NINA_IDLE_8_F0_DATA:
    ; ZX0 compressed sprite frame NINA_IDLE_8_F0 (64 -> 50 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#5B,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#FA,#B4,#F9,#09,#7B,#CB,#80,#EF,#D3,#FE,#C2,#B5,#10
    DB #55,#58
...
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_11_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_RIGHT_11_F0 (64 -> 56 bytes)
...
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_12_F0 (64 -> 51 bytes)
    ...
    DB #90,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_12_F1 (64 -> 53 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
    DB #01,#F8,#00,#9A,#C0,#40,#C0,#EA,#E0,#EC,#40,#FB,#FF,#CB,#01,#FE
    DB #CF,#FE,#F5,#29,#81,#20,#7F,#F0,#D0,#D8,#F8,#F0,#80,#00,#FD,#FE
    DB #8D,#02,#88,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F2_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_12_F2 (64 -> 52 bytes)
...
; Frame group: NINA_JUMP_LEFT_5_F0
NINA_JUMP_LEFT_5_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_5_F0_DATA
; Frame group: NINA_LAND_LEFT_6_F0
NINA_LAND_LEFT_6_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F0_DATA
; Frame group: NINA_LAND_LEFT_6_F1
NINA_LAND_LEFT_6_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F1_DATA
; Frame group: NINA_LAND_LEFT_6_F2
NINA_LAND_LEFT_6_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_LEFT_6_F2_DATA
; Frame group: NINA_DEAD_7_F0
NINA_DEAD_7_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_7_F0_DATA
; Frame group: NINA_DEAD_7_F2
NINA_DEAD_7_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_7_F2_DATA
; Frame group: NINA_IDLE_8_F0
NINA_IDLE_8_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_IDLE_8_F0_DATA
...
; Frame group: NINA_JUMP_RIGHT_11_F0
NINA_JUMP_RIGHT_11_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_11_F0_DATA
; Frame group: NINA_LAND_RIGHT_12_F0
NINA_LAND_RIGHT_12_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F0_DATA
; Frame group: NINA_LAND_RIGHT_12_F1
NINA_LAND_RIGHT_12_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F1_DATA
; Frame group: NINA_LAND_RIGHT_12_F2
NINA_LAND_RIGHT_12_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_12_F2_DATA
