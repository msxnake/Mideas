...
; Total data bytes (source blocks): 17511
; Zones used: 2
; ------------------------------------------------------------------
; ZONE 00 [#1C000-#20000] bank 6 used=15974 slack=410
...
;   + BEHAVIOR_PAN3_2_DATA (screens) @ +#1D63 size=768
;   + SCREEN_PAN4_3_LAYOUT (screens) @ +#2063 size=768
;   + SCREEN_PAN4_3_EFFECTS_LAYOUT (screens) @ +#2363 size=768
;   + SCREEN_PAN4_3_EFFECT_ZONE_TABLE (screens) @ +#2663 size=1
;   + BEHAVIOR_PAN4_3_DATA (screens) @ +#2664 size=768
;   + SCREEN_PAN5_4_LAYOUT (screens) @ +#2964 size=768
;   + SCREEN_PAN5_4_EFFECTS_LAYOUT (screens) @ +#2C64 size=768
;   + SCREEN_PAN5_4_EFFECT_ZONE_TABLE (screens) @ +#2F64 size=1
;   + BEHAVIOR_PAN5_4_DATA (screens) @ +#2F65 size=768
;   + SCREEN_PAN62_5_LAYOUT (screens) @ +#3265 size=768
;   + SCREEN_PAN62_5_EFFECTS_LAYOUT (screens) @ +#3565 size=768
;   + SCREEN_PAN62_5_EFFECT_ZONE_TABLE (screens) @ +#3865 size=1
;   + BEHAVIOR_PAN62_5_DATA (screens) @ +#3866 size=768
;   + SCREEN_PAN7_6_LAYOUT (screens) @ +#3B66 size=768
; ZONE 01 [#20000-#24000] bank 7 used=1537 slack=14847
;   + SCREEN_PAN7_6_EFFECTS_LAYOUT (screens) @ +#0000 size=768
;   + SCREEN_PAN7_6_EFFECT_ZONE_TABLE (screens) @ +#0300 size=1
;   + BEHAVIOR_PAN7_6_DATA (screens) @ +#0301 size=768

    org #1C000
; ==================================================================
; DATA ZONE 00 (bank 6) used=15974 slack=410
; ==================================================================
; ==================================================================
...
SCREEN_PAN7_6_LAYOUT:
    ...
    org #20000
; ==================================================================
; DATA ZONE 01 (bank 7) used=1537 slack=14847
; ==================================================================
