...
; Estimated payload bytes: 111598
...
; BANK 00 @#08C5 : entities.asm (5372 bytes)
; BANK 00 @#1DC1 : worlds.asm (575 bytes)
; BANK 01 @#0000 : worlds.asm (3425 bytes)
; BANK 01 @#0D61 : screens.asm part 1/3 (4767 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (4567 bytes)
; BANK 03 @#11D7 : sprites.asm part 1/2 (3625 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (6140 bytes)
; BANK 04 @#17FC : font.asm (2052 bytes)
; BANK 05 @#0000 : font.asm (1495 bytes)
; BANK 05 @#05D7 : hud.asm (4339 bytes)
; BANK 05 @#16CA : menus.asm (444 bytes)
; BANK 05 @#1886 : sound.asm (1914 bytes)
; BANK 06 @#0000 : sound.asm (1650 bytes)
; BANK 06 @#0672 : scroll.asm (2353 bytes)
; BANK 06 @#0FA3 : animtiles.asm (4189 bytes)
; BANK 07 @#0000 : animtiles.asm (1727 bytes)
; BANK 07 @#06BF : particles.asm (4963 bytes)
; BANK 07 @#1A22 : statemachine.asm part 1/4 (1502 bytes)
...
; BANK 11 @#0000 : statemachine.asm part 5/4 (4509 bytes)
; BANK 11 @#119D : gameflow.asm part 1/3 (3683 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (5102 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (128 -> 111 bytes)
    ...
    DB #83,#FF,#A9,#FF,#A5,#EA,#5B,#E1,#10,#BB,#7C,#BC,#55,#55,#80
load_pattern_bank0:
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 137 bytes)
    ...
    DB #57,#DE,#80,#C6,#46,#F5,#8D,#80,#7D,#C0,#3F,#F1,#FC,#4E,#C0,#FE
    DB #F0,#40,#A1,#86,#0A,#82,#77,#88,#E7,#A8,#81,#FE,#E1,#80,#EF,#FC
    DB #80,#53,#FD,#FC,#80,#29,#86,#0E,#B0,#5C,#DA,#7E,#82,#3C,#80,#3D
    DB #B0,#E0,#A0,#F8,#FB,#80,#D5,#55,#60
...
; Free RAM buffer for tile pattern data decompression (128 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D800

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (128 bytes)
; ==================================================================
