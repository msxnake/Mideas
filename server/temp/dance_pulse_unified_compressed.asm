...
; BANK 02 @#0000 : sound.asm part 3/2 (2312 bytes)
; BANK 02 @#0908 : scroll.asm (2407 bytes)
; BANK 02 @#126F : animtiles.asm (2549 bytes)
; BANK 02 @#1C64 : bosses.asm (924 bytes)
; BANK 03 @#0000 : bosses.asm (4858 bytes)
; BANK 03 @#12FA : statemachine.asm (5 bytes)
; BANK 03 @#12FF : gameflow.asm (3329 bytes)
; BANK 04 @#0000 : gameflow.asm (1577 bytes)
...
; Flow: Start → Music (gf_dance_music)
; ==================================================================
...
music_track_ptr_table:
    DW music_track_0_Dance_Pulse_data

; ------------------------------------------------------------------
; Tracker Song 0: Dance Pulse
; ------------------------------------------------------------------
music_track_0_Dance_Pulse_data:
    DB #05
    DB #02
    DB #00
    DB #01
    DB #02
    DW music_track_0_Dance_Pulse_order_table
    DW music_track_0_Dance_Pulse_pattern_table
    DW music_track_0_Dance_Pulse_instrument_ptr_table
    DW music_track_0_Dance_Pulse_ornament_ptr_table
    DW #00D2
    DB #0C

music_track_0_Dance_Pulse_order_table:
    DB #00,#01

music_track_0_Dance_Pulse_pattern_table:
    DW music_track_0_Dance_Pulse_pattern_0_rows
    DB #40
    DW music_track_0_Dance_Pulse_pattern_1_rows
    DB #40

music_track_0_Dance_Pulse_instrument_ptr_table:
    DW 0
    DW music_track_0_Dance_Pulse_inst_1
    DW music_track_0_Dance_Pulse_inst_2
    DW 0
    DW 0
    DW music_track_0_Dance_Pulse_inst_5
    DW music_track_0_Dance_Pulse_inst_6
    DW music_track_0_Dance_Pulse_inst_7
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_Dance_Pulse_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_Dance_Pulse_pattern_0_rows:
    DB #34,#01,#FF,#0F,#1C,#02,#FF,#0F,#1C,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#1C,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#17,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#1C,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#21,#02,#FF,#0F,#1C,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#21,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1C,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#21,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#18,#02,#FF,#0F,#1C,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#18,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#13,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#18,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#17,#02,#FF,#0F,#1C,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#17,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#12,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#17,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_Dance_Pulse_pattern_1_rows:
    DB #3B,#01,#FF,#0F,#17,#02,#FF,#0F,#23,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#17,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#12,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#17,#02,#FF,#0F,#1E,#07,#FF,#0B
    ...
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#18,#02,#FF,#0F,#23,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#18,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#13,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#18,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#1A,#02,#FF,#0F,#23,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#1A,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#15,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#1A,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1C,#02,#FF,#0F,#23,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#1C,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #4A,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #4C,#01,#FF,#0F,#17,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #4A,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#1C,#02,#FF,#0F,#1E,#07,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_Dance_Pulse_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #0C
    DW #00D2
    DW music_track_0_Dance_Pulse_inst_1_vol_env
    DB #0A
    DB #FF
    DW music_track_0_Dance_Pulse_inst_1_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_Dance_Pulse_inst_1_vol_env:
    DB #0F,#0E,#0D,#0C,#0A,#08,#06,#04,#02,#00
music_track_0_Dance_Pulse_inst_1_tone_env:
    DB #00

music_track_0_Dance_Pulse_inst_2:
    DB #01
    DB #0F
    DB #00
    DB #0C
    DW #00D2
    DW music_track_0_Dance_Pulse_inst_2_vol_env
    DB #08
    DB #FF
    DW music_track_0_Dance_Pulse_inst_2_tone_env
    DB #03
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_Dance_Pulse_inst_2_vol_env:
    DB #0F,#0F,#0D,#0B,#08,#05,#02,#00
music_track_0_Dance_Pulse_inst_2_tone_env:
    DB #00,#FF,#00

music_track_0_Dance_Pulse_inst_5:
    DB #03
    DB #0F
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_Dance_Pulse_inst_5_vol_env
    DB #06
    DB #FF
    DW music_track_0_Dance_Pulse_inst_5_tone_env
    DB #04
    DB #FF
    DW music_track_0_Dance_Pulse_inst_5_noise_env
    DB #04
    DB #FF
music_track_0_Dance_Pulse_inst_5_vol_env:
    DB #0F,#0E,#0C,#09,#05,#00
music_track_0_Dance_Pulse_inst_5_tone_env:
    DB #E2,#EE,#F8,#00
music_track_0_Dance_Pulse_inst_5_noise_env:
    DB #02,#04,#08,#10

music_track_0_Dance_Pulse_inst_6:
    DB #02
    DB #0E
    DB #00
    DB #09
    DW #00D2
    DW music_track_0_Dance_Pulse_inst_6_vol_env
    DB #06
    DB #FF
    DW music_track_0_Dance_Pulse_inst_6_tone_env
    DB #01
    DB #FF
    DW music_track_0_Dance_Pulse_inst_6_noise_env
    DB #04
    DB #FF
music_track_0_Dance_Pulse_inst_6_vol_env:
    DB #0E,#0C,#09,#06,#03,#00
music_track_0_Dance_Pulse_inst_6_tone_env:
    DB #00
music_track_0_Dance_Pulse_inst_6_noise_env:
    DB #08,#0C,#12,#1A

music_track_0_Dance_Pulse_inst_7:
    DB #02
    DB #0A
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_Dance_Pulse_inst_7_vol_env
    DB #05
    DB #FF
    DW music_track_0_Dance_Pulse_inst_7_tone_env
    DB #01
    DB #FF
    DW music_track_0_Dance_Pulse_inst_7_noise_env
    DB #04
    DB #FF
music_track_0_Dance_Pulse_inst_7_vol_env:
    DB #0A,#08,#06,#03,#00
music_track_0_Dance_Pulse_inst_7_tone_env:
    DB #00
music_track_0_Dance_Pulse_inst_7_noise_env:
    DB #02,#03,#04,#06
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_dance_start
...
; Node: Start - "gf_dance_start"
gameflow_node_gf_dance_start:
    db NODE_TYPE_START
    dw gameflow_node_gf_dance_start_data
    dw gameflow_node_gf_dance_start_conn

gameflow_node_gf_dance_start_data:
    dw gameflow_node_gf_dance_start_init    ; Initialization routine address
    db ((gameflow_node_gf_dance_start_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_dance_start_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_dance_music
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_dance_start_init
...
; Node: Music - "gf_dance_music"
gameflow_node_gf_dance_music:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gf_dance_music_data
    dw gameflow_node_gf_dance_music_conn

gameflow_node_gf_dance_music_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gf_dance_music_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_dance_end
    db CONNECTION_END

; Node: End - "gf_dance_end"
gameflow_node_gf_dance_end:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gf_dance_end_conn

gameflow_node_gf_dance_end_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
