...
; BANK 01 @#0000 : screens.asm (6181 bytes)
; BANK 01 @#1825 : sprites.asm (2011 bytes)
; BANK 02 @#0000 : sprites.asm (1838 bytes)
; BANK 02 @#072E : font.asm (3456 bytes)
; BANK 02 @#14AE : hud.asm (2898 bytes)
; BANK 03 @#0000 : hud.asm (582 bytes)
; BANK 03 @#0246 : menus.asm (168 bytes)
; BANK 03 @#02EE : sound.asm part 1/2 (7442 bytes)
; BANK 04 @#0000 : sound.asm part 2/2 (2106 bytes)
; BANK 04 @#083A : scroll.asm (2353 bytes)
; BANK 04 @#116B : animtiles.asm (3733 bytes)
; BANK 05 @#0000 : animtiles.asm (1547 bytes)
; BANK 05 @#060B : statemachine.asm part 1/2 (6645 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/2 (4379 bytes)
; BANK 06 @#111B : gameflow.asm (3813 bytes)
; BANK 07 @#0000 : gameflow.asm (2208 bytes)
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (432 -> 84 bytes)
    DB #95,#FF,#8E,#80,#81,#FD,#23,#82,#83,#FE,#F5,#E9,#F5,#E0,#1F,#C0
    DB #5F,#EC,#F9,#F9,#B0,#7F,#F0,#80,#66,#E4,#DE,#A5,#85,#F5,#A8,#F9
    DB #CF,#DC,#7F,#E7,#3C,#79,#40,#77,#F4,#5E,#04,#1E,#16,#07,#C7,#3C
    DB #9F,#90,#BC,#17,#75,#7C,#FF,#F8,#5A,#07,#DA,#E4,#FF,#7D,#E6,#A7
    DB #81,#DC,#CC,#85,#90,#A4,#85,#78,#DC,#CC,#50,#4F,#C2,#C8,#30,#1F
    DB #E0,#75,#55,#58
SCREEN_PAN1_0_BLOCK_MAP:
    ; ZX0 compressed screen_block_map (48 -> 42 bytes)
    DB #96,#00,#21,#01,#02,#80,#1D,#03,#04,#00,#05,#00,#06,#07,#08,#09
    DB #0A,#0B,#0C,#0D,#0E,#00,#0F,#10,#04,#11,#12,#00,#13,#14,#00,#10
    DB #15,#16,#17,#18,#19,#1A,#15,#1A,#55,#56
