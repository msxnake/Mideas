...
; BANK 06 @#0000 : bosses.asm part 3/2 (1096 bytes)
; BANK 06 @#0448 : statemachine.asm (5 bytes)
; BANK 06 @#044D : gameflow.asm (6064 bytes)
...
boss_initial_phase_index EQU #C01D   ; Active boss initial phase index
boss_width          EQU #C01E   ; Active boss width in chars
boss_height         EQU #C01F   ; Active boss height in chars
boss_draw_row       EQU #C020   ; Boss tile draw row scratch
boss_draw_col       EQU #C021   ; Boss tile draw column scratch
boss_draw_char      EQU #C022   ; Boss tile draw char scratch
boss_draw_screen_x  EQU #C023   ; Boss tile draw screen X scratch
boss_draw_screen_y  EQU #C024   ; Boss tile draw screen Y scratch
boss_meteor_age     EQU #C025   ; Boss meteor cycle age
boss_meteor_count   EQU #C026   ; Active meteor lanes
boss_meteor_index   EQU #C027   ; Current meteor lane index
boss_meteor_base_x  EQU #C028   ; First meteor lane X
boss_meteor_base_y  EQU #C029   ; Meteor spawn Y
boss_meteor_sprite_slot EQU #C02A   ; First HW sprite slot for meteors
boss_meteor_color   EQU #C02B   ; Meteor sprite color
boss_meteor_pattern EQU #C02C   ; Meteor base pattern
boss_meteor_speed   EQU #C02D   ; Meteor fall speed
boss_meteor_range   EQU #C02E   ; Meteor fall range
boss_meteor_spread  EQU #C02F   ; Meteor lane spacing
boss_meteor_warn    EQU #C030   ; Meteor warning frames
boss_bomb_age       EQU #C031   ; Boss bomb cycle age
boss_bomb_count     EQU #C032   ; Active bomb lanes
boss_bomb_index     EQU #C033   ; Current bomb lane index
boss_bomb_base_x    EQU #C034   ; First bomb lane X
boss_bomb_base_y    EQU #C035   ; Bomb spawn Y
boss_bomb_sprite_slot EQU #C036   ; First HW sprite slot for bombs
boss_bomb_color     EQU #C037   ; Bomb sprite color
boss_bomb_pattern   EQU #C038   ; Bomb base pattern
boss_bomb_explosion_pattern EQU #C039   ; Bomb explosion pattern
boss_bomb_spread    EQU #C03A   ; Bomb lane spacing
boss_bomb_fuse      EQU #C03B   ; Bomb fuse frames
boss_bomb_radius    EQU #C03C   ; Bomb explosion radius
boss_bomb_duration  EQU #C03D   ; Bomb explosion active frames
boss_boomerang_age  EQU #C03E   ; Boss boomerang cycle age
boss_boomerang_base_x EQU #C03F   ; Boomerang origin X
boss_boomerang_base_y EQU #C040   ; Boomerang origin Y
boss_boomerang_sprite_slot EQU #C041   ; HW sprite slot for boomerang
boss_boomerang_color EQU #C042   ; Boomerang sprite color
boss_boomerang_pattern EQU #C043   ; Boomerang base pattern
boss_boomerang_speed EQU #C044   ; Boomerang speed
boss_boomerang_range EQU #C045   ; Boomerang max distance
boss_boomerang_distance EQU #C046   ; Current boomerang distance from origin
boss_boomerang_direction EQU #C047   ; Boomerang direction
boss_rock_age       EQU #C048   ; Boss rock cycle age
boss_rock_base_x    EQU #C049   ; Rock origin X
boss_rock_base_y    EQU #C04A   ; Rock origin Y
boss_rock_sprite_slot EQU #C04B   ; HW sprite slot for rock
boss_rock_color     EQU #C04C   ; Rock sprite color
boss_rock_pattern   EQU #C04D   ; Rock base pattern
boss_rock_speed     EQU #C04E   ; Rock speed
boss_rock_range     EQU #C04F   ; Rock max travel distance
boss_rock_distance  EQU #C050   ; Current rock distance from origin
boss_rock_direction EQU #C051   ; Rock direction
boss_rock_arc_height EQU #C052   ; Rock parabolic arc height
boss_rock_arc_offset EQU #C053   ; Current rock arc offset
boss_laser_age      EQU #C054   ; Boss laser cycle age
boss_laser_base_x   EQU #C055   ; Laser origin X in pixels
boss_laser_base_y   EQU #C056   ; Laser origin Y in pixels
boss_laser_tile_char EQU #C057   ; Laser beam char code
boss_laser_length   EQU #C058   ; Laser length in chars
boss_laser_duration EQU #C059   ; Laser active frames
boss_laser_direction EQU #C05A   ; Laser direction
boss_laser_index    EQU #C05B   ; Current laser char index
boss_laser_origin_tile_x EQU #C05C   ; Laser origin tile X
boss_laser_origin_tile_y EQU #C05D   ; Laser origin tile Y
boss_laser_tile_x   EQU #C05E   ; Current laser tile X
boss_laser_tile_y   EQU #C05F   ; Current laser tile Y
boss_laser_write_mode EQU #C060   ; 0=draw laser, 1=restore map
boss_wave_age       EQU #C061   ; Boss sine-wave projectile cycle age
boss_wave_base_x    EQU #C062   ; Sine-wave projectile origin X
boss_wave_base_y    EQU #C063   ; Sine-wave projectile origin Y
boss_wave_sprite_slot EQU #C064   ; HW sprite slot for sine-wave projectile
boss_wave_color     EQU #C065   ; Sine-wave projectile sprite color
boss_wave_pattern   EQU #C066   ; Sine-wave projectile base pattern
boss_wave_speed     EQU #C067   ; Sine-wave projectile speed
boss_wave_range     EQU #C068   ; Sine-wave projectile max travel distance
boss_wave_distance  EQU #C069   ; Current sine-wave projectile distance
boss_wave_direction EQU #C06A   ; Sine-wave projectile direction
boss_wave_amplitude EQU #C06B   ; Sine-wave perpendicular amplitude
boss_wave_frequency EQU #C06C   ; Frames per sine-wave phase step
boss_wave_phase     EQU #C06D   ; Current sine-wave phase index
boss_wave_offset    EQU #C06E   ; Signed sine-wave perpendicular offset
boss_homing_age     EQU #C06F   ; Boss homing missile cycle age
boss_homing_base_x  EQU #C070   ; Homing missile origin X
boss_homing_base_y  EQU #C071   ; Homing missile origin Y
boss_homing_sprite_slot EQU #C072   ; HW sprite slot for homing missile
boss_homing_color   EQU #C073   ; Homing missile sprite color
boss_homing_pattern EQU #C074   ; Homing missile base pattern
boss_homing_speed   EQU #C075   ; Homing missile speed
boss_homing_range   EQU #C076   ; Homing missile max travel distance
boss_homing_distance EQU #C077   ; Current homing missile distance
boss_homing_direction EQU #C078   ; Homing missile launch direction
boss_homing_turn_step EQU #C079   ; Homing missile steering strength
boss_homing_turn_distance EQU #C07A   ; Homing missile steering distance
autocontrol_screen_id EQU #C07B   ; Screen id bound to current FakePlayer script
autocontrol_entity_index EQU #C07C   ; Active FakePlayer entity index (#FF=none)
autocontrol_script_ptr_l EQU #C07D   ; Current FakePlayer script pointer low byte
autocontrol_script_ptr_h EQU #C07E   ; Current FakePlayer script pointer high byte
autocontrol_script_start_l EQU #C07F   ; FakePlayer script start pointer low byte
autocontrol_script_start_h EQU #C080   ; FakePlayer script start pointer high byte
autocontrol_wait_frames EQU #C081   ; FakePlayer wait countdown in frames
autocontrol_move_opcode EQU #C082   ; Active FakePlayer movement opcode
autocontrol_move_remaining EQU #C083   ; Remaining FakePlayer movement pixels
autocontrol_loop_flag EQU #C084   ; 1=loop FakePlayer script on END
autocontrol_active EQU #C085   ; 1=FakePlayer script active
autoev_screen_id EQU #C086   ; Screen id bound to compact FakePlayer event script
autoev_entity_index EQU #C087   ; Active compact FakePlayer entity index (#FF=none)
autoev_script_ptr_l EQU #C088   ; Compact FakePlayer event pointer low byte
autoev_script_ptr_h EQU #C089   ; Compact FakePlayer event pointer high byte
autoev_script_start_l EQU #C08A   ; Compact FakePlayer event start pointer low byte
autoev_script_start_h EQU #C08B   ; Compact FakePlayer event start pointer high byte
autoev_wait_frames EQU #C08C   ; Compact FakePlayer wait countdown in frames
autoev_move_axis EQU #C08D   ; Compact move axis (1=x,2=y)
autoev_move_step EQU #C08E   ; Compact move step (1 or #FF)
autoev_move_remaining EQU #C08F   ; Remaining compact FakePlayer movement pixels
autoev_loop_flag EQU #C090   ; 1=loop compact FakePlayer event script
autoev_active EQU #C091   ; 1=compact FakePlayer event script active
autoev_wait_mode EQU #C092   ; 1=wait SPC, 2=wait typewriter
autoev_number_l EQU #C093   ; Parsed compact event number low byte
autoev_number_h EQU #C094   ; Parsed compact event number high byte
dialogue_active    EQU #C095   ; 1=dialogue box is open
dialogue_current_box EQU #C096   ; Current dialogue box config index
dialogue_text_active EQU #C097   ; 1=typewriter is writing text
dialogue_text_ptr_l EQU #C098   ; Dialogue typewriter text pointer low byte
dialogue_text_ptr_h EQU #C099   ; Dialogue typewriter text pointer high byte
dialogue_vram_ptr_l EQU #C09A   ; Dialogue typewriter VRAM pointer low byte
dialogue_vram_ptr_h EQU #C09B   ; Dialogue typewriter VRAM pointer high byte
dialogue_row_start_l EQU #C09C   ; Current dialogue row start VRAM low byte
dialogue_row_start_h EQU #C09D   ; Current dialogue row start VRAM high byte
dialogue_char_delay EQU #C09E   ; Dialogue character delay countdown
dialogue_char_delay_reload EQU #C09F   ; Dialogue character delay reload value
dialogue_box_vram_l EQU #C0A0   ; Dialogue box VRAM start low byte
dialogue_box_vram_h EQU #C0A1   ; Dialogue box VRAM start high byte
dialogue_box_width EQU #C0A2   ; Dialogue box width in chars
dialogue_box_height EQU #C0A3   ; Dialogue box height in chars
dialogue_box_tl_char EQU #C0A4   ; Dialogue top-left border char
dialogue_box_tr_char EQU #C0A5   ; Dialogue top-right border char
dialogue_box_bl_char EQU #C0A6   ; Dialogue bottom-left border char
dialogue_box_br_char EQU #C0A7   ; Dialogue bottom-right border char
dialogue_box_h_char EQU #C0A8   ; Dialogue horizontal border char
dialogue_box_v_char EQU #C0A9   ; Dialogue vertical border char
dialogue_graphic_enabled EQU #C0AA   ; 1=dialogue tile graphic is visible
dialogue_graphic_vram_l EQU #C0AB   ; Dialogue graphic VRAM start low byte
dialogue_graphic_vram_h EQU #C0AC   ; Dialogue graphic VRAM start high byte
dialogue_graphic_ptr_l EQU #C0AD   ; Dialogue graphic tile data pointer low byte
dialogue_graphic_ptr_h EQU #C0AE   ; Dialogue graphic tile data pointer high byte
dialogue_graphic_width EQU #C0AF   ; Dialogue graphic width in chars
dialogue_graphic_height EQU #C0B0   ; Dialogue graphic height in chars
current_flow_state  EQU #C0B1   ; Current game flow state
prev_flow_state     EQU #C0B2   ; Previous game flow state
gameflow_exit_requested EQU #C0B3   ; Exit flag for WorldLink loop
gameflow_menu_selection EQU #C0B4   ; Current/last submenu selection
gameflow_submenu_data_ptr EQU #C0B5   ; Pointer to active submenu data (16-bit)
gameflow_submenu_option_count EQU #C0B7   ; Cached submenu option count
gameflow_submenu_cursor_enabled EQU #C0B8   ; 1 when submenu uses sprite cursor
gameflow_submenu_cursor_layer_count EQU #C0B9   ; Cursor sprite layer count (1..4)
gameflow_condition_result EQU #C0BA   ; Result of last condition evaluation
transition_delay_var    EQU #C0BB   ; Frames per step for active transition effect

; ==================================================================
; MIDEAS GLOBAL VARIABLES (DEFAULTS + CUSTOM)
; ==================================================================
global_var_goal     EQU #C0BC   ; Goal status (0=Failure, 1=Completed)

; ==================================================================
; SYSTEM VARIABLES
; ==================================================================
ROM_slot            EQU #C0BD   ; Expanded slot for normal page 1 ROM access
slot_primary_normal EQU #C0BE   ; Primary slot register snapshot for BIOS-ROM-ROM-RAM layout
page0_bios_slot     EQU #C0BF   ; Expanded slot for normal BIOS page 0
page2_normal_slot   EQU #C0C0   ; Expanded slot for normal page 2 layout
page3_normal_slot   EQU #C0C1   ; Expanded slot for normal RAM page 3
mapper_bank_p1_current EQU #C0C2   ; Mapper current bank for page/window 1
mapper_bank_p2_current EQU #C0C3   ; Mapper current bank for page/window 2
mapper_bank_p3_current EQU #C0C4   ; Mapper current bank for page/window 3
mapper_bank_p4_current EQU #C0C5   ; Mapper current bank for page/window 4
mapper_saved_bank    EQU #C0C6   ; Saved mapper bank for push/pop helpers
mapper_saved_bank_p1 EQU #C0C7   ; Saved mapper bank for page/window 1 helpers
mapper_saved_bank_p3 EQU #C0C8   ; Saved mapper bank for page/window 3 helpers
mapper_saved_bank_p4 EQU #C0C9   ; Saved mapper bank for page/window 4 helpers
resource_descriptor_ptr EQU #C0CA   ; Pointer to cached resource descriptor entry (16-bit)
resource_descriptor_id EQU #C0CC   ; Cached resource id
resource_descriptor_type EQU #C0CD   ; Cached resource type
resource_descriptor_group EQU #C0CE   ; Cached resource group
resource_descriptor_bank EQU #C0CF   ; Cached resource bank
resource_descriptor_addr EQU #C0D0   ; Cached resource visible address (16-bit)
resource_descriptor_size EQU #C0D2   ; Cached resource size (16-bit)
vram_cache_tile_patterns_ready EQU #C0D4   ; 1 when shared gameplay tile patterns are already resident in VRAM
vram_cache_tile_colors_ready EQU #C0D5   ; 1 when shared gameplay tile colors are already resident in VRAM
vram_cache_font_ready EQU #C0D6   ; 1 when shared font patterns/colors are already resident in VRAM
current_screen2_tilebank_id EQU #C0D7   ; Current SCREEN 2 shared tilebank loaded in VRAM (#FF=none/unknown)
frame_counter       EQU #C0D8   ; Frame counter (16-bit)

; Profiling counters (16-bit, cumulative)
prof_update_all_entities_calls EQU #C0DA   ; Calls to update_all_entities
prof_execute_sm_calls EQU #C0DC   ; Calls to execute_all_state_machines
prof_sm_update_calls  EQU #C0DE   ; Calls to SM_Update
prof_collision_calls  EQU #C0E0   ; Calls to update_collision_component
prof_wall_calls       EQU #C0E2   ; Calls to update_wallcollision_component
prof_deadly_calls     EQU #C0E4   ; Calls to update_deadly_tiles_component
prof_tile_interaction_calls EQU #C0E6   ; Calls to check_tile_interaction
prof_animation_calls  EQU #C0E8   ; Calls to update_animation_component
prof_sprite_calls     EQU #C0EA   ; Calls to update_sprite_component
prof_music_task_calls EQU #C0EC   ; Calls to task_update_music
prof_deadly_behavior_reads EQU #C0EE   ; Deadly helper behavior-map reads
; page0_transfer_buffer shares the ZX0 scratch area declared near RAM_USAGE_END.

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C0F0   ; Pointer to current screen layout data (16-bit)
current_screen_layout_bank EQU #C0F2   ; Mapper bank for current screen layout data
current_behavior_map    EQU #C0F3   ; Pointer to current behavior map data (16-bit)
current_behavior_map_bank EQU #C0F5   ; Mapper bank for current behavior map data
behavior_cache_row     EQU #C0F6   ; Cached behavior row (255=invalid)
behavior_cache_map_l   EQU #C0F7   ; Cached behavior map pointer low byte
behavior_cache_map_h   EQU #C0F8   ; Cached behavior map pointer high byte
behavior_cache_row_base EQU #C0F9   ; Cached row base address in behavior map (16-bit)
RUNTIME_SCREEN_MAP_SIZE EQU 768
MAX_RUNTIME_EFFECT_ZONES EQU 0
runtime_background_layout EQU #C0FB   ; Immutable copy of current background layout (32x24)
runtime_screen_layout  EQU #C3FB   ; Mutable copy of current screen layout (32x24)
runtime_behavior_map   EQU #C6FB   ; Mutable copy of current behavior map (32x24)
runtime_interaction_type_map EQU #C9FB   ; Mutable copy of current interaction type map (32x24)
runtime_interaction_value_map EQU #CCFB   ; Mutable copy of current interaction value map (32x24)
runtime_interaction_target_map EQU #CFFB   ; Mutable copy of current interaction target map (32x24)
runtime_char_behavior_table EQU #D2FB   ; Current screen char -> behavior lookup table (256 bytes)
runtime_effects_layout EQU #D3FB   ; Alternate effects layout copy for secret zones (32x24)
screen_block_catalog_ptr EQU #D6FB   ; Scratch pointer to current screen block catalog during layout expansion
screen_block_map_ptr EQU #D6FD   ; Scratch pointer to current screen block index map during layout expansion
runtime_effect_zone_table EQU #D6FF   ; Current screen effect zone table (0 bytes)
current_effect_zone_count EQU #D6FF   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #D700   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #D701   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #D702   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #D703   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #D704   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #D705   ; Camera X position in pixels (16-bit)
camera_y            EQU #D707   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #D709   ; Camera tile X (column)
camera_tile_y       EQU #D70A   ; Camera tile Y (row)
world_width_tiles   EQU #D70B   ; World width in tiles
world_height_tiles  EQU #D70C   ; World height in tiles
scroll_dirty_flag   EQU #D70D   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #D70E   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #D70F   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #D710   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #D712   ; Animation frame timer
anim_tile_frame     EQU #D713   ; Current animation frame (0-3)
anim_tile_speed     EQU #D714   ; Frames between animation updates
anim_tile_transform_flags EQU #D715   ; Runtime flags for transform-mode tile animation (byte0=flags, byte1=opcode scratch)
anim_tile_row_buffer EQU #D717   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #D71F   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #D73F   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_button_contact_active EQU #D75F   ; 1 while entity stays on the same button tile (32 bytes)
entity_button_contact_x EQU #D77F   ; Button tile X currently latched per entity (32 bytes)
entity_button_contact_y EQU #D79F   ; Button tile Y currently latched per entity (32 bytes)
entity_on_ladder   EQU #D7BF   ; 1 while entity is centered on a ladder tile (32 bytes)
entity_gate_current_step EQU #D7DF   ; Current applied retract step (32 bytes)
entity_gate_step_timer EQU #D7FF   ; Countdown until next retract step (32 bytes)
entity_walljump_lock EQU #D81F   ; Remaining horizontal lock frames after wall jump (32 bytes)
entity_walljump_locked_vx EQU #D83F   ; Horizontal velocity preserved while wall jump lock is active (32 bytes)
entity_wallgrab_active EQU #D85F   ; 1 if entity is currently grabbing a wall (32 bytes)
entity_wallgrab_grace EQU #D87F   ; Frames to keep wall grab during transient wall flag gaps (32 bytes)
entity_wallgrab_timer EQU #D89F   ; Remaining wall-grab frames until grounded reset (32 bytes)
entity_wallgrab_lockout EQU #D8BF   ; Wall grab disabled until grounded after timer is spent (32 bytes)
entity_walljump_anim_active EQU #D8DF   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_x_pos        EQU #D8FF   ; Entity X positions (32 bytes)
entity_y_pos        EQU #D91F   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #D93F   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #D95F   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #D97F   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #D99F   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #D9BF   ; Entity screen ID (32 bytes)
entity_job_period   EQU #D9DF   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #D9FF   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DA1F   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DA20   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DA40   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DA60   ; Entity health (32 bytes)
entity_anim_frame   EQU #DA80   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DAA0   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DAC0   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DAE0   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DB00   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DB20   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DB40   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DB60   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DB80   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DBA0   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DBC0   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_collectible_enabled EQU #DBE0   ; 1 when entity has Collectible component (32 bytes)
entity_carried_by   EQU #DC00   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #DC20   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #DC40   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #DC60   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #DC80   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #DCA0   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #DCC0   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #DCE0   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #DD00   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #DD20   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #DD40   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #DD60   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #DD80   ; Number of sprites currently active
sprites_dirty      EQU #DD81   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #DD82   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #DDA2   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #DDC2   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_layer_y_offsets EQU #DDE2   ; HW sprite layer signed Y offsets - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #DE02   ; Runtime base 16x16 slot per sprite asset (1 bytes)
sprite_placeholder_base_pattern_num EQU #DE03   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #DE04   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #DE05   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #DE85   ; Currently displayed screen ID
current_screen_engine EQU #DE86   ; Runtime engine: 0=Player, 1=FakePlayer
screen_dirty_flag   EQU #DE87   ; Screen needs redraw flag
screen_transition_cooldown EQU #DE88   ; Cooldown frames after screen transition
current_world_id    EQU #DE89   ; Current world ID (for multi-world support)
current_screen_index EQU #DE8A   ; Current screen index within world
current_screen_anim_group_count EQU #DE8B   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #DE8C   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #DE8D   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #DE8E   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #DE8F   ; Player X position (16-bit)
player_y            EQU #DE91   ; Player Y position (16-bit)
player_runtime_enabled EQU #DE93   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #DE94   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #DE95   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #DE96   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #DE97   ; Player health points
player_score        EQU #DE98   ; Player score (16-bit)
gem_count           EQU #DE9A   ; Collectible tile counter (8-bit)
last_interaction_char EQU #DE9B   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #DE9C   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #DE9D   ; Interaction type id of last interacted tile
last_interaction_value EQU #DE9E   ; Interaction value byte of last interacted tile
last_interaction_target EQU #DE9F   ; Interaction target id of last interacted tile
last_interaction_x  EQU #DEA0   ; Tile X coordinate of last interaction
last_interaction_y  EQU #DEA1   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #DEA2   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #DEA3   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #DEA4   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #DEE4   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #DF24   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #DF64   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #DFA4   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #DFB4   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #DFC4   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #DFD4   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #DFE4   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #DFF4   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E004   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E005   ; Temporary 16-bit storage
temp_word_2         EQU #E007   ; Temporary 16-bit storage
temp_byte_1         EQU #E009   ; Temporary 8-bit storage
temp_byte_2         EQU #E00A   ; Temporary 8-bit storage
temp_byte_3         EQU #E00B   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E02B   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E04B   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E06B   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E08B   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E08C   ; Frames remaining for current SFX
sfx_fadeout         EQU #E08D   ; Reserved fadeout flag/state
temp_byte_7         EQU #E08E   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E0AE   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E0CE   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E0EE   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E10E   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E12E   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E14E   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E16E   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E18E   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E1AE   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E1CE   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E1EE   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E20E   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E22E   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E24E   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E26E   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E28E   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E2AE   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E2CE   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E2EE   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E32E   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E36E   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E38E   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E3AE   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E3CE   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E3CF   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E3D0   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E3D1   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E3D2   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E3D3   ; Cached entity X for wall checks
wall_temp_y         EQU #E3D4   ; Cached entity Y for wall checks
wall_hit_left       EQU #E3D5   ; Hitbox left edge cache
wall_hit_top        EQU #E3D6   ; Hitbox top edge cache
wall_hit_right      EQU #E3D7   ; Hitbox right edge cache
wall_hit_bottom     EQU #E3D8   ; Hitbox bottom edge cache
wall_hit_w          EQU #E3D9   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E3DA   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E3DB   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E3DC   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E3DD   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E3DE   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E3DF   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E3FF   ; Number of entries in active_entity_list
hero_entity_id      EQU #E400   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E401   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E402   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E422   ; Number of entries in input_entity_list
render_entity_list  EQU #E423   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E443   ; Number of entries in render_entity_list
collision_entity_list EQU #E444   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E464   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E465   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E485   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E486   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E4A6   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E4A7   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E4C7   ; Number of entities in coll_list
coll_src_left       EQU #E4C8   ; Source AABB left edge (scratch)
coll_src_right      EQU #E4C9   ; Source AABB right edge (scratch)
coll_src_top        EQU #E4CA   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E4CB   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E4CC   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E4CC   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E4CE   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E4D0   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E4D2   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E4D4   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E4D6   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E4D8   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E4DA   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E4DC   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E4DD   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E4E2   ; Frame counter (16-bit)
task_exec_time          EQU #E4E4   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E4E6   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E4E7   ; 1 while the H.TIMI dispatcher is running
RAM_INTERRUPT_END       EQU #E4E8   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E4E8   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E4E9   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E4EA   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E4EB   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E4EC   ; 0=stopped, 1=track active
music_muted          EQU #E4ED   ; 0=audible, 1=muted/pause
music_loop           EQU #E4EE   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E4EF   ; Current ROM track index
music_row_frames     EQU #E4F0   ; Frames per tracker row
music_row_countdown  EQU #E4F1   ; Countdown to next row
music_order_pos      EQU #E4F2   ; Current order position
music_pattern_index  EQU #E4F3   ; Current pattern index
music_pattern_row    EQU #E4F4   ; Current row inside pattern
music_pattern_rows   EQU #E4F5   ; Cached rows in current pattern
music_track_ptr_l    EQU #E4F6   ; Current track pointer low byte
music_track_ptr_h    EQU #E4F7   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E4F8   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E4F9   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E4FA   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E4FB   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E4FC   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E4FD   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E4FE   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E4FE   ; Channel A
music_ch_b_note EQU #E4FF   ; Channel B
music_ch_c_note EQU #E500   ; Channel C
music_ch_instrument_base EQU #E501   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E501   ; Channel A
music_ch_b_instrument EQU #E502   ; Channel B
music_ch_c_instrument EQU #E503   ; Channel C
music_ch_ornament_base EQU #E504   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E504   ; Channel A
music_ch_b_ornament EQU #E505   ; Channel B
music_ch_c_ornament EQU #E506   ; Channel C
music_ch_volume_base EQU #E507   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E507   ; Channel A
music_ch_b_volume EQU #E508   ; Channel B
music_ch_c_volume EQU #E509   ; Channel C
music_ch_vol_step_base EQU #E50A   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E50A   ; Channel A
music_ch_b_vol_step EQU #E50B   ; Channel B
music_ch_c_vol_step EQU #E50C   ; Channel C
music_ch_tone_step_base EQU #E50D   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E50D   ; Channel A
music_ch_b_tone_step EQU #E50E   ; Channel B
music_ch_c_tone_step EQU #E50F   ; Channel C
music_ch_noise_step_base EQU #E510   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E510   ; Channel A
music_ch_b_noise_step EQU #E511   ; Channel B
music_ch_c_noise_step EQU #E512   ; Channel C
music_ch_orn_step_base EQU #E513   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E513   ; Channel A
music_ch_b_orn_step EQU #E514   ; Channel B
music_ch_c_orn_step EQU #E515   ; Channel C
music_ch_hw_env_step_base EQU #E516   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E516   ; Channel A
music_ch_b_hw_env_step EQU #E517   ; Channel B
music_ch_c_hw_env_step EQU #E518   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E519   ; End of project variables (9497 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E519: Project variables (9497 bytes)
;   #E519-#E600: Alignment padding/free RAM (231 bytes)
...
boss_0_new_boss_phase_0:
    ...
    dw boss_0_new_boss_phase_0_tiles, boss_0_new_boss_phase_0_collision, boss_0_new_boss_phase_0_neck, boss_0_new_boss_phase_0_crush, boss_0_new_boss_phase_0_attacks    ; tileMatrix,collision,neck,crush,attacks
