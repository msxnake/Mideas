...
; BANK 08 @#06BF : gameflow.asm (6129 bytes)
...
SCREEN_PAN1_0_BLOCK_CATALOG_COUNT EQU 25
SCREEN_PAN1_0_BLOCK_CATALOG_SIZE EQU 400
...
SCREEN_PAN1_0_BLOCK_TOTAL_SIZE EQU 448
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (400 -> 122 bytes)
    ...
    DB #FF,#E6,#7E,#1F,#FF,#65,#82,#D9,#60,#7F,#A3,#FD,#61,#8C,#FF,#FD
    DB #E0,#DF,#92,#E0,#79,#70,#E4,#E0,#A6,#FF,#83,#87,#DF,#80,#FE,#7C
    DB #E0,#69,#87,#76,#A0,#5F,#E0,#D5,#55,#60
