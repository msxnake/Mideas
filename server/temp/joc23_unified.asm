...
; BANK 02 @#0548 : sprites.asm (3849 bytes)
; BANK 02 @#1451 : font.asm (2991 bytes)
; BANK 03 @#0000 : font.asm (465 bytes)
; BANK 03 @#01D1 : hud.asm (3480 bytes)
; BANK 03 @#0F69 : menus.asm (168 bytes)
; BANK 03 @#1011 : sound.asm part 1/2 (4079 bytes)
; BANK 04 @#0000 : sound.asm part 2/2 (5469 bytes)
; BANK 04 @#155D : scroll.asm (2353 bytes)
; BANK 04 @#1E8E : animtiles.asm (370 bytes)
; BANK 05 @#0000 : animtiles.asm (4910 bytes)
; BANK 05 @#132E : statemachine.asm part 1/2 (3282 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/2 (7899 bytes)
; BANK 06 @#1EDB : gameflow.asm (293 bytes)
; BANK 07 @#0000 : gameflow.asm (5728 bytes)
...
entity_x_pos        EQU #DD38   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DD58   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DD78   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DD98   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DDB8   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DDD8   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DDF8   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DE18   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DE38   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DE58   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DE59   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DE79   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DE99   ; Entity health (32 bytes)
entity_anim_frame   EQU #DEB9   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DED9   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DEF9   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DF19   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DF39   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DF59   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DF79   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DF99   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DFB9   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DFD9   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DFF9   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #E019   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E039   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E059   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E079   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E099   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E0B9   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E0D9   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E0F9   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E119   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E139   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E159   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E179   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E199   ; Number of sprites currently active
sprites_dirty      EQU #E19A   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E19B   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E1BB   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E1DB   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E1FB   ; Runtime base 16x16 slot per sprite asset (3 bytes)
sprite_placeholder_base_pattern_num EQU #E1FE   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E1FF   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E200   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #E280   ; Currently displayed screen ID
screen_dirty_flag   EQU #E281   ; Screen needs redraw flag
screen_transition_cooldown EQU #E282   ; Cooldown frames after screen transition
current_world_id    EQU #E283   ; Current world ID (for multi-world support)
current_screen_index EQU #E284   ; Current screen index within world
current_screen_anim_group_count EQU #E285   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E286   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E287   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E288   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E289   ; Player X position (16-bit)
player_y            EQU #E28B   ; Player Y position (16-bit)
player_runtime_enabled EQU #E28D   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E28E   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E28F   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E290   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E291   ; Player health points
player_score        EQU #E292   ; Player score (16-bit)
gem_count           EQU #E294   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E295   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E296   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E297   ; Interaction type id of last interacted tile
last_interaction_value EQU #E298   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E299   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E29A   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E29B   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E29C   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E29D   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E29E   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E2DE   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E31E   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E35E   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E39E   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E3AE   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E3BE   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E3CE   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E3DE   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E3EE   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E3FE   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E3FF   ; Temporary 16-bit storage
temp_word_2         EQU #E401   ; Temporary 16-bit storage
temp_byte_1         EQU #E403   ; Temporary 8-bit storage
temp_byte_2         EQU #E404   ; Temporary 8-bit storage
temp_byte_3         EQU #E405   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E425   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E445   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E465   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E485   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E486   ; Frames remaining for current SFX
sfx_fadeout         EQU #E487   ; Reserved fadeout flag/state
temp_byte_7         EQU #E488   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E4A8   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E4C8   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E4E8   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E508   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E528   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E548   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E568   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E588   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E5A8   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E5C8   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E5E8   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E608   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E628   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E648   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E668   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E688   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E6A8   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E6C8   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E6E8   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E728   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E768   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E788   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E7A8   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E7C8   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E7C9   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E7CA   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E7CB   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E7CC   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E7CD   ; Cached entity X for wall checks
wall_temp_y         EQU #E7CE   ; Cached entity Y for wall checks
wall_hit_left       EQU #E7CF   ; Hitbox left edge cache
wall_hit_top        EQU #E7D0   ; Hitbox top edge cache
wall_hit_right      EQU #E7D1   ; Hitbox right edge cache
wall_hit_bottom     EQU #E7D2   ; Hitbox bottom edge cache
wall_hit_w          EQU #E7D3   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E7D4   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E7D5   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E7D6   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E7D7   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E7D8   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E7D9   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E7F9   ; Number of entries in active_entity_list
hero_entity_id      EQU #E7FA   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E7FB   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E7FC   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E81C   ; Number of entries in input_entity_list
render_entity_list  EQU #E81D   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E83D   ; Number of entries in render_entity_list
collision_entity_list EQU #E83E   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E85E   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E85F   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E87F   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E880   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E8A0   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E8A1   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E8C1   ; Number of entities in coll_list
coll_src_left       EQU #E8C2   ; Source AABB left edge (scratch)
coll_src_right      EQU #E8C3   ; Source AABB right edge (scratch)
coll_src_top        EQU #E8C4   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E8C5   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E8C6   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E8C6   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E8C8   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E8CA   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E8CC   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E8CE   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E8D0   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E8D2   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E8D4   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E8D6   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E8D7   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E8DC   ; Frame counter (16-bit)
task_exec_time          EQU #E8DE   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E8E0   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E8E1   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E8E1   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E8E2   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E8E3   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E8E4   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E8E5   ; 0=stopped, 1=track active
music_muted          EQU #E8E6   ; 0=audible, 1=muted/pause
music_loop           EQU #E8E7   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E8E8   ; Current ROM track index
music_row_frames     EQU #E8E9   ; Frames per tracker row
music_row_countdown  EQU #E8EA   ; Countdown to next row
music_order_pos      EQU #E8EB   ; Current order position
music_pattern_index  EQU #E8EC   ; Current pattern index
music_pattern_row    EQU #E8ED   ; Current row inside pattern
music_pattern_rows   EQU #E8EE   ; Cached rows in current pattern
music_track_ptr_l    EQU #E8EF   ; Current track pointer low byte
music_track_ptr_h    EQU #E8F0   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E8F1   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E8F2   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E8F3   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E8F4   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E8F4   ; Channel A
music_ch_b_note EQU #E8F5   ; Channel B
music_ch_c_note EQU #E8F6   ; Channel C
music_ch_instrument_base EQU #E8F7   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E8F7   ; Channel A
music_ch_b_instrument EQU #E8F8   ; Channel B
music_ch_c_instrument EQU #E8F9   ; Channel C
music_ch_ornament_base EQU #E8FA   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E8FA   ; Channel A
music_ch_b_ornament EQU #E8FB   ; Channel B
music_ch_c_ornament EQU #E8FC   ; Channel C
music_ch_volume_base EQU #E8FD   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E8FD   ; Channel A
music_ch_b_volume EQU #E8FE   ; Channel B
music_ch_c_volume EQU #E8FF   ; Channel C
music_ch_vol_step_base EQU #E900   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E900   ; Channel A
music_ch_b_vol_step EQU #E901   ; Channel B
music_ch_c_vol_step EQU #E902   ; Channel C
music_ch_tone_step_base EQU #E903   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E903   ; Channel A
music_ch_b_tone_step EQU #E904   ; Channel B
music_ch_c_tone_step EQU #E905   ; Channel C
music_ch_noise_step_base EQU #E906   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E906   ; Channel A
music_ch_b_noise_step EQU #E907   ; Channel B
music_ch_c_noise_step EQU #E908   ; Channel C
music_ch_orn_step_base EQU #E909   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E909   ; Channel A
music_ch_b_orn_step EQU #E90A   ; Channel B
music_ch_c_orn_step EQU #E90B   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E90C   ; End of project variables (10508 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E90C: Project variables (10508 bytes)
;   #E90C-#F37F: Free RAM (~2676 bytes available)
...
tile_pattern_bank0:
    ...
    ; Row 0: Char0 Char1 
    ; Row 1: Char2 Char3 
    db #7E, #FF, #FF, #FF, #FF, #FF, #FF, #FE, #7E, #FF, #FF, #FF, #FF, #FF, #FF, #7F, #FE, #FF, #FF, #FF, #FF, #FF, #FF, #7E, #7F, #FF, #FF, #FF, #FF, #FF, #FF, #7E
...
; Sprite Asset 2: hero_walk_right
...
SPRITE_HERO_WALK_RIGHT_2_WIDTH     EQU 16
SPRITE_HERO_WALK_RIGHT_2_HEIGHT    EQU 16
SPRITE_HERO_WALK_RIGHT_2_FRAMES    EQU 2

;; ---- Sprite Frame: hero_walk_right_2_F0 ----
;; Size: 16x16
HERO_WALK_RIGHT_2_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#01,#02,#05,#0B,#09,#00,#01,#05,#09,#11,#01,#00,#00,#00,#00
    DB #00,#C0,#20,#C0,#A0,#C0,#80,#C0,#D0,#CC,#C0,#C0,#80,#80,#80,#C0

;; ---- End of Frame: hero_walk_right_2_F0 ----

;; ---- Sprite Frame: hero_walk_right_2_F1 ----
;; Size: 16x16
HERO_WALK_RIGHT_2_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#01,#02,#05,#1B,#01,#20,#1D,#01,#01,#01,#01,#3E,#20,#00
    DB #00,#00,#C0,#20,#C0,#A0,#C0,#84,#D8,#C0,#C0,#C0,#C2,#1E,#00,#00

;; ---- End of Frame: hero_walk_right_2_F1 ----
...
SPRITE_2_PATTERN EQU HERO_WALK_RIGHT_2_F0_LAYER1
...
; Sprite 2: hero_walk_right frame pointers
SPRITE_2_FRAME_PTRS:
    dw HERO_WALK_RIGHT_2_F0_LAYER1
    dw HERO_WALK_RIGHT_2_F1_LAYER1
...
SM_SpriteLayerColorTable:
    ...
    db 15 ; Sprite 2: hero_walk_right
...
load_sprite_patterns_worldmap_1776512078647:
    ...
    ld bc, 32
    call FAST_LDIRVM
    ; Sprite Asset 2: hero_walk_right frame 0 (1 layers)
    ld hl, HERO_WALK_RIGHT_2_F0_LAYER1
    ld de, SPRPAT + (3 * 32)
    ld bc, 32
    call FAST_LDIRVM
    ; Sprite Asset 2: hero_walk_right frame 1 (1 layers)
    ld hl, HERO_WALK_RIGHT_2_F1_LAYER1
    ld de, SPRPAT + (4 * 32)
    ld bc, 32
    call FAST_LDIRVM
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ...
    DB #80,#81,#80,#81,#82,#83,#82,#83,#80,#81,#FF,#FF,#82,#83,#FF,#FF
    DB #80,#81,#80,#81,#82,#83,#82,#83,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #80,#81,#80,#81,#82,#83,#82,#83,#FF,#FF,#80,#81,#FF,#FF,#82,#83
    DB #80,#81,#FF,#FF,#82,#83,#FF,#FF,#80,#81,#FF,#FF,#82,#83,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#84,#FF,#FF,#FF,#84,#80,#81,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#85,#FF,#FF,#FF,#80,#81
    DB #FF,#FF,#FF,#FF,#80,#81,#FF,#FF,#82,#83,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#85,#FF,#FF,#80,#81,#FF,#FF,#82,#83,#FF,#FF,#FF,#FF
    DB #85,#FF,#80,#81,#80,#81,#82,#83,#82,#83,#80,#81,#FF,#FF,#82,#83
    DB #80,#81,#FF,#FF,#82,#83,#80,#81,#80,#81,#82,#83,#82,#83,#FF,#FF
    ...
    DB #80,#81,#82,#83,#82,#83,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#80,#81,#FF,#FF,#82,#83,#FF,#FF
    DB #FF,#FF,#80,#81,#FF,#FF,#82,#83,#FF,#FF,#80,#81,#FF,#FF,#82,#83
    ...
    DB #80,#81,#FF,#FF,#82,#83,#FF,#FF,#80,#81,#80,#81,#82,#83,#82,#83
    ...
    DB #FF,#FF,#FF,#FF,#FF,#87,#FF,#FF,#80,#81,#80,#81,#82,#83,#82,#83
    DB #FF,#FF,#80,#81,#FF,#FF,#82,#83,#80,#81,#80,#81,#82,#83,#82,#83
    DB #FF,#FF,#80,#81,#87,#FF,#82,#83,#80,#81,#80,#81,#82,#83,#82,#83
...
SCREEN_PAN1_0_BLOCK_MAP:
    ...
    DB #04,#00,#05,#00,#06,#07,#08,#09,#0A,#0B,#0C,#0D,#0E,#00,#0F,#10
    DB #04,#11,#12,#13,#14,#15,#00,#10,#16,#17,#18,#19,#1A,#1B,#16,#1C
...
SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #10,#10,#10,#10,#08,#08,#00,#08,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_PAN1_0_INTERACTION_TYPE_MAP:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#01,#00,#00,#00,#01,#00,#05,#00,#00,#01,#00,#05
    DB #00,#05,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#05,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_PAN1_0_INTERACTION_VALUE_MAP:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#01,#01,#01,#01,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#01,#00,#01,#01,#00,#00,#00,#00,#01,#01,#01,#01,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#00,#00,#00
    DB #00,#00,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#01,#00,#00
    ...
    DB #01,#01,#01,#01,#01,#01,#00,#00,#01,#00,#00,#00,#00,#01,#01,#01
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#01,#01,#01,#01,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#01,#01,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#01,#00,#00
    DB #00,#00,#00,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#01,#01,#01,#01,#00,#00,#00,#00,#01,#01
    DB #01,#01,#00,#00,#01,#00,#00,#00,#01,#00,#00,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#01,#01,#01,#01,#00,#00,#00,#00,#01,#01
    DB #01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01
    DB #01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01
    DB #01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01
