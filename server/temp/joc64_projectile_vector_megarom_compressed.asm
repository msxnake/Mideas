; ==================================================================
; JOC64_PROJECTILE_VECTOR_MEGAROM - MEGAROM UNIFIED FILE
...
; ------------------------------------------------------------------
; Bank 1 [#6000-#8000]: components (55506/8192 bytes est.)
; Bank 2 [#8000-#A000]: statemachine, gameflow (28115/8192 bytes est.)
; Bank 5 [#6000-#8000]: bosses (11029/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 6 [#6000-#8000]: screens_code (7221/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 7 [#6000-#8000]: entities (6048/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 8 [#6000-#8000]: sprites (5523/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 9 [#6000-#8000]: sound (4463/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 10 [#6000-#8000]: hud (3947/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 11 [#6000-#8000]: font (3503/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 12 [#6000-#8000]: animtiles (3410/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 13 [#6000-#8000]: scroll (2353/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 14 [#6000-#8000]: worlds (2092/8192 bytes est.) [FAR — accessed via trampoline]
...
; Estimated payload bytes: 135277
...
; BANK 06 @#0000 : components.asm part 7/7 (8192 bytes)
; BANK 07 @#0000 : components.asm part 8/7 (24 bytes)
; BANK 07 @#0018 : entities.asm (6048 bytes)
; BANK 07 @#17B8 : worlds.asm (2092 bytes)
; BANK 07 @#1FE4 : screens.asm (28 bytes)
; BANK 08 @#0000 : screens.asm (7193 bytes)
; BANK 08 @#1C19 : sprites.asm (999 bytes)
; BANK 09 @#0000 : sprites.asm (4524 bytes)
; BANK 09 @#11AC : font.asm (3503 bytes)
; BANK 09 @#1F5B : hud.asm (165 bytes)
; BANK 10 @#0000 : hud.asm (3782 bytes)
; BANK 10 @#0EC6 : menus.asm (168 bytes)
; BANK 10 @#0F6E : sound.asm (4242 bytes)
; BANK 11 @#0000 : sound.asm (221 bytes)
; BANK 11 @#00DD : scroll.asm (2353 bytes)
; BANK 11 @#0A0E : animtiles.asm (3410 bytes)
; BANK 11 @#1760 : bosses.asm part 1/2 (2208 bytes)
; BANK 12 @#0000 : bosses.asm part 2/2 (8192 bytes)
; BANK 13 @#0000 : bosses.asm part 3/2 (629 bytes)
; BANK 13 @#0275 : statemachine.asm part 1/3 (7563 bytes)
; BANK 14 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 15 @#0000 : statemachine.asm part 3/3 (5786 bytes)
; BANK 15 @#169A : gameflow.asm (2406 bytes)
; BANK 16 @#0000 : gameflow.asm (4205 bytes); ==================================================================
...
;
; BANK 03 used 4194 / 8192
; - tile_pattern_bank0                 747 stored /  1016 raw bytes @ #A000 (rom #A000, offset +#0000) [PATTERNS/TILE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single patterns resource; ZX0 747/1016 bytes; bank 3 zone 0 offset +#0000; zone slack after pack 3998 bytes
; - tile_color_bank0                   376 stored /  1016 raw bytes @ #A2EB (rom #A2EB, offset +#02EB) [COLORS/TILE_COLORS] flags=1
;   reason: post-ZX0 first-fit single colors resource; ZX0 376/1016 bytes; bank 3 zone 0 offset +#02EB; zone slack after pack 3998 bytes
; - tilebank_pattern_data_0            691 stored /   896 raw bytes @ #A463 (rom #A463, offset +#0463) [PATTERNS/TILE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit merged patterns unit (2 labels); ZX0 691/896 bytes; bank 3 zone 0 offset +#0463; zone slack after pack 3998 bytes
; - tilebank_pattern_data_1            689 stored /   896 raw bytes @ #A716 (rom #A716, offset +#0716) [PATTERNS/TILE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit merged patterns unit (2 labels); ZX0 689/896 bytes; bank 3 zone 0 offset +#0716; zone slack after pack 3998 bytes
; - tilebank_color_data_0              354 stored /   896 raw bytes @ #A9C7 (rom #A9C7, offset +#09C7) [COLORS/TILE_COLORS] flags=1
;   reason: post-ZX0 first-fit merged colors unit (2 labels); ZX0 354/896 bytes; bank 3 zone 0 offset +#09C7; zone slack after pack 3998 bytes
; - tilebank_color_data_1              353 stored /   896 raw bytes @ #AB29 (rom #AB29, offset +#0B29) [COLORS/TILE_COLORS] flags=1
;   reason: post-ZX0 first-fit merged colors unit (2 labels); ZX0 353/896 bytes; bank 3 zone 0 offset +#0B29; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_EFFECTS_LAYOUT         6 stored /   768 raw bytes @ #AC8A (rom #AC8A, offset +#0C8A) [SCREENS/SCREEN_EFFECTS_LAYOUT] flags=1
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_EFFECTS_LAYOUT resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0C8A; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_INTERACTION_TYPE_MAP     6 stored /   768 raw bytes @ #AC90 (rom #AC90, offset +#0C90) [SCREENS/SCREEN_DATA] flags=1
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_INTERACTION_TYPE_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0C90; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_INTERACTION_VALUE_MAP    13 stored /   768 raw bytes @ #AC96 (rom #AC96, offset +#0C96) [SCREENS/SCREEN_DATA] flags=1
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_INTERACTION_VALUE_MAP resource; ZX0 13/768 bytes; bank 3 zone 0 offset +#0C96; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE    15 stored /   256 raw bytes @ #ACA3 (rom #ACA3, offset +#0CA3) [SCREENS/SCREEN_DATA] flags=1
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE resource; ZX0 15/256 bytes; bank 3 zone 0 offset +#0CA3; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_BOSS_TABLE            11 stored /    11 raw bytes @ #ACB2 (rom #ACB2, offset +#0CB2) [SCREENS/SCREEN_DATA] flags=0
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_BOSS_TABLE resource; raw 11 bytes; bank 3 zone 0 offset +#0CB2; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_EFFECT_ZONE_TABLE      1 stored /     1 raw bytes @ #ACBD (rom #ACBD, offset +#0CBD) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_EFFECT_ZONE_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#0CBD; zone slack after pack 3998 bytes
; - SCREEN_NEW_DIALOG_SCREEN_1_EFFECT_ZONE_TABLE     1 stored /     1 raw bytes @ #ACBE (rom #ACBE, offset +#0CBE) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
;   reason: post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_EFFECT_ZONE_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#0CBE; zone slack after pack 3998 bytes
; - SCREEN_NEW_DIALOG_SCREEN_1_BOSS_TABLE     1 stored /     1 raw bytes @ #ACBF (rom #ACBF, offset +#0CBF) [SCREENS/SCREEN_DATA] flags=0
;   reason: post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_BOSS_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#0CBF; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_INTERACTION_TARGET_MAP     6 stored /   768 raw bytes @ #ACC0 (rom #ACC0, offset +#0CC0) [SCREENS/SCREEN_DATA] flags=1
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_INTERACTION_TARGET_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CC0; zone slack after pack 3998 bytes
; - SCREEN_NEW_DIALOG_SCREEN_1_LAYOUT    21 stored /   768 raw bytes @ #ACC6 (rom #ACC6, offset +#0CC6) [SCREENS/SCREEN_LAYOUT] flags=1
;   reason: post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_LAYOUT resource; ZX0 21/768 bytes; bank 3 zone 0 offset +#0CC6; zone slack after pack 3998 bytes
; - SCREEN_NEW_DIALOG_SCREEN_1_EFFECTS_LAYOUT     6 stored /   768 raw bytes @ #ACDB (rom #ACDB, offset +#0CDB) [SCREENS/SCREEN_EFFECTS_LAYOUT] flags=1
;   reason: post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_EFFECTS_LAYOUT resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CDB; zone slack after pack 3998 bytes
; - BEHAVIOR_NEW_DIALOG_SCREEN_1_DATA     6 stored /   768 raw bytes @ #ACE1 (rom #ACE1, offset +#0CE1) [SCREENS/SCREEN_BEHAVIOR_MAP] flags=1
;   reason: post-ZX0 first-fit single BEHAVIOR_NEW_DIALOG_SCREEN_1_DATA resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CE1; zone slack after pack 3998 bytes
; - SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TYPE_MAP     6 stored /   768 raw bytes @ #ACE7 (rom #ACE7, offset +#0CE7) [SCREENS/SCREEN_DATA] flags=1
;   reason: post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TYPE_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CE7; zone slack after pack 3998 bytes
; - SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_VALUE_MAP     6 stored /   768 raw bytes @ #ACED (rom #ACED, offset +#0CED) [SCREENS/SCREEN_DATA] flags=1
;   reason: post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_VALUE_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CED; zone slack after pack 3998 bytes
; - SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TARGET_MAP     6 stored /   768 raw bytes @ #ACF3 (rom #ACF3, offset +#0CF3) [SCREENS/SCREEN_DATA] flags=1
;   reason: post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TARGET_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CF3; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_BLOCK_CATALOG         29 stored /    96 raw bytes @ #ACF9 (rom #ACF9, offset +#0CF9) [SCREENS/SCREEN_BLOCK_CATALOG] flags=1
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_BLOCK_CATALOG resource; ZX0 29/96 bytes; bank 3 zone 0 offset +#0CF9; zone slack after pack 3998 bytes
; - SCREEN_PAN1_0_BLOCK_MAP             16 stored /    48 raw bytes @ #AD16 (rom #AD16, offset +#0D16) [SCREENS/SCREEN_BLOCK_MAP] flags=1
;   reason: post-ZX0 first-fit single SCREEN_PAN1_0_BLOCK_MAP resource; ZX0 16/48 bytes; bank 3 zone 0 offset +#0D16; zone slack after pack 3998 bytes
; - NINA_WALK_RIGHT_0_F0_LAYER0         30 stored /    32 raw bytes @ #AD26 (rom #AD26, offset +#0D26) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_RIGHT_0_F0_LAYER0 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0D26; zone slack after pack 3998 bytes
; - NINA_WALK_RIGHT_0_F0_LAYER1         25 stored /    32 raw bytes @ #AD44 (rom #AD44, offset +#0D44) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_RIGHT_0_F0_LAYER1 resource; ZX0 25/32 bytes; bank 3 zone 0 offset +#0D44; zone slack after pack 3998 bytes
; - NINA_WALK_RIGHT_0_F1_LAYER0         31 stored /    32 raw bytes @ #AD5D (rom #AD5D, offset +#0D5D) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_RIGHT_0_F1_LAYER0 resource; ZX0 31/32 bytes; bank 3 zone 0 offset +#0D5D; zone slack after pack 3998 bytes
; - NINA_WALK_RIGHT_0_F1_LAYER1         27 stored /    32 raw bytes @ #AD7C (rom #AD7C, offset +#0D7C) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_RIGHT_0_F1_LAYER1 resource; ZX0 27/32 bytes; bank 3 zone 0 offset +#0D7C; zone slack after pack 3998 bytes
; - NINA_GRUB_RIGHT_1_F0_LAYER1         18 stored /    32 raw bytes @ #AD97 (rom #AD97, offset +#0D97) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F0_LAYER1 resource; ZX0 18/32 bytes; bank 3 zone 0 offset +#0D97; zone slack after pack 3998 bytes
; - NINA_GRUB_RIGHT_1_F0_LAYER2         28 stored /    32 raw bytes @ #ADA9 (rom #ADA9, offset +#0DA9) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F0_LAYER2 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0DA9; zone slack after pack 3998 bytes
; - NINA_GRUB_RIGHT_1_F1_LAYER1         23 stored /    32 raw bytes @ #ADC5 (rom #ADC5, offset +#0DC5) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F1_LAYER1 resource; ZX0 23/32 bytes; bank 3 zone 0 offset +#0DC5; zone slack after pack 3998 bytes
; - NINA_GRUB_RIGHT_1_F1_LAYER2         29 stored /    32 raw bytes @ #ADDC (rom #ADDC, offset +#0DDC) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F1_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#0DDC; zone slack after pack 3998 bytes
; - NEW_SPRITE_2_F0_LAYER1               5 stored /    32 raw bytes @ #ADF9 (rom #ADF9, offset +#0DF9) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_2_F0_LAYER1 resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#0DF9; zone slack after pack 3998 bytes
; - NEW_SPRITE_2_F0_LAYER2               5 stored /    32 raw bytes @ #ADFE (rom #ADFE, offset +#0DFE) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_2_F0_LAYER2 resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#0DFE; zone slack after pack 3998 bytes
; - NEW_SPRITE_2_F0_LAYER3               5 stored /    32 raw bytes @ #AE03 (rom #AE03, offset +#0E03) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_2_F0_LAYER3 resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#0E03; zone slack after pack 3998 bytes
; - NINA_JUMP_RIGHT_3_F0_LAYER0         27 stored /    32 raw bytes @ #AE08 (rom #AE08, offset +#0E08) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_JUMP_RIGHT_3_F0_LAYER0 resource; ZX0 27/32 bytes; bank 3 zone 0 offset +#0E08; zone slack after pack 3998 bytes
; - NINA_JUMP_RIGHT_3_F0_LAYER1         24 stored /    32 raw bytes @ #AE23 (rom #AE23, offset +#0E23) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_JUMP_RIGHT_3_F0_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0E23; zone slack after pack 3998 bytes
; - NINA_IDLE_RIGHT_4_F0_LAYER1         23 stored /    32 raw bytes @ #AE3B (rom #AE3B, offset +#0E3B) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_IDLE_RIGHT_4_F0_LAYER1 resource; ZX0 23/32 bytes; bank 3 zone 0 offset +#0E3B; zone slack after pack 3998 bytes
; - NINA_IDLE_RIGHT_4_F0_LAYER2         28 stored /    32 raw bytes @ #AE52 (rom #AE52, offset +#0E52) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_IDLE_RIGHT_4_F0_LAYER2 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0E52; zone slack after pack 3998 bytes
; - NEW_SPRITE_RIGHT_5_F0_LAYER1        31 stored /    32 raw bytes @ #AE6E (rom #AE6E, offset +#0E6E) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_RIGHT_5_F0_LAYER1 resource; ZX0 31/32 bytes; bank 3 zone 0 offset +#0E6E; zone slack after pack 3998 bytes
; - NEW_SPRITE_RIGHT_5_F0_LAYER2        30 stored /    32 raw bytes @ #AE8D (rom #AE8D, offset +#0E8D) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_RIGHT_5_F0_LAYER2 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0E8D; zone slack after pack 3998 bytes
; - PROJECTIL1_6_F0_LAYER1              17 stored /    32 raw bytes @ #AEAB (rom #AEAB, offset +#0EAB) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single PROJECTIL1_6_F0_LAYER1 resource; ZX0 17/32 bytes; bank 3 zone 0 offset +#0EAB; zone slack after pack 3998 bytes
; - PROJECTIL1_6_F0_LAYER2              12 stored /    32 raw bytes @ #AEBC (rom #AEBC, offset +#0EBC) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single PROJECTIL1_6_F0_LAYER2 resource; ZX0 12/32 bytes; bank 3 zone 0 offset +#0EBC; zone slack after pack 3998 bytes
; - PROJECTIL1_6_F1_LAYER1              14 stored /    32 raw bytes @ #AEC8 (rom #AEC8, offset +#0EC8) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single PROJECTIL1_6_F1_LAYER1 resource; ZX0 14/32 bytes; bank 3 zone 0 offset +#0EC8; zone slack after pack 3998 bytes
; - PROJECTIL1_6_F1_LAYER2              13 stored /    32 raw bytes @ #AED6 (rom #AED6, offset +#0ED6) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single PROJECTIL1_6_F1_LAYER2 resource; ZX0 13/32 bytes; bank 3 zone 0 offset +#0ED6; zone slack after pack 3998 bytes
; - NINA_WALK_LEFT_7_F0_LAYER0          28 stored /    32 raw bytes @ #AEE3 (rom #AEE3, offset +#0EE3) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_LEFT_7_F0_LAYER0 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0EE3; zone slack after pack 3998 bytes
; - NINA_WALK_LEFT_7_F0_LAYER1          25 stored /    32 raw bytes @ #AEFF (rom #AEFF, offset +#0EFF) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_LEFT_7_F0_LAYER1 resource; ZX0 25/32 bytes; bank 3 zone 0 offset +#0EFF; zone slack after pack 3998 bytes
; - NINA_WALK_LEFT_7_F1_LAYER0          30 stored /    32 raw bytes @ #AF18 (rom #AF18, offset +#0F18) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_LEFT_7_F1_LAYER0 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0F18; zone slack after pack 3998 bytes
; - NINA_WALK_LEFT_7_F1_LAYER1          30 stored /    32 raw bytes @ #AF36 (rom #AF36, offset +#0F36) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_WALK_LEFT_7_F1_LAYER1 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0F36; zone slack after pack 3998 bytes
; - NINA_GRUB_LEFT_8_F0_LAYER1          20 stored /    32 raw bytes @ #AF54 (rom #AF54, offset +#0F54) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_LEFT_8_F0_LAYER1 resource; ZX0 20/32 bytes; bank 3 zone 0 offset +#0F54; zone slack after pack 3998 bytes
; - NINA_GRUB_LEFT_8_F0_LAYER2          29 stored /    32 raw bytes @ #AF68 (rom #AF68, offset +#0F68) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_LEFT_8_F0_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#0F68; zone slack after pack 3998 bytes
; - NINA_GRUB_LEFT_8_F1_LAYER1          24 stored /    32 raw bytes @ #AF85 (rom #AF85, offset +#0F85) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_LEFT_8_F1_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0F85; zone slack after pack 3998 bytes
; - NINA_GRUB_LEFT_8_F1_LAYER2          28 stored /    32 raw bytes @ #AF9D (rom #AF9D, offset +#0F9D) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_GRUB_LEFT_8_F1_LAYER2 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0F9D; zone slack after pack 3998 bytes
; - NINA_JUMP_LEFT_9_F0_LAYER0          27 stored /    32 raw bytes @ #AFB9 (rom #AFB9, offset +#0FB9) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_JUMP_LEFT_9_F0_LAYER0 resource; ZX0 27/32 bytes; bank 3 zone 0 offset +#0FB9; zone slack after pack 3998 bytes
; - NINA_JUMP_LEFT_9_F0_LAYER1          24 stored /    32 raw bytes @ #AFD4 (rom #AFD4, offset +#0FD4) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_JUMP_LEFT_9_F0_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0FD4; zone slack after pack 3998 bytes
; - NINA_IDLE_LEFT_10_F0_LAYER1         24 stored /    32 raw bytes @ #AFEC (rom #AFEC, offset +#0FEC) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_IDLE_LEFT_10_F0_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0FEC; zone slack after pack 3998 bytes
; - NINA_IDLE_LEFT_10_F0_LAYER2         29 stored /    32 raw bytes @ #B004 (rom #B004, offset +#1004) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NINA_IDLE_LEFT_10_F0_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#1004; zone slack after pack 3998 bytes
; - NEW_SPRITE_LEFT_11_F0_LAYER1        31 stored /    32 raw bytes @ #B021 (rom #B021, offset +#1021) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_LEFT_11_F0_LAYER1 resource; ZX0 31/32 bytes; bank 3 zone 0 offset +#1021; zone slack after pack 3998 bytes
; - NEW_SPRITE_LEFT_11_F0_LAYER2        29 stored /    32 raw bytes @ #B040 (rom #B040, offset +#1040) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single NEW_SPRITE_LEFT_11_F0_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#1040; zone slack after pack 3998 bytes
; - SPRITE_PLACEHOLDER_PATTERN           5 stored /    32 raw bytes @ #B05D (rom #B05D, offset +#105D) [SPRITES/SPRITE_PATTERNS] flags=1
;   reason: post-ZX0 first-fit single SPRITE_PLACEHOLDER_PATTERN resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#105D; zone slack after pack 3998 bytes
; FREE 3998
;
; BANK 04 used 0 / 8192
; FREE 8192
...
;         "metadataChecksum": "fnv1a32:20A43579",
;         "resourceCount": 59,
;         "storedBytes": 4194
;       },
;       "resources": [
...
;           "flags": 1,
;           "sourceIndex": 36,
;           "placementReason": "post-ZX0 first-fit single patterns resource; ZX0 747/1016 bytes; bank 3 zone 0 offset +#0000; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 39,
...
;           "flags": 1,
;           "sourceIndex": 39,
;           "placementReason": "post-ZX0 first-fit single colors resource; ZX0 376/1016 bytes; bank 3 zone 0 offset +#02EB; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 37,
...
;           "flags": 1,
;           "sourceIndex": 37,
;           "placementReason": "post-ZX0 first-fit merged patterns unit (2 labels); ZX0 691/896 bytes; bank 3 zone 0 offset +#0463; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 38,
...
;           "flags": 1,
;           "sourceIndex": 38,
;           "placementReason": "post-ZX0 first-fit merged patterns unit (2 labels); ZX0 689/896 bytes; bank 3 zone 0 offset +#0716; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 40,
...
;           "flags": 1,
;           "sourceIndex": 40,
;           "placementReason": "post-ZX0 first-fit merged colors unit (2 labels); ZX0 354/896 bytes; bank 3 zone 0 offset +#09C7; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 41,
...
;           "flags": 1,
;           "sourceIndex": 41,
;           "placementReason": "post-ZX0 first-fit merged colors unit (2 labels); ZX0 353/896 bytes; bank 3 zone 0 offset +#0B29; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 44,
...
;           "flags": 1,
;           "sourceIndex": 44,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_EFFECTS_LAYOUT resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0C8A; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 48,
...
;           "flags": 1,
;           "sourceIndex": 48,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_INTERACTION_TYPE_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0C90; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 49,
...
;           "flags": 1,
;           "sourceIndex": 49,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_INTERACTION_VALUE_MAP resource; ZX0 13/768 bytes; bank 3 zone 0 offset +#0C96; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 47,
...
;           "flags": 1,
;           "sourceIndex": 47,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE resource; ZX0 15/256 bytes; bank 3 zone 0 offset +#0CA3; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 46,
...
;           "flags": 0,
;           "sourceIndex": 46,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_BOSS_TABLE resource; raw 11 bytes; bank 3 zone 0 offset +#0CB2; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 45,
...
;           "flags": 0,
;           "sourceIndex": 45,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_EFFECT_ZONE_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#0CBD; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 53,
...
;           "flags": 0,
;           "sourceIndex": 53,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_EFFECT_ZONE_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#0CBE; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 54,
...
;           "flags": 0,
;           "sourceIndex": 54,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_BOSS_TABLE resource; raw 1 bytes; bank 3 zone 0 offset +#0CBF; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 50,
...
;           "flags": 1,
;           "sourceIndex": 50,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_INTERACTION_TARGET_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CC0; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 51,
...
;           "flags": 1,
;           "sourceIndex": 51,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_LAYOUT resource; ZX0 21/768 bytes; bank 3 zone 0 offset +#0CC6; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 52,
...
;           "flags": 1,
;           "sourceIndex": 52,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_EFFECTS_LAYOUT resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CDB; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 55,
...
;           "flags": 1,
;           "sourceIndex": 55,
;           "placementReason": "post-ZX0 first-fit single BEHAVIOR_NEW_DIALOG_SCREEN_1_DATA resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CE1; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 56,
...
;           "flags": 1,
;           "sourceIndex": 56,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TYPE_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CE7; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 57,
...
;           "flags": 1,
;           "sourceIndex": 57,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_VALUE_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CED; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 58,
...
;           "flags": 1,
;           "sourceIndex": 58,
;           "placementReason": "post-ZX0 first-fit single SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TARGET_MAP resource; ZX0 6/768 bytes; bank 3 zone 0 offset +#0CF3; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 42,
...
;           "flags": 1,
;           "sourceIndex": 42,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_BLOCK_CATALOG resource; ZX0 29/96 bytes; bank 3 zone 0 offset +#0CF9; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 43,
...
;           "flags": 1,
;           "sourceIndex": 43,
;           "placementReason": "post-ZX0 first-fit single SCREEN_PAN1_0_BLOCK_MAP resource; ZX0 16/48 bytes; bank 3 zone 0 offset +#0D16; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 0,
...
;           "flags": 1,
;           "sourceIndex": 0,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_RIGHT_0_F0_LAYER0 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0D26; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 1,
...
;           "flags": 1,
;           "sourceIndex": 1,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_RIGHT_0_F0_LAYER1 resource; ZX0 25/32 bytes; bank 3 zone 0 offset +#0D44; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 2,
...
;           "flags": 1,
;           "sourceIndex": 2,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_RIGHT_0_F1_LAYER0 resource; ZX0 31/32 bytes; bank 3 zone 0 offset +#0D5D; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 3,
...
;           "flags": 1,
;           "sourceIndex": 3,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_RIGHT_0_F1_LAYER1 resource; ZX0 27/32 bytes; bank 3 zone 0 offset +#0D7C; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 4,
...
;           "flags": 1,
;           "sourceIndex": 4,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F0_LAYER1 resource; ZX0 18/32 bytes; bank 3 zone 0 offset +#0D97; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 5,
...
;           "flags": 1,
;           "sourceIndex": 5,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F0_LAYER2 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0DA9; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 6,
...
;           "flags": 1,
;           "sourceIndex": 6,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F1_LAYER1 resource; ZX0 23/32 bytes; bank 3 zone 0 offset +#0DC5; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 7,
...
;           "flags": 1,
;           "sourceIndex": 7,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_RIGHT_1_F1_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#0DDC; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 8,
...
;           "flags": 1,
;           "sourceIndex": 8,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_2_F0_LAYER1 resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#0DF9; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 9,
...
;           "flags": 1,
;           "sourceIndex": 9,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_2_F0_LAYER2 resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#0DFE; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 10,
...
;           "flags": 1,
;           "sourceIndex": 10,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_2_F0_LAYER3 resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#0E03; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 11,
...
;           "flags": 1,
;           "sourceIndex": 11,
;           "placementReason": "post-ZX0 first-fit single NINA_JUMP_RIGHT_3_F0_LAYER0 resource; ZX0 27/32 bytes; bank 3 zone 0 offset +#0E08; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 12,
...
;           "flags": 1,
;           "sourceIndex": 12,
;           "placementReason": "post-ZX0 first-fit single NINA_JUMP_RIGHT_3_F0_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0E23; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 13,
...
;           "flags": 1,
;           "sourceIndex": 13,
;           "placementReason": "post-ZX0 first-fit single NINA_IDLE_RIGHT_4_F0_LAYER1 resource; ZX0 23/32 bytes; bank 3 zone 0 offset +#0E3B; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 14,
...
;           "flags": 1,
;           "sourceIndex": 14,
;           "placementReason": "post-ZX0 first-fit single NINA_IDLE_RIGHT_4_F0_LAYER2 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0E52; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 15,
...
;           "flags": 1,
;           "sourceIndex": 15,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_RIGHT_5_F0_LAYER1 resource; ZX0 31/32 bytes; bank 3 zone 0 offset +#0E6E; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 16,
...
;           "flags": 1,
;           "sourceIndex": 16,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_RIGHT_5_F0_LAYER2 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0E8D; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 17,
...
;           "flags": 1,
;           "sourceIndex": 17,
;           "placementReason": "post-ZX0 first-fit single PROJECTIL1_6_F0_LAYER1 resource; ZX0 17/32 bytes; bank 3 zone 0 offset +#0EAB; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 18,
...
;           "flags": 1,
;           "sourceIndex": 18,
;           "placementReason": "post-ZX0 first-fit single PROJECTIL1_6_F0_LAYER2 resource; ZX0 12/32 bytes; bank 3 zone 0 offset +#0EBC; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 19,
...
;           "flags": 1,
;           "sourceIndex": 19,
;           "placementReason": "post-ZX0 first-fit single PROJECTIL1_6_F1_LAYER1 resource; ZX0 14/32 bytes; bank 3 zone 0 offset +#0EC8; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 20,
...
;           "flags": 1,
;           "sourceIndex": 20,
;           "placementReason": "post-ZX0 first-fit single PROJECTIL1_6_F1_LAYER2 resource; ZX0 13/32 bytes; bank 3 zone 0 offset +#0ED6; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 21,
...
;           "flags": 1,
;           "sourceIndex": 21,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_LEFT_7_F0_LAYER0 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0EE3; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 22,
...
;           "flags": 1,
;           "sourceIndex": 22,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_LEFT_7_F0_LAYER1 resource; ZX0 25/32 bytes; bank 3 zone 0 offset +#0EFF; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 23,
...
;           "flags": 1,
;           "sourceIndex": 23,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_LEFT_7_F1_LAYER0 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0F18; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 24,
...
;           "flags": 1,
;           "sourceIndex": 24,
;           "placementReason": "post-ZX0 first-fit single NINA_WALK_LEFT_7_F1_LAYER1 resource; ZX0 30/32 bytes; bank 3 zone 0 offset +#0F36; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 25,
...
;           "flags": 1,
;           "sourceIndex": 25,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_LEFT_8_F0_LAYER1 resource; ZX0 20/32 bytes; bank 3 zone 0 offset +#0F54; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 26,
...
;           "flags": 1,
;           "sourceIndex": 26,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_LEFT_8_F0_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#0F68; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 27,
...
;           "flags": 1,
;           "sourceIndex": 27,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_LEFT_8_F1_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0F85; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 28,
...
;           "flags": 1,
;           "sourceIndex": 28,
;           "placementReason": "post-ZX0 first-fit single NINA_GRUB_LEFT_8_F1_LAYER2 resource; ZX0 28/32 bytes; bank 3 zone 0 offset +#0F9D; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 29,
...
;           "flags": 1,
;           "sourceIndex": 29,
;           "placementReason": "post-ZX0 first-fit single NINA_JUMP_LEFT_9_F0_LAYER0 resource; ZX0 27/32 bytes; bank 3 zone 0 offset +#0FB9; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 30,
...
;           "flags": 1,
;           "sourceIndex": 30,
;           "placementReason": "post-ZX0 first-fit single NINA_JUMP_LEFT_9_F0_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0FD4; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 31,
...
;           "flags": 1,
;           "sourceIndex": 31,
;           "placementReason": "post-ZX0 first-fit single NINA_IDLE_LEFT_10_F0_LAYER1 resource; ZX0 24/32 bytes; bank 3 zone 0 offset +#0FEC; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 32,
...
;           "flags": 1,
;           "sourceIndex": 32,
;           "placementReason": "post-ZX0 first-fit single NINA_IDLE_LEFT_10_F0_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#1004; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 33,
...
;           "flags": 1,
;           "sourceIndex": 33,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_LEFT_11_F0_LAYER1 resource; ZX0 31/32 bytes; bank 3 zone 0 offset +#1021; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 34,
...
;           "flags": 1,
;           "sourceIndex": 34,
;           "placementReason": "post-ZX0 first-fit single NEW_SPRITE_LEFT_11_F0_LAYER2 resource; ZX0 29/32 bytes; bank 3 zone 0 offset +#1040; zone slack after pack 3998 bytes"
;         },
;         {
;           "id": 35,
...
;           "flags": 1,
;           "sourceIndex": 35,
;           "placementReason": "post-ZX0 first-fit single SPRITE_PLACEHOLDER_PATTERN resource; ZX0 5/32 bytes; bank 3 zone 0 offset +#105D; zone slack after pack 3998 bytes"
;         }
;       ]
;     },
;     {
...
; Estimated removable bytes: 6816
;
; Candidates:
; - sound: 4463 estimated bytes
; - scroll: 2353 estimated bytes
;
; Retained modules:
; - animtiles: 3410 estimated bytes
; - bosses: 11029 estimated bytes
; - colors_code: 846 estimated bytes
; - components: 55506 estimated bytes
; - entities: 6048 estimated bytes
; - font: 3503 estimated bytes
; - gameflow: 6611 estimated bytes
; - hud: 3947 estimated bytes
; - patterns_code: 894 estimated bytes
; - screens_code: 7221 estimated bytes
; - sprites: 5523 estimated bytes
; - statemachine: 21504 estimated bytes
; - worlds: 2092 estimated bytes
;
...
;       "estimatedUsedBytes": 7221,
;       "estimatedFreeBytes": 971,
...
;       "estimatedUsedBytes": 6048,
;       "estimatedFreeBytes": 2144,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "entities",
...
;       "estimatedUsedBytes": 4463,
;       "estimatedFreeBytes": 3729,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "sound",
...
;       "estimatedUsedBytes": 3947,
;       "estimatedFreeBytes": 4245,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "hud",
...
;       "estimatedUsedBytes": 3503,
;       "estimatedFreeBytes": 4689,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "font",
...
;       "estimatedUsedBytes": 3410,
;       "estimatedFreeBytes": 4782,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "animtiles",
...
;       "estimatedUsedBytes": 2092,
;       "estimatedFreeBytes": 6100,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "worlds",
...
.input_facing_done:
            ...
            ld a, (hl)
            or a
            jp z, .input_directional_sprite_done
            cp 1
            jp z, .input_directional_sprite_left
            cp 2
            jp z, .input_directional_sprite_right
            cp 3
            jp z, .input_directional_sprite_up
            cp 4
            jp z, .input_directional_sprite_down
            jp .input_directional_sprite_done

.input_directional_sprite_left:
            ld hl, sprite_dir_left_table
            jp .input_directional_sprite_lookup
.input_directional_sprite_right:
            ld hl, sprite_dir_right_table
            jp .input_directional_sprite_lookup
.input_directional_sprite_up:
            ld hl, sprite_dir_up_table
            jp .input_directional_sprite_lookup
.input_directional_sprite_down:
            ld hl, sprite_dir_down_table

.input_directional_sprite_lookup:
            push hl
            ld hl, entity_sprite_asset_index_init
            add hl, de
            ld a, (hl)
            ...
            jp z, .input_directional_sprite_done
            cp SPRITE_ASSET_COUNT
            jp nc, .input_directional_sprite_done
            ld c, a
            ld b, 0
            add hl, bc
            ld a, (hl)
...
.player_fast_facing_done:
    ...
    ld d, 0
            ...
            ld a, (hl)
            or a
            jp z, .player_fast_directional_sprite_done
            cp 1
            jp z, .player_fast_directional_sprite_left
            cp 2
            jp z, .player_fast_directional_sprite_right
            cp 3
            jp z, .player_fast_directional_sprite_up
            cp 4
            jp z, .player_fast_directional_sprite_down
            jp .player_fast_directional_sprite_done

.player_fast_directional_sprite_left:
            ld hl, sprite_dir_left_table
            jp .player_fast_directional_sprite_lookup
.player_fast_directional_sprite_right:
            ld hl, sprite_dir_right_table
            jp .player_fast_directional_sprite_lookup
.player_fast_directional_sprite_up:
            ld hl, sprite_dir_up_table
            jp .player_fast_directional_sprite_lookup
.player_fast_directional_sprite_down:
            ld hl, sprite_dir_down_table

.player_fast_directional_sprite_lookup:
            push hl
            ld hl, entity_sprite_asset_index_init
            add hl, de
            ld a, (hl)
            ...
            jp z, .player_fast_directional_sprite_done
            cp SPRITE_ASSET_COUNT
            jp nc, .player_fast_directional_sprite_done
            ld c, a
            ld b, 0
            add hl, bc
            ld a, (hl)
...
.player_fast_directional_sprite_done:
            pop hl
            pop de
            pop bc
            pop af
...
.player_fast_sync_sm_sprite_facing:
    ...
    ld d, 0
            ...
            ld a, (hl)
            or a
            jp z, .player_fast_sm_directional_sprite_done
            cp 1
            jp z, .player_fast_sm_directional_sprite_left
            cp 2
            jp z, .player_fast_sm_directional_sprite_right
            cp 3
            jp z, .player_fast_sm_directional_sprite_up
            cp 4
            jp z, .player_fast_sm_directional_sprite_down
            jp .player_fast_sm_directional_sprite_done

.player_fast_sm_directional_sprite_left:
            ld hl, sprite_dir_left_table
            jp .player_fast_sm_directional_sprite_lookup
.player_fast_sm_directional_sprite_right:
            ld hl, sprite_dir_right_table
            jp .player_fast_sm_directional_sprite_lookup
.player_fast_sm_directional_sprite_up:
            ld hl, sprite_dir_up_table
            jp .player_fast_sm_directional_sprite_lookup
.player_fast_sm_directional_sprite_down:
            ld hl, sprite_dir_down_table

.player_fast_sm_directional_sprite_lookup:
            push hl
            ld hl, entity_sprite_asset_index
            add hl, de
            ld a, (hl)
            ...
            jp z, .player_fast_sm_directional_sprite_done
            cp SPRITE_ASSET_COUNT
            jp nc, .player_fast_sm_directional_sprite_done
            ld c, a
            ld b, 0
            add hl, bc
            ld a, (hl)
...
.player_fast_sm_directional_sprite_done:
            pop hl
            pop de
            pop bc
            pop af
...
; Data start address: #A000
; Total data bytes (post-ZX0 / final): 4194
; Zones used: 2
; ------------------------------------------------------------------
; ZONE 00 [#A000-#C000] bank 3 used=4194 slack=3998
;   + tile_pattern_bank0 @ +#0000 size=747
;   + tile_color_bank0 @ +#02EB size=376
;   + tilebank_pattern_data_0, tilebank_pattern_data_1 @ +#0463 size=1380
;   + tilebank_color_data_0, tilebank_color_data_1 @ +#09C7 size=707
;   + SCREEN_PAN1_0_EFFECTS_LAYOUT @ +#0C8A size=6
;   + SCREEN_PAN1_0_INTERACTION_TYPE_MAP @ +#0C90 size=6
;   + SCREEN_PAN1_0_INTERACTION_VALUE_MAP @ +#0C96 size=13
;   + SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE @ +#0CA3 size=15
;   + SCREEN_PAN1_0_BOSS_TABLE @ +#0CB2 size=11
;   + SCREEN_PAN1_0_EFFECT_ZONE_TABLE @ +#0CBD size=1
;   + SCREEN_NEW_DIALOG_SCREEN_1_EFFECT_ZONE_TABLE @ +#0CBE size=1
;   + SCREEN_NEW_DIALOG_SCREEN_1_BOSS_TABLE @ +#0CBF size=1
;   + SCREEN_PAN1_0_INTERACTION_TARGET_MAP @ +#0CC0 size=6
;   + SCREEN_NEW_DIALOG_SCREEN_1_LAYOUT @ +#0CC6 size=21
;   + SCREEN_NEW_DIALOG_SCREEN_1_EFFECTS_LAYOUT @ +#0CDB size=6
;   + BEHAVIOR_NEW_DIALOG_SCREEN_1_DATA @ +#0CE1 size=6
;   + SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TYPE_MAP @ +#0CE7 size=6
;   + SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_VALUE_MAP @ +#0CED size=6
;   + SCREEN_NEW_DIALOG_SCREEN_1_INTERACTION_TARGET_MAP @ +#0CF3 size=6
;   + SCREEN_PAN1_0_BLOCK_CATALOG @ +#0CF9 size=29
;   + SCREEN_PAN1_0_BLOCK_MAP @ +#0D16 size=16
;   + NINA_WALK_RIGHT_0_F0_LAYER0 @ +#0D26 size=30
;   + NINA_WALK_RIGHT_0_F0_LAYER1 @ +#0D44 size=25
;   + NINA_WALK_RIGHT_0_F1_LAYER0 @ +#0D5D size=31
;   + NINA_WALK_RIGHT_0_F1_LAYER1 @ +#0D7C size=27
;   + NINA_GRUB_RIGHT_1_F0_LAYER1 @ +#0D97 size=18
;   + NINA_GRUB_RIGHT_1_F0_LAYER2 @ +#0DA9 size=28
;   + NINA_GRUB_RIGHT_1_F1_LAYER1 @ +#0DC5 size=23
;   + NINA_GRUB_RIGHT_1_F1_LAYER2 @ +#0DDC size=29
;   + NEW_SPRITE_2_F0_LAYER1 @ +#0DF9 size=5
;   + NEW_SPRITE_2_F0_LAYER2 @ +#0DFE size=5
;   + NEW_SPRITE_2_F0_LAYER3 @ +#0E03 size=5
;   + NINA_JUMP_RIGHT_3_F0_LAYER0 @ +#0E08 size=27
;   + NINA_JUMP_RIGHT_3_F0_LAYER1 @ +#0E23 size=24
;   + NINA_IDLE_RIGHT_4_F0_LAYER1 @ +#0E3B size=23
;   + NINA_IDLE_RIGHT_4_F0_LAYER2 @ +#0E52 size=28
;   + NEW_SPRITE_RIGHT_5_F0_LAYER1 @ +#0E6E size=31
;   + NEW_SPRITE_RIGHT_5_F0_LAYER2 @ +#0E8D size=30
;   + PROJECTIL1_6_F0_LAYER1 @ +#0EAB size=17
;   + PROJECTIL1_6_F0_LAYER2 @ +#0EBC size=12
;   + PROJECTIL1_6_F1_LAYER1 @ +#0EC8 size=14
;   + PROJECTIL1_6_F1_LAYER2 @ +#0ED6 size=13
;   + NINA_WALK_LEFT_7_F0_LAYER0 @ +#0EE3 size=28
;   + NINA_WALK_LEFT_7_F0_LAYER1 @ +#0EFF size=25
;   + NINA_WALK_LEFT_7_F1_LAYER0 @ +#0F18 size=30
;   + NINA_WALK_LEFT_7_F1_LAYER1 @ +#0F36 size=30
;   + NINA_GRUB_LEFT_8_F0_LAYER1 @ +#0F54 size=20
;   + NINA_GRUB_LEFT_8_F0_LAYER2 @ +#0F68 size=29
;   + NINA_GRUB_LEFT_8_F1_LAYER1 @ +#0F85 size=24
;   + NINA_GRUB_LEFT_8_F1_LAYER2 @ +#0F9D size=28
;   + NINA_JUMP_LEFT_9_F0_LAYER0 @ +#0FB9 size=27
;   + NINA_JUMP_LEFT_9_F0_LAYER1 @ +#0FD4 size=24
;   + NINA_IDLE_LEFT_10_F0_LAYER1 @ +#0FEC size=24
;   + NINA_IDLE_LEFT_10_F0_LAYER2 @ +#1004 size=29
;   + NEW_SPRITE_LEFT_11_F0_LAYER1 @ +#1021 size=31
;   + NEW_SPRITE_LEFT_11_F0_LAYER2 @ +#1040 size=29
;   + SPRITE_PLACEHOLDER_PATTERN @ +#105D size=5
; ZONE 01 [#C000-#E000] bank 4 used=0 slack=8192

    org #A000
; ==================================================================
; DATA ZONE 00 (bank 3) used=4194 slack=3998
; ==================================================================
; ==================================================================
    ...
    DB #FF,#2B,#40,#E0,#40,#44,#4E,#44,#87,#8D,#DF,#E0,#F0,#FB,#73,#3B
    DB #F8,#FD,#F2,#23,#9F,#C3,#F8,#FC,#BF,#57,#79,#7F,#DA,#80,#F6,#F3
    DB #E1,#D1,#D9,#E1,#F3,#FF,#F0,#D7,#7A,#8A,#1F,#07,#26,#1F,#7F,#1F
    DB #F8,#E0,#E1,#00,#01,#E9,#EE,#C0,#FD,#D7,#68,#1F,#3F,#FD,#3E,#FF
    DB #E7,#C3,#E7,#FE,#90,#00,#CF,#A2,#86,#DF,#F0,#70,#F0,#60,#60,#61
    DB #83,#0F,#0E,#0F,#06,#06,#F6,#1B,#BC,#21,#03,#03,#BF,#07,#69,#BD
    DB #FF,#FE,#01,#BD,#E6,#FE,#FF,#BE,#00,#0B,#E0,#79,#C9,#AC,#88,#C0
    DB #C0,#FE,#D5,#FE,#1A,#C7,#E7,#F3,#38,#1C,#64,#0F,#1F,#FF,#F9,#11
    DB #FE,#92,#FE,#E3,#E7,#CF,#1C,#38,#DF,#B5,#AD,#9B,#6C,#06,#7B,#C5
    DB #20,#DE,#FF,#A5,#FF,#6E,#03,#01,#8C,#AA,#8B,#7F,#DF,#7E,#7D,#F1
    DB #E1,#ED,#FB,#F9,#FC,#79,#DF,#FF,#AD,#C0,#80,#31,#60,#DB,#05,#C0
    DB #A8,#FF,#3F,#28,#38,#0F,#0E,#07,#0B,#03,#C2,#E0,#70,#FF,#3F,#C3
    DB #E3,#6E,#55,#F8,#8C,#8D,#9C,#08,#DE,#2B,#1F,#FF,#06,#39,#10,#43
    DB #07,#1E,#FF,#FC,#83,#87,#AB,#FC,#1C,#9F,#A1,#E0,#E0,#C0,#59,#A6
    DB #FF,#00,#FD,#F3,#5F,#8B,#69,#50,#A2,#E0,#E3,#F3,#80,#C0,#80,#AF
    DB #FF,#07,#C7,#CF,#3F,#01,#03,#07,#8F,#D1,#D6,#37,#30,#FF,#39,#FF
    DB #B0,#F2,#A2,#B3,#00,#71,#4B,#D0,#B3,#9D,#FF,#97,#4E,#9B,#BC,#FF
    DB #C2,#FE,#F9,#0D,#BE,#FC,#4D,#DE,#CC,#6E,#6E,#04,#B8,#26,#3F,#87
    DB #03,#68,#70,#F3,#2F,#74,#E6,#FF,#C0,#80,#7B,#8A,#3F,#3D,#08,#1F
    DB #1E,#1F,#E0,#A6,#F0,#FE,#78,#D9,#C9,#FE,#F3,#92,#23,#97,#0F,#04
    DB #32,#EF,#B6,#C9,#2D,#37,#7F,#78,#7C,#3C,#3E,#FE,#B1,#68,#54,#38
    DB #F8,#C3,#1C,#C0,#2B,#8F,#0E,#10,#42,#61,#D3,#01,#02,#08,#01,#0C
    DB #BD,#AE,#EC,#7F,#F8,#FB,#9E,#70,#87,#9D,#FF,#F2,#0F,#3F,#78,#D2
    DB #F3,#CE,#92,#01,#C3,#E7,#80,#F0,#F8,#63,#F0,#38,#CE,#A0,#4D,#5B
    DB #19,#3C,#7F,#E7,#C3,#D9,#FE,#A8,#C3,#7F,#62,#81,#81,#BF,#F2,#EF
    DB #10,#D9,#F7,#EE,#EC,#EC,#66,#FF,#FE,#7E,#C3,#C2,#BF,#BF,#D9,#F9
    DB #3C,#DC,#EC,#A8,#39,#2B,#E2,#DD,#9D,#CA,#02,#00,#82,#F9,#F8,#7C
    DB #3E,#9B,#0E,#00,#BF,#D5,#37,#8B,#9B,#01,#7D,#B8,#E5,#3E,#ED,#CE
    DB #FD,#FB,#77,#E5,#31,#F3,#FA,#9B,#FF,#1B,#1B,#B0,#F7,#FE,#C8,#60
    DB #DE,#7D,#1D,#0E,#03,#0C,#74,#F9,#FC,#3E,#A0,#04,#F7,#00,#FC,#FF
    DB #3E,#FD,#7D,#DB,#DD,#E8,#ED,#57,#C0,#55,#56
