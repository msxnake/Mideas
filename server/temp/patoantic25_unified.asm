...
; BANK 08 @#0000 : statemachine.asm part 3/3 (7639 bytes)
; BANK 08 @#1DD7 : gameflow.asm part 1/3 (553 bytes)
; BANK 09 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 10 @#0000 : gameflow.asm part 3/3 (7965 bytes)
