...
;   Active entities: 2
;   Used components: Position, Sprite, Animation, Patrol, Collision, Input, StateMachine, Cursors, Gravity, WallCollision, Jump
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Animation, Patrol, Collision, Input, StateMachine, Cursors, Gravity, WallCollision, Jump 
