; ==================================================================
; PATOANTIC131_JOBTEST - UNIFIED FILE
...
; Estimated payload bytes: 116592
...
; BANK 00 @#08C5 : entities.asm (5583 bytes)
; BANK 00 @#1E94 : worlds.asm (364 bytes)
; BANK 01 @#0000 : worlds.asm (3636 bytes)
; BANK 01 @#0E34 : screens.asm part 1/3 (4556 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (4778 bytes)
; BANK 03 @#12AA : sprites.asm part 1/2 (3414 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (6351 bytes)
; BANK 04 @#18CF : font.asm (1841 bytes)
; BANK 05 @#0000 : font.asm (1706 bytes)
; BANK 05 @#06AA : hud.asm (4467 bytes)
; BANK 05 @#181D : menus.asm (444 bytes)
; BANK 05 @#19D9 : sound.asm part 1/2 (1575 bytes)
; BANK 06 @#0000 : sound.asm part 2/2 (7826 bytes)
; BANK 06 @#1E92 : scroll.asm (366 bytes)
; BANK 07 @#0000 : scroll.asm (1987 bytes)
; BANK 07 @#07C3 : animtiles.asm (4817 bytes)
; BANK 07 @#1A94 : particles.asm (1388 bytes)
; BANK 08 @#0000 : particles.asm (3575 bytes)
; BANK 08 @#0DF7 : statemachine.asm part 1/4 (4617 bytes)
...
; BANK 12 @#0000 : statemachine.asm part 5/4 (1163 bytes)
; BANK 12 @#048B : gameflow.asm part 1/3 (7029 bytes)
; BANK 13 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : gameflow.asm part 3/3 (1904 bytes)
...
position_update_loop:
    ...
    ; Job cadence gate for NPC movement:
    ; - Input entities (hero/player) always run at full rate.
    ; - Movement-only entities (patrol NPCs) run only on active job slots.
    ld a, d
    and COMP_MASK_MOVEMENT
    jr z, position_check_screen
    ld a, d
    and COMP_MASK_INPUT
    jr nz, position_check_screen
    call entity_job_should_run_c
    or a
    jp z, position_next_entity

position_check_screen:
...
.skip_update_0:
    ...
    cp (hl)
    jr nz, .skip_update_1
    ; Job cadence gate for movement-only entities
    ld c, 1
    call entity_job_should_run_c
    or a
    jr z, .skip_update_1
