...
entity_sprite_config: 
    db 0, 3 ; Entity 0 (anec_right)
    db 3, 1 ; Entity 1 (bola)
    db 4, 1 ; Entity 2 (New Sprite)
    ds 58, 0 ; Padding
...
; Entity: coro1 (instance from template: tpl_1770837237607_l05j9)
ENTITY_CORO1_ID EQU 2
ENTITY_CORO1_COMP_MASK EQU #87  ; Component mask: 10000111b
; Template: tpl_1770837237607_l05j9
ENTITY_CORO1_X EQU 9
ENTITY_CORO1_Y EQU 15
...
init_coro1:
    ; Initialize coro1 at real position from JSON
    ; JSON position: (9, 15) tiles = (72, 120) pixels
    ; Template: tpl_1770837237607_l05j9
    ; Components: Position, Sprite, Movement, Animation
    ; Direction mask: #0F (1111b) = All directions
    ...
    ; === Patrol Component Init ===
    ; Waypoints: (40, 120) -> (128, 120)
    ; Override position with waypoint1
    ld hl, entity_x_pos
    add hl, de
    ld (hl), 40         ; Start X = waypoint1_x
