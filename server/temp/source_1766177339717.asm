...
temp_word_3         EQU #C4FC   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C53C   ; Temporary 16-bit storage (64 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C57C   ; End of project variables (1404 bytes used)

; ==================================================================
; MEMORY SAFETY CHECK
; ==================================================================
; RAM Layout:
;   #C000-#C57C: Project variables (1404 bytes)
;   #C57C-#F37F: Free RAM (~11780 bytes available)
...
; Reserve space for all variables defined above
    DS 1404   ; Reserve 1404 bytes for all variables
