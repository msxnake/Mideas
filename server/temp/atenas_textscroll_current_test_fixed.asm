...
; Bank 2 [#8000-#A000]: components_tail, gameflow (20975/8192 bytes est.)
; Bank 4 [#6000-#8000]: font (6704/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 5 [#6000-#8000]: gameflow_aux (5320/8192 bytes est.) [FAR — accessed via trampoline]
...
; BANK 09 @#0000 : gameflow.asm part 4/3 (501 bytes); ==================================================================
...
; - gameflow: 15070 estimated bytes
; - gameflow_aux: 5320 estimated bytes
...
;       "estimatedUsedBytes": 5320,
;       "estimatedFreeBytes": 2872,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "gameflow_aux",
...
textscroll2_capture_font_patterns:
    di
    ld hl, CHRTBL2 + (TEXTSCROLL2_FONT_FIRST * 8)
