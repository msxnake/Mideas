set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/tales7_paper_validator_smoke_megarom_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/tales7_paper_validator_smoke_megarom_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set flow [mem8 0xC104]; set screen [mem8 0xDF1E]; set irq [mem16 0xE580]; set inirq [mem8 0xE585]
...
after time 10.0 { shot "tales7_paper_validator_smoke_megarom_t10.png" "t10" }
after time 12.0 { hold_right "right" 1.0 }
after time 14.0 { shot "tales7_paper_validator_smoke_megarom_t14.png" "t14" }
after time 20.0 { shot "tales7_paper_validator_smoke_megarom_t20.png" "t20"; close $f; exit }
