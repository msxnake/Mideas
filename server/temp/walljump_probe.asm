...
; BANK 03 @#0000 : sprites.asm (3780 bytes)
; BANK 03 @#0EC4 : font.asm (3547 bytes)
; BANK 03 @#1C9F : hud.asm (865 bytes)
; BANK 04 @#0000 : hud.asm (2971 bytes)
; BANK 04 @#0B9B : menus.asm (444 bytes)
; BANK 04 @#0D57 : sound.asm (3184 bytes)
; BANK 04 @#19C7 : scroll.asm (1593 bytes)
; BANK 05 @#0000 : scroll.asm (760 bytes)
; BANK 05 @#02F8 : animtiles.asm (3349 bytes)
; BANK 05 @#100D : particles.asm (4083 bytes)
; BANK 06 @#0000 : particles.asm (880 bytes)
; BANK 06 @#0370 : statemachine.asm part 1/3 (7312 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 4/3 (264 bytes)
; BANK 09 @#0108 : gameflow.asm part 1/3 (7928 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (590 bytes)
