...
; ==================================================================
MAX_ENTITIES        EQU 32
entity_x_pos        EQU #C059   ; Entity X positions (32 bytes)
entity_y_pos        EQU #C079   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #C099   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #C0B9   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #C0D9   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #C0F9   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #C119   ; Entity screen ID (32 bytes)
entity_dir_mask     EQU #C139   ; Entity direction mask (32 bytes)
entity_health       EQU #C159   ; Entity health (32 bytes)
entity_anim_frame   EQU #C179   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #C199   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #C1B9   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #C1D9   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #C1F9   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C219   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C239   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C259   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C279   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #C299   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #C2B9   ; Entity carrier ID (32 bytes, 255=not carried)
entity_sm_var_0     EQU #C2D9   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C2F9   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C319   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C339   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C359   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #C379   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #C399   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #C3B9   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
active_sprite_count EQU #C3D9   ; Number of sprites currently active
sprite_pattern      EQU #C3DA   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #C3FA   ; Sprite colors (32 bytes)
sprite_attributes   EQU #C41A   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #C49A   ; Currently displayed screen ID
screen_dirty_flag   EQU #C49B   ; Screen needs redraw flag
current_world_id    EQU #C49C   ; Current world ID (for multi-world support)
current_screen_index EQU #C49D   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #C49E   ; Player X position (16-bit)
player_y            EQU #C4A0   ; Player Y position (16-bit)
player_health       EQU #C4A2   ; Player health points
player_score        EQU #C4A3   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #C4A5   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #C4A6   ; Temporary 16-bit storage
temp_word_2         EQU #C4A8   ; Temporary 16-bit storage
temp_byte_1         EQU #C4AA   ; Temporary 8-bit storage
temp_byte_2         EQU #C4AB   ; Temporary 8-bit storage
temp_byte_3         EQU #C4AC   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #C4CC   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #C4EC   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #C50C   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #C52C   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #C54C   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #C56C   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #C58C   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #C5AC   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #C5CC   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #C5EC   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #C60C   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #C62C   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #C64C   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #C66C   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C68C   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C6CC   ; Temporary 16-bit storage (64 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C70C   ; End of project variables (1804 bytes used)

; ==================================================================
; MEMORY SAFETY CHECK
; ==================================================================
; RAM Layout:
;   #C000-#C70C: Project variables (1804 bytes)
;   #C70C-#F37F: Free RAM (~11380 bytes available)
...
; Reserve space for all variables defined above
    DS 1804   ; Reserve 1804 bytes for all variables
...
.collect_loop:
    ...
    push bc
    ld a, c
    call destroy_entity           ; Deactivate collectible
...
get_tile_at_position:
    ...
    ; Tile width is 24 pixels - divide
    ld c, 24
    call div_a_by_c
    ...
    ; Tile height is 24 pixels - divide
    ld c, 24
    call div_a_by_c
    ld c, a                       ; C = tile row
