...
current_world_id    EQU #C38A   ; Current world ID (for multi-world support)
current_screen_index EQU #C38B   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #C38C   ; Player X position (16-bit)
player_y            EQU #C38E   ; Player Y position (16-bit)
player_health       EQU #C390   ; Player health points
player_score        EQU #C391   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #C393   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #C394   ; Temporary 16-bit storage
temp_word_2         EQU #C396   ; Temporary 16-bit storage
temp_byte_1         EQU #C398   ; Temporary 8-bit storage
temp_byte_2         EQU #C399   ; Temporary 8-bit storage
temp_byte_3         EQU #C39A   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #C3BA   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #C3DA   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #C3FA   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #C41A   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C43A   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C47A   ; Temporary 16-bit storage (64 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C4BA   ; End of project variables (1210 bytes used)

; ==================================================================
; MEMORY SAFETY CHECK
; ==================================================================
; RAM Layout:
;   #C000-#C4BA: Project variables (1210 bytes)
;   #C4BA-#F37F: Free RAM (~11974 bytes available)
