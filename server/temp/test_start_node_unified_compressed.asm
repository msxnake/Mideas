...
; BANK 00 @#0393 : sprites.asm (2359 bytes)
; BANK 00 @#0CCA : font.asm (174 bytes)
; BANK 00 @#0D78 : hud.asm (79 bytes)
; BANK 00 @#0DC7 : menus.asm (168 bytes)
; BANK 00 @#0E6F : sound.asm part 1/2 (4497 bytes)
; BANK 01 @#0000 : sound.asm part 2/2 (5044 bytes)
; BANK 01 @#13B4 : scroll.asm (2342 bytes)
; BANK 01 @#1CDA : animtiles.asm (806 bytes)
; BANK 02 @#0000 : animtiles.asm (3771 bytes)
; BANK 02 @#0EBB : statemachine.asm (5 bytes)
; BANK 02 @#0EC0 : gameflow.asm (4416 bytes)
; BANK 03 @#0000 : gameflow.asm (740 bytes)
...
entity_x_pos        EQU #DD19   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DD39   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DD59   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DD79   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DD99   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DDB9   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DDD9   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DDF9   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DE19   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DE39   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DE3A   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DE5A   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DE7A   ; Entity health (32 bytes)
entity_anim_frame   EQU #DE9A   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DEBA   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DEDA   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DEFA   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DF1A   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DF3A   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DF5A   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DF7A   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DF9A   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DFBA   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DFDA   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #DFFA   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E01A   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E03A   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E05A   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E07A   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E09A   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E0BA   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E0DA   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E0FA   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E11A   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E13A   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E15A   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E17A   ; Number of sprites currently active
sprites_dirty      EQU #E17B   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E17C   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E19C   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E1BC   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E1DC   ; Runtime base 16x16 slot per sprite asset (1 bytes)
sprite_placeholder_base_pattern_num EQU #E1DD   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E1DE   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E1DF   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E25F   ; Player X position (16-bit)
player_y            EQU #E261   ; Player Y position (16-bit)
player_runtime_enabled EQU #E263   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E264   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E265   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E266   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E267   ; Player health points
player_score        EQU #E268   ; Player score (16-bit)
gem_count           EQU #E26A   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E26B   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E26C   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E26D   ; Interaction type id of last interacted tile
last_interaction_value EQU #E26E   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E26F   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E270   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E271   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E272   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E273   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E274   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E2B4   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E2F4   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E334   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E374   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E384   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E394   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E3A4   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E3B4   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E3C4   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E3D4   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E3D5   ; Temporary 16-bit storage
temp_word_2         EQU #E3D7   ; Temporary 16-bit storage
temp_byte_1         EQU #E3D9   ; Temporary 8-bit storage
temp_byte_2         EQU #E3DA   ; Temporary 8-bit storage
temp_byte_3         EQU #E3DB   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E3FB   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E41B   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E43B   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E45B   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E45C   ; Frames remaining for current SFX
sfx_fadeout         EQU #E45D   ; Reserved fadeout flag/state
temp_byte_7         EQU #E45E   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E47E   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E49E   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E4BE   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E4DE   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E4FE   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E51E   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E53E   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E55E   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E57E   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E59E   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E5BE   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E5DE   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E5FE   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E61E   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E63E   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E65E   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E67E   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E69E   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E6BE   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E6FE   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E73E   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E75E   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E77E   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E79E   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E79F   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E7A0   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E7A1   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E7A2   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E7A3   ; Cached entity X for wall checks
wall_temp_y         EQU #E7A4   ; Cached entity Y for wall checks
wall_hit_left       EQU #E7A5   ; Hitbox left edge cache
wall_hit_top        EQU #E7A6   ; Hitbox top edge cache
wall_hit_right      EQU #E7A7   ; Hitbox right edge cache
wall_hit_bottom     EQU #E7A8   ; Hitbox bottom edge cache
wall_hit_w          EQU #E7A9   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E7AA   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E7AB   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E7AC   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E7AD   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E7AE   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E7AF   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E7CF   ; Number of entries in active_entity_list
hero_entity_id      EQU #E7D0   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E7D1   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E7D2   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E7F2   ; Number of entries in input_entity_list
render_entity_list  EQU #E7F3   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E813   ; Number of entries in render_entity_list
collision_entity_list EQU #E814   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E834   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E835   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E855   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E856   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E876   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E877   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E897   ; Number of entities in coll_list
coll_src_left       EQU #E898   ; Source AABB left edge (scratch)
coll_src_right      EQU #E899   ; Source AABB right edge (scratch)
coll_src_top        EQU #E89A   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E89B   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E89C   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E89C   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E89E   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E8A0   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E8A2   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E8A4   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E8A6   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E8A8   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E8AA   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E8AC   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E8AD   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E8B2   ; Frame counter (16-bit)
task_exec_time          EQU #E8B4   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E8B6   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E8B7   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E8B7   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E8B8   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E8B9   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E8BA   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E8BB   ; 0=stopped, 1=track active
music_muted          EQU #E8BC   ; 0=audible, 1=muted/pause
music_loop           EQU #E8BD   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E8BE   ; Current ROM track index
music_row_frames     EQU #E8BF   ; Frames per tracker row
music_row_countdown  EQU #E8C0   ; Countdown to next row
music_order_pos      EQU #E8C1   ; Current order position
music_pattern_index  EQU #E8C2   ; Current pattern index
music_pattern_row    EQU #E8C3   ; Current row inside pattern
music_pattern_rows   EQU #E8C4   ; Cached rows in current pattern
music_track_ptr_l    EQU #E8C5   ; Current track pointer low byte
music_track_ptr_h    EQU #E8C6   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E8C7   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E8C8   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E8C9   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E8CA   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E8CA   ; Channel A
music_ch_b_note EQU #E8CB   ; Channel B
music_ch_c_note EQU #E8CC   ; Channel C
music_ch_instrument_base EQU #E8CD   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E8CD   ; Channel A
music_ch_b_instrument EQU #E8CE   ; Channel B
music_ch_c_instrument EQU #E8CF   ; Channel C
music_ch_ornament_base EQU #E8D0   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E8D0   ; Channel A
music_ch_b_ornament EQU #E8D1   ; Channel B
music_ch_c_ornament EQU #E8D2   ; Channel C
music_ch_volume_base EQU #E8D3   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E8D3   ; Channel A
music_ch_b_volume EQU #E8D4   ; Channel B
music_ch_c_volume EQU #E8D5   ; Channel C
music_ch_vol_step_base EQU #E8D6   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E8D6   ; Channel A
music_ch_b_vol_step EQU #E8D7   ; Channel B
music_ch_c_vol_step EQU #E8D8   ; Channel C
music_ch_tone_step_base EQU #E8D9   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E8D9   ; Channel A
music_ch_b_tone_step EQU #E8DA   ; Channel B
music_ch_c_tone_step EQU #E8DB   ; Channel C
music_ch_noise_step_base EQU #E8DC   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E8DC   ; Channel A
music_ch_b_noise_step EQU #E8DD   ; Channel B
music_ch_c_noise_step EQU #E8DE   ; Channel C
music_ch_orn_step_base EQU #E8DF   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E8DF   ; Channel A
music_ch_b_orn_step EQU #E8E0   ; Channel B
music_ch_c_orn_step EQU #E8E1   ; Channel C
...
;   #E8E2-#F37F: Free RAM (~2718 bytes available)
