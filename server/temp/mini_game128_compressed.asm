...
;   Active entities: 13
;   Used components: Position, Sprite, Behavior, Health, Jump, Gravity, Animation, Collision, Input, StateMachine, Cursors, Carry, comp_shoot, WallCollision, comp_physics, Patrol, comp_box, Collectible, Damage
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Behavior, Health, Jump, Gravity, Animation, Collision, Input, StateMachine, Cursors, Carry, comp_shoot, WallCollision, comp_physics, Patrol, comp_box, Collectible, Damage 
...
; Entity: e_platform_multi 1 (instance from template: tpl_1761854826357_l38q3)
ENTITY_E_PLATFORM_MULTI_1_2_ID EQU 10
...
FONT_COLOR_DATA:
    ...
    DB #96,#F1,#96,#F0,#85,#F1,#57,#D6,#30,#EA,#41,#FE,#51,#7C,#F0,#05
    DB #77,#40,#75,#55,#58
load_font_colors:
...
gameflow_node_gfn_1762780385259_data:
    db 0    ; Number of assignments
    ; WARNING: 1 Globals assignment(s) skipped (undefined global variable)
    ; No valid global assignments found
...
; Free RAM buffer for font pattern data decompression (344 bytes)
; ==================================================================
ZX0_FONT_PATTERN_BUFFER EQU #D300

; ==================================================================
; ZX0 FONT COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for font color data decompression (344 bytes)
; ==================================================================
ZX0_FONT_COLOR_BUFFER EQU #D500
