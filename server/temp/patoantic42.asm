...
; Estimated payload bytes: 112995
; Estimated banks used: 14
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (1163 bytes)
; BANK 00 @#048B : patterns.asm (1290 bytes)
; BANK 00 @#0995 : colors.asm (1191 bytes)
; BANK 00 @#0E3C : components.asm (22 bytes)
; BANK 00 @#0E52 : entities.asm (4526 bytes)
; BANK 01 @#0000 : entities.asm (3187 bytes)
; BANK 01 @#0C73 : worlds.asm (3988 bytes)
; BANK 01 @#1C07 : screens.asm part 1/5 (1017 bytes)
; BANK 02 @#0000 : screens.asm part 2/5 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/5 (8192 bytes)
; BANK 04 @#0000 : screens.asm part 4/5 (8192 bytes)
; BANK 05 @#0000 : screens.asm part 5/5 (8192 bytes)
; BANK 06 @#0000 : screens.asm part 6/5 (1411 bytes)
; BANK 06 @#0583 : sprites.asm (6781 bytes)
; BANK 07 @#0000 : sprites.asm (1269 bytes)
; BANK 07 @#04F5 : font.asm (1861 bytes)
; BANK 07 @#0C3A : hud.asm (3538 bytes)
; BANK 07 @#1A0C : menus.asm (444 bytes)
; BANK 07 @#1BC8 : sound.asm part 1/2 (1080 bytes)
; BANK 08 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 09 @#0000 : sound.asm part 3/2 (276 bytes)
; BANK 09 @#0114 : scroll.asm (2353 bytes)
; BANK 09 @#0A45 : animtiles.asm (5563 bytes)
; BANK 10 @#0000 : animtiles.asm (239 bytes)
; BANK 10 @#00EF : statemachine.asm part 1/2 (7953 bytes)
; BANK 11 @#0000 : statemachine.asm part 2/2 (3905 bytes)
; BANK 11 @#0F41 : gameflow.asm part 1/3 (4287 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (6499 bytes)
...
sprite_asset_base_pattern_slot_runtime EQU #E2BB   ; Runtime base 16x16 slot per sprite asset (11 bytes)
sprite_placeholder_base_pattern_num EQU #E2C6   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E2C7   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E2C8   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (4 screens detected)
; ==================================================================
current_screen_id   EQU #E348   ; Currently displayed screen ID
screen_dirty_flag   EQU #E349   ; Screen needs redraw flag
screen_transition_cooldown EQU #E34A   ; Cooldown frames after screen transition
current_world_id    EQU #E34B   ; Current world ID (for multi-world support)
current_screen_index EQU #E34C   ; Current screen index within world
current_screen_anim_group_count EQU #E34D   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E34E   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E34F   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E350   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E351   ; Player X position (16-bit)
player_y            EQU #E353   ; Player Y position (16-bit)
player_runtime_enabled EQU #E355   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E356   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E357   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E358   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E359   ; Player health points
player_score        EQU #E35A   ; Player score (16-bit)
gem_count           EQU #E35C   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E35D   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E35E   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E35F   ; Interaction type id of last interacted tile
last_interaction_value EQU #E360   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E361   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E362   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E363   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E364   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E365   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E366   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E3A6   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E3E6   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E426   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E466   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E476   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E486   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E496   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E4A6   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E4B6   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E4C6   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E4C7   ; Temporary 16-bit storage
temp_word_2         EQU #E4C9   ; Temporary 16-bit storage
temp_byte_1         EQU #E4CB   ; Temporary 8-bit storage
temp_byte_2         EQU #E4CC   ; Temporary 8-bit storage
temp_byte_3         EQU #E4CD   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E4ED   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E50D   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E52D   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E54D   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E54E   ; Frames remaining for current SFX
sfx_fadeout         EQU #E54F   ; Reserved fadeout flag/state
temp_byte_7         EQU #E550   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E570   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E590   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E5B0   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E5D0   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E5F0   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E610   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E630   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E650   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E670   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E690   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E6B0   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E6D0   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E6F0   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E710   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E730   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E750   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E770   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E790   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E7B0   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E7F0   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E830   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E850   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E870   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E890   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E891   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E892   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E893   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E894   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E895   ; Cached entity X for wall checks
wall_temp_y         EQU #E896   ; Cached entity Y for wall checks
wall_hit_left       EQU #E897   ; Hitbox left edge cache
wall_hit_top        EQU #E898   ; Hitbox top edge cache
wall_hit_right      EQU #E899   ; Hitbox right edge cache
wall_hit_bottom     EQU #E89A   ; Hitbox bottom edge cache
wall_hit_w          EQU #E89B   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E89C   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E89D   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E89E   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E89F   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E8A0   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E8A1   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E8C1   ; Number of entries in active_entity_list
hero_entity_id      EQU #E8C2   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E8C3   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E8C4   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E8E4   ; Number of entries in input_entity_list
render_entity_list  EQU #E8E5   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E905   ; Number of entries in render_entity_list
collision_entity_list EQU #E906   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E926   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E927   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E947   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E948   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E968   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E969   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E989   ; Number of entities in coll_list
coll_src_left       EQU #E98A   ; Source AABB left edge (scratch)
coll_src_right      EQU #E98B   ; Source AABB right edge (scratch)
coll_src_top        EQU #E98C   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E98D   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E98E   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E98E   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E990   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E992   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E994   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E996   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E998   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E99A   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E99C   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E99E   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E99F   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E9A4   ; Frame counter (16-bit)
task_exec_time          EQU #E9A6   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E9A8   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E9A9   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E9A9   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E9AA   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E9AB   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E9AC   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E9AD   ; 0=stopped, 1=track active
music_muted          EQU #E9AE   ; 0=audible, 1=muted/pause
music_loop           EQU #E9AF   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E9B0   ; Current ROM track index
music_row_frames     EQU #E9B1   ; Frames per tracker row
music_row_countdown  EQU #E9B2   ; Countdown to next row
music_order_pos      EQU #E9B3   ; Current order position
music_pattern_index  EQU #E9B4   ; Current pattern index
music_pattern_row    EQU #E9B5   ; Current row inside pattern
music_pattern_rows   EQU #E9B6   ; Cached rows in current pattern
music_track_ptr_l    EQU #E9B7   ; Current track pointer low byte
music_track_ptr_h    EQU #E9B8   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E9B9   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E9BA   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E9BB   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E9BC   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E9BC   ; Channel A
music_ch_b_note EQU #E9BD   ; Channel B
music_ch_c_note EQU #E9BE   ; Channel C
music_ch_instrument_base EQU #E9BF   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E9BF   ; Channel A
music_ch_b_instrument EQU #E9C0   ; Channel B
music_ch_c_instrument EQU #E9C1   ; Channel C
music_ch_ornament_base EQU #E9C2   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E9C2   ; Channel A
music_ch_b_ornament EQU #E9C3   ; Channel B
music_ch_c_ornament EQU #E9C4   ; Channel C
music_ch_volume_base EQU #E9C5   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E9C5   ; Channel A
music_ch_b_volume EQU #E9C6   ; Channel B
music_ch_c_volume EQU #E9C7   ; Channel C
music_ch_vol_step_base EQU #E9C8   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E9C8   ; Channel A
music_ch_b_vol_step EQU #E9C9   ; Channel B
music_ch_c_vol_step EQU #E9CA   ; Channel C
music_ch_tone_step_base EQU #E9CB   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E9CB   ; Channel A
music_ch_b_tone_step EQU #E9CC   ; Channel B
music_ch_c_tone_step EQU #E9CD   ; Channel C
music_ch_noise_step_base EQU #E9CE   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E9CE   ; Channel A
music_ch_b_noise_step EQU #E9CF   ; Channel B
music_ch_c_noise_step EQU #E9D0   ; Channel C
music_ch_orn_step_base EQU #E9D1   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E9D1   ; Channel A
music_ch_b_orn_step EQU #E9D2   ; Channel B
music_ch_c_orn_step EQU #E9D3   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E9D4   ; End of project variables (10708 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E9D4: Project variables (10708 bytes)
;   #E9D4-#F37F: Free RAM (~2476 bytes available)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (64 -> 55 bytes)
    DB #28,#00,#7F,#BF,#00,#EF,#F5,#F6,#83,#FF,#FF,#00,#FB,#88,#E5,#FE
    DB #FE,#EF,#FF,#FB,#E4,#B9,#F7,#FF,#EE,#00,#7E,#DD,#F3,#09,#DB,#01
    DB #E6,#18,#30,#30,#19,#18,#0C,#0C,#98,#41,#18,#24,#5A,#5A,#24,#18
    DB #81,#00,#F0,#D5,#00,#55,#60
load_pattern_bank0:
    ...
    ld bc, 64    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 64    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
tilebank_pattern_data_0:
    db #00, #7F, #7F, #00, #EF, #EF, #00, #7F, #00, #EF, #EF, #00, #FF, #FF, #00, #FB
    db #7F, #00, #FE, #FE, #00, #7F, #7F, #7F, #FB, #00, #FF, #FF, #00, #F7, #F7, #F7
    db #00, #7E, #DD, #00, #F7, #09, #FE, #00, #18, #30, #30, #19, #18, #0C, #0C, #98
    db #41, #18, #24, #5A, #5A, #24, #18, #81, #00, #18, #24, #5A, #5A, #24, #18, #00
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (64 -> 25 bytes)
    DB #8A,#41,#51,#FF,#FA,#F0,#F7,#FE,#E0,#E9,#F0,#BA,#C1,#FF,#31,#A2
    DB #C1,#8A,#81,#91,#A0,#A1,#4D,#55,#56
load_color_bank0:
    ...
    ld bc, 64     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
tilebank_color_data_0:
    ...
    db #C1, #C1, #C1, #31, #31, #C1, #C1, #C1, #81, #81, #81, #91, #91, #A1, #A1, #A1
...
;; ---- End of Frame: nina_walk_left_4_F0 ----

;; ---- Sprite Frame: nina_walk_left_4_F1 ----
;; Size: 16x16
...
NINA_IDLE_LEFT_5_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    DB #1F,#00,#00,#00,#00,#00,#00,#03,#02,#03,#03,#07,#00,#00,#00,#02
    DB #E0,#E0,#A0,#30,#18,#08,#08,#C0,#40,#C0,#E0,#F0,#00,#80,#00,#80

;; ---- End of Frame: nina_idle_left_5_F0 ----
...
NINA_JUMP_LEFT_6_F0_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    ...
    DB #C0,#E0,#E0,#90,#28,#04,#02,#02,#C0,#40,#E0,#F0,#D6,#00,#02,#00
...
;; ---- End of Frame: nina_jump_left_6_F0 ----
...
;; ---- End of Frame: anec_left_7_F0 ----

;; ---- Sprite Frame: anec_left_7_F1 ----
;; Size: 16x16
...
;; ---- End of Frame: nina_walk_right_8_F0 ----

;; ---- Sprite Frame: nina_walk_right_8_F1 ----
;; Size: 16x16
...
NINA_IDLE_RIGHT_9_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #D4524D)
    ...
    DB #F8,#00,#00,#00,#00,#00,#00,#C0,#40,#C0,#C0,#E0,#00,#00,#00,#40

;; ---- End of Frame: nina_idle_right_9_F0 ----
...
NINA_JUMP_RIGHT_10_F0_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #03,#07,#07,#09,#14,#20,#40,#40,#03,#02,#07,#0F,#6B,#00,#40,#00
...
;; ---- End of Frame: nina_jump_right_10_F0 ----
...
sprite_asset_base_pattern_slot_worldmap_1770754170935:
    ...
    db 0 ; Sprite 6: nina_jump_left
    db 12 ; Sprite 7: anec_left
    db 16 ; Sprite 8: nina_walk_right
    db 20 ; Sprite 9: nina_idle_right
    db 0 ; Sprite 10: nina_jump_right
...
SCREEN_PAN1_0_SPRITE_PATTERN_SLOTS EQU 23
...
SCREEN_PAN2_1_SUMMARY_FLAGS EQU #06
...
screen_runtime_summary_table:
    db 1, 2, 23, #0E    ; Screen 0: pan1
    db 0, 0, 1, #06    ; Screen 1: pan2
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 111 bytes)
    DB #95,#84,#69,#FF,#57,#D5,#80,#A5,#80,#5B,#82,#96,#E6,#F1,#87,#F6
    DB #FE,#FE,#80,#5E,#E7,#E0,#81,#FC,#E1,#80,#7A,#E7,#83,#F5,#FE,#E4
    DB #00,#1F,#FE,#5A,#87,#7C,#80,#5D,#FC,#F2,#80,#5D,#FD,#E7,#FD,#00
    DB #0B,#85,#60,#5A,#F1,#C0,#3E,#79,#FC,#F4,#80,#3D,#40,#1F,#85,#D5
    DB #00,#CF,#28,#D5,#40,#FF,#F0,#FC,#4E,#C0,#FE,#F0,#40,#56,#9D,#82
    DB #F9,#88,#A8,#F5,#3A,#F8,#DF,#80,#7B,#FC,#D4,#80,#FF,#FC,#C0,#5E
    DB #80,#1E,#FC,#53,#F3,#CB,#80,#94,#FC,#F8,#CB,#80,#D5,#55,#60
...
BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 70 bytes)
    DB #85,#00,#56,#E4,#10,#C0,#5B,#08,#C7,#F6,#D7,#C0,#E1,#E7,#FE,#E5
    DB #C0,#3D,#00,#13,#D6,#FE,#9F,#08,#C0,#17,#7F,#F4,#C0,#14,#DD,#5A
    DB #7D,#C0,#43,#BD,#F6,#C0,#46,#95,#08,#3C,#F0,#F5,#FE,#E0,#D8,#E5
    DB #90,#39,#98,#7F,#3B,#C0,#5A,#08,#47,#D4,#80,#FE,#FE,#C0,#43,#D1
    DB #FE,#E1,#C0,#0D,#55,#56
SCREEN_PAN1_0_INTERACTION_TYPE_MAP:
    ...
    DB #00,#00,#01,#00,#00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_PAN1_0_INTERACTION_VALUE_MAP:
    ...
    DB #01,#01,#01,#01,#01,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 31 bytes)
    DB #80,#FF,#11,#08,#E3,#81,#80,#FC,#FE,#EA,#F5,#FC,#12,#25,#83,#82
    DB #4E,#A8,#4F,#80,#55,#F5,#2C,#28,#83,#47,#91,#80,#35,#55,#58
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #80,#00,#11,#0A,#10,#4E,#EA,#3C,#FE,#55,#35,#55,#58
...
SCREEN_PAN3_3_LAYOUT:
    ; ZX0 compressed layout (768 -> 53 bytes)
    DB #84,#FF,#10,#8F,#80,#81,#FC,#0F,#DF,#D2,#FC,#24,#82,#83,#7D,#28
    DB #43,#24,#DE,#54,#E3,#E2,#31,#DE,#3C,#80,#57,#C1,#FC,#F1,#80,#F1
    DB #34,#7A,#AC,#93,#83,#C0,#C0,#E0,#80,#4F,#FC,#13,#75,#AC,#29,#82
    DB #F5,#80,#75,#55,#58
...
anim_group_0_gema:
    ...
    ; Frame 0: gema
    db #41, #18, #24, #5A, #5A, #24, #18, #81, #A1, #A1, #A1, #A1, #A1, #A1, #A1, #A1
    ; Frame 1: gema_f0
    db #00, #18, #24, #5A, #5A, #24, #18, #00, #A1, #A1, #A1, #A1, #A1, #A1, #A1, #A1
...
submenu_cursor_sprite_layer_pattern_table:
    ...
    dw 0
    dw NINA_WALK_LEFT_4_F0_LAYER0
    dw NINA_WALK_LEFT_4_F0_LAYER1
    dw 0
    dw 0
    dw NINA_IDLE_LEFT_5_F0_LAYER1
    dw NINA_IDLE_LEFT_5_F0_LAYER2
    dw 0
    dw 0
    dw NINA_JUMP_LEFT_6_F0_LAYER0
    dw NINA_JUMP_LEFT_6_F0_LAYER1
    dw 0
    dw 0
    dw ANEC_LEFT_7_F0_LAYER1
    dw ANEC_LEFT_7_F0_LAYER2
    dw 0
    dw 0
    dw NINA_WALK_RIGHT_8_F0_LAYER0
    dw NINA_WALK_RIGHT_8_F0_LAYER1
    dw 0
    dw 0
    dw NINA_IDLE_RIGHT_9_F0_LAYER1
    dw NINA_IDLE_RIGHT_9_F0_LAYER2
    dw 0
    dw 0
    dw NINA_JUMP_RIGHT_10_F0_LAYER0
    dw NINA_JUMP_RIGHT_10_F0_LAYER1
    dw 0
    dw 0
...
submenu_cursor_sprite_layer_bank_table:
    ...
    db 0
    db 0
    db ((BOLA_DEAD_3_F0_LAYER1 - #4000) / #2000)
    db 0
    db 0
    db 0
    db ((NINA_WALK_LEFT_4_F0_LAYER0 - #4000) / #2000)
    db ((NINA_WALK_LEFT_4_F0_LAYER1 - #4000) / #2000)
    db 0
    db 0
    db ((NINA_IDLE_LEFT_5_F0_LAYER1 - #4000) / #2000)
    db ((NINA_IDLE_LEFT_5_F0_LAYER2 - #4000) / #2000)
    db 0
    db 0
    db ((NINA_JUMP_LEFT_6_F0_LAYER0 - #4000) / #2000)
    db ((NINA_JUMP_LEFT_6_F0_LAYER1 - #4000) / #2000)
    db 0
    db 0
    db ((ANEC_LEFT_7_F0_LAYER1 - #4000) / #2000)
    db ((ANEC_LEFT_7_F0_LAYER2 - #4000) / #2000)
    db 0
    db 0
    db ((NINA_WALK_RIGHT_8_F0_LAYER0 - #4000) / #2000)
    db ((NINA_WALK_RIGHT_8_F0_LAYER1 - #4000) / #2000)
    db 0
    db 0
    db ((NINA_IDLE_RIGHT_9_F0_LAYER1 - #4000) / #2000)
    db ((NINA_IDLE_RIGHT_9_F0_LAYER2 - #4000) / #2000)
    db 0
    db 0
    db ((NINA_JUMP_RIGHT_10_F0_LAYER0 - #4000) / #2000)
    db ((NINA_JUMP_RIGHT_10_F0_LAYER1 - #4000) / #2000)
    db 0
    db 0
