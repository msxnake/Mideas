...
TILE_PATTERN_BANK0:
    ...
    ; Tile 1: grass1 (16x16px)
    DB #8D, #AD, #B7, #5E, #A9, #ED, #D0, #ED, #D5, #BC, #1F, #2D, #BC, #9B, #BB, #7B, #4F, #FA, #77, #5A, #1E, #00, #14, #18, #B0, #5F, #8F, #2A, #2F, #83, #A1, #AB
...
TILE_COLOR_BANK0:
    ...
    ; Tile 1: grass1 colors (fg/bg pairs)
    DB #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1, #C1
...
SCREEN_PANTALLA1_ID EQU 0
SCREEN_PANTALLA2_ID EQU 1
...
;; --- TILE INDEX REFERENCES for PANTALLA1 ---
...
;; MAP: pantalla2 (32x24 tiles)
;; Total size: 768 bytes

;; --- TILE INDEX REFERENCES for PANTALLA2 ---
; Generated using exact Screen Editor "Download ASM" logic
; Byte values represent actual character codes in VRAM

SCREEN_PANTALLA2_WIDTH     EQU 32
SCREEN_PANTALLA2_HEIGHT    EQU 24
SCREEN_PANTALLA2_SIZE      EQU 768

SCREEN_PANTALLA2_LAYOUT:
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#00,#01,#00,#01,#04,#05
    DB #04,#05,#04,#05,#04,#05,#04,#05,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#02,#03,#02,#03,#06,#07
    DB #06,#07,#06,#07,#06,#07,#06,#07,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#04,#05
    DB #04,#05,#04,#05,#04,#05,#04,#05,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#06,#07
    DB #06,#07,#06,#07,#06,#07,#06,#07,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#FF,#FF,#00,#01,#04,#05
    DB #04,#05,#04,#05,#04,#05,#04,#05,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#FF,#FF,#02,#03,#06,#07
    DB #06,#07,#06,#07,#06,#07,#06,#07,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#04,#05
    DB #04,#05,#04,#05,#04,#05,#04,#05,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#FF,#00
    DB #01,#00,#01,#00,#01,#00,#01,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#FF,#02
    DB #03,#02,#03,#02,#03,#02,#03,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#00
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#02,#03,#02
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#01,#00,#01
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#03,#02,#03
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#00,#01,#00
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#02,#03,#02
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#01,#00,#01
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#02,#FF
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#00,#FF
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#02,#FF
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#00,#FF
...
;; BEHAVIOR MAP: pantalla2 (32x24 tiles)
;; Total size: 768 bytes (Map IDs 0-255)
;; Data format: HEX

BEHAVIOR_PANTALLA2_WIDTH     EQU 32
BEHAVIOR_PANTALLA2_HEIGHT    EQU 24
BEHAVIOR_PANTALLA2_SIZE      EQU 768

BEHAVIOR_PANTALLA2_DATA:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
;; End of Behavior Map Data for pantalla2
...
LOAD_SCREEN_PANTALLA1:
    ...
    LD HL, SCREEN_PANTALLA1_LAYOUT
    LD DE, NAMTBL
    LD BC, SCREEN_PANTALLA1_SIZE
    CALL LDIRVM
    RET

LOAD_SCREEN_PANTALLA2:
    ; Load pantalla2 screen
    LD HL, SCREEN_PANTALLA2_LAYOUT
    LD DE, NAMTBL
    LD BC, SCREEN_PANTALLA2_SIZE
    CALL LDIRVM
    RET
