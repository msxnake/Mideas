...
; 
; CRITICAL FIX: Returns ASCII codes directly (32+ for font characters)
; Font is loaded at character positions 32-127, so ASCII code = tile index
; ------------------------------------------------------------------
hud_ascii_to_tile:
    ; SIMPLIFIED: Just return the ASCII code directly
    ; Font patterns are loaded at their ASCII positions (32 = space, 48 = '0', 65 = 'A', etc.)
    ; No remapping needed - ASCII code IS the tile index
