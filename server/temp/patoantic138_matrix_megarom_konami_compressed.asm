; ==================================================================
; PATOANTIC138 - MEGAROM UNIFIED FILE
...
; Bank 3 [#A000-#C000]: gameflow (19398/8192 bytes est.)
; Bank 4 [#6000-#8000]: screens_code (14752/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 5 [#6000-#8000]: entities (9445/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 6 [#6000-#8000]: sprites (8115/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 7 [#6000-#8000]: sound (7124/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 8 [#6000-#8000]: bosses (5666/8192 bytes est.) [FAR — accessed via trampoline]
; Bank 9 [#6000-#8000]: worlds (4765/8192 bytes est.) [FAR — accessed via trampoline]
...
; ------------------------------------------------------------------
; Far code banks: bank4(screens_code) bank5(entities) bank6(sprites) bank7(sound) bank8(bosses) bank9(worlds) bank10(animtiles) bank11(hud) bank12(font) bank13(scroll) bank14(patterns_code) bank15(colors_code) bank16(menus)
; ------------------------------------------------------------------
...
; Estimated payload bytes: 153011
...
; BANK 10 @#0000 : screens.asm part 3/2 (1468 bytes)
; BANK 10 @#05BC : sprites.asm (6724 bytes)
; BANK 11 @#0000 : sprites.asm (1392 bytes)
; BANK 11 @#0570 : font.asm (3576 bytes)
; BANK 11 @#1368 : hud.asm (3224 bytes)
; BANK 12 @#0000 : hud.asm (416 bytes)
; BANK 12 @#01A0 : menus.asm (444 bytes)
; BANK 12 @#035C : sound.asm (7124 bytes)
; BANK 12 @#1F30 : scroll.asm (208 bytes)
; BANK 13 @#0000 : scroll.asm (2145 bytes)
; BANK 13 @#0861 : animtiles.asm (4223 bytes)
; BANK 13 @#18E0 : bosses.asm (1824 bytes)
; BANK 14 @#0000 : bosses.asm (3842 bytes)
; BANK 14 @#0F02 : statemachine.asm part 1/2 (4350 bytes)
; BANK 15 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 16 @#0000 : statemachine.asm part 3/2 (2538 bytes)
; BANK 16 @#09EA : gameflow.asm part 1/3 (5654 bytes)
; BANK 17 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 18 @#0000 : gameflow.asm part 3/3 (5555 bytes); ==================================================================
...
;
; BANK 17 used 3154 / 8192
; - SCREEN_PAN1_0_LAYOUT               136 stored /   768 raw bytes @ #A000 (rom #26000, offset +#0000) [SCREENS/SCREEN_LAYOUT] flags=1
; - SCREEN_PAN1_0_EFFECTS_LAYOUT         6 stored /   768 raw bytes @ #A088 (rom #26088, offset +#0088) [SCREENS/SCREEN_EFFECTS_LAYOUT] flags=1
; - BEHAVIOR_PAN1_0_DATA                69 stored /   768 raw bytes @ #A08E (rom #2608E, offset +#008E) [SCREENS/SCREEN_BEHAVIOR_MAP] flags=1
; - SCREEN_PAN1_0_INTERACTION_TYPE_MAP    15 stored /   768 raw bytes @ #A0D3 (rom #260D3, offset +#00D3) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN1_0_INTERACTION_VALUE_MAP    60 stored /   768 raw bytes @ #A0E2 (rom #260E2, offset +#00E2) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN1_0_INTERACTION_TARGET_MAP     6 stored /   768 raw bytes @ #A11E (rom #2611E, offset +#011E) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN2_1_LAYOUT                87 stored /   768 raw bytes @ #A124 (rom #26124, offset +#0124) [SCREENS/SCREEN_LAYOUT] flags=1
; - SCREEN_PAN2_1_EFFECTS_LAYOUT         6 stored /   768 raw bytes @ #A17B (rom #2617B, offset +#017B) [SCREENS/SCREEN_EFFECTS_LAYOUT] flags=1
; - BEHAVIOR_PAN2_1_DATA                42 stored /   768 raw bytes @ #A181 (rom #26181, offset +#0181) [SCREENS/SCREEN_BEHAVIOR_MAP] flags=1
; - SCREEN_PAN2_1_INTERACTION_TYPE_MAP    15 stored /   768 raw bytes @ #A1AB (rom #261AB, offset +#01AB) [SCREENS/SCREEN_DATA] flags=1
; - tile_pattern_bank0                 125 stored /   144 raw bytes @ #A1BA (rom #261BA, offset +#01BA) [PATTERNS/TILE_PATTERNS] flags=1
; - tile_color_bank0                    51 stored /   144 raw bytes @ #A237 (rom #26237, offset +#0237) [COLORS/TILE_COLORS] flags=1
; - tilebank_pattern_data_0            119 stored /   136 raw bytes @ #A26A (rom #2626A, offset +#026A) [PATTERNS/TILE_PATTERNS] flags=1
; - ANEC_RIGHT_0_F0_LAYER1              32 stored /    32 raw bytes @ #A2E1 (rom #262E1, offset +#02E1) [SPRITES/SPRITE_PATTERNS] flags=0
; - ANEC_RIGHT_0_F0_LAYER2              29 stored /    32 raw bytes @ #A301 (rom #26301, offset +#0301) [SPRITES/SPRITE_PATTERNS] flags=1
; - SCREEN_PAN1_0_EFFECT_ZONE_TABLE      1 stored /     1 raw bytes @ #A31E (rom #2631E, offset +#031E) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
; - SCREEN_PAN1_0_BOSS_TABLE             1 stored /     1 raw bytes @ #A31F (rom #2631F, offset +#031F) [SCREENS/SCREEN_DATA] flags=0
; - SCREEN_PAN2_1_EFFECT_ZONE_TABLE      1 stored /     1 raw bytes @ #A320 (rom #26320, offset +#0320) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
; - SCREEN_PAN2_1_BOSS_TABLE             1 stored /     1 raw bytes @ #A321 (rom #26321, offset +#0321) [SCREENS/SCREEN_DATA] flags=0
; - SCREEN_BACKGROUND1_2_EFFECT_ZONE_TABLE     1 stored /     1 raw bytes @ #A322 (rom #26322, offset +#0322) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
; - SCREEN_BACKGROUND1_2_BOSS_TABLE      1 stored /     1 raw bytes @ #A323 (rom #26323, offset +#0323) [SCREENS/SCREEN_DATA] flags=0
; - SCREEN_PAN3_3_EFFECT_ZONE_TABLE      1 stored /     1 raw bytes @ #A324 (rom #26324, offset +#0324) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
; - SCREEN_PAN3_3_BOSS_TABLE             1 stored /     1 raw bytes @ #A325 (rom #26325, offset +#0325) [SCREENS/SCREEN_DATA] flags=0
; - SCREEN_PAN4_4_EFFECT_ZONE_TABLE      1 stored /     1 raw bytes @ #A326 (rom #26326, offset +#0326) [SCREENS/SCREEN_EFFECT_ZONE_TABLE] flags=0
; - SCREEN_PAN4_4_BOSS_TABLE             1 stored /     1 raw bytes @ #A327 (rom #26327, offset +#0327) [SCREENS/SCREEN_DATA] flags=0
; - SCREEN_PAN2_1_INTERACTION_VALUE_MAP    40 stored /   768 raw bytes @ #A328 (rom #26328, offset +#0328) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN2_1_INTERACTION_TARGET_MAP     6 stored /   768 raw bytes @ #A350 (rom #26350, offset +#0350) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_BACKGROUND1_2_LAYOUT          6 stored /   768 raw bytes @ #A356 (rom #26356, offset +#0356) [SCREENS/SCREEN_LAYOUT] flags=1
; - SCREEN_BACKGROUND1_2_EFFECTS_LAYOUT     6 stored /   768 raw bytes @ #A35C (rom #2635C, offset +#035C) [SCREENS/SCREEN_EFFECTS_LAYOUT] flags=1
; - BEHAVIOR_BACKGROUND1_2_DATA          6 stored /   768 raw bytes @ #A362 (rom #26362, offset +#0362) [SCREENS/SCREEN_BEHAVIOR_MAP] flags=1
; - SCREEN_BACKGROUND1_2_INTERACTION_TYPE_MAP     6 stored /   768 raw bytes @ #A368 (rom #26368, offset +#0368) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_BACKGROUND1_2_INTERACTION_VALUE_MAP     6 stored /   768 raw bytes @ #A36E (rom #2636E, offset +#036E) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_BACKGROUND1_2_INTERACTION_TARGET_MAP     6 stored /   768 raw bytes @ #A374 (rom #26374, offset +#0374) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN3_3_LAYOUT               103 stored /   768 raw bytes @ #A37A (rom #2637A, offset +#037A) [SCREENS/SCREEN_LAYOUT] flags=1
; - SCREEN_PAN3_3_EFFECTS_LAYOUT         6 stored /   768 raw bytes @ #A3E1 (rom #263E1, offset +#03E1) [SCREENS/SCREEN_EFFECTS_LAYOUT] flags=1
; - tilebank_color_data_0               48 stored /   136 raw bytes @ #A3E7 (rom #263E7, offset +#03E7) [COLORS/TILE_COLORS] flags=1
; - ANEC_RIGHT_0_F1_LAYER1              32 stored /    32 raw bytes @ #A417 (rom #26417, offset +#0417) [SPRITES/SPRITE_PATTERNS] flags=0
; - ANEC_RIGHT_0_F1_LAYER2              28 stored /    32 raw bytes @ #A437 (rom #26437, offset +#0437) [SPRITES/SPRITE_PATTERNS] flags=1
; - BOLA_1_F0_LAYER1                    24 stored /    32 raw bytes @ #A453 (rom #26453, offset +#0453) [SPRITES/SPRITE_PATTERNS] flags=1
; - BOLA_1_F1_LAYER1                    28 stored /    32 raw bytes @ #A46B (rom #2646B, offset +#046B) [SPRITES/SPRITE_PATTERNS] flags=1
; - PANELL_2_F0_LAYER1                  20 stored /    32 raw bytes @ #A487 (rom #26487, offset +#0487) [SPRITES/SPRITE_PATTERNS] flags=1
; - PANELL_2_F0_LAYER2                  14 stored /    32 raw bytes @ #A49B (rom #2649B, offset +#049B) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_RIGHT_3_F0_LAYER0         30 stored /    32 raw bytes @ #A4A9 (rom #264A9, offset +#04A9) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_RIGHT_3_F0_LAYER1         25 stored /    32 raw bytes @ #A4C7 (rom #264C7, offset +#04C7) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_RIGHT_3_F1_LAYER0         31 stored /    32 raw bytes @ #A4E0 (rom #264E0, offset +#04E0) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_RIGHT_3_F1_LAYER1         27 stored /    32 raw bytes @ #A4FF (rom #264FF, offset +#04FF) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_JUMP_RIGHT_4_F0_LAYER0         27 stored /    32 raw bytes @ #A51A (rom #2651A, offset +#051A) [SPRITES/SPRITE_PATTERNS] flags=1
; - BEHAVIOR_PAN3_3_DATA                60 stored /   768 raw bytes @ #A535 (rom #26535, offset +#0535) [SCREENS/SCREEN_BEHAVIOR_MAP] flags=1
; - SCREEN_PAN3_3_INTERACTION_TYPE_MAP    24 stored /   768 raw bytes @ #A571 (rom #26571, offset +#0571) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN3_3_INTERACTION_VALUE_MAP    58 stored /   768 raw bytes @ #A589 (rom #26589, offset +#0589) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN3_3_INTERACTION_TARGET_MAP     6 stored /   768 raw bytes @ #A5C3 (rom #265C3, offset +#05C3) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN4_4_LAYOUT               109 stored /   768 raw bytes @ #A5C9 (rom #265C9, offset +#05C9) [SCREENS/SCREEN_LAYOUT] flags=1
; - SCREEN_PAN4_4_EFFECTS_LAYOUT         6 stored /   768 raw bytes @ #A636 (rom #26636, offset +#0636) [SCREENS/SCREEN_EFFECTS_LAYOUT] flags=1
; - BEHAVIOR_PAN4_4_DATA                64 stored /   768 raw bytes @ #A63C (rom #2663C, offset +#063C) [SCREENS/SCREEN_BEHAVIOR_MAP] flags=1
; - SCREEN_PAN4_4_INTERACTION_TYPE_MAP    21 stored /   768 raw bytes @ #A67C (rom #2667C, offset +#067C) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN4_4_INTERACTION_VALUE_MAP    64 stored /   768 raw bytes @ #A691 (rom #26691, offset +#0691) [SCREENS/SCREEN_DATA] flags=1
; - SCREEN_PAN4_4_INTERACTION_TARGET_MAP     6 stored /   768 raw bytes @ #A6D1 (rom #266D1, offset +#06D1) [SCREENS/SCREEN_DATA] flags=1
; - NINA_JUMP_RIGHT_4_F0_LAYER1         24 stored /    32 raw bytes @ #A6D7 (rom #266D7, offset +#06D7) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_RIGHT_5_F0_LAYER0         30 stored /    32 raw bytes @ #A6EF (rom #266EF, offset +#06EF) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_RIGHT_5_F0_LAYER1         23 stored /    32 raw bytes @ #A70D (rom #2670D, offset +#070D) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_RIGHT_5_F1_LAYER0         28 stored /    32 raw bytes @ #A724 (rom #26724, offset +#0724) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_RIGHT_5_F1_LAYER1         27 stored /    32 raw bytes @ #A740 (rom #26740, offset +#0740) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_RIGHT_5_F2_LAYER0         30 stored /    32 raw bytes @ #A75B (rom #2675B, offset +#075B) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_RIGHT_5_F2_LAYER1         26 stored /    32 raw bytes @ #A779 (rom #26779, offset +#0779) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_DEAD_RIGHT_6_F0_LAYER0         32 stored /    32 raw bytes @ #A793 (rom #26793, offset +#0793) [SPRITES/SPRITE_PATTERNS] flags=0
; - NINA_DEAD_RIGHT_6_F0_LAYER2         32 stored /    32 raw bytes @ #A7B3 (rom #267B3, offset +#07B3) [SPRITES/SPRITE_PATTERNS] flags=0
; - NINA_DEAD_RIGHT_6_F1_LAYER0         26 stored /    32 raw bytes @ #A7D3 (rom #267D3, offset +#07D3) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_DEAD_RIGHT_6_F1_LAYER2         32 stored /    32 raw bytes @ #A7ED (rom #267ED, offset +#07ED) [SPRITES/SPRITE_PATTERNS] flags=0
; - NINA_IDLE_RIGHT_7_F0_LAYER0         30 stored /    32 raw bytes @ #A80D (rom #2680D, offset +#080D) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_IDLE_RIGHT_7_F0_LAYER1         24 stored /    32 raw bytes @ #A82B (rom #2682B, offset +#082B) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_IDLE_RIGHT_7_F1_LAYER0         30 stored /    32 raw bytes @ #A843 (rom #26843, offset +#0843) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_IDLE_RIGHT_7_F1_LAYER1         24 stored /    32 raw bytes @ #A861 (rom #26861, offset +#0861) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_FALL_RIGHT_8_F0_LAYER0         29 stored /    32 raw bytes @ #A879 (rom #26879, offset +#0879) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_FALL_RIGHT_8_F0_LAYER1         24 stored /    32 raw bytes @ #A896 (rom #26896, offset +#0896) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_RIGHT_9_F0_LAYER2       21 stored /    32 raw bytes @ #A8AE (rom #268AE, offset +#08AE) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_RIGHT_9_F0_LAYER3       29 stored /    32 raw bytes @ #A8C3 (rom #268C3, offset +#08C3) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_RIGHT_9_F1_LAYER2       21 stored /    32 raw bytes @ #A8E0 (rom #268E0, offset +#08E0) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_RIGHT_9_F1_LAYER3       28 stored /    32 raw bytes @ #A8F5 (rom #268F5, offset +#08F5) [SPRITES/SPRITE_PATTERNS] flags=1
; - ANEC_LEFT_10_F0_LAYER1              32 stored /    32 raw bytes @ #A911 (rom #26911, offset +#0911) [SPRITES/SPRITE_PATTERNS] flags=0
; - ANEC_LEFT_10_F0_LAYER2              29 stored /    32 raw bytes @ #A931 (rom #26931, offset +#0931) [SPRITES/SPRITE_PATTERNS] flags=1
; - ANEC_LEFT_10_F1_LAYER1              32 stored /    32 raw bytes @ #A94E (rom #2694E, offset +#094E) [SPRITES/SPRITE_PATTERNS] flags=0
; - ANEC_LEFT_10_F1_LAYER2              29 stored /    32 raw bytes @ #A96E (rom #2696E, offset +#096E) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_LEFT_11_F0_LAYER0         28 stored /    32 raw bytes @ #A98B (rom #2698B, offset +#098B) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_LEFT_11_F0_LAYER1         25 stored /    32 raw bytes @ #A9A7 (rom #269A7, offset +#09A7) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_LEFT_11_F1_LAYER0         30 stored /    32 raw bytes @ #A9C0 (rom #269C0, offset +#09C0) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_WALK_LEFT_11_F1_LAYER1         30 stored /    32 raw bytes @ #A9DE (rom #269DE, offset +#09DE) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_JUMP_LEFT_12_F0_LAYER0         27 stored /    32 raw bytes @ #A9FC (rom #269FC, offset +#09FC) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_JUMP_LEFT_12_F0_LAYER1         24 stored /    32 raw bytes @ #AA17 (rom #26A17, offset +#0A17) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_LEFT_13_F0_LAYER0         29 stored /    32 raw bytes @ #AA2F (rom #26A2F, offset +#0A2F) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_LEFT_13_F0_LAYER1         24 stored /    32 raw bytes @ #AA4C (rom #26A4C, offset +#0A4C) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_LEFT_13_F1_LAYER0         28 stored /    32 raw bytes @ #AA64 (rom #26A64, offset +#0A64) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_LEFT_13_F1_LAYER1         28 stored /    32 raw bytes @ #AA80 (rom #26A80, offset +#0A80) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_LEFT_13_F2_LAYER0         29 stored /    32 raw bytes @ #AA9C (rom #26A9C, offset +#0A9C) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_LAND_LEFT_13_F2_LAYER1         27 stored /    32 raw bytes @ #AAB9 (rom #26AB9, offset +#0AB9) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_DEAD_LEFT_14_F0_LAYER0         32 stored /    32 raw bytes @ #AAD4 (rom #26AD4, offset +#0AD4) [SPRITES/SPRITE_PATTERNS] flags=0
; - NINA_DEAD_LEFT_14_F0_LAYER2         32 stored /    32 raw bytes @ #AAF4 (rom #26AF4, offset +#0AF4) [SPRITES/SPRITE_PATTERNS] flags=0
; - NINA_DEAD_LEFT_14_F1_LAYER0         25 stored /    32 raw bytes @ #AB14 (rom #26B14, offset +#0B14) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_DEAD_LEFT_14_F1_LAYER2         32 stored /    32 raw bytes @ #AB2D (rom #26B2D, offset +#0B2D) [SPRITES/SPRITE_PATTERNS] flags=0
; - NINA_IDLE_LEFT_15_F0_LAYER0         30 stored /    32 raw bytes @ #AB4D (rom #26B4D, offset +#0B4D) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_IDLE_LEFT_15_F0_LAYER1         24 stored /    32 raw bytes @ #AB6B (rom #26B6B, offset +#0B6B) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_IDLE_LEFT_15_F1_LAYER0         30 stored /    32 raw bytes @ #AB83 (rom #26B83, offset +#0B83) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_IDLE_LEFT_15_F1_LAYER1         24 stored /    32 raw bytes @ #ABA1 (rom #26BA1, offset +#0BA1) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_FALL_LEFT_16_F0_LAYER0         29 stored /    32 raw bytes @ #ABB9 (rom #26BB9, offset +#0BB9) [SPRITES/SPRITE_PATTERNS] flags=1
; - NINA_FALL_LEFT_16_F0_LAYER1         24 stored /    32 raw bytes @ #ABD6 (rom #26BD6, offset +#0BD6) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_LEFT_17_F0_LAYER2       20 stored /    32 raw bytes @ #ABEE (rom #26BEE, offset +#0BEE) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_LEFT_17_F0_LAYER3       29 stored /    32 raw bytes @ #AC02 (rom #26C02, offset +#0C02) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_LEFT_17_F1_LAYER2       20 stored /    32 raw bytes @ #AC1F (rom #26C1F, offset +#0C1F) [SPRITES/SPRITE_PATTERNS] flags=1
; - CAPCUADRAT1_LEFT_17_F1_LAYER3       26 stored /    32 raw bytes @ #AC33 (rom #26C33, offset +#0C33) [SPRITES/SPRITE_PATTERNS] flags=1
; - SPRITE_PLACEHOLDER_PATTERN           5 stored /    32 raw bytes @ #AC4D (rom #26C4D, offset +#0C4D) [SPRITES/SPRITE_PATTERNS] flags=1
; FREE 5038
;
...
; - gameflow: 19398 estimated bytes
; - hud: 3640 estimated bytes
; - menus: 444 estimated bytes
; - patterns_code: 894 estimated bytes
; - screens_code: 14752 estimated bytes
; - sound: 7124 estimated bytes
; - sprites: 8115 estimated bytes
...
;       "orgAddress": 40960,
;       "endAddress": 49152,
;       "estimatedUsedBytes": 19398,
;       "estimatedFreeBytes": 0,
;       "estimatedOverBudget": true,
;       "modules": [
;         {
;           "key": "gameflow",
;           "estimatedBytes": 19398
;         }
;       ]
;     },
;     {
...
;       "orgAddress": 24576,
;       "endAddress": 32768,
;       "estimatedUsedBytes": 14752,
;       "estimatedFreeBytes": 0,
;       "estimatedOverBudget": true,
;       "modules": [
;         {
;           "key": "screens_code",
;           "estimatedBytes": 14752
;         }
;       ]
;     },
;     {
...
;       "orgAddress": 24576,
;       "endAddress": 32768,
;       "estimatedUsedBytes": 8115,
;       "estimatedFreeBytes": 77,
...
;       "orgAddress": 24576,
;       "endAddress": 32768,
;       "estimatedUsedBytes": 7124,
;       "estimatedFreeBytes": 1068,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "sound",
...
;       "orgAddress": 24576,
;       "endAddress": 32768,
;       "estimatedUsedBytes": 4765,
;       "estimatedFreeBytes": 3427,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "worlds",
...
;       "orgAddress": 24576,
;       "endAddress": 32768,
;       "estimatedUsedBytes": 4223,
;       "estimatedFreeBytes": 3969,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "animtiles",
...
;       "orgAddress": 24576,
;       "endAddress": 32768,
;       "estimatedUsedBytes": 3640,
;       "estimatedFreeBytes": 4552,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "hud",
...
; Flow: Start → Music (gfn_1772744358305)
; ==================================================================
...
; ==================================================================
PT3_SETUP       EQU #E687   ; PT3 state flags (bit0=loop, bit7=song_ended)
PT3_MODADDR     EQU #E688   ; Module address pointer (2 bytes)
PT3_CrPsPtr     EQU #E68A   ; Current position pointer
PT3_SAMPTRS     EQU #E68C   ; Sample pointers base
PT3_OrnPtrs     EQU #E68E   ; Ornament pointers base
PT3_PDSP        EQU #E690   ; Pattern data start pointer
PT3_CSP         EQU #E692   ; Saved SP (CHREGS SP trick)
PT3_PSP         EQU #E694   ; PT3 stack pointer save
PT3_PrNote      EQU #E696   ; Previous note
PT3_PrSlide     EQU #E697   ; Previous slide (2 bytes)
PT3_AdInPtA     EQU #E699   ; Channel A inline pointer
PT3_AdInPtB     EQU #E69B   ; Channel B inline pointer
PT3_AdInPtC     EQU #E69D   ; Channel C inline pointer
PT3_LPosPtr     EQU #E69F   ; Loop position pointer
PT3_PatsPtr     EQU #E6A1   ; Patterns table pointer
PT3_Delay       EQU #E6A3   ; Song speed/delay
PT3_AddToEn     EQU #E6A4   ; Add to envelope
PT3_Env_Del     EQU #E6A5   ; Envelope delay
PT3_ESldAdd     EQU #E6A6   ; Envelope slide add (2 bytes)
PT3_NTL3        EQU #E6A8   ; Note table link 3
VARS            EQU #E6AA   ; Channel vars base
ChanA           EQU #E6AA   ; Channel A data (29 bytes)
ChanB           EQU #E6C7   ; Channel B data (29 bytes)
ChanC           EQU #E6E4   ; Channel C data (29 bytes)
DelyCnt         EQU #E701   ; Delay counter
CurESld         EQU #E702   ; Current envelope slide (2 bytes)
CurEDel         EQU #E704   ; Current envelope delay
Ns_Base_AddToNs EQU #E705   ; Noise base + add to noise (combined)
Ns_Base         EQU #E705   ; Noise base
AddToNs         EQU #E706   ; Add to noise
NT_             EQU #E707   ; Note table (192 bytes)
AYREGS          EQU #E7C7  ; AY registers mirror (14 bytes)
VT_             EQU #E7C7  ; Volume table base (alias for AYREGS)
EnvBase         EQU #E7D5  ; Envelope base
VAR0END         EQU #E7D7  ; End of fixed workspace
T1_             EQU #E7D7  ; Tone tables start (unpacked by PT3_INIT)
T_NEW_1         EQU #E7D7  ; Tone table new 1
T_OLD_1         EQU #E7D7  ; Tone table old 1
T_OLD_2         EQU #E7EF  ; Tone table old 2
T_NEW_3         EQU #E807  ; Tone table new 3
T_OLD_3         EQU #E807  ; Tone table old 3
T_OLD_0         EQU #E809  ; Tone table old 0
T_NEW_0         EQU #E809  ; Tone table new 0
T_NEW_2         EQU #E821  ; Tone table new 2 (last, ends at +0x1B2)
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E8C7   ; End of project variables (10439 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E8C7: Project variables (10439 bytes)
;   #E8C7-#E900: Alignment padding/free RAM (57 bytes)
...
init_default_tasks_from_plan:
    ld a, 0
    ld hl, call_music_update_resident
    call enable_task
    ld a, 1
...
gameflow_handle_music:
    ...
    push bc
    call call_music_execute_command_resident
    pop bc
    call gameflow_get_default_connection
    ld a, h
    or l
...
gameflow_node_gf_start_1770754183471_conn:
    ...
    dw gameflow_node_gfn_1772744358305
    db CONNECTION_END
...
; Node: Music - "gfn_1772744358305"
gameflow_node_gfn_1772744358305:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gfn_1772744358305_data
    dw gameflow_node_gfn_1772744358305_conn

gameflow_node_gfn_1772744358305_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gfn_1772744358305_conn:
    db CONNECTION_DEFAULT
...
.load_pan4_772291683578_zones_done:
    ...
    ld a, RESOURCE_ID_SCREEN_PAN4_4_BOSS_TABLE
    ld de, current_screen_boss_entry
    call resource_load_to_ram_by_id
    jr nc, .load_pan4_772291683578_boss_done_loaded
    xor a
    ld (current_screen_boss_count), a
    jp load_pan4_772291683578_boss_done
.load_pan4_772291683578_boss_done_loaded:
    ld hl, current_screen_boss_entry
    ld (current_screen_boss_table), hl
    ld a, #FF
    ld (current_screen_boss_table_bank), a
...
; --- PT3 Track 0: ending ---
pt3_track_0_data:
    DB #02,#07,#14,#02,#DE,#00,#00,#00,#00,#00,#E2,#04,#FC,#04,#16,#05
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#1C,#05,#1F,#05,#2A,#05,#32,#05,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#03,#03,#06,#06,#00,#00,#00,#00,#09,#09
    DB #0C,#0C,#0F,#0F,#09,#09,#0C,#0C,#0F,#0F,#FF,#02,#01,#C2,#02,#53
    DB #03,#02,#01,#91,#01,#91,#01,#95,#01,#27,#02,#65,#02,#02,#01,#C2
    DB #02,#57,#03,#02,#01,#C2,#02,#AB,#03,#D8,#03,#46,#04,#D7,#04,#1C
    DB #00,#2A,#08,#40,#CF,#B1,#02,#54,#B9,#00,#2A,#60,#B9,#00,#2A,#B1
    DB #01,#54,#B1,#02,#60,#B1,#01,#54,#B1,#02,#60,#B1,#01,#54,#B1,#02
    DB #60,#B1,#01,#54,#B1,#02,#60,#B9,#00,#2F,#52,#5E,#B1,#01,#52,#B1
    DB #02,#5E,#B1,#01,#52,#B1,#02,#5E,#B1,#01,#52,#B1,#02,#5E,#B1,#01
    DB #52,#B1,#02,#5E,#BD,#00,#3E,#59,#B9,#00,#3E,#65,#BD,#00,#3E,#B1
    DB #01,#59,#B9,#00,#3E,#B1,#02,#65,#B9,#00,#3E,#B1,#01,#59,#BD,#00
    DB #3E,#B1,#02,#65,#B1,#01,#59,#B1,#02,#65,#B1,#01,#59,#B1,#02,#65
    DB #59,#B9,#00,#3E,#65,#B1,#01,#59,#B1,#02,#65,#B1,#01,#59,#B1,#02
    DB #65,#B1,#01,#59,#B1,#02,#65,#B1,#01,#59,#B1,#02,#65,#00,#B1,#40
    DB #D0,#00,#1C,#00,#2A,#08,#40,#CF,#B1,#02,#54,#B9,#00,#2A,#60,#B9
    DB #00,#2A,#B1,#01,#54,#B1,#02,#60,#B1,#01,#54,#B1,#02,#60,#B1,#01
    DB #54,#B1,#02,#60,#B1,#01,#54,#B1,#02,#60,#B9,#00,#2F,#52,#5E,#B1
    DB #01,#52,#B1,#02,#5E,#B1,#01,#52,#B1,#02,#5E,#B1,#01,#52,#B1,#02
    DB #5E,#B1,#01,#52,#B1,#02,#5E,#BD,#00,#3E,#59,#B9,#00,#3E,#65,#BD
    DB #00,#3E,#B1,#01,#59,#B9,#00,#3E,#B1,#02,#65,#B9,#00,#3E,#B1,#01
    DB #59,#BD,#00,#3E,#B1,#02,#65,#B1,#01,#59,#B1,#02,#65,#B1,#01,#59
    DB #B1,#02,#65,#BD,#00,#46,#57,#BD,#00,#46,#63,#B1,#01,#57,#B1,#02
    DB #63,#B1,#01,#57,#B1,#02,#63,#B1,#01,#57,#B1,#02,#63,#B1,#01,#57
    DB #B1,#02,#63,#00,#B1,#02,#C0,#F1,#04,#CA,#B1,#01,#8E,#C4,#D0,#8E
    DB #CA,#B1,#02,#8B,#B1,#01,#C0,#C4,#B1,#03,#8E,#C2,#8B,#43,#C8,#B1
    DB #01,#82,#84,#89,#8B,#B1,#04,#93,#B1,#02,#95,#B1,#04,#92,#B1,#02
    DB #90,#B1,#01,#8E,#8B,#D4,#C7,#B1,#04,#6C,#73,#71,#73,#76,#78,#7A
    DB #7B,#00,#F1,#04,#CF,#B1,#01,#8E,#CA,#D0,#8E,#CF,#B1,#02,#8B,#B1
    DB #01,#C0,#C7,#B1,#03,#8E,#C8,#8B,#43,#CE,#B1,#01,#82,#84,#89,#8B
    DB #B1,#04,#93,#B1,#02,#95,#B1,#04,#92,#B1,#02,#90,#B1,#01,#8E,#8B
    DB #89,#41,#CF,#90,#CA,#D0,#C8,#D0,#C6,#D0,#C4,#D0,#C2,#D0,#C1,#B1
    DB #03,#C0,#40,#CE,#B1,#02,#76,#78,#7D,#7F,#41,#87,#CA,#D0,#CE,#89
    DB #CA,#D0,#CE,#B1,#03,#8B,#CA,#B1,#01,#D0,#CE,#B1,#04,#8E,#00,#F0
    DB #06,#CF,#B1,#01,#68,#D2,#54,#B1,#02,#60,#D3,#B1,#01,#68,#D2,#B1
    DB #02,#60,#B1,#01,#54,#D3,#B1,#02,#68,#D2,#B1,#01,#54,#54,#D3,#B1
    DB #02,#68,#D2,#B1,#01,#54,#60,#D3,#68,#D2,#52,#B1,#02,#5E,#D3,#B1
    DB #01,#68,#D2,#B1,#02,#5E,#B1,#01,#52,#D3,#B1,#02,#68,#D2,#B1,#01
    DB #52,#5E,#D3,#68,#D2,#52,#B1,#02,#5E,#D3,#B1,#01,#68,#D2,#59,#B1
    DB #02,#65,#D3,#B1,#01,#68,#D2,#B1,#02,#65,#B1,#01,#65,#D3,#B1,#02
    DB #68,#D2,#B1,#01,#65,#65,#D3,#B1,#02,#68,#D2,#65,#D3,#B1,#01,#68
    DB #D2,#59,#B1,#02,#65,#D3,#B1,#01,#68,#D2,#B1,#02,#65,#B1,#01,#65
    DB #D3,#B1,#02,#68,#D2,#65,#D3,#B1,#01,#68,#D2,#59,#B1,#02,#65,#00
    DB #B1,#40,#C0,#00,#F1,#04,#CF,#B1,#01,#84,#78,#8B,#78,#89,#84,#87
    DB #8B,#CA,#84,#78,#8B,#78,#89,#84,#87,#8B,#CF,#87,#89,#8B,#84,#78
    DB #82,#7D,#78,#CA,#87,#89,#8B,#84,#78,#82,#7D,#78,#CF,#87,#7D,#86
    DB #7D,#82,#7D,#84,#82,#CA,#87,#7D,#86,#7D,#82,#7D,#84,#82,#CF,#95
    DB #C0,#CA,#95,#CF,#97,#C0,#CA,#95,#CF,#9C,#C0,#CB,#A1,#C0,#C8,#A1
    DB #C0,#C5,#A1,#C0,#C4,#A1,#C0,#00,#F2,#08,#C8,#B1,#03,#7F,#78,#7F
    DB #78,#B1,#02,#7F,#78,#B1,#03,#86,#82,#86,#82,#B1,#02,#7D,#82,#B1
    DB #03,#80,#7F,#78,#80,#B1,#02,#7F,#78,#B1,#03,#80,#7D,#B1,#02,#78
    DB #B1,#04,#7D,#82,#00,#F1,#04,#CF,#B1,#01,#78,#B1,#02,#78,#B1,#01
    DB #78,#C0,#43,#B1,#02,#7D,#B1,#01,#7F,#82,#CA,#84,#CF,#7F,#C0,#82
    DB #CA,#84,#CE,#7D,#CF,#7F,#41,#78,#B1,#02,#78,#78,#43,#7D,#B1,#01
    DB #7F,#87,#CA,#89,#CF,#84,#C0,#87,#CA,#89,#CE,#82,#CF,#7F,#80,#C0
    DB #7F,#CA,#80,#CF,#7D,#CA,#7F,#CF,#78,#B1,#03,#7F,#41,#B1,#01,#89
    DB #43,#B1,#03,#7D,#B1,#02,#59,#B1,#01,#80,#C0,#7F,#CA,#80,#CF,#7D
    DB #CA,#7F,#CF,#79,#B1,#03,#7F,#41,#B1,#01,#79,#43,#B1,#03,#7D,#B1
    DB #02,#84,#00,#F0,#06,#CF,#B1,#01,#68,#D2,#54,#B1,#02,#60,#D3,#B1
    DB #01,#68,#D2,#B1,#02,#60,#B1,#01,#54,#D3,#B1,#02,#68,#D2,#B1,#01
    DB #54,#54,#D3,#B1,#02,#68,#D2,#B1,#01,#54,#60,#D3,#68,#D2,#52,#B1
    DB #02,#5E,#D3,#B1,#01,#68,#D2,#B1,#02,#5E,#B1,#01,#52,#D3,#B1,#02
    DB #68,#D2,#B1,#01,#52,#5E,#D3,#68,#D2,#52,#B1,#02,#5E,#D3,#B1,#01
    DB #68,#D2,#59,#B1,#02,#65,#D3,#B1,#01,#68,#D2,#B1,#02,#65,#B1,#01
    DB #65,#D3,#B1,#02,#68,#D2,#B1,#01,#65,#65,#D3,#B1,#02,#68,#D2,#65
    DB #D3,#B1,#01,#68,#D2,#55,#B1,#02,#61,#D3,#B1,#01,#68,#D2,#B1,#02
    DB #61,#B1,#01,#55,#D3,#B1,#02,#68,#D2,#55,#D3,#B1,#01,#68,#D2,#61
    DB #B1,#02,#55,#00,#F2,#08,#C9,#B1,#10,#6C,#6A,#B1,#20,#74,#00,#05
    DB #06,#01,#8F,#00,#00,#01,#8D,#00,#00,#01,#8B,#00,#00,#01,#8B,#00
    DB #00,#01,#8B,#00,#00,#01,#86,#00,#00,#05,#06,#01,#0F,#11,#00,#01
    DB #8F,#99,#00,#01,#8E,#44,#01,#01,#8E,#44,#04,#01,#8C,#55,#05,#01
    DB #80,#77,#07,#00,#01,#00,#8F,#00,#00,#00,#01,#00,#00,#09,#0C,#18
    DB #00,#00,#00,#00,#00,#00,#00,#00,#06,#0C,#07,#0C,#13,#0C,#00,#00
    DB #01,#00
...
; Zones used: 1
; ------------------------------------------------------------------
; ZONE 00 [#26000-#28000] bank 17 used=3154 slack=5038
...
;   + SPRITE_PLACEHOLDER_PATTERN @ +#0C4D size=5
    ...
    org #26000
; ==================================================================
; DATA ZONE 00 (bank 17) used=3154 slack=5038
; ==================================================================
; ==================================================================
