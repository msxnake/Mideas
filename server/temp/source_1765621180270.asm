...
entity_screen_id    EQU #C0A8   ; Entity screen ID (32 bytes)
entity_dir_mask     EQU #C0C8   ; Entity direction mask (32 bytes)
entity_health       EQU #C0E8   ; Entity health (32 bytes)
entity_anim_frame   EQU #C108   ; Entity animation frame (32 bytes)
entity_sm_ptr_l     EQU #C128   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C148   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C168   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C188   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C1A8   ; Entity State Wait Timer (32 bytes)
entity_sm_var_0     EQU #C1C8   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C1E8   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C208   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C228   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C248   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #C268   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #C288   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #C2A8   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
active_sprite_count EQU #C2C8   ; Number of sprites currently active
sprite_pattern      EQU #C2C9   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #C2E9   ; Sprite colors (32 bytes)
sprite_attributes   EQU #C309   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #C389   ; Currently displayed screen ID
screen_dirty_flag   EQU #C38A   ; Screen needs redraw flag
current_world_id    EQU #C38B   ; Current world ID (for multi-world support)
current_screen_index EQU #C38C   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #C38D   ; Player X position (16-bit)
player_y            EQU #C38F   ; Player Y position (16-bit)
player_health       EQU #C391   ; Player health points
player_score        EQU #C392   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #C394   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #C395   ; Temporary 16-bit storage
temp_word_2         EQU #C397   ; Temporary 16-bit storage
temp_byte_1         EQU #C399   ; Temporary 8-bit storage
temp_byte_2         EQU #C39A   ; Temporary 8-bit storage
temp_byte_3         EQU #C39B   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #C3BB   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #C3DB   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #C3FB   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #C41B   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C43B   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C47B   ; Temporary 16-bit storage (64 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C4BB   ; End of project variables (1211 bytes used)

; ==================================================================
; MEMORY SAFETY CHECK
; ==================================================================
; RAM Layout:
;   #C000-#C4BB: Project variables (1211 bytes)
;   #C4BB-#F37F: Free RAM (~11973 bytes available)
