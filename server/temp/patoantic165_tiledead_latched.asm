...
; BANK 11 @#0000 : statemachine.asm part 3/2 (470 bytes)
; BANK 11 @#01D6 : gameflow.asm (5516 bytes)
...
tileDead EQU temp_byte_26 ; Debug byte: mirrors hero deadly contact (entity 0)
tileDeadLatched EQU temp_byte_26 + 1 ; Debug byte: latched hero deadly detection
tileDeadX EQU temp_byte_26 + 2 ; Debug byte: last sampled tile X
tileDeadY EQU temp_byte_26 + 3 ; Debug byte: last sampled tile Y
tileDeadValue EQU temp_byte_26 + 4 ; Debug byte: raw behavior byte read
