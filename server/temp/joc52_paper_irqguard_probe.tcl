set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc52_paper_irqguard_probe.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc52_paper_irqguard_shots"
...
proc state {tag} {
    ...
    set flow [mem8 0xC104]; set screen [mem8 0xDFA4]; set irq [mem16 0xE606]; set inirq [mem8 0xE60B]
    set px [mem16 0xD95B]; set py [mem16 0xD97B]
...
after time 10.0 { shot "joc52_irqguard_t10.png" "t10" }
after time 12.0 { hold_right "right" 1.0 }
after time 14.0 { shot "joc52_irqguard_t14.png" "t14" }
after time 20.0 { shot "joc52_irqguard_t20.png" "t20"; close $f; exit }
