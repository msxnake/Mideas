set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc60_matrix_simple32k_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc60_matrix_simple32k_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set flow [mem8 0xC104]; set screen [mem8 0xDEE1]; set irq [mem16 0xE543]; set inirq [mem8 0xE548]
    set px [mem16 0xDEEB]; set py [mem16 0xDEED]
...
after time 10.0 { shot "joc60_matrix_simple32k_t10.png" "t10" }
after time 12.0 { hold_right "right" 1.0 }
after time 14.0 { shot "joc60_matrix_simple32k_t14.png" "t14" }
after time 20.0 { shot "joc60_matrix_simple32k_t20.png" "t20"; close $f; exit }
