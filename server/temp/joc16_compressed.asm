...
; BANK 02 @#0000 : sprites.asm (908 bytes)
; BANK 02 @#038C : font.asm (3456 bytes)
; BANK 02 @#110C : hud.asm (3480 bytes)
; BANK 02 @#1EA4 : menus.asm (168 bytes)
; BANK 02 @#1F4C : sound.asm part 1/2 (180 bytes)
; BANK 03 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 04 @#0000 : sound.asm part 3/2 (1176 bytes)
; BANK 04 @#0498 : scroll.asm (2353 bytes)
; BANK 04 @#0DC9 : animtiles.asm (4613 bytes)
; BANK 04 @#1FCE : statemachine.asm (50 bytes)
; BANK 05 @#0000 : statemachine.asm (7138 bytes)
; BANK 05 @#1BE2 : gameflow.asm (1054 bytes)
; BANK 06 @#0000 : gameflow.asm (4967 bytes)
...
sprite_asset_base_pattern_slot_runtime EQU #D87B   ; Runtime base 16x16 slot per sprite asset (2 bytes)
sprite_placeholder_base_pattern_num EQU #D87D   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #D87E   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #D87F   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #D8FF   ; Currently displayed screen ID
screen_dirty_flag   EQU #D900   ; Screen needs redraw flag
screen_transition_cooldown EQU #D901   ; Cooldown frames after screen transition
current_world_id    EQU #D902   ; Current world ID (for multi-world support)
current_screen_index EQU #D903   ; Current screen index within world
current_screen_anim_group_count EQU #D904   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #D905   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #D906   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #D907   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #D908   ; Player X position (16-bit)
player_y            EQU #D90A   ; Player Y position (16-bit)
player_runtime_enabled EQU #D90C   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #D90D   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #D90E   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #D90F   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #D910   ; Player health points
player_score        EQU #D911   ; Player score (16-bit)
gem_count           EQU #D913   ; Collectible tile counter (8-bit)
last_gem_char       EQU #D914   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #D915   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #D916   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #D956   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #D996   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #D9D6   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #DA16   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #DA26   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #DA36   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #DA46   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #DA56   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #DA66   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #DA76   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #DA77   ; Temporary 16-bit storage
temp_word_2         EQU #DA79   ; Temporary 16-bit storage
temp_byte_1         EQU #DA7B   ; Temporary 8-bit storage
temp_byte_2         EQU #DA7C   ; Temporary 8-bit storage
temp_byte_3         EQU #DA7D   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #DA9D   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #DABD   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #DADD   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #DAFD   ; 0=no SFX active, 1=playing
sfx_timer           EQU #DAFE   ; Frames remaining for current SFX
sfx_fadeout         EQU #DAFF   ; Reserved fadeout flag/state
temp_byte_7         EQU #DB00   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #DB20   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #DB40   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #DB60   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #DB80   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #DBA0   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #DBC0   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #DBE0   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #DC00   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #DC20   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #DC40   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #DC60   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #DC80   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #DCA0   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #DCC0   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #DCE0   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #DD00   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #DD20   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #DD40   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #DD60   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #DDA0   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #DDE0   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #DE00   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #DE20   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #DE40   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #DE41   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #DE42   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #DE43   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #DE44   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #DE45   ; Cached entity X for wall checks
wall_temp_y         EQU #DE46   ; Cached entity Y for wall checks
wall_hit_left       EQU #DE47   ; Hitbox left edge cache
wall_hit_top        EQU #DE48   ; Hitbox top edge cache
wall_hit_right      EQU #DE49   ; Hitbox right edge cache
wall_hit_bottom     EQU #DE4A   ; Hitbox bottom edge cache
wall_hit_w          EQU #DE4B   ; Hitbox width cache (min 1)
wall_hit_h          EQU #DE4C   ; Hitbox height cache (min 1)
wall_probe_left     EQU #DE4D   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #DE4E   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #DE4F   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #DE50   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #DE51   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #DE71   ; Number of entries in active_entity_list
hero_entity_id      EQU #DE72   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #DE73   ; 1=rebuild active_entity_list required
input_entity_list   EQU #DE74   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #DE94   ; Number of entries in input_entity_list
render_entity_list  EQU #DE95   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #DEB5   ; Number of entries in render_entity_list
collision_entity_list EQU #DEB6   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #DED6   ; Number of entries in collision_entity_list
ground_entity_list  EQU #DED7   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #DEF7   ; Number of entries in ground_entity_list
anim_entity_list    EQU #DEF8   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #DF18   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #DF19   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #DF39   ; Number of entities in coll_list
coll_src_left       EQU #DF3A   ; Source AABB left edge (scratch)
coll_src_right      EQU #DF3B   ; Source AABB right edge (scratch)
coll_src_top        EQU #DF3C   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #DF3D   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #DF3E   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #DF3E   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #DF40   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #DF42   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #DF44   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #DF46   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #DF48   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #DF4A   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #DF4C   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #DF4E   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #DF4F   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #DF54   ; Frame counter (16-bit)
task_exec_time          EQU #DF56   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #DF58   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #DF59   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #DF59   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #DF5A   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #DF5B   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #DF5C   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #DF5D   ; 0=stopped, 1=track active
music_muted          EQU #DF5E   ; 0=audible, 1=muted/pause
music_loop           EQU #DF5F   ; 0=no loop, 1=loop enabled
music_track_index    EQU #DF60   ; Current ROM track index
music_row_frames     EQU #DF61   ; Frames per tracker row
music_row_countdown  EQU #DF62   ; Countdown to next row
music_order_pos      EQU #DF63   ; Current order position
music_pattern_index  EQU #DF64   ; Current pattern index
music_pattern_row    EQU #DF65   ; Current row inside pattern
music_pattern_rows   EQU #DF66   ; Cached rows in current pattern
music_track_ptr_l    EQU #DF67   ; Current track pointer low byte
music_track_ptr_h    EQU #DF68   ; Current track pointer high byte
music_pattern_ptr_l  EQU #DF69   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #DF6A   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #DF6B   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #DF6C   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #DF6C   ; Channel A
music_ch_b_note EQU #DF6D   ; Channel B
music_ch_c_note EQU #DF6E   ; Channel C
music_ch_instrument_base EQU #DF6F   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #DF6F   ; Channel A
music_ch_b_instrument EQU #DF70   ; Channel B
music_ch_c_instrument EQU #DF71   ; Channel C
music_ch_ornament_base EQU #DF72   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #DF72   ; Channel A
music_ch_b_ornament EQU #DF73   ; Channel B
music_ch_c_ornament EQU #DF74   ; Channel C
music_ch_volume_base EQU #DF75   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #DF75   ; Channel A
music_ch_b_volume EQU #DF76   ; Channel B
music_ch_c_volume EQU #DF77   ; Channel C
music_ch_vol_step_base EQU #DF78   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #DF78   ; Channel A
music_ch_b_vol_step EQU #DF79   ; Channel B
music_ch_c_vol_step EQU #DF7A   ; Channel C
music_ch_tone_step_base EQU #DF7B   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #DF7B   ; Channel A
music_ch_b_tone_step EQU #DF7C   ; Channel B
music_ch_c_tone_step EQU #DF7D   ; Channel C
music_ch_noise_step_base EQU #DF7E   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #DF7E   ; Channel A
music_ch_b_noise_step EQU #DF7F   ; Channel B
music_ch_c_noise_step EQU #DF80   ; Channel C
music_ch_orn_step_base EQU #DF81   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #DF81   ; Channel A
music_ch_b_orn_step EQU #DF82   ; Channel B
music_ch_c_orn_step EQU #DF83   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #DF84   ; End of project variables (8068 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#DF84: Project variables (8068 bytes)
;   #DF84-#F37F: Free RAM (~5116 bytes available)
...
SPRITE_HERO_RIGHT_1_WIDTH     EQU 16
SPRITE_HERO_RIGHT_1_HEIGHT    EQU 16
SPRITE_HERO_RIGHT_1_FRAMES    EQU 2

;; ---- Sprite Frame: hero_right_1_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_1_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_RIGHT_1_F1_DATA (32 bytes)
...
SPRITE_1_PATTERN EQU HERO_RIGHT_1_F0_LAYER1
...
sprite_asset_frame_count:
    ...
    db 2 ; Sprite 1: hero_right
SPRITE_ASSET_COUNT EQU 2
...
; Sprite 1: hero_right frame pointers
SPRITE_1_FRAME_PTRS:
    dw HERO_RIGHT_1_F0_LAYER1
    dw HERO_RIGHT_1_F1_LAYER1
...
SM_SpriteLayerColorTable:
    db 15 ; Sprite 0: hero_left
    db 15 ; Sprite 1: hero_right
...
load_sprite_patterns_worldmap_1776512078647:
    ...
    ld a, 16
    ld (sprite_placeholder_base_pattern_num), a
    ; Sprite Asset 0: hero_left frame 0 (1 layers)
    ld hl, HERO_LEFT_0_F0_LAYER1
    ld de, SPRPAT + (0 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 0: hero_left frame 1 (1 layers)
    ld hl, HERO_LEFT_0_F1_LAYER1
    ld de, SPRPAT + (1 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 1: hero_right frame 0 (1 layers)
    ld hl, HERO_RIGHT_1_F0_LAYER1
    ld de, SPRPAT + (2 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 1: hero_right frame 1 (1 layers)
    ld hl, HERO_RIGHT_1_F1_LAYER1
    ld de, SPRPAT + (3 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
...
SCREEN_PAN1_0_SPRITE_PATTERN_SLOTS EQU 5
...
ZX0_SPRITE_FRAME_HERO_LEFT_0_F1_DATA:
    ; ZX0 compressed sprite frame HERO_LEFT_0_F1 (32 -> 31 bytes)
    DB #A0,#00,#22,#03,#04,#03,#05,#03,#21,#1B,#03,#66,#43,#78,#00,#02
    DB #80,#40,#A0,#D8,#80,#04,#B8,#80,#67,#7C,#04,#00,#55,#55,#80
ZX0_SPRITE_FRAME_HERO_RIGHT_1_F0_DATA:
    ; ZX0 compressed sprite frame HERO_RIGHT_1_F0 (32 -> 31 bytes)
    DB #4E,#00,#01,#02,#05,#0B,#09,#F5,#0B,#05,#09,#11,#01,#E2,#FF,#FD
    DB #C0,#20,#AA,#A0,#80,#9F,#D0,#CC,#C0,#F5,#B5,#FF,#C0,#55,#58
ZX0_SPRITE_FRAME_HERO_RIGHT_1_F1_DATA:
    ; ZX0 compressed sprite frame HERO_RIGHT_1_F1 (32 -> 31 bytes)
...
; Frame group: HERO_RIGHT_1_F0
HERO_RIGHT_1_F0_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_RIGHT_1_F0_DATA
; Frame group: HERO_RIGHT_1_F1
HERO_RIGHT_1_F1_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_RIGHT_1_F1_DATA
