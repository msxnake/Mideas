...
SPRITE_LLAVE_1_WIDTH     EQU 16
SPRITE_LLAVE_1_HEIGHT    EQU 16
SPRITE_LLAVE_1_FRAMES    EQU 2

;; ---- Sprite Frame: llave_1_F0 ----
;; Size: 16x16
LLAVE_1_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#20,#00,#20,#00,#00,#00

LLAVE_1_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#1F,#18,#1F,#01,#01,#01,#01,#01,#01,#01,#01,#00,#00,#00
    DB #00,#00,#FC,#0C,#FC,#C0,#C0,#C0,#C0,#C0,#D0,#C0,#D0,#00,#00,#00

LLAVE_1_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: llave_1_F0 ----

;; ---- Sprite Frame: llave_1_F1 ----
;; Size: 16x16
LLAVE_1_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

LLAVE_1_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#0F,#0C,#0F,#01,#01,#01,#01,#01,#01,#01,#01,#00,#00,#00
    DB #00,#00,#FE,#06,#FE,#C0,#C0,#C0,#C0,#C0,#C0,#C0,#C0,#00,#00,#00

LLAVE_1_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: llave_1_F1 ----
...
;   Filtered out: 7 unused templates
;
; ==================================================================
...
ENTITY_PLAYER_1_COMP_MASK EQU #03  ; Component mask: 00000011b
; Template: tpl_player
...
ENTITY_PLAYER_2_COMP_MASK EQU #03  ; Component mask: 00000011b
; Template: tpl_player
ENTITY_PLAYER_2_X EQU 19
...
init_player_2:
    ...
    ; JSON position: (19, 11) tiles = (152, 88) pixels
    ; Template: tpl_player
    ; Components: Position, Sprite
    ; Direction mask: #0F (1111b) = All directions
