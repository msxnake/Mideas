...
; BANK 11 @#0000 : statemachine.asm part 3/3 (2357 bytes)
; BANK 11 @#0935 : gameflow.asm (5835 bytes)
; BANK 12 @#0000 : gameflow.asm (1482 bytes)
...
SM_New_Statemachine_state_1771533530403_Transitions: 
    ...
    DB 14; VARIABLE_COMPARE 
    DB 9, 3, 1; Lives (ID 9) < 1
    DW SM_New_Statemachine_state_1773007838313 
    DW SM_New_Statemachine_state_1771533530403_Transitions_Actions_1 

SM_New_Statemachine_state_1771533530403_Transitions_Actions_0: 
    DB 23; REGENERATE_HUD 
    DB 0xFF; END
SM_New_Statemachine_state_1771533530403_Transitions_Actions_1: 
