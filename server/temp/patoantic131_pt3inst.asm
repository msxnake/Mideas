; ==================================================================
; PATOANTIC131_PT3INST - UNIFIED FILE
...
; Estimated payload bytes: 116253
...
; BANK 06 @#0000 : sound.asm part 2/2 (7450 bytes)
; BANK 06 @#1D1A : scroll.asm (742 bytes)
; BANK 07 @#0000 : scroll.asm (1611 bytes)
; BANK 07 @#064B : animtiles.asm (4817 bytes)
; BANK 07 @#191C : particles.asm (1764 bytes)
; BANK 08 @#0000 : particles.asm (3199 bytes)
; BANK 08 @#0C7F : statemachine.asm part 1/4 (4993 bytes)
...
; BANK 12 @#0000 : statemachine.asm part 5/4 (818 bytes)
; BANK 12 @#0332 : gameflow.asm part 1/3 (7374 bytes)
; BANK 13 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : gameflow.asm part 3/3 (1565 bytes)
...
music_ch_noise_step_base EQU #D12E   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #D12E   ; Channel A
music_ch_b_noise_step EQU #D12F   ; Channel B
music_ch_c_noise_step EQU #D130   ; Channel C
music_ch_orn_step_base EQU #D131   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #D131   ; Channel A
music_ch_b_orn_step EQU #D132   ; Channel B
music_ch_c_orn_step EQU #D133   ; Channel C

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D134   ; End of project variables (4404 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D134: Project variables (4404 bytes)
;   #D134-#F37F: Free RAM (~8780 bytes available)
