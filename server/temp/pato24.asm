...
; ==================================================================
global_var_goal     EQU #C007   ; Goal status (0=Failure, 1=Completed)

; ==================================================================
; SYSTEM VARIABLES
; ==================================================================
ROM_slot            EQU #C008   ; ROM slot number (for SETPAGES32K)
frame_counter       EQU #C009   ; Frame counter (16-bit)

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C00B   ; Pointer to current screen layout data (16-bit)
current_behavior_map    EQU #C00D   ; Pointer to current behavior map data (16-bit)

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #C00F   ; Camera X position in pixels (16-bit)
camera_y            EQU #C011   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #C013   ; Camera tile X (column)
camera_tile_y       EQU #C014   ; Camera tile Y (row)
world_width_tiles   EQU #C015   ; World width in tiles
world_height_tiles  EQU #C016   ; World height in tiles
scroll_dirty_flag   EQU #C017   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #C018   ; 1=HUD needs redraw, 0=clean

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #C019   ; Animation frame timer
anim_tile_frame     EQU #C01A   ; Current animation frame (0-3)
anim_tile_speed     EQU #C01B   ; Frames between animation updates

; ==================================================================
; PARTICLE SYSTEM VARIABLES
; ==================================================================
particle_pool       EQU #C01C   ; Particle pool (8 particles * 8 bytes = 64 bytes)

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #C05C   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_x_pos        EQU #C07C   ; Entity X positions (32 bytes)
entity_y_pos        EQU #C09C   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #C0BC   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #C0DC   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #C0FC   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #C11C   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #C13C   ; Entity screen ID (32 bytes)
entity_dir_mask     EQU #C15C   ; Entity direction mask (32 bytes)
entity_health       EQU #C17C   ; Entity health (32 bytes)
entity_anim_frame   EQU #C19C   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #C1BC   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #C1DC   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #C1FC   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #C21C   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C23C   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C25C   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C27C   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C29C   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #C2BC   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #C2DC   ; Entity carrier ID (32 bytes, 255=not carried)
entity_sm_var_0     EQU #C2FC   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C31C   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C33C   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C35C   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C37C   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #C39C   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #C3BC   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #C3DC   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #C3FC   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #C41C   ; Number of sprites currently active
sprite_pattern      EQU #C41D   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #C43D   ; Sprite colors (32 bytes)
sprite_attributes   EQU #C45D   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (2 screens detected)
; ==================================================================
current_screen_id   EQU #C4DD   ; Currently displayed screen ID
screen_dirty_flag   EQU #C4DE   ; Screen needs redraw flag
screen_transition_cooldown EQU #C4DF   ; Cooldown frames after screen transition
current_world_id    EQU #C4E0   ; Current world ID (for multi-world support)
current_screen_index EQU #C4E1   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #C4E2   ; Player X position (16-bit)
player_y            EQU #C4E4   ; Player Y position (16-bit)
player_health       EQU #C4E6   ; Player health points
player_score        EQU #C4E7   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #C4E9   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #C4EA   ; Temporary 16-bit storage
temp_word_2         EQU #C4EC   ; Temporary 16-bit storage
temp_byte_1         EQU #C4EE   ; Temporary 8-bit storage
temp_byte_2         EQU #C4EF   ; Temporary 8-bit storage
temp_byte_3         EQU #C4F0   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #C510   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #C530   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #C550   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #C570   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #C590   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #C5B0   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #C5D0   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #C5F0   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #C610   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #C630   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #C650   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #C670   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #C690   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #C6B0   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #C6D0   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C6F0   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C730   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #C770   ; Cached entity X for wall checks
wall_temp_y         EQU #C771   ; Cached entity Y for wall checks
wall_entity_idx     EQU #C772   ; Current entity index in wall loop

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #C773   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #C773   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #C775   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #C777   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #C779   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #C77B   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #C77D   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #C77F   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #C781   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #C783   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #C784   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #C789   ; Frame counter (16-bit)
task_exec_time          EQU #C78B   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #C78D   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #C78E   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C78E   ; End of project variables (1934 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#C78E: Project variables (1934 bytes)
;   #C78E-#F37F: Free RAM (~11250 bytes available)
...
PANELL_3_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#07,#07,#02,#06,#07,#07,#03,#02,#03,#03,#03,#03,#00
    DB #00,#00,#00,#E0,#E0,#E0,#E0,#E0,#60,#E0,#E0,#E0,#60,#E0,#E0,#00

PANELL_3_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#0F,#08,#08,#0D,#09,#08,#08,#0C,#05,#04,#04,#04,#04,#07
    DB #00,#00,#F0,#10,#10,#10,#10,#10,#90,#10,#10,#10,#90,#10,#10,#F0
...
gameflow_node_gfn_1770833873618_data:
    ...
    DW text_gfn_1770833873618_title          ; -> "WORLD PONK"
    DB 7, 3              ; Row 7, Col 3
    DW text_gfn_1770833873618_msg0          ; -> "NAMADE GRIDGE , EL COSMOS"
    DB 8, 2              ; Row 8, Col 2
    DW text_gfn_1770833873618_msg1          ; -> "ESTA EN GUERRA, PLANIFICA TU"
    DB 9, 12              ; Row 9, Col 12
    DW text_gfn_1770833873618_msg2          ; -> "ATAQUE."
...
text_gfn_1770833873618_msg0:
    DB "NAMADE GRIDGE , EL COSMOS", 0
text_gfn_1770833873618_msg1:
    DB "ESTA EN GUERRA, PLANIFICA TU", 0
