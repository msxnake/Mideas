...
; BANK 01 @#0000 : entities.asm (704 bytes)
; BANK 01 @#02C0 : worlds.asm (1802 bytes)
; BANK 01 @#09CA : screens.asm part 1/2 (5686 bytes)
; BANK 02 @#0000 : screens.asm part 2/2 (3648 bytes)
; BANK 02 @#0E40 : sprites.asm (4544 bytes)
; BANK 03 @#0000 : sprites.asm (3546 bytes)
; BANK 03 @#0DDA : font.asm (3456 bytes)
; BANK 03 @#1B5A : hud.asm (1190 bytes)
; BANK 04 @#0000 : hud.asm (2757 bytes)
; BANK 04 @#0AC5 : menus.asm (168 bytes)
; BANK 04 @#0B6D : sound.asm part 1/2 (5267 bytes)
; BANK 05 @#0000 : sound.asm part 2/2 (4281 bytes)
; BANK 05 @#10B9 : scroll.asm (2353 bytes)
; BANK 05 @#19EA : animtiles.asm (1558 bytes)
; BANK 06 @#0000 : animtiles.asm (3835 bytes)
; BANK 06 @#0EFB : statemachine.asm part 1/3 (4357 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (6835 bytes)
; BANK 08 @#1AB3 : gameflow.asm (1357 bytes)
; BANK 09 @#0000 : gameflow.asm (5777 bytes)
...
entity_walljump_anim_active EQU #DDFC   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_x_pos        EQU #DE1C   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DE3C   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DE5C   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DE7C   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DE9C   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DEBC   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DEDC   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DEFC   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DF1C   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DF3C   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DF3D   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DF5D   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DF7D   ; Entity health (32 bytes)
entity_anim_frame   EQU #DF9D   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DFBD   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DFDD   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DFFD   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #E01D   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #E03D   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #E05D   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #E07D   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #E09D   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #E0BD   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #E0DD   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_collectible_enabled EQU #E0FD   ; 1 when entity has Collectible component (32 bytes)
entity_carried_by   EQU #E11D   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E13D   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E15D   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E17D   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E19D   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E1BD   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E1DD   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E1FD   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E21D   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E23D   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E25D   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E27D   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E29D   ; Number of sprites currently active
sprites_dirty      EQU #E29E   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E29F   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E2BF   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E2DF   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E2FF   ; Runtime base 16x16 slot per sprite asset (11 bytes)
sprite_placeholder_base_pattern_num EQU #E30A   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E30B   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E30C   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #E38C   ; Currently displayed screen ID
screen_dirty_flag   EQU #E38D   ; Screen needs redraw flag
screen_transition_cooldown EQU #E38E   ; Cooldown frames after screen transition
current_world_id    EQU #E38F   ; Current world ID (for multi-world support)
current_screen_index EQU #E390   ; Current screen index within world
current_screen_anim_group_count EQU #E391   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E392   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E393   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E394   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E395   ; Player X position (16-bit)
player_y            EQU #E397   ; Player Y position (16-bit)
player_runtime_enabled EQU #E399   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E39A   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E39B   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E39C   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E39D   ; Player health points
player_score        EQU #E39E   ; Player score (16-bit)
gem_count           EQU #E3A0   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E3A1   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E3A2   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E3A3   ; Interaction type id of last interacted tile
last_interaction_value EQU #E3A4   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E3A5   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E3A6   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E3A7   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E3A8   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E3A9   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E3AA   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E3EA   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E42A   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E46A   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E4AA   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E4BA   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E4CA   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E4DA   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E4EA   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E4FA   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E50A   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E50B   ; Temporary 16-bit storage
temp_word_2         EQU #E50D   ; Temporary 16-bit storage
temp_byte_1         EQU #E50F   ; Temporary 8-bit storage
temp_byte_2         EQU #E510   ; Temporary 8-bit storage
temp_byte_3         EQU #E511   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E531   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E551   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E571   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E591   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E592   ; Frames remaining for current SFX
sfx_fadeout         EQU #E593   ; Reserved fadeout flag/state
temp_byte_7         EQU #E594   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E5B4   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E5D4   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E5F4   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E614   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E634   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E654   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E674   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E694   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E6B4   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E6D4   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E6F4   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E714   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E734   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E754   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E774   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E794   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E7B4   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E7D4   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E7F4   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E834   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E874   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E894   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E8B4   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E8D4   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E8D5   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E8D6   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E8D7   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E8D8   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E8D9   ; Cached entity X for wall checks
wall_temp_y         EQU #E8DA   ; Cached entity Y for wall checks
wall_hit_left       EQU #E8DB   ; Hitbox left edge cache
wall_hit_top        EQU #E8DC   ; Hitbox top edge cache
wall_hit_right      EQU #E8DD   ; Hitbox right edge cache
wall_hit_bottom     EQU #E8DE   ; Hitbox bottom edge cache
wall_hit_w          EQU #E8DF   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E8E0   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E8E1   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E8E2   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E8E3   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E8E4   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E8E5   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E905   ; Number of entries in active_entity_list
hero_entity_id      EQU #E906   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E907   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E908   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E928   ; Number of entries in input_entity_list
render_entity_list  EQU #E929   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E949   ; Number of entries in render_entity_list
collision_entity_list EQU #E94A   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E96A   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E96B   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E98B   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E98C   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E9AC   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E9AD   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E9CD   ; Number of entities in coll_list
coll_src_left       EQU #E9CE   ; Source AABB left edge (scratch)
coll_src_right      EQU #E9CF   ; Source AABB right edge (scratch)
coll_src_top        EQU #E9D0   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E9D1   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E9D2   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E9D2   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E9D4   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E9D6   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E9D8   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E9DA   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E9DC   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E9DE   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E9E0   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E9E2   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E9E3   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E9E8   ; Frame counter (16-bit)
task_exec_time          EQU #E9EA   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E9EC   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E9ED   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E9ED   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E9EE   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E9EF   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E9F0   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E9F1   ; 0=stopped, 1=track active
music_muted          EQU #E9F2   ; 0=audible, 1=muted/pause
music_loop           EQU #E9F3   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E9F4   ; Current ROM track index
music_row_frames     EQU #E9F5   ; Frames per tracker row
music_row_countdown  EQU #E9F6   ; Countdown to next row
music_order_pos      EQU #E9F7   ; Current order position
music_pattern_index  EQU #E9F8   ; Current pattern index
music_pattern_row    EQU #E9F9   ; Current row inside pattern
music_pattern_rows   EQU #E9FA   ; Cached rows in current pattern
music_track_ptr_l    EQU #E9FB   ; Current track pointer low byte
music_track_ptr_h    EQU #E9FC   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E9FD   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E9FE   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E9FF   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #EA00   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #EA00   ; Channel A
music_ch_b_note EQU #EA01   ; Channel B
music_ch_c_note EQU #EA02   ; Channel C
music_ch_instrument_base EQU #EA03   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #EA03   ; Channel A
music_ch_b_instrument EQU #EA04   ; Channel B
music_ch_c_instrument EQU #EA05   ; Channel C
music_ch_ornament_base EQU #EA06   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #EA06   ; Channel A
music_ch_b_ornament EQU #EA07   ; Channel B
music_ch_c_ornament EQU #EA08   ; Channel C
music_ch_volume_base EQU #EA09   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #EA09   ; Channel A
music_ch_b_volume EQU #EA0A   ; Channel B
music_ch_c_volume EQU #EA0B   ; Channel C
music_ch_vol_step_base EQU #EA0C   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #EA0C   ; Channel A
music_ch_b_vol_step EQU #EA0D   ; Channel B
music_ch_c_vol_step EQU #EA0E   ; Channel C
music_ch_tone_step_base EQU #EA0F   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #EA0F   ; Channel A
music_ch_b_tone_step EQU #EA10   ; Channel B
music_ch_c_tone_step EQU #EA11   ; Channel C
music_ch_noise_step_base EQU #EA12   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #EA12   ; Channel A
music_ch_b_noise_step EQU #EA13   ; Channel B
music_ch_c_noise_step EQU #EA14   ; Channel C
music_ch_orn_step_base EQU #EA15   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #EA15   ; Channel A
music_ch_b_orn_step EQU #EA16   ; Channel B
music_ch_c_orn_step EQU #EA17   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #EA18   ; End of project variables (10776 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#EA18: Project variables (10776 bytes)
;   #EA18-#F37F: Free RAM (~2408 bytes available)
...
; Sprite Asset 0: hero_walk_left
;; Sprite: hero_walk_left
;; Total Frames: 2
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
;; Drawable Palette (Hex): C0=rgba(0,0,0,0), C1=#FFFFFF, C2=#FF0000, C3=#00FF00

SPRITE_HERO_WALK_LEFT_0_WIDTH     EQU 16
SPRITE_HERO_WALK_LEFT_0_HEIGHT    EQU 16
SPRITE_HERO_WALK_LEFT_0_FRAMES    EQU 2

;; ---- Sprite Frame: hero_walk_left_0_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F1_DATA (32 bytes)
SPRITE_HERO_IDLE_1_WIDTH     EQU 16
SPRITE_HERO_IDLE_1_HEIGHT    EQU 16
SPRITE_HERO_IDLE_1_FRAMES    EQU 1

;; ---- Sprite Frame: hero_idle_1_F0 ----
;; Size: 16x16
HERO_IDLE_1_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#03,#04,#03,#05,#03,#01,#03,#0B,#33,#03,#03,#01,#01,#01,#03
    DB #00,#80,#40,#A0,#D0,#90,#00,#80,#A0,#90,#88,#80,#00,#00,#00,#00

;; ---- End of Frame: hero_idle_1_F0 ----


; Sprite Asset 2: cuadro
;; Sprite: cuadro
;; Total Frames: 1
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_CUADRO_2_WIDTH     EQU 16
SPRITE_CUADRO_2_HEIGHT    EQU 16
SPRITE_CUADRO_2_FRAMES    EQU 1
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_3_F1_DATA (32 bytes)
SPRITE_NINA_GRUB_RIGHT_4_WIDTH     EQU 16
SPRITE_NINA_GRUB_RIGHT_4_HEIGHT    EQU 16
SPRITE_NINA_GRUB_RIGHT_4_FRAMES    EQU 2

;; ---- Sprite Frame: nina_grub_right_4_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F1_DATA (32 bytes)
SPRITE_NEW_SPRITE_5_WIDTH     EQU 16
SPRITE_NEW_SPRITE_5_HEIGHT    EQU 16
SPRITE_NEW_SPRITE_5_FRAMES    EQU 1

;; ---- Sprite Frame: New Sprite_5_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA (32 bytes)
SPRITE_NINA_JUMP_RIGHT_6_WIDTH     EQU 16
SPRITE_NINA_JUMP_RIGHT_6_HEIGHT    EQU 16
SPRITE_NINA_JUMP_RIGHT_6_FRAMES    EQU 1

;; ---- Sprite Frame: nina_jump_right_6_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_6_F0_DATA (32 bytes)
SPRITE_HERO_WALK_RIGHT_7_WIDTH     EQU 16
SPRITE_HERO_WALK_RIGHT_7_HEIGHT    EQU 16
SPRITE_HERO_WALK_RIGHT_7_FRAMES    EQU 2

;; ---- Sprite Frame: hero_walk_right_7_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F1_DATA (32 bytes)
SPRITE_NINA_WALK_LEFT_8_WIDTH     EQU 16
SPRITE_NINA_WALK_LEFT_8_HEIGHT    EQU 16
SPRITE_NINA_WALK_LEFT_8_FRAMES    EQU 2

;; ---- Sprite Frame: nina_walk_left_8_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F1_DATA (32 bytes)
SPRITE_NINA_GRUB_LEFT_9_WIDTH     EQU 16
SPRITE_NINA_GRUB_LEFT_9_HEIGHT    EQU 16
SPRITE_NINA_GRUB_LEFT_9_FRAMES    EQU 2

;; ---- Sprite Frame: nina_grub_left_9_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F1_DATA (32 bytes)
SPRITE_NINA_JUMP_LEFT_10_WIDTH     EQU 16
SPRITE_NINA_JUMP_LEFT_10_HEIGHT    EQU 16
SPRITE_NINA_JUMP_LEFT_10_FRAMES    EQU 1

;; ---- Sprite Frame: nina_jump_left_10_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_10_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_10_F0_DATA (32 bytes)
...
sprite_asset_frame_count:
    ...
    db 2 ; Sprite 4: nina_grub_right
    db 1 ; Sprite 5: New Sprite
    db 1 ; Sprite 6: nina_jump_right
    db 2 ; Sprite 7: hero_walk_right
    db 2 ; Sprite 8: nina_walk_left
    db 2 ; Sprite 9: nina_grub_left
    db 1 ; Sprite 10: nina_jump_left
...
sprite_asset_layer_count:
    ...
    db 2 ; Sprite 4: nina_grub_right
    db 1 ; Sprite 5: New Sprite
    db 2 ; Sprite 6: nina_jump_right
    db 2 ; Sprite 7: hero_walk_right
    db 2 ; Sprite 8: nina_walk_left
    db 2 ; Sprite 9: nina_grub_left
    db 2 ; Sprite 10: nina_jump_left
...
SPRITE_0_FRAME_PTRS:
    dw HERO_WALK_LEFT_0_F0_LAYER1
    dw HERO_WALK_LEFT_0_F1_LAYER1

; Sprite 1: hero_idle frame pointers
SPRITE_1_FRAME_PTRS:
    dw HERO_IDLE_1_F0_LAYER1

; Sprite 2: cuadro frame pointers
SPRITE_2_FRAME_PTRS:
...
; Sprite 4: nina_grub_right frame pointers
SPRITE_4_FRAME_PTRS:
    dw NINA_GRUB_RIGHT_4_F0_LAYER1
    dw NINA_GRUB_RIGHT_4_F1_LAYER1

; Sprite 5: New Sprite frame pointers
SPRITE_5_FRAME_PTRS:
    dw SPRITE_PLACEHOLDER_PATTERN

; Sprite 6: nina_jump_right frame pointers
SPRITE_6_FRAME_PTRS:
    dw NINA_JUMP_RIGHT_6_F0_LAYER0

; Sprite 7: hero_walk_right frame pointers
SPRITE_7_FRAME_PTRS:
    dw HERO_WALK_RIGHT_7_F0_LAYER1
    dw HERO_WALK_RIGHT_7_F1_LAYER1

; Sprite 8: nina_walk_left frame pointers
SPRITE_8_FRAME_PTRS:
    dw NINA_WALK_LEFT_8_F0_LAYER0
    dw NINA_WALK_LEFT_8_F1_LAYER0

; Sprite 9: nina_grub_left frame pointers
SPRITE_9_FRAME_PTRS:
    dw NINA_GRUB_LEFT_9_F0_LAYER1
    dw NINA_GRUB_LEFT_9_F1_LAYER1

; Sprite 10: nina_jump_left frame pointers
SPRITE_10_FRAME_PTRS:
    dw NINA_JUMP_LEFT_10_F0_LAYER0
...
sprite_dir_left_table:
    db 0, 1, 2, 8, 9, 5, 10, 0, 8, 9, 10

sprite_dir_right_table:
    db 7, 1, 2, 3, 4, 5, 6, 7, 3, 4, 6
...
SM_SpriteLayerColorTable:
    ...
    db 15, 6 ; Sprite 4: nina_grub_right
    db 15, 0 ; Sprite 5: New Sprite
    db 6, 15 ; Sprite 6: nina_jump_right
    db 15, 8 ; Sprite 7: hero_walk_right
    db 6, 15 ; Sprite 8: nina_walk_left
    db 15, 6 ; Sprite 9: nina_grub_left
    db 6, 15 ; Sprite 10: nina_jump_left
...
sprite_asset_base_pattern_slot_worldmap_1776512078647:
    ...
    db 1 ; Sprite 2: cuadro
    db 2 ; Sprite 3: nina_walk_right
    db 6 ; Sprite 4: nina_grub_right
    db 0 ; Sprite 5: New Sprite
    db 0 ; Sprite 6: nina_jump_right
    db 0 ; Sprite 7: hero_walk_right
    db 10 ; Sprite 8: nina_walk_left
    db 14 ; Sprite 9: nina_grub_left
    db 0 ; Sprite 10: nina_jump_left
...
load_sprite_patterns_worldmap_1776512078647:
    ...
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 4: nina_grub_right frame 0 (2 layers)
    ld hl, NINA_GRUB_RIGHT_4_F0_LAYER1
    ld de, SPRPAT + (6 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 4: nina_grub_right frame 1 (2 layers)
    ld hl, NINA_GRUB_RIGHT_4_F1_LAYER1
    ld de, SPRPAT + (8 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 8: nina_walk_left frame 0 (2 layers)
    ld hl, NINA_WALK_LEFT_8_F0_LAYER0
    ld de, SPRPAT + (10 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 8: nina_walk_left frame 1 (2 layers)
    ld hl, NINA_WALK_LEFT_8_F1_LAYER0
    ld de, SPRPAT + (12 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 9: nina_grub_left frame 0 (2 layers)
    ld hl, NINA_GRUB_LEFT_9_F0_LAYER1
    ld de, SPRPAT + (14 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ; Sprite Asset 9: nina_grub_left frame 1 (2 layers)
    ld hl, NINA_GRUB_LEFT_9_F1_LAYER1
    ld de, SPRPAT + (16 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
...
SCREEN_PAN1_0_SPRITE_PATTERN_SLOTS EQU 19
...
entity_wallgrab_cfg_grab_sprite:
    DB 4, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255
...
ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F0_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_LEFT_0_F0 (64 -> 47 bytes)
    DB #16,#00,#03,#04,#03,#05,#03,#01,#03,#0B,#33,#03,#A2,#01,#52,#03
    DB #00,#80,#40,#A0,#D0,#90,#00,#80,#A0,#90,#88,#80,#00,#61,#84,#03
    DB #04,#0B,#04,#00,#F8,#C2,#38,#50,#28,#28,#38,#E0,#35,#55,#58
ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F1_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_LEFT_0_F1 (64 -> 46 bytes)
    DB #A0,#00,#22,#03,#04,#03,#05,#03,#21,#1B,#03,#66,#43,#78,#00,#02
    DB #80,#40,#A0,#D8,#80,#04,#B8,#80,#66,#7C,#04,#00,#86,#07,#0C,#0B
    DB #04,#00,#16,#58,#C0,#60,#B0,#58,#24,#38,#00,#0D,#55,#56
ZX0_SPRITE_FRAME_CUADRO_2_F0_DATA:
...
ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F0_DATA:
    ; ZX0 compressed sprite frame NINA_GRUB_RIGHT_4_F0 (64 -> 44 bytes)
...
ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F1_DATA:
    ; ZX0 compressed sprite frame NINA_GRUB_RIGHT_4_F1 (64 -> 48 bytes)
...
ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA:
    ; ZX0 compressed sprite frame NEW_SPRITE_5_F0 (96 -> 6 bytes)
    DB #85,#00,#57,#55,#55,#80
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_6_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_RIGHT_6_F0 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F0_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_RIGHT_7_F0 (64 -> 46 bytes)
...
ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F1_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_RIGHT_7_F1 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F0_DATA:
    ; ZX0 compressed sprite frame NINA_WALK_LEFT_8_F0 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F1_DATA:
    ; ZX0 compressed sprite frame NINA_WALK_LEFT_8_F1 (64 -> 56 bytes)
...
ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F0_DATA:
    ; ZX0 compressed sprite frame NINA_GRUB_LEFT_9_F0 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F1_DATA:
    ; ZX0 compressed sprite frame NINA_GRUB_LEFT_9_F1 (64 -> 49 bytes)
    ...
    DB #56
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_10_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_LEFT_10_F0 (64 -> 48 bytes)
...
; ==================================================================
; Frame group: HERO_WALK_LEFT_0_F0
HERO_WALK_LEFT_0_F0_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_WALK_LEFT_0_F0_DATA
; Frame group: HERO_WALK_LEFT_0_F1
...
; Frame group: NINA_GRUB_RIGHT_4_F0
NINA_GRUB_RIGHT_4_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F0_DATA
; Frame group: NINA_GRUB_RIGHT_4_F1
NINA_GRUB_RIGHT_4_F1_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_GRUB_RIGHT_4_F1_DATA
; Frame group: NEW_SPRITE_5_F0
NEW_SPRITE_5_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NEW_SPRITE_5_F0_DATA
; Frame group: NINA_JUMP_RIGHT_6_F0
NINA_JUMP_RIGHT_6_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_6_F0_DATA
; Frame group: HERO_WALK_RIGHT_7_F0
HERO_WALK_RIGHT_7_F0_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F0_DATA
; Frame group: HERO_WALK_RIGHT_7_F1
HERO_WALK_RIGHT_7_F1_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_7_F1_DATA
; Frame group: NINA_WALK_LEFT_8_F0
NINA_WALK_LEFT_8_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F0_DATA
; Frame group: NINA_WALK_LEFT_8_F1
NINA_WALK_LEFT_8_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_WALK_LEFT_8_F1_DATA
; Frame group: NINA_GRUB_LEFT_9_F0
NINA_GRUB_LEFT_9_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F0_DATA
; Frame group: NINA_GRUB_LEFT_9_F1
NINA_GRUB_LEFT_9_F1_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_9_F1_DATA
; Frame group: NINA_JUMP_LEFT_10_F0
NINA_JUMP_LEFT_10_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_10_F0_DATA
