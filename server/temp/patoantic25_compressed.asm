...
; BANK 03 @#0000 : sprites.asm (5186 bytes)
; BANK 03 @#1442 : font.asm (3006 bytes)
; BANK 04 @#0000 : font.asm (541 bytes)
; BANK 04 @#021D : hud.asm (3836 bytes)
; BANK 04 @#1119 : menus.asm (444 bytes)
; BANK 04 @#12D5 : sound.asm (3184 bytes)
; BANK 04 @#1F45 : scroll.asm (187 bytes)
; BANK 05 @#0000 : scroll.asm (2166 bytes)
; BANK 05 @#0876 : animtiles.asm (3349 bytes)
; BANK 05 @#158B : particles.asm (2677 bytes)
; BANK 06 @#0000 : particles.asm (2286 bytes)
; BANK 06 @#08EE : statemachine.asm part 1/3 (5906 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 4/3 (695 bytes)
; BANK 09 @#02B7 : gameflow.asm part 1/3 (7497 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (1035 bytes)
...
SPRITE_NINA_LEFT_6_WIDTH     EQU 16
SPRITE_NINA_LEFT_6_HEIGHT    EQU 16
SPRITE_NINA_LEFT_6_FRAMES    EQU 2

;; ---- Sprite Frame: nina_left_6_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_6_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LEFT_6_F1_DATA (32 bytes)
SPRITE_6_PATTERN EQU NINA_LEFT_6_F0_LAYER0
...
SPRITE_NINA_RIGHT_8_WIDTH     EQU 16
SPRITE_NINA_RIGHT_8_HEIGHT    EQU 16
SPRITE_NINA_RIGHT_8_FRAMES    EQU 2

;; ---- Sprite Frame: nina_right_8_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_RIGHT_8_F1_DATA (32 bytes)
SPRITE_8_PATTERN EQU NINA_RIGHT_8_F0_LAYER0
...
sprite_asset_frame_count:
    ...
    db 2 ; Sprite 6: nina_left
    db 2 ; Sprite 7: anec_left
    db 2 ; Sprite 8: nina_right
...
; Sprite 6: nina_left frame pointers
SPRITE_6_FRAME_PTRS:
    dw NINA_LEFT_6_F0_LAYER0
    dw NINA_LEFT_6_F1_LAYER0
...
; Sprite 8: nina_right frame pointers
SPRITE_8_FRAME_PTRS:
    dw NINA_RIGHT_8_F0_LAYER0
    dw NINA_RIGHT_8_F1_LAYER0
...
sprite_dir_left_table:
    db 7, 1, 2, 3, 4, 5, 6, 7, 6

sprite_dir_right_table:
    db 0, 1, 2, 3, 4, 5, 8, 0, 8
...
ZX0_SPRITE_FRAME_NINA_LEFT_6_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LEFT_6_F0 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_NINA_LEFT_6_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LEFT_6_F1 (64 -> 56 bytes)
...
ZX0_SPRITE_FRAME_NINA_RIGHT_8_F0_DATA:
    ; ZX0 compressed sprite frame NINA_RIGHT_8_F0 (64 -> 50 bytes)
    ...
    DB #55,#56
ZX0_SPRITE_FRAME_NINA_RIGHT_8_F1_DATA:
    ; ZX0 compressed sprite frame NINA_RIGHT_8_F1 (64 -> 55 bytes)
...
; Frame group: NINA_LEFT_6_F0
NINA_LEFT_6_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LEFT_6_F0_DATA
; Frame group: NINA_LEFT_6_F1
NINA_LEFT_6_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LEFT_6_F1_DATA
...
; Frame group: NINA_RIGHT_8_F0
NINA_RIGHT_8_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_RIGHT_8_F0_DATA
; Frame group: NINA_RIGHT_8_F1
NINA_RIGHT_8_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_RIGHT_8_F1_DATA
