...
; BANK 00 @#0C60 : entities.asm (4109 bytes)
; BANK 00 @#1C6D : worlds.asm (915 bytes)
; BANK 01 @#0000 : worlds.asm (878 bytes)
; BANK 01 @#036E : screens.asm part 1/2 (7314 bytes)
; BANK 02 @#0000 : screens.asm part 2/2 (2438 bytes)
; BANK 02 @#0986 : sprites.asm (4168 bytes)
; BANK 02 @#19CE : font.asm (1586 bytes)
; BANK 03 @#0000 : font.asm (1870 bytes)
; BANK 03 @#074E : hud.asm (3480 bytes)
; BANK 03 @#14E6 : menus.asm (168 bytes)
; BANK 03 @#158E : sound.asm part 1/2 (2674 bytes)
; BANK 04 @#0000 : sound.asm part 2/2 (6874 bytes)
; BANK 04 @#1ADA : scroll.asm (1318 bytes)
; BANK 05 @#0000 : scroll.asm (1035 bytes)
; BANK 05 @#040B : animtiles.asm (5280 bytes)
; BANK 05 @#18AB : statemachine.asm part 1/3 (1877 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 07 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 4/3 (945 bytes)
; BANK 08 @#03B1 : gameflow.asm (6129 bytes)
...
entity_x_pos        EQU #DD7A   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DD9A   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DDBA   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DDDA   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DDFA   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DE1A   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DE3A   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DE5A   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DE7A   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DE9A   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DE9B   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DEBB   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DEDB   ; Entity health (32 bytes)
entity_anim_frame   EQU #DEFB   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DF1B   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DF3B   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DF5B   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DF7B   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DF9B   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DFBB   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DFDB   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DFFB   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #E01B   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #E03B   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #E05B   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E07B   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E09B   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E0BB   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E0DB   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E0FB   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E11B   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E13B   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E15B   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E17B   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E19B   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E1BB   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E1DB   ; Number of sprites currently active
sprites_dirty      EQU #E1DC   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E1DD   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E1FD   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E21D   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E23D   ; Runtime base 16x16 slot per sprite asset (4 bytes)
sprite_placeholder_base_pattern_num EQU #E241   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E242   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E243   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #E2C3   ; Currently displayed screen ID
screen_dirty_flag   EQU #E2C4   ; Screen needs redraw flag
screen_transition_cooldown EQU #E2C5   ; Cooldown frames after screen transition
current_world_id    EQU #E2C6   ; Current world ID (for multi-world support)
current_screen_index EQU #E2C7   ; Current screen index within world
current_screen_anim_group_count EQU #E2C8   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E2C9   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E2CA   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E2CB   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E2CC   ; Player X position (16-bit)
player_y            EQU #E2CE   ; Player Y position (16-bit)
player_runtime_enabled EQU #E2D0   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E2D1   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E2D2   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E2D3   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E2D4   ; Player health points
player_score        EQU #E2D5   ; Player score (16-bit)
gem_count           EQU #E2D7   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E2D8   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E2D9   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E2DA   ; Interaction type id of last interacted tile
last_interaction_value EQU #E2DB   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E2DC   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E2DD   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E2DE   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E2DF   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E2E0   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E2E1   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E321   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E361   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E3A1   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E3E1   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E3F1   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E401   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E411   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E421   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E431   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E441   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E442   ; Temporary 16-bit storage
temp_word_2         EQU #E444   ; Temporary 16-bit storage
temp_byte_1         EQU #E446   ; Temporary 8-bit storage
temp_byte_2         EQU #E447   ; Temporary 8-bit storage
temp_byte_3         EQU #E448   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E468   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E488   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E4A8   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E4C8   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E4C9   ; Frames remaining for current SFX
sfx_fadeout         EQU #E4CA   ; Reserved fadeout flag/state
temp_byte_7         EQU #E4CB   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E4EB   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E50B   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E52B   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E54B   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E56B   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E58B   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E5AB   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E5CB   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E5EB   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E60B   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E62B   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E64B   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E66B   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E68B   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E6AB   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E6CB   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E6EB   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E70B   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E72B   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E76B   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E7AB   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E7CB   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E7EB   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E80B   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E80C   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E80D   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E80E   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E80F   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E810   ; Cached entity X for wall checks
wall_temp_y         EQU #E811   ; Cached entity Y for wall checks
wall_hit_left       EQU #E812   ; Hitbox left edge cache
wall_hit_top        EQU #E813   ; Hitbox top edge cache
wall_hit_right      EQU #E814   ; Hitbox right edge cache
wall_hit_bottom     EQU #E815   ; Hitbox bottom edge cache
wall_hit_w          EQU #E816   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E817   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E818   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E819   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E81A   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E81B   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E81C   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E83C   ; Number of entries in active_entity_list
hero_entity_id      EQU #E83D   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E83E   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E83F   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E85F   ; Number of entries in input_entity_list
render_entity_list  EQU #E860   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E880   ; Number of entries in render_entity_list
collision_entity_list EQU #E881   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E8A1   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E8A2   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E8C2   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E8C3   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E8E3   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E8E4   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E904   ; Number of entities in coll_list
coll_src_left       EQU #E905   ; Source AABB left edge (scratch)
coll_src_right      EQU #E906   ; Source AABB right edge (scratch)
coll_src_top        EQU #E907   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E908   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E909   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E909   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E90B   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E90D   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E90F   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E911   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E913   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E915   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E917   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E919   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E91A   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E91F   ; Frame counter (16-bit)
task_exec_time          EQU #E921   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E923   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E924   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E924   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E925   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E926   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E927   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E928   ; 0=stopped, 1=track active
music_muted          EQU #E929   ; 0=audible, 1=muted/pause
music_loop           EQU #E92A   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E92B   ; Current ROM track index
music_row_frames     EQU #E92C   ; Frames per tracker row
music_row_countdown  EQU #E92D   ; Countdown to next row
music_order_pos      EQU #E92E   ; Current order position
music_pattern_index  EQU #E92F   ; Current pattern index
music_pattern_row    EQU #E930   ; Current row inside pattern
music_pattern_rows   EQU #E931   ; Cached rows in current pattern
music_track_ptr_l    EQU #E932   ; Current track pointer low byte
music_track_ptr_h    EQU #E933   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E934   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E935   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E936   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E937   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E937   ; Channel A
music_ch_b_note EQU #E938   ; Channel B
music_ch_c_note EQU #E939   ; Channel C
music_ch_instrument_base EQU #E93A   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E93A   ; Channel A
music_ch_b_instrument EQU #E93B   ; Channel B
music_ch_c_instrument EQU #E93C   ; Channel C
music_ch_ornament_base EQU #E93D   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E93D   ; Channel A
music_ch_b_ornament EQU #E93E   ; Channel B
music_ch_c_ornament EQU #E93F   ; Channel C
music_ch_volume_base EQU #E940   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E940   ; Channel A
music_ch_b_volume EQU #E941   ; Channel B
music_ch_c_volume EQU #E942   ; Channel C
music_ch_vol_step_base EQU #E943   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E943   ; Channel A
music_ch_b_vol_step EQU #E944   ; Channel B
music_ch_c_vol_step EQU #E945   ; Channel C
music_ch_tone_step_base EQU #E946   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E946   ; Channel A
music_ch_b_tone_step EQU #E947   ; Channel B
music_ch_c_tone_step EQU #E948   ; Channel C
music_ch_noise_step_base EQU #E949   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E949   ; Channel A
music_ch_b_noise_step EQU #E94A   ; Channel B
music_ch_c_noise_step EQU #E94B   ; Channel C
music_ch_orn_step_base EQU #E94C   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E94C   ; Channel A
music_ch_b_orn_step EQU #E94D   ; Channel B
music_ch_c_orn_step EQU #E94E   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E94F   ; End of project variables (10575 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E94F: Project variables (10575 bytes)
;   #E94F-#F37F: Free RAM (~2609 bytes available)
...
;   Active entities: 1
;   Used components: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors, WallCollision, StateMachine, RetractableGate, comp_tile_collector, TileInteraction
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors, WallCollision, StateMachine, RetractableGate, comp_tile_collector, TileInteraction 
...
SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #10,#10,#10,#10,#00,#08,#00,#08,#00,#00,#00,#00,#10,#00,#10,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
ENTITY_PLAYER_1_COMP_MASK EQU #23DB  ; Component mask: 10001111011011b
; Template: tpl_player
