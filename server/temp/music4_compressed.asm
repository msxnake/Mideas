...
; BANK 00 @#079A : worlds.asm (1172 bytes)
; BANK 00 @#0C2E : screens.asm (4101 bytes)
; BANK 00 @#1C33 : sprites.asm (973 bytes)
; BANK 01 @#0000 : sprites.asm (840 bytes)
; BANK 01 @#0348 : font.asm (174 bytes)
; BANK 01 @#03F6 : hud.asm (79 bytes)
; BANK 01 @#0445 : menus.asm (168 bytes)
; BANK 01 @#04ED : sound.asm part 1/2 (6931 bytes)
; BANK 02 @#0000 : sound.asm part 2/2 (3409 bytes)
; BANK 02 @#0D51 : scroll.asm (2353 bytes)
; BANK 02 @#1682 : animtiles.asm (2430 bytes)
; BANK 03 @#0000 : animtiles.asm (1405 bytes)
; BANK 03 @#057D : particles.asm (4963 bytes)
; BANK 03 @#18E0 : statemachine.asm (5 bytes)
; BANK 03 @#18E5 : gameflow.asm (1819 bytes)
; BANK 04 @#0000 : gameflow.asm (3515 bytes)
...
SCREEN_NEW_SCREENMAP_0_LAYOUT:
    ...
    DB #90,#00,#46,#38,#80,#81,#FC,#1E,#C0,#58,#E0,#82,#83,#FC,#7C,#80
...
; Re-arm PSG hardware envelope on a new note if the instrument uses it.
; Input:  C = channel index (0=A, 1=B, 2=C)
; Output: PSG ENV registers updated only when required
; Destroys: AF, BC, DE, HL
...
music_trigger_channel_attack:
    ...
    ld a, h
    or l
    jr z, music_trigger_channel_attack_done
    ld a, (hl)
    and #04
    jr z, music_trigger_channel_attack_done
    push hl
    ...
    ld h, d
    ld l, e
    call psg_set_envelope
music_trigger_channel_attack_done:
    pop hl
    pop de
    pop bc
    ret
...
music_update_one_channel:
    ...
    call psg_set_tone
    pop bc
    call music_channel_uses_hardware_env
    or a
    jr z, .resolve_software_volume
    ld b, #10
    jr .apply_channel_volume
.resolve_software_volume:
...
music_track_0_musica_1_snd_inst_1_vol_env:
    DB #0F,#0E,#0D,#0D,#0F,#0F,#05,#03,#02,#01,#00
