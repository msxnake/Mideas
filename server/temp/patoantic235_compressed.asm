...
; Estimated payload bytes: 141908
...
; BANK 10 @#05BD : font.asm (1819 bytes)
; BANK 10 @#0CD8 : hud.asm (4290 bytes)
; BANK 10 @#1D9A : menus.asm (454 bytes)
; BANK 10 @#1F60 : sound.asm (160 bytes)
; BANK 11 @#0000 : sound.asm (7087 bytes)
; BANK 11 @#1BAF : scroll.asm (1105 bytes)
; BANK 12 @#0000 : scroll.asm (1248 bytes)
; BANK 12 @#04E0 : animtiles.asm (6239 bytes)
; BANK 12 @#1D3F : statemachine.asm part 1/3 (705 bytes)
; BANK 13 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 15 @#0000 : statemachine.asm part 4/3 (3647 bytes)
; BANK 15 @#0E3F : gameflow.asm part 1/2 (4545 bytes)
; BANK 16 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 17 @#0000 : gameflow.asm part 3/2 (2644 bytes)
...
SM_New_Statemachine_state_1771533526010_Transitions: 
    ...
    DW SM_New_Statemachine_state_1771533526010_Transitions_Actions_6 
    DB 1; AND 
    DB 2 
    DB 14; VARIABLE_COMPARE 
    DB 4, 0, 1; isOnGround (ID 4) == true
    ...
    DW SM_New_Statemachine_state_1771533526010_Transitions_Actions_7 
...
SM_New_Statemachine_state_1771533526010_Transitions_Actions_5: 
    ...
    DB 10, 1        ; Lives (ID 10)
    DB 0xFF; END
SM_New_Statemachine_state_1771533526010_Transitions_Actions_6: 
    DB 0; NONE 
    DB 0xFF; END
SM_New_Statemachine_state_1771533526010_Transitions_Actions_7: 
    DB 0; NONE 
    DB 0xFF; END
...
SM_New_Statemachine_state_walk_right_slow_1774181000001_Transitions: 
    ...
    DB 10, 4, 1; Lives (ID 10) >= 1
    DW SM_New_Statemachine_state_1771533530403 
    DW SM_New_Statemachine_state_walk_right_slow_1774181000001_Transitions_Actions_1 
    DB 8; HAS_COLLISION 
    DB 2          ; collisionType: enemy
    DW SM_New_Statemachine_state_1771533530403 
    DW SM_New_Statemachine_state_walk_right_slow_1774181000001_Transitions_Actions_2 

SM_New_Statemachine_state_walk_right_slow_1774181000001_Transitions_Actions_1: 
    DB 5; CHANGE_SPRITE 
    DB 6; sprite: nina_dead 
    DB 9; PLAY_SOUND 
    DB 0        ; sound: sound_1772354483190
    ...
    DB 10, 1        ; Lives (ID 10)
    DB 0xFF; END
SM_New_Statemachine_state_walk_right_slow_1774181000001_Transitions_Actions_2: 
    DB 5; CHANGE_SPRITE 
    DB 6; sprite: nina_dead 
    DB 9; PLAY_SOUND 
    DB 0        ; sound: sound_1772354483190
...
SM_New_Statemachine_state_walk_left_slow_1774181000003_Transitions: 
    ...
    DB 10, 4, 1; Lives (ID 10) >= 1
    DW SM_New_Statemachine_state_1771533530403 
    DW SM_New_Statemachine_state_walk_left_slow_1774181000003_Transitions_Actions_1 
    DB 8; HAS_COLLISION 
    DB 2          ; collisionType: enemy
    DW SM_New_Statemachine_state_1771533530403 
    DW SM_New_Statemachine_state_walk_left_slow_1774181000003_Transitions_Actions_2 

SM_New_Statemachine_state_walk_left_slow_1774181000003_Transitions_Actions_1: 
    DB 5; CHANGE_SPRITE 
    DB 6; sprite: nina_dead 
    DB 9; PLAY_SOUND 
    DB 0        ; sound: sound_1772354483190
    ...
    DB 10, 1        ; Lives (ID 10)
    DB 0xFF; END
SM_New_Statemachine_state_walk_left_slow_1774181000003_Transitions_Actions_2: 
    DB 5; CHANGE_SPRITE 
    DB 6; sprite: nina_dead 
    DB 9; PLAY_SOUND 
    DB 0        ; sound: sound_1772354483190
