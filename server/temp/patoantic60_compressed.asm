...
; Estimated payload bytes: 100162
...
; BANK 03 @#0000 : sprites.asm part 2/2 (7982 bytes)
; BANK 03 @#1F2E : font.asm (210 bytes)
; BANK 04 @#0000 : font.asm (3337 bytes)
; BANK 04 @#0D09 : hud.asm (3836 bytes)
; BANK 04 @#1C05 : menus.asm (444 bytes)
; BANK 04 @#1DC1 : sound.asm (575 bytes)
; BANK 05 @#0000 : sound.asm (2609 bytes)
; BANK 05 @#0A31 : scroll.asm (2353 bytes)
; BANK 05 @#1362 : animtiles.asm (3230 bytes)
; BANK 06 @#0000 : animtiles.asm (2686 bytes)
; BANK 06 @#0A7E : particles.asm (4963 bytes)
; BANK 06 @#1DE1 : statemachine.asm part 1/4 (543 bytes)
...
; BANK 10 @#0000 : statemachine.asm part 5/4 (1486 bytes)
; BANK 10 @#05CE : gameflow.asm part 1/3 (6706 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (1858 bytes)
...
SPRITE_NINA_WALK_LEFT_3_WIDTH     EQU 16
SPRITE_NINA_WALK_LEFT_3_HEIGHT    EQU 16
SPRITE_NINA_WALK_LEFT_3_FRAMES    EQU 2

;; ---- Sprite Frame: nina_walk_left_3_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F1_DATA (32 bytes)
SPRITE_3_PATTERN EQU NINA_WALK_LEFT_3_F0_LAYER0
SPRITE_3_PATTERN_BANK EQU ((SPRITE_3_PATTERN - #4000) / #2000)

; Sprite Asset 4: nina_jump_left
...
SPRITE_NINA_JUMP_LEFT_4_WIDTH     EQU 16
SPRITE_NINA_JUMP_LEFT_4_HEIGHT    EQU 16
SPRITE_NINA_JUMP_LEFT_4_FRAMES    EQU 1

;; ---- Sprite Frame: nina_jump_left_4_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_4_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_4_F0_DATA (32 bytes)
SPRITE_4_PATTERN EQU NINA_JUMP_LEFT_4_F0_LAYER1
SPRITE_4_PATTERN_BANK EQU ((SPRITE_4_PATTERN - #4000) / #2000)

; Sprite Asset 5: nina_land_left
...
SPRITE_NINA_LAND_LEFT_5_WIDTH     EQU 16
SPRITE_NINA_LAND_LEFT_5_HEIGHT    EQU 16
SPRITE_NINA_LAND_LEFT_5_FRAMES    EQU 3

;; ---- Sprite Frame: nina_land_left_5_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F2_DATA (32 bytes)
SPRITE_5_PATTERN EQU NINA_LAND_LEFT_5_F0_LAYER0
SPRITE_5_PATTERN_BANK EQU ((SPRITE_5_PATTERN - #4000) / #2000)

; Sprite Asset 6: nina_dead
;; Sprite: nina_dead
;; Total Frames: 3
;; Size: 16x16
;; Background Color (not exported as a layer): rgba(0,0,0,0)
...
SPRITE_NINA_DEAD_6_WIDTH     EQU 16
SPRITE_NINA_DEAD_6_HEIGHT    EQU 16
SPRITE_NINA_DEAD_6_FRAMES    EQU 3

;; ---- Sprite Frame: nina_dead_6_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_6_F0_DATA (32 bytes)
NINA_DEAD_6_F1_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #5F,#4F,#4B,#5B,#5F,#4F,#61,#3B,#0B,#1B,#13,#17,#10,#1E,#08,#0B
    DB #E8,#EC,#A6,#72,#DA,#8A,#8A,#C2,#5E,#CC,#E4,#F4,#84,#BC,#A0,#A0

NINA_DEAD_6_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #000000)
    DB #20,#30,#34,#24,#20,#30,#1E,#04,#04,#04,#0C,#08,#0F,#01,#07,#04
    DB #10,#10,#58,#8C,#24,#74,#74,#3C,#A0,#30,#18,#08,#78,#40,#40,#40

;; ---- End of Frame: nina_dead_6_F1 ----

;; ---- Sprite Frame: nina_dead_6_F2 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_6_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_DEAD_6_F2_DATA (32 bytes)
SPRITE_6_PATTERN EQU NINA_DEAD_6_F0_LAYER0
...
SPRITE_NINA_IDLE_RIGHT_7_FRAMES    EQU 1
...
SPRITE_ANEC_LEFT_8_WIDTH     EQU 16
SPRITE_ANEC_LEFT_8_HEIGHT    EQU 16
SPRITE_ANEC_LEFT_8_FRAMES    EQU 2

;; ---- Sprite Frame: anec_left_8_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_ANEC_LEFT_8_F1_DATA (32 bytes)
SPRITE_8_PATTERN EQU ANEC_LEFT_8_F0_LAYER1
SPRITE_8_PATTERN_BANK EQU ((SPRITE_8_PATTERN - #4000) / #2000)

; Sprite Asset 9: nina_walk_right
...
SPRITE_NINA_WALK_RIGHT_9_WIDTH     EQU 16
SPRITE_NINA_WALK_RIGHT_9_HEIGHT    EQU 16
SPRITE_NINA_WALK_RIGHT_9_FRAMES    EQU 2

;; ---- Sprite Frame: nina_walk_right_9_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F1_DATA (32 bytes)
SPRITE_9_PATTERN EQU NINA_WALK_RIGHT_9_F0_LAYER0
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_10_F0_DATA (32 bytes)
SPRITE_10_PATTERN EQU NINA_JUMP_RIGHT_10_F0_LAYER1
SPRITE_10_PATTERN_BANK EQU ((SPRITE_10_PATTERN - #4000) / #2000)

; Sprite Asset 11: nina_land_right
...
SPRITE_NINA_LAND_RIGHT_11_WIDTH     EQU 16
SPRITE_NINA_LAND_RIGHT_11_HEIGHT    EQU 16
SPRITE_NINA_LAND_RIGHT_11_FRAMES    EQU 3

;; ---- Sprite Frame: nina_land_right_11_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F2_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F2_DATA (32 bytes)
SPRITE_11_PATTERN EQU NINA_LAND_RIGHT_11_F0_LAYER0
SPRITE_11_PATTERN_BANK EQU ((SPRITE_11_PATTERN - #4000) / #2000)

; Sprite Asset 12: nina_idle_left
...
SPRITE_NINA_IDLE_LEFT_12_WIDTH     EQU 16
SPRITE_NINA_IDLE_LEFT_12_HEIGHT    EQU 16
SPRITE_NINA_IDLE_LEFT_12_FRAMES    EQU 1

;; ---- Sprite Frame: nina_idle_left_12_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_LEFT_12_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_LEFT_12_F0_DATA (32 bytes)
SPRITE_12_PATTERN EQU NINA_IDLE_LEFT_12_F0_LAYER0
...
sprite_asset_frame_count:
    ...
    db 2 ; Sprite 3: nina_walk_left
    db 1 ; Sprite 4: nina_jump_left
    db 3 ; Sprite 5: nina_land_left
    db 3 ; Sprite 6: nina_dead
    db 1 ; Sprite 7: nina_idle_right
    db 2 ; Sprite 8: anec_left
    db 2 ; Sprite 9: nina_walk_right
    db 1 ; Sprite 10: nina_jump_right
    db 3 ; Sprite 11: nina_land_right
    db 1 ; Sprite 12: nina_idle_left
...
sprite_loop_flags:
    ...
    db 0 ; Sprite 3: nina_walk_left
    db 0 ; Sprite 4: nina_jump_left
    db 0 ; Sprite 5: nina_land_left
    db 2 ; Sprite 6: nina_dead
    db 2 ; Sprite 7: nina_idle_right
    db 2 ; Sprite 8: anec_left
    db 0 ; Sprite 9: nina_walk_right
    db 0 ; Sprite 10: nina_jump_right
    db 0 ; Sprite 11: nina_land_right
    db 2 ; Sprite 12: nina_idle_left
...
; Sprite 3: nina_walk_left frame pointers
SPRITE_3_FRAME_PTRS:
    dw NINA_WALK_LEFT_3_F0_LAYER0
    dw NINA_WALK_LEFT_3_F1_LAYER0

; Sprite 4: nina_jump_left frame pointers
SPRITE_4_FRAME_PTRS:
    dw NINA_JUMP_LEFT_4_F0_LAYER1

; Sprite 5: nina_land_left frame pointers
SPRITE_5_FRAME_PTRS:
    dw NINA_LAND_LEFT_5_F0_LAYER0
    dw NINA_LAND_LEFT_5_F1_LAYER0
    dw NINA_LAND_LEFT_5_F2_LAYER0

; Sprite 6: nina_dead frame pointers
SPRITE_6_FRAME_PTRS:
    dw NINA_DEAD_6_F0_LAYER0
    dw NINA_DEAD_6_F1_LAYER0
    dw NINA_DEAD_6_F2_LAYER0

; Sprite 7: nina_idle_right frame pointers
SPRITE_7_FRAME_PTRS:
    dw NINA_IDLE_RIGHT_7_F0_LAYER0

; Sprite 8: anec_left frame pointers
SPRITE_8_FRAME_PTRS:
    dw ANEC_LEFT_8_F0_LAYER1
    dw ANEC_LEFT_8_F1_LAYER1

; Sprite 9: nina_walk_right frame pointers
SPRITE_9_FRAME_PTRS:
    dw NINA_WALK_RIGHT_9_F0_LAYER0
    dw NINA_WALK_RIGHT_9_F1_LAYER0

; Sprite 10: nina_jump_right frame pointers
SPRITE_10_FRAME_PTRS:
    dw NINA_JUMP_RIGHT_10_F0_LAYER1

; Sprite 11: nina_land_right frame pointers
SPRITE_11_FRAME_PTRS:
    dw NINA_LAND_RIGHT_11_F0_LAYER0
    dw NINA_LAND_RIGHT_11_F1_LAYER0
    dw NINA_LAND_RIGHT_11_F2_LAYER0

; Sprite 12: nina_idle_left frame pointers
SPRITE_12_FRAME_PTRS:
    dw NINA_IDLE_LEFT_12_F0_LAYER0
...
sprite_dir_left_table:
    db 8, 1, 2, 3, 4, 5, 6, 12, 8, 3, 4, 5, 12

sprite_dir_right_table:
    db 0, 1, 2, 9, 10, 11, 6, 7, 0, 9, 10, 11, 7
...
entity_sprite_config: 
    ...
    db 1, 2 ; Entity 1 (nina_walk_left)
...
SM_SpriteLayerColorTable:
    ...
    db 6, 15 ; Sprite 3: nina_walk_left
    db 15, 2 ; Sprite 4: nina_jump_left
    db 6, 15 ; Sprite 5: nina_land_left
    db 6, 1 ; Sprite 6: nina_dead
    db 6, 15 ; Sprite 7: nina_idle_right
    db 15, 7 ; Sprite 8: anec_left
    db 6, 15 ; Sprite 9: nina_walk_right
    db 15, 2 ; Sprite 10: nina_jump_right
    db 6, 15 ; Sprite 11: nina_land_right
    db 6, 15 ; Sprite 12: nina_idle_left
...
SUBMENU_CURSOR_PATTERN_COUNT EQU 8
...
ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F0_DATA:
    ; ZX0 compressed sprite frame NINA_WALK_LEFT_3_F0 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F1_DATA:
    ; ZX0 compressed sprite frame NINA_WALK_LEFT_3_F1 (64 -> 56 bytes)
...
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_4_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_LEFT_4_F0 (64 -> 55 bytes)
    DB #A0,#00,#68,#0F,#0B,#1B,#1F,#0F,#21,#28,#01,#00,#92,#AA,#00,#69
    DB #40,#C0,#80,#A3,#00,#2A,#00,#28,#02,#89,#D9,#03,#1F,#21,#E8,#13
    DB #06,#03,#87,#55,#F0,#0A,#C0,#E0,#E0,#90,#28,#04,#02,#02,#A7,#54
    DB #F0,#D6,#00,#D5,#BF,#55,#60
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_5_F0 (64 -> 50 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#5B,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#FA,#B4,#F9,#09,#7B,#CB,#80,#EF,#D3,#FE,#C2,#B5,#10
    DB #55,#58
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_5_F1 (64 -> 52 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#58,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#F8,#FE,#F9,#40,#11,#F6,#BF,#C0,#80,#80,#FE,#8D,#F5
    DB #81,#04,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F2_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_LEFT_5_F2 (64 -> 52 bytes)
    DB #61,#00,#1F,#00,#9A,#03,#02,#03,#EA,#07,#EF,#02,#12,#E0,#E0,#A0
    DB #30,#18,#08,#08,#C0,#40,#C0,#9E,#F0,#00,#80,#CC,#92,#0F,#0B,#1B
    DB #1F,#0F,#01,#FB,#FD,#E5,#20,#FE,#F4,#FF,#CB,#FE,#80,#CF,#EE,#2D
    DB #81,#04,#55,#56
ZX0_SPRITE_FRAME_NINA_DEAD_6_F0_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_6_F0 (64 -> 59 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#28,#A0,#30
    DB #18,#08,#06,#C0,#40,#C0,#E0,#F0,#00,#80,#00,#80,#20,#30,#34,#24
    DB #20,#30,#1E,#04,#25,#A0,#0C,#08,#0F,#01,#07,#04,#10,#AF,#58,#8C
    DB #24,#74,#3C,#B4,#8F,#78,#40,#FF,#55,#55,#80
ZX0_SPRITE_FRAME_NINA_DEAD_6_F2_DATA:
    ; ZX0 compressed sprite frame NINA_DEAD_6_F2 (64 -> 54 bytes)
...
ZX0_SPRITE_FRAME_NINA_IDLE_RIGHT_7_F0_DATA:
    ; ZX0 compressed sprite frame NINA_IDLE_RIGHT_7_F0 (64 -> 51 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
    DB #01,#F8,#00,#9A,#C0,#40,#C0,#EA,#E0,#EC,#40,#FB,#FF,#CB,#01,#EF
    DB #CF,#FE,#C2,#E4,#CB,#AA,#F0,#D0,#D8,#F8,#F0,#80,#80,#9F,#20,#F3
    DB #55,#55,#80
ZX0_SPRITE_FRAME_ANEC_LEFT_8_F0_DATA:
    ; ZX0 compressed sprite frame ANEC_LEFT_8_F0 (64 -> 59 bytes)
...
ZX0_SPRITE_FRAME_ANEC_LEFT_8_F1_DATA:
    ; ZX0 compressed sprite frame ANEC_LEFT_8_F1 (64 -> 58 bytes)
...
ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F0_DATA:
    ; ZX0 compressed sprite frame NINA_WALK_RIGHT_9_F0 (64 -> 50 bytes)
    ...
    DB #55,#56
ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F1_DATA:
    ; ZX0 compressed sprite frame NINA_WALK_RIGHT_9_F1 (64 -> 55 bytes)
...
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_10_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_RIGHT_10_F0 (64 -> 56 bytes)
    DB #99,#00,#A6,#02,#03,#01,#00,#54,#00,#8F,#14,#40,#E4,#85,#99,#F0
    DB #D0,#D8,#F8,#F0,#84,#14,#80,#00,#00,#55,#1B,#03,#07,#07,#09,#14
    DB #20,#40,#40,#03,#2A,#07,#0F,#6B,#8B,#BF,#C0,#F8,#89,#FE,#23,#C8
    DB #60,#C0,#E1,#AA,#00,#55,#55,#80
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F0_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_11_F0 (64 -> 51 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
    DB #01,#F8,#00,#9A,#C0,#40,#C0,#EA,#E0,#EC,#40,#FB,#FF,#CB,#01,#EF
    DB #CF,#FE,#C2,#A9,#08,#7E,#F0,#D0,#D8,#F8,#F0,#80,#00,#FD,#FE,#2D
    DB #90,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F1_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_11_F1 (64 -> 53 bytes)
    DB #A0,#07,#A1,#05,#0C,#18,#10,#61,#03,#02,#03,#07,#0F,#00,#01,#00
    DB #01,#F8,#00,#9A,#C0,#40,#C0,#EA,#E0,#EC,#40,#FB,#FF,#CB,#01,#FE
    DB #CF,#FE,#F5,#29,#81,#20,#7F,#F0,#D0,#D8,#F8,#F0,#80,#00,#FD,#FE
    DB #8D,#02,#88,#55,#56
ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F2_DATA:
    ; ZX0 compressed sprite frame NINA_LAND_RIGHT_11_F2 (64 -> 52 bytes)
    DB #28,#00,#07,#28,#05,#0C,#18,#10,#0A,#03,#02,#03,#07,#0F,#00,#01
    DB #00,#21,#F8,#00,#9A,#C0,#40,#C0,#E8,#E0,#E5,#40,#3B,#CB,#01,#F8
    DB #CF,#EE,#B9,#81,#20,#F3,#2F,#F0,#D0,#D8,#F8,#F0,#80,#FD,#BD,#A5
    DB #04,#F5,#55,#56
ZX0_SPRITE_FRAME_NINA_IDLE_LEFT_12_F0_DATA:
    ; ZX0 compressed sprite frame NINA_IDLE_LEFT_12_F0 (64 -> 50 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#58,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#BF,#04,#B0,#FB,#F3,#FF,#CB,#80,#FF,#D3,#FE,#C2,#D5
    DB #55,#60
...
; Frame group: NINA_WALK_LEFT_3_F0
NINA_WALK_LEFT_3_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F0_DATA
; Frame group: NINA_WALK_LEFT_3_F1
NINA_WALK_LEFT_3_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_WALK_LEFT_3_F1_DATA
; Frame group: NINA_JUMP_LEFT_4_F0
NINA_JUMP_LEFT_4_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_4_F0_DATA
; Frame group: NINA_LAND_LEFT_5_F0
NINA_LAND_LEFT_5_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F0_DATA
; Frame group: NINA_LAND_LEFT_5_F1
NINA_LAND_LEFT_5_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F1_DATA
; Frame group: NINA_LAND_LEFT_5_F2
NINA_LAND_LEFT_5_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_LEFT_5_F2_DATA
; Frame group: NINA_DEAD_6_F0
NINA_DEAD_6_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_6_F0_DATA
; Frame group: NINA_DEAD_6_F2
NINA_DEAD_6_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_DEAD_6_F2_DATA
; Frame group: NINA_IDLE_RIGHT_7_F0
NINA_IDLE_RIGHT_7_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_IDLE_RIGHT_7_F0_DATA
; Frame group: ANEC_LEFT_8_F0
ANEC_LEFT_8_F0_LAYER1 EQU ZX0_SPRITE_FRAME_ANEC_LEFT_8_F0_DATA
; Frame group: ANEC_LEFT_8_F1
ANEC_LEFT_8_F1_LAYER1 EQU ZX0_SPRITE_FRAME_ANEC_LEFT_8_F1_DATA
; Frame group: NINA_WALK_RIGHT_9_F0
NINA_WALK_RIGHT_9_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F0_DATA
; Frame group: NINA_WALK_RIGHT_9_F1
NINA_WALK_RIGHT_9_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_WALK_RIGHT_9_F1_DATA
; Frame group: NINA_JUMP_RIGHT_10_F0
NINA_JUMP_RIGHT_10_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_10_F0_DATA
; Frame group: NINA_LAND_RIGHT_11_F0
NINA_LAND_RIGHT_11_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F0_DATA
; Frame group: NINA_LAND_RIGHT_11_F1
NINA_LAND_RIGHT_11_F1_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F1_DATA
; Frame group: NINA_LAND_RIGHT_11_F2
NINA_LAND_RIGHT_11_F2_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_LAND_RIGHT_11_F2_DATA
; Frame group: NINA_IDLE_LEFT_12_F0
NINA_IDLE_LEFT_12_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_IDLE_LEFT_12_F0_DATA
