; ==================================================================
; JOC45_CODEX_WALLGRAB_CLIMB - UNIFIED FILE
...
entity_walljump_anim_active EQU #DE1C   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_x_pos        EQU #DE3C   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DE5C   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DE7C   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DE9C   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DEBC   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DEDC   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DEFC   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DF1C   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DF3C   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DF5C   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DF5D   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DF7D   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DF9D   ; Entity health (32 bytes)
entity_anim_frame   EQU #DFBD   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DFDD   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DFFD   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #E01D   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #E03D   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #E05D   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #E07D   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #E09D   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #E0BD   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #E0DD   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #E0FD   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_collectible_enabled EQU #E11D   ; 1 when entity has Collectible component (32 bytes)
entity_carried_by   EQU #E13D   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E15D   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E17D   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E19D   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E1BD   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E1DD   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E1FD   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E21D   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E23D   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E25D   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E27D   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E29D   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E2BD   ; Number of sprites currently active
sprites_dirty      EQU #E2BE   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E2BF   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E2DF   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E2FF   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_layer_y_offsets EQU #E31F   ; HW sprite layer signed Y offsets - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E33F   ; Runtime base 16x16 slot per sprite asset (11 bytes)
sprite_placeholder_base_pattern_num EQU #E34A   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E34B   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E34C   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #E3CC   ; Currently displayed screen ID
screen_dirty_flag   EQU #E3CD   ; Screen needs redraw flag
screen_transition_cooldown EQU #E3CE   ; Cooldown frames after screen transition
current_world_id    EQU #E3CF   ; Current world ID (for multi-world support)
current_screen_index EQU #E3D0   ; Current screen index within world
current_screen_anim_group_count EQU #E3D1   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E3D2   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E3D3   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E3D4   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E3D5   ; Player X position (16-bit)
player_y            EQU #E3D7   ; Player Y position (16-bit)
player_runtime_enabled EQU #E3D9   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E3DA   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E3DB   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E3DC   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E3DD   ; Player health points
player_score        EQU #E3DE   ; Player score (16-bit)
gem_count           EQU #E3E0   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E3E1   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E3E2   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E3E3   ; Interaction type id of last interacted tile
last_interaction_value EQU #E3E4   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E3E5   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E3E6   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E3E7   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E3E8   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E3E9   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E3EA   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E42A   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E46A   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E4AA   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E4EA   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E4FA   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E50A   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E51A   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E52A   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E53A   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E54A   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E54B   ; Temporary 16-bit storage
temp_word_2         EQU #E54D   ; Temporary 16-bit storage
temp_byte_1         EQU #E54F   ; Temporary 8-bit storage
temp_byte_2         EQU #E550   ; Temporary 8-bit storage
temp_byte_3         EQU #E551   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E571   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E591   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E5B1   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E5D1   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E5D2   ; Frames remaining for current SFX
sfx_fadeout         EQU #E5D3   ; Reserved fadeout flag/state
temp_byte_7         EQU #E5D4   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E5F4   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E614   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E634   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E654   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E674   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E694   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E6B4   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E6D4   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E6F4   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E714   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E734   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E754   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E774   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E794   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E7B4   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E7D4   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E7F4   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E814   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E834   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E874   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E8B4   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E8D4   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E8F4   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E914   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E915   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E916   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E917   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E918   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E919   ; Cached entity X for wall checks
wall_temp_y         EQU #E91A   ; Cached entity Y for wall checks
wall_hit_left       EQU #E91B   ; Hitbox left edge cache
wall_hit_top        EQU #E91C   ; Hitbox top edge cache
wall_hit_right      EQU #E91D   ; Hitbox right edge cache
wall_hit_bottom     EQU #E91E   ; Hitbox bottom edge cache
wall_hit_w          EQU #E91F   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E920   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E921   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E922   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E923   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E924   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E925   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E945   ; Number of entries in active_entity_list
hero_entity_id      EQU #E946   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E947   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E948   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E968   ; Number of entries in input_entity_list
render_entity_list  EQU #E969   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E989   ; Number of entries in render_entity_list
collision_entity_list EQU #E98A   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E9AA   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E9AB   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E9CB   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E9CC   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E9EC   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E9ED   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #EA0D   ; Number of entities in coll_list
coll_src_left       EQU #EA0E   ; Source AABB left edge (scratch)
coll_src_right      EQU #EA0F   ; Source AABB right edge (scratch)
coll_src_top        EQU #EA10   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #EA11   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #EA12   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #EA12   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #EA14   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #EA16   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #EA18   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #EA1A   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #EA1C   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #EA1E   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #EA20   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #EA22   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #EA23   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #EA28   ; Frame counter (16-bit)
task_exec_time          EQU #EA2A   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #EA2C   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #EA2D   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #EA2D   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #EA2E   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #EA2F   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #EA30   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #EA31   ; 0=stopped, 1=track active
music_muted          EQU #EA32   ; 0=audible, 1=muted/pause
music_loop           EQU #EA33   ; 0=no loop, 1=loop enabled
music_track_index    EQU #EA34   ; Current ROM track index
music_row_frames     EQU #EA35   ; Frames per tracker row
music_row_countdown  EQU #EA36   ; Countdown to next row
music_order_pos      EQU #EA37   ; Current order position
music_pattern_index  EQU #EA38   ; Current pattern index
music_pattern_row    EQU #EA39   ; Current row inside pattern
music_pattern_rows   EQU #EA3A   ; Cached rows in current pattern
music_track_ptr_l    EQU #EA3B   ; Current track pointer low byte
music_track_ptr_h    EQU #EA3C   ; Current track pointer high byte
music_pattern_ptr_l  EQU #EA3D   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #EA3E   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #EA3F   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #EA40   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #EA40   ; Channel A
music_ch_b_note EQU #EA41   ; Channel B
music_ch_c_note EQU #EA42   ; Channel C
music_ch_instrument_base EQU #EA43   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #EA43   ; Channel A
music_ch_b_instrument EQU #EA44   ; Channel B
music_ch_c_instrument EQU #EA45   ; Channel C
music_ch_ornament_base EQU #EA46   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #EA46   ; Channel A
music_ch_b_ornament EQU #EA47   ; Channel B
music_ch_c_ornament EQU #EA48   ; Channel C
music_ch_volume_base EQU #EA49   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #EA49   ; Channel A
music_ch_b_volume EQU #EA4A   ; Channel B
music_ch_c_volume EQU #EA4B   ; Channel C
music_ch_vol_step_base EQU #EA4C   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #EA4C   ; Channel A
music_ch_b_vol_step EQU #EA4D   ; Channel B
music_ch_c_vol_step EQU #EA4E   ; Channel C
music_ch_tone_step_base EQU #EA4F   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #EA4F   ; Channel A
music_ch_b_tone_step EQU #EA50   ; Channel B
music_ch_c_tone_step EQU #EA51   ; Channel C
music_ch_noise_step_base EQU #EA52   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #EA52   ; Channel A
music_ch_b_noise_step EQU #EA53   ; Channel B
music_ch_c_noise_step EQU #EA54   ; Channel C
music_ch_orn_step_base EQU #EA55   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #EA55   ; Channel A
music_ch_b_orn_step EQU #EA56   ; Channel B
music_ch_c_orn_step EQU #EA57   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #EA58   ; End of project variables (10840 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#EA58: Project variables (10840 bytes)
;   #EA58-#F37F: Free RAM (~2344 bytes available)
