; ==================================================================
; TRACKER_MINI_SONG_TEST - UNIFIED FILE
...
; BANK 02 @#0000 : sound.asm part 3/2 (790 bytes)
; BANK 02 @#0316 : scroll.asm (2407 bytes)
; BANK 02 @#0C7D : animtiles.asm (2549 bytes)
; BANK 02 @#1672 : bosses.asm (2446 bytes)
; BANK 03 @#0000 : bosses.asm (3336 bytes)
; BANK 03 @#0D08 : statemachine.asm (5 bytes)
; BANK 03 @#0D0D : gameflow.asm (453 bytes)
...
music_track_ptr_table:
    DW music_track_0_MSX_Mini_Etude_data

; ------------------------------------------------------------------
; Tracker Song 0: MSX Mini Etude
; ------------------------------------------------------------------
music_track_0_MSX_Mini_Etude_data:
    DB #06
    DB #04
    DB #00
    DB #01
    DB #01
    DW music_track_0_MSX_Mini_Etude_order_table
    DW music_track_0_MSX_Mini_Etude_pattern_table
    DW music_track_0_MSX_Mini_Etude_instrument_ptr_table
    DW music_track_0_MSX_Mini_Etude_ornament_ptr_table
    DW #00D2
    DB #10

music_track_0_MSX_Mini_Etude_order_table:
    DB #00,#00,#00,#00

music_track_0_MSX_Mini_Etude_pattern_table:
    DW music_track_0_MSX_Mini_Etude_pattern_0_rows
    DB #10

music_track_0_MSX_Mini_Etude_instrument_ptr_table:
    DW 0
    DW music_track_0_MSX_Mini_Etude_inst_1
    DW music_track_0_MSX_Mini_Etude_inst_2
    DW music_track_0_MSX_Mini_Etude_inst_3
    DW music_track_0_MSX_Mini_Etude_inst_4
    DW music_track_0_MSX_Mini_Etude_inst_5
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_MSX_Mini_Etude_ornament_ptr_table:
    DW 0
    DW music_track_0_MSX_Mini_Etude_orn_1
    DW music_track_0_MSX_Mini_Etude_orn_2
    DW music_track_0_MSX_Mini_Etude_orn_3
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_MSX_Mini_Etude_pattern_0_rows:
    DB #3C,#01,#01,#0E,#24,#02,#FF,#0D,#18,#03,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FE,#FF,#FF,#FF
    DB #40,#01,#01,#0E,#FF,#FF,#FF,#FF,#24,#05,#FF,#0A
    DB #43,#01,#03,#0D,#1F,#02,#FF,#0D,#FE,#FF,#FF,#FF
    DB #45,#01,#02,#0E,#21,#02,#FF,#0D,#24,#04,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FE,#FF,#FF,#FF
    DB #43,#01,#01,#0D,#FF,#FF,#FF,#FF,#24,#05,#FF,#09
    DB #40,#01,#FF,#0C,#1F,#02,#FF,#0C,#FE,#FF,#FF,#FF
    DB #3E,#01,#02,#0E,#1D,#02,#FF,#0D,#18,#03,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FE,#FF,#FF,#FF
    DB #41,#01,#02,#0D,#FF,#FF,#FF,#FF,#24,#05,#FF,#0A
    DB #45,#01,#03,#0D,#21,#02,#FF,#0D,#FE,#FF,#FF,#FF
    DB #43,#01,#01,#0E,#1F,#02,#FF,#0D,#24,#04,#FF,#0E
    DB #40,#01,#FF,#0C,#FF,#FF,#FF,#FF,#FE,#FF,#FF,#FF
    DB #3E,#01,#FF,#0C,#1F,#02,#FF,#0C,#24,#05,#FF,#09
    DB #3C,#01,#01,#0E,#24,#02,#FF,#0D,#FE,#FF,#FF,#FF

music_track_0_MSX_Mini_Etude_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_MSX_Mini_Etude_inst_1_vol_env
    DB #08
    DB #04
    DW music_track_0_MSX_Mini_Etude_inst_1_tone_env
    DB #08
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_0_MSX_Mini_Etude_inst_1_vol_env:
    DB #0F,#0E,#0D,#0C,#0B,#0A,#09,#08
music_track_0_MSX_Mini_Etude_inst_1_tone_env:
    DB #00,#01,#02,#01,#00,#FF,#FE,#FF

music_track_0_MSX_Mini_Etude_inst_2:
    DB #01
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_MSX_Mini_Etude_inst_2_vol_env
    DB #06
    DB #03
    DW music_track_0_MSX_Mini_Etude_inst_2_tone_env
    DB #04
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_MSX_Mini_Etude_inst_2_vol_env:
    DB #0F,#0E,#0D,#0C,#0B,#0A
music_track_0_MSX_Mini_Etude_inst_2_tone_env:
    DB #F4,#F9,#00,#00

music_track_0_MSX_Mini_Etude_inst_3:
    DB #03
    DB #0F
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_MSX_Mini_Etude_inst_3_vol_env
    DB #06
    DB #FF
    DW music_track_0_MSX_Mini_Etude_inst_3_tone_env
    DB #06
    DB #FF
    DW music_track_0_MSX_Mini_Etude_inst_3_noise_env
    DB #06
    DB #FF
music_track_0_MSX_Mini_Etude_inst_3_vol_env:
    DB #0F,#0F,#0C,#08,#04,#00
music_track_0_MSX_Mini_Etude_inst_3_tone_env:
    DB #E2,#E8,#EF,#F6,#FB,#00
music_track_0_MSX_Mini_Etude_inst_3_noise_env:
    DB #01,#02,#04,#08,#10,#1F

music_track_0_MSX_Mini_Etude_inst_4:
    DB #03
    DB #0F
    DB #00
    DB #03
    DW #00D2
    DW music_track_0_MSX_Mini_Etude_inst_4_vol_env
    DB #06
    DB #FF
    DW music_track_0_MSX_Mini_Etude_inst_4_tone_env
    DB #04
    DB #FF
    DW music_track_0_MSX_Mini_Etude_inst_4_noise_env
    DB #07
    DB #FF
music_track_0_MSX_Mini_Etude_inst_4_vol_env:
    DB #0F,#0D,#0A,#07,#03,#00
music_track_0_MSX_Mini_Etude_inst_4_tone_env:
    DB #07,#04,#02,#00
music_track_0_MSX_Mini_Etude_inst_4_noise_env:
    DB #03,#05,#08,#0C,#12,#18,#1F

music_track_0_MSX_Mini_Etude_inst_5:
    DB #02
    DB #0C
    DB #00
    DB #01
    DW #00D2
    DW music_track_0_MSX_Mini_Etude_inst_5_vol_env
    DB #04
    DB #FF
    DW music_track_0_MSX_Mini_Etude_inst_5_tone_env
    DB #01
    DB #FF
    DW music_track_0_MSX_Mini_Etude_inst_5_noise_env
    DB #07
    DB #FF
music_track_0_MSX_Mini_Etude_inst_5_vol_env:
    DB #0C,#08,#04,#00
music_track_0_MSX_Mini_Etude_inst_5_tone_env:
    DB #00
music_track_0_MSX_Mini_Etude_inst_5_noise_env:
    DB #01,#01,#02,#04,#08,#10,#1F

music_track_0_MSX_Mini_Etude_orn_1:
    DW music_track_0_MSX_Mini_Etude_orn_1_data
    DB #04
    DB #00
music_track_0_MSX_Mini_Etude_orn_1_data:
    DB #00,#04,#07,#04

music_track_0_MSX_Mini_Etude_orn_2:
    DW music_track_0_MSX_Mini_Etude_orn_2_data
    DB #04
    DB #00
music_track_0_MSX_Mini_Etude_orn_2_data:
    DB #00,#03,#07,#03

music_track_0_MSX_Mini_Etude_orn_3:
    DW music_track_0_MSX_Mini_Etude_orn_3_data
    DB #04
    DB #00
music_track_0_MSX_Mini_Etude_orn_3_data:
    DB #00,#07,#00,#0C
