...
; BANK 05 @#0000 : screens.asm part 4/4 (5391 bytes)
; BANK 05 @#150F : sprites.asm part 1/2 (2801 bytes)
; BANK 06 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 07 @#0000 : sprites.asm part 3/2 (75 bytes)
; BANK 07 @#004B : font.asm (177 bytes)
; BANK 07 @#00FC : hud.asm (114 bytes)
; BANK 07 @#016E : menus.asm (219 bytes)
; BANK 07 @#0249 : sound.asm (4769 bytes)
; BANK 07 @#14EA : scroll.asm (2389 bytes)
; BANK 07 @#1E3F : animtiles.asm (449 bytes)
; BANK 08 @#0000 : animtiles.asm (2137 bytes)
; BANK 08 @#0859 : bosses.asm (331 bytes)
; BANK 08 @#09A4 : statemachine.asm part 1/2 (5724 bytes)
; BANK 09 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 10 @#0000 : statemachine.asm part 3/2 (1760 bytes)
; BANK 10 @#06E0 : gameflow.asm (5586 bytes)
...
SCREEN_PANTALLA2_1_BEHAVIOR_SOURCE EQU 0
BEHAVIOR_PANTALLA2_1_DATA_BANK EQU ((BEHAVIOR_PANTALLA2_1_DATA - #4000) / #2000)
SCREEN_PANTALLA2_1_CHAR_BEHAVIOR_TABLE_BANK EQU 0
SCREEN_PANTALLA2_1_CHAR_BEHAVIOR_TABLE_SIZE EQU 0
...
SCREEN_PANTALLA3_2_BEHAVIOR_SOURCE EQU 0
BEHAVIOR_PANTALLA3_2_DATA_BANK EQU ((BEHAVIOR_PANTALLA3_2_DATA - #4000) / #2000)
SCREEN_PANTALLA3_2_CHAR_BEHAVIOR_TABLE_BANK EQU 0
SCREEN_PANTALLA3_2_CHAR_BEHAVIOR_TABLE_SIZE EQU 0
