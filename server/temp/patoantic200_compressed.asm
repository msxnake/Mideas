...
SCREEN_PAN4_4_LAYOUT:
    ; ZX0 compressed layout (768 -> 135 bytes)
    ...
    DB #4F,#FC,#F5,#80,#A3,#8D,#25,#40,#7C,#BB,#C4,#00,#A6,#00,#90,#80
    DB #79,#8C,#C8,#C0,#F5,#80,#3C,#C6,#1B,#81,#D3,#81,#06,#12,#9D,#82
    DB #34,#00,#36,#26,#D5,#55,#60
...
BEHAVIOR_PAN4_4_DATA:
    ...
    DB #00,#5B,#04,#BC,#FF,#10,#C0,#5F,#FE,#CC,#C0,#13,#5C,#02,#1E,#C0
    DB #04,#A5,#08,#0D,#35,#48,#3D,#C0,#5F,#FE,#57,#55,#55,#80
