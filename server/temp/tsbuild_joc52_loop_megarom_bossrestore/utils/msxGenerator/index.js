...
function generateModularASM(projectName, assets, config = {}) {
    ...
    const files = {
        ...
        'statemachine.asm': analysis.stateMachines && analysis.stateMachines.length > 0
            ? (0, stateMachineGenerator_1.generateStateMachineSystem)(analysis.stateMachines, analysis.globalVariables, analysis.sprites, analysis.tiles, analysis.templates, analysis.sounds, analysis.trackIndexByAssetId, romMode, targetFormat)
            : '; No State Machines\n',
