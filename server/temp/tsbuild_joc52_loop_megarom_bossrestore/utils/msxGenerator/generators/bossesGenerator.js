...
restore_active_boss_tiles:
    ...
    or a
    jp z, .rabt_done
    ld a, (boss_prev_width)
    or a
    jp z, .rabt_done
    ld a, (boss_prev_height)
    or a
    jp z, .rabt_done
...
`;
    ...
    lines.push(`    ld (boss_prev_width), a`);
    lines.push(`    ld (boss_prev_height), a`);
    ...
    lines.push(`; Register Contract:`);
    lines.push(`; input: none`);
    lines.push(`; output: boss_runtime_tick increments; active boss behavior is stepped and previous footprint is restored before redraw`);
    ...
    lines.push(`    call restore_active_boss_tiles`);
    ...
    lines.push(`    ld a, (boss_width)`);
    lines.push(`    ld (boss_prev_width), a`);
    lines.push(`    ld a, (boss_height)`);
    lines.push(`    ld (boss_prev_height), a`);
    lines.push(`.ubs_done:`);
    lines.push(`    pop ix`);
    lines.push(`    ret`);
