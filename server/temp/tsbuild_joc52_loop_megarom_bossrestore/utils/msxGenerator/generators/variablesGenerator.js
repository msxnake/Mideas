...
`;
    ...
    currentAddress++;
    code += `boss_prev_width     EQU #${currentAddress.toString(16).toUpperCase().padStart(4, '0')}   ; Previous boss width in chars for redraw restore\n`;
    currentAddress++;
    code += `boss_prev_height    EQU #${currentAddress.toString(16).toUpperCase().padStart(4, '0')}   ; Previous boss height in chars for redraw restore\n`;
    currentAddress++;
