...
; Estimated payload bytes: 104914
...
; BANK 09 @#0000 : bosses.asm part 2/2 (3184 bytes)
; BANK 09 @#0C70 : statemachine.asm part 1/3 (5008 bytes)
; BANK 10 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : statemachine.asm part 3/3 (8176 bytes)
; BANK 11 @#1FF0 : gameflow.asm (16 bytes)
; BANK 12 @#0000 : gameflow.asm (6610 bytes)
...
boss_1_mono1_phase_0_behavior:
    db #05, #71, #00    ; count,totalLo,totalHi
    db #00, #1E, #00, #00, #00, #FF, #00, #00
