...
; Estimated payload bytes: 49055
; Estimated banks used: 6
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (3472 bytes)
; BANK 00 @#0DF0 : colors.asm (3054 bytes)
; BANK 00 @#19DE : components.asm (22 bytes)
; BANK 00 @#19F4 : entities.asm (1548 bytes)
; BANK 01 @#0000 : entities.asm (2653 bytes)
; BANK 01 @#0A5D : worlds.asm (1826 bytes)
; BANK 01 @#117F : screens.asm part 1/2 (3713 bytes)
; BANK 02 @#0000 : screens.asm part 2/2 (7476 bytes)
; BANK 02 @#1D34 : sprites.asm (716 bytes)
; BANK 03 @#0000 : sprites.asm (2467 bytes)
; BANK 03 @#09A3 : font.asm (177 bytes)
; BANK 03 @#0A54 : hud.asm (79 bytes)
; BANK 03 @#0AA3 : menus.asm (168 bytes)
; BANK 03 @#0B4B : sound.asm (4411 bytes)
; BANK 03 @#1C86 : scroll.asm (890 bytes)
; BANK 04 @#0000 : scroll.asm (1452 bytes)
; BANK 04 @#05AC : animtiles.asm (2507 bytes)
; BANK 04 @#0F77 : bosses.asm (4233 bytes)
; BANK 05 @#0000 : bosses.asm (2773 bytes)
; BANK 05 @#0AD5 : statemachine.asm (5 bytes)
; BANK 05 @#0ADA : gameflow.asm (5317 bytes)
...
; Flow: Start → WorldLink (gfn_1777737813861)
; ==================================================================
...
; Tile 0: boss_pitagoras_single_B0_000 = 8x8px (1x1 MSX chars)
; Tile 1: boss_pitagoras_single_B0_001 = 8x8px (1x1 MSX chars)
; Tile 2: boss_pitagoras_single_B0_002 = 8x8px (1x1 MSX chars)
; Tile 3: boss_pitagoras_single_B0_003 = 8x8px (1x1 MSX chars)
; Tile 4: boss_pitagoras_single_B0_004 = 8x8px (1x1 MSX chars)
; Tile 5: boss_pitagoras_single_B0_005 = 8x8px (1x1 MSX chars)
; Tile 6: boss_pitagoras_single_B0_006 = 8x8px (1x1 MSX chars)
; Tile 7: boss_pitagoras_single_B0_007 = 8x8px (1x1 MSX chars)
; Tile 8: boss_pitagoras_single_B0_008 = 8x8px (1x1 MSX chars)
; Tile 9: boss_pitagoras_single_B0_009 = 8x8px (1x1 MSX chars)
; Tile 10: boss_pitagoras_single_B0_010 = 8x8px (1x1 MSX chars)
; Tile 11: boss_pitagoras_single_B0_011 = 8x8px (1x1 MSX chars)
; Tile 12: boss_pitagoras_single_B0_012 = 8x8px (1x1 MSX chars)
; Tile 13: boss_pitagoras_single_B0_013 = 8x8px (1x1 MSX chars)
; Tile 14: boss_pitagoras_single_B0_014 = 8x8px (1x1 MSX chars)
; Tile 15: boss_pitagoras_single_B0_015 = 8x8px (1x1 MSX chars)
; Tile 16: boss_pitagoras_single_B0_016 = 8x8px (1x1 MSX chars)
; Tile 17: boss_pitagoras_single_B0_017 = 8x8px (1x1 MSX chars)
; Tile 18: boss_pitagoras_single_B0_018 = 8x8px (1x1 MSX chars)
; Tile 19: boss_pitagoras_single_B0_019 = 8x8px (1x1 MSX chars)
; Tile 20: boss_pitagoras_single_B0_020 = 8x8px (1x1 MSX chars)
; Tile 21: boss_pitagoras_single_B0_021 = 8x8px (1x1 MSX chars)
; Tile 22: boss_pitagoras_single_B0_022 = 8x8px (1x1 MSX chars)
; Tile 23: boss_pitagoras_single_B0_023 = 8x8px (1x1 MSX chars)
; Tile 24: boss_pitagoras_single_B0_024 = 8x8px (1x1 MSX chars)
; Tile 25: boss_pitagoras_single_B0_025 = 8x8px (1x1 MSX chars)
; Tile 26: boss_pitagoras_single_B0_026 = 8x8px (1x1 MSX chars)
; Tile 27: boss_pitagoras_single_B0_027 = 8x8px (1x1 MSX chars)
; Tile 28: boss_pitagoras_single_B0_028 = 8x8px (1x1 MSX chars)
; Tile 29: boss_pitagoras_single_B0_029 = 8x8px (1x1 MSX chars)
; Tile 30: boss_pitagoras_single_B0_030 = 8x8px (1x1 MSX chars)
; Tile 31: boss_pitagoras_single_B0_031 = 8x8px (1x1 MSX chars)
; Tile 32: boss_pitagoras_single_B0_032 = 8x8px (1x1 MSX chars)
; Tile 33: boss_pitagoras_single_B0_033 = 8x8px (1x1 MSX chars)
; Tile 34: boss_pitagoras_single_B0_034 = 8x8px (1x1 MSX chars)
; Tile 35: boss_pitagoras_single_B1_000 = 8x8px (1x1 MSX chars)
; Tile 36: boss_pitagoras_single_B1_001 = 8x8px (1x1 MSX chars)
; Tile 37: boss_pitagoras_single_B1_002 = 8x8px (1x1 MSX chars)
; Tile 38: boss_pitagoras_single_B1_003 = 8x8px (1x1 MSX chars)
; Tile 39: boss_pitagoras_single_B1_004 = 8x8px (1x1 MSX chars)
; Tile 40: boss_pitagoras_single_B1_005 = 8x8px (1x1 MSX chars)
; Tile 41: boss_pitagoras_single_B1_006 = 8x8px (1x1 MSX chars)
; Tile 42: boss_pitagoras_single_B1_007 = 8x8px (1x1 MSX chars)
; Tile 43: boss_pitagoras_single_B1_008 = 8x8px (1x1 MSX chars)
; Tile 44: boss_pitagoras_single_B1_009 = 8x8px (1x1 MSX chars)
; Tile 45: boss_pitagoras_single_B1_010 = 8x8px (1x1 MSX chars)
; Tile 46: boss_pitagoras_single_B1_011 = 8x8px (1x1 MSX chars)
; Tile 47: boss_pitagoras_single_B1_012 = 8x8px (1x1 MSX chars)
; Tile 48: boss_pitagoras_single_B1_013 = 8x8px (1x1 MSX chars)
; Tile 49: boss_pitagoras_single_B1_014 = 8x8px (1x1 MSX chars)
; Tile 50: boss_pitagoras_single_B1_015 = 8x8px (1x1 MSX chars)
; Tile 51: boss_pitagoras_single_B1_016 = 8x8px (1x1 MSX chars)
; Tile 52: boss_pitagoras_single_B1_017 = 8x8px (1x1 MSX chars)
; Tile 53: boss_pitagoras_single_B1_018 = 8x8px (1x1 MSX chars)
; Tile 54: boss_pitagoras_single_B1_019 = 8x8px (1x1 MSX chars)
; Tile 55: boss_pitagoras_single_B1_020 = 8x8px (1x1 MSX chars)
; Tile 56: boss_pitagoras_single_B1_021 = 8x8px (1x1 MSX chars)
; Tile 57: boss_pitagoras_single_B1_022 = 8x8px (1x1 MSX chars)
; Tile 58: boss_pitagoras_single_B1_023 = 8x8px (1x1 MSX chars)
; Tile 59: boss_pitagoras_single_B1_024 = 8x8px (1x1 MSX chars)
; Tile 60: boss_pitagoras_single_B1_025 = 8x8px (1x1 MSX chars)
; Tile 61: boss_pitagoras_single_B1_026 = 8x8px (1x1 MSX chars)
; Tile 62: boss_pitagoras_single_B1_027 = 8x8px (1x1 MSX chars)
; Tile 63: boss_pitagoras_single_B1_028 = 8x8px (1x1 MSX chars)
; Tile 64: boss_pitagoras_single_B1_029 = 8x8px (1x1 MSX chars)
; Tile 65: boss_pitagoras_single_B1_030 = 8x8px (1x1 MSX chars)
; Tile 66: boss_pitagoras_single_B1_031 = 8x8px (1x1 MSX chars)
; Tile 67: boss_pitagoras_single_B1_032 = 8x8px (1x1 MSX chars)
; Tile 68: boss_pitagoras_single_B1_033 = 8x8px (1x1 MSX chars)
; Tile 69: boss_pitagoras_single_B1_034 = 8x8px (1x1 MSX chars)
; Tile 70: boss_pitagoras_single_B1_035 = 8x8px (1x1 MSX chars)
; Tile 71: boss_pitagoras_single_B1_036 = 8x8px (1x1 MSX chars)
; Tile 72: boss_pitagoras_single_B1_037 = 8x8px (1x1 MSX chars)
; Tile 73: boss_pitagoras_single_B1_038 = 8x8px (1x1 MSX chars)
...
SCREEN2_TILEBANK_TILEBANK_1777737788780_ID EQU 0
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (592 -> 457 bytes)
    DB #94,#00,#BC,#06,#F0,#A1,#EC,#B8,#01,#FF,#12,#0F,#1F,#3F,#7E,#70
    DB #C1,#87,#0E,#FE,#34,#BF,#34,#77,#70,#CF,#CB,#00,#80,#39,#BA,#F8
    DB #C9,#89,#12,#02,#04,#18,#70,#78,#78,#F0,#A8,#31,#B1,#D0,#D9,#5F
    DB #ED,#F6,#D9,#FC,#D5,#69,#80,#38,#85,#42,#07,#06,#09,#01,#04,#F4
    DB #7C,#CE,#E0,#19,#C1,#C0,#0B,#7F,#E8,#3F,#1F,#8F,#8F,#05,#2E,#C0
    DB #FA,#E3,#FF,#03,#07,#E4,#FC,#4D,#07,#1F,#F8,#E0,#C6,#CE,#8E,#1E
    DB #DC,#BC,#03,#03,#08,#C0,#E0,#F0,#F8,#FC,#C0,#80,#00,#03,#1C,#71
    DB #CE,#1F,#84,#F9,#99,#C0,#40,#40,#60,#20,#A0,#0F,#06,#05,#0D,#0E
    DB #1F,#3C,#FC,#7A,#FB,#F3,#F7,#F7,#EF,#FC,#FC,#F8,#FF,#A6,#70,#91
    DB #3F,#7F,#21,#A2,#73,#4A,#8E,#FE,#A0,#B0,#D0,#26,#F8,#E8,#17,#8A
    DB #3E,#2F,#58,#25,#27,#2F,#EF,#D0,#8F,#0F,#E1,#F9,#68,#C0,#F0,#FC
    DB #50,#F8,#26,#10,#9F,#FB,#06,#0E,#DA,#FC,#B0,#59,#D8,#28,#E0,#20
    DB #E1,#0F,#6E,#2E,#65,#AF,#D8,#44,#05,#87,#C3,#C0,#EF,#A7,#A0,#E0
    DB #7F,#F6,#F2,#B7,#D0,#14,#86,#10,#60,#D0,#A0,#C0,#0D,#BD,#3E,#FE
    DB #6A,#01,#A5,#09,#A6,#41,#49,#DD,#DC,#05,#BF,#E0,#C0,#E8,#C4,#86
    DB #EC,#C8,#05,#37,#3F,#67,#7F,#3F,#00,#6F,#00,#FB,#FA,#FF,#BD,#FD
    DB #03,#64,#78,#28,#7D,#39,#7C,#7D,#FD,#60,#FC,#E8,#E8,#E9,#E1,#E3
    DB #FF,#68,#E7,#3F,#BF,#9F,#DE,#A9,#CE,#FE,#5C,#9A,#5E,#5A,#42,#BB
    DB #03,#B4,#6B,#0A,#7D,#78,#75,#97,#1E,#30,#7C,#38,#EF,#E7,#EF,#EF
    DB #CF,#EF,#FF,#21,#90,#FE,#82,#03,#1E,#43,#03,#20,#A2,#07,#87,#9F
    DB #03,#02,#06,#08,#60,#7C,#79,#60,#F1,#70,#A2,#CF,#28,#8F,#1F,#A8
    DB #3F,#03,#FD,#A2,#27,#86,#DF,#35,#DE,#DC,#8A,#8E,#80,#61,#E7,#0C
    DB #04,#02,#02,#10,#FF,#70,#60,#0B,#6F,#EE,#FF,#29,#C0,#3B,#E2,#E4
    DB #C8,#89,#11,#67,#A5,#F9,#86,#FF,#FB,#78,#D8,#C2,#C6,#25,#F8,#BF
    DB #D9,#7F,#40,#00,#40,#C0,#F9,#FF,#19,#03,#13,#17,#27,#0F,#3B,#67
    DB #C5,#FE,#86,#FC,#FD,#FC,#F0,#F1,#96,#FB,#F3,#E3,#93,#73,#F0,#26
    DB #22,#99,#F7,#26,#77,#10,#00,#4A,#0F,#8F,#04,#10,#E9,#9C,#9D,#C4
    DB #1C,#0C,#E1,#BA,#88,#07,#F3,#F1,#F3,#80,#62,#00,#C0,#77,#F6,#E0
    DB #20,#08,#13,#2B,#C0,#CD,#9E,#55,#56
load_pattern_bank0:
    ...
    ld bc, 592    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 592    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
; ==================================================================
; SCREEN 2 TILEBANK PATTERN DATA (tilebank_1777737788780)
; ==================================================================

load_tilebank_tilebank_1777737788780_patterns_to_vram:
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (592 -> 277 bytes)
    DB #94,#21,#BC,#E1,#F0,#23,#41,#E1,#9E,#FD,#A1,#A1,#E1,#FE,#E9,#F3
    DB #EB,#BF,#E9,#E9,#CD,#BC,#F8,#C6,#EF,#B2,#F7,#AB,#C4,#C1,#AE,#F0
    DB #91,#FF,#3E,#E1,#EB,#FD,#88,#A4,#91,#FA,#FD,#FE,#62,#C1,#81,#41
    DB #1F,#C4,#51,#21,#C1,#FE,#7F,#FB,#8F,#66,#B1,#A6,#F9,#A1,#FF,#C1
    DB #CB,#FE,#AE,#C5,#C1,#FF,#EF,#E4,#7C,#6A,#FE,#CF,#CD,#3D,#BB,#91
    DB #68,#FF,#7F,#B9,#F5,#FB,#FE,#C1,#B6,#FF,#97,#E1,#FF,#82,#F0,#E5
    DB #C8,#E3,#A8,#B9,#A8,#BA,#91,#81,#91,#AE,#F8,#B8,#B0,#B7,#CA,#9E
    DB #64,#FF,#B1,#FA,#BA,#EB,#FE,#EB,#C3,#FE,#62,#D6,#8A,#81,#21,#6E
    DB #51,#60,#EF,#1B,#E1,#53,#EB,#17,#FA,#EA,#DD,#AD,#60,#FF,#FE,#EE
    DB #EF,#F4,#FE,#5F,#9C,#FB,#FF,#F4,#63,#94,#6D,#1C,#CF,#A4,#FB,#F0
    DB #CB,#FE,#BA,#C1,#BD,#C4,#6F,#EC,#48,#B6,#21,#A1,#87,#E4,#F7,#B5
    DB #FD,#78,#88,#51,#51,#FE,#B8,#AE,#7F,#BF,#F9,#F6,#74,#4E,#6A,#FA
    DB #FB,#B4,#63,#FF,#EB,#E7,#DD,#DA,#F7,#C7,#5A,#FA,#B6,#D7,#CA,#7E
    DB #6F,#FF,#BF,#EB,#B4,#FF,#FF,#B2,#FE,#D9,#C2,#FC,#FB,#52,#EA,#5E
    DB #51,#1F,#AA,#E3,#FE,#F3,#F1,#E2,#AF,#EF,#B1,#E5,#D9,#AB,#34,#FF
    DB #D4,#CE,#3B,#20,#F6,#F7,#EA,#F8,#FE,#FF,#9A,#CD,#F8,#FE,#B8,#98
    DB #FC,#F0,#BE,#7C,#FF,#B6,#FF,#CA,#F1,#EB,#AB,#F3,#91,#37,#BE,#F3
    DB #EF,#9E,#55,#55,#80
load_color_bank0:
    ...
    ld bc, 592     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
; ==================================================================
; SCREEN 2 TILEBANK COLOR DATA (tilebank_1777737788780)
; ==================================================================

load_tilebank_tilebank_1777737788780_colors_to_vram:
    ret
...
load_sprite_patterns:
    call load_sprite_patterns_worldmap_1777737804996
    ret
...
world_sprite_pattern_pack_table:
    db SPRITE_PATTERN_PACK_WORLDMAP_1777737804996_ID ; World 0: New Worldmap

; ------------------------------------------------------------------
; Runtime Sprite Pattern Pack: World "New Worldmap"
; Slots required: 3/64
; ------------------------------------------------------------------
SPRITE_PATTERN_PACK_WORLDMAP_1777737804996_ID EQU 0

sprite_asset_base_pattern_slot_worldmap_1777737804996:
    db 0 ; Sprite 0: New Sprite

load_sprite_patterns_worldmap_1777737804996:
    ld hl, sprite_asset_base_pattern_slot_worldmap_1777737804996
    ld de, sprite_asset_base_pattern_slot_runtime
    ld bc, SPRITE_ASSET_COUNT
    ldir
    ld a, 8
    ld (sprite_placeholder_base_pattern_num), a
    ; Sprite Asset 0: New Sprite frame 0 (2 layers)
    ...
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ld a, SPRITE_PATTERN_PACK_WORLDMAP_1777737804996_ID
    ld (current_sprite_pattern_pack_id), a
    ret


ensure_sprite_patterns_worldmap_1777737804996:
    ld a, (current_sprite_pattern_pack_id)
    cp SPRITE_PATTERN_PACK_WORLDMAP_1777737804996_ID
    ret z
    jp load_sprite_patterns_worldmap_1777737804996
...
load_sprite_patterns_by_pack_id:
    ...
    ret z
    cp SPRITE_PATTERN_PACK_WORLDMAP_1777737804996_ID
    jp z, load_sprite_patterns_worldmap_1777737804996
    ret
...
ensure_sprite_patterns_by_pack_id:
    ...
    ret z
    cp SPRITE_PATTERN_PACK_WORLDMAP_1777737804996_ID
    jp z, ensure_sprite_patterns_worldmap_1777737804996
    ret
...
SCREEN_NEW_PLAYABLE_SCREEN_0_SPRITE_PATTERN_SLOTS EQU 3
...
screen_runtime_summary_table:
    db 0, 1, 3, #04    ; Screen 0: New Playable Screen
...
SCREEN_NEW_PLAYABLE_SCREEN_0_BOSS_TABLE:
    ...
    db 15, 9, 0, 1, 1, 100, 0    ; xChar,yChar,initialPhase,flags,updateEveryNFrames,healthLo,healthHi
...
load_screen_new_playable_screen_777737800094:
    ...
    cp SCREEN2_TILEBANK_TILEBANK_1777737788780_ID
    jr z, .load_new_playable_screen_777737800094_tilebank_ready
    call load_tilebank_tilebank_1777737788780_patterns_to_vram
    call load_tilebank_tilebank_1777737788780_colors_to_vram
    ld a, SCREEN2_TILEBANK_TILEBANK_1777737788780_ID
    ld (current_screen2_tilebank_id), a
    xor a
    ld (vram_cache_font_ready), a
    call init_font_system
.load_new_playable_screen_777737800094_tilebank_ready:
    ...
    or a
    jr z, .load_new_playable_screen_777737800094_zones_done
    ld hl, SCREEN_NEW_PLAYABLE_SCREEN_0_EFFECT_ZONE_TABLE
    ld de, runtime_effect_zone_table
    ld bc, 0
    ldir
.load_new_playable_screen_777737800094_zones_done:
    ...
    or a
    jp z, load_new_playable_screen_777737800094_boss_done
...
load_new_playable_screen_777737800094_boss_done:
...
ENTITY_PLAYER_DEFAULT_1_X EQU 12
...
init_player_default_1:
    ...
    ; JSON position: (12, 12) tiles = (96, 96) pixels
    ; Template: tpl_player_default
...
boss_0_new_boss_phase_0:
    db #00, #00, #06, #0F    ; healthThreshold,buildType,width,height
...
boss_0_new_boss_phase_0_tiles:
    db #80, #80, #81, #82, #80, #80, #80, #83, #84, #85, #86, #80, #80, #87, #88, #89
    db #8A, #80, #80, #8B, #8C, #8D, #8E, #80, #80, #8F, #90, #91, #92, #93, #80, #94
    db #95, #96, #97, #98, #80, #99, #9A, #9B, #9C, #9D, #80, #9E, #9F, #A0, #A1, #A2
    db #A4, #A5, #A6, #A7, #A8, #A3, #A9, #AA, #AB, #AC, #AD, #A3, #AE, #AF, #B0, #B1
    db #B2, #A3, #B3, #B4, #B5, #B6, #B7, #B8, #B9, #BA, #BB, #BC, #BD, #A3, #BE, #BF
    db #C0, #C1, #C2, #A3, #C3, #C4, #C5, #C6, #C7, #C8
...
; Total Nodes: 3
; Total Connections: 2
; Start Node: gf_start_1777737807420
;
; ARCHITECTURE:
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_start_1777737807420
...
; Node: Start - "gf_start_1777737807420"
gameflow_node_gf_start_1777737807420:
    db NODE_TYPE_START
    dw gameflow_node_gf_start_1777737807420_data
    dw gameflow_node_gf_start_1777737807420_conn

gameflow_node_gf_start_1777737807420_data:
    dw gameflow_node_gf_start_1777737807420_init    ; Initialization routine address
    db ((gameflow_node_gf_start_1777737807420_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_start_1777737807420_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1777737813861
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_start_1777737807420_init
...
; Node: WorldLink - "gfn_1777737813861"
gameflow_node_gfn_1777737813861:
    db NODE_TYPE_WORLD_LINK
    dw gameflow_node_gfn_1777737813861_data
    dw gameflow_node_gfn_1777737813861_conn

gameflow_node_gfn_1777737813861_data:
    dw load_world_worldmap_1777737804996
    db ((load_world_worldmap_1777737804996 - #4000) / #2000)
    dw gameflow_node_gfn_1777737813861_init
    db ((gameflow_node_gfn_1777737813861_init - #4000) / #2000)

gameflow_node_gfn_1777737813861_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1777737819603
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gfn_1777737813861_init
...
; Node: End - "gfn_1777737819603"
gameflow_node_gfn_1777737819603:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gfn_1777737819603_conn

gameflow_node_gfn_1777737819603_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
...
; World: New Worldmap (worldmap_1777737804996)
...
; World ID: worldmap_1777737804996
; Screens: 1
; Start Screen Node: wmnode_1777737833691
; ------------------------------------------------------------------
load_world_worldmap_1777737804996:
    ...
    ; Load start screen: New Playable Screen (screenmap_1777737800094)
    ld a, ((load_screen_new_playable_screen_777737800094 - #4000) / #2000)
    ld hl, load_screen_new_playable_screen_777737800094
    call mapper_call_hl_auto
...
; ------------------------------------------------------------------
load_world_default:
    jp load_world_worldmap_1777737804996
...
.dispatch_world:
    ...
    jp z, check_transition_world_worldmap_1777737804996
    ret

check_transition_world_worldmap_1777737804996:
    ret
...
ZX0_SPRITE_FRAME_NEW_SPRITE_0_F0_DATA:
    ; ZX0 compressed sprite frame NEW_SPRITE_0_F0 (64 -> 52 bytes)
    DB #98,#00,#26,#03,#1E,#1F,#3F,#0A,#37,#1F,#07,#01,#9A,#00,#E0,#99
    DB #F8,#E8,#F8,#AA,#F0,#C0,#A2,#00,#19,#07,#3C,#21,#60,#40,#92,#48
    DB #60,#38,#0E,#02,#00,#24,#98,#F0,#10,#1C,#04,#14,#04,#35,#0C,#08
    DB #38,#20,#55,#58
