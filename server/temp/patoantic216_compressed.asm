...
; Estimated payload bytes: 117590
; Estimated banks used: 15
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (1514 bytes)
; BANK 00 @#05EA : colors.asm (1305 bytes)
; BANK 00 @#0B03 : components.asm (22 bytes)
; BANK 00 @#0B19 : entities.asm (5351 bytes)
; BANK 01 @#0000 : entities.asm (1974 bytes)
; BANK 01 @#07B6 : worlds.asm (6218 bytes)
; BANK 02 @#0000 : worlds.asm (1705 bytes)
; BANK 02 @#06A9 : screens.asm part 1/5 (6487 bytes)
...
; BANK 06 @#0000 : screens.asm part 5/5 (1715 bytes)
; BANK 06 @#06B3 : sprites.asm part 1/2 (6477 bytes)
; BANK 07 @#0000 : sprites.asm part 2/2 (4534 bytes)
; BANK 07 @#11B6 : font.asm (3547 bytes)
; BANK 07 @#1F91 : hud.asm (111 bytes)
; BANK 08 @#0000 : hud.asm (4356 bytes)
; BANK 08 @#1104 : menus.asm (454 bytes)
; BANK 08 @#12CA : sound.asm (3382 bytes)
; BANK 09 @#0000 : sound.asm (3873 bytes)
; BANK 09 @#0F21 : scroll.asm (2353 bytes)
; BANK 09 @#1852 : animtiles.asm (1966 bytes)
; BANK 10 @#0000 : animtiles.asm (4921 bytes)
; BANK 10 @#1339 : statemachine.asm part 1/3 (3271 bytes)
; BANK 11 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : statemachine.asm part 3/3 (7192 bytes)
; BANK 12 @#1C18 : gameflow.asm part 1/2 (1000 bytes)
; BANK 13 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 14 @#0000 : gameflow.asm part 3/2 (2902 bytes)
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #88,#92,#FB,#F0,#82,#C4,#48,#8E,#82,#83,#FD,#F4,#80,#02,#7F,#B9
    DB #C4,#42,#A6,#86,#80,#86,#9C,#15,#BF,#81,#05,#00,#88,#89,#8A,#56
    DB #24,#83,#83,#5F,#85,#BF,#91,#80,#F8,#91,#00,#E7,#CB,#8A,#8B,#8C
    DB #EE,#87,#F8,#80,#47,#A5,#51,#8C,#C8,#C6,#6F,#8E,#FF,#EF,#F0,#93
    DB #FF,#B3,#F4,#F8,#0E,#38,#5B,#88,#FC,#FE,#2C,#33,#C0,#52,#90,#83
    DB #3D,#80,#6D,#89,#F1,#65,#C0,#36,#5D,#8D,#8B,#65,#7C,#DC,#88,#EA
    DB #40,#86,#57,#60,#89,#97,#98,#99,#9A,#82,#9F,#A8,#FE,#1A,#9B,#78
    DB #80,#9B,#88,#92,#92,#FD,#F8,#C0,#7B,#FA,#AB,#80,#85,#4F,#B8,#4C
    DB #B0,#F5,#C0,#A7,#80,#DF,#80,#30,#ED,#D2,#97,#C4,#7F,#D1,#FB,#80
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #85,#00,#56,#80,#10,#0F,#88,#57,#D4,#40,#F4,#C0,#68,#08,#F7,#FB
    DB #CC,#57,#D1,#C0,#F1,#84,#0F,#D3,#80,#C0,#38,#AC,#0B,#20,#A6,#FF
    DB #10,#8E,#04,#94,#5F,#78,#3C,#E0,#4E,#42,#13,#C4,#C0,#3B,#50,#C4
    DB #C0,#D6,#90,#17,#CC,#EE,#90,#3C,#A4,#10,#3C,#C0,#46,#F4,#04,#22
    DB #F5,#C0,#77,#BC,#5E,#C0,#CC,#44,#78,#FE,#5D,#55,#56
...
; Free RAM buffer for tile pattern data decompression (232 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #E300

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (232 bytes)
; ==================================================================
