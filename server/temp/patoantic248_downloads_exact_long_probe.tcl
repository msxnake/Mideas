set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/patoantic248_downloads_exact_long_probe.log"
...
after time 13.2 { shot "patoantic248_exact_game_start.png" "game_start" }
...
after time 42.0 { shot "patoantic248_exact_42s.png" "shot_42" }
after time 48.0 { state "idle_48" }
after time 54.0 { shot "patoantic248_exact_54s.png" "shot_54" }
after time 60.0 {
    state "final_60"
    close $f
    exit
