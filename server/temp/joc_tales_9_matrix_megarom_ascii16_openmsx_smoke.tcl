set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc_tales_9_matrix_megarom_ascii16_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc_tales_9_matrix_megarom_ascii16_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set flow [mem8 0xC104]; set screen [mem8 0xE0EB]; set irq [mem16 0xE78D]; set inirq [mem8 0xE792]
    set px [mem16 0xE0F5]; set py [mem16 0xE0F7]
...
after time 12.0 { shot "joc_tales_9_matrix_megarom_ascii16_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "joc_tales_9_matrix_megarom_ascii16_t16.png" "t16" }
after time 22.0 { shot "joc_tales_9_matrix_megarom_ascii16_t22.png" "t22"; close $f; exit }
