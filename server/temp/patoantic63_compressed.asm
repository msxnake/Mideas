...
; Estimated payload bytes: 100163
...
; BANK 03 @#0000 : sprites.asm part 2/2 (7983 bytes)
; BANK 03 @#1F2F : font.asm (209 bytes)
; BANK 04 @#0000 : font.asm (3338 bytes)
; BANK 04 @#0D0A : hud.asm (3836 bytes)
; BANK 04 @#1C06 : menus.asm (444 bytes)
; BANK 04 @#1DC2 : sound.asm (574 bytes)
; BANK 05 @#0000 : sound.asm (2610 bytes)
; BANK 05 @#0A32 : scroll.asm (2353 bytes)
; BANK 05 @#1363 : animtiles.asm (3229 bytes)
; BANK 06 @#0000 : animtiles.asm (2687 bytes)
; BANK 06 @#0A7F : particles.asm (4963 bytes)
; BANK 06 @#1DE2 : statemachine.asm part 1/4 (542 bytes)
...
; BANK 10 @#0000 : statemachine.asm part 5/4 (1487 bytes)
; BANK 10 @#05CF : gameflow.asm part 1/3 (6705 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (1859 bytes)
...
;; Size: 16x16
    ...
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_4_F0_DATA (32 bytes)
SPRITE_4_PATTERN EQU NINA_JUMP_LEFT_4_F0_LAYER0
...
entity_sprite_config: 
    ...
    db 1, 2 ; Entity 1 (nina_idle_right)
...
entity_sprite_asset_index_init:
    db #01 ; Entity 0 (bola)
    db #07 ; Entity 1 (nina_idle_right)
...
SM_SpriteLayerColorTable:
    ...
    db 6, 15 ; Sprite 4: nina_jump_left
...
load_sprite_patterns:
    ...
    call COPY_SPRITE_SRC_TO_VRAM
    ; Entity 1: nina_idle_right (2 layers)
    ; Base HW Sprite: 1
...
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_4_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_LEFT_4_F0 (64 -> 51 bytes)
    DB #61,#03,#1F,#00,#87,#03,#16,#03,#87,#55,#A0,#F0,#2A,#C0,#E0,#E0
    DB #90,#28,#04,#02,#02,#40,#9F,#F0,#D5,#01,#CC,#87,#0F,#0B,#1B,#1F
    DB #0F,#BA,#ED,#09,#E9,#AA,#E6,#FE,#6E,#40,#C0,#80,#E5,#A9,#10,#2A
    DB #D5,#55,#60
...
ZX0_SPRITE_FRAME_NINA_JUMP_RIGHT_10_F0_DATA:
    ...
    DB #28,#03,#07,#29,#09,#14,#20,#40,#69,#03,#02,#07,#0F,#AB,#80,#00
    DB #86,#C0,#F8,#00,#49,#C0,#68,#C0,#E1,#AA,#00,#26,#02,#03,#01,#E6
    DB #CD,#08,#00,#54,#19,#2B,#F0,#D0,#D8,#F8,#F0,#80,#90,#A7,#C9,#55
    DB #55,#55,#80
...
NINA_JUMP_LEFT_4_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_4_F0_DATA
