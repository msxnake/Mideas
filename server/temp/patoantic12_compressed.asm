...
; ==================================================================
; ------------------------------------------------------------------
; 8KB BANK PACKER ESTIMATE (diagnostic only - no runtime mapping yet)
; Estimated payload bytes: 76553
; Estimated banks used: 10
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (855 bytes)
; BANK 00 @#0357 : colors.asm (800 bytes)
; BANK 00 @#0677 : components.asm (22 bytes)
; BANK 00 @#068D : entities.asm (3489 bytes)
; BANK 00 @#142E : worlds.asm (1942 bytes)
; BANK 00 @#1BC4 : screens.asm part 1/2 (1084 bytes)
; BANK 01 @#0000 : screens.asm part 2/2 (8192 bytes)
; BANK 02 @#0000 : screens.asm part 3/2 (357 bytes)
; BANK 02 @#0165 : sprites.asm (5361 bytes)
; BANK 02 @#1656 : font.asm (2474 bytes)
; BANK 03 @#0000 : font.asm (1053 bytes)
; BANK 03 @#041D : hud.asm (3836 bytes)
; BANK 03 @#1319 : menus.asm (444 bytes)
; BANK 03 @#14D5 : sound.asm (2859 bytes)
; BANK 04 @#0000 : sound.asm (325 bytes)
; BANK 04 @#0145 : scroll.asm (2353 bytes)
; BANK 04 @#0A76 : animtiles.asm (3349 bytes)
; BANK 04 @#178B : particles.asm (2165 bytes)
; BANK 05 @#0000 : particles.asm (2798 bytes)
; BANK 05 @#0AEE : statemachine.asm part 1/2 (5394 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 07 @#0000 : statemachine.asm part 3/2 (2507 bytes)
; BANK 07 @#09CB : gameflow.asm part 1/3 (5685 bytes)
; BANK 08 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 09 @#0000 : gameflow.asm part 3/3 (2825 bytes)
...
frame_counter       EQU #C017   ; Frame counter (16-bit)

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C019   ; Pointer to current screen layout data (16-bit)
current_screen_layout_bank EQU #C01B   ; Mapper bank for current screen layout data
current_behavior_map    EQU #C01C   ; Pointer to current behavior map data (16-bit)
current_behavior_map_bank EQU #C01E   ; Mapper bank for current behavior map data
behavior_cache_row     EQU #C01F   ; Cached behavior row (255=invalid)
behavior_cache_map_l   EQU #C020   ; Cached behavior map pointer low byte
behavior_cache_map_h   EQU #C021   ; Cached behavior map pointer high byte
behavior_cache_row_base EQU #C022   ; Cached row base address in behavior map (16-bit)

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #C024   ; Camera X position in pixels (16-bit)
camera_y            EQU #C026   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #C028   ; Camera tile X (column)
camera_tile_y       EQU #C029   ; Camera tile Y (row)
world_width_tiles   EQU #C02A   ; World width in tiles
world_height_tiles  EQU #C02B   ; World height in tiles
scroll_dirty_flag   EQU #C02C   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #C02D   ; 1=HUD needs redraw, 0=clean

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #C02E   ; Animation frame timer
anim_tile_frame     EQU #C02F   ; Current animation frame (0-3)
anim_tile_speed     EQU #C030   ; Frames between animation updates

; ==================================================================
; PARTICLE SYSTEM VARIABLES
; ==================================================================
particle_pool       EQU #C031   ; Particle pool (8 particles * 8 bytes = 64 bytes)

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #C071   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_x_pos        EQU #C091   ; Entity X positions (32 bytes)
entity_y_pos        EQU #C0B1   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #C0D1   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #C0F1   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #C111   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #C131   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #C151   ; Entity screen ID (32 bytes)
entity_dir_mask     EQU #C171   ; Entity direction mask (32 bytes)
entity_health       EQU #C191   ; Entity health (32 bytes)
entity_anim_frame   EQU #C1B1   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #C1D1   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #C1F1   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #C211   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #C231   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C251   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C271   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C291   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C2B1   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #C2D1   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #C2F1   ; Entity carrier ID (32 bytes, 255=not carried)
entity_sm_var_0     EQU #C311   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C331   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C351   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C371   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C391   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #C3B1   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #C3D1   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #C3F1   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #C411   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #C431   ; Number of sprites currently active
sprites_dirty      EQU #C432   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #C433   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #C453   ; Sprite colors (32 bytes)
sprite_attributes   EQU #C473   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (3 screens detected)
; ==================================================================
current_screen_id   EQU #C4F3   ; Currently displayed screen ID
screen_dirty_flag   EQU #C4F4   ; Screen needs redraw flag
screen_transition_cooldown EQU #C4F5   ; Cooldown frames after screen transition
current_world_id    EQU #C4F6   ; Current world ID (for multi-world support)
current_screen_index EQU #C4F7   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #C4F8   ; Player X position (16-bit)
player_y            EQU #C4FA   ; Player Y position (16-bit)
player_health       EQU #C4FC   ; Player health points
player_score        EQU #C4FD   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #C4FF   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #C500   ; Temporary 16-bit storage
temp_word_2         EQU #C502   ; Temporary 16-bit storage
temp_byte_1         EQU #C504   ; Temporary 8-bit storage
temp_byte_2         EQU #C505   ; Temporary 8-bit storage
temp_byte_3         EQU #C506   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #C526   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #C546   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #C566   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #C586   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #C5A6   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #C5C6   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #C5E6   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #C606   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #C626   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #C646   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #C666   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #C686   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #C6A6   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #C6C6   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #C6E6   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #C706   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #C726   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #C746   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #C766   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #C786   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #C7A6   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C7C6   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C806   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #C846   ; Cached entity X for wall checks
wall_temp_y         EQU #C847   ; Cached entity Y for wall checks

; Unified update helpers
active_entity_list  EQU #C848   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #C868   ; Number of entries in active_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #C869   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #C889   ; Number of entities in coll_list
coll_src_left       EQU #C88A   ; Source AABB left edge (scratch)
coll_src_right      EQU #C88B   ; Source AABB right edge (scratch)
coll_src_top        EQU #C88C   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #C88D   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #C88E   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #C88E   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #C890   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #C892   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #C894   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #C896   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #C898   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #C89A   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #C89C   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #C89E   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #C89F   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #C8A4   ; Frame counter (16-bit)
task_exec_time          EQU #C8A6   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #C8A8   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #C8A9   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C8A9   ; End of project variables (2217 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#C8A9: Project variables (2217 bytes)
;   #C8A9-#F37F: Free RAM (~10967 bytes available)
...
init_sprite_system:
    ; Decompress ZX0 sprite pattern blob into RAM buffer
    di
    ld hl, ZX0_SPRITE_PATTERN_DATA
    ld de, ZX0_SPRITE_PATTERN_BUFFER
    call dzx0_standard
    ei
...
SPRITE_PATTERN_DATA_BANK EQU 1
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_PATTERN_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_PATTERN_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_PATTERN_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_PATTERN_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_PATTERN_DATA (32 bytes)
...
SCREEN_PAN1_0_LAYOUT_BANK EQU 1
BEHAVIOR_PAN1_0_DATA_BANK EQU 1
SCREEN_PAN2_1_ID EQU 1
SCREEN_PAN2_1_LAYOUT_BANK EQU 1
BEHAVIOR_PAN2_1_DATA_BANK EQU 1
SCREEN_BACKGROUND1_2_ID EQU 2
SCREEN_BACKGROUND1_2_LAYOUT_BANK EQU 1
BEHAVIOR_BACKGROUND1_2_DATA_BANK EQU 1
...
FONT_PATTERN_DATA_BANK EQU 1
FONT_COLOR_DATA_BANK   EQU 1
...
SM_New_Statemachine_state_1771533530403_Transitions: 
    ...
    DW SM_New_Statemachine_state_1771533538995 
...
SM_New_Statemachine_state_1771533538995: 
    DB 0; ID(unused) 
    DW 0 
    DW 0 
    DW 0 
...
; ------------------------------------------------------------------
submenu_prepare_cursor_sprite:
    ; Ensure sprite pattern blob is available for submenu cursor
    di
    ld hl, ZX0_SPRITE_PATTERN_DATA
    ld de, ZX0_SPRITE_PATTERN_BUFFER
    call dzx0_standard
...
; ==================================================================
ZX0_SPRITE_PATTERN_DATA:
    ; ZX0 compressed sprite patterns (1280 -> 379 bytes)
    ...
    DB #20,#9B,#FF,#E0,#18,#04,#FD,#E1,#FD,#FE,#5F,#40,#62,#20,#10,#26
    DB #03,#00,#00,#16,#88,#78,#97,#40,#A0,#86,#E5,#D0,#29,#16,#01,#04
    DB #39,#40,#29,#84,#A5,#40,#5F,#E0,#85,#87,#03,#0F,#3F,#7B,#67,#7F
    DB #6F,#77,#3F,#1F,#07,#63,#8F,#3C,#FE,#E0,#FE,#80,#FC,#F8,#E0,#00
    DB #12,#18,#07,#0F,#1D,#1B,#3F,#6A,#1F,#69,#0F,#07,#00,#2A,#C0,#E0
    DB #60,#70,#B0,#F8,#D8,#8A,#F8,#F0,#60,#E0,#C0,#00,#05,#9A,#0F,#08
    DB #10,#32,#30,#60,#3C,#9F,#1D,#06,#00,#FE,#88,#F0,#10,#88,#08,#04
    DB #98,#0C,#F8,#00,#10,#68,#3F,#E1,#BA,#81,#94,#30,#38,#3C,#FE,#FF
    DB #FF,#3C,#18,#10,#CD,#C0,#20,#81,#C2,#24,#28,#30,#0A,#05,#24,#92
    DB #1E,#1F,#3D,#1F,#37,#39,#8A,#00,#60,#80,#80,#70,#68,#C8,#58,#F0
    DB #B0,#B0,#60,#16,#13,#05,#01,#05,#03,#36,#22,#17,#3D,#0F,#36,#CE
    DB #43,#D5,#41,#AA,#40,#40,#12,#80,#F8,#78,#80,#50,#D0,#70,#30,#20
    DB #40,#00,#58,#29,#0D,#09,#00,#0B,#2A,#30,#11,#1D,#2F,#0C,#10,#01
    DB #7E,#57,#55,#3B,#58,#50,#F1,#50,#5B,#F5,#A0,#80,#40,#4E,#ED,#A1
    DB #08,#9B,#0C,#04,#20,#2A,#01,#06,#EF,#F6,#60,#3D,#5A,#FA,#EB,#18
    DB #2D,#20,#1F,#04,#85,#FA,#56,#06,#03,#0D,#0B,#1A,#3B,#EF,#07,#02
    DB #00,#D6,#40,#8D,#10,#28,#24,#F1,#98,#80,#80,#C0,#40,#C0,#80,#66
    DB #90,#70,#E0,#20,#50,#60,#04,#05,#04,#B6,#18,#61,#BF,#10,#FD,#40
    DB #A9,#80,#6A,#02,#06,#0C,#98,#68,#88,#10,#20,#11,#68,#1E,#88,#02
    DB #05,#18,#8D,#04,#08,#2E,#82,#40,#4A,#21,#69,#02,#78,#A5,#6E,#0B
    DB #94,#68,#80,#20,#FE,#00,#A5,#FF,#5D,#55,#56
...
; ==================================================================
ZX0_TILE_COLOR_BUFFER EQU #D000

; ==================================================================
; ZX0 FONT PATTERN BUFFER (AUTO-INJECTED)
; Free RAM buffer for font pattern data decompression (360 bytes)
; ==================================================================
ZX0_FONT_PATTERN_BUFFER EQU #D100

; ==================================================================
; ZX0 FONT COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for font color data decompression (360 bytes)
; ==================================================================
ZX0_FONT_COLOR_BUFFER EQU #D300

; ==================================================================
; ZX0 SPRITE PATTERN BUFFER (AUTO-INJECTED)
; Free RAM buffer for sprite pattern blob decompression (1280 bytes)
; ==================================================================
ZX0_SPRITE_PATTERN_BUFFER EQU #D500

; ==================================================================
; ZX0 SPRITE LABEL REMAP (AUTO-INJECTED)
; Original sprite labels now point to decompressed RAM buffer
; ==================================================================
ANEC_RIGHT_0_F0_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+0
ANEC_RIGHT_0_F0_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+32
ANEC_RIGHT_0_F0_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+64
ANEC_RIGHT_0_F1_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+96
ANEC_RIGHT_0_F1_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+128
ANEC_RIGHT_0_F1_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+160
BOLA_1_F0_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+192
BOLA_1_F0_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+224
BOLA_1_F0_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+256
BOLA_1_F1_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+288
BOLA_1_F1_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+320
BOLA_1_F1_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+352
BOSSA_2_F0_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+384
BOSSA_2_F0_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+416
BOSSA_2_F0_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+448
PANELL_3_F0_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+480
PANELL_3_F0_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+512
PANELL_3_F0_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+544
BOLA_DEAD_4_F0_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+576
BOLA_DEAD_4_F0_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+608
BOLA_DEAD_4_F0_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+640
BOLA_DEAD_4_F1_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+672
BOLA_DEAD_4_F1_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+704
BOLA_DEAD_4_F1_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+736
BOLA_DEAD_4_F2_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+768
BOLA_DEAD_4_F2_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+800
BOLA_DEAD_4_F2_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+832
BOLA_DEAD_4_F3_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+864
BOLA_DEAD_4_F3_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+896
BOLA_DEAD_4_F3_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+928
BOLA_DEAD_4_F4_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+960
BOLA_DEAD_4_F4_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+992
BOLA_DEAD_4_F4_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+1024
ANEC_LEFT_5_F0_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+1056
ANEC_LEFT_5_F0_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+1088
ANEC_LEFT_5_F0_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+1120
ANEC_LEFT_5_F1_LAYER1 EQU ZX0_SPRITE_PATTERN_BUFFER+1152
ANEC_LEFT_5_F1_LAYER2 EQU ZX0_SPRITE_PATTERN_BUFFER+1184
ANEC_LEFT_5_F1_LAYER3 EQU ZX0_SPRITE_PATTERN_BUFFER+1216
SPRITE_PLACEHOLDER_PATTERN EQU ZX0_SPRITE_PATTERN_BUFFER+1248
