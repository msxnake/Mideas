...
temp_word_3         EQU #C6F8   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C738   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #C778   ; Cached entity X for wall checks
wall_temp_y         EQU #C779   ; Cached entity Y for wall checks
wall_entity_idx     EQU #C77A   ; Current entity index in wall loop

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #C77B   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #C77B   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #C77D   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #C77F   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #C781   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #C783   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #C785   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #C787   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #C789   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #C78B   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #C78C   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #C791   ; Frame counter (16-bit)
task_exec_time          EQU #C793   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #C795   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #C796   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C796   ; End of project variables (1942 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#C796: Project variables (1942 bytes)
;   #C796-#F37F: Free RAM (~11242 bytes available)
