...
; BANK 03 @#0000 : sprites.asm (7587 bytes)
; BANK 03 @#1DA3 : font.asm (605 bytes)
; BANK 04 @#0000 : font.asm (2942 bytes)
; BANK 04 @#0B7E : hud.asm (3836 bytes)
; BANK 04 @#1A7A : menus.asm (444 bytes)
; BANK 04 @#1C36 : sound.asm (970 bytes)
; BANK 05 @#0000 : sound.asm (2214 bytes)
; BANK 05 @#08A6 : scroll.asm (2353 bytes)
; BANK 05 @#11D7 : animtiles.asm (3625 bytes)
; BANK 06 @#0000 : animtiles.asm (2291 bytes)
; BANK 06 @#08F3 : particles.asm (4963 bytes)
; BANK 06 @#1C56 : statemachine.asm part 1/4 (938 bytes)
...
; BANK 10 @#0000 : statemachine.asm part 5/4 (1076 bytes)
; BANK 10 @#0434 : gameflow.asm part 1/3 (7116 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (1448 bytes)
...
SPRITE_NINA_IDLE_7_WIDTH     EQU 16
SPRITE_NINA_IDLE_7_HEIGHT    EQU 16
SPRITE_NINA_IDLE_7_FRAMES    EQU 1

;; ---- Sprite Frame: nina_idle_7_F0 ----
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_7_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_IDLE_7_F0_DATA (32 bytes)
SPRITE_7_PATTERN EQU NINA_IDLE_7_F0_LAYER0
...
; Sprite 7: nina_idle frame pointers
SPRITE_7_FRAME_PTRS:
    dw NINA_IDLE_7_F0_LAYER0
...
sprite_dir_left_table:
    db 8, 1, 2, 3, 4, 5, 6, 7, 8, 3, 4, 5

sprite_dir_right_table:
    db 0, 1, 2, 9, 10, 11, 6, 7, 0, 9, 10, 11
...
ZX0_SPRITE_FRAME_NINA_IDLE_7_F0_DATA:
    ; ZX0 compressed sprite frame NINA_IDLE_7_F0 (64 -> 50 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#5B,#0F,#0B,#1B,#1F
    DB #0F,#01,#00,#FA,#B4,#F9,#09,#7B,#CB,#80,#EF,#D3,#FE,#C2,#B5,#10
    DB #55,#58
...
; Frame group: NINA_IDLE_7_F0
NINA_IDLE_7_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_IDLE_7_F0_DATA
