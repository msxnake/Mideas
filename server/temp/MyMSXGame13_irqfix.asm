...
; BANK 02 @#003D : sound.asm (7330 bytes)
; BANK 02 @#1CDF : scroll.asm (801 bytes)
; BANK 03 @#0000 : scroll.asm (1552 bytes)
; BANK 03 @#0610 : animtiles.asm (4555 bytes)
; BANK 03 @#17DB : particles.asm (2085 bytes)
; BANK 04 @#0000 : particles.asm (2878 bytes)
; BANK 04 @#0B3E : statemachine.asm (5 bytes)
; BANK 04 @#0B43 : gameflow.asm (5309 bytes)
; BANK 05 @#0000 : gameflow.asm (282 bytes)
...
restart_rom_continue:
    ...
    ; Register default tasks based on project needs
        ; Pre-clear audio runtime before enabling H.TIMI audio task.
    ; Without this, power-on RAM garbage can make music_update run
    ; before init_sound_system has reset PT3/SFX state.
