...
active_entity_list_dirty EQU #CEAC   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #CEAD   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #CECD   ; Number of entities in coll_list
coll_src_left       EQU #CECE   ; Source AABB left edge (scratch)
coll_src_right      EQU #CECF   ; Source AABB right edge (scratch)
coll_src_top        EQU #CED0   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #CED1   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #CED2   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #CED2   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #CED4   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #CED6   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #CED8   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #CEDA   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #CEDC   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #CEDE   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #CEE0   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #CEE2   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #CEE3   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #CEE8   ; Frame counter (16-bit)
task_exec_time          EQU #CEEA   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #CEEC   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #CEED   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #CEED   ; End of project variables (3821 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#CEED: Project variables (3821 bytes)
;   #CEED-#F37F: Free RAM (~9363 bytes available)
