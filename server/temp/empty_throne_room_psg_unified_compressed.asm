; ==================================================================
; EMPTY_THRONE_ROOM_PSG - UNIFIED FILE
...
; BANK 02 @#0000 : sound.asm part 3/2 (3517 bytes)
; BANK 02 @#0DBD : scroll.asm (2407 bytes)
; BANK 02 @#1724 : animtiles.asm (2268 bytes)
; BANK 03 @#0000 : animtiles.asm (281 bytes)
; BANK 03 @#0119 : bosses.asm (5782 bytes)
; BANK 03 @#17AF : statemachine.asm (5 bytes)
; BANK 03 @#17B4 : gameflow.asm (2124 bytes)
; BANK 04 @#0000 : gameflow.asm (2789 bytes)
...
; Flow: Start → Music (gf_throne_music)
; ==================================================================
...
music_track_ptr_table:
    DW music_track_0_The_Empty_Throne_Room_PSG_data

; ------------------------------------------------------------------
; Tracker Song 0: The Empty Throne Room PSG
; ------------------------------------------------------------------
music_track_0_The_Empty_Throne_Room_PSG_data:
    DB #0A
    DB #03
    DB #00
    DB #01
    DB #03
    DW music_track_0_The_Empty_Throne_Room_PSG_order_table
    DW music_track_0_The_Empty_Throne_Room_PSG_pattern_table
    DW music_track_0_The_Empty_Throne_Room_PSG_instrument_ptr_table
    DW music_track_0_The_Empty_Throne_Room_PSG_ornament_ptr_table
    DW #00D2
    DB #0C

music_track_0_The_Empty_Throne_Room_PSG_order_table:
    DB #00,#01,#02

music_track_0_The_Empty_Throne_Room_PSG_pattern_table:
    DW music_track_0_The_Empty_Throne_Room_PSG_pattern_0_rows
    DB #40
    DW music_track_0_The_Empty_Throne_Room_PSG_pattern_1_rows
    DB #40
    DW music_track_0_The_Empty_Throne_Room_PSG_pattern_2_rows
    DB #40

music_track_0_The_Empty_Throne_Room_PSG_instrument_ptr_table:
    DW 0
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_1
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_2
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_3
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_4
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_5
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_The_Empty_Throne_Room_PSG_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_The_Empty_Throne_Room_PSG_pattern_0_rows:
    DB #3E,#01,#FF,#0F,#15,#02,#FF,#0D,#15,#04,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2D,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #46,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#15,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#FF,#FF,#FF,#FF,#34,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #44,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #46,#01,#FF,#0F,#18,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#34,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#18,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#FF,#FF,#FF,#FF,#39,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #46,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#11,#02,#FF,#0D,#15,#04,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #46,#01,#FF,#0F,#FF,#FF,#FF,#FF,#29,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#11,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#35,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#10,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#28,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2F,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#10,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#FF,#FF,#FF,#FF,#34,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_The_Empty_Throne_Room_PSG_pattern_1_rows:
    DB #3C,#01,#FF,#0F,#18,#02,#FF,#0D,#18,#04,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#24,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2B,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#18,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    ...
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#13,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2B,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#13,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#34,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#1C,#02,#FF,#0D,#18,#04,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#FF,#FF,#FF,#FF,#28,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2F,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#1C,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#34,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#17,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#FF,#FF,#FF,#FF,#24,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2B,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#17,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_The_Empty_Throne_Room_PSG_pattern_2_rows:
    DB #48,#01,#FF,#0F,#11,#02,#FF,#0D,#11,#04,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#FF,#FF,#FF,#FF,#29,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#11,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#FF,#FF,#FF,#FF,#35,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#18,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#24,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2B,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3A,#01,#FF,#0F,#18,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#18,#02,#FF,#0D,#11,#04,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#24,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#01,#FF,#0F,#FF,#FF,#FF,#FF,#2B,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#18,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #48,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #46,#01,#FF,#0F,#13,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #43,#01,#FF,#0F,#FF,#FF,#FF,#FF,#29,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #41,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#30,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#01,#FF,#0F,#18,#02,#FF,#0D,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#01,#FF,#0F,#FF,#FF,#FF,#FF,#35,#03,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#1E,#05,#FF,#07
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_The_Empty_Throne_Room_PSG_inst_1:
    DB #05
    DB #00
    DB #0B
    DB #0C
    DW #00D2
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_1_vol_env
    DB #0C
    DB #FF
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_1_tone_env
    DB #05
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_0_The_Empty_Throne_Room_PSG_inst_1_vol_env:
    DB #00,#08,#0F,#0E,#0D,#0B,#09,#07,#05,#03,#01,#00
music_track_0_The_Empty_Throne_Room_PSG_inst_1_tone_env:
    DB #00,#01,#00,#FF,#00

music_track_0_The_Empty_Throne_Room_PSG_inst_2:
    DB #05
    DB #0A
    DB #0C
    DB #0C
    DW #00D2
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_2_vol_env
    DB #09
    DB #07
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_2_tone_env
    DB #04
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_0_The_Empty_Throne_Room_PSG_inst_2_vol_env:
    DB #0A,#0D,#0F,#0F,#0E,#0D,#0C,#0B,#0A
music_track_0_The_Empty_Throne_Room_PSG_inst_2_tone_env:
    DB #00,#00,#FF,#00

music_track_0_The_Empty_Throne_Room_PSG_inst_3:
    DB #01
    DB #08
    DB #00
    DB #0C
    DW #00D2
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_3_vol_env
    DB #08
    DB #FF
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_3_tone_env
    DB #04
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_0_The_Empty_Throne_Room_PSG_inst_3_vol_env:
    DB #08,#0C,#0A,#08,#06,#04,#02,#00
music_track_0_The_Empty_Throne_Room_PSG_inst_3_tone_env:
    DB #00,#0C,#07,#00

music_track_0_The_Empty_Throne_Room_PSG_inst_4:
    DB #03
    DB #0F
    DB #00
    DB #04
    DW #00D2
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_4_vol_env
    DB #07
    DB #FF
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_4_tone_env
    DB #05
    DB #FF
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_4_noise_env
    DB #04
    DB #FF
music_track_0_The_Empty_Throne_Room_PSG_inst_4_vol_env:
    DB #0F,#0E,#0B,#08,#05,#02,#00
music_track_0_The_Empty_Throne_Room_PSG_inst_4_tone_env:
    DB #E8,#F0,#F7,#FC,#00
music_track_0_The_Empty_Throne_Room_PSG_inst_4_noise_env:
    DB #04,#07,#0C,#14

music_track_0_The_Empty_Throne_Room_PSG_inst_5:
    DB #02
    DB #06
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_5_vol_env
    DB #07
    DB #FF
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_5_tone_env
    DB #01
    DB #FF
    DW music_track_0_The_Empty_Throne_Room_PSG_inst_5_noise_env
    DB #05
    DB #FF
music_track_0_The_Empty_Throne_Room_PSG_inst_5_vol_env:
    DB #06,#05,#04,#03,#02,#01,#00
music_track_0_The_Empty_Throne_Room_PSG_inst_5_tone_env:
    DB #00
music_track_0_The_Empty_Throne_Room_PSG_inst_5_noise_env:
    DB #02,#03,#05,#08,#0D
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_throne_start
...
; Node: Start - "gf_throne_start"
gameflow_node_gf_throne_start:
    db NODE_TYPE_START
    dw gameflow_node_gf_throne_start_data
    dw gameflow_node_gf_throne_start_conn

gameflow_node_gf_throne_start_data:
    dw gameflow_node_gf_throne_start_init    ; Initialization routine address
    db ((gameflow_node_gf_throne_start_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_throne_start_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_throne_music
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_throne_start_init
...
; Node: Music - "gf_throne_music"
gameflow_node_gf_throne_music:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gf_throne_music_data
    dw gameflow_node_gf_throne_music_conn

gameflow_node_gf_throne_music_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gf_throne_music_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_throne_end
    db CONNECTION_END

; Node: End - "gf_throne_end"
gameflow_node_gf_throne_end:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gf_throne_end_conn

gameflow_node_gf_throne_end_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
