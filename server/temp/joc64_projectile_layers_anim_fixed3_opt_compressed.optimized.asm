...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (1016 -> 747 bytes)
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (1016 -> 376 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PROJECTIL1_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PROJECTIL1_6_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PROJECTIL1_6_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_PROJECTIL1_6_F1_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F1_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F1_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_9_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_9_F0_DATA (32 bytes)
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NEW_SPRITE_LEFT_11_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_NEW_SPRITE_LEFT_11_F0_DATA (32 bytes)
...
ZX0_SPRITE_FRAME_NEW_SPRITE_RIGHT_5_F0_DATA:
    ; ZX0 compressed sprite frame NEW_SPRITE_RIGHT_5_F0 (64 -> 58 bytes)
    DB #0A,#00,#0F,#0A,#17,#62,#0B,#00,#07,#99,#04,#28,#07,#3B,#00,#F8
    DB #B8,#C4,#08,#F8,#00,#80,#8E,#90,#FE,#FC,#80,#99,#7E,#00,#03,#A8
    DB #00,#29,#3F,#60,#5D,#55,#E3,#5D,#60,#3F,#A3,#00,#08,#E6,#E5,#E1
    DB #FE,#03,#DD,#26,#DD,#03,#FE,#D5,#55,#60
ZX0_SPRITE_FRAME_PROJECTIL1_6_F0_DATA:
    ; ZX0 compressed sprite frame PROJECTIL1_6_F0 (64 -> 25 bytes)
    DB #82,#00,#22,#01,#02,#21,#01,#00,#22,#C0,#20,#22,#C0,#00,#16,#8A
    DB #01,#00,#42,#BD,#C0,#C2,#D5,#55,#60
ZX0_SPRITE_FRAME_PROJECTIL1_6_F1_DATA:
    ; ZX0 compressed sprite frame PROJECTIL1_6_F1 (64 -> 21 bytes)
    DB #92,#00,#21,#02,#00,#3A,#DD,#80,#AA,#20,#80,#46,#BC,#01,#BE,#6F
    DB #C0,#C2,#75,#55,#58
...
ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F0_DATA:
    ; ZX0 compressed sprite frame NINA_GRUB_LEFT_8_F0 (64 -> 47 bytes)
...
ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F1_DATA:
    ; ZX0 compressed sprite frame NINA_GRUB_LEFT_8_F1 (64 -> 49 bytes)
    ...
    DB #60
ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_9_F0_DATA:
    ; ZX0 compressed sprite frame NINA_JUMP_LEFT_9_F0 (64 -> 48 bytes)
...
ZX0_SPRITE_FRAME_NINA_IDLE_LEFT_10_F0_DATA:
    ; ZX0 compressed sprite frame NINA_IDLE_LEFT_10_F0 (64 -> 49 bytes)
    ...
    DB #56
ZX0_SPRITE_FRAME_NEW_SPRITE_LEFT_11_F0_DATA:
    ; ZX0 compressed sprite frame NEW_SPRITE_LEFT_11_F0 (64 -> 57 bytes)
    DB #0A,#00,#1F,#1D,#23,#02,#1F,#00,#01,#71,#09,#7F,#3F,#01,#21,#A6
    DB #7E,#00,#F0,#50,#E8,#D0,#00,#E0,#29,#20,#92,#E0,#DC,#F0,#00,#10
    DB #00,#60,#A0,#7F,#C0,#BB,#AA,#A9,#BB,#C0,#7F,#00,#C0,#E6,#E1,#FC
    DB #06,#BA,#26,#BA,#06,#FC,#D5,#55,#60
...
; ==================================================================
ZX0_FONT_PATTERN_BUFFER EQU #E600
...
; ==================================================================
ZX0_FONT_COLOR_BUFFER EQU #E800
...
; Frame group: PROJECTIL1_6_F0
PROJECTIL1_6_F0_LAYER1 EQU ZX0_SPRITE_FRAME_PROJECTIL1_6_F0_DATA
; Frame group: PROJECTIL1_6_F1
PROJECTIL1_6_F1_LAYER1 EQU ZX0_SPRITE_FRAME_PROJECTIL1_6_F1_DATA
...
; Frame group: NINA_GRUB_LEFT_8_F0
NINA_GRUB_LEFT_8_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F0_DATA
; Frame group: NINA_GRUB_LEFT_8_F1
NINA_GRUB_LEFT_8_F1_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_GRUB_LEFT_8_F1_DATA
; Frame group: NINA_JUMP_LEFT_9_F0
NINA_JUMP_LEFT_9_F0_LAYER0 EQU ZX0_SPRITE_FRAME_NINA_JUMP_LEFT_9_F0_DATA
; Frame group: NINA_IDLE_LEFT_10_F0
NINA_IDLE_LEFT_10_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NINA_IDLE_LEFT_10_F0_DATA
; Frame group: NEW_SPRITE_LEFT_11_F0
NEW_SPRITE_LEFT_11_F0_LAYER1 EQU ZX0_SPRITE_FRAME_NEW_SPRITE_LEFT_11_F0_DATA
