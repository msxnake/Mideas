...
- [report-only] `load_screen_background1_771482721894_far` lines 24179-24196: `load_screen_background1_771482721894_far` is a generated screen loader (18 lines, 426 source bytes) with no external label references. Category reason: Generated screen loader routine. Related annotated loader block `runtime.screens.load_screen_background1_771482721894.loader` is currently rooted by `load_screen_background1_771482721894`. Report-only until gameflow reachability proves the loader is unreachable.
