 ...
 */
const renderScreenToCanvas = (canvas, screenMap, tileset, currentScreenMode, baseSliceDim) => {
    ...
    if (!ctx)
        return;
    ctx.imageSmoothingEnabled = false;
    const defaultBg = isScreen2 ? constants_1.MSX1_PALETTE[1].hex : constants_1.MSX_SCREEN5_PALETTE[4].hex;
