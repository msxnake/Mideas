set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc65_konami_bossbanks_smoke_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/joc65_konami_bossbanks_smoke_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set p1 [mem8 0xC126]; set p2 [mem8 0xC127]; set p3 [mem8 0xC128]; set p4 [mem8 0xC129]
    set flow [mem8 0xC10F]; set screen [mem8 0xE181]; set irq [mem16 0xE843]; set inirq [mem8 0xE848]
    set px [mem16 0xE18B]; set py [mem16 0xE18D]
...
after time 12.0 { shot "joc65_konami_bossbanks_smoke_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "joc65_konami_bossbanks_smoke_t16.png" "t16" }
after time 22.0 { shot "joc65_konami_bossbanks_smoke_t22.png" "t22"; close $f; exit }
