...
load_sprite_patterns_worldmap_1760724209990:
    ...
    call mapper_set_bank_p2
    ld hl, (HERO_RIGHT_8_F0_LAYER1 & #1FFF) | #8000
    ld de, SPRPAT + (28 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_8_PATTERN_BANK
    call mapper_set_bank_p2
    ld hl, (HERO_RIGHT_8_F1_LAYER1 & #1FFF) | #8000
    ld de, SPRPAT + (30 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_8_PATTERN_BANK
    call mapper_set_bank_p2
    ld hl, (HERO_RIGHT_8_F2_LAYER1 & #1FFF) | #8000
    ld de, SPRPAT + (32 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_8_PATTERN_BANK
    call mapper_set_bank_p2
    ld hl, (HERO_RIGHT_8_F3_LAYER1 & #1FFF) | #8000
    ld de, SPRPAT + (34 * 32)
    ld bc, 64
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p2
    ld hl, (BOT2_LEFT_9_F0_LAYER0 & #1FFF) | #8000
    ld de, SPRPAT + (36 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_9_PATTERN_BANK
    call mapper_set_bank_p2
    ld hl, (BOT2_LEFT_9_F1_LAYER0 & #1FFF) | #8000
    ld de, SPRPAT + (37 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
...
; Zones used: 1
; ------------------------------------------------------------------
; ZONE 00 [#1C000-#1E000] bank 12 used=2248 slack=5944
...
;   + BEHAVIOR_PAN7_6_DATA @ +#089C size=44
    ...
    org #1C000
; ==================================================================
; DATA ZONE 00 (bank 12) used=2248 slack=5944
; ==================================================================
; ==================================================================
