...
; Bank 8 [#6000-#8000]: gameflow_aux (4407/8192 bytes est.) [FAR — accessed via trampoline]
...
; BANK 08 @#0000 : gameflow.asm part 3/3 (7134 bytes); ==================================================================
...
; - gameflow_aux: 4407 estimated bytes
...
;       "estimatedUsedBytes": 4407,
;       "estimatedFreeBytes": 3785,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "gameflow_aux",
