...
SPRITE_ANEC_LEFT_2_WIDTH     EQU 16
SPRITE_ANEC_LEFT_2_HEIGHT    EQU 16
SPRITE_ANEC_LEFT_2_FRAMES    EQU 2

;; ---- Sprite Frame: anec_left_2_F0 ----
;; Size: 16x16
ANEC_LEFT_2_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#03,#0D,#0B,#1A,#3B,#EF,#07,#02,#00,#07,#1F,#1F,#0F,#10,#28
    DB #00,#00,#80,#80,#C0,#40,#C0,#80,#00,#00,#00,#90,#70,#E0,#20,#50

ANEC_LEFT_2_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #42EBF5)
    DB #00,#00,#00,#04,#05,#04,#00,#00,#00,#07,#18,#20,#20,#10,#00,#10
    DB #00,#00,#00,#00,#00,#80,#00,#02,#06,#0C,#98,#68,#88,#10,#00,#20

ANEC_LEFT_2_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: anec_left_2_F0 ----

;; ---- Sprite Frame: anec_left_2_F1 ----
;; Size: 16x16
ANEC_LEFT_2_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#03,#0D,#0B,#1A,#3B,#EF,#07,#02,#00,#07,#1E,#1F,#0F,#02,#05
    DB #00,#00,#80,#80,#C0,#40,#C0,#80,#00,#04,#08,#90,#70,#C0,#00,#00

ANEC_LEFT_2_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #42EBF5)
    DB #00,#00,#00,#04,#05,#04,#00,#00,#00,#07,#18,#21,#20,#10,#00,#02
    DB #00,#00,#00,#00,#00,#80,#00,#00,#07,#0B,#94,#68,#80,#20,#00,#00

ANEC_LEFT_2_F1_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: anec_left_2_F1 ----


; Unified pattern label for sprite 2
SPRITE_2_PATTERN EQU ANEC_LEFT_2_F0_LAYER1
...
; Sprite 2: anec_left frame pointers
SPRITE_2_FRAME_PTRS:
    dw ANEC_LEFT_2_F0_LAYER1
    dw ANEC_LEFT_2_F1_LAYER1
