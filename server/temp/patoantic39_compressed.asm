...
; BANK 05 @#0BD2 : animtiles.asm (5166 bytes)
; BANK 06 @#0000 : animtiles.asm (119 bytes)
; BANK 06 @#0077 : particles.asm (4963 bytes)
; BANK 06 @#13DA : statemachine.asm part 1/3 (3110 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 4/3 (4631 bytes)
; BANK 09 @#1217 : gameflow.asm part 1/3 (3561 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (4996 bytes)
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 75 bytes)
    ...
    DB #80,#44,#F9,#C5,#FC,#4E,#C0,#FF,#F0,#45,#94,#FC,#EF,#C0,#F0,#F5
    DB #80,#03,#F4,#CB,#80,#7E,#CB,#80,#35,#55,#58
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #CC,#EF,#FE,#C0,#45,#F6,#CB,#5A,#0E,#C0,#14,#5E,#FE,#57,#CF,#CA
    DB #C0,#55,#7D,#FE,#57,#55,#55,#80
...
anim_transform_table:
    db 132, 1, 5, 1    ; corda -> tile tile_1771095408431
    db 255                          ; End marker
