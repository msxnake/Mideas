...
; BANK 07 @#0000 : statemachine.asm part 3/2 (1837 bytes)
; BANK 07 @#072D : gameflow.asm (6021 bytes)
...
entity_x_pos        EQU #DD18   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DD38   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DD58   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DD78   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DD98   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DDB8   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DDD8   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DDF8   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DE18   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DE38   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DE39   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DE59   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DE79   ; Entity health (32 bytes)
entity_anim_frame   EQU #DE99   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DEB9   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DED9   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DEF9   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DF19   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DF39   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DF59   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DF79   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DF99   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DFB9   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DFD9   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #DFF9   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E019   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E039   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E059   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E079   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E099   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E0B9   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E0D9   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E0F9   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E119   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E139   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E159   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E179   ; Number of sprites currently active
sprites_dirty      EQU #E17A   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E17B   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E19B   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E1BB   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E1DB   ; Runtime base 16x16 slot per sprite asset (3 bytes)
sprite_placeholder_base_pattern_num EQU #E1DE   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E1DF   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E1E0   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #E260   ; Currently displayed screen ID
screen_dirty_flag   EQU #E261   ; Screen needs redraw flag
screen_transition_cooldown EQU #E262   ; Cooldown frames after screen transition
current_world_id    EQU #E263   ; Current world ID (for multi-world support)
current_screen_index EQU #E264   ; Current screen index within world
current_screen_anim_group_count EQU #E265   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E266   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E267   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E268   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E269   ; Player X position (16-bit)
player_y            EQU #E26B   ; Player Y position (16-bit)
player_runtime_enabled EQU #E26D   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E26E   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E26F   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E270   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E271   ; Player health points
player_score        EQU #E272   ; Player score (16-bit)
gem_count           EQU #E274   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E275   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E276   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E277   ; Interaction type id of last interacted tile
last_interaction_value EQU #E278   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E279   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E27A   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E27B   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E27C   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E27D   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E27E   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E2BE   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E2FE   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E33E   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E37E   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E38E   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E39E   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E3AE   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E3BE   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E3CE   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E3DE   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E3DF   ; Temporary 16-bit storage
temp_word_2         EQU #E3E1   ; Temporary 16-bit storage
temp_byte_1         EQU #E3E3   ; Temporary 8-bit storage
temp_byte_2         EQU #E3E4   ; Temporary 8-bit storage
temp_byte_3         EQU #E3E5   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E405   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E425   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E445   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E465   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E466   ; Frames remaining for current SFX
sfx_fadeout         EQU #E467   ; Reserved fadeout flag/state
temp_byte_7         EQU #E468   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E488   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E4A8   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E4C8   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E4E8   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E508   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E528   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E548   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E568   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E588   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E5A8   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E5C8   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E5E8   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E608   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E628   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E648   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E668   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E688   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E6A8   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E6C8   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E708   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E748   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E768   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E788   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E7A8   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E7A9   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E7AA   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E7AB   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E7AC   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E7AD   ; Cached entity X for wall checks
wall_temp_y         EQU #E7AE   ; Cached entity Y for wall checks
wall_hit_left       EQU #E7AF   ; Hitbox left edge cache
wall_hit_top        EQU #E7B0   ; Hitbox top edge cache
wall_hit_right      EQU #E7B1   ; Hitbox right edge cache
wall_hit_bottom     EQU #E7B2   ; Hitbox bottom edge cache
wall_hit_w          EQU #E7B3   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E7B4   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E7B5   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E7B6   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E7B7   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E7B8   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E7B9   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E7D9   ; Number of entries in active_entity_list
hero_entity_id      EQU #E7DA   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E7DB   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E7DC   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E7FC   ; Number of entries in input_entity_list
render_entity_list  EQU #E7FD   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E81D   ; Number of entries in render_entity_list
collision_entity_list EQU #E81E   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E83E   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E83F   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E85F   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E860   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E880   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E881   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E8A1   ; Number of entities in coll_list
coll_src_left       EQU #E8A2   ; Source AABB left edge (scratch)
coll_src_right      EQU #E8A3   ; Source AABB right edge (scratch)
coll_src_top        EQU #E8A4   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E8A5   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E8A6   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E8A6   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E8A8   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E8AA   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E8AC   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E8AE   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E8B0   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E8B2   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E8B4   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E8B6   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E8B7   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E8BC   ; Frame counter (16-bit)
task_exec_time          EQU #E8BE   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E8C0   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E8C1   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E8C1   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E8C2   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E8C3   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E8C4   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E8C5   ; 0=stopped, 1=track active
music_muted          EQU #E8C6   ; 0=audible, 1=muted/pause
music_loop           EQU #E8C7   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E8C8   ; Current ROM track index
music_row_frames     EQU #E8C9   ; Frames per tracker row
music_row_countdown  EQU #E8CA   ; Countdown to next row
music_order_pos      EQU #E8CB   ; Current order position
music_pattern_index  EQU #E8CC   ; Current pattern index
music_pattern_row    EQU #E8CD   ; Current row inside pattern
music_pattern_rows   EQU #E8CE   ; Cached rows in current pattern
music_track_ptr_l    EQU #E8CF   ; Current track pointer low byte
music_track_ptr_h    EQU #E8D0   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E8D1   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E8D2   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E8D3   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E8D4   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E8D4   ; Channel A
music_ch_b_note EQU #E8D5   ; Channel B
music_ch_c_note EQU #E8D6   ; Channel C
music_ch_instrument_base EQU #E8D7   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E8D7   ; Channel A
music_ch_b_instrument EQU #E8D8   ; Channel B
music_ch_c_instrument EQU #E8D9   ; Channel C
music_ch_ornament_base EQU #E8DA   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E8DA   ; Channel A
music_ch_b_ornament EQU #E8DB   ; Channel B
music_ch_c_ornament EQU #E8DC   ; Channel C
music_ch_volume_base EQU #E8DD   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E8DD   ; Channel A
music_ch_b_volume EQU #E8DE   ; Channel B
music_ch_c_volume EQU #E8DF   ; Channel C
music_ch_vol_step_base EQU #E8E0   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E8E0   ; Channel A
music_ch_b_vol_step EQU #E8E1   ; Channel B
music_ch_c_vol_step EQU #E8E2   ; Channel C
music_ch_tone_step_base EQU #E8E3   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E8E3   ; Channel A
music_ch_b_tone_step EQU #E8E4   ; Channel B
music_ch_c_tone_step EQU #E8E5   ; Channel C
music_ch_noise_step_base EQU #E8E6   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E8E6   ; Channel A
music_ch_b_noise_step EQU #E8E7   ; Channel B
music_ch_c_noise_step EQU #E8E8   ; Channel C
music_ch_orn_step_base EQU #E8E9   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E8E9   ; Channel A
music_ch_b_orn_step EQU #E8EA   ; Channel B
music_ch_c_orn_step EQU #E8EB   ; Channel C
...
ZX0_SCREEN_BUFFER       EQU #E900   ; Screen/layout scratch (768 bytes, shared area)
ZX0_BEHAVIOR_BUFFER     EQU #E900   ; Behavior map scratch (768 bytes, shared area)
ZX0_TILE_PATTERN_BUFFER EQU #E900   ; Tile pattern scratch (1488 bytes, shared area)
ZX0_TILE_COLOR_BUFFER   EQU #E900   ; Tile color scratch (1488 bytes, shared area)
ZX0_FONT_PATTERN_BUFFER EQU #EED0   ; Font pattern scratch (360 bytes)
ZX0_FONT_COLOR_BUFFER   EQU #F040   ; Font color scratch (360 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E8EC   ; End of project variables (10476 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E8EC: Project variables (10476 bytes)
;   #E8EC-#F37F: Free RAM (~2708 bytes available)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (72 -> 43 bytes)
    DB #21,#7E,#FF,#BC,#FE,#F0,#89,#7F,#FE,#22,#7E,#7F,#58,#FE,#7E,#42
    DB #FF,#F9,#FF,#66,#81,#3C,#7E,#7E,#3C,#81,#00,#F1,#D2,#EB,#EF,#00
    DB #AA,#ED,#00,#AB,#BF,#00,#EE,#B5,#F0,#55,#58
load_pattern_bank0:
...
tile_color_bank0:
    ...
    DB #96,#21,#96,#61,#96,#51,#96,#F1,#96,#A1,#8F,#B1,#E7,#A8,#F6,#B1
    DB #E3,#F2,#9A,#C0,#81,#E6,#F0,#B5,#C1,#55,#58
load_color_bank0:
...
;; Size: 16x16
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_2_F0_DATA (32 bytes)
    ; ZX0 compressed sprite pattern moved to ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_2_F1_DATA (32 bytes)
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (464 -> 106 bytes)
    DB #95,#FF,#8E,#80,#81,#FD,#23,#82,#83,#FE,#F5,#E9,#F5,#E0,#1F,#C0
    DB #5F,#EC,#F9,#F9,#B0,#7F,#F0,#86,#66,#9A,#84,#84,#39,#44,#28,#85
    DB #7F,#F9,#A8,#5F,#CF,#97,#DC,#F7,#E7,#3C,#97,#40,#75,#F4,#E1,#04
    DB #BF,#84,#F7,#31,#DE,#20,#0E,#5F,#CE,#3C,#90,#7D,#80,#79,#EC,#7D
    DB #F0,#F1,#A4,#BD,#84,#5A,#39,#26,#7E,#F9,#62,#1A,#FF,#7D,#E6,#A7
    DB #81,#DC,#76,#85,#70,#A1,#85,#79,#72,#B8,#87,#C0,#7C,#DE,#CC,#10
    DB #28,#87,#13,#96,#E0,#85,#87,#D5,#55,#60
SCREEN_PAN1_0_BLOCK_MAP:
    ; ZX0 compressed screen_block_map (48 -> 42 bytes)
    DB #96,#00,#21,#01,#02,#80,#1D,#03,#04,#00,#05,#00,#06,#07,#08,#09
    DB #0A,#0B,#0C,#0D,#0E,#00,#0F,#10,#04,#11,#12,#13,#14,#15,#00,#10
    DB #16,#17,#18,#19,#1A,#1B,#16,#1C,#55,#56
...
SM_New_Statemachine_state_1776707744092_Transitions: 
    ...
    DW SM_New_Statemachine_state_1776790058414 
...
ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_2_F0_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_RIGHT_2_F0 (32 -> 31 bytes)
    DB #4E,#00,#01,#02,#05,#0B,#09,#F5,#0B,#05,#09,#11,#01,#E2,#FF,#FD
    DB #C0,#20,#AA,#A0,#80,#9F,#D0,#CC,#C0,#F5,#B5,#FF,#C0,#55,#58
ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_2_F1_DATA:
    ; ZX0 compressed sprite frame HERO_WALK_RIGHT_2_F1 (32 -> 31 bytes)
...
; Frame group: HERO_WALK_RIGHT_2_F0
HERO_WALK_RIGHT_2_F0_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_2_F0_DATA
; Frame group: HERO_WALK_RIGHT_2_F1
HERO_WALK_RIGHT_2_F1_LAYER1 EQU ZX0_SPRITE_FRAME_HERO_WALK_RIGHT_2_F1_DATA
