...
; BANK 00 @#093E : entities.asm (3098 bytes)
; BANK 00 @#1558 : worlds.asm (1793 bytes)
; BANK 00 @#1C59 : screens.asm (935 bytes)
; BANK 01 @#0000 : screens.asm (5286 bytes)
; BANK 01 @#14A6 : sprites.asm (2906 bytes)
; BANK 02 @#0000 : sprites.asm (541 bytes)
; BANK 02 @#021D : font.asm (3456 bytes)
; BANK 02 @#0F9D : hud.asm (3480 bytes)
; BANK 02 @#1D35 : menus.asm (168 bytes)
; BANK 02 @#1DDD : sound.asm part 1/2 (547 bytes)
; BANK 03 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 04 @#0000 : sound.asm part 3/2 (802 bytes)
; BANK 04 @#0322 : scroll.asm (2353 bytes)
; BANK 04 @#0C53 : animtiles.asm (4613 bytes)
; BANK 04 @#1E58 : statemachine.asm (5 bytes)
; BANK 04 @#1E5D : gameflow.asm (419 bytes)
; BANK 05 @#0000 : gameflow.asm (5602 bytes)
...
entity_lifetime     EQU #D659   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #D679   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #D699   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #D6B9   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #D6D9   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #D6F9   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #D719   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #D739   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #D759   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #D779   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #D799   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #D7B9   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #D7D9   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #D7F9   ; Number of sprites currently active
sprites_dirty      EQU #D7FA   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #D7FB   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #D81B   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #D83B   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #D85B   ; Runtime base 16x16 slot per sprite asset (2 bytes)
sprite_placeholder_base_pattern_num EQU #D85D   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #D85E   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #D85F   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #D8DF   ; Currently displayed screen ID
screen_dirty_flag   EQU #D8E0   ; Screen needs redraw flag
screen_transition_cooldown EQU #D8E1   ; Cooldown frames after screen transition
current_world_id    EQU #D8E2   ; Current world ID (for multi-world support)
current_screen_index EQU #D8E3   ; Current screen index within world
current_screen_anim_group_count EQU #D8E4   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #D8E5   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #D8E6   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #D8E7   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #D8E8   ; Player X position (16-bit)
player_y            EQU #D8EA   ; Player Y position (16-bit)
player_runtime_enabled EQU #D8EC   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #D8ED   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #D8EE   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #D8EF   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #D8F0   ; Player health points
player_score        EQU #D8F1   ; Player score (16-bit)
gem_count           EQU #D8F3   ; Collectible tile counter (8-bit)
last_gem_char       EQU #D8F4   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #D8F5   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #D8F6   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #D936   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #D976   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #D9B6   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #D9F6   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #DA06   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #DA16   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #DA26   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #DA36   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #DA46   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #DA56   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #DA57   ; Temporary 16-bit storage
temp_word_2         EQU #DA59   ; Temporary 16-bit storage
temp_byte_1         EQU #DA5B   ; Temporary 8-bit storage
temp_byte_2         EQU #DA5C   ; Temporary 8-bit storage
temp_byte_3         EQU #DA5D   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #DA7D   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #DA9D   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #DABD   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #DADD   ; 0=no SFX active, 1=playing
sfx_timer           EQU #DADE   ; Frames remaining for current SFX
sfx_fadeout         EQU #DADF   ; Reserved fadeout flag/state
temp_byte_7         EQU #DAE0   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #DB00   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #DB20   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #DB40   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #DB60   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #DB80   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #DBA0   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #DBC0   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #DBE0   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #DC00   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #DC20   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #DC40   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #DC60   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #DC80   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #DCA0   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #DCC0   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #DCE0   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #DD00   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #DD20   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #DD40   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #DD80   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #DDC0   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #DDE0   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #DE00   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #DE20   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #DE21   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #DE22   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #DE23   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #DE24   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #DE25   ; Cached entity X for wall checks
wall_temp_y         EQU #DE26   ; Cached entity Y for wall checks
wall_hit_left       EQU #DE27   ; Hitbox left edge cache
wall_hit_top        EQU #DE28   ; Hitbox top edge cache
wall_hit_right      EQU #DE29   ; Hitbox right edge cache
wall_hit_bottom     EQU #DE2A   ; Hitbox bottom edge cache
wall_hit_w          EQU #DE2B   ; Hitbox width cache (min 1)
wall_hit_h          EQU #DE2C   ; Hitbox height cache (min 1)
wall_probe_left     EQU #DE2D   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #DE2E   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #DE2F   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #DE30   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #DE31   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #DE51   ; Number of entries in active_entity_list
hero_entity_id      EQU #DE52   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #DE53   ; 1=rebuild active_entity_list required
input_entity_list   EQU #DE54   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #DE74   ; Number of entries in input_entity_list
render_entity_list  EQU #DE75   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #DE95   ; Number of entries in render_entity_list
collision_entity_list EQU #DE96   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #DEB6   ; Number of entries in collision_entity_list
ground_entity_list  EQU #DEB7   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #DED7   ; Number of entries in ground_entity_list
anim_entity_list    EQU #DED8   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #DEF8   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #DEF9   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #DF19   ; Number of entities in coll_list
coll_src_left       EQU #DF1A   ; Source AABB left edge (scratch)
coll_src_right      EQU #DF1B   ; Source AABB right edge (scratch)
coll_src_top        EQU #DF1C   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #DF1D   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #DF1E   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #DF1E   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #DF20   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #DF22   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #DF24   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #DF26   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #DF28   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #DF2A   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #DF2C   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #DF2E   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #DF2F   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #DF34   ; Frame counter (16-bit)
task_exec_time          EQU #DF36   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #DF38   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #DF39   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #DF39   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #DF3A   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #DF3B   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #DF3C   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #DF3D   ; 0=stopped, 1=track active
music_muted          EQU #DF3E   ; 0=audible, 1=muted/pause
music_loop           EQU #DF3F   ; 0=no loop, 1=loop enabled
music_track_index    EQU #DF40   ; Current ROM track index
music_row_frames     EQU #DF41   ; Frames per tracker row
music_row_countdown  EQU #DF42   ; Countdown to next row
music_order_pos      EQU #DF43   ; Current order position
music_pattern_index  EQU #DF44   ; Current pattern index
music_pattern_row    EQU #DF45   ; Current row inside pattern
music_pattern_rows   EQU #DF46   ; Cached rows in current pattern
music_track_ptr_l    EQU #DF47   ; Current track pointer low byte
music_track_ptr_h    EQU #DF48   ; Current track pointer high byte
music_pattern_ptr_l  EQU #DF49   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #DF4A   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #DF4B   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #DF4C   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #DF4C   ; Channel A
music_ch_b_note EQU #DF4D   ; Channel B
music_ch_c_note EQU #DF4E   ; Channel C
music_ch_instrument_base EQU #DF4F   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #DF4F   ; Channel A
music_ch_b_instrument EQU #DF50   ; Channel B
music_ch_c_instrument EQU #DF51   ; Channel C
music_ch_ornament_base EQU #DF52   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #DF52   ; Channel A
music_ch_b_ornament EQU #DF53   ; Channel B
music_ch_c_ornament EQU #DF54   ; Channel C
music_ch_volume_base EQU #DF55   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #DF55   ; Channel A
music_ch_b_volume EQU #DF56   ; Channel B
music_ch_c_volume EQU #DF57   ; Channel C
music_ch_vol_step_base EQU #DF58   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #DF58   ; Channel A
music_ch_b_vol_step EQU #DF59   ; Channel B
music_ch_c_vol_step EQU #DF5A   ; Channel C
music_ch_tone_step_base EQU #DF5B   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #DF5B   ; Channel A
music_ch_b_tone_step EQU #DF5C   ; Channel B
music_ch_c_tone_step EQU #DF5D   ; Channel C
music_ch_noise_step_base EQU #DF5E   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #DF5E   ; Channel A
music_ch_b_noise_step EQU #DF5F   ; Channel B
music_ch_c_noise_step EQU #DF60   ; Channel C
music_ch_orn_step_base EQU #DF61   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #DF61   ; Channel A
music_ch_b_orn_step EQU #DF62   ; Channel B
music_ch_c_orn_step EQU #DF63   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #DF64   ; End of project variables (8036 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#DF64: Project variables (8036 bytes)
;   #DF64-#F37F: Free RAM (~5148 bytes available)
...
;   Active entities: 1
;   Used components: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Health, DeadlyTiles, Jump, Gravity, Animation, Collision, Input, Cursors 
