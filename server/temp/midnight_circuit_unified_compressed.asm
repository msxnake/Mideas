...
; BANK 02 @#0000 : sound.asm part 3/2 (2389 bytes)
; BANK 02 @#0955 : scroll.asm (2407 bytes)
; BANK 02 @#12BC : animtiles.asm (2549 bytes)
; BANK 02 @#1CB1 : bosses.asm (847 bytes)
; BANK 03 @#0000 : bosses.asm (4935 bytes)
; BANK 03 @#1347 : statemachine.asm (5 bytes)
; BANK 03 @#134C : gameflow.asm (3252 bytes)
; BANK 04 @#0000 : gameflow.asm (1674 bytes)
...
; Flow: Start → Music (gf_midnight_music)
; ==================================================================
...
music_track_ptr_table:
    DW music_track_0_Midnight_Circuit_data

; ------------------------------------------------------------------
; Tracker Song 0: Midnight Circuit
; ------------------------------------------------------------------
music_track_0_Midnight_Circuit_data:
    DB #05
    DB #02
    DB #00
    DB #01
    DB #02
    DW music_track_0_Midnight_Circuit_order_table
    DW music_track_0_Midnight_Circuit_pattern_table
    DW music_track_0_Midnight_Circuit_instrument_ptr_table
    DW music_track_0_Midnight_Circuit_ornament_ptr_table
    DW #00D2
    DB #0A

music_track_0_Midnight_Circuit_order_table:
    DB #00,#01

music_track_0_Midnight_Circuit_pattern_table:
    DW music_track_0_Midnight_Circuit_pattern_0_rows
    DB #40
    DW music_track_0_Midnight_Circuit_pattern_1_rows
    DB #40

music_track_0_Midnight_Circuit_instrument_ptr_table:
    DW 0
    DW music_track_0_Midnight_Circuit_inst_1
    DW music_track_0_Midnight_Circuit_inst_2
    DW 0
    DW 0
    DW music_track_0_Midnight_Circuit_inst_5
    DW music_track_0_Midnight_Circuit_inst_6
    DW music_track_0_Midnight_Circuit_inst_7
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_Midnight_Circuit_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_Midnight_Circuit_pattern_0_rows:
    DB #31,#01,#FF,#0F,#19,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #38,#01,#FF,#0F,#19,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#14,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #38,#01,#FF,#0F,#19,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #36,#01,#FF,#0F,#17,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#17,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#12,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#17,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #36,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #34,#01,#FF,#0F,#15,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #38,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#15,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#10,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#15,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #38,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #36,#01,#FF,#0F,#14,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #38,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#14,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#0F,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#14,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_Midnight_Circuit_pattern_1_rows:
    DB #38,#01,#FF,#0F,#14,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#14,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #44,#01,#FF,#0F,#0F,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#14,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#15,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#15,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #44,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#10,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#15,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#17,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#17,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #45,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #44,#01,#FF,#0F,#12,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #42,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3F,#01,#FF,#0F,#17,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3D,#01,#FF,#0F,#19,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #44,#01,#FF,#0F,#19,#02,#FF,#0F,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #49,#01,#FF,#0F,#14,#02,#FF,#0F,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #47,#01,#FF,#0F,#FF,#FF,#FF,#FF,#1E,#07,#FF,#0A
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #44,#01,#FF,#0F,#19,#02,#FF,#0F,#1A,#06,#FF,#0E
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #40,#01,#FF,#0F,#FF,#FF,#FF,#FF,#FF,#05,#FF,#0F
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_Midnight_Circuit_inst_1:
    DB #01
    DB #0F
    DB #00
    DB #0A
    DW #00D2
    DW music_track_0_Midnight_Circuit_inst_1_vol_env
    DB #0B
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_1_tone_env
    DB #03
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_Midnight_Circuit_inst_1_vol_env:
    DB #0F,#0F,#0E,#0D,#0B,#09,#07,#05,#03,#01,#00
music_track_0_Midnight_Circuit_inst_1_tone_env:
    DB #00,#01,#00

music_track_0_Midnight_Circuit_inst_2:
    DB #01
    DB #0F
    DB #00
    DB #0A
    DW #00D2
    DW music_track_0_Midnight_Circuit_inst_2_vol_env
    DB #09
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_2_tone_env
    DB #04
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_Midnight_Circuit_inst_2_vol_env:
    DB #0F,#0E,#0E,#0C,#0A,#08,#05,#02,#00
music_track_0_Midnight_Circuit_inst_2_tone_env:
    DB #00,#FF,#00,#FF

music_track_0_Midnight_Circuit_inst_5:
    DB #03
    DB #0F
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_Midnight_Circuit_inst_5_vol_env
    DB #06
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_5_tone_env
    DB #04
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_5_noise_env
    DB #04
    DB #FF
music_track_0_Midnight_Circuit_inst_5_vol_env:
    DB #0F,#0E,#0B,#07,#03,#00
music_track_0_Midnight_Circuit_inst_5_tone_env:
    DB #E0,#EC,#F6,#00
music_track_0_Midnight_Circuit_inst_5_noise_env:
    DB #02,#05,#0A,#12

music_track_0_Midnight_Circuit_inst_6:
    DB #02
    DB #0E
    DB #00
    DB #08
    DW #00D2
    DW music_track_0_Midnight_Circuit_inst_6_vol_env
    DB #06
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_6_tone_env
    DB #01
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_6_noise_env
    DB #04
    DB #FF
music_track_0_Midnight_Circuit_inst_6_vol_env:
    DB #0E,#0B,#08,#04,#01,#00
music_track_0_Midnight_Circuit_inst_6_tone_env:
    DB #00
music_track_0_Midnight_Circuit_inst_6_noise_env:
    DB #07,#0C,#12,#1A

music_track_0_Midnight_Circuit_inst_7:
    DB #02
    DB #09
    DB #00
    DB #02
    DW #00D2
    DW music_track_0_Midnight_Circuit_inst_7_vol_env
    DB #05
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_7_tone_env
    DB #01
    DB #FF
    DW music_track_0_Midnight_Circuit_inst_7_noise_env
    DB #04
    DB #FF
music_track_0_Midnight_Circuit_inst_7_vol_env:
    DB #09,#07,#05,#02,#00
music_track_0_Midnight_Circuit_inst_7_tone_env:
    DB #00
music_track_0_Midnight_Circuit_inst_7_noise_env:
    DB #02,#03,#05,#07
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_midnight_start
...
; Node: Start - "gf_midnight_start"
gameflow_node_gf_midnight_start:
    db NODE_TYPE_START
    dw gameflow_node_gf_midnight_start_data
    dw gameflow_node_gf_midnight_start_conn

gameflow_node_gf_midnight_start_data:
    dw gameflow_node_gf_midnight_start_init    ; Initialization routine address
    db ((gameflow_node_gf_midnight_start_init - #4000) / #2000)    ; Initialization routine bank

gameflow_node_gf_midnight_start_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_midnight_music
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_midnight_start_init
...
; Node: Music - "gf_midnight_music"
gameflow_node_gf_midnight_music:
    db NODE_TYPE_MUSIC
    dw gameflow_node_gf_midnight_music_data
    dw gameflow_node_gf_midnight_music_conn

gameflow_node_gf_midnight_music_data:
    db 1, 0, 1    ; command, track index, loop flag

gameflow_node_gf_midnight_music_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gf_midnight_end
    db CONNECTION_END

; Node: End - "gf_midnight_end"
gameflow_node_gf_midnight_end:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gf_midnight_end_conn

gameflow_node_gf_midnight_end_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
