...
; Estimated payload bytes: 103769
...
; BANK 01 @#0000 : entities.asm part 2/2 (4372 bytes)
; BANK 01 @#1114 : worlds.asm (3820 bytes)
; BANK 02 @#0000 : worlds.asm (2739 bytes)
; BANK 02 @#0AB3 : screens.asm part 1/3 (5453 bytes)
; BANK 03 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 04 @#0000 : screens.asm part 3/3 (5223 bytes)
; BANK 04 @#1467 : sprites.asm part 1/4 (2969 bytes)
; BANK 05 @#0000 : sprites.asm part 2/4 (8192 bytes)
; BANK 06 @#0000 : sprites.asm part 3/4 (8192 bytes)
; BANK 07 @#0000 : sprites.asm part 4/4 (8192 bytes)
; BANK 08 @#0000 : sprites.asm part 5/4 (1822 bytes)
; BANK 08 @#071E : font.asm (174 bytes)
; BANK 08 @#07CC : hud.asm (71 bytes)
; BANK 08 @#0813 : menus.asm (168 bytes)
; BANK 08 @#08BB : sound.asm (3184 bytes)
; BANK 08 @#152B : scroll.asm (2353 bytes)
; BANK 08 @#1E5C : animtiles.asm (420 bytes)
; BANK 09 @#0000 : animtiles.asm (2929 bytes)
; BANK 09 @#0B71 : particles.asm (4963 bytes)
; BANK 09 @#1ED4 : statemachine.asm part 1/3 (300 bytes)
; BANK 10 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 12 @#0000 : statemachine.asm part 4/3 (420 bytes)
; BANK 12 @#01A4 : gameflow.asm (5045 bytes)
...
;   Active entities: 8
;   Used components: Position, Sprite, Jump, Gravity, Animation, Input, Cursors, WallCollision, Collectible, Collision
;   Filtered out: -2 unused component systems
    ;
; ==================================================================
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Jump, Gravity, Animation, Input, Cursors, WallCollision, Collectible, Collision 
...
update_all_entities:
    ...
    ret
; Total systems called: 11 (optimized from 15)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (424 -> 303 bytes)
    ...
    DB #0B,#E1,#07,#C3,#AA,#07,#85,#03,#FF,#7E,#77,#DA,#59,#2C,#A0,#FE
    DB #E5,#EE,#00,#DA,#FF,#FE,#6F,#6B,#CE,#28,#B6,#03,#55,#55,#80
load_pattern_bank0:
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (424 -> 71 bytes)
    ...
    DB #B2,#60,#E2,#66,#76,#7E,#7B,#FD,#66,#1E,#88,#7A,#1B,#BF,#76,#F1
    DB #FE,#5A,#1D,#55,#D5,#55,#60
load_color_bank0:
...
SPRITE_18_PATTERN_BANK EQU ((SPRITE_18_PATTERN - #4000) / #2000)
...
SPRITE_19_PATTERN_BANK EQU ((SPRITE_19_PATTERN - #4000) / #2000)
...
SPRITE_20_PATTERN_BANK EQU ((SPRITE_20_PATTERN - #4000) / #2000)
...
SPRITE_21_PATTERN_BANK EQU ((SPRITE_21_PATTERN - #4000) / #2000)
...
SPRITE_22_PATTERN_BANK EQU ((SPRITE_22_PATTERN - #4000) / #2000)
...
SPRITE_23_PATTERN_BANK EQU ((SPRITE_23_PATTERN - #4000) / #2000)
...
entity_sprite_config: 
    ...
    db 2, 1 ; Entity 1 (gema1)
    db 3, 1 ; Entity 2 (gema1)
    db 4, 1 ; Entity 3 (gema1)
    db 5, 1 ; Entity 4 (gema1)
...
entity_sprite_asset_index_init:
    ...
    db #05 ; Entity 1 (gema1)
    db #05 ; Entity 2 (gema1)
    db #05 ; Entity 3 (gema1)
    db #05 ; Entity 4 (gema1)
...
sprite_layer_colors: 
    ...
    db 15 ; Layer 0
    db 6 ; Layer 1
    ; Entity 1 (gema1) layers:
    db 8 ; Layer 0
    ; Entity 2 (gema1) layers:
    db 8 ; Layer 0
    ; Entity 3 (gema1) layers:
    db 8 ; Layer 0
    ; Entity 4 (gema1) layers:
    db 8 ; Layer 0
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #91,#00,#69,#01,#F5,#C0,#1F,#F9,#81,#C0,#11,#FF,#CB,#FE,#C1,#C0
    DB #3D,#CE,#F0,#C0,#78,#BC,#76,#D8,#10,#FF,#AE,#58,#17,#81,#C2,#F0
    DB #FE,#51,#D5,#55,#60
...
SCREEN_PAN2_1_LAYOUT:
    ...
    DB #95,#00,#55,#8E,#95,#96,#FC,#08,#E1,#A5,#A6,#C0,#23,#97,#98,#82
    DB #FC,#37,#A7,#A8,#00,#10,#48,#FF,#99,#9A,#F8,#D4,#58,#CE,#80,#81
    DB #E7,#F4,#60,#F3,#9B,#9C,#88,#88,#F9,#C5,#C6,#FC,#33,#82,#83,#E7
    DB #F8,#D1,#F4,#F3,#9D,#9E,#E5,#B4,#F1,#FC,#C9,#4C,#E0,#05,#94,#A9
    DB #AA,#9F,#A0,#23,#AB,#AC,#F0,#81,#C4,#7C,#80,#05,#D5,#55,#60
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #95,#00,#55,#A4,#01,#3D,#C0,#5D,#C4,#00,#43,#F6,#F8,#14,#17,#B8
    DB #F4,#FE,#13,#91,#AC,#F7,#4C,#34,#96,#78,#C0,#01,#75,#55,#58
...
SCREEN_PAN3_2_LAYOUT:
    ...
    DB #65,#A9,#AA,#00,#19,#94,#AB,#AC,#00,#7C,#80,#44,#BC,#88,#00,#58
    DB #64,#80,#81,#81,#A5,#A6,#58,#60,#82,#83,#83,#A7,#A8,#43,#8E,#6F
    DB #95,#96,#FC,#4E,#00,#4F,#6E,#63,#97,#98,#93,#FC,#F2,#81,#13,#80
    DB #15,#1B,#88,#F1,#FF,#C0,#37,#22,#DC,#7D,#91,#7E,#FD,#C8,#F3,#22
    DB #8F,#36,#7E,#FF,#82,#A6,#C6,#78,#C8,#D8,#F8,#22,#9D,#9E,#0F,#A6
    DB #FF,#BF,#66,#DC,#C7,#78,#62,#9F,#A0,#4E,#74,#DE,#DF,#C6,#1F,#80
...
BEHAVIOR_PAN3_2_DATA:
    ...
    DB #A9,#01,#00,#47,#81,#C0,#12,#91,#01,#7F,#F1,#FE,#F1,#C0,#0F,#DE
    DB #5F,#FE,#5F,#C0,#57,#C8,#FF,#80,#51,#77,#BE,#57,#67,#7C,#91,#AE
    DB #DC,#3C,#37,#22,#5E,#E6,#4F,#C0,#38,#D4,#3D,#66,#3D,#C0,#F5,#90
    DB #E4,#C0,#69,#00,#54,#F7,#FE,#85,#C0,#75,#55,#58
...
SCREEN_PAN4_3_LAYOUT:
    ...
    DB #99,#00,#80,#A9,#AA,#00,#98,#99,#9A,#00,#12,#38,#AB,#AC,#C0,#22
    DB #9B,#9C,#57,#D2,#80,#25,#9D,#9E,#48,#90,#9F,#A0,#02,#3C,#95,#96
    DB #FC,#38,#80,#08,#F0,#97,#98,#FC,#E6,#80,#39,#A1,#A2,#60,#77,#E4
    DB #5E,#81,#39,#A3,#A4,#BC,#0F,#65,#83,#00,#FC,#BC,#80,#1F,#F9,#9F
    DB #BC,#80,#07,#DE,#BC,#80,#57,#DF,#BC,#80,#17,#D1,#00,#DD,#80,#19
    DB #24,#00,#80,#81,#81,#A5,#A6,#59,#61,#82,#83,#83,#A7,#A8,#A5,#A6
    DB #5F,#A8,#7B,#BC,#90,#80,#F7,#A8,#BC,#78,#80,#5F,#E8,#C7,#F4,#77
    DB #DA,#BD,#00,#80,#3E,#E8,#F1,#88,#FF,#CD,#F4,#BD,#DB,#00,#80,#7D
    DB #FF,#7F,#14,#DF,#CF,#02,#00,#4F,#FE,#D7,#14,#BF,#00,#DE,#FD,#DA
    DB #D9,#55,#56
...
BEHAVIOR_PAN4_3_DATA:
    ; ZX0 compressed behavior (768 -> 72 bytes)
    DB #9A,#00,#01,#A5,#00,#FF,#EA,#FE,#1E,#C0,#45,#5F,#FE,#5E,#C0,#11
    DB #FF,#F0,#4E,#07,#9F,#AC,#C0,#17,#9F,#B8,#C0,#17,#9F,#BC,#C0,#07
    DB #DF,#BC,#C0,#17,#F5,#FF,#C0,#7F,#FF,#C0,#40,#D8,#38,#F5,#C0,#79
    DB #00,#5D,#97,#36,#D4,#C0,#3D,#E8,#78,#D8,#1F,#FE,#F1,#C0,#29,#00
    DB #1A,#01,#14,#A1,#00,#35,#55,#58
...
SCREEN_PAN5_4_LAYOUT:
    ...
    DB #99,#00,#88,#9D,#AA,#00,#F7,#85,#84,#FC,#EF,#F6,#00,#FE,#F6,#EE
    DB #3A,#9F,#AC,#F6,#3D,#87,#86,#FC,#FE,#F6,#C0,#3F,#EE,#83,#80,#CF
    DB #86,#9A,#F7,#FE,#F8,#E4,#80,#3C,#86,#FF,#9A,#FE,#7F,#E4,#84,#00
    DB #FF,#DA,#00,#17,#83,#C0,#FF,#E4,#9E,#B9,#80,#FE,#0F,#87,#FF,#7B
    DB #9E,#81,#91,#C0,#BB,#87,#7A,#F9,#38,#80,#5F,#7A,#FE,#38,#80,#57
    ...
    DB #CC,#00,#1F,#FC,#5F,#80,#0F,#86,#4F,#00,#0F,#E6,#E0,#82,#67,#84
    DB #A1,#A2,#64,#E6,#E1,#00,#27,#A3,#A4,#88,#9F,#FE,#E6,#FD,#BD,#FC
...
BEHAVIOR_PAN5_4_DATA:
    ; ZX0 compressed behavior (768 -> 71 bytes)
    DB #9A,#00,#01,#FF,#F6,#FE,#0F,#E1,#CF,#DA,#C0,#04,#FF,#DA,#C0,#05
    DB #7D,#DA,#E4,#FE,#3B,#D2,#D4,#C0,#28,#00,#14,#F7,#BA,#FD,#F8,#EC
    DB #F5,#C0,#7F,#F8,#61,#7A,#79,#EC,#7F,#F6,#C1,#C0,#F7,#B6,#DE,#FE
    DB #C0,#42,#95,#00,#1D,#70,#1C,#D7,#C0,#07,#D7,#FE,#91,#C0,#3D,#3C
    DB #0F,#C1,#C0,#FE,#4D,#55,#56
SCREEN_PAN62_5_WIDTH     EQU 32
SCREEN_PAN62_5_HEIGHT    EQU 24
SCREEN_PAN62_5_SIZE      EQU 768

SCREEN_PAN62_5_LAYOUT:
    ; ZX0 compressed layout (768 -> 102 bytes)
    DB #25,#84,#00,#4B,#86,#D4,#C0,#F0,#80,#1E,#9B,#F3,#85,#FC,#F9,#E6
    DB #00,#54,#A1,#84,#2F,#88,#FF,#84,#42,#F7,#81,#DA,#7D,#FC,#F1,#80
    DB #F5,#00,#28,#86,#13,#C5,#80,#1D,#74,#80,#13,#31,#9C,#E5,#90,#6F
    DB #87,#8C,#E6,#FD,#86,#95,#96,#42,#3C,#A5,#A6,#C0,#CD,#2E,#9E,#84
    DB #97,#98,#FC,#58,#F2,#A7,#A8,#7E,#8E,#87,#42,#3D,#00,#27,#A3,#A4
    DB #88,#9F,#FE,#CA,#ED,#B8,#D7,#00,#F1,#3D,#FC,#BD,#86,#80,#3F,#3D
    DB #FC,#1B,#84,#55,#55,#80
BEHAVIOR_PAN62_5_WIDTH     EQU 32
BEHAVIOR_PAN62_5_HEIGHT    EQU 24
BEHAVIOR_PAN62_5_SIZE      EQU 768

BEHAVIOR_PAN62_5_DATA:
    ; ZX0 compressed behavior (768 -> 51 bytes)
    DB #25,#01,#00,#4E,#C0,#40,#7F,#DB,#FE,#79,#40,#10,#F5,#28,#E5,#12
    DB #E1,#C0,#77,#DA,#1F,#B6,#5E,#98,#13,#91,#C0,#42,#85,#00,#03,#37
    DB #A4,#C4,#C0,#E7,#F0,#D7,#FE,#85,#C0,#3D,#E0,#7D,#D2,#78,#C0,#15
    DB #D5,#55,#60
...
SCREEN_PAN7_6_LAYOUT:
    ...
    DB #7C,#84,#A1,#A2,#FC,#1B,#85,#8F,#FB,#86,#00,#FE,#06,#6B,#91,#92
    DB #00,#84,#C4,#C0,#88,#93,#94,#E0,#80,#7B,#9B,#85,#83,#FC,#D1,#80
    DB #89,#87,#86,#0E,#6E,#17,#D1,#80,#89,#86,#87,#53,#DF,#00,#6C,#E1
    DB #FC,#F4,#00,#17,#75,#00,#7E,#2D,#FC,#17,#C0,#00,#1E,#3D,#F0,#86
...
BEHAVIOR_PAN7_6_DATA:
    ; ZX0 compressed behavior (768 -> 43 bytes)
    DB #80,#01,#0A,#00,#44,#FF,#C6,#C0,#04,#E0,#4A,#F5,#80,#7C,#C0,#41
    DB #D9,#1E,#1D,#84,#C0,#43,#CC,#FF,#80,#41,#FF,#FE,#C8,#13,#84,#C0
    DB #39,#A2,#4D,#20,#40,#5F,#C0,#01,#75,#55,#58
color_shift_table:
...
; Entity: Key Item 1 (instance from template: tpl_item_key)
ENTITY_KEY_ITEM_1_2_ID EQU 6
ENTITY_KEY_ITEM_1_2_COMP_MASK EQU #8B  ; Component mask: 10001011b
; Template: tpl_item_key
ENTITY_KEY_ITEM_1_2_X EQU 27
ENTITY_KEY_ITEM_1_2_Y EQU 18

; Entity: Key Item 2 (instance from template: tpl_item_key)
ENTITY_KEY_ITEM_2_3_ID EQU 7
...
init_entities:
    ; Initialize all active game entities (8 entities)
...
update_entities:
    ; Update all active entities (8 entities)
...
init_player_1:
    ...
    ; Template: tpl_player
    ; Components: Position, Sprite, Input, Animation, Jump, Gravity
...
gameflow_node_gfn_1763447705454_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1771705446457
    db CONNECTION_END

; Node: End - "gfn_1771705446457"
gameflow_node_gfn_1771705446457:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gfn_1771705446457_conn

gameflow_node_gfn_1771705446457_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
...
load_world_worldmap_1760724209990:
    ...
    ld a, ((load_screen_pan1_760723005040 - #4000) / #2000)
    ld hl, load_screen_pan1_760723005040
    call mapper_call_hl_auto
...
transition_worldmap_1760724209990_1:
    ld a, ((load_screen_pan2_760784762679 - #4000) / #2000)
    ld hl, load_screen_pan2_760784762679
    call mapper_call_hl_auto
...
transition_worldmap_1760724209990_2:
    ld a, ((load_screen_pan3_760799152493 - #4000) / #2000)
    ld hl, load_screen_pan3_760799152493
    call mapper_call_hl_auto
...
transition_worldmap_1760724209990_3:
    ld a, ((load_screen_pan4_760799516565 - #4000) / #2000)
    ld hl, load_screen_pan4_760799516565
    call mapper_call_hl_auto
...
transition_worldmap_1760724209990_4:
    ld a, ((load_screen_pan5_760961565333 - #4000) / #2000)
    ld hl, load_screen_pan5_760961565333
    call mapper_call_hl_auto
...
transition_worldmap_1760724209990_5:
    ld a, ((load_screen_pan62_761237904051 - #4000) / #2000)
    ld hl, load_screen_pan62_761237904051
    call mapper_call_hl_auto
...
check_transition_worldmap_1760724209990_s3_apply_west:
    push de
    ld a, ((load_screen_pan7_761471728391 - #4000) / #2000)
    ld hl, load_screen_pan7_761471728391
    call mapper_call_hl_auto
    pop de
    ld a, 6
    ld (current_screen_index), a
...
; ==================================================================
ZX0_BEHAVIOR_BUFFER EQU #CC00

; ==================================================================
; ZX0 TILE PATTERN BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile pattern data decompression (424 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #CF00

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (424 bytes)
; ==================================================================
ZX0_TILE_COLOR_BUFFER EQU #D100
