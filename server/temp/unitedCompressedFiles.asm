...
; Estimated payload bytes: 93681
; Estimated banks used: 12
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (895 bytes)
; BANK 00 @#037F : colors.asm (834 bytes)
; BANK 00 @#06C1 : components.asm (22 bytes)
; BANK 00 @#06D7 : entities.asm (4994 bytes)
; BANK 00 @#1A59 : worlds.asm (1447 bytes)
; BANK 01 @#0000 : worlds.asm (1598 bytes)
; BANK 01 @#063E : screens.asm part 1/2 (6594 bytes)
; BANK 02 @#0000 : screens.asm part 2/2 (7582 bytes)
; BANK 02 @#1D9E : sprites.asm (610 bytes)
; BANK 03 @#0000 : sprites.asm (6046 bytes)
; BANK 03 @#179E : font.asm (2146 bytes)
; BANK 04 @#0000 : font.asm (1401 bytes)
; BANK 04 @#0579 : hud.asm (3836 bytes)
; BANK 04 @#1475 : menus.asm (444 bytes)
; BANK 04 @#1631 : sound.asm (2511 bytes)
; BANK 05 @#0000 : sound.asm (673 bytes)
; BANK 05 @#02A1 : scroll.asm (2353 bytes)
; BANK 05 @#0BD2 : animtiles.asm (3858 bytes)
; BANK 05 @#1AE4 : particles.asm (1308 bytes)
; BANK 06 @#0000 : particles.asm (3655 bytes)
; BANK 06 @#0E47 : statemachine.asm part 1/3 (4537 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 4/3 (3204 bytes)
; BANK 09 @#0C84 : gameflow.asm part 1/3 (4988 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (3569 bytes)
...
anim_tile_transform_flags EQU #C634   ; Runtime flags for transform-mode tile animation
anim_tile_row_buffer EQU #C635   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; PARTICLE SYSTEM VARIABLES
; ==================================================================
particle_pool       EQU #C63D   ; Particle pool (8 particles * 8 bytes = 64 bytes)

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #C67D   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_x_pos        EQU #C69D   ; Entity X positions (32 bytes)
entity_y_pos        EQU #C6BD   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #C6DD   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #C6FD   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #C71D   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #C73D   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #C75D   ; Entity screen ID (32 bytes)
entity_dir_mask     EQU #C77D   ; Entity direction mask (32 bytes)
entity_health       EQU #C79D   ; Entity health (32 bytes)
entity_anim_frame   EQU #C7BD   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #C7DD   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #C7FD   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #C81D   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #C83D   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C85D   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C87D   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C89D   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C8BD   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #C8DD   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #C8FD   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #C91D   ; Entity template token (32 bytes, 0=unknown)
entity_sm_var_0     EQU #C93D   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C95D   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C97D   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C99D   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C9BD   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #C9DD   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #C9FD   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #CA1D   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #CA3D   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #CA5D   ; Number of sprites currently active
sprites_dirty      EQU #CA5E   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #CA5F   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #CA7F   ; Sprite colors (32 bytes)
sprite_attributes   EQU #CA9F   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (4 screens detected)
; ==================================================================
current_screen_id   EQU #CB1F   ; Currently displayed screen ID
screen_dirty_flag   EQU #CB20   ; Screen needs redraw flag
screen_transition_cooldown EQU #CB21   ; Cooldown frames after screen transition
current_world_id    EQU #CB22   ; Current world ID (for multi-world support)
current_screen_index EQU #CB23   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #CB24   ; Player X position (16-bit)
player_y            EQU #CB26   ; Player Y position (16-bit)
player_health       EQU #CB28   ; Player health points
player_score        EQU #CB29   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #CB2B   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #CB2C   ; Temporary 16-bit storage
temp_word_2         EQU #CB2E   ; Temporary 16-bit storage
temp_byte_1         EQU #CB30   ; Temporary 8-bit storage
temp_byte_2         EQU #CB31   ; Temporary 8-bit storage
temp_byte_3         EQU #CB32   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #CB52   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #CB72   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #CB92   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #CBB2   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CBD2   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CBF2   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CC12   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CC32   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CC52   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CC72   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CC92   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CCB2   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CCD2   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CCF2   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CD12   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CD32   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CD52   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CD72   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CD92   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CDB2   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CDD2   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CDF2   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CE12   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #CE52   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #CE92   ; Cached entity X for wall checks
wall_temp_y         EQU #CE93   ; Cached entity Y for wall checks
wall_hit_left       EQU #CE94   ; Hitbox left edge cache
wall_hit_top        EQU #CE95   ; Hitbox top edge cache
wall_hit_right      EQU #CE96   ; Hitbox right edge cache
wall_hit_bottom     EQU #CE97   ; Hitbox bottom edge cache
wall_hit_w          EQU #CE98   ; Hitbox width cache (min 1)
wall_hit_h          EQU #CE99   ; Hitbox height cache (min 1)
wall_probe_left     EQU #CE9A   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #CE9B   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #CE9C   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #CE9D   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #CE9E   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #CEBE   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #CEBF   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #CEC0   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #CEE0   ; Number of entities in coll_list
coll_src_left       EQU #CEE1   ; Source AABB left edge (scratch)
coll_src_right      EQU #CEE2   ; Source AABB right edge (scratch)
coll_src_top        EQU #CEE3   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #CEE4   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #CEE5   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #CEE5   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #CEE7   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #CEE9   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #CEEB   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #CEED   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #CEEF   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #CEF1   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #CEF3   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #CEF5   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #CEF6   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #CEFB   ; Frame counter (16-bit)
task_exec_time          EQU #CEFD   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #CEFF   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #CF00   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #CF00   ; End of project variables (3840 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#CF00: Project variables (3840 bytes)
;   #CF00-#F37F: Free RAM (~9344 bytes available)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (48 -> 43 bytes)
    DB #28,#00,#7F,#BF,#00,#EF,#F5,#F6,#83,#FF,#FF,#00,#FB,#88,#E5,#FE
    DB #FE,#EF,#FF,#FB,#E4,#B9,#F7,#FF,#EE,#00,#7E,#DD,#F3,#09,#DB,#03
    DB #18,#0C,#08,#18,#30,#60,#60,#30,#55,#55,#80
load_pattern_bank0:
    ...
    ld bc, 48    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 48    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (48 -> 25 bytes)
    DB #8A,#41,#51,#FF,#FA,#F0,#F7,#FE,#E0,#E9,#F0,#BA,#C1,#FF,#31,#A2
    DB #C1,#8A,#81,#91,#A3,#A1,#55,#55,#80
load_color_bank0:
    ...
    ld bc, 48     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 45 bytes)
    DB #95,#84,#69,#00,#57,#80,#80,#7C,#FC,#45,#62,#80,#81,#3C,#74,#58
    DB #25,#82,#83,#82,#83,#1A,#85,#02,#85,#80,#29,#85,#7F,#FD,#80,#51
    DB #3F,#C5,#FC,#47,#F4,#45,#FC,#78,#80,#55,#75,#55,#58
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #80,#00,#11,#0A,#01,#4E,#EA,#3C,#FE,#55,#35,#55,#58
...
;   Not preserved
; Stack:
;   Uses PUSH/POP HL and BC internally
; ------------------------------------------------------------------
...
anim_transform_table:
    db 132, 1, 6, 1    ; corda -> tile tile_1771095408431
    db 255                          ; End marker
...
; Free RAM buffer for tile pattern data decompression (48 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D500

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (48 bytes)
; ==================================================================
