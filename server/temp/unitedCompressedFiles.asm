...
;         },
;         {
;           "label": "NEW_MSX2_SCREEN_4_ROOM_CELL_FLAGS",
;           "kind": "screen4_cell_flags",
;           "rawBytes": 192,
;           "loadOrder": 33
;         },
;         {
;           "label": "NEW_MSX2_SCREEN_4_ROOM_VISUAL_MAP",
;           "kind": "screen4_visual_map",
;           "rawBytes": 192,
;           "loadOrder": 34
;         },
;         {
;           "label": "NEW_MSX2_SCREEN_4_ROOM_TILE_HAZ_HIT",
...
;         "NEW_MSX2_SCREEN_4_ROOM_CELL_FLAGS",
;         "NEW_MSX2_SCREEN_4_ROOM_VISUAL_MAP",
;         "NEW_MSX2_SCREEN_4_ROOM_TILE_HAZ_HIT"
;       ]
;     },
;     {
;       "type": "msx2screen",
...
;         }
;       ],
;       "screenLabel": "PLATFORMER_STAGE_1",
;       "payloadParts": [
;         {
;           "label": "PLATFORMER_STAGE_1_NAMES",
;           "kind": "screen4_names",
;           "rawBytes": 768,
;           "loadOrder": 20
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_BANK_0_PATTERNS",
;           "kind": "screen4_patterns",
;           "rawBytes": 112,
;           "loadOrder": 0
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_BANK_0_COLORS",
;           "kind": "screen4_colors",
;           "rawBytes": 112,
;           "loadOrder": 1
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_BANK_1_PATTERNS",
;           "kind": "screen4_patterns",
;           "rawBytes": 144,
;           "loadOrder": 2
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_BANK_1_COLORS",
;           "kind": "screen4_colors",
;           "rawBytes": 144,
;           "loadOrder": 3
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_BANK_2_PATTERNS",
;           "kind": "screen4_patterns",
;           "rawBytes": 128,
;           "loadOrder": 4
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_BANK_2_COLORS",
;           "kind": "screen4_colors",
;           "rawBytes": 128,
;           "loadOrder": 5
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_COLLISION",
;           "kind": "screen4_collision",
;           "rawBytes": 192,
;           "loadOrder": 30
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_EFFECTS",
;           "kind": "screen4_effects",
;           "rawBytes": 192,
;           "loadOrder": 31
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_BEHAVIOR",
;           "kind": "screen4_behavior",
;           "rawBytes": 192,
;           "loadOrder": 32
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_CELL_FLAGS",
;           "kind": "screen4_cell_flags",
;           "rawBytes": 192,
;           "loadOrder": 33
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_VISUAL_MAP",
;           "kind": "screen4_visual_map",
;           "rawBytes": 192,
;           "loadOrder": 34
;         },
;         {
;           "label": "PLATFORMER_STAGE_1_TILE_HAZ_HIT",
;           "kind": "screen4_hazard_hitbox",
;           "rawBytes": 16,
;           "loadOrder": 35
;         }
;       ],
;       "payloadLabels": [
;         "PLATFORMER_STAGE_1_NAMES",
;         "PLATFORMER_STAGE_1_BANK_0_PATTERNS",
;         "PLATFORMER_STAGE_1_BANK_0_COLORS",
;         "PLATFORMER_STAGE_1_BANK_1_PATTERNS",
;         "PLATFORMER_STAGE_1_BANK_1_COLORS",
;         "PLATFORMER_STAGE_1_BANK_2_PATTERNS",
;         "PLATFORMER_STAGE_1_BANK_2_COLORS",
;         "PLATFORMER_STAGE_1_COLLISION",
;         "PLATFORMER_STAGE_1_EFFECTS",
;         "PLATFORMER_STAGE_1_BEHAVIOR",
;         "PLATFORMER_STAGE_1_CELL_FLAGS",
;         "PLATFORMER_STAGE_1_VISUAL_MAP",
;         "PLATFORMER_STAGE_1_TILE_HAZ_HIT"
;       ]
;     },
;     {
;       "type": "msx2sprite",
...
PLAYER_HITBOX_X EQU 3
PLAYER_HITBOX_Y EQU 4
PLAYER_HITBOX_W EQU 10
PLAYER_HITBOX_H EQU 27
...
PLATFORMER_STAGE_1_DATA_BANK EQU MSX2_SCREEN4_DATA_BANK_0
...
init_rom:
    ...
    call load_PLATFORMER_STAGE_1_screen4
...
msx2_update_hardware_sprite_vertical:
    ...
    ; Clobbers AF/BC/DE/HL.
    jp msx2_player_state_machine_tick
...
msx2_state_machine_exit:
    jp apply_msx2_conveyor
...
init_msx2_effect_buffers:
    ...
    ; Clobbers AF/BC/DE/HL.
    ld a, PLATFORMER_STAGE_1_DATA_BANK
    call msx2_screen4_data_bank_enter_selected
    ld hl, PLATFORMER_STAGE_1_CELL_FLAGS
    ld de, #C087
    ...
    call msx2_screen4_data_bank_enter_selected
    ld hl, NEW_MSX2_SCREEN_4_ROOM_CELL_FLAGS
    ld de, #C147
    ld bc, msx2_layer_size
    ldir
    call msx2_screen4_data_bank_leave
...
load_current_msx2_screen4:
    ...
    ld a, (msx2_current_screen_index)
    cp 0
    jp z, load_PLATFORMER_STAGE_1_screen4
    cp 1
    jp z, load_NEW_MSX2_SCREEN_4_ROOM_screen4
    jp load_PLATFORMER_STAGE_1_screen4

load_PLATFORMER_STAGE_1_screen4:
    xor a
    ld hl, SCREEN4_NAME_VRAM
    ...
    ld hl, PLATFORMER_STAGE_1_BANK_0_PATTERNS
    ld de, #0000
    ld bc, 112
    call LDIRVM
    ld hl, PLATFORMER_STAGE_1_BANK_0_COLORS
    ld de, #2000
    ld bc, 112
    call LDIRVM
    ld hl, PLATFORMER_STAGE_1_BANK_1_PATTERNS
    ld de, #0800
    ld bc, 144
    call LDIRVM
    ld hl, PLATFORMER_STAGE_1_BANK_1_COLORS
    ld de, #2800
    ld bc, 144
    call LDIRVM
    ld hl, PLATFORMER_STAGE_1_BANK_2_PATTERNS
    ld de, #1000
    ld bc, 128
    call LDIRVM
    ld hl, PLATFORMER_STAGE_1_BANK_2_COLORS
    ld de, #3000
    ld bc, 128
    call LDIRVM

    ld hl, PLATFORMER_STAGE_1_NAMES
    ...
    call load_msx2_hud_font
    call draw_PLATFORMER_STAGE_1_hud_text
    ld a, PLATFORMER_STAGE_1_DATA_BANK
    call msx2_screen4_data_bank_enter_selected
    ld hl, PLATFORMER_STAGE_1_COLLISION
    ld de, msx2_collision_runtime_cache
    ld bc, msx2_layer_size
    ldir
    ld hl, PLATFORMER_STAGE_1_BEHAVIOR
    ...
    ld a, PLATFORMER_STAGE_1_DATA_BANK
    call msx2_screen4_data_bank_enter_selected
    ld hl, PLATFORMER_STAGE_1_VISUAL_MAP
    ld de, msx2_visual_map_cache
    ld bc, msx2_layer_size
    ldir
    ld hl, PLATFORMER_STAGE_1_TILE_HAZ_HIT
    ...
    call apply_PLATFORMER_STAGE_1_collected_visuals
    ret
...
load_NEW_MSX2_SCREEN_4_ROOM_screen4:
    ...
    ld a, NEW_MSX2_SCREEN_4_ROOM_DATA_BANK
    call msx2_screen4_data_bank_enter_selected
    ld hl, NEW_MSX2_SCREEN_4_ROOM_VISUAL_MAP
    ld de, msx2_visual_map_cache
    ld bc, msx2_layer_size
    ldir
    ld hl, NEW_MSX2_SCREEN_4_ROOM_TILE_HAZ_HIT
    ld de, msx2_hazard_hitbox_cache
    ld bc, msx2_hazard_hitbox_cache_bytes
    ldir
    call msx2_screen4_data_bank_leave
...
apply_PLATFORMER_STAGE_1_collected_visuals:
...
draw_PLATFORMER_STAGE_1_hud_text:
    ret
    ret
...
msx2_hw_sprite_frame_0_pattern_0:
    DB #00,#00,#1F,#20,#40,#00,#88,#9B,#AF,#57,#23,#07,#07,#10,#38,#3C
    DB #00,#00,#C0,#10,#68,#94,#9E,#FE,#F8,#E8,#D0,#E0,#80,#20,#70,#78
; Hardware metasprite frame 0 part 1: x+0, y+0
msx2_hw_sprite_frame_0_pattern_1:
    DB #00,#00,#00,#1F,#3F,#7F,#77,#64,#50,#28,#1C,#08,#00,#07,#00,#00
    DB #00,#00,#00,#E0,#90,#48,#40,#00,#00,#10,#20,#00,#00,#80,#00,#00
; Hardware metasprite frame 1 part 0: x+0, y+0
msx2_hw_sprite_frame_1_pattern_0:
    DB #00,#1F,#20,#40,#00,#88,#9B,#AF,#57,#23,#07,#07,#01,#01,#03,#03
    DB #00,#C0,#10,#68,#94,#9E,#FE,#F8,#E8,#D0,#E0,#80,#00,#00,#80,#C0
; Hardware metasprite frame 1 part 1: x+0, y+0
msx2_hw_sprite_frame_1_pattern_1:
    DB #00,#00,#1F,#3F,#7F,#77,#64,#50,#28,#1C,#08,#00,#06,#00,#00,#00
    DB #00,#00,#E0,#90,#48,#40,#00,#00,#10,#20,#00,#00,#80,#00,#00,#00
; Mirrored hardware metasprite frame 0 part 0: authored right
msx2_hw_sprite_frame_0_mirror_pattern_0:
    DB #00,#00,#03,#08,#16,#29,#79,#7F,#1F,#17,#0B,#07,#01,#04,#0E,#1E
    DB #00,#00,#F8,#04,#02,#00,#11,#D9,#F5,#EA,#C4,#E0,#E0,#08,#1C,#3C
; Mirrored hardware metasprite frame 0 part 1: authored right
msx2_hw_sprite_frame_0_mirror_pattern_1:
    DB #00,#00,#00,#07,#09,#12,#02,#00,#00,#08,#04,#00,#00,#01,#00,#00
    DB #00,#00,#00,#F8,#FC,#FE,#EE,#26,#0A,#14,#38,#10,#00,#E0,#00,#00
; Mirrored hardware metasprite frame 1 part 0: authored right
msx2_hw_sprite_frame_1_mirror_pattern_0:
    DB #00,#03,#08,#16,#29,#79,#7F,#1F,#17,#0B,#07,#01,#00,#00,#01,#03
    DB #00,#F8,#04,#02,#00,#11,#D9,#F5,#EA,#C4,#E0,#E0,#80,#80,#C0,#C0
; Mirrored hardware metasprite frame 1 part 1: authored right
msx2_hw_sprite_frame_1_mirror_pattern_1:
    DB #00,#00,#07,#09,#12,#02,#00,#00,#08,#04,#00,#00,#01,#00,#00,#00
    DB #00,#00,#F8,#FC,#FE,#EE,#26,#0A,#14,#38,#10,#00,#60,#00,#00,#00
...
msx2_hw_push_box_sprite_pattern:
    DB #80,#C0,#60,#50,#48,#44,#42,#41,#41,#42,#44,#48,#50,#60,#C0,#80
    DB #01,#03,#06,#0A,#12,#22,#42,#82,#82,#42,#22,#12,#0A,#06,#03,#01
msx2_hw_sprite_patterns_end:

msx2_hw_sprite_colors:
; Line colors for hardware sprite layer 0
msx2_hw_sprite_colors_0:
    DB #05,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#0F,#0F,#0F
; Line colors for hardware sprite layer 1
msx2_hw_sprite_colors_1:
    DB #05,#05,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#05,#0F,#05,#05,#05
...
msx2_hw_push_box_sprite_colors:
    DB #06,#0E,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#0E,#06
...
msx2_hw_sprite_attrs:
    DB #77,#D5,#00,#00,#77,#D5,#04,#00,#D0,#00,#20,#00,#D0,#00,#20,#00
...
; Platformer Stage 1 SCREEN 4 name table, 32x24 chars
PLATFORMER_STAGE_1_NAMES:
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    ...
    DB #0E,#0E,#0E,#0E,#0E,#0E,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0F,#0F,#0F,#0F,#0F,#0F,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
...
; Platformer Stage 1 SCREEN 4 bank 0 compact patterns
PLATFORMER_STAGE_1_BANK_0_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 SCREEN 4 bank 0 compact colors
PLATFORMER_STAGE_1_BANK_0_COLORS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 SCREEN 4 bank 1 compact patterns
PLATFORMER_STAGE_1_BANK_1_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 SCREEN 4 bank 1 compact colors
PLATFORMER_STAGE_1_BANK_1_COLORS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 SCREEN 4 bank 2 compact patterns
PLATFORMER_STAGE_1_BANK_2_PATTERNS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 SCREEN 4 bank 2 compact colors
PLATFORMER_STAGE_1_BANK_2_COLORS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; New MSX2 SCREEN 4 Room collision layer, copied from cold ROM to current RAM cache on screen load
NEW_MSX2_SCREEN_4_ROOM_COLLISION:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 effects layer, copied from cold ROM to RAM on screen reset
PLATFORMER_STAGE_1_EFFECTS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; New MSX2 SCREEN 4 Room behavior layer, copied from cold ROM to current RAM cache on screen load
NEW_MSX2_SCREEN_4_ROOM_BEHAVIOR:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 packed cell flags (solid/effect/behavior), copied from cold ROM to current RAM cache on screen load
PLATFORMER_STAGE_1_CELL_FLAGS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ...
    DB #01,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#02,#00
    DB #00,#00,#00,#00,#01,#01,#01,#01,#00,#00,#00,#00,#00,#01,#01,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#29,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00
    DB #01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01

; New MSX2 SCREEN 4 Room packed cell flags (solid/effect/behavior), copied from cold ROM to current RAM cache on screen load
NEW_MSX2_SCREEN_4_ROOM_CELL_FLAGS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 visual tile index map copied to RAM on screen load
PLATFORMER_STAGE_1_VISUAL_MAP:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ...
    DB #01,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#03,#00
    DB #00,#00,#00,#00,#01,#01,#01,#01,#00,#00,#00,#00,#00,#01,#01,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#02,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00
    DB #01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01

; New MSX2 SCREEN 4 Room visual tile index map copied to RAM on screen load
NEW_MSX2_SCREEN_4_ROOM_VISUAL_MAP:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Platformer Stage 1 per-tile hazard hitboxes copied to RAM on screen load
PLATFORMER_STAGE_1_TILE_HAZ_HIT:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#0C,#10,#04

; New MSX2 SCREEN 4 Room per-tile hazard hitboxes copied to RAM on screen load
NEW_MSX2_SCREEN_4_ROOM_TILE_HAZ_HIT:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
