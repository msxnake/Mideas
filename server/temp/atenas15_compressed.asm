...
; BANK 03 @#0000 : screens.asm part 2/2 (3881 bytes)
; BANK 03 @#0F29 : sprites.asm part 1/2 (4311 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (5865 bytes)
; BANK 04 @#16E9 : font.asm (177 bytes)
; BANK 04 @#179A : hud.asm (114 bytes)
; BANK 04 @#180C : menus.asm (168 bytes)
; BANK 04 @#18B4 : sound.asm (1868 bytes)
; BANK 05 @#0000 : sound.asm (2901 bytes)
; BANK 05 @#0B55 : scroll.asm (2389 bytes)
; BANK 05 @#14AA : animtiles.asm (2586 bytes)
; BANK 05 @#1EC4 : bosses.asm (316 bytes)
; BANK 06 @#0000 : bosses.asm (5466 bytes)
; BANK 06 @#155A : statemachine.asm part 1/2 (2726 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/2 (4719 bytes)
; BANK 08 @#126F : gameflow.asm (3473 bytes)
; BANK 09 @#0000 : gameflow.asm (2121 bytes)
...
SCREEN_PANTALLA1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (368 -> 216 bytes)
    DB #39,#F4,#F5,#FD,#A3,#D5,#F7,#F6,#D5,#FF,#FF,#FF,#F8,#E0,#A6,#F6
    DB #9F,#FF,#F8,#A4,#D5,#7C,#FE,#58,#E2,#80,#81,#E5,#84,#85,#02,#03
    DB #82,#83,#8B,#8C,#86,#87,#8F,#90,#D8,#B0,#88,#8D,#8E,#82,#91,#92
    DB #24,#88,#89,#F8,#F0,#48,#8C,#8D,#8A,#8B,#93,#94,#86,#87,#9C,#9D
    DB #80,#E2,#A0,#A1,#8E,#8F,#A4,#A5,#95,#96,#BD,#9E,#9F,#22,#A2,#A3
    DB #22,#A6,#A7,#39,#A8,#7F,#E8,#88,#A9,#A1,#A2,#88,#A5,#A6,#8F,#A9
    DB #A1,#E9,#8E,#E7,#A3,#A4,#0F,#22,#A7,#A8,#EE,#A2,#EF,#88,#F8,#8E
    DB #84,#81,#0E,#A6,#85,#EA,#89,#4E,#85,#7E,#94,#38,#90,#91,#F9,#88
    DB #94,#95,#88,#9D,#9E,#03,#CE,#CF,#D0,#D1,#D3,#D4,#D5,#D6,#D8,#D9
    DB #DA,#DB,#DD,#DE,#DF,#E0,#FF,#E1,#49,#E1,#B5,#DF,#E0,#93,#FE,#47
    DB #49,#47,#E0,#A6,#D9,#38,#D9,#A6,#47,#7F,#88,#AA,#AB,#AC,#8C,#C5
    DB #DD,#FD,#F8,#51,#A7,#AF,#8D,#8E,#A0,#F8,#DF,#E5,#59,#7E,#E5,#F9
    DB #C4,#78,#F7,#3E,#FF,#C9,#CA,#CB,#36,#9A,#D2,#D7,#6D,#CC,#AE,#7C
    DB #D1,#20,#A6,#D5,#9D,#DB,#55,#56
...
SCREEN_PANTALLA1_0_CHAR_BEHAVIOR_TABLE:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#10,#10,#10,#00,#00,#10,#10,#00,#00,#10,#10,#10,#10,#10,#10
    DB #10,#00,#00,#10,#10,#00,#00,#00,#00,#00,#00,#00,#10,#10,#00,#00
    DB #10,#10,#10,#00,#10,#10,#10,#00,#00,#10,#10,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
