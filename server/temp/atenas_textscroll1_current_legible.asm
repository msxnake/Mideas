...
; Bank 2 [#8000-#A000]: components_tail, gameflow (20305/8192 bytes est.)
...
; BANK 08 @#0000 : gameflow.asm part 3/3 (7137 bytes); ==================================================================
...
; - gameflow: 14400 estimated bytes
