...
${(0, registerContract_1.buildRegisterContractComment)({
            ...
            notes: keepRuntimeBackgroundLayout
                ? ['Uses screen_block_catalog_ptr and screen_block_map_ptr as scratch pointers.', 'Callers should copy runtime_background_layout to runtime_screen_layout after expansion.']
                : ['Uses screen_block_catalog_ptr and screen_block_map_ptr as scratch pointers.', 'Source block map must not overlap runtime_screen_layout because expansion writes there.']
...
${page0CopyToRam(`SCREEN_${screenName}_${index}_BLOCK_CATALOG`, 'runtime_effects_layout', `SCREEN_${screenName}_${index}_BLOCK_CATALOG_SIZE`)}${page0CopyToRam(`SCREEN_${screenName}_${index}_BLOCK_MAP`, blockLayoutMapScratchLabel, `SCREEN_${screenName}_${index}_BLOCK_MAP_SIZE`)}    ld hl, runtime_effects_layout
