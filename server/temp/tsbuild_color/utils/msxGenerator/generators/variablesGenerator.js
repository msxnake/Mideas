...
`;
    ...
    currentAddress++;
    code += `gameflow_reveal_world_after_load EQU #${currentAddress.toString(16).toUpperCase().padStart(4, '0')}   ; 1 when Transition->WorldLink reveals the loaded screen by raster\n`;
    currentAddress++;
