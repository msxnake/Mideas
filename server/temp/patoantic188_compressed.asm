...
; Estimated payload bytes: 100883
...
; BANK 11 @#0000 : statemachine.asm part 3/3 (3454 bytes)
; BANK 11 @#0D7E : gameflow.asm (4738 bytes)
; BANK 12 @#0000 : gameflow.asm (2579 bytes)
...
SM_New_Statemachine_state_1771533526010_Transitions_Actions_4: 
    DB 13; SET_VARIABLE (from ASSIGN_VARIABLE)
    DB 9, 0        ; Lives = 0
    DB 39; EXIT_CURRENT_WORLD 
    DB 0xFF; END
...
SM_New_Statemachine_state_1771533530403_Transitions: 
    ...
    DW SM_New_Statemachine_state_1771533530403_Transitions_Actions_0 

SM_New_Statemachine_state_1771533530403_Transitions_Actions_0: 
    DB 15; DECREMENT_VARIABLE 
    DB 9, 1        ; Lives (ID 9)
    DB 0xFF; END
...
SM_New_Statemachine_state_1773007838313_Transitions: 
    ...
    DB 9, 0, 1; Lives (ID 9) == 1
    DW SM_New_Statemachine_state_1771533530403 
    DW SM_New_Statemachine_state_1773007838313_Transitions_Actions_2 
...
SM_New_Statemachine_state_1773007838313_Transitions_Actions_1: 
    ...
    DB 6; sprite: nina_dead 
    DB 0xFF; END
SM_New_Statemachine_state_1773007838313_Transitions_Actions_2: 
    DB 13; SET_VARIABLE (from ASSIGN_VARIABLE)
    DB 9, 0        ; Lives = 0
    DB 39; EXIT_CURRENT_WORLD 
    DB 0xFF; END
...
gameflow_node_gfn_1773061671607_data:
    ...
    DW text_gfn_1773061671607_title          ; -> "GAME"
    DB 7, 5              ; Row 7, Col 5
...
gameflow_node_gfn_1773061671607_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1773061713613
    db CONNECTION_END

; Node: End - "gfn_1773061713613"
gameflow_node_gfn_1773061713613:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gfn_1773061713613_conn

gameflow_node_gfn_1773061713613_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
