...
; Estimated payload bytes: 149143
; Estimated banks used: 19
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (1163 bytes)
; BANK 00 @#048B : patterns.asm (2100 bytes)
; BANK 00 @#0CBF : colors.asm (1868 bytes)
; BANK 00 @#140B : components.asm (22 bytes)
; BANK 00 @#1421 : entities.asm part 1/2 (3039 bytes)
; BANK 01 @#0000 : entities.asm part 2/2 (6285 bytes)
; BANK 01 @#188D : worlds.asm part 1/2 (1907 bytes)
; BANK 02 @#0000 : worlds.asm part 2/2 (6685 bytes)
; BANK 02 @#1A1D : screens.asm part 1/8 (1507 bytes)
; BANK 03 @#0000 : screens.asm part 2/8 (8192 bytes)
; BANK 04 @#0000 : screens.asm part 3/8 (8192 bytes)
; BANK 05 @#0000 : screens.asm part 4/8 (8192 bytes)
; BANK 06 @#0000 : screens.asm part 5/8 (8192 bytes)
; BANK 07 @#0000 : screens.asm part 6/8 (8192 bytes)
; BANK 08 @#0000 : screens.asm part 7/8 (8192 bytes)
; BANK 09 @#0000 : screens.asm part 8/8 (7511 bytes)
; BANK 09 @#1D57 : sprites.asm part 1/2 (681 bytes)
; BANK 10 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 11 @#0000 : sprites.asm part 3/2 (4203 bytes)
; BANK 11 @#106B : font.asm (1861 bytes)
; BANK 11 @#17B0 : hud.asm (2128 bytes)
; BANK 12 @#0000 : hud.asm (1479 bytes)
; BANK 12 @#05C7 : menus.asm (454 bytes)
; BANK 12 @#078D : sound.asm (6259 bytes)
; BANK 13 @#0000 : sound.asm (1020 bytes)
; BANK 13 @#03FC : scroll.asm (2353 bytes)
; BANK 13 @#0D2D : animtiles.asm (4819 bytes)
; BANK 14 @#0000 : animtiles.asm (2047 bytes)
; BANK 14 @#07FF : statemachine.asm part 1/3 (6145 bytes)
; BANK 15 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 16 @#0000 : statemachine.asm part 3/3 (3545 bytes)
; BANK 16 @#0DD9 : gameflow.asm part 1/2 (4647 bytes)
; BANK 17 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 18 @#0000 : gameflow.asm part 3/2 (1687 bytes)
...
resource_descriptor_ptr EQU #C020   ; Pointer to cached resource descriptor entry (16-bit)
resource_descriptor_id EQU #C022   ; Cached resource id
resource_descriptor_type EQU #C023   ; Cached resource type
resource_descriptor_group EQU #C024   ; Cached resource group
resource_descriptor_bank EQU #C025   ; Cached resource bank
resource_descriptor_addr EQU #C026   ; Cached resource visible address (16-bit)
resource_descriptor_size EQU #C028   ; Cached resource size (16-bit)
vram_cache_tile_patterns_ready EQU #C02A   ; 1 when shared gameplay tile patterns are already resident in VRAM
vram_cache_tile_colors_ready EQU #C02B   ; 1 when shared gameplay tile colors are already resident in VRAM
vram_cache_font_ready EQU #C02C   ; 1 when shared font patterns/colors are already resident in VRAM
resource_ram_cache_screen_layout_id EQU #C02D   ; Cached resource id for runtime_background_layout source
resource_ram_cache_effects_layout_id EQU #C02E   ; Cached resource id for runtime_effects_layout source
resource_ram_cache_behavior_map_id EQU #C02F   ; Cached resource id for pristine behavior-map RAM copy
resource_ram_cache_effect_zone_table_id EQU #C030   ; Cached resource id for runtime_effect_zone_table source
current_screen2_tilebank_id EQU #C031   ; Current SCREEN 2 shared tilebank loaded in VRAM (#FF=none/unknown)
frame_counter       EQU #C032   ; Frame counter (16-bit)

; Profiling counters (16-bit, cumulative)
prof_update_all_entities_calls EQU #C034   ; Calls to update_all_entities
prof_execute_sm_calls EQU #C036   ; Calls to execute_all_state_machines
prof_sm_update_calls  EQU #C038   ; Calls to SM_Update
prof_collision_calls  EQU #C03A   ; Calls to update_collision_component
prof_wall_calls       EQU #C03C   ; Calls to update_wallcollision_component
prof_deadly_calls     EQU #C03E   ; Calls to update_deadly_tiles_component
prof_tile_interaction_calls EQU #C040   ; Calls to check_tile_interaction
prof_animation_calls  EQU #C042   ; Calls to update_animation_component
prof_sprite_calls     EQU #C044   ; Calls to update_sprite_component
prof_music_task_calls EQU #C046   ; Calls to task_update_music
prof_deadly_behavior_reads EQU #C048   ; Deadly helper behavior-map reads
page0_transfer_buffer EQU #C04A   ; Temporary RAM buffer for page0 -> VRAM copies
...
resource_ram_cache_behavior_map EQU #C755   ; Pristine behavior map cache for current banked resource (32x24)
runtime_behavior_map   EQU #CA55   ; Mutable copy of current behavior map (32x24)
runtime_interaction_type_map EQU #CD55   ; Mutable copy of current interaction type map (32x24)
runtime_interaction_value_map EQU #D055   ; Mutable copy of current interaction value map (32x24)
runtime_interaction_target_map EQU #D355   ; Mutable copy of current interaction target map (32x24)
runtime_char_behavior_table EQU #D655   ; Current screen char -> behavior lookup table (256 bytes)
runtime_effects_layout EQU #D755   ; Alternate effects layout copy for secret zones (32x24)
screen_block_catalog_ptr EQU #DA55   ; Scratch pointer to current screen block catalog during layout expansion
screen_block_map_ptr EQU #DA57   ; Scratch pointer to current screen block index map during layout expansion
runtime_effect_zone_table EQU #DA59   ; Current screen effect zone table (MAX_RUNTIME_EFFECT_ZONES * 8 bytes)
current_effect_zone_count EQU #DC59   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #DC5A   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #DC5B   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #DC5C   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #DC5D   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #DC5E   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #DC5F   ; Camera X position in pixels (16-bit)
camera_y            EQU #DC61   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #DC63   ; Camera tile X (column)
camera_tile_y       EQU #DC64   ; Camera tile Y (row)
world_width_tiles   EQU #DC65   ; World width in tiles
world_height_tiles  EQU #DC66   ; World height in tiles
scroll_dirty_flag   EQU #DC67   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #DC68   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #DC69   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #DC6A   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #DC6C   ; Animation frame timer
anim_tile_frame     EQU #DC6D   ; Current animation frame (0-3)
anim_tile_speed     EQU #DC6E   ; Frames between animation updates
anim_tile_transform_flags EQU #DC6F   ; Runtime flags for transform-mode tile animation (byte0=flags, byte1=opcode scratch)
anim_tile_row_buffer EQU #DC71   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #DC79   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #DC99   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_button_contact_active EQU #DCB9   ; 1 while entity stays on the same button tile (32 bytes)
entity_button_contact_x EQU #DCD9   ; Button tile X currently latched per entity (32 bytes)
entity_button_contact_y EQU #DCF9   ; Button tile Y currently latched per entity (32 bytes)
entity_on_ladder   EQU #DD19   ; 1 while entity is centered on a ladder tile (32 bytes)
entity_gate_current_step EQU #DD39   ; Current applied retract step (32 bytes)
entity_gate_step_timer EQU #DD59   ; Countdown until next retract step (32 bytes)
entity_walljump_lock EQU #DD79   ; Remaining horizontal lock frames after wall jump (32 bytes)
entity_walljump_locked_vx EQU #DD99   ; Horizontal velocity preserved while wall jump lock is active (32 bytes)
entity_walljump_anim_active EQU #DDB9   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_x_pos        EQU #DDD9   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DDF9   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DE19   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DE39   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DE59   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DE79   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DE99   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DEB9   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DED9   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DEF9   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DEFA   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DF1A   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DF3A   ; Entity health (32 bytes)
entity_anim_frame   EQU #DF5A   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DF7A   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DF9A   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DFBA   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DFDA   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DFFA   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #E01A   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #E03A   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #E05A   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #E07A   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #E09A   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_collectible_enabled EQU #E0BA   ; 1 when entity has Collectible component (32 bytes)
entity_carried_by   EQU #E0DA   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #E0FA   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #E11A   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #E13A   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E15A   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E17A   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E19A   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E1BA   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E1DA   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E1FA   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E21A   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E23A   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E25A   ; Number of sprites currently active
sprites_dirty      EQU #E25B   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E25C   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E27C   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E29C   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E2BC   ; Runtime base 16x16 slot per sprite asset (18 bytes)
sprite_placeholder_base_pattern_num EQU #E2CE   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E2CF   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E2D0   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (7 screens detected)
; ==================================================================
current_screen_id   EQU #E350   ; Currently displayed screen ID
screen_dirty_flag   EQU #E351   ; Screen needs redraw flag
screen_transition_cooldown EQU #E352   ; Cooldown frames after screen transition
current_world_id    EQU #E353   ; Current world ID (for multi-world support)
current_screen_index EQU #E354   ; Current screen index within world
current_screen_anim_group_count EQU #E355   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #E356   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #E357   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #E358   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E359   ; Player X position (16-bit)
player_y            EQU #E35B   ; Player Y position (16-bit)
player_runtime_enabled EQU #E35D   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E35E   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E35F   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E360   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E361   ; Player health points
player_score        EQU #E362   ; Player score (16-bit)
gem_count           EQU #E364   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E365   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #E366   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #E367   ; Interaction type id of last interacted tile
last_interaction_value EQU #E368   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E369   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E36A   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E36B   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E36C   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E36D   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E36E   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E3AE   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E3EE   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E42E   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E46E   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E47E   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E48E   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E49E   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E4AE   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E4BE   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E4CE   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E4CF   ; Temporary 16-bit storage
temp_word_2         EQU #E4D1   ; Temporary 16-bit storage
temp_byte_1         EQU #E4D3   ; Temporary 8-bit storage
temp_byte_2         EQU #E4D4   ; Temporary 8-bit storage
temp_byte_3         EQU #E4D5   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E4F5   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E515   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E535   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E555   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E556   ; Frames remaining for current SFX
sfx_fadeout         EQU #E557   ; Reserved fadeout flag/state
temp_byte_7         EQU #E558   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E578   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E598   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E5B8   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E5D8   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E5F8   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E618   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E638   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E658   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E678   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E698   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E6B8   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E6D8   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E6F8   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E718   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E738   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E758   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E778   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E798   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E7B8   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E7F8   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E838   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E858   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E878   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E898   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E899   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E89A   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E89B   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E89C   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E89D   ; Cached entity X for wall checks
wall_temp_y         EQU #E89E   ; Cached entity Y for wall checks
wall_hit_left       EQU #E89F   ; Hitbox left edge cache
wall_hit_top        EQU #E8A0   ; Hitbox top edge cache
wall_hit_right      EQU #E8A1   ; Hitbox right edge cache
wall_hit_bottom     EQU #E8A2   ; Hitbox bottom edge cache
wall_hit_w          EQU #E8A3   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E8A4   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E8A5   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E8A6   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E8A7   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E8A8   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E8A9   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E8C9   ; Number of entries in active_entity_list
hero_entity_id      EQU #E8CA   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E8CB   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E8CC   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E8EC   ; Number of entries in input_entity_list
render_entity_list  EQU #E8ED   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E90D   ; Number of entries in render_entity_list
collision_entity_list EQU #E90E   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E92E   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E92F   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E94F   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E950   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E970   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E971   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E991   ; Number of entities in coll_list
coll_src_left       EQU #E992   ; Source AABB left edge (scratch)
coll_src_right      EQU #E993   ; Source AABB right edge (scratch)
coll_src_top        EQU #E994   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E995   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E996   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E996   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E998   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E99A   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E99C   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E99E   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E9A0   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E9A2   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E9A4   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E9A6   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E9A7   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E9AC   ; Frame counter (16-bit)
task_exec_time          EQU #E9AE   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E9B0   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E9B1   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E9B1   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E9B2   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E9B3   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E9B4   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E9B5   ; 0=stopped, 1=track active
music_muted          EQU #E9B6   ; 0=audible, 1=muted/pause
music_loop           EQU #E9B7   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E9B8   ; Current ROM track index
music_row_frames     EQU #E9B9   ; Frames per tracker row
music_row_countdown  EQU #E9BA   ; Countdown to next row
music_order_pos      EQU #E9BB   ; Current order position
music_pattern_index  EQU #E9BC   ; Current pattern index
music_pattern_row    EQU #E9BD   ; Current row inside pattern
music_pattern_rows   EQU #E9BE   ; Cached rows in current pattern
music_track_ptr_l    EQU #E9BF   ; Current track pointer low byte
music_track_ptr_h    EQU #E9C0   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E9C1   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E9C2   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E9C3   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E9C4   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E9C4   ; Channel A
music_ch_b_note EQU #E9C5   ; Channel B
music_ch_c_note EQU #E9C6   ; Channel C
music_ch_instrument_base EQU #E9C7   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E9C7   ; Channel A
music_ch_b_instrument EQU #E9C8   ; Channel B
music_ch_c_instrument EQU #E9C9   ; Channel C
music_ch_ornament_base EQU #E9CA   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E9CA   ; Channel A
music_ch_b_ornament EQU #E9CB   ; Channel B
music_ch_c_ornament EQU #E9CC   ; Channel C
music_ch_volume_base EQU #E9CD   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E9CD   ; Channel A
music_ch_b_volume EQU #E9CE   ; Channel B
music_ch_c_volume EQU #E9CF   ; Channel C
music_ch_vol_step_base EQU #E9D0   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E9D0   ; Channel A
music_ch_b_vol_step EQU #E9D1   ; Channel B
music_ch_c_vol_step EQU #E9D2   ; Channel C
music_ch_tone_step_base EQU #E9D3   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E9D3   ; Channel A
music_ch_b_tone_step EQU #E9D4   ; Channel B
music_ch_c_tone_step EQU #E9D5   ; Channel C
music_ch_noise_step_base EQU #E9D6   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E9D6   ; Channel A
music_ch_b_noise_step EQU #E9D7   ; Channel B
music_ch_c_noise_step EQU #E9D8   ; Channel C
music_ch_orn_step_base EQU #E9D9   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E9D9   ; Channel A
music_ch_b_orn_step EQU #E9DA   ; Channel B
music_ch_c_orn_step EQU #E9DB   ; Channel C

; ==================================================================
; PT3 REPLAYER WORKSPACE (~448 bytes)
; Layout matches PT3-ROM-alltables-glass.asm expected labels
; ==================================================================
PT3_SETUP       EQU #E9DC   ; PT3 state flags (bit0=loop, bit7=song_ended)
PT3_MODADDR     EQU #E9DD   ; Module address pointer (2 bytes)
PT3_CrPsPtr     EQU #E9DF   ; Current position pointer
PT3_SAMPTRS     EQU #E9E1   ; Sample pointers base
PT3_OrnPtrs     EQU #E9E3   ; Ornament pointers base
PT3_PDSP        EQU #E9E5   ; Pattern data start pointer
PT3_CSP         EQU #E9E7   ; Saved SP (CHREGS SP trick)
PT3_PSP         EQU #E9E9   ; PT3 stack pointer save
PT3_PrNote      EQU #E9EB   ; Previous note
PT3_PrSlide     EQU #E9EC   ; Previous slide (2 bytes)
PT3_AdInPtA     EQU #E9EE   ; Channel A inline pointer
PT3_AdInPtB     EQU #E9F0   ; Channel B inline pointer
PT3_AdInPtC     EQU #E9F2   ; Channel C inline pointer
PT3_LPosPtr     EQU #E9F4   ; Loop position pointer
PT3_PatsPtr     EQU #E9F6   ; Patterns table pointer
PT3_Delay       EQU #E9F8   ; Song speed/delay
PT3_AddToEn     EQU #E9F9   ; Add to envelope
PT3_Env_Del     EQU #E9FA   ; Envelope delay
PT3_ESldAdd     EQU #E9FB   ; Envelope slide add (2 bytes)
PT3_NTL3        EQU #E9FD   ; Note table link 3
VARS            EQU #E9FF   ; Channel vars base
ChanA           EQU #E9FF   ; Channel A data (29 bytes)
ChanB           EQU #EA1C   ; Channel B data (29 bytes)
ChanC           EQU #EA39   ; Channel C data (29 bytes)
DelyCnt         EQU #EA56   ; Delay counter
CurESld         EQU #EA57   ; Current envelope slide (2 bytes)
CurEDel         EQU #EA59   ; Current envelope delay
Ns_Base_AddToNs EQU #EA5A   ; Noise base + add to noise (combined)
Ns_Base         EQU #EA5A   ; Noise base
AddToNs         EQU #EA5B   ; Add to noise
NT_             EQU #EA5C   ; Note table (192 bytes)
AYREGS          EQU #EB1C  ; AY registers mirror (14 bytes)
VT_             EQU #EB1C  ; Volume table base (alias for AYREGS)
EnvBase         EQU #EB2A  ; Envelope base
VAR0END         EQU #EB2C  ; End of fixed workspace
T1_             EQU #EB2C  ; Tone tables start (unpacked by PT3_INIT)
T_NEW_1         EQU #EB2C  ; Tone table new 1
T_OLD_1         EQU #EB2C  ; Tone table old 1
T_OLD_2         EQU #EB44  ; Tone table old 2
T_NEW_3         EQU #EB5C  ; Tone table new 3
T_OLD_3         EQU #EB5C  ; Tone table old 3
T_OLD_0         EQU #EB5E  ; Tone table old 0
T_NEW_0         EQU #EB5E  ; Tone table new 0
T_NEW_2         EQU #EB76  ; Tone table new 2 (last, ends at +0x1B2)
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #EC1C   ; End of project variables (11292 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#EC1C: Project variables (11292 bytes)
;   #EC1C-#F37F: Free RAM (~1892 bytes available)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (232 -> 198 bytes)
    ...
    DB #64,#A5,#FF,#EF,#C7,#83,#01,#FF,#AA,#00,#10,#38,#7C,#38,#10,#00
    DB #D0,#A2,#C0,#FF,#C0,#8A,#D0,#0B,#A2,#03,#FF,#03,#25,#FE,#7E,#FE
    DB #AE,#DE,#BE,#DE,#FC,#C3,#FF,#BC,#E1,#FF,#98,#00,#1C,#3E,#7E,#7F
    DB #1A,#00,#38,#7C,#7E,#EE,#D6,#EE,#FE,#7F,#A1,#3F,#AA,#1F,#0F,#07
    DB #01,#FE,#FC,#4A,#F8,#F0,#E0,#80,#71,#C2,#5A,#D2,#CA,#71,#00,#FF
    DB #8C,#D6,#7F,#DE,#D6,#96,#F1,#E3,#92,#FD,#C0,#E2,#00,#FF,#5F,#BF
    DB #4F,#1A,#FD,#14,#55,#56
load_pattern_bank0:
    ...
    ld bc, 232    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 232    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (232 -> 80 bytes)
    DB #8A,#41,#51,#FF,#FA,#F0,#F7,#FE,#E0,#E9,#F0,#B8,#C1,#FF,#AA,#31
    DB #21,#C1,#8A,#81,#91,#A0,#A1,#4F,#AC,#7D,#70,#59,#3A,#F1,#F1,#71
    DB #E1,#E1,#F1,#FF,#61,#3E,#71,#6A,#BF,#F1,#DE,#8E,#F6,#FF,#9F,#71
    DB #F0,#6F,#41,#9E,#3F,#20,#FB,#FF,#BD,#F4,#E0,#9D,#FC,#68,#81,#F6
    DB #FE,#8F,#A1,#8B,#80,#F0,#FB,#8D,#FC,#A5,#FF,#F1,#B5,#81,#55,#58
load_color_bank0:
    ...
    ld bc, 232     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 173 bytes)
    DB #95,#84,#69,#FF,#56,#95,#84,#6A,#80,#E3,#81,#FC,#F1,#FB,#FC,#88
    DB #88,#92,#FB,#F0,#82,#C4,#48,#8E,#82,#83,#FD,#F5,#80,#00,#3C,#80
    DB #5E,#F9,#A9,#86,#80,#E4,#FE,#6B,#81,#88,#00,#85,#89,#8A,#62,#83
    DB #83,#45,#FB,#85,#91,#80,#F9,#F8,#00,#1E,#CB,#7E,#8A,#8B,#8C,#87
    DB #F8,#E4,#80,#7A,#51,#8C,#5C,#86,#C6,#FE,#8E,#FF,#F0,#FB,#93,#FF
    DB #F4,#30,#F8,#E5,#38,#BF,#88,#FE,#C3,#2C,#35,#C0,#29,#83,#03,#D6
    DB #80,#DD,#89,#65,#67,#C8,#90,#C0,#E8,#D1,#8B,#0E,#B4,#0D,#62,#80
    DB #A8,#83,#86,#02,#19,#9C,#98,#99,#9A,#82,#7D,#5C,#7E,#FE,#9E,#9B
    DB #80,#26,#88,#92,#92,#FF,#F8,#C0,#5E,#FA,#EA,#80,#85,#D3,#B8,#D3
    DB #B0,#3D,#C0,#69,#80,#F7,#80,#F7,#30,#D0,#7D,#FC,#BF,#82,#FB,#80
    DB #0C,#BE,#44,#B5,#FC,#4B,#80,#E3,#FB,#D0,#55,#55,#80
...
BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 80 bytes)
    DB #85,#00,#56,#80,#10,#0F,#88,#57,#D4,#40,#F4,#C0,#68,#08,#F7,#F9
    DB #CC,#57,#D1,#C0,#F1,#84,#0F,#D3,#80,#C0,#38,#AC,#0B,#20,#A6,#FF
    DB #10,#8E,#04,#94,#5F,#78,#3C,#E0,#4E,#42,#13,#C4,#C0,#36,#9C,#47
    DB #F3,#E3,#F0,#D7,#AE,#DC,#EE,#91,#3E,#F9,#C9,#5C,#7C,#C0,#46,#B9
    DB #04,#FE,#38,#C0,#13,#4D,#4C,#7B,#C0,#31,#44,#E1,#FE,#75,#55,#58
...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 132 bytes)
    ...
    DB #F6,#E4,#80,#73,#74,#42,#65,#94,#95,#82,#18,#E8,#96,#97,#17,#86
    DB #53,#7D,#3D,#FC,#EC,#E4,#C6,#C4,#F8,#83,#FC,#80,#8B,#8C,#BF,#88
    DB #E5,#84,#4E,#98,#FC,#EE,#C0,#34,#F7,#99,#D2,#47,#EC,#5C,#86,#91
    DB #0E,#DA,#D8,#20,#8A,#81,#D9,#B8,#F3,#24,#FF,#FB,#E5,#F0,#DA,#4F
    DB #E0,#BD,#8C,#F9,#DD,#B8,#BF,#A4,#E4,#E3,#FB,#E4,#BB,#50,#FD,#88
    DB #D5,#F5,#55,#60
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #22,#04,#10,#01,#36,#AA,#54,#CC,#30,#57,#34,#60,#73,#20,#57,#61
    DB #A8,#7F,#35,#BC,#4C,#D5,#40,#FD,#9E,#84,#CE,#3C,#E2,#38,#C0,#53
    DB #55,#55,#80
...
SCREEN_PAN2_1_INTERACTION_VALUE_MAP:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_PAN3_3_LAYOUT:
    ...
    DB #18,#90,#80,#81,#68,#86,#3F,#6B,#F1,#80,#80,#D3,#84,#43,#68,#2D
    DB #82,#79,#FC,#5E,#80,#04,#D5,#55,#60
...
BEHAVIOR_PAN3_3_DATA:
    ; ZX0 compressed behavior (768 -> 61 bytes)
    DB #85,#00,#56,#95,#10,#7D,#82,#4F,#C0,#0A,#08,#14,#FC,#D3,#58,#1E
    DB #40,#50,#A1,#00,#5E,#FA,#13,#DD,#FE,#D4,#7C,#F5,#00,#5A,#08,#CD
    DB #54,#4E,#C0,#05,#33,#82,#5C,#D3,#60,#D5,#C0,#F7,#76,#70,#40,#3D
    DB #C0,#5A,#08,#4F,#F1,#49,#82,#47,#80,#C0,#4D,#55,#56
...
SCREEN_PAN3_3_INTERACTION_VALUE_MAP:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    DB #00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00,#01,#01,#00,#01,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01
    DB #01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01
...
SCREEN_PAN4_4_LAYOUT:
    ; ZX0 compressed layout (768 -> 131 bytes)
    DB #85,#FF,#56,#3C,#80,#81,#FC,#4F,#C3,#F1,#F9,#88,#7A,#FA,#FA,#82
    DB #C0,#86,#14,#FE,#C9,#FB,#80,#22,#82,#83,#41,#DC,#F6,#E1,#80,#22
    DB #94,#95,#0A,#FF,#68,#8D,#46,#21,#96,#97,#68,#8D,#FD,#FA,#82,#56
    DB #2F,#89,#8A,#FB,#CF,#80,#00,#5F,#E0,#9F,#8B,#8C,#82,#FB,#73,#80
    DB #E0,#93,#00,#F7,#EF,#80,#17,#D7,#6E,#A1,#81,#86,#A4,#FF,#1D,#D7
    DB #80,#F4,#EF,#C0,#FD,#7B,#80,#2F,#93,#FF,#82,#78,#FF,#88,#BA,#00
    DB #4F,#FC,#F0,#80,#73,#40,#5F,#80,#5F,#FE,#5E,#81,#91,#80,#69,#FF
    DB #A0,#82,#17,#C1,#C6,#BD,#81,#81,#31,#06,#29,#82,#D3,#00,#43,#6D
    DB #26,#55,#56
...
BEHAVIOR_PAN4_4_DATA:
    ...
    DB #85,#00,#56,#94,#10,#3F,#C2,#C5,#88,#F6,#C0,#95,#08,#7F,#F5,#C0
    DB #02,#80,#00,#5B,#08,#80,#80,#68,#08,#FD,#FA,#C7,#56,#C0,#40,#D9
    DB #40,#7C,#40,#3D,#EF,#D1,#80,#F5,#C0,#A5,#08,#5E,#41,#95,#00,#69
    DB #00,#5B,#04,#BC,#FF,#10,#C0,#4F,#FE,#F1,#C0,#CD,#40,#03,#CF,#CC
    DB #C0,#55,#D3,#48,#53,#D5,#C0,#F5,#FE,#75,#55,#58
SCREEN_PAN4_4_INTERACTION_TYPE_MAP:
    ...
    DB #00,#00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#01,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_PAN4_4_INTERACTION_VALUE_MAP:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#01
    DB #00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#01,#00,#00,#01,#00,#00
    DB #00,#00,#00,#00,#00,#01,#01,#01,#01,#01,#01,#01,#01,#00,#00,#01
    DB #00,#00,#00,#00,#00,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#01,#01,#01,#01,#01,#01,#01,#01,#00,#00,#01
    DB #01,#00,#00,#00,#01,#01,#01,#00,#00,#00,#00,#00,#00,#00,#01,#01
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#01
...
SM_New_Statemachine_state_1771966990568_Transitions: 
    ...
    DB 16, 4, 0, 1; Lives (ID 16) >= 1
    DW SM_New_Statemachine_state_1771533530403 
    DW SM_New_Statemachine_state_1771966990568_Transitions_Actions_2 
    DB 8; HAS_COLLISION 
    DB 2          ; collisionType: enemy
    DW SM_New_Statemachine_state_1771533530403 
