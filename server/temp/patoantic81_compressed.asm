...
; Estimated payload bytes: 103135
...
; BANK 01 @#0000 : worlds.asm (680 bytes)
; BANK 01 @#02A8 : screens.asm part 1/2 (7512 bytes)
; BANK 02 @#0000 : screens.asm part 2/2 (6664 bytes)
; BANK 02 @#1A08 : sprites.asm part 1/2 (1528 bytes)
; BANK 03 @#0000 : sprites.asm part 2/2 (8139 bytes)
; BANK 03 @#1FCB : font.asm (53 bytes)
; BANK 04 @#0000 : font.asm (3494 bytes)
; BANK 04 @#0DA6 : hud.asm (3836 bytes)
; BANK 04 @#1CA2 : menus.asm (444 bytes)
; BANK 04 @#1E5E : sound.asm (418 bytes)
; BANK 05 @#0000 : sound.asm (2766 bytes)
; BANK 05 @#0ACE : scroll.asm (2353 bytes)
; BANK 05 @#13FF : animtiles.asm (3073 bytes)
; BANK 06 @#0000 : animtiles.asm (2843 bytes)
; BANK 06 @#0B1B : particles.asm (4963 bytes)
; BANK 06 @#1E7E : statemachine.asm part 1/4 (386 bytes)
...
; BANK 10 @#0000 : statemachine.asm part 5/4 (4324 bytes)
; BANK 10 @#10E4 : gameflow.asm part 1/3 (3868 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (4831 bytes)
...
load_sprite_patterns:
    ...
    call mapper_push_p2
    ; Entity 0: nina_walk_right (2 layers)
    ; Base HW Sprite: 0
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 117 bytes)
    DB #95,#84,#69,#00,#57,#D5,#80,#A1,#80,#58,#E6,#80,#81,#FC,#E5,#82
    DB #C0,#A1,#86,#23,#82,#83,#9B,#FC,#80,#D3,#96,#D7,#FC,#C3,#80,#E0
    DB #A3,#7E,#A5,#83,#E5,#00,#0A,#00,#44,#F5,#FE,#E4,#00,#3E,#FF,#00
    DB #40,#E3,#CD,#00,#85,#60,#F0,#D8,#50,#4F,#FB,#9F,#C0,#76,#E4,#38
    DB #7D,#80,#EE,#F6,#C0,#57,#37,#DA,#D1,#80,#BD,#86,#C0,#1C,#94,#0A
    DB #EF,#C0,#F0,#E5,#40,#69,#82,#DF,#88,#9E,#A8,#FE,#07,#DD,#80,#91
    DB #40,#BC,#86,#80,#3F,#FC,#C1,#80,#E5,#FC,#3F,#CB,#80,#39,#FC,#4F
    DB #CB,#8D,#80,#55,#56
...
BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 63 bytes)
    DB #85,#00,#56,#E5,#10,#D0,#7C,#FE,#F0,#C0,#A5,#08,#5F,#E5,#D7,#FE
    DB #D7,#C0,#D1,#80,#F8,#FF,#C0,#11,#36,#5A,#53,#D3,#8E,#83,#EA,#C5
    DB #70,#F5,#C0,#1A,#08,#1D,#95,#B0,#78,#D8,#39,#90,#4E,#98,#5F,#C0
    DB #00,#A4,#08,#7F,#FE,#90,#80,#F4,#FE,#78,#C0,#43,#55,#55,#80
...
SM_New_Statemachine_state_1772025558931_Transitions: 
    ...
    DB 2          ; collisionType: enemy
    DW SM_New_Statemachine_state_1771533530403 
    DW SM_New_Statemachine_state_1772025558931_Transitions_Actions_0 

SM_New_Statemachine_state_1772025558931_Transitions_Actions_0: 
    DB 5; CHANGE_SPRITE 
    DB 6; sprite: nina_dead 
    DB 0xFF; END
