; ==================================================================
; JOC4_BLOCKS2X2 - MEGAROM UNIFIED FILE
...
; Bank 6 [#A000-#C000]: screens_code (4178/8192 bytes est.) [FAR — accessed via trampoline]
...
; - SCREEN_PAN1_0_BLOCK_MAP            192 bytes @ #8600 (rom #1E600, offset +#0600) [SCREENS/SCREEN_BLOCK_MAP]
; - SCREEN_PAN1_0_BLOCK_CATALOG         40 bytes @ #86C0 (rom #1E6C0, offset +#06C0) [SCREENS/SCREEN_BLOCK_CATALOG]
; - SPRITE_PLACEHOLDER_PATTERN          32 bytes @ #86E8 (rom #1E6E8, offset +#06E8) [SPRITES/SPRITE_PATTERNS]
; - tile_pattern_bank0                  32 bytes @ #8708 (rom #1E708, offset +#0708) [PATTERNS/TILE_PATTERNS]
; - tilebank_pattern_data_0             32 bytes @ #8728 (rom #1E728, offset +#0728) [PATTERNS/TILE_PATTERNS]
; - tile_color_bank0                    32 bytes @ #8748 (rom #1E748, offset +#0748) [COLORS/TILE_COLORS]
; - tilebank_color_data_0               32 bytes @ #8768 (rom #1E768, offset +#0768) [COLORS/TILE_COLORS]
; - SCREEN_PAN1_0_EFFECT_ZONE_TABLE      1 bytes @ #8788 (rom #1E788, offset +#0788) [SCREENS/SCREEN_EFFECT_ZONE_TABLE]
; FREE 6263
...
SCREEN_PAN1_0_BLOCK_CATALOG_COUNT EQU 10
SCREEN_PAN1_0_BLOCK_CATALOG_SIZE EQU 40
SCREEN_PAN1_0_BLOCK_MAP_BANK EQU ((SCREEN_PAN1_0_BLOCK_MAP - #4000) / #2000)
SCREEN_PAN1_0_BLOCK_MAP_WIDTH EQU 16
SCREEN_PAN1_0_BLOCK_MAP_HEIGHT EQU 12
SCREEN_PAN1_0_BLOCK_MAP_SIZE EQU 192
SCREEN_PAN1_0_BLOCK_TOTAL_SIZE EQU 232
...
; Data start address: #1E000
; Total data bytes (source blocks): 1929
; Zones used: 1
; Placement policy: sort blocks by size descending, then first-fit by zone.
; ------------------------------------------------------------------
; ZONE 00 [#1E000-#20000] bank 13 used=1929 slack=6263
;   + SCREEN_PAN1_0_EFFECTS_LAYOUT (screens) @ +#0000 size=768
;   + BEHAVIOR_PAN1_0_DATA (screens) @ +#0300 size=768
;   + SCREEN_PAN1_0_BLOCK_MAP (screens) @ +#0600 size=192
;   + SCREEN_PAN1_0_BLOCK_CATALOG (screens) @ +#06C0 size=40
;   + SPRITE_PLACEHOLDER_PATTERN (sprites) @ +#06E8 size=32
;   + tile_pattern_bank0 (patterns) @ +#0708 size=32
;   + tilebank_pattern_data_0 (patterns) @ +#0728 size=32
;   + tile_color_bank0 (colors) @ +#0748 size=32
;   + tilebank_color_data_0 (colors) @ +#0768 size=32
;   + SCREEN_PAN1_0_EFFECT_ZONE_TABLE (screens) @ +#0788 size=1

    org #1E000
; ==================================================================
; DATA ZONE 00 (bank 13) used=1929 slack=6263
; ==================================================================
SCREEN_PAN1_0_EFFECTS_LAYOUT:
...
SCREEN_PAN1_0_BLOCK_MAP:
    ; pan1 - background block index map (16x12)
    ; 232 bytes optimized vs 768 raw (536 byte delta)
    DB #00,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#02
    DB #00,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#02
    DB #00,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#02
    DB #00,#03,#03,#03,#03,#03,#03,#03,#03,#03,#04,#01,#01,#01,#01,#02
    DB #00,#05,#05,#05,#05,#05,#05,#05,#05,#05,#06,#01,#01,#01,#01,#02
    DB #00,#05,#05,#05,#05,#05,#05,#05,#05,#05,#06,#01,#01,#01,#01,#02
    DB #00,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#01,#02
    DB #00,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#01,#01,#01,#02
    DB #00,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#01,#01,#01,#02
    DB #00,#08,#08,#08,#08,#08,#08,#08,#08,#08,#08,#08,#01,#01,#01,#02
    DB #00,#05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#05,#03,#03,#03,#09
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; pan1 - background block catalog (2x2)
    ; 10 unique blocks, 40 bytes total
    DB #00,#01,#02,#03,#FF,#FF,#FF,#FF,#FF,#00,#FF,#02,#FF,#FF,#00,#01
    DB #FF,#FF,#00,#FF,#02,#03,#00,#01,#02,#FF,#00,#FF,#02,#03,#01,#00
    DB #03,#02,#00,#01,#FF,#00,#00,#01
