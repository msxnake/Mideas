...
function applyConditionalHandlers(asm, usedActions, usedConditions) {
    ...
    if (!hasAction(statemachine_types_1.ActionTypes.EXIT_CURRENT_WORLD)) {
 ...
 */
function generateStateMachineSystem(stateMachines, globalVariables, sprites, tiles, templates, sounds, trackIndexByAssetId, romMode = 'simple32k', targetFormat = 'konami') {
