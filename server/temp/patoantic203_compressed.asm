...
update_secret_zone_component:
    ...
    srl a
    srl a
    ld h, a                       ; H = hero center X in cells
    ...
    srl a
    srl a
    ld l, a                       ; L = hero center Y in cells
...
BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 78 bytes)
    DB #85,#00,#56,#80,#10,#0F,#88,#53,#BD,#C1,#08,#40,#5D,#C4,#CC,#AA
    DB #08,#10,#55,#F1,#C0,#5D,#D1,#80,#F8,#D3,#C0,#03,#80,#AC,#BA,#19
    DB #FF,#10,#68,#04,#E5,#94,#F3,#78,#C4,#E0,#E1,#42,#39,#C0,#04,#D6
    DB #90,#13,#D7,#D9,#BE,#07,#E5,#C9,#98,#F1,#C0,#1A,#04,#79,#BA,#5B
    DB #08,#84,#C0,#DD,#BC,#7B,#C0,#31,#44,#E1,#FE,#75,#55,#58
...
BEHAVIOR_PAN6_6_DATA:
    ...
    DB #85,#00,#56,#96,#10,#8A,#19,#10,#50,#EE,#AA,#CE,#53,#D1,#FE,#E0
