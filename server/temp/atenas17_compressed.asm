...
; BANK 03 @#0000 : screens.asm part 2/2 (4080 bytes)
; BANK 03 @#0FF0 : sprites.asm part 1/2 (4112 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (6064 bytes)
; BANK 04 @#17B0 : font.asm (177 bytes)
; BANK 04 @#1861 : hud.asm (114 bytes)
; BANK 04 @#18D3 : menus.asm (219 bytes)
; BANK 04 @#19AE : sound.asm (1618 bytes)
; BANK 05 @#0000 : sound.asm (3151 bytes)
; BANK 05 @#0C4F : scroll.asm (2389 bytes)
; BANK 05 @#15A4 : animtiles.asm (2586 bytes)
; BANK 05 @#1FBE : bosses.asm (66 bytes)
; BANK 06 @#0000 : bosses.asm (5716 bytes)
; BANK 06 @#1654 : statemachine.asm part 1/2 (2476 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/2 (4969 bytes)
; BANK 08 @#1369 : gameflow.asm (3223 bytes)
; BANK 09 @#0000 : gameflow.asm (2371 bytes)
