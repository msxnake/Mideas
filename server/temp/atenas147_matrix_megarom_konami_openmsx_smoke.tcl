set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas147_matrix_megarom_konami_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas147_matrix_megarom_konami_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set p1 [mem8 0xC153]; set p2 [mem8 0xC154]; set p3 [mem8 0xC155]; set p4 [mem8 0xC156]
    set flow [mem8 0xC11C]; set screen [mem8 0xE27D]; set irq [mem16 0xE978]; set inirq [mem8 0xE97D]
    set px [mem16 0xE287]; set py [mem16 0xE289]
...
after time 12.0 { shot "atenas147_matrix_megarom_konami_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "atenas147_matrix_megarom_konami_t16.png" "t16" }
after time 22.0 { shot "atenas147_matrix_megarom_konami_t22.png" "t22"; close $f; exit }
