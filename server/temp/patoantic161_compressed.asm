...
; Estimated payload bytes: 96798
; Estimated banks used: 12
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (1265 bytes)
; BANK 00 @#04F1 : colors.asm (1127 bytes)
; BANK 00 @#0958 : components.asm (22 bytes)
; BANK 00 @#096E : entities.asm part 1/2 (5778 bytes)
; BANK 01 @#0000 : entities.asm part 2/2 (2845 bytes)
; BANK 01 @#0B1D : worlds.asm (3978 bytes)
; BANK 01 @#1AA7 : screens.asm part 1/3 (1369 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (8046 bytes)
; BANK 03 @#1F6E : sprites.asm part 1/2 (146 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 05 @#0000 : sprites.asm part 3/2 (2782 bytes)
; BANK 05 @#0ADE : font.asm (3547 bytes)
; BANK 05 @#18B9 : hud.asm (1863 bytes)
; BANK 06 @#0000 : hud.asm (2604 bytes)
; BANK 06 @#0A2C : menus.asm (168 bytes)
; BANK 06 @#0AD4 : sound.asm part 1/2 (5420 bytes)
; BANK 07 @#0000 : sound.asm part 2/2 (4118 bytes)
; BANK 07 @#1016 : scroll.asm (2353 bytes)
; BANK 07 @#1947 : animtiles.asm (1721 bytes)
; BANK 08 @#0000 : animtiles.asm (5166 bytes)
; BANK 08 @#142E : particles.asm (3026 bytes)
; BANK 09 @#0000 : particles.asm (1937 bytes)
; BANK 09 @#0791 : statemachine.asm part 1/2 (6255 bytes)
; BANK 10 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 11 @#0000 : statemachine.asm part 3/2 (1170 bytes)
; BANK 11 @#0492 : gameflow.asm (5516 bytes)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (152 -> 136 bytes)
    ...
    DB #D0,#A2,#C0,#FF,#C0,#8A,#D0,#0B,#A2,#03,#FF,#03,#20,#35,#7E,#FE
    DB #AE,#DE,#BE,#DE,#FC,#00,#55,#58
load_pattern_bank0:
    ...
    ld bc, 152    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 152    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (152 -> 55 bytes)
...
load_color_bank0:
    ...
    ld bc, 152     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 139 bytes)
    DB #95,#84,#69,#00,#56,#95,#84,#6A,#80,#E3,#81,#FC,#F1,#FB,#FC,#88
    DB #88,#92,#FB,#F0,#82,#C4,#48,#8E,#82,#83,#FD,#F5,#80,#00,#3C,#80
    DB #5E,#FD,#BC,#86,#80,#18,#F4,#81,#81,#00,#62,#83,#83,#50,#DD,#6E
    DB #F4,#80,#A0,#85,#3E,#8B,#FC,#6F,#80,#C0,#03,#9C,#F0,#86,#C6,#F2
    DB #8E,#FF,#BE,#4F,#FB,#21,#F8,#DC,#38,#5F,#B1,#35,#C0,#29,#83,#F4
    DB #80,#4F,#C1,#DF,#F0,#FC,#4F,#D8,#3A,#40,#E4,#86,#10,#37,#88,#3D
    DB #A8,#F5,#FE,#E2,#80,#6F,#88,#92,#92,#F8,#E5,#80,#74,#F4,#B8,#CF
    DB #B0,#80,#4A,#86,#68,#85,#0E,#30,#7C,#FC,#6E,#82,#FB,#E5,#85,#80
    DB #FC,#BD,#FC,#6E,#80,#FB,#FD,#85,#D0,#55,#56
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #02,#C0,#15,#F9,#CF,#C0,#0A,#04,#11,#33,#C0,#59,#91,#19,#19,#19
    DB #C8,#F8,#47,#8F,#C6,#C0,#01,#35,#85,#90,#F2,#EE,#E4,#08,#90,#39
    DB #98,#7D,#C0,#57,#D7,#BA,#A6,#C1,#08,#BD,#04,#FE,#1E,#C0,#10,#D5
    DB #55,#60
...
; Free RAM buffer for tile pattern data decompression (152 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D800

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (152 bytes)
; ==================================================================
