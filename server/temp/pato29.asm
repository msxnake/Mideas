...
;   Active entities: 2
;   Used components: Position, Sprite, Animation, Patrol, Input, StateMachine, Cursors, Gravity, WallCollision, Jump
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Animation, Patrol, Input, StateMachine, Cursors, Gravity, WallCollision, Jump 
...
update_all_entities:
    ...
    ret
; Total systems called: 9 (optimized from 15)
...
gameflow_node_gfn_1770833873618_data:
    ...
    DW load_screen_pan2_771184738851            ; Background screen load function (0=none)
...
gameflow_node_gfn_1771421649196_data:
    ...
    DB 7, 9              ; Row 7, Col 9
    DW text_gfn_1771421649196_msg0          ; -> "GRAPHICS-JORDI"
    DB 8, 6              ; Row 8, Col 6
    DW text_gfn_1771421649196_msg1          ; -> "SALA,
GAMEPLAY-JORDI"
    DB 9, 4              ; Row 9, Col 4
    DW text_gfn_1771421649196_msg2          ; -> "SALA,
THANKS FOR PLAYING"
    DB 20, 5              ; Row 20, Col 5
