...
; Auto MegaROM: No
; ==================================================================
; EXPERIMENTAL: plain48k plumbing is enabled, but page-0 asset packing is not implemented yet.
; ------------------------------------------------------------------
...
; Checks end-of-song flag, handles loop/stop, runs PT3_ROUT+PT3_PLAY.
