...
; Estimated payload bytes: 100825
...
; BANK 11 @#0000 : statemachine.asm part 3/3 (3396 bytes)
; BANK 11 @#0D44 : gameflow.asm (4796 bytes)
; BANK 12 @#0000 : gameflow.asm (2521 bytes)
