...
SCREEN_PAN2_1_LAYOUT:
    ...
    DB #46,#57,#D5,#C0,#A5,#82,#58,#EF,#89,#8A,#FC,#28,#39,#54,#38,#00
    DB #39,#6A,#7D,#54,#4E,#80,#5D,#C4,#30,#FE,#F6,#80,#1D,#70,#80,#17
    DB #7D,#3D,#FC,#EC,#E4,#C6,#C4,#F8,#83,#FC,#80,#8B,#8C,#EF,#E4,#84
    DB #4E,#98,#F5,#40,#A4,#8D,#3B,#98,#D0,#00,#FB,#5C,#86,#24,#0E,#76
    DB #D8,#88,#8A,#81,#36,#B8,#78,#F5,#9F,#90,#91,#FB,#9F,#E4,#4F,#6A
    DB #E0,#8C,#F7,#F9,#B8,#7F,#F9,#C1,#BF,#F4,#FB,#E4,#39,#FC,#D5,#55
    DB #60
...
BEHAVIOR_PAN2_1_DATA:
    ; ZX0 compressed behavior (768 -> 55 bytes)
    DB #85,#00,#56,#95,#10,#7F,#BA,#D4,#3A,#AA,#10,#08,#51,#3D,#46,#5F
    DB #C0,#55,#F5,#2A,#F5,#D4,#E4,#2A,#69,#10,#56,#84,#10,#1D,#74,#80
    DB #03,#D3,#C4,#81,#C0,#3D,#40,#69,#08,#5F,#00,#57,#93,#9E,#D5,#0A
    DB #E4,#E6,#E1,#C0,#4D,#55,#56
