; ==================================================================
; PATOANTIC132_AUTOSAVE - UNIFIED FILE
...
; Estimated payload bytes: 118199
...
; BANK 00 @#08C5 : entities.asm (5947 bytes)
; BANK 01 @#0000 : entities.asm (1083 bytes)
; BANK 01 @#043B : worlds.asm (4000 bytes)
; BANK 01 @#13DB : screens.asm part 1/3 (3109 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (6225 bytes)
; BANK 03 @#1851 : sprites.asm part 1/2 (1967 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (7903 bytes)
; BANK 04 @#1EDF : font.asm (289 bytes)
; BANK 05 @#0000 : font.asm (3258 bytes)
; BANK 05 @#0CBA : hud.asm (4467 bytes)
; BANK 05 @#1E2D : menus.asm (444 bytes)
; BANK 05 @#1FE9 : sound.asm part 1/2 (23 bytes)
; BANK 06 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 07 @#0000 : sound.asm part 3/2 (1186 bytes)
; BANK 07 @#04A2 : scroll.asm (2353 bytes)
; BANK 07 @#0DD3 : animtiles.asm (4653 bytes)
; BANK 08 @#0000 : animtiles.asm (164 bytes)
; BANK 08 @#00A4 : particles.asm (4963 bytes)
; BANK 08 @#1407 : statemachine.asm part 1/4 (3065 bytes)
...
; BANK 12 @#0000 : statemachine.asm part 5/4 (2770 bytes)
; BANK 12 @#0AD2 : gameflow.asm part 1/3 (5422 bytes)
; BANK 13 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : gameflow.asm part 3/3 (3511 bytes)
...
load_pattern_bank0:
    ...
    ld bc, 128    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 128    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
load_color_bank0:
    ...
    ld bc, 128     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    call mapper_pop_p2
    ret
...
;; Size: 16x16
NINA_DEAD_LEFT_13_F1_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #40,#40,#40,#40,#40,#40,#60,#38,#08,#18,#10,#10,#10,#1E,#08,#08
    DB #08,#0C,#06,#02,#02,#02,#02,#02,#1E,#0C,#04,#04,#04,#3C,#20,#20

NINA_DEAD_LEFT_13_F1_LAYER2: ; Brush Color Index 2 (Actual Color: #000000)
    DB #20,#30,#34,#24,#20,#30,#1E,#04,#04,#04,#0C,#08,#0F,#01,#07,#04
    DB #10,#10,#58,#8C,#24,#74,#74,#3C,#A0,#30,#18,#00,#78,#40,#40,#40

;; ---- End of Frame: nina_dead_left_13_F1 ----
...
;; Size: 16x16
NINA_IDLE_LEFT_14_F0_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #1F,#00,#00,#00,#00,#00,#00,#03,#02,#03,#07,#0F,#00,#00,#00,#02
    DB #E0,#E0,#A0,#30,#18,#08,#08,#C0,#40,#C0,#E0,#F0,#00,#80,#00,#80

NINA_IDLE_LEFT_14_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#0F,#0B,#1F,#1F,#0F,#01,#00,#01,#00,#00,#00,#00,#00,#00,#01
    DB #00,#00,#00,#40,#C0,#80,#80,#00,#00,#00,#00,#00,#80,#00,#80,#00

;; ---- End of Frame: nina_idle_left_14_F0 ----

;; ---- Sprite Frame: nina_idle_left_14_F1 ----
;; Size: 16x16
NINA_IDLE_LEFT_14_F1_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #1F,#00,#00,#00,#00,#00,#00,#03,#02,#03,#07,#0F,#00,#00,#00,#02
    DB #E0,#E0,#A0,#30,#18,#04,#04,#C0,#40,#C0,#E0,#F0,#00,#80,#00,#80

NINA_IDLE_LEFT_14_F1_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#0F,#0B,#1B,#1F,#0F,#01,#00,#01,#00,#00,#00,#00,#00,#00,#01
    DB #00,#00,#00,#40,#C0,#80,#80,#00,#00,#00,#00,#00,#80,#00,#80,#00

;; ---- End of Frame: nina_idle_left_14_F1 ----
...
;; Size: 16x16
NINA_FALL_LEFT_15_F0_LAYER0: ; Brush Color Index 0 (Actual Color: #D4524D)
    DB #1F,#00,#00,#00,#00,#00,#00,#03,#02,#07,#0F,#3F,#00,#00,#00,#00
    DB #E0,#E0,#A0,#30,#18,#08,#08,#C0,#40,#E0,#F0,#FC,#80,#00,#80,#00

NINA_FALL_LEFT_15_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#0F,#0B,#1B,#1F,#0F,#01,#00,#01,#00,#00,#00,#00,#00,#00,#01
    DB #00,#00,#00,#40,#C0,#80,#80,#00,#00,#00,#00,#00,#00,#80,#00,#80

;; ---- End of Frame: nina_fall_left_15_F0 ----
...
SCREEN_PAN3_3_LAYOUT:
    ...
    DB #00,#00,#00,#00,#00,#86,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#80
    DB #00,#00,#00,#8D,#00,#00,#8D,#00,#00,#8D,#00,#00,#00,#00,#8D,#00
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#82,#83,#82,#83,#82,#83,#82,#83,#82,#80
    DB #82,#83,#82,#83,#00,#00,#81,#80,#81,#80,#81,#80,#81,#80,#81,#80
    DB #81,#80,#00,#00,#00,#00,#80,#81,#80,#81,#80,#81,#80,#81,#80,#82
...
BEHAVIOR_PAN3_3_DATA:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#00,#00,#08,#00,#00,#08,#00,#00,#08,#00,#00,#00,#00,#08,#00
    ...
    DB #10,#10,#00,#00,#00,#00,#10,#10,#10,#10,#10,#10,#10,#10,#10,#10
...
; Entity: pato 3 (instance from template: tpl_1770837237607_l05j9)
ENTITY_PATO_3_ID EQU 2
ENTITY_PATO_3_COMP_MASK EQU #8F  ; Component mask: 10001111b
; Template: tpl_1770837237607_l05j9
ENTITY_PATO_3_X EQU 5
ENTITY_PATO_3_Y EQU 4

; Entity: pato 4 (instance from template: tpl_1770837237607_l05j9)
ENTITY_PATO_4_ID EQU 3
ENTITY_PATO_4_COMP_MASK EQU #8F  ; Component mask: 10001111b
; Template: tpl_1770837237607_l05j9
ENTITY_PATO_4_X EQU 16
ENTITY_PATO_4_Y EQU 19
...
init_pato_3:
    ; Initialize pato 3 at real position from JSON
...
init_pato_4:
    ; Initialize pato 4 at real position from JSON
