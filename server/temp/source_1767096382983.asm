...
; Flow: Start → WorldLink (gfn_1767095607858)
; ==================================================================
...
ENTITY_PUNTDEMIRA_1_TEMPLATE EQU "tpl_1767095359697_dc6vt"
...
; Total Nodes: 3
; Total Connections: 2
; Start Node: gf_start_1767095547738
;
; ARCHITECTURE:
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_start_1767095547738
...
gameflow_handle_end:
    ...
    inc de
    ld l, (de)                    ; HL = message pointer (if any)
    inc de
    ld h, (de)
...
; ------------------------------------------------------------------
; Helper: Clear screen area for end screen
; ------------------------------------------------------------------
clear_screen_area:
...
.psv_loop:
    ...
    push hl
    push de
    ld hl, de                     ; HL = VRAM address
    ld (hl), a                    ; Write to VRAM (simplified)
    ; In reality, need to use WRTVRM
    ld a, (hl)
    ld c, a
    call WRTVRM
    pop de
...
; Node: Start - "gf_start_1767095547738"
gameflow_node_gf_start_1767095547738:
    db NODE_TYPE_START
    dw gameflow_node_gf_start_1767095547738_data
    dw gameflow_node_gf_start_1767095547738_conn

gameflow_node_gf_start_1767095547738_data:
    dw gameflow_node_gf_start_1767095547738_init    ; Initialization routine address

gameflow_node_gf_start_1767095547738_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1767095607858
    db CONNECTION_END

; ------------------------------------------------------------------
; gameflow_node_gf_start_1767095547738_init
...
; Node: WorldLink - "gfn_1767095607858"
gameflow_node_gfn_1767095607858:
    db NODE_TYPE_WORLD_LINK
    dw gameflow_node_gfn_1767095607858_data
    dw gameflow_node_gfn_1767095607858_conn

gameflow_node_gfn_1767095607858_data:
    dw load_world_worldmap_1767095499385

gameflow_node_gfn_1767095607858_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1767095618442
    db CONNECTION_END

; Node: End - "gfn_1767095618442"
gameflow_node_gfn_1767095618442:
    db NODE_TYPE_END
    dw gameflow_no_data
    dw gameflow_node_gfn_1767095618442_conn

gameflow_node_gfn_1767095618442_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
