...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (384 -> 121 bytes)
    ...
    DB #83,#F9,#F3,#F8,#E4,#2E,#F7,#DE,#DF,#70,#F0,#7D,#D2,#FF,#BA,#88
    DB #FF,#E6,#7E,#1F,#FF,#65,#82,#D8,#60,#7F,#53,#A3,#D8,#FD,#8C,#7F
    DB #FD,#E0,#F7,#92,#DF,#E0,#70,#7F,#E0,#DF,#A0,#8B,#67,#3C,#DF,#E0
    DB #FE,#7F,#E0,#65,#C0,#FD,#E0,#55,#56
SCREEN_PAN1_0_BLOCK_MAP:
    ; ZX0 compressed screen_block_map (48 -> 40 bytes)
    DB #96,#00,#21,#01,#02,#94,#8B,#03,#04,#00,#05,#00,#06,#00,#07,#08
    DB #09,#0A,#0B,#0C,#00,#0D,#9E,#E1,#0E,#0F,#10,#F0,#80,#D5,#11,#12
    DB #13,#14,#15,#16,#16,#17,#55,#60
