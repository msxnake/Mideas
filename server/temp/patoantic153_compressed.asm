...
; BANK 00 @#0937 : entities.asm part 1/2 (5833 bytes)
; BANK 01 @#0000 : entities.asm part 2/2 (2786 bytes)
; BANK 01 @#0AE2 : worlds.asm (3978 bytes)
; BANK 01 @#1A6C : screens.asm part 1/3 (1428 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (7987 bytes)
; BANK 03 @#1F33 : sprites.asm part 1/2 (205 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 05 @#0000 : sprites.asm part 3/2 (2723 bytes)
; BANK 05 @#0AA3 : font.asm (3547 bytes)
; BANK 05 @#187E : hud.asm (1922 bytes)
; BANK 06 @#0000 : hud.asm (2545 bytes)
; BANK 06 @#09F1 : menus.asm (168 bytes)
; BANK 06 @#0A99 : sound.asm part 1/2 (5479 bytes)
; BANK 07 @#0000 : sound.asm part 2/2 (4059 bytes)
; BANK 07 @#0FDB : scroll.asm (2353 bytes)
; BANK 07 @#190C : animtiles.asm (1780 bytes)
; BANK 08 @#0000 : animtiles.asm (5107 bytes)
; BANK 08 @#13F3 : particles.asm (3085 bytes)
; BANK 09 @#0000 : particles.asm (1878 bytes)
; BANK 09 @#0756 : statemachine.asm part 1/2 (6314 bytes)
; BANK 10 @#0000 : statemachine.asm part 2/2 (8192 bytes)
; BANK 11 @#0000 : statemachine.asm part 3/2 (1111 bytes)
; BANK 11 @#0457 : gameflow.asm (5516 bytes)
...
;   Active entities: 5
;   Used components: Position, Sprite, Input, Cursors, Gravity, WallCollision, Animation, Jump, StateMachine, Collision, comp_tile_collector, Health, Patrol, TileInteraction
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Input, Cursors, Gravity, WallCollision, Animation, Jump, StateMachine, Collision, comp_tile_collector, Health, Patrol, TileInteraction 
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (144 -> 124 bytes)
    ...
    DB #18,#80,#18,#3C,#7E,#B9,#34,#18,#01,#F0,#81,#F8,#80,#FE,#FF,#FF
    DB #DF,#AF,#DF,#FF,#7F,#70,#A8,#80,#20,#42,#22,#09,#80,#8A,#42,#08
    DB #3E,#02,#10,#89,#F7,#88,#09,#2E,#40,#00,#04,#01,#FF,#8F,#38,#F7
    DB #AA,#62,#A9,#8E,#A5,#E1,#AB,#10,#7C,#A1,#BC,#E4,#D0,#D0,#C0,#C0
    DB #FF,#FB,#BD,#D0,#0B,#0B,#03,#03,#FF,#FF,#55,#56
load_pattern_bank0:
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (144 -> 52 bytes)
    DB #8A,#41,#51,#FF,#FA,#F0,#F7,#FE,#E0,#E9,#F0,#B8,#C1,#FF,#AA,#31
    DB #21,#C1,#8A,#81,#91,#A0,#A1,#4F,#9A,#7D,#70,#59,#3A,#F1,#F1,#71
    DB #E1,#E1,#F1,#FF,#61,#3B,#71,#81,#BF,#EE,#DE,#8E,#F6,#FF,#9F,#71
    DB #F0,#75,#55,#58
load_color_bank0:
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #88,#FE,#EF,#F0,#82,#48,#12,#3B,#82,#83,#FD,#80,#D4,#00,#F1,#80
    DB #7A,#FD,#86,#F0,#80,#63,#81,#81,#D1,#00,#89,#83,#83,#43,#77,#6E
    DB #D2,#80,#80,#85,#F9,#8B,#FC,#BC,#80,#C0,#0E,#F0,#72,#C6,#1B,#8E
    DB #C9,#FF,#BE,#3C,#FB,#87,#F8,#71,#38,#7C,#B1,#D4,#C0,#A7,#83,#D1
    DB #80,#3F,#C1,#F0,#7D,#FC,#3C,#D8,#EB,#40,#86,#90,#10,#DC,#88,#F7
    DB #A8,#D7,#FE,#87,#80,#BD,#FC,#80,#4F,#FC,#F4,#80,#A6,#86,#80,#85
    DB #E5,#B0,#CD,#7E,#A2,#82,#F7,#85,#D0,#97,#B0,#83,#A0,#E3,#FB,#80
    DB #55,#55,#80
...
BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 68 bytes)
    DB #85,#00,#56,#80,#10,#0F,#88,#57,#D4,#40,#F4,#C0,#69,#08,#17,#9F
    DB #02,#C0,#00,#BD,#04,#C4,#E4,#C0,#28,#04,#44,#CD,#C0,#66,#19,#19
    DB #19,#47,#21,#F8,#1E,#C6,#3C,#C0,#04,#D6,#90,#17,#CB,#EE,#08,#90
    DB #90,#E5,#98,#F5,#C0,#5F,#BA,#5E,#C1,#9A,#08,#04,#F4,#FE,#78,#C0
    DB #43,#55,#55,#80
...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 110 bytes)
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#BA,#F5,#3A,#2A,#80,#94,#86,#4F
    DB #46,#57,#D5,#C0,#A5,#82,#58,#EF,#89,#8A,#FC,#28,#3C,#5C,#F0,#00
    DB #E5,#6A,#F5,#5C,#3D,#80,#DD,#30,#5F,#D6,#0D,#70,#80,#17,#7D,#3D
    DB #FC,#DC,#5E,#39,#FD,#82,#8D,#82,#83,#20,#8B,#8C,#3B,#E4,#D3,#84
    DB #BD,#98,#40,#0E,#98,#F4,#C0,#3E,#5C,#C9,#86,#0E,#1D,#A2,#D8,#8A
    DB #81,#0D,#9E,#B8,#F5,#27,#90,#91,#E7,#FB,#E4,#DA,#4F,#E0,#BD,#8C
    DB #F9,#DF,#B8,#F9,#EF,#C1,#F4,#FB,#CE,#E4,#FC,#75,#55,#58
...
BEHAVIOR_PAN2_1_DATA:
    ...
    DB #C0,#55,#E0,#2A,#7C,#02,#0F,#C0,#7D,#2A,#0A,#08,#A5,#10,#5F,#C0
    DB #1D,#74,#80,#03,#D3,#C4,#81,#C0,#3D,#40,#28,#08,#03,#D5,#00,#E4
    DB #9C,#F5,#0A,#79,#E6,#38,#C0,#53,#55,#55,#80
...
ENTITY_HERO_1_COMP_MASK EQU #3DB  ; Component mask: 1111011011b
...
init_hero_1:
    ...
    ; Template: tpl_1771166650770_6ibnk
    ; Components: Position, Sprite, Collision, Input, Health, Animation, Jump, Gravity
...
init_pato_2:
    ...
    ; JSON position: (12, 11) tiles = (96, 88) pixels
    ; Template: tpl_1770837237607_l05j9
    ; Components: Position, Sprite, Movement, Collision, Animation
    ; Direction mask: #0F (1111b) = All directions
    ...
    ; === Patrol Component Init ===
    ; Waypoints: (112, 88) -> (136, 88)
    ; Override position with waypoint1
    ld hl, entity_x_pos
    add hl, de
    ld (hl), 112         ; Start X = waypoint1_x
...
SM_New_Statemachine_state_1771533526010_Transitions_Actions_3: 
    ...
    DB 6; sprite: nina_dead 
    DB 9; PLAY_SOUND 
    DB 1        ; sound: sound_1772359893342
    DB 0xFF; END
