...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 134 bytes)
    ...
    DB #0E,#DA,#D8,#20,#8A,#81,#D9,#B8,#E2,#F5,#90,#91,#7E,#FB,#E4,#7D
    DB #4F,#AB,#E0,#8C,#DD,#F9,#B8,#FE,#F9,#C1,#F4,#F8,#FB,#E4,#EE,#50
    DB #FD,#F5,#88,#F5,#55,#58
...
SCREEN_PAN4_4_LAYOUT:
    ; ZX0 compressed layout (768 -> 113 bytes)
    ...
    DB #EF,#80,#47,#F1,#EF,#00,#A4,#86,#F1,#80,#29,#00,#A1,#8D,#4F,#ED
    DB #FD,#7A,#80,#3E,#FD,#00,#1A,#88,#69,#00,#5F,#FD,#81,#80,#A3,#8D
    DB #59,#C0,#1F,#80,#0E,#BA,#47,#8E,#7E,#80,#53,#F2,#8C,#C0,#3D,#80
    DB #4F,#C6,#06,#E3,#81,#80,#C0,#46,#DB,#26,#4D,#00,#0D,#B5,#26,#55
    DB #58
