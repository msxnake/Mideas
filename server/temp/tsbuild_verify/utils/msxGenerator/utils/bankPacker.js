...
exports.formatBankPackReportAsAsmComments = formatBankPackReportAsAsmComments;
...
function estimateDataDirectiveBytes(asm) {
    let total = 0;
...
function buildBankPackReport(files) {
...
function formatBankPackReportAsAsmComments(report) {
    const lines = [];
    lines.push('; ------------------------------------------------------------------');
