...
function generateMegaromUnifiedFile(files, projectName, analysis, executionPlan, config, options) {
    ...
    const generatedArtifactBlocks = (0, megaromResourceArtifacts_1.renderMegaromGeneratedArtifactsAsCommentBlocks)(dataPack, mapperWindow);
...
; Generated artifacts: resource_ids.asm, resource_table.asm, packing_manifest.txt
;
; Tiles: ${analysis.tiles?.length || 0}
; Sprites: ${analysis.sprites?.length || 0}
; Screens: ${analysis.screenMaps?.length || 0}
