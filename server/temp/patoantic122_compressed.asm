...
SCREEN_PAN3_3_LAYOUT:
    ...
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#82,#57,#8A,#C0,#86,#41,#A6,#82
    DB #EF,#8D,#F5,#83,#FC,#0E,#80,#02,#94,#00,#3D,#00,#5F,#41,#DF,#FA
    DB #F6,#E7,#E8,#D1,#80,#E1,#00,#06,#B3,#86,#54,#53,#94,#80,#CA,#EB
    DB #88,#4F,#80,#42,#91,#88,#69,#82,#7F,#F4,#D6,#E1,#9A,#5F,#00,#1F
    DB #2C,#E0,#56,#DD,#00,#18,#90,#80,#81,#6E,#86,#16,#7E,#F1,#80,#03
    DB #4D,#84,#0D,#A1,#2D,#82,#E5,#FC,#78,#80,#13,#55,#55,#80
