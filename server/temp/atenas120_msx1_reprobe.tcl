set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas120_msx1_reprobe.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas120_msx1_reprobe_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set px [mem16 0xDF87]
    set py [mem16 0xDF89]
    logline [format "%s pc=%04X exit=%02X dialog=%02X text=%02X screen=%02X engine=%02X world=%02X pxy=%d,%d" $tag $pc $exit $dialog $text $screen $engine $world $px $py]
}
...
foreach t {20 23 26 29 32 35 38 41} {
...
after time 43.0 { shot "t43_after_dialog.png" "shot_t43"; close $f; exit }
