set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas122_player_reach_probe.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/atenas122_player_reach_probe_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set px [mem16 0xDF87]
    set py [mem16 0xDF89]
    logline [format "%s pc=%04X sp=%04X exit=%02X sel=%02X dialog=%02X text=%02X screen=%02X engine=%02X world=%02X pxy=%d,%d" $tag $pc $sp $exit $sel $dialog $text $screen $engine $world $px $py]
}
...
after time 66.0 { shot "t66_final.png" "shot_t66"; close $f; exit }
