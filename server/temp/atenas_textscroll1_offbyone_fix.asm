...
; Bank 2 [#8000-#A000]: components_tail, gameflow (20303/8192 bytes est.)
...
; Bank 8 [#6000-#8000]: gameflow_aux (4535/8192 bytes est.) [FAR — accessed via trampoline]
...
; BANK 08 @#0000 : gameflow.asm part 3/3 (7262 bytes); ==================================================================
...
; - gameflow: 14398 estimated bytes
; - gameflow_aux: 4535 estimated bytes
...
;       "estimatedUsedBytes": 4535,
;       "estimatedFreeBytes": 3657,
;       "estimatedOverBudget": false,
;       "modules": [
;         {
;           "key": "gameflow_aux",
