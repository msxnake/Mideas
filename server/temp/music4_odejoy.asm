...
; Estimated payload bytes: 46960
; Estimated banks used: 6
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (1123 bytes)
; BANK 00 @#04C3 : colors.asm (1043 bytes)
; BANK 00 @#08D6 : components.asm (22 bytes)
; BANK 00 @#08EC : entities.asm (303 bytes)
; BANK 00 @#0A1B : worlds.asm (1819 bytes)
; BANK 00 @#1136 : screens.asm part 1/2 (3786 bytes)
; BANK 01 @#0000 : screens.asm part 2/2 (7059 bytes)
; BANK 01 @#1B93 : sprites.asm (1133 bytes)
; BANK 02 @#0000 : sprites.asm (1690 bytes)
; BANK 02 @#069A : font.asm (177 bytes)
; BANK 02 @#074B : hud.asm (79 bytes)
; BANK 02 @#079A : menus.asm (168 bytes)
; BANK 02 @#0842 : sound.asm part 1/2 (6078 bytes)
; BANK 03 @#0000 : sound.asm part 2/2 (8192 bytes)
; BANK 04 @#0000 : sound.asm part 3/2 (933 bytes)
; BANK 04 @#03A5 : scroll.asm (2353 bytes)
; BANK 04 @#0CD6 : animtiles.asm (4621 bytes)
; BANK 04 @#1EE3 : statemachine.asm (5 bytes)
; BANK 04 @#1EE8 : gameflow.asm (280 bytes)
; BANK 05 @#0000 : gameflow.asm (6000 bytes)
...
SCREEN2_TILEBANK_TILEBANK_1772518789742_ID EQU 0
...
; ==================================================================
tile_pattern_bank0:
    ; Tile 0: New Tile (16x16px = 2x2 chars = 4 MSX characters)
    ; Character layout: 2x2 grid
    ; Row 0: Char0 Char1 
    ; Row 1: Char2 Char3 
    db #FF, #FF, #C0, #C0, #C0, #C0, #C0, #C0, #FF, #FF, #03, #03, #03, #03, #03, #03, #C0, #C0, #C0, #C0, #C0, #C0, #FF, #FF, #03, #03, #03, #03, #03, #03, #FF, #FF
...
; ==================================================================
; SCREEN 2 TILEBANK PATTERN DATA (tilebank_1772518789742)
; ==================================================================

tilebank_tilebank_1772518789742_load_pattern_bank0:
...
tilebank_tilebank_1772518789742_load_pattern_bank1:
    ld hl, tilebank_pattern_data_0
...
tilebank_tilebank_1772518789742_load_pattern_bank2:
    ld hl, tilebank_pattern_data_0
...
load_tilebank_tilebank_1772518789742_patterns_to_vram:
    call tilebank_tilebank_1772518789742_load_pattern_bank0
    call tilebank_tilebank_1772518789742_load_pattern_bank1
    call tilebank_tilebank_1772518789742_load_pattern_bank2
    ret

tilebank_pattern_data_0:
    db #FF, #FF, #C0, #C0, #C0, #C0, #C0, #C0, #FF, #FF, #03, #03, #03, #03, #03, #03
    db #C0, #C0, #C0, #C0, #C0, #C0, #FF, #FF, #03, #03, #03, #03, #03, #03, #FF, #FF
...
; ==================================================================
; SCREEN 2 TILEBANK COLOR DATA (tilebank_1772518789742)
; ==================================================================

tilebank_tilebank_1772518789742_load_color_bank0:
...
tilebank_tilebank_1772518789742_load_color_bank1:
    ld hl, tilebank_color_data_0
...
tilebank_tilebank_1772518789742_load_color_bank2:
    ld hl, tilebank_color_data_0
...
load_tilebank_tilebank_1772518789742_colors_to_vram:
    call tilebank_tilebank_1772518789742_load_color_bank0
    call tilebank_tilebank_1772518789742_load_color_bank1
    call tilebank_tilebank_1772518789742_load_color_bank2
    ret
...
load_sprite_patterns:
    call load_sprite_patterns_worldmap_1772518931791
    ret
...
world_sprite_pattern_pack_table:
    db SPRITE_PATTERN_PACK_WORLDMAP_1772518931791_ID ; World 0: New Worldmap

; ------------------------------------------------------------------
; Runtime Sprite Pattern Pack: World "New Worldmap"
; Slots required: 1/64
; ------------------------------------------------------------------
SPRITE_PATTERN_PACK_WORLDMAP_1772518931791_ID EQU 0

sprite_asset_base_pattern_slot_worldmap_1772518931791:
    db 0 ; Sprite 0: Placeholder

load_sprite_patterns_worldmap_1772518931791:
    ld hl, sprite_asset_base_pattern_slot_worldmap_1772518931791
    ...
    ld bc, 32
    call FAST_LDIRVM
    ld a, SPRITE_PATTERN_PACK_WORLDMAP_1772518931791_ID
    ld (current_sprite_pattern_pack_id), a
    ret


ensure_sprite_patterns_worldmap_1772518931791:
    ld a, (current_sprite_pattern_pack_id)
    cp SPRITE_PATTERN_PACK_WORLDMAP_1772518931791_ID
    ret z
    jp load_sprite_patterns_worldmap_1772518931791
...
load_sprite_patterns_by_pack_id:
    ...
    ret z
    cp SPRITE_PATTERN_PACK_WORLDMAP_1772518931791_ID
    jp z, load_sprite_patterns_worldmap_1772518931791
    ret
...
ensure_sprite_patterns_by_pack_id:
    ...
    ret z
    cp SPRITE_PATTERN_PACK_WORLDMAP_1772518931791_ID
    jp z, ensure_sprite_patterns_worldmap_1772518931791
    ret
...
SCREEN_NEW_SCREENMAP_0_BEHAVIOR_SOURCE EQU 0
BEHAVIOR_NEW_SCREENMAP_0_DATA_BANK EQU ((BEHAVIOR_NEW_SCREENMAP_0_DATA - #4000) / #2000)
SCREEN_NEW_SCREENMAP_0_CHAR_BEHAVIOR_TABLE_BANK EQU 0
SCREEN_NEW_SCREENMAP_0_CHAR_BEHAVIOR_TABLE_SIZE EQU 0
SCREEN_NEW_SCREENMAP_0_INTERACTION_TYPE_MAP_BANK EQU ((SCREEN_NEW_SCREENMAP_0_INTERACTION_TYPE_MAP - #4000) / #2000)
SCREEN_NEW_SCREENMAP_0_INTERACTION_VALUE_MAP_BANK EQU ((SCREEN_NEW_SCREENMAP_0_INTERACTION_VALUE_MAP - #4000) / #2000)
SCREEN_NEW_SCREENMAP_0_INTERACTION_TARGET_MAP_BANK EQU ((SCREEN_NEW_SCREENMAP_0_INTERACTION_TARGET_MAP - #4000) / #2000)
...
SCREEN_NEW_SCREENMAP_0_BLOCK_LAYOUT_PRESENT EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_LAYOUT_MODE EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_CATALOG_BANK EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_CATALOG_COUNT EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_CATALOG_SIZE EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_MAP_BANK EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_MAP_WIDTH EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_MAP_HEIGHT EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_MAP_SIZE EQU 0
SCREEN_NEW_SCREENMAP_0_BLOCK_TOTAL_SIZE EQU 0
...
SCREEN_NEW_SCREENMAP_0_MUSIC_IN_GAME EQU 1
SCREEN_NEW_SCREENMAP_0_SUMMARY_FLAGS EQU #05
...
screen_runtime_summary_table:
    db 0, 0, 1, #05    ; Screen 0: New Screenmap
...
SCREEN_NEW_SCREENMAP_0_LAYOUT:
    ...
    DB #00,#01,#00,#01,#00,#01,#00,#01,#00,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#02,#03,#02,#03,#02,#03,#02,#03
    DB #02,#03,#02,#03,#02,#03,#02,#03,#02,#03,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#00,#01,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#02,#03,#FF,#FF,#FF,#FF,#FF,#FF
...
SCREEN_NEW_SCREENMAP_0_INTERACTION_TYPE_MAP:
    ; New Screenmap - per-cell interaction type map
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_NEW_SCREENMAP_0_INTERACTION_VALUE_MAP:
    ; New Screenmap - per-cell interaction value map
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
SCREEN_NEW_SCREENMAP_0_INTERACTION_TARGET_MAP:
    ; New Screenmap - per-cell interaction target map
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
load_screen_new_screenmap_772518805887:
    ...
    cp SCREEN2_TILEBANK_TILEBANK_1772518789742_ID
    jr z, .load_new_screenmap_772518805887_tilebank_ready
    call load_tilebank_tilebank_1772518789742_patterns_to_vram
    call load_tilebank_tilebank_1772518789742_colors_to_vram
    ld a, SCREEN2_TILEBANK_TILEBANK_1772518789742_ID
    ld (current_screen2_tilebank_id), a
    xor a
    ld (vram_cache_font_ready), a
    call init_font_system
.load_new_screenmap_772518805887_tilebank_ready:
    ...
    ld hl, SCREEN_NEW_SCREENMAP_0_INTERACTION_TYPE_MAP
    ld de, runtime_interaction_type_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, SCREEN_NEW_SCREENMAP_0_INTERACTION_VALUE_MAP
    ld de, runtime_interaction_value_map
    ld bc, RUNTIME_SCREEN_MAP_SIZE
    ldir

    ld hl, SCREEN_NEW_SCREENMAP_0_INTERACTION_TARGET_MAP
...
music_track_ptr_table:
    DW music_track_0_ode_to_joy_pixeltune_snd_data

; ------------------------------------------------------------------
; Tracker Song 0: ode_to_joy_pixeltune_snd
; ------------------------------------------------------------------
music_track_0_ode_to_joy_pixeltune_snd_data:
    DB #05
    DB #04
    DB #00
    DB #01
    DB #04
    DW music_track_0_ode_to_joy_pixeltune_snd_order_table
    DW music_track_0_ode_to_joy_pixeltune_snd_pattern_table
    DW music_track_0_ode_to_joy_pixeltune_snd_instrument_ptr_table
    DW music_track_0_ode_to_joy_pixeltune_snd_ornament_ptr_table
    DW #00D2
    DB #10

music_track_0_ode_to_joy_pixeltune_snd_order_table:
    DB #00,#01,#02,#03

music_track_0_ode_to_joy_pixeltune_snd_pattern_table:
    DW music_track_0_ode_to_joy_pixeltune_snd_pattern_0_rows
    DB #20
    DW music_track_0_ode_to_joy_pixeltune_snd_pattern_1_rows
    DB #20
    DW music_track_0_ode_to_joy_pixeltune_snd_pattern_2_rows
    DB #20
    DW music_track_0_ode_to_joy_pixeltune_snd_pattern_3_rows
    DB #20

music_track_0_ode_to_joy_pixeltune_snd_instrument_ptr_table:
    DW 0
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_1
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_3
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_4
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_5
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_6
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_7
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_8
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_9
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_10
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_ode_to_joy_pixeltune_snd_ornament_ptr_table:
    DW 0
    DW 0
    DW 0
    DW 0
...
music_track_0_ode_to_joy_pixeltune_snd_pattern_0_rows:
    DB #3B,#03,#FF,#0E,#1F,#02,#FF,#0C,#18,#05,#FF,#0C
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#03,#FF,#0E,#1F,#02,#FF,#0A,#18,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3E,#03,#FF,#0E,#26,#02,#FF,#0C,#18,#06,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#26,#02,#FF,#0A,#18,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#03,#FF,#0E,#1F,#02,#FF,#0C,#18,#05,#FF,#0C
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#1F,#02,#FF,#0A,#18,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#26,#02,#FF,#0C,#18,#06,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#26,#02,#FF,#0A,#18,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_ode_to_joy_pixeltune_snd_pattern_1_rows:
    DB #3B,#03,#FF,#0E,#1F,#02,#FF,#0C,#18,#05,#FF,#0C
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    ...
    DB #3B,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#26,#02,#FF,#0C,#18,#06,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#03,#FF,#0E,#26,#02,#FF,#0A,#18,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_ode_to_joy_pixeltune_snd_pattern_2_rows:
    DB #39,#03,#FF,#0E,#26,#02,#FF,#0C,#18,#05,#FF,#0C
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#26,#02,#FF,#0A,#18,#07,#FF,#09
    ...
    DB #37,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#1F,#02,#FF,#0C,#18,#06,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3C,#03,#FF,#0E,#1F,#02,#FF,#0A,#18,#07,#FF,#09
    ...
    DB #3B,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#03,#FF,#0E,#26,#02,#FF,#0C,#18,#05,#FF,#0C
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#26,#02,#FF,#0A,#18,#07,#FF,#09
    ...
    DB #3C,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#1F,#02,#FF,#0C,#18,#06,#FF,#0B
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #39,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #37,#03,#FF,#0E,#1F,#02,#FF,#0A,#18,#07,#FF,#09
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

music_track_0_ode_to_joy_pixeltune_snd_pattern_3_rows:
    DB #3B,#03,#FF,#0E,#1F,#02,#FF,#0C,#18,#05,#FF,#0C
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #3B,#03,#FF,#0E,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
...
music_track_0_ode_to_joy_pixeltune_snd_inst_1:
    DB #05
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_1_vol_env
    DB #0B
    DB #FF
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_1_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_1_vol_env:
    DB #0F,#0E,#0D,#0B,#09,#07,#05,#03,#02,#01,#00
music_track_0_ode_to_joy_pixeltune_snd_inst_1_tone_env:
    DB #00

music_track_0_ode_to_joy_pixeltune_snd_inst_2:
    DB #05
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_2_vol_env
    DB #07
    DB #04
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_2_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_2_vol_env:
    DB #0F,#0D,#0C,#0B,#0A,#09,#08
music_track_0_ode_to_joy_pixeltune_snd_inst_2_tone_env:
    DB #00

music_track_0_ode_to_joy_pixeltune_snd_inst_3:
    DB #05
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_3_vol_env
    DB #08
    DB #02
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_3_tone_env
    DB #04
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_3_vol_env:
    DB #0F,#0F,#0E,#0D,#0C,#0B,#0A,#09
music_track_0_ode_to_joy_pixeltune_snd_inst_3_tone_env:
    DB #00,#01,#00,#FF

music_track_0_ode_to_joy_pixeltune_snd_inst_4:
    DB #05
    DB #00
    DB #0D
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_4_vol_env
    DB #0B
    DB #08
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_4_tone_env
    DB #08
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_4_vol_env:
    DB #00,#02,#04,#06,#08,#0A,#0C,#0E,#0F,#0F,#0F
music_track_0_ode_to_joy_pixeltune_snd_inst_4_tone_env:
    DB #00,#00,#01,#01,#00,#00,#FF,#FF

music_track_0_ode_to_joy_pixeltune_snd_inst_5:
    DB #05
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_5_vol_env
    DB #06
    DB #FF
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_5_tone_env
    DB #04
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_5_vol_env:
    DB #0F,#0C,#09,#06,#03,#00
music_track_0_ode_to_joy_pixeltune_snd_inst_5_tone_env:
    DB #0C,#08,#04,#00

music_track_0_ode_to_joy_pixeltune_snd_inst_6:
    DB #06
    DB #0E
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_6_vol_env
    DB #06
    DB #FF
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_6_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_6_vol_env:
    DB #0E,#0B,#08,#05,#02,#00
music_track_0_ode_to_joy_pixeltune_snd_inst_6_tone_env:
    DB #00

music_track_0_ode_to_joy_pixeltune_snd_inst_7:
    DB #06
    DB #0A
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_7_vol_env
    DB #05
    DB #FF
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_7_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_7_vol_env:
    DB #0A,#07,#04,#01,#00
music_track_0_ode_to_joy_pixeltune_snd_inst_7_tone_env:
    DB #00

music_track_0_ode_to_joy_pixeltune_snd_inst_8:
    DB #05
    DB #0F
    DB #0A
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_8_vol_env
    DB #08
    DB #00
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_8_tone_env
    DB #07
    DB #00
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_8_vol_env:
    DB #0F,#0F,#0E,#0E,#0D,#0D,#0C,#0C
music_track_0_ode_to_joy_pixeltune_snd_inst_8_tone_env:
    DB #00,#04,#07,#0C,#07,#04,#00

music_track_0_ode_to_joy_pixeltune_snd_inst_9:
    DB #05
    DB #0F
    DB #0D
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_9_vol_env
    DB #05
    DB #00
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_9_tone_env
    DB #01
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_9_vol_env:
    DB #0F,#0F,#0F,#0F,#0F
music_track_0_ode_to_joy_pixeltune_snd_inst_9_tone_env:
    DB #00

music_track_0_ode_to_joy_pixeltune_snd_inst_10:
    DB #05
    DB #0F
    DB #00
    DB #10
    DW #00D2
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_10_vol_env
    DB #0B
    DB #FF
    DW music_track_0_ode_to_joy_pixeltune_snd_inst_10_tone_env
    DB #03
    DB #FF
    DW 0
    DB #00
    DB #FF
music_track_0_ode_to_joy_pixeltune_snd_inst_10_vol_env:
    DB #0F,#0E,#0C,#0A,#08,#06,#04,#03,#02,#01,#00
music_track_0_ode_to_joy_pixeltune_snd_inst_10_tone_env:
    DB #00,#0C,#00
...
gameflow_node_gfn_1772519023718_data:
    ...
    dw gameflow_node_gfn_1772519023718_init
    db ((gameflow_node_gfn_1772519023718_init - #4000) / #2000)
...
; ------------------------------------------------------------------
; gameflow_node_gfn_1772519023718_init
...
; ------------------------------------------------------------------
load_world_default:
    jp load_world_worldmap_1772518931791
