...
; Estimated payload bytes: 107442
...
; BANK 00 @#077B : entities.asm (3912 bytes)
; BANK 00 @#16C3 : worlds.asm (2365 bytes)
; BANK 01 @#0000 : worlds.asm (1398 bytes)
; BANK 01 @#0576 : screens.asm part 1/3 (6794 bytes)
; BANK 02 @#0000 : screens.asm part 2/3 (8192 bytes)
; BANK 03 @#0000 : screens.asm part 3/3 (2540 bytes)
; BANK 03 @#09EC : sprites.asm part 1/2 (5652 bytes)
; BANK 04 @#0000 : sprites.asm part 2/2 (4015 bytes)
; BANK 04 @#0FAF : font.asm (3547 bytes)
; BANK 04 @#1D8A : hud.asm (630 bytes)
; BANK 05 @#0000 : hud.asm (3206 bytes)
; BANK 05 @#0C86 : menus.asm (444 bytes)
; BANK 05 @#0E42 : sound.asm (3184 bytes)
; BANK 05 @#1AB2 : scroll.asm (1358 bytes)
; BANK 06 @#0000 : scroll.asm (995 bytes)
; BANK 06 @#03E3 : animtiles.asm (5916 bytes)
; BANK 06 @#1AFF : particles.asm (1281 bytes)
; BANK 07 @#0000 : particles.asm (3682 bytes)
; BANK 07 @#0E62 : statemachine.asm part 1/4 (4510 bytes)
...
; BANK 11 @#0000 : statemachine.asm part 5/4 (439 bytes)
; BANK 11 @#01B7 : gameflow.asm part 1/3 (7753 bytes)
; BANK 12 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 13 @#0000 : gameflow.asm part 3/3 (946 bytes)
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #DE,#80,#F6,#F4,#80,#4F,#C0,#76,#BE,#03,#BF,#C0,#F0,#A1,#41,#86
    DB #1A,#82,#77,#88,#E7,#A8,#81,#FE,#E1,#80,#EF,#FC,#80,#53,#FD,#FC
    DB #80,#28,#86,#4E,#FC,#53,#F3,#CB,#80,#94,#FC,#F8,#CB,#80,#D5,#55
    DB #60
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #C2,#79,#EE,#B9,#08,#90,#1E,#98,#5F,#C0,#55,#F5,#BA,#E8,#C1,#08
...
SCREEN_PAN2_1_LAYOUT:
    ; ZX0 compressed layout (768 -> 48 bytes)
    DB #85,#00,#56,#3D,#80,#81,#FC,#1F,#BA,#F5,#7A,#7D,#3A,#17,#65,#46
    DB #43,#D5,#00,#5D,#D0,#46,#5F,#C4,#08,#E0,#82,#83,#FC,#38,#84,#1F
    DB #40,#43,#EF,#9C,#86,#C0,#47,#4D,#40,#43,#F4,#81,#FC,#75,#55,#58
BEHAVIOR_PAN2_1_WIDTH     EQU 32
BEHAVIOR_PAN2_1_HEIGHT    EQU 24
BEHAVIOR_PAN2_1_SIZE      EQU 768

BEHAVIOR_PAN2_1_DATA:
    ; ZX0 compressed behavior (768 -> 38 bytes)
    DB #85,#00,#56,#95,#10,#7F,#BA,#D5,#7A,#F4,#3A,#5D,#95,#46,#0F,#00
    DB #55,#77,#46,#41,#7D,#C4,#38,#C0,#13,#D4,#40,#E9,#C1,#08,#43,#D5
    DB #80,#F5,#FE,#4D,#55,#56
...
ENTITY_PATO_1_X EQU 5
ENTITY_PATO_1_Y EQU 3
