...
set logfh [open "C:/Users/salam/Documents/Programacion/Mideas/server/temp/openmsx_profile_stage1_idle.log" "w"]
log_line $logfh "SCRIPT_START idle"
set ::profile_done 0
after realtime 8000 {
    if {[catch {dump_profile "idle_8s"} err]} {
