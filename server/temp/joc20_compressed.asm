...
; Estimated payload bytes: 59571
; Estimated banks used: 8
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (1251 bytes)
; BANK 00 @#0543 : colors.asm (1156 bytes)
; BANK 00 @#09C7 : components.asm (22 bytes)
; BANK 00 @#09DD : entities.asm (3465 bytes)
; BANK 00 @#1766 : worlds.asm (1793 bytes)
; BANK 00 @#1E67 : screens.asm (409 bytes)
; BANK 01 @#0000 : screens.asm (6200 bytes)
; BANK 01 @#1838 : sprites.asm (1992 bytes)
; BANK 02 @#0000 : sprites.asm (1857 bytes)
; BANK 02 @#0741 : font.asm (3456 bytes)
; BANK 02 @#14C1 : hud.asm (2879 bytes)
; BANK 03 @#0000 : hud.asm (601 bytes)
; BANK 03 @#0259 : menus.asm (168 bytes)
; BANK 03 @#0301 : sound.asm part 1/2 (7423 bytes)
; BANK 04 @#0000 : sound.asm part 2/2 (2125 bytes)
; BANK 04 @#084D : scroll.asm (2353 bytes)
; BANK 04 @#117E : animtiles.asm (3714 bytes)
; BANK 05 @#0000 : animtiles.asm (1566 bytes)
; BANK 05 @#061E : statemachine.asm part 1/2 (6626 bytes)
; BANK 06 @#0000 : statemachine.asm part 2/2 (4398 bytes)
; BANK 06 @#112E : gameflow.asm (3794 bytes)
; BANK 07 @#0000 : gameflow.asm (2227 bytes)
...
runtime_char_behavior_table EQU #CD54   ; Current screen char -> behavior lookup table (256 bytes)
runtime_effects_layout EQU #CE54   ; Alternate effects layout copy for secret zones (32x24)
screen_block_catalog_ptr EQU #D154   ; Scratch pointer to current screen block catalog during layout expansion
screen_block_map_ptr EQU #D156   ; Scratch pointer to current screen block index map during layout expansion
runtime_effect_zone_table EQU #D158   ; Current screen effect zone table (MAX_RUNTIME_EFFECT_ZONES * 8 bytes)
current_effect_zone_count EQU #D358   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #D359   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #D35A   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #D35B   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #D35C   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #D35D   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #D35E   ; Camera X position in pixels (16-bit)
camera_y            EQU #D360   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #D362   ; Camera tile X (column)
camera_tile_y       EQU #D363   ; Camera tile Y (row)
world_width_tiles   EQU #D364   ; World width in tiles
world_height_tiles  EQU #D365   ; World height in tiles
scroll_dirty_flag   EQU #D366   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #D367   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #D368   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #D369   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #D36B   ; Animation frame timer
anim_tile_frame     EQU #D36C   ; Current animation frame (0-3)
anim_tile_speed     EQU #D36D   ; Frames between animation updates
anim_tile_transform_flags EQU #D36E   ; Runtime flags for transform-mode tile animation (byte0=flags, byte1=opcode scratch)
anim_tile_row_buffer EQU #D370   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #D378   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #D398   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_x_pos        EQU #D3B8   ; Entity X positions (32 bytes)
entity_y_pos        EQU #D3D8   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #D3F8   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #D418   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #D438   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #D458   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #D478   ; Entity screen ID (32 bytes)
entity_job_period   EQU #D498   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #D4B8   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #D4D8   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #D4D9   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #D4F9   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #D519   ; Entity health (32 bytes)
entity_anim_frame   EQU #D539   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #D559   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #D579   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #D599   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #D5B9   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #D5D9   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #D5F9   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #D619   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #D639   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #D659   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #D679   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #D699   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #D6B9   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #D6D9   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #D6F9   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #D719   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #D739   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #D759   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #D779   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #D799   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #D7B9   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #D7D9   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #D7F9   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #D819   ; Number of sprites currently active
sprites_dirty      EQU #D81A   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #D81B   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #D83B   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #D85B   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #D87B   ; Runtime base 16x16 slot per sprite asset (3 bytes)
sprite_placeholder_base_pattern_num EQU #D87E   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #D87F   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #D880   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #D900   ; Currently displayed screen ID
screen_dirty_flag   EQU #D901   ; Screen needs redraw flag
screen_transition_cooldown EQU #D902   ; Cooldown frames after screen transition
current_world_id    EQU #D903   ; Current world ID (for multi-world support)
current_screen_index EQU #D904   ; Current screen index within world
current_screen_anim_group_count EQU #D905   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #D906   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #D907   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #D908   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #D909   ; Player X position (16-bit)
player_y            EQU #D90B   ; Player Y position (16-bit)
player_runtime_enabled EQU #D90D   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #D90E   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #D90F   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #D910   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #D911   ; Player health points
player_score        EQU #D912   ; Player score (16-bit)
gem_count           EQU #D914   ; Collectible tile counter (8-bit)
last_gem_char       EQU #D915   ; Char code of last collected gem tile (for SM VARIABLE_COMPARE)

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #D916   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #D917   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #D957   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #D997   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #D9D7   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #DA17   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #DA27   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #DA37   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #DA47   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #DA57   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #DA67   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #DA77   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #DA78   ; Temporary 16-bit storage
temp_word_2         EQU #DA7A   ; Temporary 16-bit storage
temp_byte_1         EQU #DA7C   ; Temporary 8-bit storage
temp_byte_2         EQU #DA7D   ; Temporary 8-bit storage
temp_byte_3         EQU #DA7E   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #DA9E   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #DABE   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #DADE   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #DAFE   ; 0=no SFX active, 1=playing
sfx_timer           EQU #DAFF   ; Frames remaining for current SFX
sfx_fadeout         EQU #DB00   ; Reserved fadeout flag/state
temp_byte_7         EQU #DB01   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #DB21   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #DB41   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #DB61   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #DB81   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #DBA1   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #DBC1   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #DBE1   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #DC01   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #DC21   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #DC41   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #DC61   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #DC81   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #DCA1   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #DCC1   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #DCE1   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #DD01   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #DD21   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #DD41   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #DD61   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #DDA1   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #DDE1   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #DE01   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #DE21   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #DE41   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #DE42   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #DE43   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #DE44   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #DE45   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #DE46   ; Cached entity X for wall checks
wall_temp_y         EQU #DE47   ; Cached entity Y for wall checks
wall_hit_left       EQU #DE48   ; Hitbox left edge cache
wall_hit_top        EQU #DE49   ; Hitbox top edge cache
wall_hit_right      EQU #DE4A   ; Hitbox right edge cache
wall_hit_bottom     EQU #DE4B   ; Hitbox bottom edge cache
wall_hit_w          EQU #DE4C   ; Hitbox width cache (min 1)
wall_hit_h          EQU #DE4D   ; Hitbox height cache (min 1)
wall_probe_left     EQU #DE4E   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #DE4F   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #DE50   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #DE51   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #DE52   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #DE72   ; Number of entries in active_entity_list
hero_entity_id      EQU #DE73   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #DE74   ; 1=rebuild active_entity_list required
input_entity_list   EQU #DE75   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #DE95   ; Number of entries in input_entity_list
render_entity_list  EQU #DE96   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #DEB6   ; Number of entries in render_entity_list
collision_entity_list EQU #DEB7   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #DED7   ; Number of entries in collision_entity_list
ground_entity_list  EQU #DED8   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #DEF8   ; Number of entries in ground_entity_list
anim_entity_list    EQU #DEF9   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #DF19   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #DF1A   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #DF3A   ; Number of entities in coll_list
coll_src_left       EQU #DF3B   ; Source AABB left edge (scratch)
coll_src_right      EQU #DF3C   ; Source AABB right edge (scratch)
coll_src_top        EQU #DF3D   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #DF3E   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #DF3F   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #DF3F   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #DF41   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #DF43   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #DF45   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #DF47   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #DF49   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #DF4B   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #DF4D   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #DF4F   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #DF50   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #DF55   ; Frame counter (16-bit)
task_exec_time          EQU #DF57   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #DF59   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #DF5A   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #DF5A   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #DF5B   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #DF5C   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #DF5D   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #DF5E   ; 0=stopped, 1=track active
music_muted          EQU #DF5F   ; 0=audible, 1=muted/pause
music_loop           EQU #DF60   ; 0=no loop, 1=loop enabled
music_track_index    EQU #DF61   ; Current ROM track index
music_row_frames     EQU #DF62   ; Frames per tracker row
music_row_countdown  EQU #DF63   ; Countdown to next row
music_order_pos      EQU #DF64   ; Current order position
music_pattern_index  EQU #DF65   ; Current pattern index
music_pattern_row    EQU #DF66   ; Current row inside pattern
music_pattern_rows   EQU #DF67   ; Cached rows in current pattern
music_track_ptr_l    EQU #DF68   ; Current track pointer low byte
music_track_ptr_h    EQU #DF69   ; Current track pointer high byte
music_pattern_ptr_l  EQU #DF6A   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #DF6B   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #DF6C   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #DF6D   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #DF6D   ; Channel A
music_ch_b_note EQU #DF6E   ; Channel B
music_ch_c_note EQU #DF6F   ; Channel C
music_ch_instrument_base EQU #DF70   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #DF70   ; Channel A
music_ch_b_instrument EQU #DF71   ; Channel B
music_ch_c_instrument EQU #DF72   ; Channel C
music_ch_ornament_base EQU #DF73   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #DF73   ; Channel A
music_ch_b_ornament EQU #DF74   ; Channel B
music_ch_c_ornament EQU #DF75   ; Channel C
music_ch_volume_base EQU #DF76   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #DF76   ; Channel A
music_ch_b_volume EQU #DF77   ; Channel B
music_ch_c_volume EQU #DF78   ; Channel C
music_ch_vol_step_base EQU #DF79   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #DF79   ; Channel A
music_ch_b_vol_step EQU #DF7A   ; Channel B
music_ch_c_vol_step EQU #DF7B   ; Channel C
music_ch_tone_step_base EQU #DF7C   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #DF7C   ; Channel A
music_ch_b_tone_step EQU #DF7D   ; Channel B
music_ch_c_tone_step EQU #DF7E   ; Channel C
music_ch_noise_step_base EQU #DF7F   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #DF7F   ; Channel A
music_ch_b_noise_step EQU #DF80   ; Channel B
music_ch_c_noise_step EQU #DF81   ; Channel C
music_ch_orn_step_base EQU #DF82   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #DF82   ; Channel A
music_ch_b_orn_step EQU #DF83   ; Channel B
music_ch_c_orn_step EQU #DF84   ; Channel C
...
ZX0_SCREEN_BUFFER       EQU #E000   ; Screen/layout scratch (768 bytes, shared area)
ZX0_BEHAVIOR_BUFFER     EQU #E000   ; Behavior map scratch (768 bytes, shared area)
ZX0_TILE_PATTERN_BUFFER EQU #E000   ; Tile pattern scratch (1488 bytes, shared area)
ZX0_TILE_COLOR_BUFFER   EQU #E000   ; Tile color scratch (1488 bytes, shared area)
ZX0_FONT_PATTERN_BUFFER EQU #E5D0   ; Font pattern scratch (360 bytes)
ZX0_FONT_COLOR_BUFFER   EQU #E740   ; Font color scratch (360 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #DF85   ; End of project variables (8069 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#DF85: Project variables (8069 bytes)
;   #DF85-#F37F: Free RAM (~5115 bytes available)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (56 -> 33 bytes)
    DB #21,#7E,#FF,#BC,#FE,#F0,#89,#7F,#FE,#22,#7E,#7F,#58,#FE,#7E,#42
    DB #FF,#F9,#FF,#66,#81,#3C,#7E,#7E,#3C,#81,#00,#F1,#D2,#F5,#EF,#55
    DB #58
load_pattern_bank0:
    ...
    ld bc, 56    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 56    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (56 -> 21 bytes)
...
load_color_bank0:
    ...
    ld bc, 56     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
SCREEN_PAN1_0_BLOCK_CATALOG_COUNT EQU 28
SCREEN_PAN1_0_BLOCK_CATALOG_SIZE EQU 448
...
SCREEN_PAN1_0_BLOCK_TOTAL_SIZE EQU 496
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ; ZX0 compressed screen_block_catalog (448 -> 102 bytes)
    ...
    DB #81,#DC,#76,#85,#70,#A1,#85,#78,#72,#D9,#14,#39,#50,#CD,#10,#28
    DB #85,#13,#DD,#E0,#55,#56
SCREEN_PAN1_0_BLOCK_MAP:
    ...
    DB #16,#17,#18,#19,#1A,#1B,#16,#1B,#55,#56
...
SCREEN_PAN1_0_CHAR_BEHAVIOR_TABLE:
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #10,#10,#10,#10,#00,#08,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
