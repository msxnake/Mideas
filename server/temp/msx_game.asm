...
; BANK 01 @#0000 : sound.asm part 2/2 (4264 bytes)
; BANK 01 @#10A8 : scroll.asm (2342 bytes)
; BANK 01 @#19CE : animtiles.asm (1586 bytes)
; BANK 02 @#0000 : animtiles.asm (2969 bytes)
; BANK 02 @#0B99 : particles.asm (4963 bytes)
; BANK 02 @#1EFC : statemachine.asm (5 bytes)
; BANK 02 @#1F01 : gameflow.asm (255 bytes)
; BANK 03 @#0000 : gameflow.asm (37 bytes)
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #D16D   ; End of project variables (4461 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#D16D: Project variables (4461 bytes)
;   #D16D-#F37F: Free RAM (~8723 bytes available)
