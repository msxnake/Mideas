...
; BANK 01 @#0000 : screens.asm (3569 bytes)
; BANK 01 @#0DF1 : sprites.asm (2569 bytes)
; BANK 01 @#17FA : font.asm (2054 bytes)
; BANK 02 @#0000 : font.asm (1402 bytes)
; BANK 02 @#057A : hud.asm (3480 bytes)
; BANK 02 @#1312 : menus.asm (168 bytes)
; BANK 02 @#13BA : sound.asm part 1/2 (3142 bytes)
; BANK 03 @#0000 : sound.asm part 2/2 (6399 bytes)
; BANK 03 @#18FF : scroll.asm (1793 bytes)
; BANK 04 @#0000 : scroll.asm (560 bytes)
; BANK 04 @#0230 : animtiles.asm (4613 bytes)
; BANK 04 @#1435 : statemachine.asm (5 bytes)
; BANK 04 @#143A : gameflow.asm (3014 bytes)
; BANK 05 @#0000 : gameflow.asm (3007 bytes)
...
SCREEN_PAN1_0_BLOCK_CATALOG:
    ...
    ; 4 unique blocks, 64 bytes total
    DB #FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF
    DB #80,#81,#80,#81,#82,#83,#82,#83,#80,#81,#80,#81,#82,#83,#82,#83
    DB #80,#81,#FF,#FF,#82,#83,#FF,#FF,#FF,#FF,#80,#81,#FF,#FF,#82,#83
    DB #80,#81,#FF,#FF,#82,#83,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF,#FF

SCREEN_PAN1_0_BLOCK_MAP:
    ; pan1 - background block index map (8x6)
    ; 112 bytes optimized vs 768 raw (656 byte delta)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00
    DB #00,#02,#00,#00,#00,#00,#00,#00,#00,#00,#02,#00,#00,#00,#00,#00
    DB #00,#00,#00,#02,#00,#00,#00,#00,#00,#00,#00,#00,#03,#00,#00,#00
...
BEHAVIOR_PAN1_0_DATA:
    ...
    DB #95,#00,#56,#B8,#10,#C0,#03,#84,#FE,#54,#35,#55,#58
