...
; Estimated payload bytes: 118395
...
; BANK 06 @#05E4 : sound.asm (6684 bytes)
; BANK 07 @#0000 : sound.asm (156 bytes)
; BANK 07 @#009C : scroll.asm (2353 bytes)
; BANK 07 @#09CD : animtiles.asm (5630 bytes)
; BANK 07 @#1FCB : particles.asm (53 bytes)
; BANK 08 @#0000 : particles.asm (4910 bytes)
; BANK 08 @#132E : statemachine.asm part 1/4 (3282 bytes)
...
; BANK 12 @#0000 : statemachine.asm part 5/4 (2498 bytes)
; BANK 12 @#09C2 : gameflow.asm part 1/3 (5694 bytes)
; BANK 13 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 14 @#0000 : gameflow.asm part 3/3 (3707 bytes)
...
gameflow_handle_submenu:
    ...
    push bc
    ld a, 4
    ld hl, show_menu_placeholder
    call mapper_call_hl_p1
...
; ------------------------------------------------------------------
; Bank 4 tail: submenu runtime, submenu assets, late GameFlow/world code.
; The linear build grows past #BFFF; restart the physical window here so
; late routines stay callable through mapper bank 4 / p1 (#4000-#5FFF).
; ------------------------------------------------------------------
    org #4000
