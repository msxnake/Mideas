...
entity_x_pos        EQU #DCB9   ; Entity X positions (32 bytes)
entity_y_pos        EQU #DCD9   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #DCF9   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #DD19   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #DD39   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #DD59   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #DD79   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DD99   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DDB9   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DDD9   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DDDA   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DDFA   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DE1A   ; Entity health (32 bytes)
entity_anim_frame   EQU #DE3A   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DE5A   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DE7A   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DE9A   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DEBA   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DEDA   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DEFA   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DF1A   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DF3A   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DF5A   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DF7A   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #DF9A   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #DFBA   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #DFDA   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #DFFA   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #E01A   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #E03A   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #E05A   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #E07A   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #E09A   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #E0BA   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #E0DA   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #E0FA   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #E11A   ; Number of sprites currently active
sprites_dirty      EQU #E11B   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #E11C   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #E13C   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #E15C   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #E17C   ; Runtime base 16x16 slot per sprite asset (1 bytes)
sprite_placeholder_base_pattern_num EQU #E17D   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #E17E   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #E17F   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #E1FF   ; Player X position (16-bit)
player_y            EQU #E201   ; Player Y position (16-bit)
player_runtime_enabled EQU #E203   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #E204   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #E205   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #E206   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #E207   ; Player health points
player_score        EQU #E208   ; Player score (16-bit)
gem_count           EQU #E20A   ; Collectible tile counter (8-bit)
last_interaction_char EQU #E20B   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_type EQU #E20C   ; Interaction type id of last interacted tile
last_interaction_value EQU #E20D   ; Interaction value byte of last interacted tile
last_interaction_target EQU #E20E   ; Interaction target id of last interacted tile
last_interaction_x  EQU #E20F   ; Tile X coordinate of last interaction
last_interaction_y  EQU #E210   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #E211   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #E212   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #E213   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #E253   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #E293   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #E2D3   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #E313   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #E323   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #E333   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #E343   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E353   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E363   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E373   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E374   ; Temporary 16-bit storage
temp_word_2         EQU #E376   ; Temporary 16-bit storage
temp_byte_1         EQU #E378   ; Temporary 8-bit storage
temp_byte_2         EQU #E379   ; Temporary 8-bit storage
temp_byte_3         EQU #E37A   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E39A   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E3BA   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E3DA   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E3FA   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E3FB   ; Frames remaining for current SFX
sfx_fadeout         EQU #E3FC   ; Reserved fadeout flag/state
temp_byte_7         EQU #E3FD   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E41D   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E43D   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E45D   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E47D   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E49D   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E4BD   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E4DD   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E4FD   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E51D   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E53D   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E55D   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E57D   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E59D   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E5BD   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E5DD   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E5FD   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E61D   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E63D   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E65D   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E69D   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E6DD   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E6FD   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E71D   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E73D   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E73E   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E73F   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E740   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E741   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E742   ; Cached entity X for wall checks
wall_temp_y         EQU #E743   ; Cached entity Y for wall checks
wall_hit_left       EQU #E744   ; Hitbox left edge cache
wall_hit_top        EQU #E745   ; Hitbox top edge cache
wall_hit_right      EQU #E746   ; Hitbox right edge cache
wall_hit_bottom     EQU #E747   ; Hitbox bottom edge cache
wall_hit_w          EQU #E748   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E749   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E74A   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E74B   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E74C   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E74D   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E74E   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E76E   ; Number of entries in active_entity_list
hero_entity_id      EQU #E76F   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E770   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E771   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E791   ; Number of entries in input_entity_list
render_entity_list  EQU #E792   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E7B2   ; Number of entries in render_entity_list
collision_entity_list EQU #E7B3   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E7D3   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E7D4   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E7F4   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E7F5   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E815   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E816   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E836   ; Number of entities in coll_list
coll_src_left       EQU #E837   ; Source AABB left edge (scratch)
coll_src_right      EQU #E838   ; Source AABB right edge (scratch)
coll_src_top        EQU #E839   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E83A   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E83B   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E83B   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E83D   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E83F   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E841   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E843   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E845   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E847   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E849   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E84B   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E84C   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E851   ; Frame counter (16-bit)
task_exec_time          EQU #E853   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E855   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #E856   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E856   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E857   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E858   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E859   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E85A   ; 0=stopped, 1=track active
music_muted          EQU #E85B   ; 0=audible, 1=muted/pause
music_loop           EQU #E85C   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E85D   ; Current ROM track index
music_row_frames     EQU #E85E   ; Frames per tracker row
music_row_countdown  EQU #E85F   ; Countdown to next row
music_order_pos      EQU #E860   ; Current order position
music_pattern_index  EQU #E861   ; Current pattern index
music_pattern_row    EQU #E862   ; Current row inside pattern
music_pattern_rows   EQU #E863   ; Cached rows in current pattern
music_track_ptr_l    EQU #E864   ; Current track pointer low byte
music_track_ptr_h    EQU #E865   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E866   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E867   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E868   ; PSG mixer shadow for music runtime
music_ch_note_base EQU #E869   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E869   ; Channel A
music_ch_b_note EQU #E86A   ; Channel B
music_ch_c_note EQU #E86B   ; Channel C
music_ch_instrument_base EQU #E86C   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E86C   ; Channel A
music_ch_b_instrument EQU #E86D   ; Channel B
music_ch_c_instrument EQU #E86E   ; Channel C
music_ch_ornament_base EQU #E86F   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E86F   ; Channel A
music_ch_b_ornament EQU #E870   ; Channel B
music_ch_c_ornament EQU #E871   ; Channel C
music_ch_volume_base EQU #E872   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E872   ; Channel A
music_ch_b_volume EQU #E873   ; Channel B
music_ch_c_volume EQU #E874   ; Channel C
music_ch_vol_step_base EQU #E875   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E875   ; Channel A
music_ch_b_vol_step EQU #E876   ; Channel B
music_ch_c_vol_step EQU #E877   ; Channel C
music_ch_tone_step_base EQU #E878   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E878   ; Channel A
music_ch_b_tone_step EQU #E879   ; Channel B
music_ch_c_tone_step EQU #E87A   ; Channel C
music_ch_noise_step_base EQU #E87B   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E87B   ; Channel A
music_ch_b_noise_step EQU #E87C   ; Channel B
music_ch_c_noise_step EQU #E87D   ; Channel C
music_ch_orn_step_base EQU #E87E   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E87E   ; Channel A
music_ch_b_orn_step EQU #E87F   ; Channel B
music_ch_c_orn_step EQU #E880   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E881   ; End of project variables (10369 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E881: Project variables (10369 bytes)
;   #E881-#F37F: Free RAM (~2815 bytes available)
