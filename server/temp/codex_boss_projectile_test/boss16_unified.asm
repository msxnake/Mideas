...
; BANK 06 @#0000 : bosses.asm part 3/3 (7057 bytes)
; BANK 06 @#1B91 : statemachine.asm (5 bytes)
; BANK 06 @#1B96 : gameflow.asm (1130 bytes)
; BANK 07 @#0000 : gameflow.asm (4934 bytes)
...
boss_meteor_age     EQU #C04A   ; Boss meteor cycle age
boss_meteor_count   EQU #C04B   ; Active meteor lanes
boss_meteor_index   EQU #C04C   ; Current meteor lane index
boss_meteor_base_x  EQU #C04D   ; First meteor lane X
boss_meteor_base_y  EQU #C04E   ; Meteor spawn Y
boss_meteor_sprite_slot EQU #C04F   ; First HW sprite slot for meteors
boss_meteor_color   EQU #C050   ; Meteor sprite color
boss_meteor_pattern EQU #C051   ; Meteor base pattern
boss_meteor_speed   EQU #C052   ; Meteor fall speed
boss_meteor_range   EQU #C053   ; Meteor fall range
boss_meteor_spread  EQU #C054   ; Meteor lane spacing
boss_meteor_warn    EQU #C055   ; Meteor warning frames
boss_bomb_age       EQU #C056   ; Boss bomb cycle age
boss_bomb_count     EQU #C057   ; Active bomb lanes
boss_bomb_index     EQU #C058   ; Current bomb lane index
boss_bomb_base_x    EQU #C059   ; First bomb lane X
boss_bomb_base_y    EQU #C05A   ; Bomb spawn Y
boss_bomb_sprite_slot EQU #C05B   ; First HW sprite slot for bombs
boss_bomb_color     EQU #C05C   ; Bomb sprite color
boss_bomb_pattern   EQU #C05D   ; Bomb base pattern
boss_bomb_explosion_pattern EQU #C05E   ; Bomb explosion pattern
boss_bomb_spread    EQU #C05F   ; Bomb lane spacing
boss_bomb_fuse      EQU #C060   ; Bomb fuse frames
boss_bomb_radius    EQU #C061   ; Bomb explosion radius
boss_bomb_duration  EQU #C062   ; Bomb explosion active frames
boss_boomerang_age  EQU #C063   ; Boss boomerang cycle age
boss_boomerang_base_x EQU #C064   ; Boomerang origin X
boss_boomerang_base_y EQU #C065   ; Boomerang origin Y
boss_boomerang_sprite_slot EQU #C066   ; HW sprite slot for boomerang
boss_boomerang_color EQU #C067   ; Boomerang sprite color
boss_boomerang_pattern EQU #C068   ; Boomerang base pattern
boss_boomerang_speed EQU #C069   ; Boomerang speed
boss_boomerang_range EQU #C06A   ; Boomerang max distance
boss_boomerang_distance EQU #C06B   ; Current boomerang distance from origin
boss_boomerang_direction EQU #C06C   ; Boomerang direction
boss_rock_age       EQU #C06D   ; Boss rock cycle age
boss_rock_base_x    EQU #C06E   ; Rock origin X
boss_rock_base_y    EQU #C06F   ; Rock origin Y
boss_rock_sprite_slot EQU #C070   ; HW sprite slot for rock
boss_rock_color     EQU #C071   ; Rock sprite color
boss_rock_pattern   EQU #C072   ; Rock base pattern
boss_rock_speed     EQU #C073   ; Rock speed
boss_rock_range     EQU #C074   ; Rock max travel distance
boss_rock_distance  EQU #C075   ; Current rock distance from origin
boss_rock_direction EQU #C076   ; Rock direction
boss_rock_arc_height EQU #C077   ; Rock parabolic arc height
boss_rock_arc_offset EQU #C078   ; Current rock arc offset
boss_laser_age      EQU #C079   ; Boss laser cycle age
boss_laser_base_x   EQU #C07A   ; Laser origin X in pixels
boss_laser_base_y   EQU #C07B   ; Laser origin Y in pixels
boss_laser_tile_char EQU #C07C   ; Laser beam char code
boss_laser_length   EQU #C07D   ; Laser length in chars
boss_laser_duration EQU #C07E   ; Laser active frames
boss_laser_direction EQU #C07F   ; Laser direction
boss_laser_index    EQU #C080   ; Current laser char index
boss_laser_origin_tile_x EQU #C081   ; Laser origin tile X
boss_laser_origin_tile_y EQU #C082   ; Laser origin tile Y
boss_laser_tile_x   EQU #C083   ; Current laser tile X
boss_laser_tile_y   EQU #C084   ; Current laser tile Y
boss_laser_write_mode EQU #C085   ; 0=draw laser, 1=restore map
boss_wave_age       EQU #C086   ; Boss sine-wave projectile cycle age
boss_wave_base_x    EQU #C087   ; Sine-wave projectile origin X
boss_wave_base_y    EQU #C088   ; Sine-wave projectile origin Y
boss_wave_sprite_slot EQU #C089   ; HW sprite slot for sine-wave projectile
boss_wave_color     EQU #C08A   ; Sine-wave projectile sprite color
boss_wave_pattern   EQU #C08B   ; Sine-wave projectile base pattern
boss_wave_speed     EQU #C08C   ; Sine-wave projectile speed
boss_wave_range     EQU #C08D   ; Sine-wave projectile max travel distance
boss_wave_distance  EQU #C08E   ; Current sine-wave projectile distance
boss_wave_direction EQU #C08F   ; Sine-wave projectile direction
boss_wave_amplitude EQU #C090   ; Sine-wave perpendicular amplitude
boss_wave_frequency EQU #C091   ; Frames per sine-wave phase step
boss_wave_phase     EQU #C092   ; Current sine-wave phase index
boss_wave_offset    EQU #C093   ; Signed sine-wave perpendicular offset
boss_homing_age     EQU #C094   ; Boss homing missile cycle age
boss_homing_base_x  EQU #C095   ; Homing missile origin X
boss_homing_base_y  EQU #C096   ; Homing missile origin Y
boss_homing_sprite_slot EQU #C097   ; HW sprite slot for homing missile
boss_homing_color   EQU #C098   ; Homing missile sprite color
boss_homing_pattern EQU #C099   ; Homing missile base pattern
boss_homing_speed   EQU #C09A   ; Homing missile speed
boss_homing_range   EQU #C09B   ; Homing missile max travel distance
boss_homing_distance EQU #C09C   ; Current homing missile distance
boss_homing_direction EQU #C09D   ; Homing missile launch direction
boss_homing_turn_step EQU #C09E   ; Homing missile steering strength
boss_homing_turn_distance EQU #C09F   ; Homing missile steering distance
autocontrol_screen_id EQU #C0A0   ; Screen id bound to current FakePlayer script
autocontrol_entity_index EQU #C0A1   ; Active FakePlayer entity index (#FF=none)
autocontrol_script_ptr_l EQU #C0A2   ; Current FakePlayer script pointer low byte
autocontrol_script_ptr_h EQU #C0A3   ; Current FakePlayer script pointer high byte
autocontrol_script_start_l EQU #C0A4   ; FakePlayer script start pointer low byte
autocontrol_script_start_h EQU #C0A5   ; FakePlayer script start pointer high byte
autocontrol_wait_frames EQU #C0A6   ; FakePlayer wait countdown in frames
autocontrol_move_opcode EQU #C0A7   ; Active FakePlayer movement opcode
autocontrol_move_remaining EQU #C0A8   ; Remaining FakePlayer movement pixels
autocontrol_loop_flag EQU #C0A9   ; 1=loop FakePlayer script on END
autocontrol_active EQU #C0AA   ; 1=FakePlayer script active
autoev_screen_id EQU #C0AB   ; Screen id bound to compact FakePlayer event script
autoev_entity_index EQU #C0AC   ; Active compact FakePlayer entity index (#FF=none)
autoev_script_ptr_l EQU #C0AD   ; Compact FakePlayer event pointer low byte
autoev_script_ptr_h EQU #C0AE   ; Compact FakePlayer event pointer high byte
autoev_script_start_l EQU #C0AF   ; Compact FakePlayer event start pointer low byte
autoev_script_start_h EQU #C0B0   ; Compact FakePlayer event start pointer high byte
autoev_wait_frames EQU #C0B1   ; Compact FakePlayer wait countdown in frames
autoev_move_axis EQU #C0B2   ; Compact move axis (1=x,2=y)
autoev_move_step EQU #C0B3   ; Compact move step (1 or #FF)
autoev_move_remaining EQU #C0B4   ; Remaining compact FakePlayer movement pixels
autoev_loop_flag EQU #C0B5   ; 1=loop compact FakePlayer event script
autoev_active EQU #C0B6   ; 1=compact FakePlayer event script active
autoev_wait_mode EQU #C0B7   ; 1=wait SPC, 2=wait typewriter
autoev_number_l EQU #C0B8   ; Parsed compact event number low byte
autoev_number_h EQU #C0B9   ; Parsed compact event number high byte
dialogue_active    EQU #C0BA   ; 1=dialogue box is open
dialogue_current_box EQU #C0BB   ; Current dialogue box config index
dialogue_text_active EQU #C0BC   ; 1=typewriter is writing text
dialogue_text_ptr_l EQU #C0BD   ; Dialogue typewriter text pointer low byte
dialogue_text_ptr_h EQU #C0BE   ; Dialogue typewriter text pointer high byte
dialogue_vram_ptr_l EQU #C0BF   ; Dialogue typewriter VRAM pointer low byte
dialogue_vram_ptr_h EQU #C0C0   ; Dialogue typewriter VRAM pointer high byte
dialogue_row_start_l EQU #C0C1   ; Current dialogue row start VRAM low byte
dialogue_row_start_h EQU #C0C2   ; Current dialogue row start VRAM high byte
dialogue_char_delay EQU #C0C3   ; Dialogue character delay countdown
dialogue_char_delay_reload EQU #C0C4   ; Dialogue character delay reload value
dialogue_box_vram_l EQU #C0C5   ; Dialogue box VRAM start low byte
dialogue_box_vram_h EQU #C0C6   ; Dialogue box VRAM start high byte
dialogue_box_width EQU #C0C7   ; Dialogue box width in chars
dialogue_box_height EQU #C0C8   ; Dialogue box height in chars
dialogue_box_tl_char EQU #C0C9   ; Dialogue top-left border char
dialogue_box_tr_char EQU #C0CA   ; Dialogue top-right border char
dialogue_box_bl_char EQU #C0CB   ; Dialogue bottom-left border char
dialogue_box_br_char EQU #C0CC   ; Dialogue bottom-right border char
dialogue_box_h_char EQU #C0CD   ; Dialogue horizontal border char
dialogue_box_v_char EQU #C0CE   ; Dialogue vertical border char
dialogue_graphic_enabled EQU #C0CF   ; 1=dialogue tile graphic is visible
dialogue_graphic_vram_l EQU #C0D0   ; Dialogue graphic VRAM start low byte
dialogue_graphic_vram_h EQU #C0D1   ; Dialogue graphic VRAM start high byte
dialogue_graphic_ptr_l EQU #C0D2   ; Dialogue graphic tile data pointer low byte
dialogue_graphic_ptr_h EQU #C0D3   ; Dialogue graphic tile data pointer high byte
dialogue_graphic_width EQU #C0D4   ; Dialogue graphic width in chars
dialogue_graphic_height EQU #C0D5   ; Dialogue graphic height in chars
current_flow_state  EQU #C0D6   ; Current game flow state
prev_flow_state     EQU #C0D7   ; Previous game flow state
gameflow_exit_requested EQU #C0D8   ; Exit flag for WorldLink loop
gameflow_menu_selection EQU #C0D9   ; Current/last submenu selection
gameflow_submenu_data_ptr EQU #C0DA   ; Pointer to active submenu data (16-bit)
gameflow_submenu_option_count EQU #C0DC   ; Cached submenu option count
gameflow_submenu_cursor_enabled EQU #C0DD   ; 1 when submenu uses sprite cursor
gameflow_submenu_cursor_layer_count EQU #C0DE   ; Cursor sprite layer count (1..4)
gameflow_condition_result EQU #C0DF   ; Result of last condition evaluation
transition_delay_var    EQU #C0E0   ; Frames per step for active transition effect

; ==================================================================
; MIDEAS GLOBAL VARIABLES (DEFAULTS + CUSTOM)
; ==================================================================
global_var_goal     EQU #C0E1   ; Goal status (0=Failure, 1=Completed)

; ==================================================================
; SYSTEM VARIABLES
; ==================================================================
ROM_slot            EQU #C0E2   ; Expanded slot for normal page 1 ROM access
slot_primary_normal EQU #C0E3   ; Primary slot register snapshot for BIOS-ROM-ROM-RAM layout
page0_bios_slot     EQU #C0E4   ; Expanded slot for normal BIOS page 0
page2_normal_slot   EQU #C0E5   ; Expanded slot for normal page 2 layout
page3_normal_slot   EQU #C0E6   ; Expanded slot for normal RAM page 3
mapper_bank_p1_current EQU #C0E7   ; Mapper current bank for page/window 1
mapper_bank_p2_current EQU #C0E8   ; Mapper current bank for page/window 2
mapper_bank_p3_current EQU #C0E9   ; Mapper current bank for page/window 3
mapper_bank_p4_current EQU #C0EA   ; Mapper current bank for page/window 4
mapper_saved_bank    EQU #C0EB   ; Saved mapper bank for push/pop helpers
mapper_saved_bank_p1 EQU #C0EC   ; Saved mapper bank for page/window 1 helpers
mapper_saved_bank_p3 EQU #C0ED   ; Saved mapper bank for page/window 3 helpers
mapper_saved_bank_p4 EQU #C0EE   ; Saved mapper bank for page/window 4 helpers
resource_descriptor_ptr EQU #C0EF   ; Pointer to cached resource descriptor entry (16-bit)
resource_descriptor_id EQU #C0F1   ; Cached resource id
resource_descriptor_type EQU #C0F2   ; Cached resource type
resource_descriptor_group EQU #C0F3   ; Cached resource group
resource_descriptor_bank EQU #C0F4   ; Cached resource bank
resource_descriptor_addr EQU #C0F5   ; Cached resource visible address (16-bit)
resource_descriptor_size EQU #C0F7   ; Cached resource size (16-bit)
vram_cache_tile_patterns_ready EQU #C0F9   ; 1 when shared gameplay tile patterns are already resident in VRAM
vram_cache_tile_colors_ready EQU #C0FA   ; 1 when shared gameplay tile colors are already resident in VRAM
vram_cache_font_ready EQU #C0FB   ; 1 when shared font patterns/colors are already resident in VRAM
current_screen2_tilebank_id EQU #C0FC   ; Current SCREEN 2 shared tilebank loaded in VRAM (#FF=none/unknown)
frame_counter       EQU #C0FD   ; Frame counter (16-bit)

; Profiling counters (16-bit, cumulative)
prof_update_all_entities_calls EQU #C0FF   ; Calls to update_all_entities
prof_execute_sm_calls EQU #C101   ; Calls to execute_all_state_machines
prof_sm_update_calls  EQU #C103   ; Calls to SM_Update
prof_collision_calls  EQU #C105   ; Calls to update_collision_component
prof_wall_calls       EQU #C107   ; Calls to update_wallcollision_component
prof_deadly_calls     EQU #C109   ; Calls to update_deadly_tiles_component
prof_tile_interaction_calls EQU #C10B   ; Calls to check_tile_interaction
prof_animation_calls  EQU #C10D   ; Calls to update_animation_component
prof_sprite_calls     EQU #C10F   ; Calls to update_sprite_component
prof_music_task_calls EQU #C111   ; Calls to task_update_music
prof_deadly_behavior_reads EQU #C113   ; Deadly helper behavior-map reads
; page0_transfer_buffer shares the ZX0 scratch area declared near RAM_USAGE_END.

; ==================================================================
; SCREEN MAP POINTERS (Current active screen)
; ==================================================================
current_screen_layout   EQU #C115   ; Pointer to current screen layout data (16-bit)
current_screen_layout_bank EQU #C117   ; Mapper bank for current screen layout data
current_behavior_map    EQU #C118   ; Pointer to current behavior map data (16-bit)
current_behavior_map_bank EQU #C11A   ; Mapper bank for current behavior map data
behavior_cache_row     EQU #C11B   ; Cached behavior row (255=invalid)
behavior_cache_map_l   EQU #C11C   ; Cached behavior map pointer low byte
behavior_cache_map_h   EQU #C11D   ; Cached behavior map pointer high byte
behavior_cache_row_base EQU #C11E   ; Cached row base address in behavior map (16-bit)
RUNTIME_SCREEN_MAP_SIZE EQU 768
MAX_RUNTIME_EFFECT_ZONES EQU 0
runtime_background_layout EQU #C120   ; Immutable copy of current background layout (32x24)
runtime_screen_layout  EQU #C420   ; Mutable copy of current screen layout (32x24)
runtime_behavior_map   EQU #C720   ; Mutable copy of current behavior map (32x24)
runtime_interaction_type_map EQU #CA20   ; Mutable copy of current interaction type map (32x24)
runtime_interaction_value_map EQU #CD20   ; Mutable copy of current interaction value map (32x24)
runtime_interaction_target_map EQU #D020   ; Mutable copy of current interaction target map (32x24)
runtime_char_behavior_table EQU #D320   ; Current screen char -> behavior lookup table (256 bytes)
runtime_effects_layout EQU #D420   ; Alternate effects layout copy for secret zones (32x24)
screen_block_catalog_ptr EQU #D720   ; Scratch pointer to current screen block catalog during layout expansion
screen_block_map_ptr EQU #D722   ; Scratch pointer to current screen block index map during layout expansion
runtime_effect_zone_table EQU #D724   ; Current screen effect zone table (0 bytes)
current_effect_zone_count EQU #D724   ; Number of effect zones copied into runtime_effect_zone_table
secret_zone_active EQU #D725   ; 1 if hero is currently inside an active secret zone
secret_zone_rect_x EQU #D726   ; Active secret zone rect X in cells
secret_zone_rect_y EQU #D727   ; Active secret zone rect Y in cells
secret_zone_rect_w EQU #D728   ; Active secret zone rect width in cells
secret_zone_rect_h EQU #D729   ; Active secret zone rect height in cells

; ==================================================================
; VIEWPORT/CAMERA VARIABLES (for scroll system)
; ==================================================================
camera_x            EQU #D72A   ; Camera X position in pixels (16-bit)
camera_y            EQU #D72C   ; Camera Y position in pixels (16-bit)
camera_tile_x       EQU #D72E   ; Camera tile X (column)
camera_tile_y       EQU #D72F   ; Camera tile Y (row)
world_width_tiles   EQU #D730   ; World width in tiles
world_height_tiles  EQU #D731   ; World height in tiles
scroll_dirty_flag   EQU #D732   ; 1=viewport changed, needs redraw
hud_dirty_flag      EQU #D733   ; 1=HUD needs redraw, 0=clean
time_second_frame_counter EQU #D734   ; VBlank frames remaining until the next TimeRemaining decrement
time_last_interrupt_counter EQU #D735   ; Last interrupt_counter snapshot used by TimeRemaining sync (16-bit)

; ==================================================================
; ANIMATED TILES VARIABLES
; ==================================================================
anim_tile_timer     EQU #D737   ; Animation frame timer
anim_tile_frame     EQU #D738   ; Current animation frame (0-3)
anim_tile_speed     EQU #D739   ; Frames between animation updates
anim_tile_transform_flags EQU #D73A   ; Runtime flags for transform-mode tile animation (byte0=flags, byte1=opcode scratch)
anim_tile_row_buffer EQU #D73C   ; Temp buffer (8 bytes) for row transforms

; ==================================================================
; ENTITY SYSTEM VARIABLES (Fixed 32 entities)
; ==================================================================
MAX_ENTITIES        EQU 32
entity_active       EQU #D744   ; Entity active flags (32 bytes, 0=inactive, 1=active)
entity_is_player    EQU #D764   ; Entity hero/player flag (32 bytes, 0=no, 1=yes)
entity_button_contact_active EQU #D784   ; 1 while entity stays on the same button tile (32 bytes)
entity_button_contact_x EQU #D7A4   ; Button tile X currently latched per entity (32 bytes)
entity_button_contact_y EQU #D7C4   ; Button tile Y currently latched per entity (32 bytes)
entity_on_ladder   EQU #D7E4   ; 1 while entity is centered on a ladder tile (32 bytes)
entity_gate_current_step EQU #D804   ; Current applied retract step (32 bytes)
entity_gate_step_timer EQU #D824   ; Countdown until next retract step (32 bytes)
entity_walljump_lock EQU #D844   ; Remaining horizontal lock frames after wall jump (32 bytes)
entity_walljump_locked_vx EQU #D864   ; Horizontal velocity preserved while wall jump lock is active (32 bytes)
entity_wallgrab_active EQU #D884   ; 1 if entity is currently grabbing a wall (32 bytes)
entity_wallgrab_grace EQU #D8A4   ; Frames to keep wall grab during transient wall flag gaps (32 bytes)
entity_wallgrab_timer EQU #D8C4   ; Remaining wall-grab frames until grounded reset (32 bytes)
entity_wallgrab_lockout EQU #D8E4   ; Wall grab disabled until grounded after timer is spent (32 bytes)
entity_walljump_anim_active EQU #D904   ; Wall jump one-shot animation is waiting to restore base sprite (32 bytes)
entity_x_pos        EQU #D924   ; Entity X positions (32 bytes)
entity_y_pos        EQU #D944   ; Entity Y positions (32 bytes)
entity_vel_x        EQU #D964   ; Entity X velocity (32 bytes)
entity_vel_y        EQU #D984   ; Entity Y velocity (32 bytes)
entity_comp_masks   EQU #D9A4   ; Entity component masks (32 bytes)
entity_comp_masks_hi EQU #D9C4   ; Entity component masks high byte (32 bytes)
entity_screen_id    EQU #D9E4   ; Entity screen ID (32 bytes)
entity_job_period   EQU #DA04   ; Entity job period in frames (32 bytes, 1=100%,2=50%,3=33%,4=25%)
entity_job_entry    EQU #DA24   ; Entity job entry slot within period window (32 bytes)
entity_job_scheduler_active EQU #DA44   ; 1 when any entity uses non-default job cadence
entity_dir_mask     EQU #DA45   ; Entity direction mask (32 bytes)
entity_input_speed  EQU #DA65   ; Entity input/cursor speed (32 bytes)
entity_health       EQU #DA85   ; Entity health (32 bytes)
entity_anim_frame   EQU #DAA5   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #DAC5   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #DAE5   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #DB05   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #DB25   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #DB45   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #DB65   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #DB85   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #DBA5   ; Entity State Wait Timer (32 bytes)
entity_sm_sprite_control EQU #DBC5   ; 1 when the assigned state machine explicitly drives sprite changes (32 bytes)
entity_lifetime     EQU #DBE5   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_collectible_enabled EQU #DC05   ; 1 when entity has Collectible component (32 bytes)
entity_carried_by   EQU #DC25   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #DC45   ; Entity template token (32 bytes, 0=unknown)
entity_facing_dir   EQU #DC65   ; Last facing direction (32 bytes, 0=none,1=left,2=right,3=up,4=down)
entity_sm_var_0     EQU #DC85   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #DCA5   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #DCC5   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #DCE5   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #DD05   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #DD25   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #DD45   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #DD65   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #DD85   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #DDA5   ; Number of sprites currently active
sprites_dirty      EQU #DDA6   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #DDA7   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #DDC7   ; Sprite colors (32 bytes)
sprite_layer_colors EQU #DDE7   ; HW sprite layer color cache - RAM copy (32 bytes, indexed by HW sprite index)
sprite_layer_y_offsets EQU #DE07   ; HW sprite layer signed Y offsets - RAM copy (32 bytes, indexed by HW sprite index)
sprite_asset_base_pattern_slot_runtime EQU #DE27   ; Runtime base 16x16 slot per sprite asset (1 bytes)
sprite_placeholder_base_pattern_num EQU #DE28   ; Runtime placeholder pattern number (base slot * 4)
current_sprite_pattern_pack_id EQU #DE29   ; Active runtime sprite pattern pack id (#FF=none loaded)
sprite_attributes   EQU #DE2A   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (1 screens detected)
; ==================================================================
current_screen_id   EQU #DEAA   ; Currently displayed screen ID
current_screen_engine EQU #DEAB   ; Runtime engine: 0=Player, 1=FakePlayer
screen_dirty_flag   EQU #DEAC   ; Screen needs redraw flag
screen_transition_cooldown EQU #DEAD   ; Cooldown frames after screen transition
current_world_id    EQU #DEAE   ; Current world ID (for multi-world support)
current_screen_index EQU #DEAF   ; Current screen index within world
current_screen_anim_group_count EQU #DEB0   ; Animated tile groups visible in current screen
current_screen_entity_count EQU #DEB1   ; Entity instances assigned to current screen
current_screen_sprite_pattern_slots EQU #DEB2   ; Sprite pattern slots needed by current screen
current_screen_summary_flags EQU #DEB3   ; Runtime screen summary flags (music/hud/effects/anim)

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #DEB4   ; Player X position (16-bit)
player_y            EQU #DEB6   ; Player Y position (16-bit)
player_runtime_enabled EQU #DEB8   ; 1=player fast runtime bound to hero entity
player_entity_index EQU #DEB9   ; Entity index used by player fast runtime (#FF=none)
player_vx_runtime   EQU #DEBA   ; Cached player X velocity (signed 8-bit)
player_vy_runtime   EQU #DEBB   ; Cached player Y velocity (signed 8-bit)
player_health       EQU #DEBC   ; Player health points
player_score        EQU #DEBD   ; Player score (16-bit)
gem_count           EQU #DEBF   ; Collectible tile counter (8-bit)
last_interaction_char EQU #DEC0   ; Char code of last interacted tile (for SM VARIABLE_COMPARE)
last_gem_char       EQU last_interaction_char   ; Backwards-compatible alias for collectible SM checks
last_interaction_pending EQU #DEC1   ; 1 when a new tile interaction is pending for State Machine logic
last_interaction_type EQU #DEC2   ; Interaction type id of last interacted tile
last_interaction_value EQU #DEC3   ; Interaction value byte of last interacted tile
last_interaction_target EQU #DEC4   ; Interaction target id of last interacted tile
last_interaction_x  EQU #DEC5   ; Tile X coordinate of last interaction
last_interaction_y  EQU #DEC6   ; Tile Y coordinate of last interaction
last_interaction_entity EQU #DEC7   ; Entity index that triggered the last interaction

; Persistent collectibles list (survives screen re-entry)
MAX_COLLECTIBLES     EQU 64              ; Max persistent collectible records
collected_count      EQU #DEC8   ; Number of collected tiles recorded (8-bit)
collected_world      EQU #DEC9   ; World IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_screen     EQU #DF09   ; Screen IDs for each collected tile (MAX_COLLECTIBLES bytes)
collected_idx_l      EQU #DF49   ; Tile name-table index low byte (MAX_COLLECTIBLES bytes)
collected_idx_h      EQU #DF89   ; Tile name-table index high byte (MAX_COLLECTIBLES bytes)

; Timed bonus tile respawn slots (bonus gem regeneration)
MAX_BONUS_RESPAWNS   EQU 16              ; Max timed bonus tiles waiting to respawn
bonus_respawn_world  EQU #DFC9   ; World IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_screen EQU #DFD9   ; Screen IDs for timed bonus respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_l  EQU #DFE9   ; Tile index low byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_idx_h  EQU #DFF9   ; Tile index high byte for timed respawns (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_secs   EQU #E009   ; Remaining seconds per timed respawn slot (MAX_BONUS_RESPAWNS bytes)
bonus_respawn_frames EQU #E019   ; Frame countdown (60..1) per timed respawn slot (MAX_BONUS_RESPAWNS bytes)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #E029   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #E02A   ; Temporary 16-bit storage
temp_word_2         EQU #E02C   ; Temporary 16-bit storage
temp_byte_1         EQU #E02E   ; Temporary 8-bit storage
temp_byte_2         EQU #E02F   ; Temporary 8-bit storage
temp_byte_3         EQU #E030   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #E050   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #E070   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #E090   ; Temporary 8-bit storage (32 bytes)

; ==================================================================
; SOUND SYSTEM VARIABLES
; ==================================================================
sfx_active          EQU #E0B0   ; 0=no SFX active, 1=playing
sfx_timer           EQU #E0B1   ; Frames remaining for current SFX
sfx_fadeout         EQU #E0B2   ; Reserved fadeout flag/state
temp_byte_7         EQU #E0B3   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #E0D3   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #E0F3   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #E113   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #E133   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #E153   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #E173   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #E193   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #E1B3   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #E1D3   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #E1F3   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #E213   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #E233   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #E253   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #E273   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #E293   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #E2B3   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #E2D3   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #E2F3   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #E313   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #E353   ; Temporary 16-bit storage (64 bytes)
temp_byte_26        EQU #E393   ; Temporary 8-bit storage (32 bytes)
temp_byte_27        EQU #E3B3   ; Temporary 8-bit storage (32 bytes)
temp_byte_28        EQU #E3D3   ; Temporary 8-bit storage (32 bytes)
tileDead_dbg        EQU #E3F3   ; Debug byte: current hero deadly contact
tileDead_latched_dbg EQU #E3F4   ; Debug byte: latched hero deadly contact
tileDead_x_dbg      EQU #E3F5   ; Debug byte: last sampled deadly tile X
tileDead_y_dbg      EQU #E3F6   ; Debug byte: last sampled deadly tile Y
tileDead_value_dbg  EQU #E3F7   ; Debug byte: last raw deadly behavior value

; Wall collision temporary variables
wall_temp_x         EQU #E3F8   ; Cached entity X for wall checks
wall_temp_y         EQU #E3F9   ; Cached entity Y for wall checks
wall_hit_left       EQU #E3FA   ; Hitbox left edge cache
wall_hit_top        EQU #E3FB   ; Hitbox top edge cache
wall_hit_right      EQU #E3FC   ; Hitbox right edge cache
wall_hit_bottom     EQU #E3FD   ; Hitbox bottom edge cache
wall_hit_w          EQU #E3FE   ; Hitbox width cache (min 1)
wall_hit_h          EQU #E3FF   ; Hitbox height cache (min 1)
wall_probe_left     EQU #E400   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #E401   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #E402   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #E403   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #E404   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #E424   ; Number of entries in active_entity_list
hero_entity_id      EQU #E425   ; First current-screen entity flagged as player (#FF = none)
active_entity_list_dirty EQU #E426   ; 1=rebuild active_entity_list required
input_entity_list   EQU #E427   ; Active current-screen entities with Input component (MAX_ENTITIES bytes)
input_entity_count  EQU #E447   ; Number of entries in input_entity_list
render_entity_list  EQU #E448   ; Active current-screen entities with Sprite component (MAX_ENTITIES bytes)
render_entity_count EQU #E468   ; Number of entries in render_entity_list
collision_entity_list EQU #E469   ; Active current-screen entities with Collision component (MAX_ENTITIES bytes)
collision_entity_count EQU #E489   ; Number of entries in collision_entity_list
ground_entity_list  EQU #E48A   ; Active current-screen entities with Collision or Gravity (MAX_ENTITIES bytes)
ground_entity_count EQU #E4AA   ; Number of entries in ground_entity_list
anim_entity_list    EQU #E4AB   ; Active current-screen entities with Animation+Sprite (MAX_ENTITIES bytes)
anim_entity_count   EQU #E4CB   ; Number of entries in anim_entity_list

; Entity-entity collision optimized variables
coll_list           EQU #E4CC   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #E4EC   ; Number of entities in coll_list
coll_src_left       EQU #E4ED   ; Source AABB left edge (scratch)
coll_src_right      EQU #E4EE   ; Source AABB right edge (scratch)
coll_src_top        EQU #E4EF   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #E4F0   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #E4F1   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #E4F1   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #E4F3   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #E4F5   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #E4F7   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #E4F9   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #E4FB   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #E4FD   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #E4FF   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #E501   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #E502   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #E507   ; Frame counter (16-bit)
task_exec_time          EQU #E509   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #E50B   ; Set to 1 on each VBlank (1 byte)
interrupt_in_progress   EQU #E50C   ; 1 while the H.TIMI dispatcher is running
RAM_INTERRUPT_END       EQU #E50D   ; End of interrupt system

; ==================================================================
; STATE MACHINE SOUND RUNTIME (one active sound asset)
; ==================================================================
sm_sound_active       EQU #E50D   ; 0=idle, 1=playing state-machine sound asset
sm_sound_frames_left  EQU #E50E   ; Frames left for current state-machine sound asset
sm_sound_ptr_l        EQU #E50F   ; Next sound frame pointer low byte
sm_sound_ptr_h        EQU #E510   ; Next sound frame pointer high byte

; ==================================================================
; TRACKER MUSIC RUNTIME
; ==================================================================
music_active         EQU #E511   ; 0=stopped, 1=track active
music_muted          EQU #E512   ; 0=audible, 1=muted/pause
music_loop           EQU #E513   ; 0=no loop, 1=loop enabled
music_track_index    EQU #E514   ; Current ROM track index
music_row_frames     EQU #E515   ; Frames per tracker row
music_row_countdown  EQU #E516   ; Countdown to next row
music_order_pos      EQU #E517   ; Current order position
music_pattern_index  EQU #E518   ; Current pattern index
music_pattern_row    EQU #E519   ; Current row inside pattern
music_pattern_rows   EQU #E51A   ; Cached rows in current pattern
music_track_ptr_l    EQU #E51B   ; Current track pointer low byte
music_track_ptr_h    EQU #E51C   ; Current track pointer high byte
music_pattern_ptr_l  EQU #E51D   ; Current pattern rows pointer low byte
music_pattern_ptr_h  EQU #E51E   ; Current pattern rows pointer high byte
music_mixer_shadow   EQU #E51F   ; PSG mixer shadow for music runtime
music_pitch_note_work EQU #E520   ; Scratch note index while resolving tone/ornament macros
music_pitch_step_work EQU #E521   ; Scratch macro step while resolving tone/ornament macros
music_pitch_len_work  EQU #E522   ; Scratch macro length while resolving tone/ornament macros
music_ch_note_base EQU #E523   ; Current note index (255=silent) (3 bytes)
music_ch_a_note EQU #E523   ; Channel A
music_ch_b_note EQU #E524   ; Channel B
music_ch_c_note EQU #E525   ; Channel C
music_ch_instrument_base EQU #E526   ; Current instrument id (0=none) (3 bytes)
music_ch_a_instrument EQU #E526   ; Channel A
music_ch_b_instrument EQU #E527   ; Channel B
music_ch_c_instrument EQU #E528   ; Channel C
music_ch_ornament_base EQU #E529   ; Current ornament id (0=none) (3 bytes)
music_ch_a_ornament EQU #E529   ; Channel A
music_ch_b_ornament EQU #E52A   ; Channel B
music_ch_c_ornament EQU #E52B   ; Channel C
music_ch_volume_base EQU #E52C   ; Current base volume (0-15) (3 bytes)
music_ch_a_volume EQU #E52C   ; Channel A
music_ch_b_volume EQU #E52D   ; Channel B
music_ch_c_volume EQU #E52E   ; Channel C
music_ch_vol_step_base EQU #E52F   ; Reserved software volume envelope step (3 bytes)
music_ch_a_vol_step EQU #E52F   ; Channel A
music_ch_b_vol_step EQU #E530   ; Channel B
music_ch_c_vol_step EQU #E531   ; Channel C
music_ch_tone_step_base EQU #E532   ; Reserved software tone envelope step (3 bytes)
music_ch_a_tone_step EQU #E532   ; Channel A
music_ch_b_tone_step EQU #E533   ; Channel B
music_ch_c_tone_step EQU #E534   ; Channel C
music_ch_noise_step_base EQU #E535   ; Reserved software noise envelope step (3 bytes)
music_ch_a_noise_step EQU #E535   ; Channel A
music_ch_b_noise_step EQU #E536   ; Channel B
music_ch_c_noise_step EQU #E537   ; Channel C
music_ch_orn_step_base EQU #E538   ; Reserved ornament step (3 bytes)
music_ch_a_orn_step EQU #E538   ; Channel A
music_ch_b_orn_step EQU #E539   ; Channel B
music_ch_c_orn_step EQU #E53A   ; Channel C
music_ch_hw_env_step_base EQU #E53B   ; Software hardware-envelope divider step (3 bytes)
music_ch_a_hw_env_step EQU #E53B   ; Channel A
music_ch_b_hw_env_step EQU #E53C   ; Channel B
music_ch_c_hw_env_step EQU #E53D   ; Channel C
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E53E   ; End of project variables (9534 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E53E: Project variables (9534 bytes)
;   #E53E-#E600: Alignment padding/free RAM (194 bytes)
