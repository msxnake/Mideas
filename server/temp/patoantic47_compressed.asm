...
; BANK 09 @#0000 : statemachine.asm part 4/4 (6267 bytes)
; BANK 09 @#187B : gameflow.asm part 1/3 (1925 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (6632 bytes)
