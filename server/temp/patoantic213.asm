...
; Estimated payload bytes: 149833
; Estimated banks used: 19
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (1163 bytes)
; BANK 00 @#048B : patterns.asm (1909 bytes)
; BANK 00 @#0C00 : colors.asm (1711 bytes)
; BANK 00 @#12AF : components.asm (22 bytes)
; BANK 00 @#12C5 : entities.asm part 1/2 (3387 bytes)
; BANK 01 @#0000 : entities.asm part 2/2 (5938 bytes)
; BANK 01 @#1732 : worlds.asm part 1/2 (2254 bytes)
; BANK 02 @#0000 : worlds.asm part 2/2 (6338 bytes)
; BANK 02 @#18C2 : screens.asm part 1/8 (1854 bytes)
...
; BANK 09 @#0000 : screens.asm part 8/8 (7164 bytes)
; BANK 09 @#1BFC : sprites.asm part 1/2 (1028 bytes)
; BANK 10 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 11 @#0000 : sprites.asm part 3/2 (3856 bytes)
; BANK 11 @#0F10 : font.asm (1861 bytes)
; BANK 11 @#1655 : hud.asm (2475 bytes)
; BANK 12 @#0000 : hud.asm (1165 bytes)
; BANK 12 @#048D : menus.asm (454 bytes)
; BANK 12 @#0653 : sound.asm part 1/2 (6573 bytes)
; BANK 13 @#0000 : sound.asm part 2/2 (2975 bytes)
; BANK 13 @#0B9F : scroll.asm (2353 bytes)
; BANK 13 @#14D0 : animtiles.asm (2864 bytes)
; BANK 14 @#0000 : animtiles.asm (4002 bytes)
; BANK 14 @#0FA2 : statemachine.asm part 1/3 (4190 bytes)
; BANK 15 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 16 @#0000 : statemachine.asm part 3/3 (4445 bytes)
; BANK 16 @#115D : gameflow.asm part 1/2 (3747 bytes)
; BANK 17 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 18 @#0000 : gameflow.asm part 3/2 (2377 bytes)
...
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #E9DC   ; End of project variables (10716 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#E9DC: Project variables (10716 bytes)
;   #E9DC-#F37F: Free RAM (~2468 bytes available)
...
; ==================================================================
tile_pattern_bank0:
    ; ZX0 compressed tile_pattern (192 -> 170 bytes)
    ...
    DB #01,#FE,#FC,#0D,#F8,#F0,#E0,#80,#55,#56
load_pattern_bank0:
    ...
    ld bc, 192    ; Total bytes for all tile characters (16x16 tiles = 4 chars each)
...
load_pattern_bank1:
    ...
    ld bc, 192    ; Total bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
; ==================================================================
tile_color_bank0:
    ; ZX0 compressed tile_color (192 -> 68 bytes)
    ...
    DB #F0,#6F,#41,#9E,#3F,#20,#FB,#FF,#BD,#F4,#E0,#9D,#FC,#68,#81,#E7
    DB #FE,#55,#55,#80
load_color_bank0:
    ...
    ld bc, 192     ; Total color bytes for all tile characters
    call FAST_LDIRVM              ; Fast VRAM write (direct port access)
    ret
...
SCREEN_PAN1_0_LAYOUT:
    ; ZX0 compressed layout (768 -> 166 bytes)
    DB #95,#84,#69,#FF,#56,#95,#84,#6A,#80,#E3,#81,#FC,#F1,#FB,#FC,#88
    DB #88,#92,#FB,#F0,#82,#C4,#48,#8E,#82,#83,#FD,#6F,#80,#FF,#86,#FE
    DB #16,#2F,#82,#88,#C4,#13,#F9,#89,#81,#FE,#5A,#81,#F4,#00,#62,#83
    DB #83,#1E,#84,#56,#7F,#89,#8A,#80,#F8,#91,#80,#E7,#CB,#8A,#8B,#8C
    DB #EE,#87,#F8,#80,#47,#A5,#51,#8C,#C8,#C6,#6F,#8E,#FF,#EF,#F0,#93
    DB #FF,#B3,#F4,#F8,#0E,#38,#5B,#88,#FC,#FE,#2C,#35,#D1,#C0,#F9,#85
    DB #CC,#5F,#80,#5B,#89,#7C,#65,#C0,#4D,#A3,#5D,#8B,#59,#7C,#77,#88
    DB #3A,#40,#E4,#86,#10,#37,#88,#3D,#A8,#F5,#FE,#E2,#80,#6F,#88,#92
    DB #92,#F8,#E4,#80,#6B,#85,#4F,#B8,#4C,#B0,#F4,#80,#A6,#86,#80,#85
    DB #FE,#30,#D8,#D9,#C4,#77,#D1,#F0,#FB,#80,#CB,#44,#E4,#B5,#FC,#BE
    DB #80,#FB,#D0,#35,#55,#58
...
BEHAVIOR_PAN1_0_DATA:
    ; ZX0 compressed behavior (768 -> 82 bytes)
    DB #85,#00,#56,#80,#10,#0F,#88,#53,#BD,#C1,#08,#40,#5D,#C4,#CC,#AA
    DB #08,#10,#55,#F1,#C0,#5D,#D1,#80,#F8,#D3,#C0,#03,#80,#AC,#BA,#20
    DB #FF,#10,#68,#04,#E5,#94,#F3,#78,#C4,#E0,#E1,#42,#3C,#C0,#43,#BC
    DB #50,#C0,#4D,#61,#90,#3D,#D9,#70,#BE,#7E,#C9,#98,#5F,#C0,#11,#A7
    DB #04,#95,#BA,#B8,#08,#C0,#4D,#D7,#BC,#B3,#C0,#44,#1E,#FE,#17,#55
    DB #55,#80
...
SCREEN_PAN1_0_INTERACTION_VALUE_MAP:
    ...
    DB #01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#01,#01,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ...
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#01,#01,#01,#01
    DB #01,#01,#01,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#01,#01,#01,#01
    DB #01,#01,#01,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#01,#01,#01,#01,#01
    DB #01,#01,#01,#01,#01,#01,#01,#01,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#01,#01,#00,#00,#01,#01,#01,#01,#01
...
init_hero_1:
    ...
    ; JSON position: (3, 15) tiles = (24, 120) pixels
    ; Template: tpl_1771166650770_6ibnk
