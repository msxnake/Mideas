; ==================================================================
; SPRITEOPTIMIZATIONTEST - UNIFIED FILE
...
; ==================================================================
player_x            EQU #C4BA   ; Player X position (16-bit)
player_y            EQU #C4BC   ; Player Y position (16-bit)
player_health       EQU #C4BE   ; Player health points
player_score        EQU #C4BF   ; Player score (16-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #C4C1   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #C4C2   ; Temporary 16-bit storage
temp_word_2         EQU #C4C4   ; Temporary 16-bit storage
temp_byte_1         EQU #C4C6   ; Temporary 8-bit storage
temp_byte_2         EQU #C4C7   ; Temporary 8-bit storage
temp_byte_3         EQU #C4C8   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #C4E8   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #C508   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #C528   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #C548   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #C568   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #C588   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #C5A8   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #C5C8   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #C5E8   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #C608   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #C628   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #C648   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #C668   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #C688   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #C6A8   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #C6E8   ; Temporary 16-bit storage (64 bytes)

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C728   ; End of project variables (1832 bytes used)

; ==================================================================
; MEMORY SAFETY CHECK
; ==================================================================
; RAM Layout:
;   #C000-#C728: Project variables (1832 bytes)
;   #C728-#F37F: Free RAM (~11352 bytes available)
...
; Reserve space for all variables defined above
    DS 1832   ; Reserve 1832 bytes for all variables
...
; Sprite Asset 0: WhiteSprite
;; Sprite: WhiteSprite
;; Total Frames: 1
;; Size: 16x16
;; Background Color (not exported as a layer): #000000
;; Drawable Palette (Hex): C0=#000000, C1=#FFFFFF, C2=#FC584A, C3=#E7E474

SPRITE_WHITESPRITE_0_WIDTH     EQU 16
SPRITE_WHITESPRITE_0_HEIGHT    EQU 16
SPRITE_WHITESPRITE_0_FRAMES    EQU 1

;; ---- Sprite Frame: WhiteSprite_0_F0 ----
;; Size: 16x16
WHITESPRITE_0_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #01,#03,#07,#0F,#1F,#3F,#7F,#FF,#FF,#7F,#3F,#1F,#0F,#07,#03,#01
    DB #80,#C0,#E0,#F0,#F8,#FC,#FE,#FF,#FF,#FE,#FC,#F8,#F0,#E0,#C0,#80

;; ---- End of Frame: WhiteSprite_0_F0 ----


; Unified pattern label for sprite 0
SPRITE_0_PATTERN EQU WHITESPRITE_0_F0_LAYER1
...
; Sprite 0: WhiteSprite frame pointers
SPRITE_0_FRAME_PTRS:
    dw WHITESPRITE_0_F0_LAYER1
...
load_sprite_patterns:
    ...
    ; Sprite Asset 0: WhiteSprite (1 frames, 1 layers)
...
main_program:
    ...
    ; GameFlow initial state: default to GAME (pure game, no menu)
