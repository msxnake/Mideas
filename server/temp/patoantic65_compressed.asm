...
; Estimated payload bytes: 101317
...
; BANK 04 @#0000 : sprites.asm part 3/2 (914 bytes)
; BANK 04 @#0392 : font.asm (3547 bytes)
; BANK 04 @#116D : hud.asm (3731 bytes)
; BANK 05 @#0000 : hud.asm (105 bytes)
; BANK 05 @#0069 : menus.asm (444 bytes)
; BANK 05 @#0225 : sound.asm (3184 bytes)
; BANK 05 @#0E95 : scroll.asm (2353 bytes)
; BANK 05 @#17C6 : animtiles.asm (2106 bytes)
; BANK 06 @#0000 : animtiles.asm (3810 bytes)
; BANK 06 @#0EE2 : particles.asm (4382 bytes)
; BANK 07 @#0000 : particles.asm (581 bytes)
; BANK 07 @#0245 : statemachine.asm part 1/4 (7611 bytes)
; BANK 08 @#0000 : statemachine.asm part 2/4 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 3/4 (8192 bytes)
; BANK 10 @#0000 : statemachine.asm part 4/4 (2641 bytes)
; BANK 10 @#0A51 : gameflow.asm part 1/3 (5551 bytes)
; BANK 11 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 12 @#0000 : gameflow.asm part 3/3 (3013 bytes)
...
SPRITE_NINA_IDLE_LEFT_14_FRAMES    EQU 1
...
ZX0_SPRITE_FRAME_NINA_IDLE_LEFT_14_F0_DATA:
    ; ZX0 compressed sprite frame NINA_IDLE_LEFT_14_F0 (64 -> 50 bytes)
    DB #21,#1F,#00,#9A,#03,#02,#03,#22,#07,#00,#28,#02,#E0,#29,#A0,#30
    DB #18,#08,#7A,#C0,#40,#C0,#E0,#F0,#00,#80,#FC,#58,#0F,#0B,#1B,#1F
