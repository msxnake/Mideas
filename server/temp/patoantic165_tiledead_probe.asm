...
tileDeadX EQU temp_byte_26 + 1 ; Debug byte: last sampled tile X
tileDeadY EQU temp_byte_26 + 2 ; Debug byte: last sampled tile Y
tileDeadValue EQU temp_byte_26 + 3 ; Debug byte: raw behavior byte read
