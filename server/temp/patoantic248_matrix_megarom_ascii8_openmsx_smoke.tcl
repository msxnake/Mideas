set log_path "C:/Users/salam/Documents/Programacion/Mideas/server/temp/patoantic248_matrix_megarom_ascii8_openmsx_smoke.log"
set shot_dir "C:/Users/salam/Documents/Programacion/Mideas/server/temp/patoantic248_matrix_megarom_ascii8_openmsx_smoke_shots"
file mkdir $shot_dir
...
proc state {tag} {
    ...
    set flow [mem8 0xC104]; set screen [mem8 0xE1C8]; set irq [mem16 0xE86A]; set inirq [mem8 0xE86F]
...
after time 12.0 { shot "patoantic248_matrix_megarom_ascii8_t12.png" "t12" }
after time 13.5 { hold_right "right" 1.0 }
after time 16.0 { shot "patoantic248_matrix_megarom_ascii8_t16.png" "t16" }
after time 22.0 { shot "patoantic248_matrix_megarom_ascii8_t22.png" "t22"; close $f; exit }
