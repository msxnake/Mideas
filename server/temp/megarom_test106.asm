; ==================================================================
; PATOANTIC241 - MEGAROM UNIFIED FILE
; File: unitedFiles.asm
; ROM Mode: megarom (flat 32KB, mapper initialized for future bank switching)
; Mapper: konami
;
; Layout: flat 4000h-BFFFh, same as simple32k but with real mapper writes.
; The Konami mapper is configured at boot (banks 0-3 statically mapped).
; This enables future dynamic bank switching without code changes.
;
; Tiles: 21
; Sprites: 10
; Screens: 8
...
; Estimated payload bytes: 144582
; Estimated banks used: 18
; ------------------------------------------------------------------
; BANK 00 @#0000 : page0.asm (96 bytes)
; BANK 00 @#0060 : patterns.asm (2537 bytes)
; BANK 00 @#0A49 : colors.asm (2254 bytes)
; BANK 00 @#1317 : components.asm (22 bytes)
; BANK 00 @#132D : entities.asm part 1/2 (3283 bytes)
; BANK 01 @#0000 : entities.asm part 2/2 (6185 bytes)
; BANK 01 @#1829 : worlds.asm part 1/2 (2007 bytes)
; BANK 02 @#0000 : worlds.asm part 2/2 (6480 bytes)
; BANK 02 @#1950 : screens.asm part 1/6 (1712 bytes)
...
; BANK 07 @#0000 : screens.asm part 6/6 (8192 bytes)
; BANK 08 @#0000 : screens.asm part 7/6 (4799 bytes)
; BANK 08 @#12BF : sprites.asm part 1/2 (3393 bytes)
; BANK 09 @#0000 : sprites.asm part 2/2 (8192 bytes)
; BANK 10 @#0000 : sprites.asm part 3/2 (3095 bytes)
; BANK 10 @#0C17 : font.asm (3547 bytes)
; BANK 10 @#19F2 : hud.asm (1550 bytes)
; BANK 11 @#0000 : hud.asm (2740 bytes)
; BANK 11 @#0AB4 : menus.asm (454 bytes)
; BANK 11 @#0C7A : sound.asm (4998 bytes)
; BANK 12 @#0000 : sound.asm (2249 bytes)
; BANK 12 @#08C9 : scroll.asm (2353 bytes)
; BANK 12 @#11FA : animtiles.asm (3590 bytes)
; BANK 13 @#0000 : animtiles.asm (2678 bytes)
; BANK 13 @#0A76 : statemachine.asm part 1/3 (5514 bytes)
; BANK 14 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 15 @#0000 : statemachine.asm part 3/3 (6321 bytes)
; BANK 15 @#18B1 : gameflow.asm part 1/2 (1871 bytes)
; BANK 16 @#0000 : gameflow.asm part 2/2 (8192 bytes)
; BANK 17 @#0000 : gameflow.asm part 3/2 (5318 bytes); ==================================================================
...
load_sprite_patterns_worldmap_1770754170935:
    ...
    call mapper_set_bank_p2
    ld hl, CAPCUADRAT1_RIGHT_9_F0_LAYER3
    ld de, SPRPAT + (28 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_9_PATTERN_BANK
    call mapper_set_bank_p2
    ld hl, CAPCUADRAT1_RIGHT_9_F1_LAYER3
    ld de, SPRPAT + (29 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    call mapper_set_bank_p2
    ld hl, CAPCUADRAT1_LEFT_17_F0_LAYER3
    ld de, SPRPAT + (56 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
    ...
    ld a, SPRITE_17_PATTERN_BANK
    call mapper_set_bank_p2
    ld hl, CAPCUADRAT1_LEFT_17_F1_LAYER3
    ld de, SPRPAT + (57 * 32)
    ld bc, 32
    call COPY_SPRITE_SRC_TO_VRAM
...
SCREEN_PAN1_2_7_LAYOUT:
    ; ZX0 compressed layout (768 -> 59 bytes)
    DB #81,#FF,#55,#58,#3C,#80,#81,#89,#8A,#FC,#19,#65,#9E,#9F,#82,#83
    DB #8B,#A2,#A3,#FF,#FB,#F9,#FC,#48,#E6,#A1,#80,#D7,#A4,#A5,#A4,#3F
    DB #F9,#FD,#EF,#FB,#F4,#EB,#FF,#E8,#D4,#FF,#FC,#81,#F9,#BF,#B2,#DE
    DB #CE,#FC,#B6,#E3,#F4,#9B,#E4,#A1,#55,#55,#80
...
BEHAVIOR_PAN1_2_7_DATA:
    ; ZX0 compressed behavior (768 -> 9 bytes)
    DB #81,#00,#55,#5A,#10,#55,#5D,#55,#56
