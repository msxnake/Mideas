...
; BANK 01 @#0000 : screens.asm (2812 bytes)
; BANK 01 @#0AFC : sprites.asm (2569 bytes)
; BANK 01 @#1505 : font.asm (2811 bytes)
; BANK 02 @#0000 : font.asm (572 bytes)
; BANK 02 @#023C : hud.asm (3480 bytes)
; BANK 02 @#0FD4 : menus.asm (168 bytes)
; BANK 02 @#107C : sound.asm part 1/2 (3972 bytes)
; BANK 03 @#0000 : sound.asm part 2/2 (5569 bytes)
; BANK 03 @#15C1 : scroll.asm (2353 bytes)
; BANK 03 @#1EF2 : animtiles.asm (270 bytes)
; BANK 04 @#0000 : animtiles.asm (4343 bytes)
; BANK 04 @#10F7 : statemachine.asm (5 bytes)
; BANK 04 @#10FC : gameflow.asm (3844 bytes)
; BANK 05 @#0000 : gameflow.asm (2177 bytes)
