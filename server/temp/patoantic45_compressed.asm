...
; Estimated payload bytes: 95848
; Estimated banks used: 12
; ------------------------------------------------------------------
; BANK 00 @#0000 : patterns.asm (955 bytes)
; BANK 00 @#03BB : colors.asm (883 bytes)
; BANK 00 @#072E : components.asm (22 bytes)
; BANK 00 @#0744 : entities.asm (4994 bytes)
; BANK 00 @#1AC6 : worlds.asm (1338 bytes)
; BANK 01 @#0000 : worlds.asm (1707 bytes)
; BANK 01 @#06AB : screens.asm part 1/2 (6485 bytes)
; BANK 02 @#0000 : screens.asm part 2/2 (7691 bytes)
; BANK 02 @#1E0B : sprites.asm (501 bytes)
; BANK 03 @#0000 : sprites.asm (6155 bytes)
; BANK 03 @#180B : font.asm (2037 bytes)
; BANK 04 @#0000 : font.asm (1510 bytes)
; BANK 04 @#05E6 : hud.asm (3836 bytes)
; BANK 04 @#14E2 : menus.asm (444 bytes)
; BANK 04 @#169E : sound.asm (2402 bytes)
; BANK 05 @#0000 : sound.asm (782 bytes)
; BANK 05 @#030E : scroll.asm (2353 bytes)
; BANK 05 @#0C3F : animtiles.asm (5057 bytes)
; BANK 06 @#0000 : animtiles.asm (859 bytes)
; BANK 06 @#035B : particles.asm (4963 bytes)
; BANK 06 @#16BE : statemachine.asm part 1/3 (2370 bytes)
; BANK 07 @#0000 : statemachine.asm part 2/3 (8192 bytes)
; BANK 08 @#0000 : statemachine.asm part 3/3 (8192 bytes)
; BANK 09 @#0000 : statemachine.asm part 4/3 (5371 bytes)
; BANK 09 @#14FB : gameflow.asm part 1/3 (2821 bytes)
; BANK 10 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 11 @#0000 : gameflow.asm part 3/3 (5736 bytes)
...
entity_health       EQU #C79E   ; Entity health (32 bytes)
entity_anim_frame   EQU #C7BE   ; Entity animation frame (32 bytes)
entity_anim_tick    EQU #C7DE   ; Entity animation tick counter (32 bytes)
entity_anim_speed   EQU #C7FE   ; Entity animation speed (ticks per frame) (32 bytes)
entity_anim_flags   EQU #C81E   ; Entity animation flags (32 bytes)
entity_sm_ptr_l     EQU #C83E   ; Entity State Pointer Low (32 bytes)
entity_sm_ptr_h     EQU #C85E   ; Entity State Pointer High (32 bytes)
entity_sm_timer_l   EQU #C87E   ; Entity State Timer Low (32 bytes)
entity_sm_timer_h   EQU #C89E   ; Entity State Timer High (32 bytes)
entity_sm_wait_timer EQU #C8BE   ; Entity State Wait Timer (32 bytes)
entity_lifetime     EQU #C8DE   ; Entity lifetime for auto-destroy (32 bytes, 0=infinite)
entity_carried_by   EQU #C8FE   ; Entity carrier ID (32 bytes, 255=not carried)
entity_template_token EQU #C91E   ; Entity template token (32 bytes, 0=unknown)
entity_sm_var_0     EQU #C93E   ; Entity Variable 0 (32 bytes)
entity_sm_var_1     EQU #C95E   ; Entity Variable 1 (32 bytes)
entity_sm_var_2     EQU #C97E   ; Entity Variable 2 (32 bytes)
entity_sm_var_3     EQU #C99E   ; Entity Variable 3 (32 bytes)
entity_sm_var_4     EQU #C9BE   ; Entity Variable 4 (32 bytes)
entity_sm_var_5     EQU #C9DE   ; Entity Variable 5 (32 bytes)
entity_sm_var_6     EQU #C9FE   ; Entity Variable 6 (32 bytes)
entity_sm_var_7     EQU #CA1E   ; Entity Variable 7 (32 bytes)

; ==================================================================
; SPRITE SYSTEM VARIABLES
; ==================================================================
entity_sprite_asset_index EQU #CA3E   ; Entity sprite asset index - RAM copy (32 bytes)
active_sprite_count EQU #CA5E   ; Number of sprites currently active
sprites_dirty      EQU #CA5F   ; 1=sprite_attributes changed, needs VRAM sync
sprite_pattern      EQU #CA60   ; Sprite pattern IDs (32 bytes)
sprite_color        EQU #CA80   ; Sprite colors (32 bytes)
sprite_attributes   EQU #CAA0   ; Interleaved sprite attributes (32 * 4 bytes)

; ==================================================================
; SCREEN SYSTEM VARIABLES (4 screens detected)
; ==================================================================
current_screen_id   EQU #CB20   ; Currently displayed screen ID
screen_dirty_flag   EQU #CB21   ; Screen needs redraw flag
screen_transition_cooldown EQU #CB22   ; Cooldown frames after screen transition
current_world_id    EQU #CB23   ; Current world ID (for multi-world support)
current_screen_index EQU #CB24   ; Current screen index within world

; ==================================================================
; PLAYER SYSTEM VARIABLES (player entity detected)
; ==================================================================
player_x            EQU #CB25   ; Player X position (16-bit)
player_y            EQU #CB27   ; Player Y position (16-bit)
player_health       EQU #CB29   ; Player health points
player_score        EQU #CB2A   ; Player score (16-bit)
gem_count           EQU #CB2C   ; Collectible tile counter (8-bit)

; ==================================================================
; AUXILIARY VARIABLES 
; ==================================================================
deterministic        EQU #CB2D   ; Deterministic mode flag

; ==================================================================
; TEMPORARY VARIABLES (ALWAYS NEEDED)
; ==================================================================
temp_word_1         EQU #CB2E   ; Temporary 16-bit storage
temp_word_2         EQU #CB30   ; Temporary 16-bit storage
temp_byte_1         EQU #CB32   ; Temporary 8-bit storage
temp_byte_2         EQU #CB33   ; Temporary 8-bit storage
temp_byte_3         EQU #CB34   ; Temporary 8-bit storage (32 bytes)
temp_byte_4         EQU #CB54   ; Temporary 8-bit storage (32 bytes)
temp_byte_5         EQU #CB74   ; Temporary 8-bit storage (32 bytes)
temp_byte_6         EQU #CB94   ; Temporary 8-bit storage (32 bytes)
temp_byte_7         EQU #CBB4   ; Temporary 8-bit storage (32 bytes)
temp_byte_8         EQU #CBD4   ; Temporary 8-bit storage (32 bytes)
temp_byte_9         EQU #CBF4   ; Temporary 8-bit storage (32 bytes)
temp_byte_10        EQU #CC14   ; Temporary 8-bit storage (32 bytes)
temp_byte_11        EQU #CC34   ; Temporary 8-bit storage (32 bytes)
temp_byte_12        EQU #CC54   ; Temporary 8-bit storage (32 bytes)
temp_byte_13        EQU #CC74   ; Temporary 8-bit storage (32 bytes)
temp_byte_14        EQU #CC94   ; Temporary 8-bit storage (32 bytes)
temp_byte_15        EQU #CCB4   ; Temporary 8-bit storage (32 bytes)
temp_byte_16        EQU #CCD4   ; Temporary 8-bit storage (32 bytes)
temp_byte_17        EQU #CCF4   ; Temporary 8-bit storage (32 bytes)
temp_byte_18        EQU #CD14   ; Temporary 8-bit storage (32 bytes)
temp_byte_19        EQU #CD34   ; Temporary 8-bit storage (32 bytes)
temp_byte_20        EQU #CD54   ; Temporary 8-bit storage (32 bytes)
temp_byte_21        EQU #CD74   ; Temporary 8-bit storage (32 bytes)
temp_byte_22        EQU #CD94   ; Temporary 8-bit storage (32 bytes)
temp_byte_23        EQU #CDB4   ; Temporary 8-bit storage (32 bytes)
temp_byte_24        EQU #CDD4   ; Temporary 8-bit storage (32 bytes)
temp_byte_25        EQU #CDF4   ; Temporary 8-bit storage (32 bytes)
temp_word_3         EQU #CE14   ; Temporary 16-bit storage (64 bytes)
temp_word_4         EQU #CE54   ; Temporary 16-bit storage (64 bytes)

; Wall collision temporary variables
wall_temp_x         EQU #CE94   ; Cached entity X for wall checks
wall_temp_y         EQU #CE95   ; Cached entity Y for wall checks
wall_hit_left       EQU #CE96   ; Hitbox left edge cache
wall_hit_top        EQU #CE97   ; Hitbox top edge cache
wall_hit_right      EQU #CE98   ; Hitbox right edge cache
wall_hit_bottom     EQU #CE99   ; Hitbox bottom edge cache
wall_hit_w          EQU #CE9A   ; Hitbox width cache (min 1)
wall_hit_h          EQU #CE9B   ; Hitbox height cache (min 1)
wall_probe_left     EQU #CE9C   ; X probe near hitbox left (adaptive inset)
wall_probe_right    EQU #CE9D   ; X probe near hitbox right (adaptive inset)
wall_probe_top      EQU #CE9E   ; Y probe near hitbox top (adaptive inset)
wall_probe_bottom   EQU #CE9F   ; Y probe near hitbox bottom (adaptive inset)

; Unified update helpers
active_entity_list  EQU #CEA0   ; Entity indices with non-zero component masks (MAX_ENTITIES bytes)
active_entity_count EQU #CEC0   ; Number of entries in active_entity_list
active_entity_list_dirty EQU #CEC1   ; 1=rebuild active_entity_list required

; Entity-entity collision optimized variables
coll_list           EQU #CEC2   ; Active collidable entity indices (MAX_ENTITIES bytes)
coll_list_count     EQU #CEE2   ; Number of entities in coll_list
coll_src_left       EQU #CEE3   ; Source AABB left edge (scratch)
coll_src_right      EQU #CEE4   ; Source AABB right edge (scratch)
coll_src_top        EQU #CEE5   ; Source AABB top edge (scratch)
coll_src_bottom     EQU #CEE6   ; Source AABB bottom edge (scratch)

; ==================================================================
; INTERRUPT SYSTEM VARIABLES (dynamically allocated)
; ==================================================================
task_table              EQU #CEE7   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #CEE7   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #CEE9   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #CEEB   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #CEED   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #CEEF   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #CEF1   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #CEF3   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #CEF5   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #CEF7   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #CEF8   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #CEFD   ; Frame counter (16-bit)
task_exec_time          EQU #CEFF   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #CF01   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #CF02   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #CF02   ; End of project variables (3842 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#CF02: Project variables (3842 bytes)
;   #CF02-#F37F: Free RAM (~9342 bytes available)
...
SCREEN_PAN1_0_LAYOUT:
    ...
    DB #95,#84,#69,#00,#57,#D5,#80,#A5,#80,#5B,#82,#96,#E6,#F1,#86,#F6
    DB #FE,#FE,#80,#5E,#E7,#E0,#81,#FC,#E1,#80,#7A,#E7,#83,#F5,#FE,#E4
    DB #00,#1F,#FE,#59,#BC,#86,#87,#86,#80,#5D,#FC,#F2,#80,#5D,#FD,#E7
    DB #FD,#00,#0B,#85,#60,#5A,#F1,#C0,#3E,#79,#FC,#F4,#80,#3D,#40,#1F
    DB #85,#D5,#00,#CF,#28,#D5,#40,#FF,#F0,#FC,#4E,#C0,#FE,#F0,#40,#56
    DB #9D,#82,#F9,#88,#A8,#F5,#3A,#F8,#DF,#80,#7B,#FC,#D4,#80,#FF,#FC
    DB #C0,#5E,#80,#1E,#FC,#53,#F3,#CB,#80,#94,#FC,#F8,#CB,#80,#D5,#55
    DB #60
...
SCREEN_PAN2_1_LAYOUT:
    ...
    DB #80,#00,#11,#08,#E3,#81,#80,#FC,#FE,#EA,#F5,#FC,#12,#25,#83,#82
...
; Free RAM buffer for tile pattern data decompression (64 bytes)
; ==================================================================
ZX0_TILE_PATTERN_BUFFER EQU #D600

; ==================================================================
; ZX0 TILE COLOR BUFFER (AUTO-INJECTED)
; Free RAM buffer for tile color data decompression (64 bytes)
; ==================================================================
