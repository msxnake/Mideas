...
; Flow: Start → WorldLink (gfn_1766756993852)
; ==================================================================
...
>
    ...
    ld bc, #E201
    call FAST_WRTVDP
    ; After setting screen mode, you MUST set:
    ; VDP R#5 = SAT base address >> 7  →  #1B00 >> 7 = #36
    ld bc, #3605
    call FAST_WRTVDP

    ; VDP R#6 = Pattern base address >> 6 → #3800 >> 6 = #E0, but only 7 bits → #70
    ld bc, #7006
    call FAST_WRTVDP
...
;   Active entities: 1
;   Used components: Position, Sprite, Input, Cursors
...
; Initialize component systems(OPTIMIZED - only used components) 
    ; Used: Position, Sprite, Input, Cursors 
...
SPRITE_PUNT_MIRA1_0_WIDTH     EQU 16
SPRITE_PUNT_MIRA1_0_HEIGHT    EQU 16
SPRITE_PUNT_MIRA1_0_FRAMES    EQU 1

;; ---- Sprite Frame: punt_mira1_0_F0 ----
;; Size: 16x16
PUNT_MIRA1_0_F0_LAYER1: ; Brush Color Index 1 (Actual Color: #FFFFFF)
    DB #00,#00,#00,#01,#01,#01,#0F,#1E,#0F,#01,#01,#01,#00,#00,#00,#00
    DB #00,#00,#80,#C0,#C0,#C0,#78,#3C,#78,#C0,#C0,#C0,#80,#00,#00,#00

PUNT_MIRA1_0_F0_LAYER2: ; Brush Color Index 2 (Actual Color: #FF0000)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

PUNT_MIRA1_0_F0_LAYER3: ; Brush Color Index 3 (Actual Color: #00FF00)
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

;; ---- End of Frame: punt_mira1_0_F0 ----


; Unified pattern label for sprite 0
SPRITE_0_PATTERN EQU PUNT_MIRA1_0_F0_LAYER1
...
; Sprite 0: punt_mira1 frame pointers
SPRITE_0_FRAME_PTRS:
    dw PUNT_MIRA1_0_F0_LAYER1
...
load_screen_new_screenmap_766756894972:
...
ENTITY_PLAYER_1_COMP_MASK EQU #13  ; Component mask: 00010011b
...
init_player_1:
    ...
    ; Template: tpl_player
    ; Components: Position, Sprite, Input
...
; Total Nodes: 3
; Total Connections: 2
; Start Node: gf_start_1766756988396
;
; ARCHITECTURE:
...
gameflow_start:
    ; Load the Start node
    ld hl, gameflow_node_gf_start_1766756988396
...
; Node: Start - "gf_start_1766756988396"
gameflow_node_gf_start_1766756988396:
    db NODE_TYPE_START
    dw gameflow_no_data
    dw gameflow_node_gf_start_1766756988396_conn

gameflow_node_gf_start_1766756988396_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1766756993852
    db CONNECTION_END

; Node: WorldLink - "gfn_1766756993852"
gameflow_node_gfn_1766756993852:
    db NODE_TYPE_WORLD_LINK
    dw gameflow_node_gfn_1766756993852_data
    dw gameflow_node_gfn_1766756993852_conn

gameflow_node_gfn_1766756993852_data:
    dw load_world_worldmap_1766756973757

gameflow_node_gfn_1766756993852_conn:
    db CONNECTION_DEFAULT
    dw gameflow_node_gfn_1766757008043
    db CONNECTION_END

; Node: Restart - "Game Over"
gameflow_node_gfn_1766757008043:
    db NODE_TYPE_RESTART
    dw gameflow_no_data
    dw gameflow_node_gfn_1766757008043_conn

gameflow_node_gfn_1766757008043_conn:
    db CONNECTION_DEFAULT
    dw 0
    db CONNECTION_END
...
; World: New Worldmap (worldmap_1766756973757)
...
; World ID: worldmap_1766756973757
; Screens: 1
; Start Screen Node: wmnode_1766756977055
; ------------------------------------------------------------------
load_world_worldmap_1766756973757:
    ; Load start screen: New Screenmap (screenmap_1766756894972)
    call load_screen_new_screenmap_766756894972
