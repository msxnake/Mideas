var _a, _b;
import { EFFECT_ZONE_FLAGS as EFFECT_ZONE_FLAGS_TYPE } from './types';
...
export const DEFAULT_SCREEN2_FG_COLOR = ((_a = MSX1_PALETTE.find(c => c.index === DEFAULT_SCREEN2_FG_COLOR_INDEX)) === null || _a === void 0 ? void 0 : _a.hex) || MSX1_PALETTE[15].hex;
/** The default background color hex value for SCREEN 2. */
export const DEFAULT_SCREEN2_BG_COLOR = ((_b = MSX1_PALETTE.find(c => c.index === DEFAULT_SCREEN2_BG_COLOR_INDEX)) === null || _b === void 0 ? void 0 : _b.hex) || MSX1_PALETTE[1].hex;
