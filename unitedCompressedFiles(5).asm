...
; BANK 08 @#0000 : statemachine.asm part 4/3 (772 bytes)
; BANK 08 @#0304 : gameflow.asm part 1/3 (7420 bytes)
; BANK 09 @#0000 : gameflow.asm part 2/3 (8192 bytes)
; BANK 10 @#0000 : gameflow.asm part 3/3 (1065 bytes)
...
Action_ChangeSprite:
    ...
    ; Clear ANIM_FLAG_COMPLETED and set ANIM_FLAG_PLAYING on sprite change
    ld hl, entity_anim_flags
    add hl, bc
    ld a, (hl)
...
SM_New_Statemachine_state_1771533538995: 
    ...
    DW 0 
    DW 0 
    DW SM_New_Statemachine_state_1771533538995_Transitions 
SM_New_Statemachine_state_1771533538995_Transitions: 
    DB 1; Count
    DB 4; KEY_PRESSED 
    DB 9          ; Key: space
    DW SM_New_Statemachine_state_1771533526010 
    DW SM_New_Statemachine_state_1771533538995_Transitions_Actions_0 
SM_New_Statemachine_state_1771533538995_Transitions_Actions_0: 
    DB 1; SET_POSITION 
    DB 32, 128 
    DB 0xFF; END
