...
bitmap_bullet_pool     EQU #C0D9
bitmap_shoot_cooldown  EQU #C0E5
bitmap_shoot_lock      EQU #C0E6
    org #4000
...
; INPUT: none. OUTPUT: SAT entries at VRAM #F608 onwards.
