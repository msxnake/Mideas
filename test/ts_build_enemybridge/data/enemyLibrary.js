...
exports.createEmptyEnemyDefinition = exports.createEnemyFromTemplate = exports.GLOBAL_ENEMY_TEMPLATES = void 0;
exports.GLOBAL_ENEMY_TEMPLATES = [
    {
...
const defaultHitbox = (x, y, w, h) => ({ x, y, w, h });
const createEnemyFromTemplate = (template, options = {}) => {
...
exports.createEnemyFromTemplate = createEnemyFromTemplate;
const createEmptyEnemyDefinition = (existingIds = new Set()) => {
    const schema = [
        { name: 'p0', label: 'Param 0', type: 'byte', default: 0, min: 0, max: 255, exportParam: 'p0' },
    ];
    return {
        ...(0, exports.createEnemyFromTemplate)({
...
exports.createEmptyEnemyDefinition = createEmptyEnemyDefinition;
