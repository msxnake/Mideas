...
; Project: msx2_bitmap_room_smoke
...
hud_dec3_buffer EQU #C0E9
; Linked HUD counter #0 (el_gems), bound to "collectibles" [8-bit, 3 digits].
hud_linked_0_drawn EQU #C0E7
hud_linked_0_value EQU #C0E8
; Key/items + locked doors system (SCREEN 5 bitmap). RAM follows skills/HUD chain.
bitmap_key_inventory       EQU #C0EC
bitmap_key_pending_entry_x EQU #C0ED
bitmap_key_pending_entry_y EQU #C0EE
bitmap_key_work_mask       EQU #C0EF
bitmap_key_work_offset     EQU #C0F0
bitmap_key_target_page     EQU #C0F1
bitmap_key_probe_x         EQU #C0F2
bitmap_key_probe_y         EQU #C0F3
bitmap_key_keys            EQU #C0F4
bitmap_key_up_lock         EQU #C0F5
bitmap_key_work_price      EQU #C0F6
bitmap_key_pickup_flags    EQU #C0F7
bitmap_key_door_open_flags EQU #C0F9
...
init_rom:
    ...
    ; UP lock starts armed: a held UP at boot must be released before it can act.
    ld a, 1
...
.skip_player_movement:
    ...
    call update_hud_linked_0    ; redraw linked HUD counter #0 (el_gems)
...
; ------------------------------------------------------------
; PURPOSE:
;   Numeric counter widget for linked HUD element "el_gems": 3
;   zero-padded decimal digit(s) at x=8, y=4, redrawn only when
;   hud_linked_0_value changes (dirty-flag). 8-bit value via hud_byte_to_dec3.
...
bitmap_update_key_doors:
    ...
    or a
    ret nz
    ; Capture the PPI row-8 pressed mask once per frame (UP=#20). Releasing UP
...
.key_door_loop:
    ...
    inc hl
    ld (bitmap_key_work_offset), a
    ; "Enter with UP" doors: ignore the touch entirely (no key consume, no
...
start_key_door_transition:
    ; Arm the UP lock on every door transition: if the player lands on another
...
; Raw bytes: 2048; encoded bytes: 886
; VRAM #10000, raw 2048 bytes, RLE 886 bytes
bitmap_room_tileset_rle_chunk_0:
    ...
    DB #02,#FF,#01,#F1,#40,#00,#01,#18,#03,#88,#01,#18,#02,#88,#01,#81
    DB #01,#19,#03,#99,#01,#19,#02,#99,#01,#91,#01,#1A,#03,#AA,#01,#1A
    DB #02,#AA,#01,#A1,#01,#1C,#03,#CC,#01,#1C,#02,#CC,#01,#C1,#01,#17
    DB #03,#77,#01,#17,#02,#77,#01,#71,#01,#15,#03,#55,#01,#15,#02,#55
    DB #01,#51,#01,#1D,#03,#DD,#01,#1D,#02,#DD,#01,#D1,#01,#1F,#03,#FF
    DB #01,#1F,#02,#FF,#01,#F1,#40,#00,#01,#18,#03,#88,#01,#18,#02,#88
    DB #01,#81,#01,#19,#03,#99,#01,#19,#02,#99,#01,#91,#01,#1A,#03,#AA
    DB #01,#1A,#02,#AA,#01,#A1,#01,#1C,#03,#CC,#01,#1C,#02,#CC,#01,#C1
    DB #01,#17,#03,#77,#01,#17,#02,#77,#01,#71,#01,#15,#03,#55,#01,#15
    DB #02,#55,#01,#51,#01,#1D,#03,#DD,#01,#1D,#02,#DD,#01,#D1,#01,#1F
    DB #03,#FF,#01,#1F,#02,#FF,#01,#F1,#40,#00,#01,#18,#03,#88,#01,#18
    ...
    DB #01,#1F,#03,#FF,#01,#1F,#02,#FF,#01,#F1,#40,#00,#01,#18,#03,#88
    DB #01,#18,#02,#88,#01,#81,#01,#19,#03,#99,#01,#19,#02,#99,#01,#91
    DB #01,#1A,#03,#AA,#01,#1A,#02,#AA,#01,#A1,#01,#1C,#03,#CC,#01,#1C
    DB #02,#CC,#01,#C1,#01,#17,#03,#77,#01,#17,#02,#77,#01,#71,#01,#15
    DB #03,#55,#01,#15,#02,#55,#01,#51,#01,#1D,#03,#DD,#01,#1D,#02,#DD
    DB #01,#D1,#01,#1F,#03,#FF,#01,#1F,#02,#FF,#01,#F1,#40,#00,#01,#18
    DB #03,#88,#01,#18,#02,#88,#01,#81,#01,#19,#03,#99,#01,#19,#02,#99
    DB #01,#91,#01,#1A,#03,#AA,#01,#1A,#02,#AA,#01,#A1,#01,#1C,#03,#CC
    DB #01,#1C,#02,#CC,#01,#C1,#01,#17,#03,#77,#01,#17,#02,#77,#01,#71
    DB #01,#15,#03,#55,#01,#15,#02,#55,#01,#51,#01,#1D,#03,#DD,#01,#1D
    DB #02,#DD,#01,#D1,#01,#1F,#03,#FF,#01,#1F,#02,#FF,#01,#F1,#40,#00
    ...
    DB #40,#00,#40,#11,#40,#00,#01,#18,#06,#88,#01,#81,#01,#19,#06,#99
    DB #01,#91,#01,#1A,#06,#AA,#01,#A1,#01,#1C,#06,#CC,#01,#C1,#01,#17
    DB #06,#77,#01,#71,#01,#15,#06,#55,#01,#51,#01,#1D,#06,#DD,#01,#D1
    DB #01,#1F,#06,#FF,#01,#F1,#40,#00,#01,#18,#06,#88,#01,#81,#01,#19
    DB #06,#99,#01,#91,#01,#1A,#06,#AA,#01,#A1,#01,#1C,#06,#CC,#01,#C1
    DB #01,#17,#06,#77,#01,#71,#01,#15,#06,#55,#01,#51,#01,#1D,#06,#DD
    DB #01,#D1,#01,#1F,#06,#FF,#01,#F1,#40,#00,#01,#18,#06,#88,#01,#81
    DB #01,#19,#06,#99,#01,#91,#01,#1A,#06,#AA,#01,#A1,#01,#1C,#06,#CC
    DB #01,#C1,#01,#17,#06,#77,#01,#71,#01,#15,#06,#55,#01,#51,#01,#1D
    DB #06,#DD,#01,#D1,#01,#1F,#06,#FF,#01,#F1,#40,#00,#01,#18,#06,#88
    DB #01,#81,#01,#19,#06,#99,#01,#91,#01,#1A,#06,#AA,#01,#A1,#01,#1C
    DB #06,#CC,#01,#C1,#01,#17,#06,#77,#01,#71,#01,#15,#06,#55,#01,#51
    DB #01,#1D,#06,#DD,#01,#D1,#01,#1F,#06,#FF,#01,#F1,#40,#00,#01,#18
    DB #06,#88,#01,#81,#01,#19,#06,#99,#01,#91,#01,#1A,#06,#AA,#01,#A1
    DB #01,#1C,#06,#CC,#01,#C1,#01,#17,#06,#77,#01,#71,#01,#15,#06,#55
    DB #01,#51,#01,#1D,#06,#DD,#01,#D1,#01,#1F,#06,#FF,#01,#F1,#40,#00
    DB #01,#18,#06,#88,#01,#81,#01,#19,#06,#99,#01,#91,#01,#1A,#06,#AA
    DB #01,#A1,#01,#1C,#06,#CC,#01,#C1,#01,#17,#06,#77,#01,#71,#01,#15
    DB #06,#55,#01,#51,#01,#1D,#06,#DD,#01,#D1,#01,#1F,#06,#FF,#01,#F1
    DB #40,#00,#40,#11,#40,#00
...
bitmap_room_hud_linked_0_rle_chunk_0:
    DB #01,#11,#02,#BB,#02,#11,#01,#1B,#01,#B1,#02,#11,#02,#BB,#02,#11
    DB #02,#BB,#03,#11,#01,#BB,#01,#11,#01,#1B,#02,#BB,#01,#B1,#01,#11
    DB #01,#1B,#01,#BB,#01,#11,#01,#1B,#02,#BB,#01,#B1,#01,#11,#02,#BB
    DB #02,#11,#02,#BB,#01,#11,#58,#00,#01,#1B,#01,#B1,#01,#1B,#01,#B1
    DB #01,#11,#01,#BB,#01,#B1,#01,#11,#01,#1B,#01,#B1,#01,#1B,#01,#B1
    DB #01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#11,#01,#1B,#01,#BB,#01,#11
    DB #01,#1B,#01,#B1,#03,#11,#01,#BB,#04,#11,#01,#1B,#01,#B1,#01,#1B
    DB #01,#B1,#01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#1B,#01,#B1,#58,#00
    DB #01,#1B,#01,#B1,#01,#BB,#01,#B1,#01,#11,#01,#1B,#01,#B1,#03,#11
    DB #01,#1B,#01,#B1,#02,#11,#01,#1B,#01,#B1,#01,#11,#02,#BB,#01,#11
    DB #01,#1B,#02,#BB,#01,#11,#01,#1B,#01,#B1,#04,#11,#01,#BB,#01,#11
    DB #01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#1B,#01,#B1
    DB #58,#00,#01,#1B,#01,#BB,#01,#1B,#01,#B1,#01,#11,#01,#1B,#01,#B1
    DB #02,#11,#01,#1B,#01,#BB,#02,#11,#01,#1B,#01,#BB,#01,#11,#01,#1B
    DB #01,#B1,#01,#BB,#03,#11,#01,#1B,#01,#B1,#01,#1B,#02,#BB,#02,#11
    DB #01,#1B,#01,#B1,#02,#11,#02,#BB,#02,#11,#02,#BB,#01,#B1,#58,#00
    DB #01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#11,#01,#1B,#01,#B1,#02,#11
    DB #01,#BB,#04,#11,#01,#1B,#01,#B1,#01,#1B,#02,#BB,#01,#B1,#02,#11
    DB #01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#11,#01,#BB
    DB #02,#11,#01,#1B,#01,#B1,#01,#1B,#01,#B1,#02,#11,#01,#1B,#01,#B1
    DB #58,#00,#01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#11,#01,#1B,#01,#B1
    DB #01,#11,#01,#1B,#01,#B1,#02,#11,#01,#1B,#01,#B1,#01,#1B,#01,#B1
    DB #02,#11,#01,#BB,#01,#11,#01,#1B,#01,#B1,#01,#1B,#01,#B1,#01,#1B
    DB #01,#B1,#01,#1B,#01,#B1,#01,#11,#01,#BB,#02,#11,#01,#1B,#01,#B1
    DB #01,#1B,#01,#B1,#02,#11,#01,#BB,#01,#11,#58,#00,#01,#11,#02,#BB
    DB #01,#11,#01,#1B,#02,#BB,#01,#B1,#01,#1B,#02,#BB,#01,#B1,#01,#11
    DB #02,#BB,#03,#11,#01,#BB,#02,#11,#02,#BB,#02,#11,#02,#BB,#02,#11
    DB #01,#BB,#03,#11,#02,#BB,#02,#11,#01,#BB,#01,#B1,#01,#11,#58,#00
    DB #28,#11,#58,#00
...
; Room 0 key pickup records: x,y,keyMask,pickupFlagOffset,gemPrice
bitmap_key_pickups_room_0:
    DB #20,#80,#01,#00,#00,#50,#B0,#02,#01,#02
; Room 1 key pickup records: x,y,keyMask,pickupFlagOffset,gemPrice
...
bitmap_key_doors_room_0:
    DB #C0,#B0,#10,#10,#00,#01,#30,#80,#0A,#00
