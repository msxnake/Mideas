...
bitmap_jumper_timer       EQU #C0DA
bitmap_jumper_target_page EQU #C0DB
bitmap_jumper_active      EQU #C0DC
...
init_rom:
    ...
    ; jumper springs: clear revert timer + active record pointer.
    xor a
...
bitmap_jumpers_room_0:
    DB #30,#B0,#FA,#40,#00,#00,#02,#30,#00,#C4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#60,#00,#00,#02,#30,#00,#C4,#00,#10,#00,#10,#00,#00,#00
    DB #D0
