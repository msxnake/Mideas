...
; Wall-jumper springs (SCREEN 5 bitmap): 2 wall-spring(s). RAM follows the jumper-spring chain.
bitmap_walljumper_timer       EQU #C0E7
bitmap_walljumper_target_page EQU #C0E8
bitmap_walljumper_active      EQU #C0E9
...
bitmap_walljumpers_room_0:
    DB #A0,#50,#F8,#00,#00,#00,#00,#00,#A0,#00,#64,#00,#10,#00,#10,#00
    DB #11,#00,#C0,#00,#00,#00,#00,#A0,#00,#64,#00,#10,#00,#10,#00,#11
    DB #00,#C0,#40,#70,#0A,#01,#00,#00,#00,#00,#40,#00,#84,#00,#10,#00
    DB #10,#00,#11,#00,#C0,#00,#00,#00,#00,#40,#00,#84,#00,#10,#00,#10
    DB #00,#11,#00,#C0
