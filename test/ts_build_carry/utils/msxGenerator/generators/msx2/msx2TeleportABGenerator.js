...
exports.MSX2_TELEPORT_AB_RAM_BYTES = void 0;
exports.resolveMsx2TeleportABRamBase = resolveMsx2TeleportABRamBase;
exports.buildMsx2TeleportABEquates = buildMsx2TeleportABEquates;
exports.buildMsx2TeleportABRuntimeAsm = buildMsx2TeleportABRuntimeAsm;
exports.buildMsx2TeleportABInputGateAsm = buildMsx2TeleportABInputGateAsm;
exports.buildMsx2TeleportABDamageSkipAsm = buildMsx2TeleportABDamageSkipAsm;
exports.buildMsx2TeleportABHazardSkipAsm = buildMsx2TeleportABHazardSkipAsm;
exports.buildMsx2TeleportABInitClearAsm = buildMsx2TeleportABInitClearAsm;
...
exports.MSX2_TELEPORT_AB_RAM_BYTES = 8;
...
function resolveMsx2TeleportABRamBase(pushBoxMovement, dashEnabled) {
    return (0, msx2SkillRamLayout_1.resolveMsx2SkillExtensionRamBase)((0, msx2SkillRamLayout_1.buildMsx2SkillRamOptions)(pushBoxMovement, dashEnabled, false, false, false));
}
function buildTeleportPressedRoutine(config) {
    return (0, msx2SkillControlsGenerator_1.buildMsx2SkillPressedRoutine)('msx2_control_teleport_pressed', 'teleport skill', config.primaryControl, config.secondaryControl);
}
function buildMsx2TeleportABEquates(ramBase) {
...
function buildMsx2TeleportABRuntimeAsm(config) {
    if (!config.enabled)
        return '';
...
function buildMsx2TeleportABInputGateAsm(config) {
    if (!config.enabled)
        return '';
    return `    call msx2_try_teleport_ab
`;
}
function buildMsx2TeleportABDamageSkipAsm(config) {
    if (!config.enabled)
        return '';
...
function buildMsx2TeleportABHazardSkipAsm(config) {
    if (!config.enabled)
        return '';
    return `    ld a, (msx2_teleport_delay)
    or a
...
function buildMsx2TeleportABInitClearAsm() {
    return `    xor a
    ld (msx2_teleport_cooldown), a
    ld (msx2_teleport_delay), a
    ld (msx2_teleport_lock), a
