...
msx2_dash_timer EQU #C079
msx2_dash_cooldown EQU #C07A
msx2_dash_lock EQU #C07B
msx2_dash_direction EQU #C07C
msx2_teleport_cooldown EQU #C07D
msx2_teleport_delay EQU #C07E
msx2_teleport_lock EQU #C07F
msx2_teleport_flags EQU #C080
msx2_teleport_ax EQU #C081
msx2_teleport_ay EQU #C082
msx2_teleport_bx EQU #C083
msx2_teleport_by EQU #C084
MSX2_TELEPORT_FLAG_HAS_A EQU #01
MSX2_TELEPORT_FLAG_HAS_B EQU #02
MSX2_TELEPORT_FLAG_TARGET_B EQU #04
msx2_glide_stamina EQU #C085
msx2_glide_active EQU #C086
...
msx2_control_dash_pressed:
    ; ------------------------------------------------------------
    ; FUNCTION: msx2_control_dash_pressed
    ; PURPOSE: A=1 when the configured dash skill input combo is held.
...
msx2_control_teleport_pressed:
    ; ------------------------------------------------------------
    ; FUNCTION: msx2_control_teleport_pressed
    ; PURPOSE: A=1 when the configured teleport skill input combo is held.
    ; INPUT: none (reads joystick/keyboard via BIOS).
    ; OUTPUT: A=1 pressed, A=0 not pressed (Z set when not pressed).
    ; DESTROYS: AF, BC, DE (GTSTCK / msx2_read_control_buttons BIOS paths).
    ; PRESERVES: HL, IX, IY.
...
.teleport_to_a:
    ...
    ld c, a
    call msx2_teleport_distance_ok_bc
    or a
    jp z, .teleport_done
