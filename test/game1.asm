...
; ==================================================================
task_table              EQU #C72C   ; Task table base (8 slots x 2 bytes = 16 bytes)
task_0_ptr              EQU #C72C   ; Slot 0 pointer (2 bytes)
task_1_ptr              EQU #C72E   ; Slot 1 pointer (2 bytes)
task_2_ptr              EQU #C730   ; Slot 2 pointer (2 bytes)
task_3_ptr              EQU #C732   ; Slot 3 pointer (2 bytes)
task_4_ptr              EQU #C734   ; Slot 4 pointer (2 bytes)
task_5_ptr              EQU #C736   ; Slot 5 pointer (2 bytes)
task_6_ptr              EQU #C738   ; Slot 6 pointer (2 bytes)
task_7_ptr              EQU #C73A   ; Slot 7 pointer (2 bytes)
interrupt_system_enabled EQU #C73C   ; 0=disabled, 1=enabled (1 byte)
old_htimi_hook          EQU #C73D   ; Original H.TIMI hook (5 bytes)
interrupt_counter       EQU #C742   ; Frame counter (16-bit)
task_exec_time          EQU #C744   ; Cycles used by tasks (16-bit, debug)
vblank_flag             EQU #C746   ; Set to 1 on each VBlank (1 byte)
RAM_INTERRUPT_END       EQU #C747   ; End of interrupt system

; ==================================================================
; END OF VARIABLES
; ==================================================================
RAM_USAGE_END       EQU #C747   ; End of project variables (1863 bytes used)

; ==================================================================
; MEMORY LAYOUT INFO (Reference only - no code generated)
; ==================================================================
; RAM Layout:
;   #C000-#C747: Project variables (1863 bytes)
;   #C747-#F37F: Free RAM (~11321 bytes available)
