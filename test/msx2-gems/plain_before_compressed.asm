...
bitmap_dlg_cfg             EQU #C0ED
bitmap_dlg_cfg_box_x       EQU #C0ED
bitmap_dlg_cfg_box_y       EQU #C0EE
bitmap_dlg_cfg_box_w       EQU #C0EF
bitmap_dlg_cfg_box_h       EQU #C0F0
bitmap_dlg_cfg_border_clr  EQU #C0F1
bitmap_dlg_cfg_bg_clr      EQU #C0F2
bitmap_dlg_cfg_delay       EQU #C0F3
bitmap_dlg_cfg_mouth_int   EQU #C0F4
bitmap_dlg_cfg_text_x      EQU #C0F5
bitmap_dlg_cfg_text_y      EQU #C0F6
bitmap_dlg_cfg_text_w      EQU #C0F7
bitmap_dlg_cfg_text_h      EQU #C0F8
bitmap_dlg_cfg_strip_sy    EQU #C0F9
bitmap_dlg_cfg_por_x       EQU #C0FB
bitmap_dlg_cfg_por_y       EQU #C0FC
bitmap_dlg_cfg_por_max_w   EQU #C0FD
bitmap_dlg_cfg_por_max_h   EQU #C0FE
bitmap_dlg_cfg_line_base   EQU #C0FF
bitmap_dlg_cfg_line_count  EQU #C100
bitmap_dlg_state           EQU #C101
bitmap_dlg_lock            EQU #C102
bitmap_dlg_line            EQU #C103
bitmap_dlg_lines_left      EQU #C104
bitmap_dlg_text_ptr        EQU #C105
bitmap_dlg_delay           EQU #C107
bitmap_dlg_mouth_count     EQU #C108
bitmap_dlg_mouth_state     EQU #C109
bitmap_dlg_portrait        EQU #C10A
bitmap_dlg_cursor_x        EQU #C10B
bitmap_dlg_cursor_y        EQU #C10C
bitmap_dlg_key_mask        EQU #C10D
bitmap_dlg_wait_flags      EQU #C10E
bitmap_dlg_scratch_idx     EQU #C10F
