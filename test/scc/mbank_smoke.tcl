# Multi-bank music smoke for test139_mbank.rom (music data split across TWO
...
#     -carta out/test139_mbank.rom -romtype KonamiSCC -script ../mbank_smoke.tcl
...
set result_path "C:/Users/salam/Documents/Programacion/Mideas/test/scc/mbank_result.txt"
set lines [list]
...
after time 16.0 {
    ...
    if {[rd 0xC400] == 1 && [rd 0xC404] == 1 && [rd 0xC4DD] == 1 && $bank == 16 \
        && ($scc_row != $::snap_scc_row || $psg_row != $::snap_psg_row)} { set verdict "OK" }
