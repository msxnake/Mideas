...
function generateVariablesFile(analysis, romMode = 'simple32k') {
    ...
    const runtimeSecretRestoreBufferSize = (0, runtimeLayoutPolicy_1.getRuntimeSecretRestoreBufferSize)(analysis);
...
`;
    ...
    currentAddress += 32 * 4;
    const screenRuntimeCount = Math.max(Array.isArray(analysis.screenMaps) ? analysis.screenMaps.length : 0, Array.isArray(analysis.msx2Screens) ? analysis.msx2Screens.length : 0);
