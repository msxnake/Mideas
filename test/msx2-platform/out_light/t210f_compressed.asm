...
; World rooms: 7; start room index: 1
; Shared tileset bytes: 6144 at VRAM #10000
...
bitmap_room_hud_heart_rle_chunk_0_DATA_BANK EQU 4
bitmap_room_render_0_p0_DATA_BANK EQU 4
bitmap_room_render_0_p1_DATA_BANK EQU 4
bitmap_room_collision_0_DATA_BANK EQU 4
bitmap_room_behavior_0_DATA_BANK EQU 4
bitmap_room_render_1_p0_DATA_BANK EQU 4
bitmap_room_render_1_p1_DATA_BANK EQU 4
bitmap_room_collision_1_DATA_BANK EQU 4
...
bitmap_room_render_3_p0_DATA_BANK EQU 5
bitmap_room_render_3_p1_DATA_BANK EQU 5
bitmap_room_collision_3_DATA_BANK EQU 5
bitmap_room_behavior_3_DATA_BANK EQU 5
bitmap_room_render_4_p0_DATA_BANK EQU 5
bitmap_room_render_4_p1_DATA_BANK EQU 5
bitmap_room_collision_4_DATA_BANK EQU 5
bitmap_room_behavior_4_DATA_BANK EQU 5
bitmap_room_render_5_p0_DATA_BANK EQU 5
bitmap_room_render_5_p1_DATA_BANK EQU 5
bitmap_room_collision_5_DATA_BANK EQU 5
bitmap_room_behavior_5_DATA_BANK EQU 5
bitmap_room_render_6_p0_DATA_BANK EQU 5
bitmap_room_render_6_p1_DATA_BANK EQU 6
bitmap_room_collision_6_DATA_BANK EQU 6
bitmap_room_behavior_6_DATA_BANK EQU 6
...
bitmap_sm_state EQU #C0FC
bitmap_light_x                 EQU #C0FD
bitmap_light_y                 EQU #C0FE
bitmap_light_tx                EQU #C0FF
bitmap_light_ty                EQU #C100
bitmap_light_active            EQU #C101
bitmap_light_page              EQU #C102
bitmap_light_op_clr            EQU #C103
bitmap_light_op_cmd            EQU #C104
bitmap_light_d                 EQU #C105
bitmap_light_xsign             EQU #C106
bitmap_light_xadj              EQU #C107
bitmap_light_ybias             EQU #C108
bitmap_light_rx                EQU #C109
bitmap_light_ry                EQU #C10A
bitmap_light_rw                EQU #C10B
bitmap_light_rh                EQU #C10D
bitmap_light_band_y            EQU #C10E
bitmap_light_band_h            EQU #C10F
bitmap_light_band_hw           EQU #C110
bitmap_light_on                EQU #C111
bitmap_light_stage             EQU #C112
bitmap_light_timer             EQU #C113
bitmap_light_bands_ptr         EQU #C115
bitmap_light_sdown_ptr         EQU #C117
bitmap_light_sdown_n           EQU #C119
bitmap_light_sup_ptr           EQU #C11A
bitmap_light_sup_n             EQU #C11C
bitmap_light_cxmin             EQU #C11D
bitmap_light_cxmax             EQU #C11E
bitmap_mush_cx                 EQU #C11F
bitmap_mush_cy                 EQU #C120
bitmap_light_srx               EQU #C121
bitmap_light_sry               EQU #C122
bitmap_light_srw               EQU #C123
bitmap_light_srh               EQU #C124
bitmap_light_tx0               EQU #C125
bitmap_light_ty0               EQU #C126
bitmap_light_tw                EQU #C127
bitmap_light_th                EQU #C128
bitmap_mush_ex                 EQU #C129
bitmap_mush_ey                 EQU #C12A
bitmap_mush_flag               EQU #C12B
bitmap_mush_sx                 EQU #C12C
bitmap_mush_sy                 EQU #C12D
bitmap_light_protect           EQU #C12F
bitmap_mush_flags              EQU #C130
; --- MOVING PLATFORM runtime state (14 bytes): count + rider + 1 slot(s) x 11
; (x,y,dx,dy,minX,maxX,minY,maxY,widthCells,movedX,movedY) ---
bitmap_platform_count EQU #C0E9
bitmap_platform_rider EQU #C0EA
bitmap_platform_pool  EQU #C0EB
; Per-slot colour state: 0 = authored (normal room), 1 = dim, 2 = inside halo.
bitmap_platform_light_state EQU #C0F6
; --- MULTI-SCREEN SHAFT state (5 bytes): 1 cabin(s) x 4
; (slot, y, dir, rider) + 1 shared forced-room byte ---
bitmap_shaft_state EQU #C0F7
...
bitmap_shaft_forced_room EQU #C0FB
...
bitmap_room_spawn_y_table:
    DB 128,216,216,216,216,216,216
...
.write_display_page:
    ...
    call commit_room_tick_music     ; keep the song running across the commit
    call bitmap_load_platforms
    call bitmap_shaft_after_commit
    scf
    ret
...
; ------------------------------------------------------------
upload_hud_hearts:
    ld a, bitmap_room_hud_heart_rle_chunk_0_DATA_BANK
    call bitmap_room_select_data_bank_a
...
; ------------------------------------------------------------
; PURPOSE: Writes the 1 fixed platform SAT slot(s) at VRAM #F610
...
; --- climbing: y decreases, and under 0 we move up one room (slot + 1) ---
    ...
    add a, 192   ; wrapped past the top of this room
    ld (ix+1), a
    inc (ix+0)
...
.shaft_have_dir:
    call start_room_transition
    pop bc
    ret nc                    ; no rail that way: keep riding in this room
...
.shaft_commit_one:
    ...
    xor a
    ld (player_vy), a
    ld (player_vy_frac), a    ; commit_room_flip may have left fall speed armed
.shaft_commit_pop:
    pop bc
.shaft_commit_next:
    ld de, 4
...
; ------------------------------------------------------------
; PURPOSE: Write the 1 fixed shaft SAT slot(s) at VRAM #F614.
;   A cabin whose current room is not the displayed one is parked off-screen at
;   Y=#D4 so the VDP keeps scanning.
; DESTROYS: AF, BC, DE, HL, IX.
; ------------------------------------------------------------
bitmap_shaft_sat:
    push de
    ...
    out (VDP_CTRL_PORT), a
.sat_shaft_0_0:
    ld ix, bitmap_shaft_state + 0
    ld b, 0
    call bitmap_shaft_room_for_slot
    ld hl, current_screen_index
    cp (hl)
    jp nz, .sat_shaft_0_0_hidden
    ld a, 0
    call bitmap_shaft_def_ptr
    ld de, 9
    add hl, de
    ...
    xor a
    out (VDP_DATA_PORT), a    ; EC = 0
    jp .sat_shaft_0_0_end
.sat_shaft_0_0_hidden:
    ld a, #D4
    out (VDP_DATA_PORT), a    ; off-screen, non-terminator
    xor a
    out (VDP_DATA_PORT), a
...
bitmap_shaft_upload_sprites:
    ld hl, bitmap_shaft_sprite_patterns + 0
    ld de, #FE20
    ld bc, 32
    call copy_to_vram_ext
    ld hl, bitmap_shaft_sprite_colors + 0
    ld de, #F450
    ld bc, 16
    call copy_to_vram_ext
    ret
...
bitmap_mush_room_3:    ; no mushrooms in this room
...
bitmap_room_platform_table_2:
    DB #01,#60,#60,#00,#01,#60,#60,#00,#BF,#01,#00,#00
...
bitmap_room_platform_table_4:
    DB #01,#60,#70,#00,#01,#60,#60,#00,#BF,#01,#00,#00
...
bitmap_shaft_path_0:
    DB 2    ; rooms in the path, BOTTOM FIRST
    DB #02,#03
; bottomSlot, bottomY, topSlot, topY, startSlot, startY, startDir, speed, x,
...
bitmap_shaft_path_ptr_table:
    DW bitmap_shaft_path_0
bitmap_shaft_def_ptr_table:
    DW bitmap_shaft_def_0
...
bitmap_room_sprite_colors:
    ...
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#4D,#4D,#4D,#0D,#4D,#4D,#0D
    DB #0B,#0B,#0B,#0B,#0B,#0D,#0B,#0B,#0B,#0B,#0D,#0D,#0D,#0D,#0B,#0F
    DB #0D,#0D,#0D,#0D,#0D,#0F,#4D,#0D,#0D,#0D,#0F,#0F,#0F,#0F,#0F,#0F
...
bitmap_room_sprite_colors_glowing:
    ...
    DB #05,#05,#05,#05,#05,#05,#05,#05,#05,#45,#45,#45,#05,#45,#45,#05
    DB #03,#03,#03,#03,#03,#05,#03,#03,#03,#03,#05,#05,#05,#05,#03,#07
    DB #05,#05,#05,#05,#05,#07,#45,#05,#05,#05,#07,#07,#07,#07,#07,#07
    ...
    DB #07,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03
    DB #07,#07,#05,#05,#05,#05,#05,#05,#05,#05,#05,#45,#45,#45,#45,#45
    DB #03,#03,#03,#03,#03,#03,#03,#05,#03,#03,#03,#03,#05,#05,#05,#03
    DB #45,#45,#45,#05,#05,#05,#05,#07,#07,#05,#05,#05,#07,#07,#07,#07
    DB #07,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03,#03
    DB #07,#07,#05,#05,#05,#05,#05,#05,#05,#45,#45,#45,#45,#45,#45,#45
    DB #03,#03,#03,#03,#03,#03,#03,#05,#03,#03,#03,#03,#05,#05,#05,#03
    DB #45,#05,#05,#05,#05,#05,#05,#07,#07,#05,#05,#05,#07,#07,#07,#07
...
bitmap_room_sprite_patterns:
    ...
    DB #01,#02,#02,#06,#06,#1C,#0D,#00,#00,#00,#01,#01,#01,#01,#00,#00
    DB #20,#40,#40,#20,#10,#18,#40,#80,#80,#80,#00,#00,#00,#80,#C0,#00
    DB #40,#41,#41,#41,#21,#02,#01,#03,#01,#01,#00,#00,#00,#00,#00,#00
    DB #C0,#A0,#A0,#D0,#E0,#A0,#48,#18,#00,#00,#00,#00,#00,#00,#00,#00
    ...
    DB #04,#02,#02,#04,#08,#18,#02,#01,#01,#01,#00,#00,#00,#01,#03,#00
    DB #80,#40,#40,#60,#60,#38,#B0,#00,#00,#00,#80,#80,#80,#80,#00,#00
    DB #03,#05,#05,#0B,#07,#05,#12,#18,#00,#00,#00,#00,#00,#00,#00,#00
    DB #02,#82,#82,#82,#84,#40,#80,#C0,#80,#80,#00,#00,#00,#00,#00,#00
...
; Persistent 256x20 HUD seed mirrored on page 0/1, packed 4bpp RLE; VRAM #00000, raw 2560 bytes, RLE 22 bytes
...
; Persistent 256x20 HUD seed mirrored on page 0/1, packed 4bpp RLE; VRAM #08000, raw 2560 bytes, RLE 22 bytes
bitmap_room_hud_seed_p1_rle_chunk_0:
    DB #FF,#11,#FF,#11,#FF,#11,#FF,#11,#FF,#11,#FF,#11,#FF,#11,#FF,#11
    DB #FF,#11,#89,#11,#80,#FF
bitmap_room_hud_seed_p1_rle_chunk_0_end:

; Shared world tileset (atlas), packed 4bpp RLE; VRAM #10000, raw 6144 bytes, RLE 2884 bytes
bitmap_room_tileset_rle_chunk_0:
    ...
    DB #07,#00,#08,#22,#11,#00,#01,#0F,#02,#FF,#01,#F8,#01,#EE,#01,#E0
    DB #01,#00,#01,#FF,#01,#E0,#01,#00,#01,#0F,#04,#FF,#08,#00,#04,#FF
    DB #01,#F0,#01,#00,#01,#0E,#01,#8E,#01,#00,#02,#EE,#01,#E8,#02,#FF
    DB #01,#F0,#01,#00,#01,#32,#07,#22,#01,#00,#01,#0C,#01,#CC,#02,#44
    DB #01,#CC,#01,#C0,#01,#00,#07,#22,#01,#30,#07,#00,#01,#20,#01,#32
    DB #06,#22,#01,#23,#01,#02,#01,#00,#01,#22,#03,#02,#02,#20,#07,#00
    DB #02,#22,#07,#00,#08,#22,#08,#00,#01,#02,#01,#00,#01,#22,#03,#02
    DB #02,#20,#04,#FF,#01,#F8,#02,#EE,#01,#E0,#01,#FF,#01,#E0,#01,#EE
    DB #01,#EB,#03,#FF,#01,#FB,#01,#BE,#05,#00,#01,#0E,#01,#EB,#01,#BF
    DB #03,#FF,#01,#8E,#01,#EE,#01,#0E,#01,#8E,#01,#0E,#02,#EE,#01,#E8
    DB #04,#FF,#01,#32,#07,#22,#01,#00,#01,#CC,#01,#C4,#01,#47,#01,#74
    DB #01,#4C,#01,#CC,#01,#00,#07,#22,#01,#30,#05,#00,#01,#22,#01,#00
    DB #01,#20,#01,#32,#06,#22,#01,#23,#01,#02,#01,#00,#01,#20,#03,#02
    DB #01,#00,#01,#20,#07,#00,#02,#22,#0A,#00,#01,#02,#01,#20,#0B,#00
    DB #01,#02,#01,#00,#01,#20,#03,#02,#01,#00,#01,#20,#01,#FF,#01,#F0
    DB #04,#00,#01,#0E,#01,#E0,#01,#BB,#01,#E0,#01,#EE,#01,#E0,#01,#0F
    DB #01,#FF,#01,#00,#01,#0B,#01,#BE,#01,#E0,#04,#00,#01,#0E,#01,#EB
    DB #02,#00,#01,#FF,#01,#F0,#01,#8E,#01,#EE,#01,#0E,#01,#8E,#01,#0E
    DB #01,#E0,#04,#00,#01,#0F,#01,#FF,#01,#32,#01,#20,#01,#02,#05,#22
    ...
    DB #01,#20,#0B,#00,#01,#02,#01,#00,#01,#22,#03,#02,#02,#20,#01,#FF
    DB #01,#EE,#01,#E0,#03,#00,#01,#EE,#01,#E0,#01,#88,#01,#E0,#05,#00
    DB #01,#EE,#01,#8E,#05,#00,#01,#0E,#01,#8E,#01,#EE,#05,#00,#01,#0E
    DB #01,#EE,#01,#0E,#01,#EE,#03,#00,#01,#08,#01,#88,#01,#FF,#01,#32
    DB #01,#20,#01,#02,#05,#22,#01,#CC,#01,#C4,#01,#44,#02,#77,#01,#44
    DB #01,#CC,#01,#44,#05,#22,#01,#11,#01,#22,#01,#30,#05,#00,#01,#11
    DB #01,#00,#01,#20,#01,#32,#01,#20,#01,#02,#02,#22,#01,#21,#01,#12
    DB #01,#23,#01,#02,#01,#00,#01,#20,#03,#02,#01,#00,#01,#20,#07,#00
    DB #02,#22,#0A,#00,#01,#02,#01,#20,#0B,#00,#01,#02,#01,#00,#01,#20
    DB #03,#02,#01,#00,#01,#20,#01,#00,#02,#EE,#01,#EB,#03,#EE,#01,#E0
    DB #01,#EE,#01,#00,#01,#0E,#01,#EE,#01,#88,#01,#8E,#02,#EE,#01,#E0
    DB #06,#00,#01,#0E,#02,#EE,#01,#88,#01,#8E,#01,#EE,#01,#E0,#01,#00
    DB #01,#EE,#01,#0E,#02,#EE,#01,#E8,#01,#8E,#01,#EE,#01,#88,#01,#00
    DB #01,#32,#07,#22,#01,#CC,#05,#44,#01,#CC,#01,#C4,#07,#22,#01,#30
    DB #07,#00,#01,#20,#01,#32,#06,#22,#01,#23,#01,#02,#01,#20,#01,#22
    DB #01,#00,#01,#20,#01,#02,#01,#20,#01,#22,#07,#00,#02,#22,#0A,#00
    DB #01,#02,#01,#20,#0B,#00,#01,#02,#01,#20,#01,#22,#01,#00,#01,#20
    DB #01,#02,#01,#20,#01,#22,#02,#00,#01,#EE,#01,#EB,#02,#EE,#01,#00
    DB #01,#04,#01,#BB,#01,#44,#01,#0E,#01,#EE,#02,#88,#01,#EE,#09,#00
    DB #01,#0E,#01,#EE,#02,#88,#01,#EE,#01,#E0,#01,#4E,#01,#BA,#01,#40
    DB #01,#00,#01,#EE,#01,#E8,#01,#88,#01,#EE,#02,#00,#01,#32,#07,#22
    DB #01,#4C,#01,#44,#05,#CC,#01,#C4,#07,#22,#01,#30,#07,#00,#01,#20
    DB #01,#32,#06,#22,#01,#23,#0F,#00,#02,#22,#0A,#00,#01,#02,#01,#20
    DB #1A,#00,#01,#44,#01,#BF,#01,#E4,#01,#40,#06,#00,#01,#04,#01,#AF
    DB #01,#FF,#01,#BE,#01,#E4,#07,#00,#01,#04,#01,#4E,#01,#FB,#01,#44
    DB #07,#00,#01,#32,#07,#22,#02,#CC,#02,#C0,#01,#CC,#01,#0C,#01,#CC
    DB #01,#44,#07,#22,#01,#30,#07,#00,#01,#20,#01,#32,#06,#22,#01,#23
    DB #0F,#00,#02,#22,#0A,#00,#01,#02,#01,#20,#1D,#00,#01,#0E,#06,#00
    DB #01,#04,#01,#EB,#01,#BB,#01,#8E,#01,#E4,#01,#44,#05,#00,#01,#0E
    DB #01,#E0,#0A,#00,#01,#32,#07,#22,#01,#0C,#01,#C0,#01,#00,#02,#CC
    DB #01,#00,#01,#CC,#01,#C0,#07,#22,#01,#30,#07,#00,#01,#20,#01,#32
    DB #06,#22,#01,#23,#0F,#00,#02,#22,#0A,#00,#01,#02,#01,#20,#19,#00
    DB #01,#04,#01,#44,#01,#BF,#01,#E4,#01,#40,#05,#00,#01,#04,#06,#44
    DB #01,#40,#05,#00,#01,#04,#01,#4A,#01,#FB,#01,#E4,#01,#40,#06,#00
    DB #01,#32,#07,#22,#01,#00,#01,#C0,#01,#0C,#02,#CC,#01,#00,#01,#CC
    DB #01,#00,#07,#22,#01,#30,#07,#00,#01,#20,#01,#32,#06,#22,#01,#23
    DB #02,#00,#01,#22,#01,#00,#01,#02,#01,#22,#09,#00,#02,#22,#0A,#00
    DB #01,#02,#01,#20,#0D,#00,#01,#22,#01,#00,#01,#02,#0E,#00,#01,#44
    DB #03,#00,#01,#0E,#01,#EE,#06,#00,#01,#EE,#01,#E0,#03,#00,#01,#44
    DB #0B,#00,#01,#32,#07,#22,#02,#00,#01,#0C,#01,#C4,#01,#CC,#03,#00
    DB #05,#22,#01,#00,#01,#22,#01,#30,#05,#00,#01,#22,#01,#00,#01,#20
    DB #01,#32,#06,#22,#01,#23,#02,#00,#01,#02,#01,#00,#01,#02,#0A,#00
    DB #02,#22,#0A,#00,#01,#02,#01,#20,#0D,#00,#01,#02,#01,#00,#01,#02
    DB #09,#00,#01,#4E,#01,#EE,#01,#E0,#02,#00,#02,#44,#01,#E0,#01,#00
    DB #01,#FE,#01,#EE,#01,#0E,#01,#AB,#01,#EE,#01,#E4,#01,#44,#01,#40
    DB #02,#EE,#01,#00,#03,#44,#02,#00,#01,#0E,#01,#EE,#01,#E4,#06,#00
    DB #01,#32,#01,#20,#01,#02,#05,#22,#02,#00,#01,#0C,#01,#C4,#01,#4C
    DB #03,#00,#05,#22,#01,#00,#01,#22,#01,#30,#05,#00,#01,#22,#01,#00
    DB #01,#20,#01,#32,#01,#23,#01,#02,#02,#22,#01,#23,#01,#12,#01,#23
    DB #02,#00,#01,#02,#01,#00,#01,#02,#01,#20,#09,#00,#02,#22,#0A,#00
    DB #01,#02,#01,#20,#0D,#00,#01,#02,#01,#00,#02,#02,#07,#00,#01,#FF
    DB #01,#BB,#01,#BE,#01,#E0,#02,#44,#01,#40,#01,#44,#01,#EE,#01,#E0
    DB #01,#FA,#01,#EE,#01,#44,#02,#EE,#03,#44,#01,#EA,#01,#A4,#01,#04
    DB #02,#44,#01,#04,#02,#44,#01,#0E,#01,#AB,#01,#BA,#01,#E0,#05,#00
    DB #01,#32,#01,#20,#01,#02,#05,#22,#02,#00,#01,#0C,#01,#44,#01,#4C
    DB #03,#00,#07,#22,#01,#30,#07,#00,#01,#20,#01,#32,#01,#20,#01,#02
    DB #02,#22,#01,#21,#01,#02,#01,#23,#02,#00,#01,#02,#02,#00,#01,#02
    DB #09,#00,#02,#22,#0A,#00,#01,#02,#01,#20,#0D,#00,#01,#02,#01,#00
    DB #01,#02,#01,#22,#07,#00,#01,#AA,#01,#BF,#01,#FE,#01,#40,#01,#AA
    DB #02,#44,#01,#40,#01,#4E,#01,#E0,#01,#BA,#01,#EE,#05,#44,#01,#4E
    DB #01,#EE,#01,#AE,#01,#04,#04,#44,#01,#AA,#01,#0E,#01,#EF,#01,#FA
    DB #01,#E0,#05,#00,#01,#32,#07,#22,#02,#00,#01,#0C,#01,#C4,#01,#CC
    DB #03,#00,#07,#22,#01,#30,#07,#00,#01,#20,#01,#32,#06,#22,#01,#23
    DB #02,#00,#01,#02,#02,#00,#01,#02,#09,#00,#02,#22,#0A,#00,#01,#02
    DB #01,#20,#0D,#00,#01,#02,#02,#00,#01,#02,#07,#00,#01,#4E,#02,#04
    DB #01,#40,#01,#A8,#01,#AA,#01,#E4,#01,#40,#01,#44,#01,#EA,#01,#BE
    DB #01,#EA,#01,#AE,#01,#44,#01,#EE,#02,#44,#01,#AA,#01,#AE,#01,#EE
    DB #03,#44,#01,#4E,#02,#AA,#01,#04,#01,#40,#01,#44,#01,#40,#05,#00
    DB #01,#03,#07,#33,#03,#00,#01,#CC,#01,#C0,#03,#00,#07,#33,#01,#00
    DB #07,#22,#01,#00,#01,#03,#06,#33,#01,#31,#02,#00,#01,#02,#01,#00
    DB #01,#02,#01,#20,#09,#00,#02,#22,#0A,#00,#01,#02,#01,#20,#03,#00
    DB #08,#22,#02,#00,#01,#02,#02,#00,#01,#02,#07,#00,#01,#44,#02,#04
    DB #01,#00,#01,#44,#01,#88,#01,#E4,#01,#40,#01,#4E,#01,#EE,#01,#AE
    DB #01,#EA,#01,#AE,#01,#EA,#01,#AB,#01,#AA,#01,#E0,#01,#AA,#01,#AE
    DB #01,#EE,#02,#44,#01,#0E,#01,#48,#01,#8A,#01,#44,#01,#04,#02,#44
    DB #01,#40,#10,#00,#01,#CC,#01,#C0,#2A,#00,#02,#22,#09,#00,#01,#02
    DB #02,#22,#01,#20,#02,#00,#08,#22,#0D,#00,#01,#44,#01,#00,#01,#04
    DB #01,#00,#03,#44,#01,#40,#01,#0E,#01,#EE,#01,#4E,#01,#EE,#01,#AE
    DB #01,#EA,#02,#BB,#01,#E4,#01,#AA,#02,#EE,#02,#44,#01,#00,#03,#44
    DB #01,#00,#01,#40,#01,#04,#01,#40,#62,#00,#01,#44,#02,#04,#01,#40
    DB #03,#44,#01,#04,#02,#44,#01,#4E,#01,#EE,#01,#BA,#03,#EE,#01,#E4
    DB #01,#8A,#02,#EE,#01,#44,#01,#04,#01,#40,#03,#44,#01,#04,#01,#40
    DB #01,#44,#01,#40,#62,#00,#03,#44,#01,#40,#01,#04,#01,#40,#01,#44
    DB #01,#04,#01,#44,#01,#40,#01,#0E,#01,#EA,#01,#E4,#01,#00,#01,#02
    DB #01,#20,#01,#00,#01,#4A,#01,#AE,#01,#E0,#01,#04,#01,#44,#01,#40
    DB #02,#04,#01,#00,#01,#04,#02,#44,#01,#40,#63,#00,#01,#44,#01,#40
    DB #04,#00,#01,#04,#02,#44,#01,#EE,#01,#BA,#01,#E0,#01,#00,#02,#22
    DB #01,#00,#01,#04,#01,#BA,#01,#E0,#02,#44,#01,#40,#04,#00,#02,#44
    DB #67,#00,#03,#44,#01,#04,#01,#44,#01,#4E,#01,#AB,#01,#EE,#01,#00
    DB #04,#22,#01,#00,#01,#EE,#01,#BE,#02,#44,#01,#40,#01,#04,#02,#44
    DB #68,#00,#01,#0E,#01,#EE,#01,#8B,#01,#BE,#01,#EE,#01,#E0,#01,#44
    DB #01,#4E,#01,#EA,#01,#EE,#01,#E2,#01,#22,#01,#2A,#02,#22,#01,#2E
    DB #01,#EE,#01,#AE,#02,#44,#01,#0E,#01,#EE,#01,#EB,#01,#B8,#01,#EE
    DB #01,#E0,#65,#00,#01,#0E,#02,#EE,#01,#BF,#01,#F8,#01,#EE,#01,#E0
    DB #02,#44,#01,#4E,#01,#0E,#01,#E2,#01,#22,#01,#AF,#02,#22,#01,#2E
    DB #01,#E0,#01,#E4,#02,#44,#01,#0E,#01,#EE,#01,#8F,#01,#F8,#02,#EE
    DB #01,#E0,#64,#00,#01,#EE,#01,#E8,#01,#80,#01,#00,#01,#B8,#01,#0E
    DB #01,#E0,#01,#44,#01,#EE,#01,#44,#01,#0E,#01,#E2,#01,#22,#01,#AA
    DB #01,#20,#01,#02,#01,#2E,#01,#E0,#01,#44,#01,#EE,#01,#44,#01,#0E
    DB #01,#E0,#01,#88,#01,#00,#01,#08,#01,#8E,#01,#EE,#64,#00,#01,#E0
    DB #01,#8B,#01,#BB,#01,#08,#01,#BB,#01,#B0,#01,#EE,#01,#0E,#01,#EA
    DB #01,#00,#01,#0B,#01,#B2,#01,#20,#01,#22,#01,#00,#01,#02,#01,#2B
    DB #01,#B0,#01,#E0,#01,#AE,#01,#40,#01,#EE,#01,#0B,#01,#BB,#01,#B0
    DB #01,#BB,#01,#B8,#01,#EE,#64,#00,#01,#EE,#01,#80,#02,#08,#01,#00
    DB #01,#88,#01,#EE,#02,#00,#01,#EE,#01,#0E,#01,#E2,#01,#22,#02,#00
    DB #01,#22,#01,#2E,#02,#E0,#02,#00,#01,#EE,#01,#BB,#01,#08,#01,#BB
    DB #01,#B0,#01,#08,#01,#EE,#64,#00,#01,#EE,#01,#E0,#01,#08,#01,#0E
    DB #01,#00,#02,#EE,#02,#00,#01,#EE,#01,#0E,#01,#E0,#01,#22,#02,#00
    DB #01,#22,#01,#0E,#02,#E0,#02,#00,#01,#EE,#01,#88,#01,#08,#01,#88
    DB #01,#80,#01,#0E,#01,#EE,#64,#00,#01,#E0,#02,#EE,#01,#0E,#01,#EE
    DB #01,#E0,#02,#EE,#01,#44,#01,#0E,#01,#40,#01,#EE,#01,#02,#02,#22
    DB #01,#20,#01,#EE,#01,#0E,#01,#E0,#01,#44,#02,#EE,#01,#0E,#01,#EE
    DB #01,#80,#02,#EE,#01,#0E,#64,#00,#01,#0E,#01,#EE,#01,#E0,#01,#00
    DB #01,#EE,#01,#0E,#01,#E0,#01,#EE,#02,#44,#02,#EE,#01,#E0,#02,#22
    DB #01,#0E,#01,#EE,#01,#A4,#01,#04,#01,#44,#01,#E4,#01,#0E,#02,#EE
    DB #01,#00,#01,#0E,#01,#EE,#65,#00,#01,#0E,#05,#EE,#01,#EB,#01,#BE
    DB #01,#E4,#01,#40,#01,#4E,#01,#AE,#01,#EA,#02,#FF,#01,#AE,#01,#0E
    DB #01,#E4,#01,#04,#01,#4E,#01,#8B,#01,#BE,#05,#EE,#66,#00,#01,#0E
    DB #04,#EE,#01,#0B,#01,#BE,#01,#E0,#02,#44,#01,#EE,#01,#EA,#02,#BB
    DB #02,#EE,#02,#44,#01,#0E,#01,#8B,#01,#B0,#04,#EE,#01,#E0,#68,#00
    DB #01,#40,#01,#4E,#01,#00,#01,#0E,#01,#88,#01,#40,#02,#44,#03,#EE
    DB #01,#E4,#01,#44,#01,#EE,#01,#44,#01,#40,#01,#04,#01,#88,#01,#E0
    DB #01,#00,#01,#E4,#01,#04,#01,#40,#68,#00,#01,#0E,#02,#EE,#01,#E0
    DB #01,#EE,#01,#88,#01,#EE,#01,#04,#08,#44,#01,#00,#01,#EE,#01,#88
    DB #04,#EE,#01,#E0,#68,#00,#01,#0E,#01,#EE,#01,#E0,#02,#EE,#01,#E0
    DB #01,#EE,#01,#04,#08,#44,#01,#00,#01,#EE,#01,#04,#02,#EE,#01,#0E
    DB #01,#EE,#01,#80,#68,#00,#01,#E8,#01,#EE,#01,#E0,#02,#EE,#01,#00
    DB #01,#EE,#01,#04,#01,#44,#01,#40,#03,#44,#01,#40,#01,#04,#01,#44
    DB #01,#00,#01,#EE,#01,#00,#02,#EE,#01,#0E,#01,#EE,#01,#8E,#67,#00
    DB #01,#0E,#01,#E8,#01,#EE,#01,#E0,#01,#EE,#01,#0E,#01,#E0,#01,#40
    DB #01,#00,#01,#44,#01,#40,#03,#44,#01,#40,#01,#04,#01,#44,#01,#00
    DB #02,#0E,#01,#E0,#01,#EE,#01,#0E,#01,#EE,#01,#8E,#01,#E0,#66,#00
    DB #01,#0E,#01,#E0,#01,#EE,#01,#00,#01,#EE,#01,#00,#01,#EE,#02,#00
    DB #01,#04,#01,#40,#04,#00,#01,#04,#01,#40,#02,#00,#01,#EE,#01,#00
    DB #01,#EE,#01,#00,#01,#EE,#01,#0E,#01,#E0,#67,#00,#01,#EE,#02,#0E
    DB #01,#E0,#03,#00,#01,#E0,#01,#EE,#01,#00,#01,#E0,#02,#00,#01,#EE
    DB #01,#00,#01,#EE,#01,#0E,#03,#00,#01,#0E,#02,#E0,#01,#EE,#68,#00
    DB #01,#EE,#01,#E0,#01,#00,#01,#0E,#01,#E4,#01,#40,#01,#44,#02,#E0
    DB #01,#0E,#01,#EE,#02,#00,#01,#EE,#01,#00,#02,#0E,#01,#40,#01,#04
    DB #01,#4E,#01,#E0,#01,#00,#01,#EE,#01,#E0,#6B,#00,#04,#44,#03,#00
    DB #01,#0E,#02,#EE,#02,#00,#01,#0E,#01,#40,#02,#44,#01,#4E,#01,#EE
    DB #6E,#00,#01,#44,#01,#4E,#01,#EE,#01,#44,#01,#0E,#01,#EE,#02,#E0
    DB #02,#EE,#02,#0E,#01,#EE,#01,#E0,#01,#4E,#01,#EE,#01,#E4,#01,#EE
    DB #6E,#00,#01,#44,#01,#4E,#01,#A8,#01,#40,#01,#0E,#02,#EE,#01,#E0
    DB #01,#EF,#01,#BE,#01,#0E,#02,#EE,#01,#E0,#01,#0E,#01,#BE,#01,#E4
    DB #01,#44,#6E,#00,#01,#E0,#02,#44,#01,#40,#01,#E0,#01,#00,#01,#EE
    DB #01,#E0,#01,#EF,#01,#BE,#01,#0E,#01,#EE,#01,#00,#01,#0E,#01,#04
    DB #02,#44,#01,#0E,#6E,#00,#01,#EE,#02,#44,#01,#00,#01,#EE,#01,#0E
    DB #02,#E0,#02,#00,#02,#0E,#01,#E0,#01,#EE,#01,#00,#02,#44,#01,#EE
    DB #6E,#00,#01,#EE,#03,#00,#01,#E0,#01,#0E,#01,#E0,#01,#00,#01,#4F
    DB #01,#B4,#01,#00,#01,#0E,#01,#E0,#01,#0E,#03,#00,#01,#EE,#6E,#00
    DB #01,#44,#03,#EE,#04,#00,#01,#4B,#01,#A4,#04,#00,#03,#EE,#01,#44
    DB #6E,#00,#01,#4E,#03,#EE,#01,#E0,#03,#00,#01,#40,#01,#04,#03,#00
    DB #01,#0E,#03,#EE,#01,#40,#6E,#00,#01,#0E,#03,#EE,#01,#E0,#08,#00
    DB #01,#0E,#03,#EE,#01,#E0,#6F,#00,#02,#EE,#01,#E0,#0A,#00,#01,#0E
    DB #02,#EE,#0C,#00
bitmap_room_tileset_rle_chunk_0_end:

; Hearts HUD tiles (full + empty outline), packed 4bpp RLE; VRAM #07000, raw 2048 bytes, RLE 252 bytes
...
; Room 0 page 0 render program: 99 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_0_p0:
    ...
    DB #02,#20,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #F0,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#00
    DB #00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#10,#00
    DB #34,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#20,#00,#34
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#30,#00,#34,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#34,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#44,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#00,#02,#B0,#00,#44,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#00,#02,#C0,#00,#44,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#00,#02,#D0,#00,#44,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#F0,#00,#44,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#00,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#70,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#80,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#F0,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#00,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #50,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#60
    DB #00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#70,#00
    DB #64,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#80,#00,#64
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#64,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#74,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#50,#00,#74,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#00,#02,#60,#00,#74,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#70,#00,#74,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#80,#00,#74,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#00,#00,#84,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#00,#02,#50,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#00,#02,#60,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#00,#02,#70,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00
    DB #00,#02,#80,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00
    DB #02,#90,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02
    DB #A0,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00
    DB #00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#10,#00
    DB #94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#20,#00,#94
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#30,#00,#94,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#50,#00,#94,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#60,#00,#94,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#00,#02,#70,#00,#94,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#00,#02,#80,#00,#94,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#00,#02,#90,#00,#94,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#00,#02,#A0,#00,#94,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#00,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#50,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#60,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #00,#02,#70,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00
    DB #02,#80,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #90,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#A0
    DB #00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00
    DB #B4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#50,#00,#B4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#60,#00,#B4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#70,#00,#B4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#80,#00,#B4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#B4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#A0,#00,#B4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#B0,#00,#B4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#00,#02,#C0,#00,#B4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#00,#02,#D0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#E0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#F0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #00,#02,#00,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00
    DB #02,#10,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #20,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#30
    DB #00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#40,#00
    DB #C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#50,#00,#C4
    ...
    DB #00,#00,#D0,#00,#00,#00,#02,#B0,#00,#C4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#00,#02,#C0,#00,#C4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#00,#02,#D0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#00,#02,#E0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#00,#02,#F0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#10,#00
    DB #00,#02,#D0,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0
bitmap_room_render_0_p0_end:

; Room 0 page 1 render program: 99 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_0_p1:
    ...
    DB #02,#20,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #F0,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#00
    DB #00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#10,#00
    DB #34,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#20,#00,#34
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#30,#00,#34,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#34,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#44,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#00,#02,#B0,#00,#44,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#00,#02,#C0,#00,#44,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#00,#02,#D0,#00,#44,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#F0,#00,#44,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#00,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#70,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#80,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#F0,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#00,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #50,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#60
    DB #00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#70,#00
    DB #64,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#80,#00,#64
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#64,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#74,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#50,#00,#74,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#00,#02,#60,#00,#74,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#70,#00,#74,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#80,#00,#74,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#00,#00,#84,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#00,#02,#50,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#00,#02,#60,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#00,#02,#70,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00
    DB #00,#02,#80,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00
    DB #02,#90,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02
    DB #A0,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00
    DB #00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#10,#00
    DB #94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#20,#00,#94
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#30,#00,#94,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#50,#00,#94,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#60,#00,#94,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#00,#02,#70,#00,#94,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#00,#02,#80,#00,#94,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#00,#02,#90,#00,#94,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#00,#02,#A0,#00,#94,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#00,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#50,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#60,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #00,#02,#70,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00
    DB #02,#80,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #90,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#A0
    DB #00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00
    DB #B4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#50,#00,#B4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#60,#00,#B4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#70,#00,#B4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#80,#00,#B4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#B4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#A0,#00,#B4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#B0,#00,#B4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#00,#02,#C0,#00,#B4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#00,#02,#D0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#E0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#F0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #00,#02,#00,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00
    DB #02,#10,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #20,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#30
    DB #00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#40,#00
    DB #C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#50,#00,#C4
    ...
    DB #00,#00,#D0,#00,#00,#00,#02,#B0,#00,#C4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#00,#02,#C0,#00,#C4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#00,#02,#D0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#00,#02,#E0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#00,#02,#F0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#10,#00
    DB #00,#02,#D0,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0
...
bitmap_room_collision_0:
    ...
    DB #10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10,#10,#10,#00,#10
...
bitmap_room_render_1_p0:
    ...
    DB #00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00
    DB #24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#00,#00,#34
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#10,#00,#34,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#34,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#00,#00,#44,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#00,#02,#10,#00,#44,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#44,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#00,#02,#00,#00,#54,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#00,#02,#10,#00,#54,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#F0,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#00,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#10,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#F0,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#F0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #F0,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#90,#00,#00,#02,#D0
    DB #00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00
    DB #94,#00,#10,#00,#10,#00,#00,#00,#D0,#60,#00,#00,#02,#C0,#00,#A4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#50,#00,#00,#02,#D0,#00,#A4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#E0,#00,#A4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#A4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#B4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#80,#00,#00,#02,#D0,#00,#B4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#F0,#00,#B4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#00,#02,#00,#00,#C4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#00,#02,#10,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#20,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#00,#02,#30,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00
    DB #00,#02,#40,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#50,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #60,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#70
    DB #00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#80,#00
    DB #C4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#90,#00,#C4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#A0,#00,#C4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#B0,#00,#C4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#C0,#00,#C4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#00,#02,#D0,#00,#C4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#E0,#00,#C4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#F0,#00,#C4,#00,#10,#00,#10,#00,#00
    DB #00,#D0
...
bitmap_room_render_1_p1:
    ...
    DB #00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00
    DB #24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#00,#00,#34
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#10,#00,#34,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#34,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#00,#00,#44,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#00,#02,#10,#00,#44,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#44,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#00,#02,#00,#00,#54,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#00,#02,#10,#00,#54,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#F0,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#00,#02,#00,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#00,#02,#10,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#F0,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#F0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #F0,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#90,#00,#00,#02,#D0
    DB #00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00
    DB #94,#01,#10,#00,#10,#00,#00,#00,#D0,#60,#00,#00,#02,#C0,#00,#A4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#50,#00,#00,#02,#D0,#00,#A4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#E0,#00,#A4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#A4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#B4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#80,#00,#00,#02,#D0,#00,#B4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#F0,#00,#B4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#00,#02,#00,#00,#C4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#00,#02,#10,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#20,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#00,#02,#30,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00
    DB #00,#02,#40,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#50,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02
    DB #60,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#70
    DB #00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#80,#00
    DB #C4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#90,#00,#C4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#00,#02,#A0,#00,#C4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#B0,#00,#C4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#C0,#00,#C4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#00,#02,#D0,#00,#C4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#E0,#00,#C4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#F0,#00,#C4,#01,#10,#00,#10,#00,#00
    DB #00,#D0
bitmap_room_render_1_p1_end:

; Room 1 16x12 collision grid (16x16 px cells), row-major, 0=empty
bitmap_room_collision_1:
    DB #00,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
...
bitmap_room_render_2_p0:
    ...
    DB #00,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0
    DB #00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00
    DB #34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#34
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#44,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#44,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#54,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#54,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#64,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#10,#00,#64,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#20,#00,#64,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#30,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#40,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#50,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#F0,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#00,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #10,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#20
    DB #00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#30,#00
    DB #74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#40,#00,#74
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#50,#00,#74,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#74,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#84,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#10,#00,#84,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#20,#00,#84,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#30,#00,#84,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#40,#00,#84,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#50,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0
    ...
    DB #30,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#40
    DB #00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#50,#00
    ...
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#B4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#B4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#00,#00,#C4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#10,#00,#C4,#00,#10,#00,#10,#00,#00
...
bitmap_room_render_2_p1:
    ...
    DB #00,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0
    DB #00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00
    DB #34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#34
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#44,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#44,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#54,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#54,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#64,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#10,#00,#64,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#20,#00,#64,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#30,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#40,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#50,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#F0,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#00,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #10,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#20
    DB #00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#30,#00
    DB #74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#40,#00,#74
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#50,#00,#74,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#74,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#84,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#10,#00,#84,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#20,#00,#84,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#30,#00,#84,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#40,#00,#84,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#50,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0
    ...
    DB #30,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#40
    DB #00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#50,#00
    ...
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#B4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#B4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#00,#02,#00,#00,#C4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#00,#02,#10,#00,#C4,#01,#10,#00,#10,#00,#00
...
bitmap_room_collision_2:
    ...
    DB #10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #10,#10,#10,#10,#10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #10,#10,#10,#10,#10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #10,#10,#10,#10,#10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #10,#10,#10,#10,#10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
...
; Room 3 page 0 render program: 35 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_3_p0:
    ...
    DB #00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00
    DB #34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#44
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#44,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#54,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#90,#00,#00,#02,#D0,#00,#54,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#54,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#64,#00,#10,#00,#10,#00
    ...
    DB #00,#00,#02,#00,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00
    DB #00,#02,#D0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#F0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #00,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#B0
    DB #00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0,#00
    DB #84,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00,#84
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#84,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#84,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#94,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#94,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#A4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#F0,#00,#A4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#00,#00,#B4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#F0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#00,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#10,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#F0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0
bitmap_room_render_3_p0_end:

; Room 3 page 1 render program: 35 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_3_p1:
    ...
    DB #00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00
    DB #34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#44
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#44,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#54,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#90,#00,#00,#02,#D0,#00,#54,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#54,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#64,#01,#10,#00,#10,#00
    ...
    DB #00,#00,#02,#00,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00
    DB #00,#02,#D0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#F0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #00,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#B0
    DB #00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0,#00
    DB #84,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00,#84
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#84,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#84,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#94,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#94,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#A4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#F0,#00,#A4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#00,#00,#B4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#F0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#00,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#10,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00
...
; Room 4 page 0 render program: 73 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_4_p0:
    ...
    DB #00,#02,#90,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#34
    ...
    DB #00,#02,#90,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#54
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#54,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#64,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#64,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#A0,#00,#64,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#B0,#00,#64,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#C0,#00,#64,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#D0,#00,#64,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#E0,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#F0,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#00,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#90,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#74
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#74,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#84,#00,#10
    ...
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#C4,#00
    DB #10,#00,#10,#00,#00,#00,#D0
bitmap_room_render_4_p0_end:

; Room 4 page 1 render program: 73 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_4_p1:
    ...
    DB #00,#02,#90,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#34
    ...
    DB #00,#02,#90,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#54
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#54,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#64,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#64,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#A0,#00,#64,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#B0,#00,#64,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#C0,#00,#64,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#D0,#00,#64,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#E0,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#F0,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#00,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#90,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#74
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#74,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#84,#01,#10
    ...
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#C4,#01
    DB #10,#00,#10,#00,#00,#00,#D0
...
bitmap_room_render_5_p0:
    ...
    DB #00,#00,#02,#00,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#00,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#00,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #00,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00
    DB #00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00
    DB #74,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#84
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#94,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#94,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#A0,#00,#94,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#A4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#A4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#A0,#00,#A4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#00,#00,#B4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#90,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#A0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#00,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#90,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#C4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#C4,#00
    DB #10,#00,#10,#00,#00,#00,#D0
...
bitmap_room_render_5_p1:
    ...
    DB #00,#00,#02,#00,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#00,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#00,#00,#44,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #00,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00
    DB #00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00
    DB #74,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#84
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#94,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#94,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#A0,#00,#94,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#40,#00,#00,#02,#00,#00,#A4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#40,#00,#00,#02,#90,#00,#A4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#00,#02,#A0,#00,#A4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#40,#00,#00,#02,#00,#00,#B4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#40,#00,#00,#02,#90,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#00,#02,#A0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#40
    DB #00,#00,#02,#00,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00
    DB #00,#02,#90,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00
    DB #02,#A0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02
    DB #B0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#C0
    DB #00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#D0,#00
    DB #C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#E0,#00,#C4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#00,#02,#F0,#00,#C4,#01
    DB #10,#00,#10,#00,#00,#00,#D0
...
; Room 6 page 0 render program: 33 V9938 command blocks (clear + 16x16 tile copies)
...
; Room 6 page 1 render program: 33 V9938 command blocks (clear + 16x16 tile copies)
...
bitmap_room_collision_6:
    DB #00,#10,#10,#10,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#10
