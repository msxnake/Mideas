...
BITMAP_MUSIC_DATA_BANK_0 EQU 7   ; PT3 half 0, mapped to P2/#8000
BITMAP_MUSIC_DATA_BANK_1 EQU 8   ; PT3 half 1, mapped to P3/#A000
...
; Shared world tileset (atlas), packed 4bpp RLE; VRAM #10000, raw 2048 bytes, RLE 1148 bytes
...
; Linked HUD dynamic widget #3 (counter) tile/glyph data, packed 4bpp RLE; VRAM #10800, raw 1024 bytes, RLE 452 bytes
...
; ==================================================================
; MUSIC DATA BANK 7 (chunk 0: shared tables + serialized songs, 8192/8192 bytes).
...
; ==================================================================
; MUSIC DATA BANK 8 (chunk 1: shared tables + serialized songs, 8192/8192 bytes).
; Mapped into the music runtime window only while music_play_track / music_update run;
; the wrappers restore resident P2=2 and P3=3 before returning. Source PT3
; uses consecutive chunks as #8000/#A000 halves; native SCC/PSG uses P3.
; SCC-window bank numbers are never allocated. The ds guard fails loudly
