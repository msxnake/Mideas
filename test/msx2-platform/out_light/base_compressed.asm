...
bitmap_light_x                 EQU #C0F4
bitmap_light_y                 EQU #C0F5
bitmap_light_tx                EQU #C0F6
bitmap_light_ty                EQU #C0F7
bitmap_light_active            EQU #C0F8
bitmap_light_page              EQU #C0F9
bitmap_light_op_clr            EQU #C0FA
bitmap_light_op_cmd            EQU #C0FB
bitmap_light_d                 EQU #C0FC
bitmap_light_xsign             EQU #C0FD
bitmap_light_xadj              EQU #C0FE
bitmap_light_ybias             EQU #C0FF
bitmap_light_rx                EQU #C100
bitmap_light_ry                EQU #C101
bitmap_light_rw                EQU #C102
bitmap_light_rh                EQU #C104
bitmap_light_band_y            EQU #C105
bitmap_light_band_h            EQU #C106
bitmap_light_band_hw           EQU #C107
...
undefined    call bitmap_load_platforms
