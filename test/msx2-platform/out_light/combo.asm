...
bitmap_light_x                 EQU #C0F5
bitmap_light_y                 EQU #C0F6
bitmap_light_tx                EQU #C0F7
bitmap_light_ty                EQU #C0F8
bitmap_light_active            EQU #C0F9
bitmap_light_page              EQU #C0FA
bitmap_light_op_clr            EQU #C0FB
bitmap_light_op_cmd            EQU #C0FC
bitmap_light_d                 EQU #C0FD
bitmap_light_xsign             EQU #C0FE
bitmap_light_xadj              EQU #C0FF
bitmap_light_ybias             EQU #C100
bitmap_light_rx                EQU #C101
bitmap_light_ry                EQU #C102
bitmap_light_rw                EQU #C103
bitmap_light_rh                EQU #C105
bitmap_light_band_y            EQU #C106
bitmap_light_band_h            EQU #C107
bitmap_light_band_hw           EQU #C108
bitmap_light_on                EQU #C109
bitmap_light_stage             EQU #C10A
bitmap_light_timer             EQU #C10B
bitmap_light_bands_ptr         EQU #C10D
bitmap_light_sdown_ptr         EQU #C10F
bitmap_light_sdown_n           EQU #C111
bitmap_light_sup_ptr           EQU #C112
bitmap_light_sup_n             EQU #C114
bitmap_light_cxmin             EQU #C115
bitmap_light_cxmax             EQU #C116
; --- MOVING PLATFORM runtime state (14 bytes): count + rider + 1 slot(s) x 11
; (x,y,dx,dy,minX,maxX,minY,maxY,widthCells,movedX,movedY) ---
bitmap_platform_count EQU #C0E7
bitmap_platform_rider EQU #C0E8
bitmap_platform_pool  EQU #C0E9
; Per-slot colour state: 0 = authored (normal room), 1 = dim, 2 = inside halo.
bitmap_platform_light_state EQU #C0F4
...
bitmap_room_render_bank_table_p0:
    DB bitmap_room_render_0_p0_DATA_BANK,bitmap_room_render_1_p0_DATA_BANK
; Konami data bank for each page 1 room render program
bitmap_room_render_bank_table_p1:
    DB bitmap_room_render_0_p1_DATA_BANK,bitmap_room_render_1_p1_DATA_BANK
...
bitmap_room_behavior_bank_table:
    DB bitmap_room_behavior_0_DATA_BANK,bitmap_room_behavior_1_DATA_BANK
...
;
; NOTES:
;   Source = bitmap_room_sprite_colors[_glowing] + player_anim_frame * 32.
...
; OUTPUT: bitmap_platform_count/rider/pool + VRAM pattern groups 8..8.
...
.bplat_slot_0_lit_room:
    ...
    ; --- upload widthCells pattern groups -> VRAM #F900 (group 8+) ---
    ...
    ld de, #F900
    call copy_to_vram_ext
    ; --- upload widthCells 16-byte colour tables -> VRAM #F420 ---
...
;   (delta = feet - top accepted in [-2..3]).
...
.plat_right_ok:
    ...
    ; feet delta: A = player_y + 16 - platTop, accepted in [-2..3]
    ld a, (player_y)
    add a, 16
    sub (ix+1)
    add a, 2
...
; ------------------------------------------------------------
; PURPOSE: Writes the 1 fixed platform SAT slot(s) at VRAM #F608
...
; OUTPUT: SAT entries at VRAM #F608..#F60F.
; DESTROYS: AF. PRESERVES: BC, DE, HL, IX, IY.
; ------------------------------------------------------------
...
bitmap_room_platform_table_0:
    DB #01,#30,#A0,#01,#00,#20,#60,#A0,#A0,#01,#00,#00
...
bitmap_room_sprite_colors_glowing:
    DB #07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07
    DB #07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07
    DB #07,#07,#07,#07,#07,#02,#02,#02,#02,#07,#07,#07,#02,#02,#02,#02
    DB #07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07,#07
...
; Persistent 256x20 HUD seed mirrored on page 0/1, packed 4bpp RLE; VRAM #00000, raw 2560 bytes, RLE 532 bytes
...
; Persistent 256x20 HUD seed mirrored on page 0/1, packed 4bpp RLE; VRAM #08000, raw 2560 bytes, RLE 532 bytes
...
; Shared world tileset (atlas), packed 4bpp RLE; VRAM #10000, raw 2048 bytes, RLE 886 bytes
