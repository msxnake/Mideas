...
bitmap_shaft_pending_dir EQU #C0ED
...
.shaft_up_same_room:
    ...
    ; the room, not by the cabin: the carry writes (cabin_y - 16), which
    ; underflows 16 px earlier and threw the rider off the top edge -- that was
    ...
    ld a, (ix+1)
    cp 18     ; player_y would drop under 2: the engine's own edge rule
