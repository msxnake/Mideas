...
.benemy_slot_0:
    ...
    ; --- upload frameCount*2 pattern groups -> VRAM #FE00 (group 48+) ---
    ld a, (ix+8)
...
; Raw bytes: 8192; encoded bytes: 5180
; VRAM #10000, raw 8192 bytes, RLE 5180 bytes
...
; Linked HUD dynamic widget #3 (counter) tile/glyph data, packed 4bpp RLE, destination VRAM #12000
; Raw bytes: 1024; encoded bytes: 452
; VRAM #12000, raw 1024 bytes, RLE 452 bytes
