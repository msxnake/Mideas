...
bitmap_light_x                 EQU #D01A
bitmap_light_y                 EQU #D01B
bitmap_light_tx                EQU #D01C
bitmap_light_ty                EQU #D01D
bitmap_light_active            EQU #D01E
bitmap_light_page              EQU #D01F
bitmap_light_op_clr            EQU #D020
bitmap_light_op_cmd            EQU #D021
bitmap_light_d                 EQU #D022
bitmap_light_xsign             EQU #D023
bitmap_light_xadj              EQU #D024
bitmap_light_ybias             EQU #D025
bitmap_light_rx                EQU #D026
bitmap_light_ry                EQU #D027
bitmap_light_rw                EQU #D028
bitmap_light_rh                EQU #D02A
bitmap_light_band_y            EQU #D02B
bitmap_light_band_h            EQU #D02C
bitmap_light_band_hw           EQU #D02D
; --- MOVING PLATFORM runtime state (26 bytes): count + rider + 2 slot(s) x 11
; (x,y,dx,dy,minX,maxX,minY,maxY,widthCells,movedX,movedY) ---
bitmap_platform_count EQU #D000
bitmap_platform_rider EQU #D001
bitmap_platform_pool  EQU #D002
; Per-slot colour state: 0 = authored (normal room), 1 = dim, 2 = inside halo.
bitmap_platform_light_state EQU #D018
...
; OUTPUT: bitmap_platform_count/rider/pool + VRAM pattern groups 8..9.
...
.bplat_slot_1_lit_room:
    ...
    ; --- upload widthCells pattern groups -> VRAM #F920 (group 9+) ---
    ld a, (ix+9)              ; patOff, in 32-byte groups
    call bitmap_platform_patterns_offset
    ld a, (ix+8)              ; widthCells
    push hl
    ...
    ld de, #F920
    call copy_to_vram_ext
    ; --- upload widthCells 16-byte colour tables -> VRAM #F430 ---
...
; ------------------------------------------------------------
; PURPOSE: Writes the 2 fixed platform SAT slot(s) at VRAM #F608
...
; OUTPUT: SAT entries at VRAM #F608..#F613.
; DESTROYS: AF. PRESERVES: BC, DE, HL, IX, IY.
; ------------------------------------------------------------
...
bitmap_room_platform_table_0:
    DB #02,#30,#A0,#01,#00,#20,#60,#A0,#A0,#01,#00,#00,#C0,#A0,#01,#00
    DB #B0,#E0,#A0,#A0,#01,#00,#00
...
bitmap_room_platform_table_1:
    DB #01,#30,#A0,#01,#00,#20,#60,#A0,#A0,#01,#00,#00,#00,#00,#00,#00
