...
; Sprite 0 line color table (mode 2): configured player sprite "player_jump" + 1 state clip(s)
...
; Sprite 0 pattern (16x16, mode 2 quadrants): configured player sprite "player_jump" + 1 state clip(s)
