...
bitmap_room_hud_linked_4_rle_chunk_0_DATA_BANK EQU 4
...
; Linked HUD counter #0 (hud_el_ammo_nueces), bound to "ammo" [8-bit, 2 digits].
...
; collector_gems skill (SCREEN 5 bitmap): 6 pickup(s), 6 of them nuts (shoot ammo). RAM follows key-door/dialogue chain.
...
bitmap_heal_work_offset EQU #D013
bitmap_heal_target_page EQU #D014
bitmap_heal_flags       EQU #D015
bitmap_heal_cmd_block   EQU #C2C0
; Player-linked State Machine runtime (SCREEN 5 bitmap route).
bitmap_sm_state EQU #D04A
bitmap_light_x                 EQU #D04B
bitmap_light_y                 EQU #D04C
bitmap_light_tx                EQU #D04D
bitmap_light_ty                EQU #D04E
bitmap_light_active            EQU #D04F
bitmap_light_page              EQU #D050
bitmap_light_op_clr            EQU #D051
bitmap_light_op_cmd            EQU #D052
bitmap_light_d                 EQU #D053
bitmap_light_xsign             EQU #D054
bitmap_light_xadj              EQU #D055
bitmap_light_ybias             EQU #D056
bitmap_light_rx                EQU #D057
bitmap_light_ry                EQU #D058
bitmap_light_rw                EQU #D059
bitmap_light_rh                EQU #D05B
bitmap_light_band_y            EQU #D05C
bitmap_light_band_h            EQU #D05D
bitmap_light_band_hw           EQU #D05E
bitmap_light_on                EQU #D05F
bitmap_light_stage             EQU #D060
bitmap_light_timer             EQU #D061
bitmap_light_bands_ptr         EQU #D063
bitmap_light_sdown_ptr         EQU #D065
bitmap_light_sdown_n           EQU #D067
bitmap_light_sup_ptr           EQU #D068
bitmap_light_sup_n             EQU #D06A
bitmap_light_cxmin             EQU #D06B
bitmap_light_cxmax             EQU #D06C
bitmap_mush_cx                 EQU #D06D
bitmap_mush_cy                 EQU #D06E
bitmap_light_srx               EQU #D06F
bitmap_light_sry               EQU #D070
bitmap_light_srw               EQU #D071
bitmap_light_srh               EQU #D072
bitmap_light_tx0               EQU #D073
bitmap_light_ty0               EQU #D074
bitmap_light_tw                EQU #D075
bitmap_light_th                EQU #D076
bitmap_mush_ex                 EQU #D077
bitmap_mush_ey                 EQU #D078
bitmap_mush_flag               EQU #D079
bitmap_mush_sx                 EQU #D07A
bitmap_mush_sy                 EQU #D07B
bitmap_light_protect           EQU #D07D
bitmap_mush_flags              EQU #D07E
bitmap_bl_on                   EQU #D07F
bitmap_bl_x                    EQU #D080
bitmap_bl_y                    EQU #D081
...
bitmap_enemy_count EQU #D016
bitmap_enemy_pool  EQU #D017
bitmap_enemy_update_lane EQU #D02E
; --- MOVING PLATFORM runtime state (26 bytes): count + rider + 2 slot(s) x 11
; (x,y,dx,dy,minX,maxX,minY,maxY,widthCells,movedX,movedY) ---
bitmap_platform_count EQU #D030
bitmap_platform_rider EQU #D031
bitmap_platform_pool  EQU #D032
; Per-slot colour state: 0 = authored (normal room), 1 = dim, 2 = inside halo.
bitmap_platform_light_state EQU #D048
...
.skip_player_movement:
    ...
    call update_hud_linked_0    ; redraw linked HUD counter #0 (hud_el_ammo_nueces)
...
; ------------------------------------------------------------
; PURPOSE:
;   Numeric counter widget for linked HUD element "hud_el_ammo_nueces": 2
...
hud_linked_3_cmd_template:
    ; SY is a full 10-bit word: tile sources may live past VRAM row 255
    ; (page-1 offscreen band or after the shared atlas).
    DB 0,0, #40,#02, 0,0, 0,0, #10,0, #10,0, 0,0, #D0
; ------------------------------------------------------------
...
; ------------------------------------------------------------
upload_hud_linked_4:
    ld a, bitmap_room_hud_linked_4_rle_chunk_0_DATA_BANK
    call bitmap_room_select_data_bank_a
...
hud_linked_4_cmd_template:
    ; SY is a full 10-bit word: glyph sources may live past VRAM row 255
    ; (page-1 offscreen band or after the shared atlas).
    DB 0,0, #50,#02, 0,0, 0,0, 8,0, 8,0, 0,0, #D0
...
bitmap_gems_room_0:
    DB #30,#A0,#00,#01,#F0,#00,#00,#02,#30,#00,#B4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#00,#00,#30,#00,#B4,#00,#10,#00,#10,#00,#11
    DB #00,#C0,#40,#A0,#01,#01,#F0,#00,#00,#02,#40,#00,#B4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#00,#00,#40,#00,#B4,#00,#10,#00,#10
    DB #00,#11,#00,#C0,#B0,#90,#02,#01,#F0,#00,#00,#02,#B0,#00,#A4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#00,#B0,#00,#A4,#00,#10
    DB #00,#10,#00,#11,#00,#C0,#E0,#90,#03,#01,#F0,#00,#00,#02,#E0,#00
    DB #A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#00,#E0,#00,#A4
    DB #00,#10,#00,#10,#00,#11,#00,#C0,#90,#60,#04,#01,#F0,#00,#00,#02
    DB #90,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#00,#90
    DB #00,#74,#00,#10,#00,#10,#00,#11,#00,#C0,#70,#30,#05,#01,#F0,#00
    DB #00,#02,#70,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00
    DB #00,#70,#00,#44,#00,#10,#00,#10,#00,#11,#00,#C0
...
; Shared world tileset (atlas), packed 4bpp RLE; VRAM #10000, raw 8192 bytes, RLE 5262 bytes
bitmap_room_tileset_rle_chunk_0:
    ...
    DB #03,#33,#08,#00,#01,#13,#06,#33,#01,#31,#09,#00,#01,#0F,#02,#FF
    DB #01,#F8,#01,#EE,#01,#E0,#01,#00,#01,#FF,#01,#E0,#01,#00,#01,#0F
    DB #04,#FF,#08,#00,#04,#FF,#01,#F0,#01,#00,#01,#0E,#01,#8E,#01,#00
    DB #02,#EE,#01,#E8,#02,#FF,#01,#F0,#1C,#00,#01,#07,#01,#AA,#3B,#00
    DB #04,#FF,#01,#F8,#02,#EE,#01,#E0,#01,#FF,#01,#E0,#01,#EE,#01,#EB
    DB #03,#FF,#01,#FB,#01,#BE,#05,#00,#01,#0E,#01,#EB,#01,#BF,#03,#FF
    DB #01,#8E,#01,#EE,#01,#0E,#01,#8E,#01,#0E,#02,#EE,#01,#E8,#04,#FF
    DB #12,#00,#01,#07,#01,#70,#02,#00,#01,#07,#02,#77,#02,#00,#01,#0A
    DB #01,#AA,#3B,#00,#01,#FF,#01,#F0,#04,#00,#01,#0E,#01,#E0,#01,#BB
    ...
    DB #03,#00,#01,#26,#03,#00,#01,#07,#01,#77,#01,#70,#02,#00,#01,#22
    DB #05,#00,#01,#A2,#01,#70,#02,#00,#03,#77,#01,#70,#01,#07,#01,#7A
    DB #01,#AA,#3B,#00,#01,#FF,#01,#EE,#01,#E0,#03,#00,#01,#EE,#01,#E0
    ...
    DB #01,#77,#01,#22,#01,#27,#01,#70,#01,#07,#01,#7A,#01,#77,#3C,#00
    DB #02,#EE,#01,#EB,#03,#EE,#01,#E0,#01,#EE,#01,#00,#01,#0E,#01,#EE
    DB #01,#88,#01,#8E,#02,#EE,#01,#E0,#06,#00,#01,#0E,#02,#EE,#01,#88
    DB #01,#8E,#01,#EE,#01,#E0,#01,#00,#01,#EE,#01,#0E,#02,#EE,#01,#E8
    DB #01,#8E,#01,#EE,#01,#88,#04,#00,#01,#22,#01,#60,#01,#00,#01,#07
    DB #01,#72,#01,#22,#01,#77,#01,#70,#01,#AA,#06,#00,#01,#0A,#01,#AA
    DB #01,#77,#01,#07,#01,#72,#02,#22,#01,#77,#01,#07,#01,#A7,#01,#77
    DB #3D,#00,#01,#EE,#01,#EB,#02,#EE,#01,#00,#01,#04,#01,#BB,#01,#44
    DB #01,#0E,#01,#EE,#02,#88,#01,#EE,#09,#00,#01,#0E,#01,#EE,#02,#88
    DB #01,#EE,#01,#E0,#01,#4E,#01,#BA,#01,#40,#01,#00,#01,#EE,#01,#E8
    DB #01,#88,#01,#EE,#03,#00,#01,#07,#01,#70,#01,#06,#01,#67,#01,#70
    DB #01,#07,#01,#29,#01,#99,#01,#27,#01,#70,#01,#AA,#06,#00,#01,#07
    DB #01,#7A,#02,#77,#01,#29,#01,#9B,#01,#92,#01,#27,#01,#02,#02,#77
    DB #42,#00,#01,#44,#01,#BF,#01,#E4,#01,#40,#06,#00,#01,#04,#01,#AF
    DB #01,#FF,#01,#BE,#01,#E4,#07,#00,#01,#04,#01,#4E,#01,#FB,#01,#44
    DB #08,#00,#01,#06,#01,#60,#01,#07,#02,#77,#01,#06,#01,#29,#01,#BA
    DB #01,#22,#01,#77,#01,#A7,#01,#70,#01,#77,#01,#70,#02,#00,#01,#77
    DB #01,#00,#01,#7A,#01,#27,#01,#77,#01,#29,#01,#BB,#01,#B9,#01,#27
    DB #01,#22,#01,#27,#01,#77,#01,#00,#01,#70,#43,#00,#01,#0E,#06,#00
    DB #01,#04,#01,#EB,#01,#BB,#01,#8E,#01,#E4,#01,#44,#05,#00,#01,#0E
    DB #01,#E0,#0B,#00,#01,#06,#01,#A6,#01,#77,#01,#72,#01,#77,#01,#72
    DB #01,#29,#01,#BA,#01,#27,#01,#77,#01,#67,#01,#70,#01,#77,#01,#70
    DB #02,#00,#03,#77,#02,#22,#02,#99,#01,#BB,#01,#97,#01,#22,#01,#27
    DB #01,#77,#01,#07,#01,#77,#3F,#00,#01,#04,#01,#44,#01,#BF,#01,#E4
    DB #01,#40,#05,#00,#01,#04,#06,#44,#01,#40,#05,#00,#01,#04,#01,#4A
    DB #01,#FB,#01,#E4,#01,#40,#08,#00,#01,#A6,#01,#77,#01,#72,#01,#22
    DB #01,#77,#01,#22,#01,#A2,#02,#77,#01,#27,#02,#77,#01,#70,#01,#00
    DB #01,#07,#01,#72,#02,#77,#02,#22,#01,#29,#01,#22,#01,#AB,#01,#22
    DB #01,#29,#01,#22,#01,#77,#01,#07,#01,#A7,#44,#00,#01,#44,#03,#00
    DB #01,#0E,#01,#EE,#06,#00,#01,#EE,#01,#E0,#03,#00,#01,#44,#0D,#00
    DB #01,#AA,#01,#67,#01,#22,#01,#99,#01,#22,#01,#72,#01,#92,#01,#66
    DB #01,#72,#01,#22,#02,#77,#02,#00,#01,#07,#01,#22,#01,#27,#01,#72
    DB #01,#29,#01,#A2,#01,#22,#01,#29,#01,#9A,#01,#22,#01,#AA,#01,#A2
    DB #01,#27,#01,#79,#01,#A7,#08,#00,#01,#07,#01,#77,#35,#00,#01,#4E
    DB #01,#EE,#01,#E0,#02,#00,#02,#44,#01,#E0,#01,#00,#01,#FE,#01,#EE
    DB #01,#0E,#01,#AB,#01,#EE,#01,#E4,#01,#44,#01,#40,#02,#EE,#01,#00
    DB #03,#44,#02,#00,#01,#0E,#01,#EE,#01,#E4,#08,#00,#01,#76,#01,#96
    DB #01,#29,#01,#BB,#01,#92,#01,#22,#02,#99,#02,#92,#01,#27,#01,#70
    DB #02,#00,#01,#07,#01,#72,#02,#22,#02,#BB,#01,#92,#01,#9B,#01,#B9
    DB #01,#99,#01,#BB,#01,#BA,#02,#22,#01,#70,#08,#00,#03,#77,#01,#70
    DB #01,#22,#31,#00,#01,#FF,#01,#BB,#01,#BE,#01,#E0,#02,#44,#01,#40
    DB #01,#44,#01,#EE,#01,#E0,#01,#FA,#01,#EE,#01,#44,#02,#EE,#03,#44
    DB #01,#EA,#01,#A4,#01,#04,#02,#44,#01,#04,#02,#44,#01,#0E,#01,#AB
    DB #01,#BA,#01,#E0,#07,#00,#01,#77,#01,#66,#01,#2A,#01,#BB,#01,#B9
    DB #01,#A9,#01,#BB,#01,#9A,#01,#99,#01,#22,#01,#27,#01,#70,#01,#06
    DB #01,#60,#01,#07,#01,#77,#01,#22,#01,#2A,#02,#BB,#01,#A9,#01,#BB
    DB #01,#BA,#01,#AB,#01,#BF,#01,#BB,#01,#99,#01,#27,#01,#70,#05,#00
    DB #01,#22,#01,#00,#01,#07,#01,#72,#01,#99,#01,#27,#01,#70,#01,#62
    DB #31,#00,#01,#AA,#01,#BF,#01,#FE,#01,#40,#01,#AA,#02,#44,#01,#40
    DB #01,#4E,#01,#E0,#01,#BA,#01,#EE,#05,#44,#01,#4E,#01,#EE,#01,#AE
    DB #01,#04,#04,#44,#01,#AA,#01,#0E,#01,#EF,#01,#FA,#01,#E0,#06,#00
    DB #01,#07,#01,#77,#01,#76,#01,#AB,#01,#B9,#01,#29,#01,#DF,#01,#FB
    DB #01,#B9,#01,#DD,#01,#D2,#01,#27,#01,#77,#01,#76,#01,#96,#01,#00
    DB #01,#77,#01,#72,#01,#2B,#01,#BF,#01,#FB,#01,#AA,#01,#BF,#01,#BB
    DB #01,#AF,#01,#FF,#01,#FB,#01,#A9,#02,#77,#05,#00,#01,#22,#02,#77
    DB #01,#29,#01,#BB,#01,#97,#01,#77,#01,#70,#31,#00,#01,#4E,#02,#04
    ...
    DB #2F,#00,#01,#44,#02,#04,#01,#00,#01,#44,#01,#88,#01,#E4,#01,#40
    DB #01,#4E,#01,#EE,#01,#AE,#01,#EA,#01,#AE,#01,#EA,#01,#AB,#01,#AA
    DB #01,#E0,#01,#AA,#01,#AE,#01,#EE,#02,#44,#01,#0E,#01,#48,#01,#8A
    DB #01,#44,#01,#04,#02,#44,#01,#40,#06,#00,#01,#72,#01,#22,#01,#67
    DB #01,#22,#01,#99,#01,#DD,#02,#FF,#01,#FB,#01,#99,#01,#D2,#01,#27
    DB #01,#2A,#01,#67,#01,#00,#01,#77,#01,#22,#01,#29,#01,#99,#01,#BB
    DB #01,#9B,#01,#BF,#01,#FF,#01,#FB,#01,#BB,#01,#B9,#01,#BB,#01,#92
    DB #02,#22,#01,#77,#02,#00,#01,#02,#01,#20,#01,#00,#01,#72,#01,#27
    DB #01,#2B,#01,#BB,#02,#22,#03,#77,#2F,#00,#01,#44,#01,#00,#01,#04
    ...
    DB #6F,#00,#02,#EE,#01,#E0,#0A,#00,#01,#0E,#02,#EE,#64,#00
bitmap_room_tileset_rle_chunk_0_end:

; Linked HUD dynamic widget #0 (counter) tile/glyph data, packed 4bpp RLE; VRAM #06A00, raw 1024 bytes, RLE 452 bytes
...
; Linked HUD dynamic widget #1 (iconRow) tile/glyph data, packed 4bpp RLE; VRAM #07200, raw 2048 bytes, RLE 298 bytes
...
; Linked HUD dynamic widget #3 (iconRow) tile/glyph data, packed 4bpp RLE; VRAM #12000, raw 2048 bytes, RLE 360 bytes
...
; Linked HUD dynamic widget #4 (counter) tile/glyph data, packed 4bpp RLE; VRAM #12800, raw 1024 bytes, RLE 452 bytes
