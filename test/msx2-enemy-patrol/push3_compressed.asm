...
msx2_air_dash_timer EQU #C079
msx2_air_dash_cooldown EQU #C07A
msx2_air_dash_lock EQU #C07B
msx2_air_dash_direction EQU #C07C
...
msx2_player_colors_loaded EQU #C0A8
...
msx2_effects_runtime_buffers EQU #C0A9
...
init_hardware_sprites:
    ...
    ld a, #FF                       ; force update_msx2_player_frame_colors to load frame-0 sprite colours on the first frame
...
;   animation frame to the SCREEN 4 sprite colour table (#1C00),
...
;
; INPUT:
;   msx2_player_anim_frame    = current logical frame (0..1).
...
;   to the player's sprite colour planes at #1C00 and updates
;   msx2_player_colors_loaded.
;
; NOTES:
;   Source = msx2_hw_player_frame_colors + msx2_player_anim_frame * 32.
...
upload_hardware_sprite_attrs:
    ...
    call update_msx2_player_frame_colors
...
msx2_control_air_dash_pressed:
    ; ------------------------------------------------------------
    ; FUNCTION: msx2_control_air_dash_pressed
    ; PURPOSE: A=1 when the configured air dash skill input combo is held.
...
; Player anim frame 0 layer 0 per-line colours
msx2_hw_player_frame_0_colors_0:
    DB #05,#05,#05,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#0F,#0F,#0F
; Player anim frame 0 layer 1 per-line colours
msx2_hw_player_frame_0_colors_1:
    DB #05,#05,#05,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#05,#05,#05,#05
; Player anim frame 1 layer 0 per-line colours
msx2_hw_player_frame_1_colors_0:
    DB #05,#05,#0F,#06,#06,#06,#06,#06,#06,#06,#06,#06,#06,#0F,#0F,#0F
; Player anim frame 1 layer 1 per-line colours
msx2_hw_player_frame_1_colors_1:
    DB #05,#05,#05,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#0F,#05,#0F,#05,#05,#05
msx2_hw_player_frame_colors_end:

; pantalla1 collision layer, 16x12 bytes
PANTALLA1_COLLISION:
...
; pantalla1 effects layer, 16x12 bytes
PANTALLA1_EFFECTS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; pantalla1 behavior layer, 16x12 bytes
PANTALLA1_BEHAVIOR:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; pantalla1 packed cell flags (solid/effect/behavior), 16x12 bytes
PANTALLA1_CELL_FLAGS:
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#00,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#01,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#01,#00,#00,#01,#00
...
; pantalla1 per-tile hazard hitboxes (ox, oy, w, h)
PANTALLA1_TILE_HAZ_HIT:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#0C,#10,#04

; pantalla2 collision layer, 16x12 bytes
PANTALLA2_COLLISION:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; pantalla2 effects layer, 16x12 bytes
PANTALLA2_EFFECTS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; pantalla2 behavior layer, 16x12 bytes
PANTALLA2_BEHAVIOR:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; pantalla2 packed cell flags (solid/effect/behavior), 16x12 bytes
PANTALLA2_CELL_FLAGS:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; pantalla2 visual tile index map, 16x12 bytes
PANTALLA2_VISUAL_MAP:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; pantalla2 per-tile hazard hitboxes (ox, oy, w, h)
PANTALLA2_TILE_HAZ_HIT:
    DB #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
