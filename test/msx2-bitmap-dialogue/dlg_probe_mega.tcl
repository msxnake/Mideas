...
set out [open "test/msx2-bitmap-dialogue/probe_mega.log" w]
...
after time 8 {
    ...
    screenshot test/msx2-bitmap-dialogue/mega_shot1_typing.png
}
after time 11.5 {
    plog "typing done: state=[st] (expect 2 wait)"
    screenshot test/msx2-bitmap-dialogue/mega_shot2_line1.png
    keymatrixdown 8 0x20
}
after time 11.9 { keymatrixup 8 0x20 }
after time 12.5 {
    plog "line 2 typing: state=[st] (expect 1)"
    screenshot test/msx2-bitmap-dialogue/mega_shot3_line2.png
}
after time 15.5 {
...
after time 16.5 {
    ...
    screenshot test/msx2-bitmap-dialogue/mega_shot4_closed.png
