...
; ------------------------------------------------------------
; PURPOSE: Bullet-vs-target dispatch. Jumps to bitmap_enemy_bullet_hit (bitmap boss hit check).
...
bitmap_room_enemy_table_0:
    ...
    DB #01,#02,#03,#0C,#0A,#02,#01,#64,#30,#20,#01,#01,#00,#F0,#00,#B0
    DB #04,#04,#02,#06,#0D,#00,#00,#01,#02,#03,#0C,#0A,#02,#01,#64,#B0
