...
set log_path "C:/Users/salam/Documents/Programacion/Mideas/test/msx2-boss/test606_route_probe.txt"
...
proc snap {} {
    global ROOM PLR_X PLR_Y BOSS_X BOSS_Y BOSS_ACT TTBUF POOL
    set bw [mem8 [expr {$TTBUF + 13}]]
    logline "room=[mem8 $ROOM] player=([mem8 $PLR_X],[mem8 $PLR_Y]) boss_act=[mem8 $BOSS_ACT] boss=([mem8 $BOSS_X],[mem8 $BOSS_Y]) bw=$bw pool0=[mem8 $POOL]"
    after time 1 snap
}
snap
proc watch {} {
