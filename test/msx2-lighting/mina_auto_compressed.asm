...
bitmap_sm_state EQU #D009
bitmap_light_x                 EQU #D00A
bitmap_light_y                 EQU #D00B
bitmap_light_tx                EQU #D00C
bitmap_light_ty                EQU #D00D
bitmap_light_active            EQU #D00E
bitmap_light_page              EQU #D00F
bitmap_light_op_clr            EQU #D010
bitmap_light_op_cmd            EQU #D011
bitmap_light_d                 EQU #D012
bitmap_light_xsign             EQU #D013
bitmap_light_xadj              EQU #D014
bitmap_light_ybias             EQU #D015
bitmap_light_rx                EQU #D016
bitmap_light_ry                EQU #D017
bitmap_light_rw                EQU #D018
bitmap_light_rh                EQU #D01A
bitmap_light_band_y            EQU #D01B
bitmap_light_band_h            EQU #D01C
bitmap_light_band_hw           EQU #D01D
...
init_rom:
    ...
    call prepare_dark_atlas   ; dimmed twin: dark rooms compose from it directly
...
.bitmap_main_loop:
    ...
    ; Deferred dirty/variable-cost sprite VRAM copies. A late copy can affect
...
;   uploaded: rows 528..543 are a copy of rows 512..527 with bit 3 set
...
;   commands here cost ~36 ms at boot and are amortised after the first
;   two room entries.
;
; INPUT:  none.  OUTPUT: none.
; DESTROYS: AF, BC, DE, HL.  PRESERVES: IX, IY.
; SIDE EFFECTS: writes offscreen VRAM rows 528..543; leaves the command engine idle.
; ------------------------------------------------------------
prepare_dark_atlas:
...
bitmap_dark_atlas_cmds:
    ...
    DB #00,#00,#00,#02,#00,#00,#10,#02,#00,#01,#10,#00,#00,#00,#D0
    ; LMMV + logical OR over the twin: colour #08 sets bit 3 of every pixel.
    DB #00,#00,#00,#00,#00,#00,#10,#02,#00,#01,#10,#00,#08,#00,#82
...
;
;   A drift of less than 4 px is left pending (see MIN_STEP): each strip costs
;   the same whether it is 2 or 4 px wide, so waiting halves the frames that pay.
;
; INPUT:
;   bitmap_light_tx = wanted centre, bitmap_light_x = current centre.
;
; OUTPUT:
;   bitmap_light_x advanced by 4..8 px, or left alone.
;
; DESTROYS:
;   AF, BC, DE, HL.
; ------------------------------------------------------------
...
;
;   Same 4 px dead zone as the horizontal pass. Note this axis is the one that
...
;
; OUTPUT:
;   bitmap_light_y advanced by 4..8 px (never more than the
...
bitmap_light_bands:    ; signed Y offset from the halo centre, height, half width
    DB #E0, 16, 24
    DB #F0, 32, 40
    DB #10, 16, 24
...
bitmap_room_render_0_p0:
    DB #00,#00,#00,#00,#00,#00,#14,#00,#00,#01,#C0,#00,#99,#00,#C0,#A0
    DB #00,#10,#02,#00,#00,#14,#00,#10,#00,#10,#00,#00,#00,#D0,#A0,#00
    DB #10,#02,#10,#00,#14,#00,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10
    DB #02,#20,#00,#14,#00,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02
    DB #30,#00,#14,#00,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#40
    DB #00,#14,#00,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#50,#00
    DB #14,#00,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#60,#00,#14
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#70,#00,#14,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#80,#00,#14,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#90,#00,#14,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#A0,#00,#10,#02,#A0,#00,#14,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#A0,#00,#10,#02,#B0,#00,#14,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#A0,#00,#10,#02,#C0,#00,#14,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#A0,#00,#10,#02,#D0,#00,#14,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#A0,#00,#10,#02,#E0,#00,#14,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #A0,#00,#10,#02,#F0,#00,#14,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #24,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#24
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#24,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#24,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#24,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#24,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#24,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#24,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#24,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#24,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #34,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#34
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#34,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#34,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#34,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#34,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#34,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#34,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#34,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#34,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #44,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#44
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#44,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#44,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#44,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#44,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#44,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#44,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#44,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#44,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#54
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#54,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#54,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#54,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#54,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#54,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#54,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#54,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #64,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#64
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#64,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#64,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#64,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#64,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#64,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#64,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#64,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#64,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02
    DB #30,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#40
    DB #00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#74
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#74,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#74,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#74,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#10,#02,#A0,#00,#74,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#74,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#10,#02,#C0,#00,#74,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#74,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#84
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#84,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#84,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#84,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#84,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#84,#00,#10,#00,#10,#00
    ...
    DB #20,#00,#10,#02,#F0,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#94
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#94,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#94,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#94,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#94,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#94,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#94,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#94,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#10,#02,#F0,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#C0,#00
    DB #10,#02,#10,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#A4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#A4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#A4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#A4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#A4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#A4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#A4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#A4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#C0,#00,#10,#02,#E0,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#10,#02,#F0,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#80
    DB #00,#10,#02,#00,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00
    DB #10,#02,#10,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10
    DB #02,#20,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02
    DB #30,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#40
    DB #00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#E0,#00,#10,#02,#50,#00
    DB #B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#60,#00,#B4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#70,#00,#B4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#80,#00,#B4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#90,#00,#B4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#E0,#00,#10,#02,#A0,#00,#B4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#80,#00,#10,#02,#B0,#00,#B4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#80,#00,#10,#02,#C0,#00,#B4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#80,#00,#10,#02,#D0,#00,#B4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#80,#00,#10,#02,#E0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #80,#00,#10,#02,#F0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00
    DB #10,#02,#10,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10
    DB #02,#20,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02
    DB #30,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#60,#00,#10,#02,#40
    DB #00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#60,#00,#C4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10,#02,#70,#00,#C4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#80,#00,#C4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#90,#00,#C4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#60,#00,#10,#02,#A0,#00,#C4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#C4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#10,#02,#C0,#00,#C4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#10,#02,#D0,#00,#C4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#10,#02,#E0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#10,#02,#F0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0
; Room 0 page 1 render program: 193 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_0_p1:
    DB #00,#00,#00,#00,#00,#00,#14,#01,#00,#01,#C0,#00,#99,#00,#C0,#A0
    DB #00,#10,#02,#00,#00,#14,#01,#10,#00,#10,#00,#00,#00,#D0,#A0,#00
    DB #10,#02,#10,#00,#14,#01,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10
    DB #02,#20,#00,#14,#01,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02
    DB #30,#00,#14,#01,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#40
    DB #00,#14,#01,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#50,#00
    DB #14,#01,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#60,#00,#14
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#70,#00,#14,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#80,#00,#14,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#A0,#00,#10,#02,#90,#00,#14,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#A0,#00,#10,#02,#A0,#00,#14,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#A0,#00,#10,#02,#B0,#00,#14,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#A0,#00,#10,#02,#C0,#00,#14,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#A0,#00,#10,#02,#D0,#00,#14,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#A0,#00,#10,#02,#E0,#00,#14,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #A0,#00,#10,#02,#F0,#00,#14,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #24,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#24
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#24,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#24,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#24,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#24,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#24,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#24,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#24,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#24,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #34,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#34
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#34,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#34,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#34,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#34,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#34,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#34,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#34,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#34,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#44,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#44,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#44,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#44,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#44,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #44,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#44
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#44,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#44,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#44,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#44,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#44,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#44,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#44,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#44,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#44,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#54
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#54,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#54,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#54,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#54,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#54,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#54,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#54,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #64,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#64
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#64,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#64,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#64,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#64,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#64,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#64,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#64,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#64,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02
    DB #30,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#40
    DB #00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#74
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#74,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#74,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#74,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#10,#02,#A0,#00,#74,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#74,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#20,#00,#10,#02,#C0,#00,#74,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#74,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#84
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#84,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#84,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#84,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#84,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#84,#01,#10,#00,#10,#00
    ...
    DB #20,#00,#10,#02,#F0,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#94
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#94,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#94,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#94,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#94,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#94,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#94,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#94,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#10,#02,#F0,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#C0,#00
    DB #10,#02,#10,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#A4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#A4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#A4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#A4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#A4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#A4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#A4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#A4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#C0,#00,#10,#02,#E0,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #00,#00,#10,#02,#F0,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#80
    DB #00,#10,#02,#00,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00
    DB #10,#02,#10,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10
    DB #02,#20,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02
    DB #30,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#40
    DB #00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#E0,#00,#10,#02,#50,#00
    DB #B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#60,#00,#B4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#70,#00,#B4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#80,#00,#B4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#90,#00,#B4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#E0,#00,#10,#02,#A0,#00,#B4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#80,#00,#10,#02,#B0,#00,#B4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#80,#00,#10,#02,#C0,#00,#B4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#80,#00,#10,#02,#D0,#00,#B4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#80,#00,#10,#02,#E0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #80,#00,#10,#02,#F0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00
    DB #10,#02,#10,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10
    DB #02,#20,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02
    DB #30,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#60,#00,#10,#02,#40
    DB #00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#60,#00,#C4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10,#02,#70,#00,#C4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#80,#00,#C4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#90,#00,#C4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#60,#00,#10,#02,#A0,#00,#C4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#C4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#10,#02,#C0,#00,#C4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#10,#02,#D0,#00,#C4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#10,#02,#E0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #40,#00,#10,#02,#F0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0
...
bitmap_room_render_1_p0:
    ...
    DB #00,#54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #54,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#54
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#70,#00,#54,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#80,#00,#54,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#54,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#54,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#54,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#54,#00,#10,#00,#10,#00,#00
    ...
    DB #00,#10,#02,#00,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #74,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#74
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#74,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#74,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#74,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#74,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#74,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#74,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#74,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#74,#00,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#40
    DB #00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #84,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#84
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#84,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#84,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#84,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#10,#02,#A0,#00,#84,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#84,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#84,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#84,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#84,#00,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#10,#02,#00,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    ...
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#94,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#94,#00,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#10,#02,#00,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#C0,#00
    DB #10,#02,#10,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#C0,#00,#10,#02,#40
    DB #00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #A4,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#A4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#A4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#A4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#A4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#A4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#C0,#00,#10,#02,#B0,#00,#A4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#A4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#A4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#C0,#00,#10,#02,#E0,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#A4,#00,#10,#00,#10,#00,#00,#00,#D0,#80
    DB #00,#10,#02,#00,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00
    DB #10,#02,#10,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10
    DB #02,#20,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02
    DB #30,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#40
    DB #00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#50,#00
    DB #B4,#00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#60,#00,#B4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#70,#00,#B4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#80,#00,#B4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#90,#00,#B4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#80,#00,#10,#02,#A0,#00,#B4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#80,#00,#10,#02,#B0,#00,#B4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#80,#00,#10,#02,#C0,#00,#B4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#80,#00,#10,#02,#D0,#00,#B4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#80,#00,#10,#02,#E0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0
    ...
    DB #10,#02,#10,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10
    DB #02,#20,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02
    DB #30,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#40
    DB #00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #C4,#00,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#60,#00,#C4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10,#02,#70,#00,#C4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#80,#00,#C4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#90,#00,#C4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#10,#02,#A0,#00,#C4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#C4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#10,#02,#C0,#00,#C4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#10,#02,#D0,#00,#C4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#10,#02,#E0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0
...
bitmap_room_render_1_p1:
    ...
    DB #00,#54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #54,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#54
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#70,#00,#54,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#80,#00,#54,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#54,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#54,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#54,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#54,#01,#10,#00,#10,#00,#00
    ...
    DB #00,#10,#02,#00,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    DB #00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #74,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#74
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#74,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#74,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#74,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#74,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#00,#00,#10,#02,#B0,#00,#74,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#74,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#74,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#74,#01,#10,#00,#10,#00,#00,#00,#D0,#20
    DB #00,#10,#02,#00,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#40
    DB #00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #84,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#84
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#84,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#84,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#84,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#10,#02,#A0,#00,#84,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#84,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#84,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#84,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#84,#01,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#10,#02,#00,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00
    DB #10,#02,#10,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#40
    ...
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#94,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#00,#00,#10,#02,#E0,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#94,#01,#10,#00,#10,#00,#00,#00,#D0,#00
    DB #00,#10,#02,#00,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#C0,#00
    DB #10,#02,#10,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10
    DB #02,#20,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02
    DB #30,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#C0,#00,#10,#02,#40
    DB #00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#50,#00
    DB #A4,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#60,#00,#A4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#70,#00,#A4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#80,#00,#A4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#00,#00,#10,#02,#90,#00,#A4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#00,#00,#10,#02,#A0,#00,#A4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#C0,#00,#10,#02,#B0,#00,#A4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#00,#00,#10,#02,#C0,#00,#A4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#00,#00,#10,#02,#D0,#00,#A4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#C0,#00,#10,#02,#E0,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #20,#00,#10,#02,#F0,#00,#A4,#01,#10,#00,#10,#00,#00,#00,#D0,#80
    DB #00,#10,#02,#00,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00
    DB #10,#02,#10,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10
    DB #02,#20,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02
    DB #30,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#40
    DB #00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#50,#00
    DB #B4,#01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#60,#00,#B4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#70,#00,#B4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#80,#00,#B4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#80,#00,#10,#02,#90,#00,#B4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#80,#00,#10,#02,#A0,#00,#B4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#80,#00,#10,#02,#B0,#00,#B4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#80,#00,#10,#02,#C0,#00,#B4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#80,#00,#10,#02,#D0,#00,#B4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#80,#00,#10,#02,#E0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0
    ...
    DB #10,#02,#10,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10
    DB #02,#20,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02
    DB #30,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#40
    DB #00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#50,#00
    DB #C4,#01,#10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#60,#00,#C4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#40,#00,#10,#02,#70,#00,#C4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#80,#00,#C4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#20,#00,#10,#02,#90,#00,#C4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#20,#00,#10,#02,#A0,#00,#C4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#20,#00,#10,#02,#B0,#00,#C4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#40,#00,#10,#02,#C0,#00,#C4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#20,#00,#10,#02,#D0,#00,#C4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#20,#00,#10,#02,#E0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0
...
; Sprite 0 line color table (mode 2): configured player sprite "player_jump" + 4 state clip(s)
...
; Sprite 0 pattern (16x16, mode 2 quadrants): configured player sprite "player_jump" + 4 state clip(s)
...
; Player animation clip table: id 0 = base idle/walk, ids 1..4 = state
; clips. 3 bytes/entry: frameBase, frameCount, delayFrames. Indexed by player_anim_state.
; 1=IDLE(base 0,2f), 2=WALK(base 2,2f), 3=perceiving(base 4,1f), 4=ATTACK(base 5,1f)
bitmap_player_anim_clip_table:
    DB #00,#02,#08,#00,#02,#08,#02,#02,#08,#04,#01,#08,#05,#01,#08
