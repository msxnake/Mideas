...
msx2_stomp_active EQU #C07D
msx2_stomp_cooldown EQU #C07E
msx2_shake_timer EQU #C07F
...
update_hardware_sprite_input:
    ...
    ; power_stomp: try to start, then while active pin the fall and skip move/ladder.
...
msx2_control_power_stomp_pressed:
    ; ------------------------------------------------------------
    ; FUNCTION: msx2_control_power_stomp_pressed
    ; PURPOSE: A=1 when the configured power stomp input combo is held.
    ; INPUT: none (reads joystick/keyboard via BIOS).
    ; OUTPUT: A=1 pressed, A=0 not pressed (Z set when not pressed).
    ; DESTROYS: AF, BC, DE (GTSTCK / msx2_read_control_buttons BIOS paths).
    ; PRESERVES: HL, IX, IY.
...
msx2_screen_shake_update:
    ...
    ; INPUT: msx2_shake_timer (0 = idle, 1..5 = playing).
    ...
    dec a
    ld (msx2_shake_timer), a
    ; A = remaining timer after dec (0..4). Index table[A].
...
PANTALLA1_NAMES:
    ...
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0E,#0E,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0F,#0F,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0F,#0F,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0E,#0E,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0E,#0E,#0D,#0D,#0E,#0E,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0F,#0F,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0F,#0F,#0D,#0D,#0F,#0F,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0E,#0E,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0E,#0E,#0D,#0D,#0E,#0E,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0F,#0F,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D
    DB #0D,#0D,#0D,#0D,#0D,#0D,#0D,#0D,#0F,#0F,#0D,#0D,#0F,#0F,#0D,#0D
...
PANTALLA1_COLLISION:
    ...
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #01,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00
...
PANTALLA1_CELL_FLAGS:
    ...
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #01,#02,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00
...
PANTALLA1_VISUAL_MAP:
    ...
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #00,#00,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00,#01,#00
    DB #01,#03,#00,#01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#01,#00
