...
LODE_RUNNER_LEVEL_1_DATA_BANK EQU MSX2_SCREEN4_DATA_BANK_0
...
msx2_enemy_anim_counter EQU #C644
msx2_enemy_anim_frame EQU #C645
msx2_runtime_ram_end EQU #C646
...
update_hardware_sprite_vertical:
    ...
    ; Body hitbox: x=1, y=1, w=14, h=15. Vertical probes use inset 2.
...
upload_hardware_sprite_attrs:
    ...
    call update_msx2_enemy_behavior_states
...
update_msx2_enemy_behavior_states:
    ...
    or a
    ret nz
    call update_msx2_enemy_behavior_state_slot_0
    call update_msx2_enemy_behavior_state_slot_1
    call update_msx2_enemy_behavior_state_slot_2
    call update_msx2_enemy_behavior_state_slot_3
    call update_msx2_enemy_behavior_state_slot_4
    call update_msx2_enemy_behavior_state_slot_5
    call update_msx2_enemy_behavior_state_slot_6
    call update_msx2_enemy_behavior_state_slot_7
    call update_msx2_enemy_behavior_state_slot_8
    call update_msx2_enemy_behavior_state_slot_9
    call update_msx2_enemy_behavior_state_slot_10
    call update_msx2_enemy_behavior_state_slot_11
    ret

update_msx2_enemy_behavior_state_slot_0:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_0_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_0_x_dist_ready
.enemy_behavior_slot_0_x_player_right:
    sub b
.enemy_behavior_slot_0_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_0_far
    ld hl, msx2_enemy_runtime_y

    ld b, (hl)
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_0_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_0_y_dist_ready
.enemy_behavior_slot_0_y_player_below:
    sub b
.enemy_behavior_slot_0_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_0_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_0_store_mode
.enemy_behavior_slot_0_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_0_store_mode:
    ld hl, msx2_enemy_runtime_mode

    ld (hl), a
    ret

update_msx2_enemy_behavior_state_slot_1:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_1_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_1_x_dist_ready
.enemy_behavior_slot_1_x_player_right:
    sub b
.enemy_behavior_slot_1_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_1_far
    ld hl, msx2_enemy_runtime_y
    ld de, 1
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_1_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_1_y_dist_ready
.enemy_behavior_slot_1_y_player_below:
    sub b
.enemy_behavior_slot_1_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_1_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_1_store_mode
.enemy_behavior_slot_1_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_1_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 1
    add hl, de
...
update_msx2_enemy_behavior_state_slot_2:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_2_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_2_x_dist_ready
.enemy_behavior_slot_2_x_player_right:
    sub b
.enemy_behavior_slot_2_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_2_far
    ld hl, msx2_enemy_runtime_y
    ld de, 2
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_2_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_2_y_dist_ready
.enemy_behavior_slot_2_y_player_below:
    sub b
.enemy_behavior_slot_2_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_2_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_2_store_mode
.enemy_behavior_slot_2_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_2_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 2
    add hl, de
...
update_msx2_enemy_behavior_state_slot_3:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_3_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_3_x_dist_ready
.enemy_behavior_slot_3_x_player_right:
    sub b
.enemy_behavior_slot_3_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_3_far
    ld hl, msx2_enemy_runtime_y
    ld de, 3
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_3_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_3_y_dist_ready
.enemy_behavior_slot_3_y_player_below:
    sub b
.enemy_behavior_slot_3_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_3_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_3_store_mode
.enemy_behavior_slot_3_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_3_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 3
    add hl, de
...
update_msx2_enemy_behavior_state_slot_4:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_4_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_4_x_dist_ready
.enemy_behavior_slot_4_x_player_right:
    sub b
.enemy_behavior_slot_4_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_4_far
    ld hl, msx2_enemy_runtime_y
    ld de, 4
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_4_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_4_y_dist_ready
.enemy_behavior_slot_4_y_player_below:
    sub b
.enemy_behavior_slot_4_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_4_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_4_store_mode
.enemy_behavior_slot_4_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_4_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 4
    add hl, de
...
update_msx2_enemy_behavior_state_slot_5:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_5_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_5_x_dist_ready
.enemy_behavior_slot_5_x_player_right:
    sub b
.enemy_behavior_slot_5_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_5_far
    ld hl, msx2_enemy_runtime_y
    ld de, 5
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_5_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_5_y_dist_ready
.enemy_behavior_slot_5_y_player_below:
    sub b
.enemy_behavior_slot_5_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_5_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_5_store_mode
.enemy_behavior_slot_5_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_5_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 5
    add hl, de
...
update_msx2_enemy_behavior_state_slot_6:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_6_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_6_x_dist_ready
.enemy_behavior_slot_6_x_player_right:
    sub b
.enemy_behavior_slot_6_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_6_far
    ld hl, msx2_enemy_runtime_y
    ld de, 6
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_6_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_6_y_dist_ready
.enemy_behavior_slot_6_y_player_below:
    sub b
.enemy_behavior_slot_6_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_6_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_6_store_mode
.enemy_behavior_slot_6_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_6_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 6
    add hl, de
...
update_msx2_enemy_behavior_state_slot_7:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_7_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_7_x_dist_ready
.enemy_behavior_slot_7_x_player_right:
    sub b
.enemy_behavior_slot_7_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_7_far
    ld hl, msx2_enemy_runtime_y
    ld de, 7
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_7_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_7_y_dist_ready
.enemy_behavior_slot_7_y_player_below:
    sub b
.enemy_behavior_slot_7_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_7_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_7_store_mode
.enemy_behavior_slot_7_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_7_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 7
    add hl, de
...
update_msx2_enemy_behavior_state_slot_8:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_8_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_8_x_dist_ready
.enemy_behavior_slot_8_x_player_right:
    sub b
.enemy_behavior_slot_8_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_8_far
    ld hl, msx2_enemy_runtime_y
    ld de, 8
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_8_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_8_y_dist_ready
.enemy_behavior_slot_8_y_player_below:
    sub b
.enemy_behavior_slot_8_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_8_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_8_store_mode
.enemy_behavior_slot_8_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_8_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 8
    add hl, de
...
update_msx2_enemy_behavior_state_slot_9:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_9_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_9_x_dist_ready
.enemy_behavior_slot_9_x_player_right:
    sub b
.enemy_behavior_slot_9_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_9_far
    ld hl, msx2_enemy_runtime_y
    ld de, 9
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_9_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_9_y_dist_ready
.enemy_behavior_slot_9_y_player_below:
    sub b
.enemy_behavior_slot_9_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_9_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_9_store_mode
.enemy_behavior_slot_9_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_9_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 9
    add hl, de
...
update_msx2_enemy_behavior_state_slot_10:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_10_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_10_x_dist_ready
.enemy_behavior_slot_10_x_player_right:
    sub b
.enemy_behavior_slot_10_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_10_far
    ld hl, msx2_enemy_runtime_y
    ld de, 10
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_10_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_10_y_dist_ready
.enemy_behavior_slot_10_y_player_below:
    sub b
.enemy_behavior_slot_10_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_10_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_10_store_mode
.enemy_behavior_slot_10_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_10_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 10
    add hl, de
...
update_msx2_enemy_behavior_state_slot_11:
    ld a, (msx2_current_screen_index)
    ld e, a
    ld d, 0
    ld hl, msx2_screen_enemy_count
    ...
    ld a, (msx2_player_sprite_x)
    cp b
    jp nc, .enemy_behavior_slot_11_x_player_right
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_11_x_dist_ready
.enemy_behavior_slot_11_x_player_right:
    sub b
.enemy_behavior_slot_11_x_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    ...
    ld a, (hl)
    cp c
    jp c, .enemy_behavior_slot_11_far
    ld hl, msx2_enemy_runtime_y
    ld de, 11
    add hl, de
    ...
    ld a, (msx2_player_sprite_y)
    cp b
    jp nc, .enemy_behavior_slot_11_y_player_below
    ld c, a
    ld a, b
    sub c
    jp .enemy_behavior_slot_11_y_dist_ready
.enemy_behavior_slot_11_y_player_below:
    sub b
.enemy_behavior_slot_11_y_dist_ready:
    ld c, a
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
...
.enemy_behavior_slot_11_near:
    ...
    add hl, de
    ld a, (hl)
    jp .enemy_behavior_slot_11_store_mode
.enemy_behavior_slot_11_far:
    ld a, (msx2_current_screen_index)
    ld b, a
    xor a
    add a, b
    ...
    add hl, de
    ld a, (hl)
.enemy_behavior_slot_11_store_mode:
    ld hl, msx2_enemy_runtime_mode
    ld de, 11
    add hl, de
...
update_msx2_enemy_position_slot_0:
    ...
    cp 5
    jp z, .enemy_slot_0_flyer_sine
    cp 6
    jp z, .enemy_slot_0_jumper
    cp 7
    jp z, .enemy_slot_0_walker_edge
    cp 8
    jp z, .enemy_slot_0_chase_h
    ld hl, msx2_enemy_runtime_dx
...
update_msx2_enemy_position_slot_1:
    ...
    cp 5
    jp z, .enemy_slot_1_flyer_sine
    cp 6
    jp z, .enemy_slot_1_jumper
    cp 7
    jp z, .enemy_slot_1_walker_edge
    cp 8
    jp z, .enemy_slot_1_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 1
    add hl, de
...
.enemy_slot_1_walker_edge:
    ld b, 1
    jp msx2_enemy_walker_edge_shared

.enemy_slot_1_chase_h:
    ld b, 1
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_2:
    ...
    cp 5
    jp z, .enemy_slot_2_flyer_sine
    cp 6
    jp z, .enemy_slot_2_jumper
    cp 7
    jp z, .enemy_slot_2_walker_edge
    cp 8
    jp z, .enemy_slot_2_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 2
    add hl, de
...
.enemy_slot_2_walker_edge:
    ld b, 2
    jp msx2_enemy_walker_edge_shared

.enemy_slot_2_chase_h:
    ld b, 2
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_3:
    ...
    cp 5
    jp z, .enemy_slot_3_flyer_sine
    cp 6
    jp z, .enemy_slot_3_jumper
    cp 7
    jp z, .enemy_slot_3_walker_edge
    cp 8
    jp z, .enemy_slot_3_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 3
    add hl, de
...
.enemy_slot_3_walker_edge:
    ld b, 3
    jp msx2_enemy_walker_edge_shared

.enemy_slot_3_chase_h:
    ld b, 3
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_4:
    ...
    cp 5
    jp z, .enemy_slot_4_flyer_sine
    cp 6
    jp z, .enemy_slot_4_jumper
    cp 7
    jp z, .enemy_slot_4_walker_edge
    cp 8
    jp z, .enemy_slot_4_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 4
    add hl, de
...
.enemy_slot_4_walker_edge:
    ld b, 4
    jp msx2_enemy_walker_edge_shared

.enemy_slot_4_chase_h:
    ld b, 4
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_5:
    ...
    cp 5
    jp z, .enemy_slot_5_flyer_sine
    cp 6
    jp z, .enemy_slot_5_jumper
    cp 7
    jp z, .enemy_slot_5_walker_edge
    cp 8
    jp z, .enemy_slot_5_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 5
    add hl, de
...
.enemy_slot_5_walker_edge:
    ld b, 5
    jp msx2_enemy_walker_edge_shared

.enemy_slot_5_chase_h:
    ld b, 5
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_6:
    ...
    cp 5
    jp z, .enemy_slot_6_flyer_sine
    cp 6
    jp z, .enemy_slot_6_jumper
    cp 7
    jp z, .enemy_slot_6_walker_edge
    cp 8
    jp z, .enemy_slot_6_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 6
    add hl, de
...
.enemy_slot_6_walker_edge:
    ld b, 6
    jp msx2_enemy_walker_edge_shared

.enemy_slot_6_chase_h:
    ld b, 6
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_7:
    ...
    cp 5
    jp z, .enemy_slot_7_flyer_sine
    cp 6
    jp z, .enemy_slot_7_jumper
    cp 7
    jp z, .enemy_slot_7_walker_edge
    cp 8
    jp z, .enemy_slot_7_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 7
    add hl, de
...
.enemy_slot_7_walker_edge:
    ld b, 7
    jp msx2_enemy_walker_edge_shared

.enemy_slot_7_chase_h:
    ld b, 7
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_8:
    ...
    cp 5
    jp z, .enemy_slot_8_flyer_sine
    cp 6
    jp z, .enemy_slot_8_jumper
    cp 7
    jp z, .enemy_slot_8_walker_edge
    cp 8
    jp z, .enemy_slot_8_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 8
    add hl, de
...
.enemy_slot_8_walker_edge:
    ld b, 8
    jp msx2_enemy_walker_edge_shared

.enemy_slot_8_chase_h:
    ld b, 8
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_9:
    ...
    cp 5
    jp z, .enemy_slot_9_flyer_sine
    cp 6
    jp z, .enemy_slot_9_jumper
    cp 7
    jp z, .enemy_slot_9_walker_edge
    cp 8
    jp z, .enemy_slot_9_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 9
    add hl, de
...
.enemy_slot_9_walker_edge:
    ld b, 9
    jp msx2_enemy_walker_edge_shared

.enemy_slot_9_chase_h:
    ld b, 9
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_10:
    ...
    cp 5
    jp z, .enemy_slot_10_flyer_sine
    cp 6
    jp z, .enemy_slot_10_jumper
    cp 7
    jp z, .enemy_slot_10_walker_edge
    cp 8
    jp z, .enemy_slot_10_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 10
    add hl, de
...
.enemy_slot_10_flyer_sine:
    ld b, 10
    jp msx2_enemy_flyer_sine_shared

.enemy_slot_10_jumper:
    ld b, 10
    jp msx2_enemy_jumper_shared

.enemy_slot_10_walker_edge:
    ld b, 10
    jp msx2_enemy_walker_edge_shared

.enemy_slot_10_chase_h:
    ld b, 10
    jp msx2_enemy_chase_h_shared
...
update_msx2_enemy_position_slot_11:
    ...
    cp 5
    jp z, .enemy_slot_11_flyer_sine
    cp 6
    jp z, .enemy_slot_11_jumper
    cp 7
    jp z, .enemy_slot_11_walker_edge
    cp 8
    jp z, .enemy_slot_11_chase_h
    ld hl, msx2_enemy_runtime_dx
    ld de, 11
    add hl, de
...
.enemy_slot_11_flyer_sine:
    ld b, 11
    jp msx2_enemy_flyer_sine_shared

.enemy_slot_11_jumper:
    ld b, 11
    jp msx2_enemy_jumper_shared

.enemy_slot_11_walker_edge:
    ld b, 11
    jp msx2_enemy_walker_edge_shared

.enemy_slot_11_chase_h:
    ld b, 11
    jp msx2_enemy_chase_h_shared
...
init_msx2_effect_buffers:
    ...
    ; Clobbers AF/BC/DE/HL.
    ld a, LODE_RUNNER_LEVEL_1_DATA_BANK
...
msx2_screen_enemy_x:
    DB #A0,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
msx2_screen_enemy_max_x:
    DB #F0,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
msx2_screen_enemy_mode:
    DB #07,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
; Per-msx2screen enemy behavior state-switch flag, 12 slots per screen
msx2_screen_enemy_state_switch:
    DB #01,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

; Per-msx2screen enemy PlayerNear target movement mode, 12 slots per screen
msx2_screen_enemy_state_near_mode:
    DB #08,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

; Per-msx2screen enemy return movement mode, 12 slots per screen
msx2_screen_enemy_state_far_mode:
    DB #07,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

; Per-msx2screen enemy PlayerNear horizontal range in pixels, 12 slots per screen
msx2_screen_enemy_state_range_x:
    DB #30,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00

; Per-msx2screen enemy PlayerNear vertical range in pixels, 12 slots per screen
msx2_screen_enemy_state_range_y:
    DB #20,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
...
msx2_hw_sprite_frame_1_mirror_pattern_3:
    ...
    DB #00,#00,#00,#00,#00,#80,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
; Shared enemy/hazard hardware sprite frame 0 from MSX2 entity sprite asset
...
; Mirrored shared enemy/hazard hardware sprite frame 0: authored right
...
; Lode Runner Level 1 collision layer, copied from cold ROM to current RAM cache on screen load
...
; Lode Runner Level 1 effects layer, copied from cold ROM to RAM on screen reset
...
; Lode Runner Level 1 behavior layer, copied from cold ROM to current RAM cache on screen load
...
; Lode Runner Level 1 packed cell flags (solid/effect/behavior), copied from cold ROM to current RAM cache on screen load
...
; Lode Runner Level 1 visual tile index map copied to RAM on screen load
...
; Lode Runner Level 1 per-tile hazard hitboxes copied to RAM on screen load
