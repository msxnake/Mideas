...
; --- CRUMBLING FLOOR (Manic Miner) RAM (62 bytes at #D000) ---
...
bitmap_crumble_page       EQU #D000
bitmap_crumble_cell       EQU #D001
bitmap_crumble_frames     EQU #D002
bitmap_crumble_band       EQU #D003
bitmap_crumble_pool       EQU #D004
bitmap_crumble_debris     EQU #D034
...
init_rom:
    ...
    ; crumbling floor: chip pattern (32 bytes) -> VRAM #F900 + slot colour tables
...
;
; OUTPUT: SAT entries at VRAM #F608 onwards.
...
; Room 0 page 0 render program: 346 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_0_p0:
    ...
    DB #14,#00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#20,#00,#74
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#30,#00,#74,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#40,#00,#74,#00,#10
    DB #00,#10,#00,#00,#00,#D0
; Room 0 page 1 render program: 346 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_0_p1:
    ...
    DB #14,#01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#20,#00,#74
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#30,#00,#74,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#00,#00,#00,#02,#40,#00,#74,#01,#10
    DB #00,#10,#00,#00,#00,#D0
