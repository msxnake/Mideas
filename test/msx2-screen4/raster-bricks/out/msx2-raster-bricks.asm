...
;       "reason": "GameFlow WorldLink node world_ref_for_megarom_budget"
;     }
;   ],
;   "excludedAssets": [
;     {
...
;   "worldPackageSummary": [
;     {
;       "worldId": "world_msx2_raster_bricks",
;       "assetCount": 2,
;       "screenCount": 1,
;       "estimatedBytes": 6668,
;       "estimated8kBanks": 1,
...
;           },
;           {
;             "id": "worldmap.world_msx2_raster_bricks",
;             "usedBytes": 321,
;             "recommendedBankClass": "world.manifest"
;           }
;         ]
...
;         "packages": [
;           {
;             "packageId": "msx2screen.asset_screen_msx2_raster_bricks",
;             "type": "msx2screen",
...
;           },
;           {
;             "packageId": "worldmap.world_msx2_raster_bricks",
;             "type": "worldmap",
;             "sourceId": "world_msx2_raster_bricks",
...
;       {
;         "severity": "warning",
;         "target": "estimatedBank0",
;         "reason": "Estimated packed bank uses 7503/8192 bytes.",
...
msx2_gf_node_2:
    ...
    ld b, #0F
.msx2_gf_node_2_timed_step_0:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_0
    ld hl, #1802
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_1:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_1
    ld hl, #1804
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_2:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_2
    ld hl, #1806
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_3:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_3
    ld hl, #1808
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_4:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_4
    ld hl, #180A
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_5:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_5
    ld hl, #180C
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_6:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_6
    ld hl, #180E
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_7:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_7
    ld hl, #1810
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_8:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_8
    ld hl, #1812
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_9:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_9
    ld hl, #1814
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_10:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_10
    ld hl, #1816
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_11:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_11
    ld hl, #1818
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_12:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_12
    ld hl, #181A
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_13:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_13
    ld hl, #181C
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_14:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_14
    ld hl, #181E
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_15:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_15
    ld hl, #185E
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_16:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_16
    ld hl, #189E
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_17:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_17
    ld hl, #18DE
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_18:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_18
    ld hl, #191E
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_19:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_19
    ld hl, #195E
    ld b, 2
    ld c, 2
    call clear_screen4_name_rect
    ...
    call clear_screen4_name_rect
    ld b, #0F
.msx2_gf_node_2_timed_step_20:
    call wait_frame_busy
    djnz .msx2_gf_node_2_timed_step_20
