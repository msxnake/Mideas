...
; Project: msx2_bitmap_room_smoke_sway
...
; --- GRASS SWAY RAM (52 bytes at #D000) ---
; 10 swaying cell(s) over 1 frame set(s). Cosmetic only:
...
bitmap_sway_page       EQU #D000
bitmap_sway_cell       EQU #D001
bitmap_sway_set        EQU #D002
bitmap_sway_budget     EQU #D003
; Body sample scratch, both #FF-terminated: 2 column(s) x 2 row(s) for a
; 16x16 hitbox.
bitmap_sway_cols       EQU #D004
bitmap_sway_cells      EQU #D007
bitmap_sway_pool       EQU #D00C
...
init_rom:
    ...
    call init_bitmap_hud_band
    call bitmap_sway_reset_visible      ; grass comes back upright
    ...
    ; grass sway: no page yet, empty pool (#FF = free slot).
    xor a
...
.commit_enter_left:
    ...
    ld (player_x), a
.commit_flip_page:
    call bitmap_sway_reset_pending      ; grass comes back upright
...
.movement_done:
    ...
    ; 16px tall standing on a ledge whose top is at y=32 sits at exactly
...
bitmap_try_move_y:
    ...
    ; blocked. Probes X cols 0/15. Clobbers AF/BC/DE/HL.
...
bitmap_settle_top_entry:
    ...
    ; 16px tall, so its bottom edge lands at 2+15=17, i.e. INSIDE cell
    ; row 1 whenever the destination room has a ledge tucked under the ceiling.
...
.deadly_invuln_done:
    ...
    ; Probe the WHOLE body for a deadly cell: 2 rows x 3 columns.
...
; ------------------------------------------------------------
; PURPOSE:
;   Address the 10-byte record of sway set A.
;
; INPUT: A = set index.
; OUTPUT: HL = bitmap_sway_set_table + A * 10.
...
;   2 per frame so the CPU never waits on more than one queued 16x16
...
; Raw bytes: 2048; encoded bytes: 1094
; VRAM #10000, raw 2048 bytes, RLE 1094 bytes
bitmap_room_tileset_rle_chunk_0:
    ...
    DB #01,#1F,#03,#FF,#01,#1F,#02,#FF,#01,#F1,#01,#00,#06,#FF,#04,#00
    DB #02,#CC,#33,#00,#01,#18,#03,#88,#01,#18,#02,#88,#01,#81,#01,#19
    DB #03,#99,#01,#19,#02,#99,#01,#91,#01,#1A,#03,#AA,#01,#1A,#02,#AA
    DB #01,#A1,#01,#1C,#03,#CC,#01,#1C,#02,#CC,#01,#C1,#01,#17,#03,#77
    DB #01,#17,#02,#77,#01,#71,#01,#15,#03,#55,#01,#15,#02,#55,#01,#51
    DB #01,#1D,#03,#DD,#01,#1D,#02,#DD,#01,#D1,#01,#1F,#03,#FF,#01,#1F
    DB #02,#FF,#01,#F1,#01,#00,#01,#FF,#04,#AA,#01,#FF,#04,#00,#02,#CC
    DB #33,#00,#01,#18,#03,#88,#01,#18,#02,#88,#01,#81,#01,#19,#03,#99
    ...
    DB #01,#F1,#01,#00,#01,#FF,#04,#AA,#01,#FF,#04,#00,#02,#CC,#33,#00
    ...
    DB #01,#00,#01,#FF,#01,#AA,#02,#DD,#01,#AA,#01,#FF,#04,#00,#02,#CC
    DB #33,#00,#01,#18,#03,#88,#01,#18,#02,#88,#01,#81,#01,#19,#03,#99
    DB #01,#19,#02,#99,#01,#91,#01,#1A,#03,#AA,#01,#1A,#02,#AA,#01,#A1
    DB #01,#1C,#03,#CC,#01,#1C,#02,#CC,#01,#C1,#01,#17,#03,#77,#01,#17
    DB #02,#77,#01,#71,#01,#15,#03,#55,#01,#15,#02,#55,#01,#51,#01,#1D
    DB #03,#DD,#01,#1D,#02,#DD,#01,#D1,#01,#1F,#03,#FF,#01,#1F,#02,#FF
    DB #01,#F1,#01,#00,#01,#FF,#01,#AA,#02,#DD,#01,#AA,#01,#FF,#04,#00
    DB #02,#CC,#33,#00,#01,#18,#03,#88,#01,#18,#02,#88,#01,#81,#01,#19
    DB #03,#99,#01,#19,#02,#99,#01,#91,#01,#1A,#03,#AA,#01,#1A,#02,#AA
    DB #01,#A1,#01,#1C,#03,#CC,#01,#1C,#02,#CC,#01,#C1,#01,#17,#03,#77
    DB #01,#17,#02,#77,#01,#71,#01,#15,#03,#55,#01,#15,#02,#55,#01,#51
    ...
    DB #04,#00,#02,#CC,#33,#00,#40,#11,#01,#00,#01,#FF,#01,#AA,#02,#DD
    DB #01,#AA,#01,#FF,#02,#00,#01,#0A,#04,#AA,#01,#A0,#31,#00,#01,#18
    ...
    DB #01,#FF,#01,#AA,#02,#DD,#01,#AA,#01,#FF,#02,#00,#01,#0A,#04,#AA
    DB #01,#A0,#31,#00,#01,#18,#06,#88,#01,#81,#01,#19,#06,#99,#01,#91
    DB #01,#1A,#06,#AA,#01,#A1,#01,#1C,#06,#CC,#01,#C1,#01,#17,#06,#77
    DB #01,#71,#01,#15,#06,#55,#01,#51,#01,#1D,#06,#DD,#01,#D1,#01,#1F
    DB #06,#FF,#01,#F1,#01,#00,#01,#FF,#01,#AA,#02,#DD,#01,#AA,#01,#FF
    DB #02,#00,#01,#0A,#04,#AA,#01,#A0,#31,#00,#01,#18,#06,#88,#01,#81
    ...
    DB #01,#FF,#02,#00,#01,#0A,#04,#AA,#01,#A0,#31,#00,#01,#18,#06,#88
    ...
    DB #04,#AA,#01,#FF,#02,#00,#01,#0A,#04,#AA,#01,#A0,#31,#00,#01,#18
    DB #06,#88,#01,#81,#01,#19,#06,#99,#01,#91,#01,#1A,#06,#AA,#01,#A1
    DB #01,#1C,#06,#CC,#01,#C1,#01,#17,#06,#77,#01,#71,#01,#15,#06,#55
    DB #01,#51,#01,#1D,#06,#DD,#01,#D1,#01,#1F,#06,#FF,#01,#F1,#01,#00
    DB #06,#FF,#03,#00,#01,#0F,#02,#FF,#01,#F0,#32,#00,#01,#18,#06,#88
    DB #01,#81,#01,#19,#06,#99,#01,#91,#01,#1A,#06,#AA,#01,#A1,#01,#1C
    DB #06,#CC,#01,#C1,#01,#17,#06,#77,#01,#71,#01,#15,#06,#55,#01,#51
    DB #01,#1D,#06,#DD,#01,#D1,#01,#1F,#06,#FF,#01,#F1,#01,#00,#06,#FF
    DB #03,#00,#01,#0F,#02,#FF,#01,#F0,#32,#00,#40,#11,#0A,#00,#01,#0F
    DB #02,#FF,#01,#F0,#32,#00
...
; Room 0 swaying cells: cell index, sway set index
bitmap_sway_room_0:
    DB #00,#00,#A4,#00,#A5,#00,#A6,#00,#A7,#00,#A8,#00,#A9,#00,#AA,#00
    DB #AB,#00,#AC,#00
; Room 1 swaying cells: cell index, sway set index
bitmap_sway_room_1:
    DB #00
bitmap_sway_ptr_table:
    DW bitmap_sway_room_0
    DW bitmap_sway_room_1
bitmap_sway_count_table:
    DB 10,0
; Sway sets (10 bytes each): holdFrames, then rest/left/right frame as sx, syLow, syHigh (absolute VRAM source of the 16x16 atlas region)
bitmap_sway_set_table:
    DB #0C,#30,#00,#02,#00,#00,#02,#40,#00,#02




; Per-room render programs, collision maps and behavior maps.
; Room 0 page 0 render program: 368 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_0_p0:
    ...
    DB #14,#00,#10,#00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#40,#00,#B4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#50,#00,#B4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#60,#00,#B4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#70,#00,#B4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#30,#00,#00,#02,#80,#00,#B4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#30,#00,#00,#02,#90,#00,#B4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#30,#00,#00,#02,#A0,#00,#B4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#30,#00,#00,#02,#B0,#00,#B4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#30,#00,#00,#02,#C0,#00,#B4,#00,#10,#00,#10,#00,#00,#00,#D0
    DB #70,#00,#00,#02,#00,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#70
    DB #00,#00,#02,#10,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#70,#00
    DB #00,#02,#20,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00
    DB #02,#30,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02
    DB #40,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#50
    DB #00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#60,#00
    DB #C4,#00,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#70,#00,#C4
    DB #00,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#80,#00,#C4,#00
    DB #10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#90,#00,#C4,#00,#10
    DB #00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#A0,#00,#C4,#00,#10,#00
    DB #10,#00,#00,#00,#D0,#70,#00,#00,#02,#B0,#00,#C4,#00,#10,#00,#10
    DB #00,#00,#00,#D0,#70,#00,#00,#02,#C0,#00,#C4,#00,#10,#00,#10,#00
    DB #00,#00,#D0,#70,#00,#00,#02,#D0,#00,#C4,#00,#10,#00,#10,#00,#00
    DB #00,#D0,#70,#00,#00,#02,#E0,#00,#C4,#00,#10,#00,#10,#00,#00,#00
    DB #D0,#70,#00,#00,#02,#F0,#00,#C4,#00,#10,#00,#10,#00,#00,#00,#D0
; Room 0 page 1 render program: 368 V9938 command blocks (clear + 16x16 tile copies)
bitmap_room_render_0_p1:
    ...
    DB #14,#01,#10,#00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#40,#00,#B4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#50,#00,#B4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#60,#00,#B4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#30,#00,#00,#02,#70,#00,#B4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#30,#00,#00,#02,#80,#00,#B4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#30,#00,#00,#02,#90,#00,#B4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#30,#00,#00,#02,#A0,#00,#B4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#30,#00,#00,#02,#B0,#00,#B4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#30,#00,#00,#02,#C0,#00,#B4,#01,#10,#00,#10,#00,#00,#00,#D0
    DB #70,#00,#00,#02,#00,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#70
    DB #00,#00,#02,#10,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#70,#00
    DB #00,#02,#20,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00
    DB #02,#30,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02
    DB #40,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#50
    DB #00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#60,#00
    DB #C4,#01,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#70,#00,#C4
    DB #01,#10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#80,#00,#C4,#01
    DB #10,#00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#90,#00,#C4,#01,#10
    DB #00,#10,#00,#00,#00,#D0,#70,#00,#00,#02,#A0,#00,#C4,#01,#10,#00
    DB #10,#00,#00,#00,#D0,#70,#00,#00,#02,#B0,#00,#C4,#01,#10,#00,#10
    DB #00,#00,#00,#D0,#70,#00,#00,#02,#C0,#00,#C4,#01,#10,#00,#10,#00
    DB #00,#00,#D0,#70,#00,#00,#02,#D0,#00,#C4,#01,#10,#00,#10,#00,#00
    DB #00,#D0,#70,#00,#00,#02,#E0,#00,#C4,#01,#10,#00,#10,#00,#00,#00
    DB #D0,#70,#00,#00,#02,#F0,#00,#C4,#01,#10,#00,#10,#00,#00,#00,#D0
