...
exports.MSX2_BITMAP_ICE_SLIDE_RAM_BYTES = void 0;
exports.bitmapIceSlideEnabled = bitmapIceSlideEnabled;
exports.buildBitmapIceSlideEquates = buildBitmapIceSlideEquates;
exports.buildBitmapIceSlideInitClearAsm = buildBitmapIceSlideInitClearAsm;
exports.buildBitmapIceSlideHorizontalHookAsm = buildBitmapIceSlideHorizontalHookAsm;
exports.buildBitmapIceSlideRuntimeAsm = buildBitmapIceSlideRuntimeAsm;
exports.MSX2_BITMAP_ICE_SLIDE_RAM_BYTES = 4;
function asmWord(value) {
    return `#${Math.max(0, Math.min(0xffff, value)).toString(16).toUpperCase().padStart(4, '0')}`;
}
function bitmapIceSlideEnabled(config) {
    return !!config.enabled;
}
function buildBitmapIceSlideEquates(config, ramBase) {
    if (!bitmapIceSlideEnabled(config))
        return '';
...
function buildBitmapIceSlideInitClearAsm(config) {
    if (!bitmapIceSlideEnabled(config))
        return '';
    return `    xor a
    ld (bitmap_ice_vx), a
...
function buildBitmapIceSlideHorizontalHookAsm(config) {
    if (!bitmapIceSlideEnabled(config))
        return '';
    return `    push bc
...
function buildBitmapIceSlideRuntimeAsm(config) {
    if (!bitmapIceSlideEnabled(config))
        return '';
