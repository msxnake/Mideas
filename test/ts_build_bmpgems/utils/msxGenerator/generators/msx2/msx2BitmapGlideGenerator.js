...
exports.MSX2_BITMAP_GLIDE_RAM_BYTES = void 0;
exports.bitmapGlideEnabled = bitmapGlideEnabled;
exports.buildBitmapGlideEquates = buildBitmapGlideEquates;
exports.buildBitmapGlideInitClearAsm = buildBitmapGlideInitClearAsm;
exports.buildBitmapGlideGravityHookAsm = buildBitmapGlideGravityHookAsm;
exports.buildBitmapGlideRuntimeAsm = buildBitmapGlideRuntimeAsm;
/**
 ...
 */
exports.MSX2_BITMAP_GLIDE_RAM_BYTES = 2;
...
function bitmapGlideEnabled(config) {
    return Boolean(config?.enabled);
}
function buildBitmapGlideEquates(config, ramBase) {
    if (!bitmapGlideEnabled(config))
        return '';
...
function buildBitmapGlideInitClearAsm(config) {
    if (!bitmapGlideEnabled(config))
        return '';
...
function buildBitmapGlideGravityHookAsm(config) {
    if (!bitmapGlideEnabled(config))
        return '';
    return `    call bitmap_apply_glide_clamp
`;
}
function buildBitmapGlideRuntimeAsm(config) {
    if (!config || !bitmapGlideEnabled(config))
        return '';
