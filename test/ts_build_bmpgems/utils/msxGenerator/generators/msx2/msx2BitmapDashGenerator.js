...
exports.MSX2_BITMAP_DASH_RAM_BYTES = exports.MSX2_BITMAP_DASH_RAM_BASE = void 0;
exports.bitmapDashEnabled = bitmapDashEnabled;
exports.buildBitmapDashEquates = buildBitmapDashEquates;
exports.buildBitmapDashInitClearAsm = buildBitmapDashInitClearAsm;
exports.buildBitmapDashGateAsm = buildBitmapDashGateAsm;
exports.buildBitmapDashRuntimeAsm = buildBitmapDashRuntimeAsm;
/**
 ...
 */
exports.MSX2_BITMAP_DASH_RAM_BASE = 0xC0DA;
exports.MSX2_BITMAP_DASH_RAM_BYTES = 4;
...
function bitmapDashEnabled(config) {
    return Boolean(config?.enabled);
}
/** RAM EQU block (empty when the dash is disabled). */
function buildBitmapDashEquates(config) {
    if (!bitmapDashEnabled(config))
        return '';
    const base = exports.MSX2_BITMAP_DASH_RAM_BASE;
...
function buildBitmapDashInitClearAsm(config) {
    if (!bitmapDashEnabled(config))
        return '';
    return `    xor a
...
function buildBitmapDashGateAsm(config) {
    if (!bitmapDashEnabled(config))
        return '';
...
function buildBitmapDashRuntimeAsm(config, stateAnimIds = {}) {
    if (!config || !bitmapDashEnabled(config))
        return '';
