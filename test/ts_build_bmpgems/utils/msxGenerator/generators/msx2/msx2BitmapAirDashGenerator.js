...
exports.MSX2_BITMAP_AIR_DASH_RAM_BYTES = void 0;
exports.bitmapAirDashEnabled = bitmapAirDashEnabled;
exports.buildBitmapAirDashEquates = buildBitmapAirDashEquates;
exports.buildBitmapAirDashInitClearAsm = buildBitmapAirDashInitClearAsm;
exports.buildBitmapAirDashGateAsm = buildBitmapAirDashGateAsm;
exports.buildBitmapAirDashRuntimeAsm = buildBitmapAirDashRuntimeAsm;
/**
 ...
 */
exports.MSX2_BITMAP_AIR_DASH_RAM_BYTES = 4;
...
function bitmapAirDashEnabled(config) {
    return Boolean(config?.enabled);
}
function buildBitmapAirDashEquates(config, ramBase) {
    if (!bitmapAirDashEnabled(config))
        return '';
...
function buildBitmapAirDashInitClearAsm(config) {
    if (!bitmapAirDashEnabled(config))
        return '';
    return `    xor a
...
function buildBitmapAirDashKeyCheck(key) {
    if (!key) {
        return `    xor a
    ret
`;
...
function buildBitmapAirDashPressedRoutine(config) {
 ...
 */
function buildBitmapAirDashGateAsm(config) {
    if (!bitmapAirDashEnabled(config))
        return '';
...
function buildBitmapAirDashRuntimeAsm(config, options = {}) {
    if (!config || !bitmapAirDashEnabled(config))
        return '';
