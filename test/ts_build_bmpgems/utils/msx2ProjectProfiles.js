...
exports.MSX2_ENTITY_TEMPLATE_ID_PREFIX = exports.MSX2_GAME_PROFILE_OPTIONS = exports.MSX2_NOT_IMPLEMENTED_GAME_PROFILE_IDS = exports.MSX2_EXPERIMENTAL_GAME_PROFILE_IDS = exports.MSX2_CREATABLE_GAME_PROFILE_IDS = void 0;
...
exports.detectMsx2ScreenModeConflict = detectMsx2ScreenModeConflict;
exports.getMsx2ScreenModeConflictMessage = getMsx2ScreenModeConflictMessage;
...
exports.MSX2_EXPERIMENTAL_GAME_PROFILE_IDS = ['bitmapPlatform'];
/** Profile ids surfaced with a "Not implemented" badge in the picker (backend pending). */
exports.MSX2_NOT_IMPLEMENTED_GAME_PROFILE_IDS = [
    'maze',
    'shooterVertical',
    'shooterHorizontal',
];
exports.MSX2_GAME_PROFILE_OPTIONS = exports.MSX2_CREATABLE_GAME_PROFILE_IDS.map(id => ({
    ...
    previewKind: id,
    experimental: exports.MSX2_EXPERIMENTAL_GAME_PROFILE_IDS.includes(id),
    notImplemented: exports.MSX2_NOT_IMPLEMENTED_GAME_PROFILE_IDS.includes(id),
}));
 ...
 */
function detectMsx2ScreenModeConflict(assets) {
    let hasTileScreens = false;
    let hasBitmapRooms = false;
    for (const asset of assets || []) {
        if (asset?.type === 'msx2screen')
            hasTileScreens = true;
        else if (asset?.type === 'msx2bitmaproom')
            hasBitmapRooms = true;
    }
 ...
 */
function getMsx2ScreenModeConflictMessage(assets) {
    if (!detectMsx2ScreenModeConflict(assets).conflict)
        return null;
    return ('MSX2 export blocked: this project mixes tile SCREEN 4 screens (MSX2 SCREEN 4 Rooms) and ' +
