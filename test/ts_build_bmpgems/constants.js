...
exports.EDITABLE_TILE_DIMENSIONS = Array.from({ length: 16 }, (_, index) => (index + 1) * 8);
...
exports.DEFAULT_MSX2_SCREEN5_PRESENTATION_CONFIG = {
    enabled: false,
    ...
    height: 192,
    fitMode: 'cover',
    palette: exports.DEFAULT_SCREEN5_CUSTOM_PALETTE.map(slot => ({ ...slot })),
