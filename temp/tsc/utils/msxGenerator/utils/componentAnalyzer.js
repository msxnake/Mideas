 ...
 */
export function analyzeComponentUsage(analysis) {
 ...
 */
export function isComponentUsed(componentName, analysis) {
    return analysis.usedComponents.has(componentName);
}
/**
 * Get entities that use a specific component
 */
export function getEntitiesWithComponent(componentName, analysis) {
 ...
 */
export function generateEntityComponentMask(entity, template, analysis) {
    let mask = 0;
