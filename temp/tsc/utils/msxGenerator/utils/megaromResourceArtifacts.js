...
export function buildResourceIdLabelFromAsmLabel(label) {
...
export function renderNamedArtifactAsCommentBlock(fileName, content) {
...
export function buildMegaromGeneratedArtifacts(packResult, mapperWindow) {
...
export function renderMegaromGeneratedArtifactsAsCommentBlocks(packResult, mapperWindow) {
