...
import { buildMegaromGeneratedArtifacts, renderMegaromGeneratedArtifactsAsCommentBlocks, renderNamedArtifactAsCommentBlock, } from '../utils/megaromResourceArtifacts';
/**
 ...
 */
export function generateUnifiedFile(files, projectName, analysis, executionPlan, config = {
    romMode: 'simple32k',
    targetFormat: 'konami',
    autoMegaROM: false
}) {
    ...
    const bankPackReport = buildBankPackReport(files);
