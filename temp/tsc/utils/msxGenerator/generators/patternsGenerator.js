...
import { buildReferencedScreen2TileBanks, getScreen2TileBankIdLabel, getScreen2TileBankPatternLoaderLabel, } from '../utils/screen2TileBanks';
import { usesMapperBanking } from './romModeUtils';
import { buildMapperBankEqu, buildMapperDataPopAsm, buildMapperDataPushAsm, buildMapperWindowedAddress, getMapperWindowConfig, } from './mapperWindowUtils';
 ...
 */
export function generatePatternsFile(analysis, romMode = 'simple32k', dataInBank4 = false, targetFormat = 'konami') {
...
`;
    ...
    const dataHl = (label) => usesMapper ? buildMapperWindowedAddress(label, mapperWindow) : label;
 ...
 */
export function getPatternsBank4Data(analysis) {
    if (!analysis.tiles || analysis.tiles.length === 0) {
