...
export function buildPage0Plan(analysis, romMode = 'simple32k', fontRawData) {
    if (romMode !== 'plain48k') {
...
export function presentationScreenUsesPage0Group(analysis, romMode = 'plain48k') {
    return buildPage0Plan(analysis, romMode).selectedGroups.some(group => group.id === 'presentationScreen');
}
export function fontDataUsesPage0Group(analysis, romMode = 'plain48k', fontRawData) {
    return buildPage0Plan(analysis, romMode, fontRawData).selectedGroups.some(group => group.id === 'fontData');
}
export function hasPage0DataGroups(analysis, romMode = 'simple32k', fontRawData) {
    return buildPage0Plan(analysis, romMode, fontRawData).selectedGroups.length > 0;
}
export function page0NeedsZx0Decoder(analysis, romMode = 'simple32k', fontRawData) {
...
export function formatPage0PlanComments(plan) {
    const lines = [
...
export function generatePage0File(analysis, romMode = 'simple32k', fontRawData) {
