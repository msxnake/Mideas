 ...
 */
export function generateSoundFile(analysis, executionPlan, romMode = 'simple32k') {
...
export function getSerializedTrackerMusicBufferSize(analysis) {
...
export function getSoundBank4Data(analysis) {
    const tracks = collectSerializedTrackerTracks(analysis);
    if (tracks.length === 0) {
        return '';
    }
