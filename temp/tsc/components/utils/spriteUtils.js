 ...
 */
export const generateSpriteBinaryData = (sprite) => {
 ...
 */
export const mirrorPixelDataHorizontally = (pixelData) => {
 ...
 */
export const mirrorPixelDataVertically = (pixelData) => {
 ...
 */
export const buildMSXDirectionalSpriteCatalog = (sourceSprites) => {
    const warnings = [];
 ...
 */
export const generateSingleFrameASMCode = (frameName, frameData, spritePalette, backgroundColor, spriteWidth, spriteHeight, dataFormat = 'hex', layerIndexesToExport) => {
 ...
 */
export const generateSpriteASMCode = (sprite, dataFormat = 'hex', uniqueIndex) => {
    ...
    sprite.frames.forEach((frame, index) => {
        fullAsmCode += generateSingleFrameASMCode(`${uniqueName}_F${index}`, frame.data, sprite.spritePalette, sprite.backgroundColor, sprite.size.width, sprite.size.height, dataFormat, usedLayerIndexes);
    });
    return fullAsmCode;
};
