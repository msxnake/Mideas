import { EFFECT_ZONE_TYPE_CONFIG as EFFECT_ZONE_TYPE_CONFIG_TYPE } from './types';
 ...
 */
export const MSX_SCREEN5_PALETTE = [
...
export const MSX2_COLOR_LEVELS = [0x00, 0x24, 0x49, 0x6D, 0x92, 0xB6, 0xDB, 0xFF];
const toHex = (value) => value.toString(16).padStart(2, '0').toUpperCase();
/** Complete 512-color master palette for SCREEN 5 (MSX2). */
export const MSX_SCREEN5_MASTER_PALETTE = (() => {
    const palette = [];
 ...
 */
export const snapHexToScreen5MasterColor = (hex) => {
...
export const DEFAULT_SCREEN5_CUSTOM_PALETTE = MSX_SCREEN5_PALETTE.map((color, idx) => {
    if (idx === 0) {
...
export const EDITABLE_TILE_DIMENSIONS = [8, 16, 24, 32];
...
export const Z80_BEHAVIOR_SNIPPETS = [];
...
export const MSX1_PALETTE_MAP = new Map(MSX1_PALETTE.map(c => [c.hex, c]));
/** A Map from MSX1 color indices to their MSX1Color object. */
export const MSX1_PALETTE_IDX_MAP = new Map(MSX1_PALETTE.map(c => [c.index, c]));
/** The default MSX1 color object (black). */
export const MSX1_DEFAULT_COLOR = MSX1_PALETTE[1]; // Default to black if lookup fails
...
export const PT3_CHANNELS = ['A', 'B', 'C'];
/** The SCC channel identifiers. */
export const SCC_CHANNELS = ['1', '2', '3', '4', '5'];
...
export const PT3_DEFAULT_VIBRATO_TABLE = [
 ...
 */
export const PT3_PIANO_KEY_LAYOUT = {
 ...
 */
export const DEFAULT_TILE_BANK_DEFINITIONS = [
    {
        id: 'bank_0',
...
export const DEFAULT_MAIN_MENU_CONFIG = {
    isEnabled: true,
    options: [
...
export const DEFAULT_PRESENTATION_SCREEN_CONFIG = {
    enabled: false,
...
export const DEFAULT_HELP_DOCS_DATA = [
    {
        id: "getting_started",
...
export const MIDEAS_GLOBAL_VARIABLES = [
    // === OBJECTIVE / PROGRESS ===
    {
        name: 'Goal',
 ...
 */
export function getMideasVariableValues(variableName) {
 ...
 */
export function getMideasVariable(variableName) {
