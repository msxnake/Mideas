...
; perception skill (SCREEN 5 bitmap): 3 hidden_obj marker(s), radius 40px, 3 ship part(s) + 'I' window.
bitmap_flag_near         EQU #C0E7
bitmap_percept_work_flag EQU #C0E8
bitmap_percept_work_type EQU #C0E9
bitmap_hidden_count      EQU #C0EA
bitmap_inv_state         EQU #C0EB
bitmap_inv_key_lock      EQU #C0EC
bitmap_inv_cmd_block     EQU #C2C0
bitmap_hidden_flags      EQU #C0ED
    org #4000
...
;   uncollected object within the 40px square radius -> bitmap_flag_near = 1
...
; Room 0 hidden_obj records: centerX, centerY, flagOffset, rewardType(0 part/1 gem/2 key)
bitmap_percept_room_0:
    DB #88,#98,#00,#00,#28,#38,#01,#00,#D8,#28,#02,#00
...
bitmap_percept_count_table:
    DB 3,0
; Parts window box: outer 15-fill + inner 1-fill, 72x32 at (92,64)
bitmap_inv_cmd_box:
    DB #00,#00,#00,#00,#5C,#00,#54,#00,#48,#00,#20,#00,#FF,#00,#C0,#00
    DB #00,#00,#00,#5E,#00,#56,#00,#44,#00,#1C,#00,#11,#00,#C0
; 3 part slot(s): flagOffset, emptyCmd(15), collectedCmd(15)
bitmap_inv_slot_cmds:
    DB #00,#00,#00,#00,#00,#64,#00,#5C,#00,#10,#00,#10,#00,#EE,#00,#C0
    DB #40,#00,#00,#02,#64,#00,#5C,#00,#10,#00,#10,#00,#00,#00,#D0,#01
    DB #00,#00,#00,#00,#78,#00,#5C,#00,#10,#00,#10,#00,#EE,#00,#C0,#60
    DB #00,#00,#02,#78,#00,#5C,#00,#10,#00,#10,#00,#00,#00,#D0,#02,#00
    DB #00,#00,#00,#8C,#00,#5C,#00,#10,#00,#10,#00,#EE,#00,#C0,#00,#00
    DB #00,#00,#8C,#00,#5C,#00,#10,#00,#10,#00,#FF,#00,#C0
