...
export const DEFAULT_COMPONENT_DEFINITIONS: ComponentDefinition[] = [
  ...
  },
  {
    ...
    properties: [
      ...
      { name: "commands", type: "string", defaultValue: "move_right 64\njump\ndash_right\ndelay 1000\nopen_dialog\nwrite_line 0\nwait_spc\nclose_dialog", description: "One command per line: move_left/right/up/down pixels, jump, dash_left/right/up/down, grab_wall, release_wall, delay ms, open_dialog, write_line index, wait_spc, clear_dialog, close_dialog." }
    ],
