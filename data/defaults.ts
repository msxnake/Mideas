...
export const DEFAULT_COMPONENT_DEFINITIONS: ComponentDefinition[] = [
  ...
  },
  {
    ...
    properties: [
      ...
      { name: "commands", type: "string", defaultValue: "move_right 64\njump\ndash_right\ndelay 1000\nplay_dialog", description: "One command per line: move_right or move right pixels, jump, dash_right or dash right, grab_wall, release_wall, delay ms, wait seconds, play_dialog, open_dialog/open frame_dialog, write_line/write text index, wait_spc/wait SPC, clear_dialog/clean, close_dialog." }
    ],
