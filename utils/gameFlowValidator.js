...
function validateGameFlow(gameFlow, allAssets) {
    ...
    if (startNode) {
        var startConnections = gameFlow.connections.filter(function (c) { var _a; return ((_a = c.from) === null || _a === void 0 ? void 0 : _a.nodeId) === startNode.id || c.from === startNode.id; });
    ...
    // Step 3: Check for orphaned nodes (no incoming or outgoing connections)
    var connectedNodeIds = new Set();
    gameFlow.connections.forEach(function (conn) {
        var _a, _b;
        var fromId = ((_a = conn.from) === null || _a === void 0 ? void 0 : _a.nodeId) || conn.from;
        var toId = ((_b = conn.to) === null || _b === void 0 ? void 0 : _b.nodeId) || conn.to;
        if (fromId)
    ...
    gameFlow.nodes.forEach(function (node) {
        ...
        var hasOutgoingConnections = gameFlow.connections.some(function (c) { var _a; return ((_a = c.from) === null || _a === void 0 ? void 0 : _a.nodeId) === node.id || c.from === node.id; });
        ...
        if (node.type === 'SubMenu') {
            ...
            options.forEach(function (option) {
                ...
                if (!hasOptionConnection) {
                    issues.push({
                        type: 'WARNING',
                        message: "SubMenu option \"".concat(option.text, "\" has no outgoing connection"),
                        nodeId: node.id
                    });
                }
            });
            ...
            if (!hasOutgoingConnections) {
                issues.push({
                    type: 'WARNING',
                    message: "Node has no outgoing connection (should connect to End/Restart or another node): ".concat(node.type),
                    nodeId: node.id
                });
            }
        }
    ...
    endNodes.forEach(function (node) {
        var hasIncoming = gameFlow.connections.some(function (c) { var _a; return ((_a = c.to) === null || _a === void 0 ? void 0 : _a.nodeId) === node.id || c.to === node.id; });
        if (!hasIncoming) {
            issues.push({
                type: 'WARNING',
...
function generateGameFlowLog(gameFlow, allAssets, projectName) {
    ...
    gameFlow.connections.forEach(function (conn, i) {
        var _a, _b;
        var fromNodeId = ((_a = conn.from) === null || _a === void 0 ? void 0 : _a.nodeId) || conn.from;
        var toNodeId = ((_b = conn.to) === null || _b === void 0 ? void 0 : _b.nodeId) || conn.to;
