...
export function analyzeProject(projectName: string, assets: ProjectAsset[]): ProjectAnalysis {
  ...
  const msx2BitmapRooms = assets.filter(a => a.type === 'msx2bitmaproom').map(a => a.data as Msx2Screen5BitmapRoom);
