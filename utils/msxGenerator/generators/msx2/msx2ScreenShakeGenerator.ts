...
export const MSX2_SCREEN_SHAKE_RAM_BYTES = 1;
...
export function resolveMsx2ScreenShakeRamBase(options: Msx2SkillRamOptions): number {
  return resolveMsx2SkillExtensionRamBase(options);
}

/** EQU for the 1 screen-shake RAM byte, anchored at `ramBase`. */
export function buildMsx2ScreenShakeEquates(ramBase: number): string {
 ...
 */
export function buildMsx2ScreenShakeInitClearAsm(): string {
 ...
 */
export function buildMsx2ScreenShakeRuntimeAsm(): string {
...
export function buildMsx2ScreenShakeMainLoopCallAsm(): string {
