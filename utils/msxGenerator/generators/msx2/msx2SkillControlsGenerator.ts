import { Msx2PlayerControlId } from '../../../../types';
 ...
 */
function buildDirectionalCheck(matchValues: number[], blockSuffix: string): string {
...
export function buildMsx2SkillControlPressedCheck(
...
export function buildMsx2SkillPressedRoutine(
  routineLabel: string,
  skillName: string,
