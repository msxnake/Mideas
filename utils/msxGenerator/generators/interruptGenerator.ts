 ...
 */
function generateHardPlayerTickRoutine(hardPlayerTickEnabled: boolean): string {
...
function generateTaskManagementFunctions(hardPlayerTickEnabled: boolean): string {
  return `; ==================================================================
