...
`;
  ...
  currentAddress += 32;
  code += `entity_wallgrab_lockout EQU #${currentAddress.toString(16).toUpperCase().padStart(4, '0')}   ; Wall grab disabled until grounded after stamina is spent (32 bytes)\n`;
  currentAddress += 32;
