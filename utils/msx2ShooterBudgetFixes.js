/** @typedef {{ severity?: string, code?: string, screenId?: string, message?: string }} Msx2ShooterBudgetFixItem */
...
/**
 * @param {Msx2ShooterBudgetFixItem | null | undefined} item
 * @returns {{ severity: string, target: string, reason?: string, action: string }}
 */
...
/**
 * @param {Msx2ShooterBudgetFixItem[] | null | undefined} items
 * @returns {ReturnType<typeof buildMsx2Shooter60HzSuggestedFix>[]}
 */
