...
addCheck('MSX2 GameFlow editor clears dropdown connections when selecting None', editor.includes('clearSelectedOutgoingConnectionPort') && editor.includes("else clearSelectedOutgoingConnectionPort('then')") && editor.includes("else clearSelectedOutgoingConnectionPort('else')") && editor.includes('else clearSelectedOutgoingConnectionPort(option.id)') && editor.includes('else clearSelectedOutgoingConnectionPort();'));
