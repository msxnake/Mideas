...
check('code export displays selected MSX2 GameFlow and SCREEN 5 presentation', codeExportModal.includes('getMsx2Screen5ExportInfo') && codeExportModal.includes('SCREEN 5 export: GameFlow=') && codeExportModal.includes('missing SCREEN 5 presentation asset'));
...
check('presentation generator emits terminal MSX2 GameFlow transitions', presentationGenerator.includes('resolveNextTransition') && presentationGenerator.includes('MSX2_GAMEFLOW_NEXT_TRANSITION') && presentationGenerator.includes('msx2_gameflow_run_transition') && presentationGenerator.includes('screen5_black_palette_data') && presentationGenerator.includes('clear_screen5_visible_vram') && presentationGenerator.includes('FILVRM'));
