...
check('code export displays selected MSX2 GameFlow and SCREEN 5 presentation', codeExportModal.includes('getMsx2Screen5ExportInfo') && codeExportModal.includes('SCREEN 5 export: GameFlow=') && codeExportModal.includes('Terminal transition=') && codeExportModal.includes('invalidFlowShape') && codeExportModal.includes("startNextNode?.type !== 'Screen5Presentation'") && codeExportModal.includes('missingPresentation') && codeExportModal.includes("nodeAfterTransition?.type === 'End'") && codeExportModal.includes("nodeAfterTransition?.type === 'Restart'") && codeExportModal.includes('getNextExportNode') && codeExportModal.includes('missing SCREEN 5 presentation asset') && codeExportModal.includes('reachable Screen5Presentation node') && codeExportModal.includes('optional Waypoints'));
