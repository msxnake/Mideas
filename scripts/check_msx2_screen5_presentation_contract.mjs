...
check('PNG import CLI can create a ready MSX2 GameFlow', pngImportScript.includes('--with-msx2-gameflow') && pngImportScript.includes("type\": \"msx2gameflow\"") && pngImportScript.includes("type\": \"Screen5Presentation\"") && pngImportScript.includes("presentationAssetId"));
