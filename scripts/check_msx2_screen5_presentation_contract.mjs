...
check('generator routes msx2presentation assets to SCREEN 5 regardless of stale screenMode', generatorIndex.includes('function hasMsx2PresentationAssets') && generatorIndex.includes('if (hasMsx2PresentationAssets(assets))') && generatorIndex.includes("return 'msx2-screen5-presentation'"));
...
check('CLI JSON export preserves SCREEN 5 presentation backend', buildScript.includes('hasMsx2Presentation') && buildScript.includes('const exportScreenMode = hasMsx2Presentation ? "SCREEN 5 (Graphics III)" : requestedScreenMode') && buildScript.includes('? "msx2-screen5-presentation"') && buildScript.includes('targetGraphicsBackend: raw.targetGraphicsBackend || defaultGraphicsBackend'));
