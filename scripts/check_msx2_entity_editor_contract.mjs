...
const checks = [
  ...
  ['MSX2 failure reports expose automatic resolution plans', buildScriptSource.includes('build_msx2_automatic_resolution_plan') && buildScriptSource.includes('"automaticResolutionPlan"') && serverSource.includes('buildMsx2AutomaticResolutionPlan') && serverSource.includes('automaticResolutionPlan') && msx2BudgetFeedbackSource.includes('buildMsx2AutomaticResolutionPlan') && msx2BudgetFeedbackSource.includes('automaticResolutionPlan') && codeExportModalSource.includes('Automatic plan:')],
