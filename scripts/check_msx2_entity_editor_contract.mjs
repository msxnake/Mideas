...
const checks = [
  ...
  ['SCREEN 4 MegaROM keeps HUD font patterns in cold data bank', generatorSource.includes('buildMsx2HudTextRuntimeAsm(analysis, useKonamiDataBank)') && generatorSource.includes('call msx2_screen4_data_bank_enter') && generatorSource.includes("${useKonamiDataBank ? '' : hudFontPatternDataAsm}") && generatorSource.includes('${hudFontPatternDataAsm}\n${hardwareSpriteDataAsm}')],
