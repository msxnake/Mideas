...
const checks = [
  ...
  ['MSX2 split package chunks expose future loader label contract', generatorSource.includes('splitChunkManifest') && generatorSource.includes('dataBankSymbol') && generatorSource.includes('loaderSymbol') && buildScriptSource.includes('splitChunkManifest entry is missing')],
  ...
  ['compile endpoint budget resolver exposes candidate IDs', serverSource.includes('buildMsx2BudgetResolverCandidates') && serverSource.includes('resolverCandidateIds') && serverSource.includes('candidateId') && serverSource.includes('emit_multi_bank_world_data_loader') && msx2BudgetFeedbackSource.includes('resolverCandidates') && msx2BudgetFeedbackSource.includes('emit_multi_bank_world_data_loader')],
