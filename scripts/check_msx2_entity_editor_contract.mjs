...
const checks = [
  ...
  ['MSX2 split package chunks expose future loader label contract', generatorSource.includes('splitChunkManifest') && generatorSource.includes('payloadLabels') && generatorSource.includes('payloadKind') && generatorSource.includes('dataBankSymbol') && generatorSource.includes('loaderSymbol') && generatorSource.includes('`${dataBankSymbol} EQU MSX2_SCREEN4_DATA_BANK_${bankIndex}`') && generatorSource.includes('`${payloadLabel}_DATA_BANK EQU ${dataBankSymbol') && buildScriptSource.includes('splitChunkManifest entry is missing') && buildScriptSource.includes('payloadLabels must be a non-empty list')],
