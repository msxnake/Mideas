...
const checks = [
  ...
  ['MSX2 build summary records Post-ASM attempts', buildScriptSource.includes('"postAsmAttempts"') && buildScriptSource.includes('post_asm_attempts.append') && buildScriptSource.includes('"accepted"') && buildScriptSource.includes('"check_only_passed"') && buildScriptSource.includes('"ruleClasses"')],
  ...
  ['compile endpoint budget resolver exposes candidate IDs', serverSource.includes('buildMsx2BudgetResolverCandidates') && serverSource.includes('resolverCandidateIds') && serverSource.includes('candidateId') && msx2BudgetFeedbackSource.includes('resolverCandidates')],
