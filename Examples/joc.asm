...
; Entities: 12
; Total Hardware Sprites (Layers): 1
; ==================================================================
...
entity_sprite_config:
    db 0, 0 ; Entity 0 (NO_SPRITE)
    db 0, 0 ; Entity 1 (NO_SPRITE)
    db 0, 0 ; Entity 2 (NO_SPRITE)
    db 0, 0 ; Entity 3 (NO_SPRITE)
    db 0, 0 ; Entity 4 (NO_SPRITE)
    db 0, 0 ; Entity 5 (NO_SPRITE)
    db 0, 0 ; Entity 6 (NO_SPRITE)
    db 0, 0 ; Entity 7 (NO_SPRITE)
    db 0, 0 ; Entity 8 (NO_SPRITE)
    db 0, 0 ; Entity 9 (NO_SPRITE)
    db 0, 0 ; Entity 10 (NO_SPRITE)
    db 0, 0 ; Entity 11 (NO_SPRITE)
    ds 40, 0 ; Padding
...
load_sprite_patterns:
    ...
    ; Sprite Asset 0: New Sprite (3 frames, 2 layers)
    ld hl, SPRITE_0_PATTERN
    ld de, SPRPAT + (0 * 32)
    ld bc, 192
    call LDIRVM
    ; Sprite Asset 1: coin (6 frames, 1 layers)
...
clear_all_sprites:
    ...
    ld b, 5 ; Clear a bit more for safety
.clear_loop:
