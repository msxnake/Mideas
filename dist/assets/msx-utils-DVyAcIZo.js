...
SOLO UN HEROE PUEDE DETENERLOS.`,backgroundAssetId:null},menuScreenAssetId:null,cursorSpriteAssetId:null,menuColors:{text:J[15].hex,background:J[4].hex,highlightText:J[11].hex,highlightBackground:J[5].hex,border:J[15].hex}},mr=ya,fr="HELP_DOCS_SYSTEM_ASSET",br=[{id:"getting_started",title:"Getting Started",articles:[{id:"welcome",title:"Welcome to MSX Retro IDE",content:`
          <h2>Welcome!</h2>
...
`;const n=t.width/Z,c=t.height/Z,r=h=>a==="hex"?`$${Ta(h)}`:h.toString(10),p=[],d=[];for(let h=0;h<c;h++)for(let f=0;f<n;f++){const m=`;; Character Block (${f}, ${h}) for ${l}`,s=[];for(let I=0;I<Z;I++){const S=h*Z+I;let b=0;if(t.lineAttributes[S]&&t.lineAttributes[S][f]){const _=t.lineAttributes[S][f].fg;for(let E=0;E<Z;E++){const C=f*Z+E;t.data[S]&&t.data[S][C]!==void 0&&t.data[S][C]===_&&(b|=1<<7-E)}}s.push(b)}const y=s.map(r).join(",");p.push({comment:`${m} - PATTERN Data (8 bytes):`,dataString:`DB ${y}`});const g=[];for(let I=0;I<Z;I++){const S=h*Z+I;let b=Ne<<4|xe;if(t.lineAttributes[S]&&t.lineAttributes[S][f]){const _=t.lineAttributes[S][f],E=((u=Ve.get(_.fg))==null?void 0:u.index)??Ne,C=((i=Ve.get(_.bg))==null?void 0:i.index)??xe;b=E<<4|C}g.push(b)}const A=g.map(r).join(",");d.push({comment:`${m} - COLOR Attribute Data (8 bytes - FG|BG):`,dataString:`DB ${A}`})}return o+=`;; --- PATTERN DATA ---
...
`,o},Er=(t,e,a,l)=>{const o=Math.max(1,t/Qe);return Array(e).fill(null).map(()=>Array(o).fill(null).map(()=>({fg:a,bg:l})))},la=(t,e)=>{var c,r,p,d;const a=[],l=t.width/Z,o=t.height/Z,n=e==="SCREEN 2 (Graphics I)";for(let u=0;u<o;u++)for(let i=0;i<l;i++)for(let h=0;h<Z;h++){const f=u*Z+h;let m=0,s;n&&t.lineAttributes&&t.lineAttributes[f]&&t.lineAttributes[f][i]&&(s=t.lineAttributes[f][i].fg);for(let y=0;y<Z;y++){const g=i*Z+y,A=(c=t.data[f])==null?void 0:c[g];if(A!==void 0){let I=!1;n&&s?I=A===s:n||(I=A!==De[0].hex&&A!==((d=(p=(r=t.lineAttributes)==null?void 0:r[0])==null?void 0:p[0])==null?void 0:d.bg)),I&&(m|=1<<7-y)}}a.push(m)}return new Uint8Array(a)},Ce=(t,e)=>{var n,c;const a=t.length;if(a===0)return[];const l=((n=t[0])==null?void 0:n.length)||0;if(l===0)return[[]];const o=t.map(r=>[...r]);for(let r=0;r<a;r++)for(let p=0;p<l;p++){const d=Math.floor(p/Qe),u=(c=e[r])==null?void 0:c[d],i=o[r][p];u&&i!==u.fg&&i!==u.bg&&(o[r][p]=u.fg)}return o},Sr=(t,e,a)=>{if(t.length<2)return t;const o=t.slice(1);return o.push([...t[0]]),a==="SCREEN 2 (Graphics I)"&&e?Ce(o,e):o},Ar=(t,e,a)=>{const l=t.length;if(l<2)return t;const o=t.slice(0,l-1);return o.unshift([...t[l-1]]),a==="SCREEN 2 (Graphics I)"&&e?Ce(o,e):o},Tr=(t,e,a)=>{if(t.length===0)return[];const l=t.map(o=>{if(o.length<2)return[...o];const n=o.slice(1);return n.push(o[0]),n});return a==="SCREEN 2 (Graphics I)"&&e?Ce(l,e):l},Cr=(t,e,a)=>{if(t.length===0)return[];const l=t.map(o=>{const n=o.length;if(n<2)return[...o];const c=o.slice(0,n-1);return c.unshift(o[n-1]),c});return a==="SCREEN 2 (Graphics I)"&&e?Ce(l,e):l},Ir=(t,e,a)=>{if(t.length===0)return[];const l=t.map(o=>[...o].reverse());return a==="SCREEN 2 (Graphics I)"&&e?Ce(l,e):l},vr=(t,e,a)=>{if(t.length===0)return[];const l=[...t].reverse();return a==="SCREEN 2 (Graphics I)"&&e?Ce(l,e):l},oa=t=>{var o,n,c;if(!t.lineAttributes)return null;const e=[],a=t.width/Z,l=t.height/Z;for(let r=0;r<l;r++)for(let p=0;p<a;p++)for(let d=0;d<Z;d++){const u=r*Z+d;let i=Ne<<4|xe;const h=(o=t.lineAttributes[u])==null?void 0:o[p];if(h){const f=((n=Ve.get(h.fg))==null?void 0:n.index)??Ne,m=((c=Ve.get(h.bg))==null?void 0:c.index)??xe;i=f<<4|m}e.push(i)}return new Uint8Array(e)},wr=t=>{const e=[];t.frames.forEach(l=>{var o,n,c,r,p;for(let d=0;d<t.spritePalette.length;d++){const u=t.spritePalette[d];if(u===t.backgroundColor)continue;let i=!1;const h=[],f=t.size.width,m=t.size.height;if(f===16&&m===16){for(let s=0;s<8;s++){let y=0;for(let g=0;g<8;g++)((o=l.data[s])==null?void 0:o[g])===u&&(y|=1<<7-g,i=!0);h.push(y)}for(let s=8;s<16;s++){let y=0;for(let g=0;g<8;g++)((n=l.data[s])==null?void 0:n[g])===u&&(y|=1<<7-g,i=!0);h.push(y)}for(let s=0;s<8;s++){let y=0;for(let g=0;g<8;g++)((c=l.data[s])==null?void 0:c[8+g])===u&&(y|=1<<7-g,i=!0);h.push(y)}for(let s=8;s<16;s++){let y=0;for(let g=0;g<8;g++)((r=l.data[s])==null?void 0:r[8+g])===u&&(y|=1<<7-g,i=!0);h.push(y)}}else for(let s=0;s<m;s++)for(let y=0;y<Math.ceil(f/8);y++){let g=0;for(let A=0;A<8;A++){const I=y*8+A;I<f&&((p=l.data[s])==null?void 0:p[I])===u&&(g|=1<<7-A,i=!0)}h.push(g)}i&&e.push(h)}});const a=e.flat();return new Uint8Array(a)},Nt=t=>t.map(e=>[...e].reverse()),xt=t=>[...t].reverse(),Ca=/_(left|right|up|down)$/i,na=t=>{if(!t)return;const e=t.trim().toLowerCase();if(e==="left"||e==="right"||e==="up"||e==="down")return e},Ia=t=>{const e=t.match(Ca);return e?{baseName:t.slice(0,-e[0].length),suffixDirection:na(e[1])}:{baseName:t}},va=(t,e,a,l)=>({...t,id:`${t.id}__auto_${a}`,name:e,facingDirection:a,frames:t.frames.map((o,n)=>({...o,id:`${o.id||`f${n}`}_${a}_auto`,data:l(o.data)}))}),et=(t,e,a,l)=>{if(!e)return;(e===e.toLowerCase()?[e]:[e,e.toLowerCase()]).forEach(n=>{const c=t[n];if(c===void 0){t[n]=a;return}c!==a&&l.push(`Name alias collision for "${n}" between indexes ${c} and ${a}. Keeping first mapping.`)})},dt=t=>{const e=[],a=new Set,l=[],o=new Map,n=(i,h,f)=>{if(!a.has(i))return i;if(!a.has(h))return e.push(`Name "${i}" already exists. Using fallback "${h}" for ${f}.`),h;let m=1,s=`${i}_${m}`;for(;a.has(s);)m+=1,s=`${i}_${m}`;return e.push(`Name "${i}" already exists. Using "${s}" for ${f}.`),s};t.forEach((i,h)=>{const f=i.name||`sprite_${h}`,{baseName:m,suffixDirection:s}=Ia(f),y=na(i.facingDirection);y&&s&&y!==s&&e.push(`Sprite "${f}" has suffix "${s}" but facing "${y}". Using facing direction.`);const g=y||s,A=s?m:f,I=g?`${A}_${g}`:f,S=n(I,f,`sprite "${f}"`),b=new Set;f!==S&&b.add(f);const E={sprite:{...i,name:S,facingDirection:g||i.facingDirection},baseName:A,direction:g,aliases:b};if(l.push(E),a.add(S),g){const C=o.get(A)||{};C[g]===void 0?(C[g]=l.length-1,o.set(A,C)):e.push(`Duplicate directional sprite for "${A}_${g}". Keeping first occurrence.`)}}),o.forEach((i,h)=>{const f=(m,s,y,g)=>{if(s===void 0||i[m]!==void 0)return;const A=`${h}_${m}`;if(a.has(A)){e.push(`Cannot auto-generate "${A}" because the name already exists.`);return}const I=l[s],b={sprite:va(I.sprite,A,m,y),baseName:h,direction:m,aliases:new Set};l.push(b),i[m]=l.length-1,a.add(A),e.push(`Auto-generated "${A}" from "${I.sprite.name}" using ${g}.`)};i.right!==void 0&&i.left===void 0?f("left",i.right,Nt,"horizontal mirror"):i.left!==void 0&&i.right===void 0&&f("right",i.left,Nt,"horizontal mirror"),i.up!==void 0&&i.down===void 0?f("down",i.up,xt,"vertical mirror"):i.down!==void 0&&i.up===void 0&&f("up",i.down,xt,"vertical mirror")});const c={};l.forEach((i,h)=>{et(c,i.sprite.name,h,e),et(c,i.sprite.id,h,e)}),l.forEach((i,h)=>{i.aliases.forEach(f=>et(c,f,h,e))});const r=l.map((i,h)=>h),p=l.map((i,h)=>h),d=l.map((i,h)=>h),u=l.map((i,h)=>h);return l.forEach((i,h)=>{const f=o.get(i.baseName);f&&(f.left!==void 0&&(r[h]=f.left),f.right!==void 0&&(p[h]=f.right),f.up!==void 0&&(d[h]=f.up),f.down!==void 0&&(u[h]=f.down))}),{sprites:l.map(i=>i.sprite),nameToIndex:c,directionalLookupTables:{left:r,right:p,up:d,down:u},warnings:e}},wa=t=>{let e=t.toString(16).toUpperCase();return e.length===1&&(e="0"+e),e},La=(t,e,a,l,o,n,c="hex",r)=>{var f,m,s,y,g;const d=t.replace(/[^a-zA-Z0-9_]/g,"_").toUpperCase();let u=`;; ---- Sprite Frame: ${t} ----
`;u+=`;; Size: ${o}x${n}
`;let i=0;const h=Array.isArray(r)&&r.length>0?r:a.map((A,I)=>I).filter(A=>{const I=a[A];return!!I&&I!==l});for(const A of h){const I=a[A];if(!I||I===l)continue;const S=[];if(o===16&&n===16){for(let b=0;b<8;b++){let _=0;for(let E=0;E<8;E++){const C=E;((f=e[b])==null?void 0:f[C])===I&&(_|=1<<7-E)}S.push(_)}for(let b=8;b<16;b++){let _=0;for(let E=0;E<8;E++){const C=E;((m=e[b])==null?void 0:m[C])===I&&(_|=1<<7-E)}S.push(_)}for(let b=0;b<8;b++){let _=0;for(let E=0;E<8;E++){const C=8+E;((s=e[b])==null?void 0:s[C])===I&&(_|=1<<7-E)}S.push(_)}for(let b=8;b<16;b++){let _=0;for(let E=0;E<8;E++){const C=8+E;((y=e[b])==null?void 0:y[C])===I&&(_|=1<<7-E)}S.push(_)}}else for(let b=0;b<n;b++)for(let _=0;_<Math.ceil(o/8);_++){let E=0;for(let C=0;C<8;C++){const T=_*8+C;T<o&&((g=e[b])==null?void 0:g[T])===I&&(E|=1<<7-C)}S.push(E)}i+=1,u+=`${d}_LAYER${A}: ; Brush Color Index ${A} (Actual Color: ${I})
`,o%8!==0&&(u+=`;; WARNING: Sprite width ${o} is not a multiple of 8. Bitmask generation might be problematic for standard VDP.
`);for(let b=0;b<S.length;b+=16){const E=S.slice(b,b+16).map(C=>c==="hex"?`#${wa(C)}`:C.toString());u+=`    DB ${E.join(",")}
`}u+=`
...
`;const r=t.spritePalette.map((p,d)=>d).filter(p=>{const d=t.spritePalette[p];return!d||d===t.backgroundColor?!1:t.frames.some(u=>{var i;return(i=u==null?void 0:u.data)==null?void 0:i.some(h=>h==null?void 0:h.some(f=>f===d))})});return t.frames.forEach((p,d)=>{l+=La(`${n}_F${d}`,p.data,t.spritePalette,t.backgroundColor,t.size.width,t.size.height,e,r)}),l},tt=16,ra="SCREEN 2 (Graphics I)",Da="SCREEN 5 (Graphics III)",be=8,Na={pixelWidth:ye*tt,pixelHeight:ze*tt,widthTiles:ye,heightTiles:ze,baseTileSize:tt},Mt={[ra]:{pixelWidth:ye*Ae,pixelHeight:ze*Ae,widthTiles:ye,heightTiles:ze,baseTileSize:Ae},[Da]:{pixelWidth:256,pixelHeight:212,widthTiles:32,heightTiles:27,baseTileSize:Ae},"SCREEN 0 (Text 40)":{pixelWidth:240,pixelHeight:192,widthTiles:40,heightTiles:24,baseTileSize:be},"SCREEN 1 (Text 32)":{pixelWidth:256,pixelHeight:192,widthTiles:32,heightTiles:24,baseTileSize:be},"SCREEN 3 (Multicolor)":{pixelWidth:256,pixelHeight:192,widthTiles:32,heightTiles:24,baseTileSize:be},"SCREEN 4 (Graphics II)":{pixelWidth:256,pixelHeight:192,widthTiles:32,heightTiles:24,baseTileSize:be},"SCREEN 6 (Graphics IV)":{pixelWidth:512,pixelHeight:212,widthTiles:64,heightTiles:27,baseTileSize:be},"SCREEN 7 (Graphics V)":{pixelWidth:512,pixelHeight:212,widthTiles:64,heightTiles:27,baseTileSize:be},"SCREEN 8 (Graphics VI)":{pixelWidth:256,pixelHeight:212,widthTiles:32,heightTiles:27,baseTileSize:be}};function Lr(t){const e=typeof t=="string"?t.trim():"";return e&&Mt[e]?Mt[e]:Na}const Ge=t=>t===ra,xa=t=>Ge(t)?J:De,Ma=(t,e)=>{const a=xa(e);if(t===void 0||t<0||t>=a.length)return Ge(e)?J[1].hex:De[4].hex;const l=a[t];return(l==null?void 0:l.hex)??(Ge(e)?J[1].hex:De[4].hex)},Rr=(t,e,a,l)=>{var h;const o=t.layers.background,n=t.activeAreaX??0,c=t.activeAreaY??0,r=t.activeAreaWidth??t.width,p=t.activeAreaHeight??t.height,d=[];let u=0;const i=new Map;for(let f=0;f<p;f++){const m=c+f;for(let s=0;s<r;s++){const y=n+s;if(m>=o.length||y>=((h=o[m])==null?void 0:h.length)){d.push(ge);continue}const g=o[m][y];if(!g||!g.tileId)d.push(ge);else{let A=ge;const I=e.find(S=>S.id===g.tileId);if(l==="SCREEN 2 (Graphics I)"&&a&&I){let S=!1,b={tileId:g.tileId,position:{x:y,y:m},attempts:[],banksReceived:a.length};typeof globalThis.screenUtils_firstTileLogged>"u"&&(console.log("🔍 First tile structure check:",{tileId:g.tileId,position:{x:y,y:m},banksCount:a.length,banks:a.map(_=>({name:_.name,assignedTileIds:Object.keys(_.assignedTiles||{}),hasThisTile:!!(_.assignedTiles&&_.assignedTiles[g.tileId]),assignedTilesType:typeof _.assignedTiles,assignedTilesSample:_.assignedTiles?Object.entries(_.assignedTiles).slice(0,2):[]}))}),globalThis.screenUtils_firstTileLogged=!0);for(const _ of a)if((_.enabled??!0)&&_.assignedTiles[g.tileId]){const E=_.assignedTiles[g.tileId].charCode,C=Math.ceil(I.width/Ae),T=g.subTileX||0,w=g.subTileY||0;A=E+w*C+T;const D=A>=_.charsetRangeStart&&A<=_.charsetRangeEnd;if(b.attempts.push({bankName:_.name,baseCharCode:E,calculated:A,range:`${_.charsetRangeStart}-${_.charsetRangeEnd}`,inRange:D}),D){S=!0;break}else A=ge}else b.attempts.push({bankName:_.name,reason:"Tile not assigned to this bank"});S||(console.warn("⚠️ Tile not found in valid range:",b),A=ge)}else if(l!=="SCREEN 2 (Graphics I)"){const S=`${g.tileId}_${g.subTileX??0}_${g.subTileY??0}`;i.has(S)?A=i.get(S):u>255?A=ge:(i.set(S,u),A=u++)}d.push(A)}}}return new Uint8Array(d)},Pa=(t,e,a,l,o,n="hex")=>{const r=t.replace(/[^a-zA-Z0-9_]/g,"_").toUpperCase();let p=`;; MAP: ${t} (${e}x${a} tiles)
...
`}return p},Oa=(t,e,a,l,o="hex")=>{const c=t.replace(/[^a-zA-Z0-9_]/g,"_").toUpperCase();let r=`;; BEHAVIOR MAP: ${t} (${e}x${a} tiles)
...
`,r},Dr=(t,e)=>{if(t.width!==e.width||t.height!==e.height||t.data.length!==e.data.length)return!1;for(let a=0;a<t.height;a++){if(t.data[a].length!==e.data[a].length)return!1;for(let l=0;l<t.width;l++)if(t.data[a][l]!==e.data[a][l])return!1}if(t.lineAttributes&&e.lineAttributes){if(t.lineAttributes.length!==e.lineAttributes.length)return!1;for(let a=0;a<t.lineAttributes.length;a++){if(t.lineAttributes[a].length!==e.lineAttributes[a].length)return!1;for(let l=0;l<t.lineAttributes[a].length;l++)if(t.lineAttributes[a][l].fg!==e.lineAttributes[a][l].fg||t.lineAttributes[a][l].bg!==e.lineAttributes[a][l].bg)return!1}}else if(t.lineAttributes!==e.lineAttributes)return!1;return JSON.stringify(t.logicalProperties)===JSON.stringify(e.logicalProperties)};function Nr(t,e,a,l,o,n,c){const{data:r,width:p,height:d,lineAttributes:u}=t;if(!r||d===0||p===0)return"";const i=document.createElement("canvas");i.width=n,i.height=n;const h=i.getContext("2d");if(!h)return"";h.imageSmoothingEnabled=!1;const f=(e??0)*n,m=(a??0)*n;for(let g=0;g<n;g++)for(let A=0;A<n;A++){const I=f+A,S=m+g;if(S>=0&&S<d&&I>=0&&I<p){let b=r[S][I];if(c==="SCREEN 2 (Graphics I)"&&u&&u[S]){const _=Math.floor(I/Qe),E=u[S][_];E&&b!==E.fg&&b!==E.bg&&(b=E.fg)}h.fillStyle=b,h.fillRect(A,g,1,1)}}if(i.width===l&&i.height===o)return i.toDataURL();const s=document.createElement("canvas");s.width=l,s.height=o;const y=s.getContext("2d");return y?(y.imageSmoothingEnabled=!1,y.drawImage(i,0,0,l,o),s.toDataURL()):i.toDataURL()}function xr(t,e,a){var n;if(!t||a===0||e===0)return"";const l=document.createElement("canvas");l.width=e,l.height=a;const o=l.getContext("2d");if(!o)return"";o.imageSmoothingEnabled=!1;for(let c=0;c<a;c++)for(let r=0;r<e;r++){const p=(n=t[c])==null?void 0:n[r];p&&p!=="rgba(0,0,0,0)"&&(o.fillStyle=p,o.fillRect(r,c,1,1))}return l.toDataURL()}const Mr=(t,e,a,l,o,n,c)=>{var i,h;const r=Ge(l);t.width=e.width*o,t.height=e.height*o;const p=t.getContext("2d");if(!p)return;p.imageSmoothingEnabled=!1;const d=Ma(e.backgroundColor,l);p.fillStyle=d,p.fillRect(0,0,t.width,t.height);const u=e.layers.background;for(let f=0;f<e.height;f++)for(let m=0;m<e.width;m++){const s=(i=u[f])==null?void 0:i[m];if(!(s!=null&&s.tileId))continue;const y=a.find(T=>T.id===s.tileId);if(!y)continue;const{data:g,width:A,height:I,lineAttributes:S}=y;if(!g)continue;const b=s.subTileX??0,_=s.subTileY??0,E=b*o,C=_*o;for(let T=0;T<o;T++)for(let w=0;w<o;w++){const D=E+w,N=C+T;if(N<I&&D<A){let M=(h=g[N])==null?void 0:h[D];if(M===void 0)continue;if(r&&S&&S[N]){const z=Math.floor(D/Qe),Q=S[N][z];Q&&M!==Q.fg&&M!==Q.bg&&(M=Q.fg)}p.fillStyle=M,p.fillRect(m*o+w,f*o+T,1,1)}}}};function oe(t){const e=typeof t=="string"?t.trim():"";if(!e)return"";const a=He.find(l=>l.name.toLowerCase()===e.toLowerCase());return a?a.name:e}function Le(t){return`global_var_${oe(t).replace(/([A-Z])/g,"_$1").toLowerCase().replace(/^_/,"")}`}function Re(t){return`${oe(t).replace(/[^A-Za-z0-9]/g,"_").toUpperCase()}_`}function ka(t){const e=t.find(c=>c.type==="globalvariables");if(!e||!e.data)return[...He];const a=e.data.customVariables||[],l=new Map;He.forEach(c=>{const r=oe(c.name);l.set(r,{...c,name:r})}),a.forEach(c=>{const r=oe(c.name);r&&l.set(r,{...c,name:r,asmName:Le(r),constantPrefix:c.constantPrefix||Re(r)})});const o=He.map(c=>oe(c.name)),n=[];return o.forEach(c=>{const r=l.get(c);r&&(n.push(r),l.delete(c))}),l.forEach(c=>{n.push(c)}),n}function Pr(t){const e=t.find(o=>o.type==="globalvariables");if(!e||!e.data)return[];const a=e.data.customVariables||[],l=new Map;return a.forEach(o=>{const n=oe(o.name);n&&l.set(n,{...o,name:n,asmName:Le(n),constantPrefix:o.constantPrefix||Re(n)})}),Array.from(l.values())}function Ua(t){const e=ka(t);if(e.length===0)return[];const a=[],l=t.filter(m=>m.type==="screenmap");l.forEach(m=>{var y,g;(((g=(y=m.data)==null?void 0:y.layers)==null?void 0:g.entities)||[]).forEach(A=>{var I,S;(S=(I=A.components)==null?void 0:I.Behavior)!=null&&S.behaviorCode&&a.push(A.components.Behavior.behaviorCode)})});const o=t.find(m=>m.type==="gameflow"),n=new Set,c=new Set,r=new Set,p=new Set;if(o!=null&&o.data){const m=o.data;m.nodes&&Array.isArray(m.nodes)&&m.nodes.forEach(s=>{var y;if(s.type==="StateMachine"&&((y=s.data)!=null&&y.customCode)&&a.push(s.data.customCode),s.type==="IfThenElse"&&s.variableName){const g=oe(s.variableName);g&&n.add(g)}s.type==="Globals"&&s.variables&&Array.isArray(s.variables)&&s.variables.forEach(g=>{if(g.variableName){const A=oe(g.variableName);A&&c.add(A)}})})}t.filter(m=>m.type==="componentdefinition").forEach(m=>{const s=m.data;s.customCode&&a.push(s.customCode)});const u=m=>{if(typeof m!="string")return;const s=oe(m);s&&r.add(s)};l.forEach(m=>{var g,A,I,S;(((A=(g=m.data)==null?void 0:g.layers)==null?void 0:A.entities)||[]).forEach(b=>{var _,E;u((E=(_=b==null?void 0:b.componentOverrides)==null?void 0:_.comp_tile_collector)==null?void 0:E.targetVariable)}),(((S=(I=m.data)==null?void 0:I.hudConfiguration)==null?void 0:S.elements)||[]).forEach(b=>{const _=String((b==null?void 0:b.type)||"").toLowerCase();_==="score"?p.add(oe("Score")):_==="lives"&&p.add(oe("Lives"))})}),t.filter(m=>m.type==="entitytemplate").forEach(m=>{var g,A;const s=m.data,y=(g=s==null?void 0:s.components)==null?void 0:g.find(I=>I.definitionId==="comp_tile_collector");u((A=y==null?void 0:y.defaultValues)==null?void 0:A.targetVariable)});const h=[],f=new Set;return e.forEach(m=>{const s=oe(m.name),y=a.some(b=>new RegExp(`\\b${m.asmName}\\b`,"i").test(b)),g=n.has(s),A=c.has(s),I=r.has(s),S=p.has(s);(y||g||A||I||S)&&!f.has(s)&&(h.push(m),f.add(s))}),c.forEach(m=>{const s=oe(m);if(!f.has(s)){const y=Le(s);h.push({name:s,asmName:y,constantPrefix:Re(s),type:"8bit",description:"Auto-generated variable from Globals node",values:[{label:"0",value:0}],category:"special"}),f.add(s)}}),n.forEach(m=>{const s=oe(m);if(!f.has(s)){const y=Le(s);h.push({name:s,asmName:y,constantPrefix:Re(s),type:"8bit",description:"Auto-generated variable from IfThenElse node",values:[{label:"0",value:0}],category:"special"}),f.add(s)}}),r.forEach(m=>{const s=oe(m);if(!f.has(s)){const y=Le(s);h.push({name:s,asmName:y,constantPrefix:Re(s),type:"8bit",description:"Auto-generated variable from Tile Collector",values:[{label:"0",value:0}],category:"special"}),f.add(s)}}),h}const j={AND:"AND",OR:"OR",XOR:"XOR",NOT:"NOT",KEY_PRESSED:"KEY_PRESSED",KEY_RELEASED:"KEY_RELEASED",TIME_OUT:"TIME_OUT",CAN_MOVE_DIRECTION:"CAN_MOVE_DIRECTION",HAS_COLLISION:"HAS_COLLISION",PATH_CLEAR:"PATH_CLEAR",ON_WALL_COLLISION:"ON_WALL_COLLISION",HAS_DEADLY_TILE_COLLISION:"HAS_DEADLY_TILE_COLLISION",ANIMATION_COMPLETE:"ANIMATION_COMPLETE",KEY_AND_MOVEMENT:"KEY_AND_MOVEMENT",VARIABLE_COMPARE:"VARIABLE_COMPARE"},R={NONE:"NONE",SET_POSITION:"SET_POSITION",MOVE_BY:"MOVE_BY",SET_VELOCITY:"SET_VELOCITY",APPLY_FORCE:"APPLY_FORCE",CHANGE_SPRITE:"CHANGE_SPRITE",PLAY_ANIMATION:"PLAY_ANIMATION",SET_ANIMATION_SPEED:"SET_ANIMATION_SPEED",TOGGLE_ANIMATION:"TOGGLE_ANIMATION",PLAY_SOUND:"PLAY_SOUND",PLAY_MUSIC:"PLAY_MUSIC",MUTE_MUSIC:"MUTE_MUSIC",STOP_MUSIC:"STOP_MUSIC",SET_VARIABLE:"SET_VARIABLE",INCREMENT_VARIABLE:"INCREMENT_VARIABLE",DECREMENT_VARIABLE:"DECREMENT_VARIABLE",SET_COMPONENT_PROPERTY:"SET_COMPONENT_PROPERTY",WAIT:"WAIT",GOTO_STATE:"GOTO_STATE",DESTROY_ENTITY:"DESTROY_ENTITY",SPAWN_ENTITY:"SPAWN_ENTITY",GET_RANDOM_ENTITY_POSITION:"GET_RANDOM_ENTITY_POSITION",CHANGE_GAME_FLOW_NODE:"CHANGE_GAME_FLOW_NODE",DECREASE_LIVES:"DECREASE_LIVES",INCREASE_LIVES:"INCREASE_LIVES",RESPAWN_PLAYER:"RESPAWN_PLAYER",BREAK_TILE:"BREAK_TILE",REPLACE_TILE:"REPLACE_TILE",RND:"RND",POINT_AT:"POINT_AT",ADD_VARIABLES:"ADD_VARIABLES",SUBTRACT_VARIABLES:"SUBTRACT_VARIABLES",MULTIPLY_VARIABLES:"MULTIPLY_VARIABLES",DIVIDE_VARIABLES:"DIVIDE_VARIABLES",MODULO_VARIABLES:"MODULO_VARIABLES",ASSIGN_VARIABLE:"ASSIGN_VARIABLE",DISABLE_INPUT:"DISABLE_INPUT",ENABLE_INPUT:"ENABLE_INPUT"};function ct(t,e){const a=e.filter(v=>v.type==="componentdefinition").map(v=>v.data),l=e.filter(v=>v.type==="entitytemplate").map(v=>v.data),o=e.filter(v=>v.type==="sprite").map(v=>v.data),n=e.filter(v=>v.type==="sound").map(v=>{var x,U;return{...v.data,id:((x=v.data)==null?void 0:x.id)||v.id,name:((U=v.data)==null?void 0:U.name)||v.name}}),c=[],r={};e.filter(v=>v.type==="track").forEach(v=>{const x=v.data;if(!x)return;const U=x.soundChip||"PSG";if(U!=="PSG")return;const P={...x,soundChip:U,id:x.id||v.id,name:x.name||v.name},F=c.length;c.push(P),r[v.id]=F,r[P.id]=F});const p=e.filter(v=>v.type==="tile").map(v=>v.data),d=e.filter(v=>v.type==="screenmap").map(v=>v.data),u=e.filter(v=>v.type==="worldmap").map(v=>v.data),i=e.filter(v=>v.type==="statemachine").map(v=>v.data),h=[],f=new Set,m=(v,x,U)=>{var B,ee;if(v!=null&&v.id)return String(v.id);const P=((B=v==null?void 0:v.position)==null?void 0:B.x)??"",F=((ee=v==null?void 0:v.position)==null?void 0:ee.y)??"",X=(v==null?void 0:v.entityTemplateId)??"",pe=(v==null?void 0:v.name)??"";return`${(x==null?void 0:x.id)??`screen_${U}`}|${X}|${pe}|${P}|${F}`},s=(v,x,U)=>{if(!v||typeof v!="object")return;const P=m(v,x,U);f.has(P)||(f.add(P),h.push({...v,screenAssetId:v.screenAssetId||(x==null?void 0:x.id),screenIndex:typeof v.screenIndex=="number"?v.screenIndex:U}))};d.forEach((v,x)=>{var U;(U=v.layers)!=null&&U.entities&&Array.isArray(v.layers.entities)&&v.layers.entities.forEach(P=>s(P,v,x)),v.entities&&Array.isArray(v.entities)&&v.entities.forEach(P=>s(P,v,x))});const y=e.find(v=>v.type==="gameflow"),g=y==null?void 0:y.data,A=h.length>0,I=a.length>0||A,S=d.length>1,b=o.length>0,_=p.length>0,E=d.length>0,C=a.length>0,T=!!g,w=e.some(v=>v.type==="font"),D=o.some(v=>v.frames.length>1),N=d.some(v=>v.layers.collision.some(x=>x.some(U=>U!==null))),M=l.some(v=>v.name.toLowerCase().includes("menu")),z=[];a.forEach(v=>{v.name.toLowerCase().includes("state")&&z.push(v.name.replace(/[^a-zA-Z0-9]/g,"").toUpperCase())});const Q=Ua(e);return{projectName:t,components:a,templates:l,sprites:o,sounds:n,tracks:c,trackIndexByAssetId:r,tiles:p,screenMaps:d,screens:d,worldmaps:u,entities:h,fonts:e.filter(v=>v.type==="font"),gameFlow:g,stateMachines:i,hasECS:I,hasMultipleScreens:S,hasSprites:b,hasTiles:_,hasScreens:E,hasEntities:A,hasComponents:C,hasGameFlow:T,hasMenus:M,hasFonts:w,hasAnimations:D,hasCollisions:N,hasMenuSystem:M,customStates:z,globalVariables:Q}}const Fa=t=>{if(!t.hasECS)return`    ; No ECS system - basic entity updates
...
`}function Ya(t){return t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Or(t,e){const a=Wa(),l=Ga(a,t,e),n=`${t.toLowerCase().replace(/[^a-z0-9]/g,"_")}_dynamic_system.asm`,c=ct(t,e);return{filename:n,content:l,analysis:c}}function Ee(t,e,a){if(!(!a||a.length===0)){t.push(`;   ${e}:`);for(const l of a)t.push(`;     - ${l}`)}}function V(t){const e=[];return e.push("; Register Contract:"),t.purpose&&e.push(`;   Purpose: ${t.purpose}`),Ee(e,"Inputs",t.inputs),Ee(e,"Outputs",t.outputs),Ee(e,"Clobbers",t.clobbers),Ee(e,"Preserved",t.preserved),Ee(e,"Register roles",t.usage),Ee(e,"Notes",t.notes),`${e.join(`
`)}
...
; ==================================================================
`,e}function dl(t){if(!t)return"";let e="";return t.hasSprites&&(e+=`    ld a, 1
...
${t.stateMachines&&t.stateMachines.length>0?`    ; Advance any active state-machine PLAY_SOUND effect
    call SM_UpdateSound
`:""}
...
`,t.globalVariables.forEach(d=>{const u=d.name,i=d.asmName||`global_var_${u.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/^_/,"")}`,h=String(d.type||"").toLowerCase(),f=d.values&&d.values.length>0?d.values[0].value:0;let m=0;if(typeof f=="boolean")m=f?1:0;else{const s=Number(f);m=Number.isFinite(s)?Math.trunc(s):0}if(h==="word"||h==="16bit"){const s=Math.max(0,Math.min(65535,m));a+=`    ld a, ${s&255}
...
`),a}function El(t,e,a){var d,u,i,h,f,m,s,y,g,A,I,S;const l=`gameflow_node_${de(t.id)}`,o=`${l}_conn`,n=["Start","WorldLink","SubMenu","Text","IfThenElse","Globals","Transition","Music"].includes(t.type)||t.type==="Globals"&&t.variables&&t.variables.length>0,c=n?`${l}_data`:"gameflow_no_data";let r=`; Node: ${t.type} - "${t.title||t.name||t.id}"
${l}:
    db ${sa(t.type)}
    dw ${c}
    dw ${o}
...
`;break;case"SubMenu":{const T=de(t.id),w=(Array.isArray(t.options)?t.options:[]).slice(0,6),D=w.length,N=ml(t),M=D>0?Math.min(N,D-1):0,z=Pt(t.title||t.name||"MENU").toUpperCase(),Q=((u=(d=t==null?void 0:t.appearance)==null?void 0:d.colors)==null?void 0:u.background)||"#000000",v=kt(Q),x=ul(t),U=(i=t==null?void 0:t.appearance)==null?void 0:i.cursorSpriteAssetId,P=pl(a,U),F=P>=0?(h=a.sprites)==null?void 0:h[P]:null,X=x==="char"?!1:P>=0,pe=X?P:255,G=X&&F?hl(F):{layerOffsets:[],layerColors:[]},B=G.layerOffsets.slice(0,4),ee=G.layerColors.slice(0,4),Me=Math.min(ee.length,4);for(;B.length<4;)B.push(0);for(;ee.length<4;)ee.push(0);const Ie=(f=t==null?void 0:t.appearance)==null?void 0:f.backgroundScreenAssetId;let fe="0";if(Ie&&a.screenMaps){const H=a.screenMaps.find(ae=>ae.id===Ie);if(H){const ae=H.name.toUpperCase().replace(/[^A-Z0-9]/g,"_"),se=H.id?`_${H.id.replace(/[^a-zA-Z0-9]/g,"_").slice(-12)}`:"";fe=`load_screen_${ae.toLowerCase()}${se.toLowerCase()}`}}const ie=fe==="0"?"0":`((${fe} - #4000) / #2000)`;r+=`    db ${v}    ; Background color (MSX index)
...
submenu_${T}_title:
`,r+=`    db "${z}", 0
`,w.forEach((H,ae)=>{const se=Pt((H==null?void 0:H.text)||(H==null?void 0:H.label)||(H==null?void 0:H.name)||(H==null?void 0:H.id)||`OPTION ${ae+1}`).toUpperCase();r+=`submenu_${T}_opt${ae}:
`,r+=`    db "${se}", 0
`})}break;case"Text":{const T=de(t.id),w=(t.title||t.name||"").replace(/"/g,"").replace(/\r?\n/g," ").trim().toUpperCase()||"TEXT",D=(t.message||"").replace(/"/g,"").replace(/\r?\n/g," "),N=((s=(m=t.appearance)==null?void 0:m.colors)==null?void 0:s.background)||"#000000",M=kt(N),z=28,Q=D.split(" "),v=[];let x="";for(const G of Q){const B=G.toUpperCase(),ee=x?x+" "+B:B;ee.length>z&&x?(v.push(x),x=B):x=ee}x.trim()&&v.push(x);const U="PRESS FIRE TO CONTINUE",P=[];P.push({row:3,text:w,label:`text_${T}_title`}),v.forEach((G,B)=>{P.push({row:7+B,text:G,label:`text_${T}_msg${B}`})}),P.push({row:20,text:U,label:`text_${T}_prompt`});const F=(y=t.appearance)==null?void 0:y.backgroundScreenAssetId;let X="0";if(F&&a.screenMaps){const G=a.screenMaps.find(B=>B.id===F);if(G){const B=G.name.toUpperCase().replace(/[^A-Z0-9]/g,"_"),ee=G.id?`_${G.id.replace(/[^a-zA-Z0-9]/g,"_").slice(-12)}`:"";X=`load_screen_${B.toLowerCase()}${ee.toLowerCase()}`}}const pe=X==="0"?"0":`((${X} - #4000) / #2000)`;r+=`    DB ${M}                  ; Background color (MSX index from ${N})
...
`,r+=`    DB "${G.text}", 0
`;break}case"Music":{const T=typeof t.trackAssetId=="string"?t.trackAssetId:"",w=a.trackIndexByAssetId||{},D=a.tracks||[];let N=255,M=255,z=t.loop===!1?0:1,Q="";if(t.stop===!0)N=0,z=0;else if(t.autoPlay===!1)Q="; WARNING: Music node autoPlay=false -> no-op in ROM";else if(T&&w[T]!==void 0)N=1,M=w[T];else if(T){const v=D.find(x=>(x==null?void 0:x.id)===T);(v==null?void 0:v.soundChip)==="SCC"?Q=`; WARNING: Track "${T}" uses SCC and is ignored in ROM export`:Q=`; WARNING: Track "${T}" not found / not exportable as PSG`}else Q="; WARNING: Music node has no trackAssetId -> no-op";r+=`    db ${N}, ${M}, ${z}    ; command, track index, loop flag
`,Q&&(r+=`    ${Q}
`);break}case"IfThenElse":const _=t.variableName||"unknown",E=Ut(_,a),C=t.compareValue||0;E?r+=`    dw ${E}    ; Variable to check
`:r+=`    dw 0                 ; WARNING: Missing global variable "${_}"
`,r+=`    db ${C}   ; Compare value
`,r+=`    db 0                 ; Operator (0=equals)
`;break;case"Globals":if(t.variables&&t.variables.length>0){const T=t.variables.map(D=>{const N=D.variableName||D.name||"unknown",M=Ut(N,a),z=D.value||0;return{vName:N,vAsmName:M,vValue:z}}).filter(D=>!!D.vAsmName);r+=`    db ${T.length}    ; Number of assignments
...
`;break;case"Transition":{const T={cls:0,dissolve_pixels:1,dissolve_chars:2,vertical_lines:3,horizontal_lines:4,spiral:5,fill_white_squares:6},w={cls:1,dissolve_pixels:8,dissolve_chars:8,vertical_lines:16,horizontal_lines:24,spiral:96,fill_white_squares:4},D=T[t.effect]??0,N=w[t.effect]??8,M=t.duration??1e3,z=Math.max(1,Math.min(255,Math.round(M/N/20)));r+=`    db ${D}              ; Effect: ${t.effect||"cls"}
`,r+=`    db ${z}              ; Frames per step (duration ${M}ms / ${N} steps / 20ms)
`;break}}r+=`
`}r+=`${o}:
`;const p=((g=e.connections)==null?void 0:g.filter(b=>{var _;return(((_=b.from)==null?void 0:_.nodeId)||b.from)===t.id}))||[];if(t.type==="IfThenElse"){const b=p.find(E=>{var C,T;return((C=E.from)==null?void 0:C.sourceId)==="then"||!((T=E.from)!=null&&T.sourceId)}),_=p.find(E=>{var C;return((C=E.from)==null?void 0:C.sourceId)==="else"});r+=`    db CONNECTION_THEN
...
`}else if(t.type==="SubMenu")(Array.isArray(t.options)?t.options:[]).slice(0,6).forEach((_,E)=>{var T;const C=p.find(w=>{var D;return((D=w.from)==null?void 0:D.sourceId)===_.id});r+=`    db CONNECTION_OPTION_${E}
...
`,l}function Al(t){var n;const e=(n=t.screenMaps)==null?void 0:n.some(c=>{var r;return((r=c.hudConfiguration)==null?void 0:r.elements)&&c.hudConfiguration.elements.length>0}),a=t.screenMaps&&t.screenMaps.length>0?t.screenMaps[0]:null,l=a?bl(a):null;return`; ==================================================================
...
`)}function Pl(t,e,a,l={romMode:"simple32k",targetFormat:"konami",autoMegaROM:!1}){var u,i,h,f,m,s,y,g,A,I;const o=(i=(u=a.gameFlow)==null?void 0:u.nodes)==null?void 0:i.some(S=>S.type==="SubMenu"),n=(h=a.screenMaps)==null?void 0:h.some(S=>{var b,_;return((b=S.layers)==null?void 0:b.text)||((_=S.textElements)==null?void 0:_.length)>0}),c=(f=a.screenMaps)==null?void 0:f.some(S=>{var b;return((b=S.hudConfiguration)==null?void 0:b.elements)&&S.hudConfiguration.elements.length>0}),r=o||n||c,p=xl(t),d=Ml(p);return`; ==================================================================
...
; SPRITE PATTERN DATA
; ==================================================================
`;l.forEach((_,E)=>{const C=`_${E}`,w=(_.name+C).replace(/[^a-zA-Z0-9_]/g,"_").toUpperCase(),D=Ra(_,Ul,E),N=$t(_);s+=`
...
`,l.forEach((_,E)=>{var T;const C=((T=_.frames)==null?void 0:T.length)||1;s+=`    db ${C} ; Sprite ${E}: ${_.name}
`}),l.length===0&&(s+=`    db 1 ; Placeholder
`),s+=`
; Table: Sprite Asset Loop Flags
; Format: db flags (bit 1: 1=loop, 0=once)
sprite_loop_flags:
`,l.forEach((_,E)=>{const T=_.loops!==!1?"2":"0";s+=`    db ${T} ; Sprite ${E}: ${_.name}
...
`),l.forEach((_,E)=>{var M;const C=`_${E}`,w=(_.name+C).replace(/[^a-zA-Z0-9_]/g,"_").toUpperCase(),D=$t(_),N=((M=_.frames)==null?void 0:M.length)||1;s+=`
; Sprite ${E}: ${_.name} frame pointers
SPRITE_${E}_FRAME_PTRS:
`;for(let z=0;z<N;z++)D>=0?s+=`    dw ${w}_F${z}_LAYER${D}
...
`,_.colors.forEach((E,C)=>{s+=`    db ${E} ; Layer ${C}
...
`,l.forEach((_,E)=>{const T=[...d(_)];for(;T.length<y;)T.push(0);s+=`    db ${T.join(", ")} ; Sprite ${E}: ${_.name}
...
load_sprite_patterns:
    ...
    call mapper_push_p2
`;let I=!1;if(h.forEach(_=>{if(_.layerCount===0)return;const E=_.spriteAssetIndex<0?"SPRITE_PLACEHOLDER_PATTERN":`SPRITE_${_.spriteAssetIndex}_PATTERN`;s+=`    ; Entity ${_.entityIndex}: ${_.spriteName} (${_.layerCount} layers)
    ...
    call FAST_LDIRVM
`,I=!0}),!I)if(l.length===0)s+=`    ; No sprites to load
`;else{s+=`    ; No active entities detected, load all sprite assets sequentially
`;let _=0;l.forEach((E,C)=>{var N;const T=d(E).length||1,w=((N=E.frames)==null?void 0:N.length)||1,D=T*w*32;s+=`    ; Sprite Asset ${C}: ${E.name} (${w} frames, ${T} layers)
    ...
    ld bc, ${D}
    call FAST_LDIRVM
`,_+=T*w})}return s+=`    call mapper_pop_p2
    ret
...
`:((b=t.targetVariable)==null?void 0:b.asmName)==="global_var_lives"?`    ; Keep HUD Lives text in sync with the updated global variable.
    ...
    call force_render_hud
    pop de
`:"",f=t.targetVariable&&t.incrementAmount>0?t.targetVariable.isWord?`    ; Tile Collector configured variable increment (16-bit).
...
; END OF COMPONENTS(MINIMAL VERSION)
    ; ==================================================================
        `;const a=Xe(t),l=a.usedComponents,o=Array.isArray(t.tiles)&&t.tiles.some(f=>{var m;return((((m=f.logicalProperties)==null?void 0:m.mapId)??0)&8)!==0}),n=io(t),c=Array.isArray(t.stateMachines)&&t.stateMachines.length>0;o&&l.has("Input")&&l.add("TileInteraction");const r=(f,m)=>{if(!f||typeof f!="object")return!1;const s=String(f.type||"").toUpperCase();if(m.has(s))return!0;const y=Array.isArray(f.conditions)?f.conditions:[];for(const g of y)if(r(g,m))return!0;return!1},p=Array.isArray(t.stateMachines)?t.stateMachines:[],d=new Set(["HAS_COLLISION","HAS_DEADLY_TILE_COLLISION"]);p.some(f=>(Array.isArray(f==null?void 0:f.transitions)?f.transitions:[]).some(s=>r(s==null?void 0:s.conditions,d)))&&!l.has("Collision")&&(console.log("  - Forcing Collision system: required by state machine conditions"),l.add("Collision")),console.log("🎯 Generating optimized components.asm..."),console.log(`  - Active entities: ${a.activeEntities.length} `),console.log(`  - Used components: ${Array.from(l).join(", ")} `),console.log(`  - Filtered out: ${8-l.size} unused components`);let i=`; ==================================================================
...
tile_behavior_table:
    ...
    ${Array(127).fill(0).map((f,m)=>`db TILE_PASSABLE              ; ${m+1}: Passable`).join(`
    `)}

    ; Index 128-255: Project tile characters (solid by default)
    ; MSX Screen 2 assigns character IDs >= 128 to project tiles
    ${Array(128).fill(0).map((f,m)=>`db TILE_SOLID                 ; ${128+m}: Solid`).join(`
    `)}
...
; END OF COMPONENT SYSTEMS
    ; ==================================================================
        `,i}function uo(t){var y,g,A,I;const e=(S,b)=>{if(typeof S=="boolean")return S;if(typeof S=="number")return S!==0;if(typeof S=="string"){const _=S.trim().toLowerCase();if(_==="true")return!0;if(_==="false")return!1;const E=parseInt(_,10);if(!Number.isNaN(E))return E!==0}return b},a=(S,b)=>{const _=typeof S=="number"?S:parseInt(String(S??""),10);return Number.isNaN(_)?b:Math.max(0,Math.min(255,_|0))},l=(S,b)=>{const _=typeof S=="number"?S:parseInt(String(S??""),10);return Number.isNaN(_)?b&255:_<0?256+Math.max(-128,Math.min(-1,_|0))&255:Math.max(0,Math.min(255,_|0))},o=S=>(S&255).toString(16).toUpperCase().padStart(2,"0"),n=S=>{const b=(S==null?void 0:S.screenAssetId)||(S==null?void 0:S.screenId)||(S==null?void 0:S.screenMapId);if(b){const T=t.worldmaps||[];for(const w of T){const N=((w==null?void 0:w.nodes)||[]).findIndex(M=>(M==null?void 0:M.screenAssetId)===b);if(N>=0)return N}}if(typeof(S==null?void 0:S.screenIndex)=="number"&&S.screenIndex>=0)return S.screenIndex;let _=0,E=null;if(t.screenMaps&&t.screenMaps.forEach((T,w)=>{var N;(((N=T==null?void 0:T.layers)==null?void 0:N.entities)||[]).some(M=>M.id===S.id)&&(_=w,E=T.id||null)}),!E)return _;const C=t.worldmaps||[];for(const T of C){const D=((T==null?void 0:T.nodes)||[]).findIndex(N=>(N==null?void 0:N.screenAssetId)===E);if(D>=0)return D}return _},c=S=>{const b={};if(!S||S.length===0)return b;let _=1;return S.forEach(E=>{!E||!E.id||b[E.id]===void 0&&(b[E.id]=_,E.name&&(b[String(E.name)]=_,b[String(E.name).toLowerCase()]=_),_<255&&(_+=1))}),b},p=Xe(t).activeEntities,d=2,u=16,i=c(t.templates),h=S=>String(S??"entity").toUpperCase().replace(/[^A-Z0-9]/g,"_").replace(/^_+|_+$/g,"")||"ENTITY",f=new Map,m=p.map((S,b)=>{const _=h((S==null?void 0:S.name)||`ENTITY_${b}`),E=(f.get(_)||0)+1;return f.set(_,E),E===1?_:`${_}_${E}`});console.log("🎯 Generating optimized entities.asm..."),console.log(`  - Total entity templates in JSON: ${((y=t.templates)==null?void 0:y.length)||0}`),console.log(`  - Actually instantiated entities: ${p.length}`),console.log(`  - Filtered out: ${(((g=t.templates)==null?void 0:g.length)||0)-p.length} unused templates`);let s=`; ==================================================================
; GAME ENTITIES
; File: entities.asm
...
`,p.forEach((b,_)=>{var w;const E=m[_],C=(w=t.templates)==null?void 0:w.find(D=>D.id===b.entityTemplateId),T=Ft(b,C,t);s+=`; Entity: ${b.name} (instance from template: ${b.entityTemplateId})
ENTITY_${E}_ID EQU ${_}
ENTITY_${E}_COMP_MASK EQU #${T.toString(16).toUpperCase().padStart(2,"0")}  ; Component mask: ${T.toString(2).padStart(8,"0")}b
`,b.entityTemplateId&&(s+=`; Template: ${b.entityTemplateId}
`),b.position&&(s+=`ENTITY_${E}_X EQU ${b.position.x}
ENTITY_${E}_Y EQU ${b.position.y}
`),s+=`
`}),s+=`; ==================================================================
...
`,p.length>0?p.forEach((b,_)=>{const E=m[_];s+=`    call init_${E.toLowerCase()}
`}):s+=`    ; No entities to initialize
`,s+=`    ret

update_entities:
    ; Update all active entities (${p.length} entities)
`,p.length>0?p.forEach((b,_)=>{const E=m[_];s+=`    ; Skip entity update if entity belongs to another screen
...
`;let S=!1;p.forEach((b,_)=>{var mt,ft,bt,yt,gt,Et,St,At,Tt,Ct,It,vt,wt,Lt,Rt;const E=m[_],C=(mt=t.templates)==null?void 0:mt.find(O=>O.id===b.entityTemplateId),T=Ft(b,C,t),w=(T&d)!==0,D=(T&u)!==0;w&&D&&(S=!0);const N=((ft=b.position)==null?void 0:ft.x)||100,M=((bt=b.position)==null?void 0:bt.y)||100,z=8,Q=8,v=N*z,x=M*Q,U=Math.min(v,240),P=Math.min(x,191);(v!==U||x!==P)&&console.warn(`Entity ${b.name} position clamped: (${v},${x}) → (${U},${P})`);const F=[];T&1&&F.push("Position"),T&2&&F.push("Sprite"),T&4&&F.push("Movement"),T&8&&F.push("Collision"),T&16&&F.push("Input"),T&32&&F.push("Behavior"),T&64&&F.push("Health"),T&128&&F.push("Animation"),T&256&&F.push("Jump"),T&512&&F.push("Gravity");let X=15,pe=2;if(T&16){const O=C==null?void 0:C.components.find(W=>W.definitionId==="comp_cursors"||W.definitionId==="comp_input"||W.definitionId==="comp_player_input");if(O){const W=O.defaultValues||{},te=((yt=b.componentOverrides)==null?void 0:yt.comp_cursors)||{},$={...W,...te};pe=Math.max(1,a($.speed??2,2)),X=0,$.allowUp!==!1&&(X|=1),$.allowDown!==!1&&(X|=2),$.allowLeft!==!1&&(X|=4),$.allowRight!==!1&&(X|=8)}}let G=1;if(T&256){const O=(gt=C==null?void 0:C.components)==null?void 0:gt.find(W=>W.definitionId==="comp_jump");if(O){const W=O.defaultValues||{},te=((Et=b.componentOverrides)==null?void 0:Et.comp_jump)||{},$={...W,...te};G=Math.max(1,a($.maxJumps??1,1))}}const B=[];X&1&&B.push("UP"),X&2&&B.push("DOWN"),X&4&&B.push("LEFT"),X&8&&B.push("RIGHT");const ee=B.length===4?"All directions":B.join("+");let Me="";if(T&128){const O=(St=C==null?void 0:C.components)==null?void 0:St.find(Pe=>Pe.definitionId==="comp_animation"||Pe.definitionName==="Animation"),W=(O==null?void 0:O.defaultValues)||(O==null?void 0:O.values)||{},te=((At=b.componentOverrides)==null?void 0:At.comp_animation)||{},$={...W,...te},le=a($.currentFrameIndex??$.currentFrame??0,0),re=Math.max(1,a($.animationSpeed??6,6)),ne=e($.loops,!0),ue=e($.isPlaying,!0),ve=e($.animateOnlyWhenMoving,!1),qe=(ue?1:0)|(ne?2:0)|(ve?4:0);Me=`
...
`}let Ie="",fe=!1,ie=0,H=0,ae=0,se=0,_e=0,he=0;const pt=(Tt=C==null?void 0:C.components)==null?void 0:Tt.find(O=>O.definitionId==="comp_patrol");if(pt){fe=!0;const O=pt.defaultValues||{},W=((Ct=b.componentOverrides)==null?void 0:Ct.comp_patrol)||{},te={...O,...W};ie=Math.max(0,Math.min(255,Number(te.waypoint1_x)||0)),H=Math.max(0,Math.min(191,Number(te.waypoint1_y)||0)),ae=Math.max(0,Math.min(255,Number(te.waypoint2_x??ie))),se=Math.max(0,Math.min(191,Number(te.waypoint2_y??H)));const $=ae-ie,le=se-H,re=Math.sqrt($*$+le*le),ne=Number(te.speed)||1;re>0&&(_e=Math.round($/re*ne),he=Math.round(le/re*ne),$!==0&&_e===0&&(_e=$>0?1:-1),le!==0&&he===0&&(he=le>0?1:-1));const ue=_e>=0?_e:256+_e,ve=he>=0?he:256+he;Ie=`
...
`}let _t="";if(T&8){const O=(It=C==null?void 0:C.components)==null?void 0:It.find(Dt=>Dt.definitionId==="comp_collision"||Dt.definitionName==="Collision"),W=(O==null?void 0:O.defaultValues)||{},te=((vt=b.componentOverrides)==null?void 0:vt.comp_collision)||{},$={...W,...te},le=a($.hitboxWidth,16),re=a($.hitboxHeight,16),ne=l($.offsetX,0),ue=l($.offsetY,0),ve=ne>=128?ne-256:ne,qe=ue>=128?ue-256:ue,Pe=a($.collisionLayer,1),ba=a($.collidesWith,255);_t=`
    ...
    ld hl, entity_collides_with
    add hl, de
    ld (hl), #${o(ba)}      ; collidesWith
`}let ht="";const Ke=(wt=b.componentOverrides)==null?void 0:wt.comp_statemachine,Ze=(Lt=C==null?void 0:C.components)==null?void 0:Lt.find(O=>O.definitionId==="comp_statemachine"),ut=(Ke==null?void 0:Ke.stateMachineAssetId)||((Rt=Ze==null?void 0:Ze.defaultValues)==null?void 0:Rt.stateMachineAssetId);if(ut&&t.stateMachines){const O=t.stateMachines.find(W=>W.id===ut);if(O&&O.states&&O.states.length>0){let W=O.states[0];if(O.initialStateId){const le=O.states.find(re=>re.id===O.initialStateId);le&&(W=le)}const $=`SM_${O.name.replace(/[^a-zA-Z0-9]/g,"_")}_${W.id.replace(/[^a-zA-Z0-9]/g,"_")}`;ht=`
...
`}}let L="";if(fe){w&&(S=!0);const O=Math.min(ie,ae),W=Math.max(ie,ae),te=Math.min(H,se),$=Math.max(H,se),le=ie!==ae,re=H!==se,ne=re?`.patrol_check_y_${_}`:`.patrol_end_${_}`;L=`update_${E.toLowerCase()}:
...
`,L+=`    ret
`;const ma=n(b),fa=i[b.entityTemplateId]??0;s+=`init_${E.toLowerCase()}:
...
`,t.screenMaps.forEach(l=>{var o,n;if(l.layers&&l.layers.background){const c=[];if(t.tiles&&t.tiles.length>0){const y={...Aa[1],assignedTiles:{},charsetRangeStart:128,charsetRangeEnd:255,enabled:!0};let g=128;t.tiles.forEach(I=>{if(I&&I.id){const S=Math.ceil(I.width/8),b=Math.ceil(I.height/8);y.assignedTiles[I.id]={charCode:g,assignedAt:Date.now()},g+=S*b}});const A={id:"global_auto_bank",name:"Global Auto Bank",banks:[y,y,y]};c.push(A),console.log(`✅ Created GLOBAL tile bank with ${Object.keys(y.assignedTiles).length} assigned tiles`)}const r=[];l.activeAreaX,l.activeAreaY,l.activeAreaWidth??l.width,l.activeAreaHeight??l.height;const p=32,d=24;for(let s=0;s<d;s++)for(let y=0;y<p;y++){const g=(o=l.layers.background[s])==null?void 0:o[y];if(!g||!g.tileId)r.push(0);else{let A=0;const I=(n=t.tiles)==null?void 0:n.find(b=>b.id===g.tileId),S=c.length>0?c[0].banks:void 0;if(S&&I){let b=!1;for(const _ of S)if((_.enabled??!0)&&_.assignedTiles[g.tileId]){const E=_.assignedTiles[g.tileId].charCode,C=Math.ceil(I.width/Ae),T=g.subTileX||0,w=g.subTileY||0;if(A=E+w*C+T,A>=_.charsetRangeStart&&A<=_.charsetRangeEnd){b=!0;break}else A=0}b||(A=0)}else A=0;r.push(A)}}const u=r.filter(s=>s!==255).length,i=new Set(r);console.log(`📊 Generated ${r.length} bytes: ${u} non-FF (${(u/r.length*100).toFixed(1)}%)`),console.log(`🎯 Unique byte values: [${Array.from(i).sort((s,y)=>s-y).join(", ")}]`);const h=[];h.push('; Generated using exact Screen Editor "Download ASM" logic'),h.push("; Byte values represent actual character codes in VRAM");const f=`${l.name}_${t.screenMaps.indexOf(l)}`,m=Pa(f,p,d,r,h,"hex");if(a+=m,l.layers.collision&&t.tiles){const s=l.layers.collision,y=[];s.forEach(A=>{A.forEach(I=>{var S,b;if(I.tileId){const _=(S=t.tiles)==null?void 0:S.find(E=>E.id===I.tileId);y.push(((b=_==null?void 0:_.logicalProperties)==null?void 0:b.mapId)??0)}else y.push(0)})});const g=Oa(f,l.width,l.height,y,"hex");a+=`
...
`,t.screenMaps.forEach((l,o)=>{var C,T;const n=l.name.toUpperCase().replace(/[^A-Z0-9]/g,"_"),c=l.backgroundColor!==void 0?l.backgroundColor:1,r=l.borderColor!==void 0?l.borderColor:1,p=l.id?`_${l.id.replace(/[^a-zA-Z0-9]/g,"_").slice(-12)}`:"",d=l.activeAreaX??0,u=l.activeAreaY??0,i=l.activeAreaWidth??l.width??32,h=l.activeAreaHeight??l.height??24,f=Math.max(0,Math.min(31,d)),m=Math.max(0,Math.min(23,u)),s=Math.max(0,Math.min(32-f,i)),y=Math.max(0,Math.min(24-m,h)),A=(f>0||m>0||s<32||y<24)&&s>0&&y>0,I=m*32+f,S=s*y,b=(((T=(C=l.hudConfiguration)==null?void 0:C.importedFrame)==null?void 0:T.cells)||[]).filter(w=>typeof(w==null?void 0:w.x)=="number"&&typeof(w==null?void 0:w.y)=="number"&&typeof(w==null?void 0:w.charCode)=="number"&&w.x>=0&&w.x<32&&w.y>=0&&w.y<24).map(w=>({x:w.x|0,y:w.y|0,charCode:w.charCode&255})),_=b.length>0,E=`hud_imported_frame_${n.toLowerCase()}${p.toLowerCase()}`;_&&(a+=`${E}_data:
    ; Imported HUD frame snapshot for ${l.name} (${b.length} cells)
`,b.forEach(w=>{const D=w.y*32+w.x,N=D&255,M=D>>8&255,z=w.charCode&255;a+=`    DB #${N.toString(16).padStart(2,"0").toUpperCase()},#${M.toString(16).padStart(2,"0").toUpperCase()},#${z.toString(16).padStart(2,"0").toUpperCase()}
`}),a+=`
${E}_draw:
...
`,r+=`    DB ${g.map(I=>"#"+I.toString(16).padStart(2,"0").toUpperCase()).join(", ")}
`,p+=`    ; Char ${s}
...
; END OF FONT DATA
; ==================================================================
`}function Ht(t,e){return(Array.isArray(t.globalVariables)?t.globalVariables:[]).some(l=>String((l==null?void 0:l.asmName)||"").trim().toLowerCase()===e.toLowerCase())}function bo(t){var n,c,r;const e=[],a=new Map;if(console.log(`🎯 [HUD Generator] Total screens: ${((n=t.screenMaps)==null?void 0:n.length)||0}`),(c=t.screenMaps)==null||c.forEach(p=>{var i;const d=!!p.hudConfiguration,u=((i=p.hudConfiguration)==null?void 0:i.elements)||[];console.log(`  📺 Screen "${p.name}" (${p.id}): hudConfiguration=${d}, elements=${u.length}`),u.length>0&&(u.forEach((h,f)=>console.log(`    📝 Element[${f}]: type=${h.type}, name="${h.name}", text="${h.text||""}" pos=(${h.position.x},${h.position.y}) visible=${h.visible}`)),e.push(...u),a.set(p.id,u))}),console.log(`🎯 [HUD Generator] Total HUD elements found: ${e.length}`),e.length===0)return`; ==================================================================
...
`}function So(t){const e=t.findIndex(b=>b.type===q.Score),a=t.findIndex(b=>b.type===q.Lives),l=e>=0?t[e]:null,o=a>=0?t[a]:null,n=e>=0?`hud_text_${e}`:null,c=a>=0?`hud_text_${a}`:null,r=(b,_)=>{const E=b||"",C=/\d+(?!.*\d)/.exec(E);return!C||typeof C.index!="number"?{offset:E.length,digits:_}:{offset:C.index,digits:Math.max(1,C[0].length)}},p=(l==null?void 0:l.text)||(l==null?void 0:l.name)||"",d=(o==null?void 0:o.text)||(o==null?void 0:o.name)||"",u=r(p,5),i=r(d,1),h=(b,_)=>{var T,w;if(!b)return null;const E=Math.floor((((T=b.position)==null?void 0:T.x)||0)/8)+_;return 6144+Math.floor((((w=b.position)==null?void 0:w.y)||0)/8)*32+E},f=h(l,u.offset),m=h(o,i.offset),s=Math.min(u.digits,5),y=Math.max(0,u.digits-s),g=[1e4,1e3,100,10],A=g.slice(g.length-Math.max(0,s-1)),I=Array.from({length:y},(b,_)=>`    ; Leading digit ${_}: forced zero (Score is 16-bit max 65535)
    ld a, '0'
    push hl
    ld h, d
    ld l, e
...
`,n.nodes&&n.nodes.length>0){const u=new Map;n.nodes.forEach((i,h)=>{const f=Be(i.name||`screen_${h}`),m=u.get(f)||0,s=m===0?f:`${f}_${m+1}`;u.set(f,m+1),l+=`WORLD_${r}_SCREEN_${s}_ID EQU ${h}
`})}l+=`
`}),l+=`; ==================================================================
...
`;return}const h=at(i,t),f=Co(n,t);l+=`    ; Load start screen: ${d.name||"unknown"} (${i})
    ld a, ((${h} - #4000) / #2000)
    ld hl, ${h}
    call mapper_call_hl_auto
...
`;return}const f=r.find(A=>A.id===i),m=r.find(A=>A.id===h);if(!f||!m){l+=`; Invalid connection ${u}: missing nodes

`;return}const s=m.screenAssetId,y=r.findIndex(A=>A.id===m.id),g=at(s,t);l+=`; Transition: ${f.name||"screen"} -> ${m.name||"screen"}
transition_${$e(c)}_${u}:
    ld a, ((${g} - #4000) / #2000)
    ld hl, ${g}
    call mapper_call_hl_auto
...
`;return}const i=new Map;d.forEach((f,m)=>i.set(f.id,m));const h=new Map;d.forEach((f,m)=>h.set(m,{})),u.forEach(f=>{const m=je(f,"from"),s=je(f,"to"),y=Vt(f,"from"),g=Vt(f,"to");if(!m||!s)return;const A=i.get(m),I=i.get(s);if(!(A===void 0||I===void 0)){if(y){const S=h.get(A);S&&S[y]===void 0&&(S[y]=I)}if(g){const S=h.get(I);S&&S[g]===void 0&&(S[g]=A)}}}),l+=`    ld a, (current_screen_index)
`,d.forEach((f,m)=>{const s=`check_transition_${p}_screen_${m}`;l+=`    cp ${m}
    jp z, ${s}
`}),l+=`    ret

`,d.forEach((f,m)=>{const s=h.get(m)||{},y=`check_transition_${p}_screen_${m}`;l+=`${y}:
`;const g=["east","west","south","north"];let A=!1;g.forEach(I=>{const S=s[I];if(S===void 0)return;const b=d[S];if(!(b!=null&&b.screenAssetId))return;const _=at(b.screenAssetId,t);l+=Io(p,m,I,S,_),A=!0}),l+=`    ret
...
`,t.gameFlow.nodes.filter(n=>n.type==="SubMenu").forEach(n=>{var i,h,f,m;(n.title||n.id).toUpperCase().replace(/[^A-Z0-9]/g,"_");const c=n.id.replace(/[^a-zA-Z0-9]/g,"_"),r=((h=(i=n.appearance)==null?void 0:i.colors)==null?void 0:h.background)||"#000000",p=((m=(f=n.appearance)==null?void 0:f.colors)==null?void 0:m.border)||"#FFFFFF",d=Gt(r),u=Gt(p);a+=`show_menu_${c}:
...
`}),a+=`
`,e.forEach((l,o)=>{const n=Array.isArray(l==null?void 0:l.channels)?l.channels:[],c=[0,1,2].map(u=>{const i=n[u],h=Array.isArray(i==null?void 0:i.steps)?i.steps:[],f=[];for(const m of h){const s=Ho(m==null?void 0:m.durationMs);for(let y=0;y<s;y++)f.push(m||{})}return f}),r=Math.max(c[0].length,c[1].length,c[2].length),p=Math.min(255,r),d=Math.max(0,Math.min(31,_a(l==null?void 0:l.noisePeriod)));if(a+=`SM_SoundAsset_${o}:
`,a+=`    DB ${p}
`,a+=`    DW SM_SoundAsset_${o}_Frames
`,a+=`
`,a+=`SM_SoundAsset_${o}_Frames:
`,p===0){a+=`    ; Empty sound asset: silent
`;return}for(let u=0;u<p;u++){let i=63;const h=[];for(let f=0;f<3;f++){const m=c[f][u],s=jo(m==null?void 0:m.tonePeriod),y=s&255,g=s>>8&15,A=m?Bo(m.volume):0,I=!!(m!=null&&m.toneEnabled),S=!!(m!=null&&m.noiseEnabled);I&&(i&=~(1<<f)),S&&(i&=~(1<<f+3)),h.push(y,g,A)}h.push(d,i&63),a+=`    DB ${h.join(", ")}
`}a+=`
...
`;const u=xo(e),i=Mo(l),h=pa(o),f=zo(n),m=Uo(o,d,h),s=(y,g)=>{const A=g.map(I=>Math.max(0,Math.min(255,I|0)));return`${y}:
    DB ${A.join(", ")}
`};r+=`; ==================================================================
...
`,r+=`; ==================================================================
`,r+=Vo(n),r+=`
`;for(const y of t)r+=Wo(y,u,d,i,h,f,c);return r}function Wo(t,e,a,l,o,n,c){let r=`; State Machine: ${t.name} (${t.id}) 
`;const p=t.name.replace(/[^a-zA-Z0-9]/g,"_"),d=u=>{if(!u)return!1;const i=u.trim().toLowerCase();return i==="any"||i==="__any_state__"||i==="any state (*)"};for(const u of t.states){const i=`SM_${p}_${u.id.replace(/[^a-zA-Z0-9]/g,"_")}`,h=`${i}_OnEnter`,f=`${i}_OnExit`,m=`${i}_Transitions`;r+=`${i}: 
`,r+=`    DB 0; ID(unused) 
`,r+=`    DW ${u.onEnter&&u.onEnter.length>0?h:0} 
`,r+=`    DW ${u.onExit&&u.onExit.length>0?f:0} 
...
`}if(u.onExit&&u.onExit.length>0){r+=`${f}: 
`;for(const y of u.onExit)r+=ot(y,t.name,e,a,l,o,n,c);r+=`    DB 0xFF; END
`}if(s.length>0){r+=`${m}: 
`,r+=`    DB ${s.length}; Count
`;const y=[];s.forEach((g,A)=>{const S=d(g.fromStateId)&&d(g.toStateId)?"0":`SM_${p}_${g.toStateId.replace(/[^a-zA-Z0-9]/g,"_")}`,b=g.actions&&g.actions.length>0?`${m}_Actions_${A}`:"0";if(g.conditions?r+=it(g.conditions,e):r+=`    DB 0; Empty Condition(Always True) 
`,r+=`    DW ${S} 
`,r+=`    DW ${b} 
`,b!=="0"){let _=`${b}: 
...
`;break;case R.CHANGE_SPRITE:{const i=t.params.sprite||t.params.spriteId||"";let h=0;if(l&&typeof i=="string"){const f=l[i],m=l[i.toLowerCase()];f!==void 0?h=f:m!==void 0?h=m:h=k(i)==="0"?0:parseInt(k(i),10)||0}else h=k(i)==="0"?0:parseInt(k(i),10)||0;d+=`    DB ${h}; sprite: ${i} 
...
`;break;case R.PLAY_SOUND:{const i=t.params.soundId??t.params.sound??t.params.soundAssetId??0;let h=255;if(typeof i=="string"){const f=c==null?void 0:c[i],m=c==null?void 0:c[i.toLowerCase()];f!==void 0?h=f:m!==void 0&&(h=m)}else{const f=parseInt(k(i),10);isNaN(f)||(h=f)}d+=`    DB ${h}        ; sound: ${i}
`;break}case R.PLAY_MUSIC:{const i=t.params.trackId??t.params.musicId??t.params.music??0,h=t.params.loop??!0,f=Yo(i,r),m=f===255&&i!==0&&i!=="0"?`        ; WARNING: unresolved/non-PSG track ${i}`:"";d+=`    DB ${f}, ${k(h)}        ; track: ${i}${m}
`;break}case R.SET_VARIABLE:case R.INCREMENT_VARIABLE:case R.DECREMENT_VARIABLE:{const i=t.params.variable||t.params.variableName||t.params.name,h=(a==null?void 0:a[i])??0,f=t.params.value??t.params.amount??0;d+=`    DB ${h}, ${k(f)}        ; ${i} (ID ${h})
...
`;break;case R.SPAWN_ENTITY:{const i=t.params.templateId??t.params.entityTemplateId??t.params.entityId??0,h=typeof i=="string"?(n==null?void 0:n[i])??(n==null?void 0:n[i.toLowerCase()])??0:parseInt(k(i),10)||0,f=t.params.x??0,m=t.params.y??0;d+=`    DB ${h}, ${k(f)}, ${k(m)}        ; template=${i}=>${h}
`;break}case R.DESTROY_ENTITY:{const i=((u=t.params)==null?void 0:u.target)||"self";d+=`    DB ${i==="other"?1:0}          ; Target: ${i}
`;break}case R.GET_RANDOM_ENTITY_POSITION:{const i=t.params.templateId??t.params.entityTemplateId??0,h=typeof i=="string"?(n==null?void 0:n[i])??(n==null?void 0:n[i.toLowerCase()])??0:parseInt(k(i),10)||0,f=t.params.targetVariableX??t.params.variableX,m=t.params.targetVariableY??t.params.variableY,s=(a==null?void 0:a[f])??0,y=(a==null?void 0:a[m])??0;d+=`    DB ${h}, ${s}, ${y}        ; template=${i}, x->${f}(${s}), y->${m}(${y})
`;break}case R.SET_COMPONENT_PROPERTY:{const i=t.params.componentId??t.params.component??t.params.compId??0,h=t.params.propertyName??t.params.prop??t.params.name??0,f=t.params.value??0,m=Po(i),s=Oo(h);let y=k(f);if(s===5&&typeof f=="string"&&l){const g=l[f],A=l[f.toLowerCase()];g!==void 0?y=String(g):A!==void 0&&(y=String(A))}d+=`    DB ${m}, ${s}, ${y}        ; comp=${i}=>${m}, prop=${h}=>${s}, value=${f}
`;break}case R.CHANGE_GAME_FLOW_NODE:{const i=t.params.nodeId??t.params.targetNodeId??0,h=typeof i=="string"&&i.toUpperCase()==="START"?255:k(i);d+=`    DB ${h}        ; node=${i}
`;break}case R.BREAK_TILE:{const i=String(t.params.direction||"up").toLowerCase(),h=Zt[i]??0;d+=`    DB 0, ${h}        ; BREAK_TILE dir=${i}
`;break}case R.REPLACE_TILE:{const i=String(t.params.direction||"up").toLowerCase(),h=Zt[i]??0,f=t.params.replacementTileId??t.params.tileId??0,m=ko(f,o);d+=`    DB ${m}, ${h}        ; REPLACE_TILE tile=${f}=>${m}, dir=${i}
`;break}case R.RND:{const i=t.params.variable??t.params.variableName??t.params.targetVariable??t.params.name,h=(a==null?void 0:a[i])??k(t.params.varId??0),f=k(t.params.dataType??t.params.type??0);d+=`    DB ${h}, ${f}        ; RND var=${i??t.params.varId??0}, type=${t.params.dataType??t.params.type??0}
`;break}case R.POINT_AT:{const i=k(t.params.x1??0),h=k(t.params.y1??0),f=k(t.params.x2??0),m=k(t.params.y2??0),s=k(t.params.speed??1);d+=`    DB ${i}, ${h}, ${f}, ${m}, ${s}
`;break}case R.DECREASE_LIVES:case R.INCREASE_LIVES:{const i=t.params.amount??1;d+=`    DB ${k(i)} 
`;break}case R.RESPAWN_PLAYER:{const i=t.params.x??255,h=t.params.y??255;d+=`    DB ${k(i)}, ${k(h)} 
`;break}case R.ADD_VARIABLES:case R.SUBTRACT_VARIABLES:case R.MULTIPLY_VARIABLES:case R.DIVIDE_VARIABLES:case R.MODULO_VARIABLES:{const i=t.params.destination||t.params.dest||t.params.result,h=t.params.source1||t.params.src1||t.params.operand1,f=t.params.source2||t.params.src2||t.params.operand2,m=(a==null?void 0:a[i])??0,s=(a==null?void 0:a[h])??0,y=(a==null?void 0:a[f])??0,g=t.type===R.ADD_VARIABLES?"ADD":t.type===R.SUBTRACT_VARIABLES?"SUB":t.type===R.MULTIPLY_VARIABLES?"MUL":t.type===R.DIVIDE_VARIABLES?"DIV":"MOD";d+=`    DB ${m}, ${s}, ${y}        ; ${i} = ${h} ${g} ${f}
...
`;break}return d}function it(t,e){var o,n,c,r,p,d,u,i,h,f,m,s,y,g,A,I,S;const a=Lo[t.type];if(!a)return console.warn(`[State Machine Generator] Unknown condition "${t.type}". Falling back to NOP condition.`),`    DB 0; FALLBACK NOP for unknown condition ${t.type}
`;let l=`    DB ${a}; ${t.type} 
`;switch(t.type){case j.KEY_PRESSED:case j.KEY_RELEASED:{const b=(n=(o=t.params)==null?void 0:o.key)==null?void 0:n.toLowerCase(),_=Qt[b]??0;l+=`    DB ${_}          ; Key: ${b||"unknown"}
...
`;break}case j.ON_WALL_COLLISION:{const b=String(((p=t.params)==null?void 0:p.direction)||"any").toLowerCase(),_=Xt[b]??0;b in Xt||console.warn(`[State Machine Generator] Unknown direction "${b}" in ON_WALL_COLLISION. Using any.`),l+=`    DB ${_}          ; Wall direction: ${b}
`;break}case j.HAS_COLLISION:{const b=String(((d=t.params)==null?void 0:d.collisionType)||"any").toLowerCase();let _=Kt[b];_===void 0&&(console.warn(`[State Machine Generator] Unknown collisionType "${b}" in HAS_COLLISION. Using any.`),_=Kt.any),l+=`    DB ${_}          ; collisionType: ${b}
...
`;break}case j.ANIMATION_COMPLETE:break;case j.KEY_AND_MOVEMENT:{const b=String(((i=t.params)==null?void 0:i.key)||"").toLowerCase(),_=Qt[b]??0,E=String(((h=t.params)==null?void 0:h.direction)||"").toLowerCase();let C=lt[E]??0;!E&&_!==9&&(C=_),E&&C===0&&console.warn(`[State Machine Generator] Unknown direction "${E}" in KEY_AND_MOVEMENT. Using 0.`),l+=`    DB ${_}, ${C}          ; key=${b||"unknown"}, dir=${E||"auto"}
`;break}case j.AND:case j.OR:case j.XOR:if(t.conditions){l+=`    DB ${t.conditions.length} 
`;for(const b of t.conditions)l+=it(b,e)}else l+=`    DB 0
...
`);break;case j.VARIABLE_COMPARE:{const b=((f=t.params)==null?void 0:f.variable)||"x",_=e==null?void 0:e[b];if(_===void 0)console.warn(`[State Machine Generator] Unknown variable "${b}" in VARIABLE_COMPARE. Using x (ID 0) as fallback.`),l+=`    DB 0, ${Yt[((m=t.params)==null?void 0:m.operator)||"=="]||0}, ${k(((s=t.params)==null?void 0:s.value)||0)}; FALLBACK: unknown var "${b}" -> x ${((y=t.params)==null?void 0:y.operator)||"=="} ${((g=t.params)==null?void 0:g.value)||0}
`;else{const E=Yt[((A=t.params)==null?void 0:A.operator)||"=="]||0,C=((I=t.params)==null?void 0:I.value)||0;l+=`    DB ${_}, ${E}, ${k(C)}; ${b} (ID ${_}) ${((S=t.params)==null?void 0:S.operator)||"=="} ${C}
...
; ==================================================================
`}const Tn="SCREEN 2 (Graphics I)";function me(t,e,a=0,l=255){return Number.isFinite(t)?t<a?a:t>l?l:Math.floor(t):e}function rt(t){return String(t||"").trim().toLowerCase()}function Cn(t){const e=String(t||"").trim();if(!e)return null;const a=e.match(/^(.*?)(?:[_\-\s](?:f|frame))(\d+)$/i);if(!a)return null;const l=String(a[1]||"").trim(),o=parseInt(a[2],10);return!l||Number.isNaN(o)?null:{groupId:l,frameOrder:o}}const ha={rotate_left:1,rotate_right:2,shift_left:3,shift_right:4,shift_up:5,shift_down:6,swap_top_bottom:7};function In(t){return String(t||"").trim().toLowerCase()==="transform"?"transform":"frames"}function ua(t){const e=String(t||"").trim().toLowerCase();return e&&Object.prototype.hasOwnProperty.call(ha,e)?e:null}function vn(t){const e=(t==null?void 0:t.animation)??(t==null?void 0:t.animatedTile)??(t==null?void 0:t.tileAnimation)??null;if((typeof(e==null?void 0:e.enabled)=="boolean"?e.enabled:typeof(t==null?void 0:t.isAnimated)=="boolean"?t.isAnimated:void 0)===!1||e===!1)return{enabled:!1,mode:"frames",groupId:null,frameOrder:null,speed:null,baseTileId:null,transformEffect:null,transformIncludeColors:!0};const l=(t==null?void 0:t.animationGroup)??(e==null?void 0:e.groupId)??(e==null?void 0:e.group)??(e==null?void 0:e.name)??(e==null?void 0:e.id)??null,o=typeof l=="string"&&l.trim()?l.trim():null,n=(t==null?void 0:t.animationFrameIndex)??(t==null?void 0:t.frameIndex)??(e==null?void 0:e.frameIndex)??(e==null?void 0:e.frame)??null,c=Number.isFinite(Number(n))?me(Number(n),0):null,r=(t==null?void 0:t.animationSpeed)??(t==null?void 0:t.animationSpeedFrames)??(e==null?void 0:e.speed)??(e==null?void 0:e.speedFrames)??(e==null?void 0:e.ticksPerFrame)??null,p=Number.isFinite(Number(r))?me(Number(r),8,1,255):null,d=(t==null?void 0:t.animationBaseTileId)??(e==null?void 0:e.baseTileId)??(e==null?void 0:e.targetTileId)??null,u=typeof d=="string"&&d.trim()?d.trim():null,i=(e==null?void 0:e.transform)??null,h=ua((t==null?void 0:t.animationTransformEffect)??(e==null?void 0:e.transformEffect)??(i==null?void 0:i.effect)??(e==null?void 0:e.effect)),f=(t==null?void 0:t.animationMode)??(e==null?void 0:e.mode)??(e==null?void 0:e.animationMode)??(h?"transform":null),m=In(f),s=h||(m==="transform"?"rotate_left":null),y=(t==null?void 0:t.animationTransformIncludeColors)??(e==null?void 0:e.animationTransformIncludeColors)??(i==null?void 0:i.includeColors);return{enabled:!0,mode:m,groupId:o,frameOrder:c,speed:p,baseTileId:u,transformEffect:s,transformIncludeColors:typeof y=="boolean"?y:!0}}function wn(t){const e=new Map,a=Array.isArray(t.tiles)?t.tiles:[];let l=128;return a.forEach((o,n)=>{if(!(o!=null&&o.id))return;const c=Math.max(1,Math.ceil((o.width||8)/8)),r=Math.max(1,Math.ceil((o.height||8)/8)),p=c*r;e.set(o.id,{charCode:l,charsPerTile:p,tileIndex:n}),l+=p}),e}function Ln(t){return`#${me(t,0).toString(16).toUpperCase().padStart(2,"0")}`}function ea(t,e){return String(t||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")||e}function Rn(t,e=16){if(!t.length)return"    db #00";const a=[];for(let l=0;l<t.length;l+=e){const o=t.slice(l,l+e).map(Ln).join(", ");a.push(`    db ${o}`)}return a.join(`
`)}function Dn(t){var c,r;const e=Array.isArray(t.tiles)?t.tiles:[];if(!e.length)return{frameGroups:[],transformGroups:[]};const a=wn(t),l=new Map,o=[];e.forEach((p,d)=>{const u=String((p==null?void 0:p.id)||"").trim();if(!u)return;const i=a.get(u);if(!i)return;const h=vn(p);if(!h.enabled)return;const f=Cn((p==null?void 0:p.name)||""),m=(h.groupId||(f==null?void 0:f.groupId)||(p==null?void 0:p.name)||u||"").trim();if(h.mode==="transform"){const I=ua(h.transformEffect);if(!I)return;const b=(h.baseTileId&&a.has(h.baseTileId)?h.baseTileId:null)||u,_=a.get(b);if(!_)return;const E=_.charCode,C=_.charsPerTile;if(E<0||E+C-1>255)return;const T=ha[I];if(!T)return;const w=h.transformIncludeColors?1:0,D=`anim_transform_${o.length}_${ea(m,`t${o.length}`)}`;o.push({label:D,groupId:m,speed:me(h.speed??8,8,1,255),targetTileId:b,targetCharCode:E,charsPerTile:C,operationCode:T,flags:w});return}if(!m)return;let s=h.frameOrder;s===null&&f&&(!h.groupId||rt(h.groupId)===rt(f.groupId))&&(s=f.frameOrder),s===null&&(s=i.tileIndex);const y=me(h.speed??8,8,1,255),g=rt(m),A=l.get(g)||[];A.push({tile:p,tileIndex:d,tileId:u,groupId:m,frameOrder:s,speed:y,baseTileId:h.baseTileId}),l.set(g,A)});const n=[];for(const p of l.values()){if(p.length<2)continue;const d=[...p].sort((b,_)=>b.frameOrder!==_.frameOrder?b.frameOrder-_.frameOrder:b.tileIndex-_.tileIndex),i=((c=d.find(b=>!!b.baseTileId&&a.has(b.baseTileId)))==null?void 0:c.baseTileId)||null||d[0].tileId,h=a.get(i);if(!h)continue;const f=d.filter(b=>{const _=a.get(b.tileId);return!!_&&_.charsPerTile===h.charsPerTile});if(f.length<2)continue;const m=h.charCode,s=h.charsPerTile;if(m<0||m+s-1>255)continue;const y=[],g=s*8;let A=f[0].speed;for(const b of f){const _=Array.from(la(b.tile,Tn)||[]);if(_.length!==g)continue;const E=oa(b.tile),C=241,T=E?Array.from(E).slice(0,g):new Array(g).fill(C);for(;T.length<g;)T.push(C);const w=[];for(let D=0;D<s;D++){const N=D*8;w.push(..._.slice(N,N+8)),w.push(...T.slice(N,N+8))}y.push({tileName:String(((r=b.tile)==null?void 0:r.name)||b.tileId),bytes:w}),A=Math.min(A,b.speed)}if(y.length<2)continue;const I=f[0].groupId,S=`anim_group_${n.length}_${ea(I,`g${n.length}`)}`;n.push({label:S,groupId:I,speed:me(A,8,1,255),targetTileId:i,targetCharCode:m,charsPerTile:s,frameCount:me(y.length,y.length,2,255),bytesPerFrame:s*16,frames:y})}return{frameGroups:n,transformGroups:o}}function Nn(t){var f,m;const{frameGroups:e,transformGroups:a}=Dn(t),l=e.length>0,o=a.length>0,n=me(((f=e[0])==null?void 0:f.speed)??((m=a[0])==null?void 0:m.speed)??8,8,1,255),c=Math.max(1,e.length+a.length),r=l?e.map(s=>`    db ${s.targetCharCode}, ${s.charsPerTile}, ${s.frameCount}, ${s.speed}, ${s.bytesPerFrame}    ; ${s.groupId} -> tile ${s.targetTileId}
    dw ${s.label}`).join(`
...
`:ca(l,p),"entities.asm":uo(l),"worlds.asm":vo(l),"screens.asm":mo(l),"sprites.asm":Fl(l),"font.asm":fo(l),"hud.asm":bo(l),"menus.asm":wo(l),"sound.asm":ln(l),"scroll.asm":An(l),"animtiles.asm":Nn(l),"particles.asm":xn(l),"statemachine.asm":l.stateMachines&&l.stateMachines.length>0?Go(l.stateMachines,l.globalVariables,l.sprites,l.tiles,l.templates,l.sounds,l.trackIndexByAssetId):`; No State Machines
`,"gameflow.asm":yl(l),"main.asm":Tl(t,l),"unitedFiles.asm":""};return a.generateUnified&&(u["unitedFiles.asm"]=Pl(u,t,l,{romMode:p,targetFormat:r,autoMegaROM:d})),console.log("✅ Modular ASM files generated successfully!"),console.log(`📊 Generated ${Object.keys(u).filter(h=>u[h]).length} files`),console.log("📋 [DEBUG] Files generated:",Object.keys(u)),console.log("🎯 [DEBUG] interrupt.asm length:",((i=u["interrupt.asm"])==null?void 0:i.length)||"MISSING!"),u}const kr=Object.freeze(Object.defineProperty({__proto__:null,generateModularASM:Mn},Symbol.toStringTag,{value:"Module"}));export{pr as $,Nt as A,Ae as B,xt as C,Bn as D,jn as E,Pa as F,Oa as G,q as H,Nr as I,tr as J,er as K,Ma as L,$n as M,mr as N,Ge as O,Un as P,Lr as Q,Dr as R,Qe as S,Rr as T,ga as U,ir as V,ar as W,or as X,lr as Y,Yn as Z,dr as _,Qn as a,nr as a0,rr as a1,cr as a2,sr as a3,_r as a4,ye as a5,ze as a6,Zn as a7,Mr as a8,zn as a9,Hn as aa,He as ab,Re as ac,Le as ad,oe as ae,Pr as af,ur as ag,ka as ah,j as ai,R as aj,Fn as ak,ct as al,Or as am,fr as an,Gn as ao,Aa as ap,Kn as aq,br as ar,hr as as,Vn as at,yr as au,kr as av,Wn as b,Xn as c,De as d,Er as e,qn as f,gr as g,Jn as h,la as i,oa as j,J as k,On as l,kn as m,Ve as n,Ar as o,Tr as p,Cr as q,Ir as r,Sr as s,vr as t,Ne as u,xe as v,Ra as w,wr as x,Pn as y,xr as z};
