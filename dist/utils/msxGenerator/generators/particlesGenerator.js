/**
 * @fileoverview Particles Generator - Visual effects using pattern redefinition
 * Generates particles.asm with dynamic VRAM pattern manipulation
 *
 * MSX-Specific Approach: Instead of traditional sprite-based particles,
 * we redefine character patterns in VRAM on-the-fly to create effects like:
 * - Explosions, smoke, sparks
 * - Dust clouds, debris
 * - Impact effects, muzzle flashes
 *
 * This leverages MSX's tile-based architecture efficiently.
 */
/**
 * Generate particles system file (particles.asm)
 *
 * @param analysis - Project analysis
 * @returns ASM code string with particle system
 */
export function generateParticlesFile(analysis) {
...
particle_pool:
    ; 8 particles * 8 bytes = 64 bytes reserved in RAM
    ; Structure defined in variables.asm
