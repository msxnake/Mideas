...
export const Z80_SNIPPETS: Snippet[] = [
  {
    id: "dynamic_snippet_1",
    name: "Load Specific Tile Char Code",
    code: `; Loads the character code for a tile by its name.
; Placeholder will be replaced on insertion.
; Replace 'MyTile' with the actual tile name you want.
LD A, {{tile.MyTile.char_code}}
`
  },
  {
    id: "dynamic_snippet_2",
    name: "Define Bank Tile Equates",
    code: `; Defines EQUates for all tiles in the specified bank.
; The macro will be replaced with a list of all assigned tiles.
; Replace 'Main_Game_Area' with your target bank name.
{{BANK_TILE_DEFINITIONS(Main_Game_Area)}}
`
  },
  {
    id: "default_snippet_1",
...
`
  ...
  {
    id: "default_snippet_2",
    name: "Custom Interrupt Hook",
    code: `; Custom Interrupt Handler Hook
...
export const Z80_BEHAVIOR_SNIPPETS: Snippet[] = [
  {
    id: "behavior_snippet_1",
    name: "Basic Movement",
    code: `; Behavior: Basic Entity Movement
...
`
  ...
  {
    id: "behavior_snippet_2",
    name: "Simple Patrol",
    code: `; Behavior: Simple Horizontal Patrol
