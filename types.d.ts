...
export declare const EXPLOSION_SPRITE_SIZES: readonly [16, 24, 32];
 ...
 */
export declare enum HUDElementType {
    Score = "Score",
    HighScore = "HighScore",
    Lives = "Lives",
    EnergyBar = "EnergyBar",
...
export declare const EFFECT_ZONE_FLAGS: {
    readonly water: {
        readonly bit: 0;
        readonly label: "Water Effect";
        readonly maskValue: 1;
        readonly color: "rgba(50, 100, 200, 0.4)";
    };
    readonly customGravity: {
        readonly bit: 1;
        readonly label: "Custom Gravity";
        readonly maskValue: 2;
        readonly color: "rgba(150, 50, 200, 0.4)";
    };
    readonly icePhysics: {
        readonly bit: 2;
        readonly label: "Ice Physics";
        readonly maskValue: 4;
        readonly color: "rgba(100, 200, 255, 0.4)";
    };
    readonly spriteConceal: {
        readonly bit: 3;
        readonly label: "Sprite Concealment";
        readonly maskValue: 8;
        readonly color: "rgba(100, 100, 100, 0.4)";
    };
};
...
export declare const DITHER_BRUSH_DIAMETERS: readonly [1, 3, 5, 7];
export type DitherBrushDiameter = typeof DITHER_BRUSH_DIAMETERS[number];
export type ScreenEditorTool = 'draw' | 'erase' | 'select' | 'placeEntity' | 'defineEffectZone';
...
export declare const SOLIDITY_TYPES: readonly [{
    readonly id: 0;
    readonly name: "NoSolid (Passable)";
    readonly isSolid: false;
}, {
    readonly id: 1;
    readonly name: "Solid (Wall/Ground)";
    readonly isSolid: true;
}, {
    readonly id: 2;
    readonly name: "Platform (Top-Solid)";
    readonly isSolid: true;
}, {
    readonly id: 3;
    readonly name: "Slope (Solid)";
    readonly isSolid: true;
}];
export type SolidityTypeId = typeof SOLIDITY_TYPES[number]['id'];
export declare const PROPERTY_FLAGS: {
    readonly isBreakable: {
        readonly bit: 0;
        readonly label: "Breakable";
    };
    readonly isMovable: {
        readonly bit: 1;
        readonly label: "Movable";
    };
    readonly causesDamage: {
        readonly bit: 2;
        readonly label: "Deadly";
    };
    readonly isInteractiveSwitch: {
        readonly bit: 3;
        readonly label: "Interactable";
    };
};
...
export interface BehaviorMapASMExportData {
    mapName: string;
    mapWidth: number;
    mapHeight: number;
...
export interface PletterExportData {
    mapName: string;
    mapWidth: number;
    mapHeight: number;
...
export interface SuperRLEExportData {
    mapName: string;
    mapWidth: number;
    mapHeight: number;
    originalSize: number;
    compressedSize: number;
    superRLEDataBytes: number[];
    tilePartReferences?: {
        byteValue: number;
        tileId: string | null;
        subTileX?: number;
...
export interface OptimizedRLEExportData {
    mapName: string;
    mapWidth: number;
    mapHeight: number;
    originalSize: number;
    compressedSize: number;
    optimizedRLEPackets: number[];
    decompressorAsm: string;
